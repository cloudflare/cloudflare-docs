...
- Squattable placeholder package names: install or exec targets such as npx some-cli-tool or npm install some-experimental-package that keep a placeholder-looking, bare unscoped name in runnable package-manager syntax. Docs commands are published for AI coding agents and may be run verbatim, and anyone can register an unclaimed package name. Do not report scoped names or clearly non-executable placeholder forms such as <your-cli-tool>.
