...
- If `<AnchorHeading>` is used in a regular MDX file → in regular MDX, headings get anchors automatically. Use an inline comment to override the anchor ID instead: `## My heading {/* custom-anchor */}`.
