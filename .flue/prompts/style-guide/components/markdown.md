...
- If `<Markdown>` is used outside a JSX or partial context → use standard Markdown prose instead; `<Markdown>` is primarily for rendering variables passed into partials.
