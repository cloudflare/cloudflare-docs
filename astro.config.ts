...
import { incrementalCssInvalidation } from "./src/integrations/incremental-css-invalidation";
...
const incrementalBuild = process.env.INCREMENTAL_BUILD === "true";
...
const integrations = [
	...
	...(incrementalBuild
		? [incrementalCssInvalidation(new URL("./dist/_astro/", import.meta.url))]
		: []),
];
