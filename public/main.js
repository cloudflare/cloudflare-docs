// ns-hugo:/Users/kliao/Desktop/cloudflare-docs/assets/events.ts
...
function zarazTrackDocEvents() {
  ...
  const dropdowns2 = document.getElementsByTagName("details");
      ...
      for (const copyButton of copyCodeBlockButtons) {
        copyButton.addEventListener("click", () => {
          ...
          zaraz.track("copy button link click", {
            title: (_a = codeBlockElement.getAttribute("title")) != null ? _a : "title not set",
            language: (_b = codeBlockElement.getAttribute("language")) != null ? _b : "language not set"
          });
        });
      }
    }
...
// ns-hugo:/Users/kliao/Desktop/cloudflare-docs/assets/contents.ts
...
// ns-hugo:/Users/kliao/Desktop/cloudflare-docs/assets/timeago.ts
function init() {
  let i = 0, tmp;
...
// ns-hugo:/Users/kliao/Desktop/cloudflare-docs/assets/navlinks.ts
function init2() {
