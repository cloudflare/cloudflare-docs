...
2.  [Create a monitor](/load-balancing/how-to/create-monitor/) with a **Type** of *SMTP*.
...
2.  [Create a monitor](/load-balancing/how-to/create-monitor/) with a **Type** of *UDP-ICMP* or *TCP*.
