...
<table style='width:100%'>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Update the <a href="/load-balancing/understand-basics/traffic-steering/policies/">steering policy</a> associated with your load balancer.</td>
    </tr>
    <tr>
      <td><em>Override</em></td>
      <td><em>Fallback pool</em></td>
      <td>Update the <a href="/load-balancing/understand-basics/traffic-steering/policies/#off---standard-failover">fallback pools</a> associated with your load balancer.</td>
    </tr>
    <tr>
      <td><em>Override</em></td>
    ...
    <tr>
      ...
      <td>Update the <a href="/load-balancing/understand-basics/traffic-steering/policies/geo-steering/">region pools</a> associated with your load balancer.</td>
    </tr>
    <tr>
      <td><em>Override</em></td>
