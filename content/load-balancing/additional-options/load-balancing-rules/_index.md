...
By default, non-Enterprise customers have **one** Load Balancing rule **per load balancer**. For more rules, upgrade to [Enterprise](https://www.cloudflare.com/enterprise/).
