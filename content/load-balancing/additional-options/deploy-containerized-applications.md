...
![Diagram of an application deployed across Google Kubernetes Engine and AWS](https://developers.cloudflare.com/load-balancing/static/images/best-practices-2.png)
