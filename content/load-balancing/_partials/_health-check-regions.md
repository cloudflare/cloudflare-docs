...
![Health checks come from three data centers within each selected region.](https://developers.cloudflare.com/load-balancing/static/images/health-check-component.png)
