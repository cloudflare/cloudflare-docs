...
Health monitors associated with load balancers are different from standalone [Health Checks](/health-checks/). For an overview of how the Cloudflare Load Balancing solution works, check out [Load Balancing components](/load-balancing/understand-basics/load-balancing-components/).
