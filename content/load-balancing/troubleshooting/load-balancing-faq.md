...
-   Ensure your firewall or web server does not block or rate limit [our health checks](/fundamentals/get-started/reference/cloudflare-site-crawling/#specific-products) and accepts requests from [Cloudflare IP addresses](/fundamentals/get-started/setup/allow-cloudflare-ip-addresses/).
