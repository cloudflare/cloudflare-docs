...
When a pool reaches **Critical** health, your load balancer will begin diverting traffic according to its [Traffic steering policy](/load-balancing/understand-basics/traffic-steering/policies/):
