...
2.  [Traffic steering](/load-balancing/understand-basics/traffic-steering/policies/): Policies set on your [load balancer](/load-balancing/understand-basics/load-balancers/) that route traffic to attached and available pools.
