...
![Clicking GraphiQL Docs link to open Documentation Explorer](https://developers.cloudflare.com/analytics/static/images/graphiql-docs-link.png)

The **Documentation Explorer** opens and displays a list of available objects:

![GraphiQl Doc Explorer pane](https://developers.cloudflare.com/analytics/static/images/graphiql-doc-explorer.png)
...
![Documentation Explorer displaying mutation and query nodes](https://developers.cloudflare.com/analytics/static/images/graphiql-doc-explorer-query-mutations.png)
...
![Documentation Explorer displaying cost and viewer fields](https://developers.cloudflare.com/analytics/static/images/graphiql-doc-explorer-view-cost.png)
...
![Displaying viewer fields](https://developers.cloudflare.com/analytics/static/images/graphiql-doc-explorer-viewer-fields.png)
...
![Clicking zone type definition](https://developers.cloudflare.com/analytics/static/images/graphiql-doc-explorer-zones.png)
...
![Fields section displaying datasets available](https://developers.cloudflare.com/analytics/static/images/graphiql-doc-explorer-zone-fields.png)

Use the search input (magnifying glass icon) to find specific datasets:

![Searching a dataset in the Documentation Explorer](https://developers.cloudflare.com/analytics/static/images/graphiql-doc-explorer-find-firewall.png)
...
![Example of a dataset definition](https://developers.cloudflare.com/analytics/static/images/graphiql-doc-explorer-firewallevents-definition.png)
...
![Clicking type definition to visualize fields available for a dataset](https://developers.cloudflare.com/analytics/static/images/graphiql-doc-explorer-firewall-type-definition.png)

The list of fields displays:

![Displaying available fields for a dataset](https://developers.cloudflare.com/analytics/static/images/graphiql-doc-explorer-firewall-fields.png)
