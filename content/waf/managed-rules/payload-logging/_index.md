...
* Decrypt the matched payload in your [Logpush](/logs/about/) job using a Worker before storing the logs in your {{<glossary-tooltip term_id="SIEM">}}SIEM system{{</glossary-tooltip>}}. Refer to [Store decrypted matched payloads in logs](/waf/managed-rules/payload-logging/decrypt-in-logs/) for details.
