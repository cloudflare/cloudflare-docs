...
Cloudflare has a regular cadence of releasing updates and new rules to the WAF's managed rulesets. The updates either improve a rule's accuracy, lower false positives rates, or increase the protection due to a change in the threat landscape.
