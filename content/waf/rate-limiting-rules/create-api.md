...
For API guidance on the previous version of rate limiting rules, refer to the [Cloudflare API documentation](https://developers.cloudflare.com/api/operations/rate-limits-for-a-zone-properties).
