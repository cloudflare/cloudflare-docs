...
9. (Optional) If you selected the _Block_ action, you can [configure the response](/waf/reference/response-blocked-requests/) for requests exceeding the configured rate limit.
