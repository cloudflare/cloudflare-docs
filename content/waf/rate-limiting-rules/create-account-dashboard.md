...
9. (Optional) If you selected the _Block_ action, you can [configure the response](#configuring-the-response-for-blocked-requests) for requests exceeding the configured rate limit.
