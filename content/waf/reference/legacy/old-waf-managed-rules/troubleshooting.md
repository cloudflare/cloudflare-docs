...
- **(Not recommended) Disable WAF managed rules for traffic to a URL:** Lowers security on the particular URL endpoint. Configured via [Page Rules](/rules/page-rules/) (deprecated).
...
- Are WAF managed rules being disabled via [Page Rules](/rules/page-rules/) (deprecated)?
