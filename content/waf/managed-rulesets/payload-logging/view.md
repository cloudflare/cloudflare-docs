...
3.  Under **Payload match**, select **Decrypt payload log**.
    ...
    ![Example of a firewall event with available payload match data (still encrypted)](https://developers.cloudflare.com/waf/static/transform-rules/payload-logging-example.png)
...
![Viewing the decrypted payload match data after entering your private key in the dashboard](https://developers.cloudflare.com/waf/static/transform-rules/payload-decrypted.png)
