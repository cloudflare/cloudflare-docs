...
If you wish to deploy a Managed Ruleset for several zones in your account, refer to [Deploy a Managed Ruleset in the dashboard for an account](/waf/managed-rulesets/deploy-account-dashboard/).
