...
3.  [Create a Custom Firewall rule](/custom-rules/custom-firewall/create-dashboard) by clicking **Create custom rule** > **Firewall rule**, or edit an existing Custom Firewall rule.
