...
*   [**Custom Firewall rules**](/custom-rules/custom-firewall) — Control incoming traffic by filtering requests. Perform actions like *Block* or *JS Challenge* on incoming requests according to rules you define.
