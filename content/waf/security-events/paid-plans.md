...
![Example of adding a new filter in Security Events for the Allow action](/images/waf/analytics-add-filter.png)
...
![Filter by action by selecting Filter when hovering the desired action in Events summary](/images/waf/analytics-events-summary.png)
