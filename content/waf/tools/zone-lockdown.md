...
To create a Zone Lockdown rule, issue a `POST` request for the [Create a Zone Lockdown rule](https://developers.cloudflare.com/api/operations/zone-lockdown-create-a-zone-lockdown-rule) operation.
