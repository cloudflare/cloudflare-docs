...
# Create Enterprise Network Interconnects
...
4. In **Enter your location**, search for the location where you have the data centers you want to connect to Cloudflare through ENI.
5. From the list of locations, choose the one that suits you with **Select the location**.

    {{<Aside type="note">}}If your location does not come up in the search, that means that ENI is not available in your location yet. Refer to Classic CNI to learn how you can use the classic version of network interconnect to connect your location to Cloudflare.{{</Aside>}}
