...
5. From the list of locations, choose the one that suits you with **Select the location**.
    ...
    {{<Aside type="note">}}If your location does not come up in the search, that means that CNI 2.0 is not available in your location yet. Refer to [CNI 1.0](/network-interconnect/cni-1.0/) to learn how you can use the manual version of CNI to connect your location to Cloudflare.{{</Aside>}}
