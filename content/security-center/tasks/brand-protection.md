...
While the Brand Protection tool is in beta, you will need to request access by filling in this sign up [form](http://cloudflare.com/lp/brandprotection).
...
5. Select **Save**.
6. In the **All notifications** tab, you can manage your notifications. You can disable, edit, delete, or test them. 

## Limits

While this product is in beta, all Cloudflare paid plans have access to the functionality with limits according to the plans. Pro and Biz customers have access to a limited number of private scans and on-demand searches, while ENT customers and Cloudforce One subscribers will have higher limits and the ability to save queries and create notifications for when there are new domain matches.
