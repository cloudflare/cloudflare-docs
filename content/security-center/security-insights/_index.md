...
| [Page Shield not enabled](/page-shield/get-started/) | Page Shield helps meet PCI DSS v4.0 comliance regarding requirement 6.4.3. | 
| [SPF Record Errors](/dns/manage-dns-records/reference/dns-record-types/#spf) | We detect an incorrect or missing `SPF` record. |
| [Unassigned Access seats](/cloudflare-one/) | We detect a Zero Trust subscription that isn't configured yet. | 
