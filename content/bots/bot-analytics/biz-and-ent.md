...
![View Bot Analytics in the Cloudflare Dashboard. For more details, keep reading.](https://developers.cloudflare.com/bots/static/bot-analytics-dashboard-biz.png)
