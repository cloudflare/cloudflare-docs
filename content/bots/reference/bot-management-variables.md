...
- **Bot DetectionIDs**: List of IDs that correlate to the Bot Management Heuristic detections made on a request (Multiple Heuristics can be made on a single request)
