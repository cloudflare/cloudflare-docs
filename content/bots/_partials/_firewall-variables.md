...
Bot Management provides access to several [new variables](/ruleset-engine/rules-language/fields/#dynamic-fields) within the expression builder of Ruleset Engine-based products such as the [WAF](/waf/). You can also use these fields in firewall rules.
