...
If your domain is not on Cloudflare Registrar, you can enable DNSSEC on the [DNS section](/dns/additional-options/dnssec/) of the Cloudflare dashboard.
...
When DNSSEC has been successfully applied to your domain, Cloudflare shows you a confirmed status. Navigate to the [DNS section](https://dash.cloudflare.com/login?to=/:account/:zone/dns) of the Cloudflare dashboard, and scroll down to DNSSEC. You can also confirm this by reviewing the WHOIS information for your domain. Domains with DNSSEC will read `signedDelegation` in the DNSSEC field.
