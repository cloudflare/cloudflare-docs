...
- You failed to follow the steps highlighted above in [creating an account with your domain](/fundamentals/get-started/setup/account-setup/create-account/) and [changing your DNS nameservers to Cloudflare](/dns/zone-setups/full-setup/).
