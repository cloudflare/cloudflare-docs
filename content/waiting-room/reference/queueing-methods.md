...
![First In First Out flow showing visitors entering the origin by order of arrival to the waiting room](https://developers.cloudflare.com/waiting-room/static/fifo-queueing-method.png)
...
![Random queueing flow showing visitors randomly exiting the waiting room and entering an origin](https://developers.cloudflare.com/waiting-room/static/random-queueing-method.png)
