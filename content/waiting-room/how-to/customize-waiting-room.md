...
- [Returne a JSON-friendly waiting room response](/waiting-room/how-to/json-response/): Toggle to also enable a JSON response with a user's status in the waiting room.
