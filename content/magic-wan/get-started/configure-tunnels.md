...
{{<render file="_tunnel-endpoints.md" productFolder="magic-transit" withParameters="`169.254.244.0/20` (this address space is also a [link-local address](https://en.wikipedia.org/wiki/Link-local_address));;Magic WAN;;**Magic WAN** > **Manage Magic WAN configuration** > **Configure**;;/magic-wan/reference/tunnels/#ipsec-tunnels;;/magic-wan/get-started/configure-static-routes/;;/magic-wan/reference/tunnels/;;/magic-wan/how-to/run-tunnel-health-checks/#update-health-check-frequency;;/magic-wan/reference/probe-construction/;;/magic-wan/reference/anti-replay-protection/">}}