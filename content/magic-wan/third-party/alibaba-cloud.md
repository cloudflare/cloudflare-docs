...
4. Choose the **Region** that aligns with where your servers are located, to improve performance.
...
1. Follow the [Configure static routes](/magic-wan/get-started/configure-static-routes/) instructions to create a static route.
