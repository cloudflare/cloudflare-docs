...
As a Magic WAN customer, you can also use Cloudflare Gateway to set up policies to inspect DNS, network, HTTP and egress traffic. Refer to [Connect to Cloudflare Gateway with Magic WAN](/magic-wan/zero-trust/cloudflare-gateway/) to learn how to set up Gateway with Magic WAN.