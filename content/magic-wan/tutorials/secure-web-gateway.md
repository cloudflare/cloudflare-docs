...
![Magic WAN prefix and next hope values for each branch office](https://developers.cloudflare.com/magic-wan/static/tunnel-config-values.png)
...
![Tunnel configuration for each branch office, including interface address, Customer and Cloudflare GRE endpoints, and TTL and MTU](https://developers.cloudflare.com/magic-wan/static/gre-tunnel-values.png)
...
![Static route configuration with defined prefixes, next hops, and priorities](https://developers.cloudflare.com/magic-wan/static/static-route-values.png)
