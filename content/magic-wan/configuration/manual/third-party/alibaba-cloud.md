...
1. Follow the [Add tunnels](/magic-wan/configuration/manual/how-to/configure-tunnels/#add-tunnels) instructions to create the required IPsec tunnels with the following options:
...
1. Follow the [Configure static routes](/magic-wan/configuration/manual/how-to/configure-static-routes/#create-a-static-route) instructions to create a static route.
