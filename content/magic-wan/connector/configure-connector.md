...
9. Under **WAN configuration**, you will be configuring your [wide area network (WAN)](https://www.cloudflare.com/learning/network-layer/what-is-a-wan/). Select **Create** and define the following settings:
    ...
    4. **Priority**: The priority for your WAN. Lower numbers have higer priority. Refer to [Traffic steering](/magic-wan/reference/traffic-steering/) to learn more about how Cloudlfare calculates priorities.
