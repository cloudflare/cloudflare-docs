...
B->>C: Payload <br> Protocol <br> IP header <br> IPsec <br> IP header
C->>B: Payload <br> Protocol <br> IP header <br> IPsec <br> IP header
B->>A: Payload <br> Protocol <br> IP header
```

<br>

{{<Aside type="note">}}By default, $1 does not use Direct Server Return (DSR).{{</Aside>}}
