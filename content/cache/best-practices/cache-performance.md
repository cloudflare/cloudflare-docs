...
- **Dynamic**: Default response for many file types including HTML. To cache additional content, refer to [custom caching with page rules](/cache/troubleshooting/best-practices-speed-up-your-site-with-custom-caching-via-cloudflare-page-rules/).
