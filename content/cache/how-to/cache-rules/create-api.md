...
4. Use [Update a zone ruleset rule](/api/operations/updateZoneRulesetRule) operation to update an existing rule within the ruleset. For an example, refer to the section below.
