...
- `vary` — Cloudflare does not consider vary values in caching decisions. Nevertheless, vary values are respected when [Vary for images](/cache/about/vary-for-images/) and [`accept-encoding`](https://support.cloudflare.com/hc/en-us/articles/200168396-What-will-Cloudflare-compress-) are configured. For more information about `vary: accept-encoding` header, refer to this [community thread](https://community.cloudflare.com/t/vary-accept-encoding-header/145014).
