...
- Cache Reserve makes requests for uncompressed content directly from the origin. Unlike a standard CDN, Cache Reserve does not include the `Accept-Encoding: gzip` header when sending requests to the origin.
