...
In this card you can check the status of your account's DNS records. 

* **Email DNS records misconfigured** - There is a problem with your accounts DNS records. Select **Enable Email Routing** to start troubleshooting for problems.
