...
However, if you are using the [new version of rate limiting rules](https://developers.cloudflare.com/waf/rate-limiting-rules/) (documented in the developer documentation), you must ensure that your rate limiting rules are not affecting known good bots, so that the SEO ranking of your website is not affected. For more information, refer to [Improve SEO](https://developers.cloudflare.com/fundamentals/get-started/basic-tasks/improve-seo/).
...
-   [How is Rate Limiting reported in ELS (Enterprise Log Share)?](https://developers.cloudflare.com/logs/reference/log-fields)
