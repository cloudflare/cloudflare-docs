...
In order to apply the custom cache key to specific paths or file extensions, it may be necessary to add additional logic to the Worker or apply the code to multiple different Worker routes. See the Worker [documentation](https://developers.cloudflare.com/workers/) for further details or contact your Solutions Engineer.
