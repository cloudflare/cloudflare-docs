...
Refer to [Supported URL components in Bulk Redirects](/rules/bulk-redirects/reference/url-components) for details on the supported URL components for redirect source URLs.
...
Refer to [Supported URL components in Bulk Redirects](/rules/bulk-redirects/reference/url-components) for details on the supported URL components for redirect target URLs.
...
Refer to [Supported URL components in Bulk Redirects](/rules/bulk-redirects/reference/url-components) for details on the required URL components for redirect source URLs.
...
Refer to [URL redirect parameters](/rules/bulk-redirects/reference/parameters) for more information on the current limits.
...
Refer to [Supported URL components in Bulk Redirects](/rules/bulk-redirects/reference/url-components) for details on the required URL components for redirect target URLs.
