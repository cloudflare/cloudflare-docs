...
For responses with error status codes, Cloudflare will only compress responses if their error status code is `403` or `404`. Responses with other error status codes will not be compressed.
