...
If you have resources that do not have a file extension that [Cloudflare caches](h/cache/about/default-cache-behavior/) we treat that resource as dynamic HTML. We don't cache it by default, and Cloudflare's system will send that resource gzipped and with chunked encoding.  
