...
They can use Cloudflare API: [https://api.cloudflare.com/#zone-settings-change-ciphers-setting](https://api.cloudflare.com/#zone-settings-change-ciphers-setting) to change the required settings
