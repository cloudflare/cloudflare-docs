...
When [generating Client Certificates at Cloudflare](/ssl/client-certificates/create-a-client-certificate) for use with [API Shield™](/api-shield/products/mtls/configure) to protect your API or web application, it's hard to differentiate the generated certificates.
