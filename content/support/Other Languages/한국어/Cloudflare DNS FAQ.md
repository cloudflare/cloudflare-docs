...
이는 이전의 권한 있는 DNS에서 와일드카드 \* 레코드가 구성되었을 때 발생할 수 있습니다. https://api.cloudflare.com/#dns-records-for-a-zone-delete-dns-record API를 사용하여 이러한 레코드를 대량으로 제거할 수 있습니다. 또는 Cloudflare Dashboard에서 도메인을 삭제한 다음 신뢰할 수 있는 DNS에서 와일드카드 레코드를 삭제하고 도메인을 다시 추가할 수도 있습니다.
