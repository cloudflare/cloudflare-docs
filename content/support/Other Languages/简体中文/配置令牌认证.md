...
-   [配置 Worker](https://developers.cloudflare.com/workers/get-started/quickstarts/)
-   使用 [Auth with Headers](https://developers.cloudflare.com/workers/examples/auth-with-headers/) 模板
