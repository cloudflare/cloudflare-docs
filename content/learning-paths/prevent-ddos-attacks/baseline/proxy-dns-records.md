...
Before proxying your records, you should likely [allow Cloudflare IP addresses]((/fundamentals/setup/allow-cloudflare-ip-addresses/)) at your origin to prevent requests from being blocked.
