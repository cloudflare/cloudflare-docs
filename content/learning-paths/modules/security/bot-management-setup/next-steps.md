...
- Regularly review [Bot analytics](/bots/bot-analytics/bm-subscription/), [Security events](/waf/security-events/paid-plans/), each rule's [Challenge solve rate](https://developers.cloudflare.com/bots/concepts/challenge-solve-rate/), and [Cloudflare logs](/logs/about/).
