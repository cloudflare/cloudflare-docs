...
6. [Download](/cloudflare-one/connections/connect-devices/warp/download-warp/) and install WARP on the device.
7. Once WARP is installed, manually authenticate into your Zero Trust organization:
