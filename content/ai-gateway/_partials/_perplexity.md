...
`https://gateway.ai.cloudflare.com/v1/<ACCOUNT_ID>/<GATEWAY>/perplexity-ai`
...
curl --request POST \
     --url https://gateway.ai.cloudflare.com/v1/<ACCOUNT_ID>/<GATEWAY>/perplexity-ai/chat/completions \
...
import OpenAI from "openai";
  ...
  const perplexity = new OpenAI({
    ...
    baseURL: "https://gateway.ai.cloudflare.com/v1/<ACCOUNT_ID>/<GATEWAY>/perplexity-ai"
  });
