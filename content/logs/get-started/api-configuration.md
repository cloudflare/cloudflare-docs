...
|---|---|---|
| `POST` | Create job | [Zone-scoped job](https://developers.cloudflare.com/api/operations/post-zones-zone_identifier-logpush-jobs) / [Account-scoped job](https://developers.cloudflare.com/api/operations/post-accounts-account_identifier-logpush-jobs) |
| `GET` | Retrieve job | [Zone-scoped job](https://developers.cloudflare.com/api/operations/get-zones-zone_identifier-logpush-jobs-job_identifier) / [Account-scoped job](https://developers.cloudflare.com/api/operations/get-accounts-account_identifier-logpush-jobs-job_identifier) |
| `GET` | Retrieve all jobs for all datasets | [Zone-scoped jobs](https://developers.cloudflare.com/api/operations/get-zones-zone_identifier-logpush-jobs) / [Account-scoped jobs](https://developers.cloudflare.com/api/operations/get-accounts-account_identifier-logpush-jobs) |
| `GET` | Retrieve all jobs for a dataset | [Zone-scoped jobs](https://developers.cloudflare.com/api/operations/get-zones-zone_identifier-logpush-datasets-dataset-jobs) / [Account-scoped jobs](https://developers.cloudflare.com/api/operations/get-accounts-account_identifier-logpush-datasets-dataset-jobs) |
| `GET` | Retrieve all available fields for a dataset | [Zone-scoped fields](https://developers.cloudflare.com/api/operations/get-zones-zone_identifier-logpush-datasets-dataset-fields) / [Account-scoped fields](https://developers.cloudflare.com/api/operations/get-accounts-account_identifier-logpush-datasets-dataset-fields) |
| `PUT` | Update job | [Zone-scoped job](https://developers.cloudflare.com/api/operations/put-zones-zone_identifier-logpush-jobs-job_identifier) / [Account-scoped job](https://developers.cloudflare.com/api/operations/put-accounts-account_identifier-logpush-jobs-job_identifier) |
| `DELETE` | Delete job | [Zone-scoped job](https://developers.cloudflare.com/api/operations/delete-zones-zone_identifier-logpush-jobs-job_identifier) / [Account-scoped job](https://developers.cloudflare.com/api/operations/delete-accounts-account_identifier-logpush-jobs-job_identifier) |
| `POST` | Check whether destination exists | [Zone-scoped job](https://developers.cloudflare.com/api/operations/post-zones-zone_identifier-logpush-validate-destination-exists) / [Account-scoped job](https://developers.cloudflare.com/api/operations/delete-accounts-account_identifier-logpush-validate-destination-exists) |
| `POST` | Get ownership challenge | [Zone-scoped job](https://developers.cloudflare.com/api/operations/post-zones-zone_identifier-logpush-ownership) / [Account-scoped job](https://developers.cloudflare.com/api/operations/post-accounts-account_identifier-logpush-ownership) |
| `POST` | Validate ownership challenge | [Zone-scoped job](https://developers.cloudflare.com/api/operations/post-zones-zone_identifier-logpush-ownership-validate) / [Account-scoped job](https://developers.cloudflare.com/api/operations/post-accounts-account_identifier-logpush-ownership-validate) |
| `POST` | Validate log options | [Zone-scoped job](https://developers.cloudflare.com/api/operations/post-zones-zone_identifier-logpush-validate-origin) / [Account-scoped job](https://developers.cloudflare.com/api/operations/post-accounts-account_identifier-logpush-validate-origin) |

{{</table-wrap>}}

For concrete examples, see the tutorial at [Manage Logpush examples](/logs/tutorials/examples/).
...
For a detailed description, refer to the [API documentation](https://developers.cloudflare.com/api/operations/get-zones-zone_identifier-logpush-jobs).
