...
Below is a description of the available permissions for tokens and roles as they relate to Logs. For information about how to create an API token, please refer to [Creating API tokens](/api/tokens/create/).
