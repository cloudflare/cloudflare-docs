...
{{<faq-item>}}
{{<faq-question level=2 text="How long are logs retained?" >}}
...
{{<faq-item>}}
{{<faq-question level=2 text="I am asking for logs for the time window of 16:10-16:13. However, the timestamps in the logs show requests that are before this time period. Why does that happen?" >}}
