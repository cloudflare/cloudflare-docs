...
6. In **Select data fields**:
    ...
    - In **Advanced Settings**, you can change the Timestamp format (`RFC3339`(default),`Umix`, or `UnixNano`), [Sampling rate](/logs/get-started/api-configuration/#sampling-rate) and enable redaction for `CVE-2021-44228`.
