...
* The maximum length of custom field data is 8 KB per field type. Any data over this limit will be truncated. For example, if you create four cookie custom fields, the maximum size limit of 8 KB applies to the total size of all of the cookie fields.
