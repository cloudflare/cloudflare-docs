...
Version Management does not currently support the following products or features: 
...
- [Cache Rules](https://developers.cloudflare.com/cache/how-to/cache-rules/) when used with [Cloudflare Images](https://developers.cloudflare.com/images/)
