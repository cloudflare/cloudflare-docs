...
{{<description>}}
Stop {{<glossary-tooltip term_id="phishing">}}phishing{{</glossary-tooltip>}} attacks with Email Security (formerly Area 1) cloud-native email security service.
{{</description>}}
...
In addition to standard logins, Email Security (formerly Area 1) offers support for {{<glossary-tooltip term_id="SAML">}}SAML{{</glossary-tooltip>}} based single sign-on (SSO) logins to your dashboard.
{{</feature>}}
