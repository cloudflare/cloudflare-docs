...
To enable Email Link Isolation you must have an [inline deployment](/email-security/deployment/inline/) for your Cloud Email Security (formerly Area 1) setup. Email Link Isolation is not available if Cloud Email Security (formerly Area 1) is deployed through [journaling or BCC](/email-security/deployment/api/setup/) setups.
