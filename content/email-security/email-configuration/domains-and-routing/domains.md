...
Cloud Email Security (formerly Area 1) works through a system of domain-based routing, where Cloudflare receives and evaluates incoming email from a domain.

## Create a domain

To create a new domain in Cloud Email Security (formerly Area 1):
