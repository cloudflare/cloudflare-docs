...
Cloud Email Security (formerly Area 1) can integrate with Google to retrieve user and group information. This can be used to enforce the Business Email Compromise configuration to prevent user impersonation.

## 1. Create a service account in Google for Cloud Email Security (formerly Area 1) Directory Integration

You need to authorize Cloud Email Security (formerly Area 1) to make connections into your Google tenant to retrieve your directory details. Cloudflare recommends that you create a service account for this purpose. This account will require the following following privileges:
...
## 2. Authorize Cloud Email Security (formerly Area 1) for Directory Access with Google
...
2. Go to **Directories**, and select **Add Directory** to start the authorization process.
    ...
    ![Go to Directories in the dashboard of Cloud Email Security (formerly Area 1), and then select Add Directory to start the authorization process](/images/email-security/bec/gmail/step2-directories.png)
...
4. The Cloud Email Security (formerly Area 1) dashboard will redirect you to a Google login page. Select or enter the appropriate account to initiate the authentication process.
