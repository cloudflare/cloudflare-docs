...
## 1. Authorize Cloud Email Security (formerly Area 1) with Office 365 for Directory Access

You need to authorize Cloudflare Cloud Email Security (formerly Area 1) to make connections into your [Office 365 tenant](https://learn.microsoft.com/en-us/microsoft-365/solutions/tenant-management-overview) to retrieve your directory details. The account used to authorize will require the **Privileged authentication admin** and **Privileged role admin** roles.
...
![A list of permissions for Cloud Email Security (formerly Area 1)](/images/email-security/bec/o365/permissions.png)
...
2. Go to **Directories**, and select **Add Directory** to start the authorization process.
    ...
    ![Go to Directories in the dashboard of Cloud Email Security (formerly Area 1), and then select Add Directory to start the authorization process](/images/email-security/bec/o365/step2-directories.png)
