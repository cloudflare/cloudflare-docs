...
{{<Aside type="note">}}After being released from quarantine, Area 1 forwards the original email messages to their destination. These emails should arrive at email inboxes from the original sender, not Area 1.{{</Aside>}}