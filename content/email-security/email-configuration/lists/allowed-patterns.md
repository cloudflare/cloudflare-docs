...
5. Enter the pattern information:
    ...
    - **Allow Type**: Choose one or more of the following types:
        ...
        - **Trusted Sender**: Messages will bypass all [detections](/email-security/reference/dispositions-and-attributes/) and link following by Cloud Email Security. Typically, only applies to {{<glossary-tooltip term_id="phishing">}}phishing{{</glossary-tooltip>}} simulations from vendors such as KnowB4.
