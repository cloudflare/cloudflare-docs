...
However — so long as you also have [**Journalling**](#link-needed) configured — you can set up **Message retraction** to take post-delivery actions against messages that are suspicious. These retractions happen through API integrations with Microsoft 365 and Google Workspaces (Gmail).
