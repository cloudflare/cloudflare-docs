...
You can report false positives from the Area 1 dashboard:

1. Log in to the [Area 1 dashboard](https://horizon.area1security.com/).
2. Select the **Search** bar.
3. Search for the message that you want to report as a false positive, and select **Report as false positive**.
4. (Optional) You can also report several emails as false positives. Select all emails that apply > **Report as FP**.