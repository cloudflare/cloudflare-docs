...
When you set up Cloud Email Security (formerly Area 1) through a [partner](/email-security/partners/), that partner's account is the **parent** account to your **child** account.
...
4. Select a permission level:
    ...
    - **No external account access**: Shuts off all access from the parent account (including Cloud Email Security (formerly Area 1)).
