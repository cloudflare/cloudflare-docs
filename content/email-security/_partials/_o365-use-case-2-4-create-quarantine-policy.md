...
8. In **Recipient message access**, select **Set specific access (Advanced)**, and then:
    ...
    ![Configure the Recipient message access as stated in the step above](/images/email-security/deployment/inline-setup/o365-area1-mx/use-cases/step8-allow-message-release.png)
...
17. In **Recipient message access**, select **Set specific access (Advanced)**, and then:
    ...
    ![Configure the Recipient message access as stated in the step above](/images/email-security/deployment/inline-setup/o365-area1-mx/use-cases/step8-request-message-release.png)
