...
![With inline deployment, messages travel through Cloud Email Security's email filter before reaching your users.](/images/email-security/deployment/inline-setup/inline-deployment-diagram.png)
...
- Cloud Email Security can [modify delivered messages](/email-security/email-configuration/email-policies/text-addons/), adding subject or body mark-ups.
