...
8. In **Recipient message access**, select **Set specific access (Advanced)**, and then:
    ...
    ![Configure the Recipient message access as stated in the step above](/email-security/static/flexible-partial-images/o365-area1-mx/step8-allow-message-release.png)
...
17. In **Recipient message access**, select **Set specific access (Advanced)**, and then:
    ...
    ![Configure the Recipient message access as stated in the step above](/email-security/static/flexible-partial-images/o365-area1-mx/step8-request-message-release.png)
