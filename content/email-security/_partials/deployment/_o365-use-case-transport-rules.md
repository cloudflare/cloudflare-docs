...
To create the transport rules that will send emails with certain {{<glossary-tooltip term_id="disposition">}}dispositions{{</glossary-tooltip>}} to Cloud Email Security (formerly Area 1):
