...
# Office 365 Graph API set up with Email Security (formerly Area 1)
...
![Email flow when setting up Email Security with the Microsoft Graph API](/images/email-security/deployment/api-setup/ms-graph/ms-graph.png)
