...
weight: 4
meta:
   title: Deploy and configure Email Security (formerly Area 1) with with Cisco as MX record
updated: 2022-09-30
---

# Deploy and configure Email Security (formerly Area 1) with with Cisco as MX record
...
## 2. Add {{<glossary-tooltip term_id="SMTP">}}SMTP{{</glossary-tooltip>}} route for the Email Security Email Protection Hosts
