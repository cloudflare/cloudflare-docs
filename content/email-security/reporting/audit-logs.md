...
You can use Cloud Email Security (formerly Area 1) logs to review actions performed on your account:
...
You can use one of the Preview logs to preview how Cloud Email Security (formerly Area 1) handles post delivery retractions. With Audit logs Preview, Cloud Email Security (formerly Area 1) shows you the emails that would have been retracted with Post Delivery Response (PDR) or Phish Submissions Response (PSR) enabled.
