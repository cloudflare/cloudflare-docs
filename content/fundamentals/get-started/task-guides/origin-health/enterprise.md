...
- **SSL**:
  - To encrypt all traffic between Cloudflare and your server, [choose Strict (SSL-Only Origin Pull)](/ssl/origin-configuration/ssl-modes/ssl-only-origin-pull/-ssl-only-origin-pull) SSL/TLS mode (requires server configuration)
