...
![Example list of events in the Activity log, with one of the events expanded to show its details](/images/waf/analytics-activity-log.png)

Additionally, you can [add filters](/waf/security-events/paid-plans/#adjusting-displayed-data) to look for specific Ray IDs.

![Example of adding a new filter in Security Events for the Allow action](/images/waf/analytics-add-filter-free.png)
