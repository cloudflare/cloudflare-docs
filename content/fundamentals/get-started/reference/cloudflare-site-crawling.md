...
* **Certificate validation**: 
    ...
    * *Triggered when*: You choose to validate a custom hostname certificate with a [DCV HTTP token](/cloudflare-for-saas/ssl/common-tasks/certificate-validation-methods/#http).