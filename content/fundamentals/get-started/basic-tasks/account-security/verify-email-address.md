...
When you first [create an account](/fundamentals/get-started/account-setup/create-account/), Cloudflare automatically sends a message to the email address you provided for your account.
