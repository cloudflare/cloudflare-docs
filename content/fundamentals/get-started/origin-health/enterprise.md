...
- **Prevent external connections**:
  - **Origin Server** (moderately secure): Configure your origin server to [only allows traffic from Cloudflare IP addresses](/fundamentals/get-started/basic-tasks/allow-cloudflare-ip-addresses/#configure-origin-server).
