...
To update the communication preferences for your profile (which requires a [verified email address](/fundamentals/get-started/basic-tasks/account-security/verify-email-address/)):
