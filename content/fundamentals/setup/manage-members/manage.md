...
{{<Aside type="note">}}
If you have been invited to an account, you can remove yourself from this account under **Manage Account > Members**.
You can thee select click on your email address and then click **Leave**.
{{</Aside>}}
