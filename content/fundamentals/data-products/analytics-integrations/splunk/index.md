...
You can change the **Index Name** after initial configuration by clicking on the **Settings** dropdown and navigating to **Advance search**. There you can click on **Search macros** and look for the Cloudflare App for Splunk.
