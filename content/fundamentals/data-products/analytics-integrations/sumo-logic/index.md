...
![Sumo Logic Processing Rules for Logs page with sample Filter settings](https://developers.cloudflare.com/fundamentals/static/images/sumo-logic/screenshots/exclude_Workers-sumo_logic.png)
...
1.  In the Sumo Logic UI, click **App Catalog** and search for _Cloudflare_.
    ![Sumo Logic Cloudflare in App Catalog page with Cloudflare in search bar and Cloudflare app](https://developers.cloudflare.com/fundamentals/static/images/sumo-logic/screenshots/cloudflare-app-sumo-logic-app-catalog.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Web Traffic Overview metrics](https://developers.cloudflare.com/fundamentals/static/images/sumo-logic/dashboards/cloudflare-snapshot-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Summary of Edge and Origin Response Status metrics](https://developers.cloudflare.com/fundamentals/static/images/sumo-logic/dashboards/cloudflare-reliability-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Security Overview metrics](https://developers.cloudflare.com/fundamentals/static/images/sumo-logic/dashboards/cloudflare-security-overview-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Security metrics for WAF](https://developers.cloudflare.com/fundamentals/static/images/sumo-logic/dashboards/cloudflare-security-waf-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Security metrics for Rate Limiting](https://developers.cloudflare.com/fundamentals/static/images/sumo-logic/dashboards/cloudflare-security-rate-limiting-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Security metrics for Bot Management](https://developers.cloudflare.com/fundamentals/static/images/sumo-logic/dashboards/cloudflare-security-bot-management-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Performance metrics for Requests, Bandwidth, and Cache](https://developers.cloudflare.com/fundamentals/static/images/sumo-logic/dashboards/cloudflare-performance-requests-bandwidth-cache-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Performance metrics for Hostname, Content Type, Request Methods, and Connection Type](https://developers.cloudflare.com/fundamentals/static/images/sumo-logic/dashboards/cloudflare-performance-hostname-content-type-request-methods-connection-type-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Performance metrics for Static vs. Dynamic Content](https://developers.cloudflare.com/fundamentals/static/images/sumo-logic/dashboards/cloudflare-performance-static-vs-dynamic-content-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard menu bar with funnel icon highlighted](https://developers.cloudflare.com/fundamentals/static/images/sumo-logic/screenshots/filter-sumo-logic.png)
