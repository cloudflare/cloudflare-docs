...
![Sumo Logic Processing Rules for Logs page with sample Filter settings](/images/fundamentals/sumo-logic/screenshots/exclude_Workers-sumo_logic.png)
...
1.  In the Sumo Logic UI, click **App Catalog** and search for _Cloudflare_.
    ![Sumo Logic Cloudflare in App Catalog page with Cloudflare in search bar and Cloudflare app](/images/fundamentals/sumo-logic/screenshots/cloudflare-app-sumo-logic-app-catalog.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Web Traffic Overview metrics](/images/fundamentals/sumo-logic/dashboards/cloudflare-snapshot-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Summary of Edge and Origin Response Status metrics](/images/fundamentals/sumo-logic/dashboards/cloudflare-reliability-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Security Overview metrics](/images/fundamentals/sumo-logic/dashboards/cloudflare-security-overview-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Security metrics for WAF](/images/fundamentals/sumo-logic/dashboards/cloudflare-security-waf-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Security metrics for Rate Limiting](/images/fundamentals/sumo-logic/dashboards/cloudflare-security-rate-limiting-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Security metrics for Bot Management](/images/fundamentals/sumo-logic/dashboards/cloudflare-security-bot-management-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Performance metrics for Requests, Bandwidth, and Cache](/images/fundamentals/sumo-logic/dashboards/cloudflare-performance-requests-bandwidth-cache-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Performance metrics for Hostname, Content Type, Request Methods, and Connection Type](/images/fundamentals/sumo-logic/dashboards/cloudflare-performance-hostname-content-type-request-methods-connection-type-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard with Cloudflare Snapshot and Performance metrics for Static vs. Dynamic Content](/images/fundamentals/sumo-logic/dashboards/cloudflare-performance-static-vs-dynamic-content-dashboard-sumo-logic.png)
...
![Sumo Logic dashboard menu bar with funnel icon highlighted](/images/fundamentals/sumo-logic/screenshots/filter-sumo-logic.png)
