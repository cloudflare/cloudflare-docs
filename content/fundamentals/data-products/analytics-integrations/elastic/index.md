...
2.  Upload the _cloudflare-elastic-lambda.zip_ file to an S3 bucket.
    ...
    ![Uploading a file to an Amazon S3 bucket](/fundamentals/static/images/elastic/screenshots/cloudflare-elastic-lambda-zip-s3-bucket.png)
...
2.  Once logged in, create a new deployment where the Cloudflare logs will reside.
    ![Create your first deployment page](/fundamentals/static/images/elastic/screenshots/create-your-first-deployment.png)
...
3.  Configure your new deployment with the following parameters:
    ...
    - **Template**: Choose _Hot-Warm Architecture_ (recommended) or _I/O Optimize_
      ![Creating an Elastic deployment from a template](/fundamentals/static/images/elastic/screenshots/create-elastic-deployment-hot-warm-architecture.png)
...
4.  Click **Customize Deployment**. On this page, you can set your Elasticsearch cluster memory and storage.
    ...
    - **Hot-Warm Template Configuration**
      ...
      ![Configuring Fault tolerance](/fundamentals/static/images/elastic/screenshots/configure-hot-and-warm-elastic-8gb-ram.png)
...
5.  Add an index pattern for `cloudflare-*` and set it to migrate data off the hot zone after 7 days.
    ![Adding an index pattern in the index curation section of the Index Management page](/fundamentals/static/images/elastic/screenshots/index-curation-add-cloudflare.png)
...
![Details of the user created: username, password, Cloud ID and APM Server secret token](/fundamentals/static/images/elastic/screenshots/generated-user-details-elastic-deployment.png)
...
![Importing Elastic Kibana saved objects](/fundamentals/static/images/elastic/screenshots/kibana-saved-objects-import-dashboards.png)
...
3.  Configure the handler as `com.cloudflare.elastic.ElasticLambdaForwarder::handleRequest` and upload the function that we had previously saved to our S3 bucket.
    ![Configuring the handler and uploading the Lambda function](/fundamentals/static/images/elastic/screenshots/function-code-lambda.png)
...
4.  Configure the function. The Lambda function requires the following environment variables:
    ...
    - **elastic_password**: Use the randomly generated password that was created for you.
      ![Configuring the Elastic Lambda environment variables](/fundamentals/static/images/elastic/screenshots/environment-variables-lambda-cloudflare.png)
...
6.  Ensure your execution role is configured. In order for the function to be able to read logs from the S3 bucket, you may have to configure the execution role.
    ![Configuring the Elastic Lambda execution role](/fundamentals/static/images/elastic/screenshots/execution-role-aws.png)

7.  View the execution role and add an inline policy that enables the function to read from the bucket.
    ![Adding actions to Elastic AWS S3 bucket](/fundamentals/static/images/elastic/screenshots/s3-bucket-actions.png)
...
![Cloudflare dashboard showing Web Traffic Overview](/fundamentals/static/images/elastic/dashboards/elastic-snapshot.png)
...
![Cloudflare dashboard showing Threats](/fundamentals/static/images/elastic/dashboards/elastic-security.png)
...
![Cloudflare dashboard showing security WAF](/fundamentals/static/images/elastic/dashboards/elastic-security-waf.png)
...
![Cloudflare dashboard showing security Rate Limiting](/fundamentals/static/images/elastic/dashboards/elastic-security-rate-limiting.png)
...
![Cloudflare dashboard showing bot management](/fundamentals/static/images/elastic/dashboards/elastic-bot-management.png)
...
![Cloudflare dashboard showing Performance Overiew (requests, bandwidth, cache)](/fundamentals/static/images/elastic/dashboards/elastic-performance.png)
...
![Cloudflare dashboard showing Origin Request hostname, content type, request methods, and connection type](/fundamentals/static/images/elastic/dashboards/elastic-origin-requests-by-hostname-type.png)
...
![Cloudflare dashboard showing static vs. dynamic content](/fundamentals/static/images/elastic/dashboards/elastic-performance-static-vs-dynamic-content.png)
...
![Cloudflare dashboard showing Summary of Edge and Origin Response Status](/fundamentals/static/images/elastic/dashboards/elastic-reliability.png)
...
![AWS Lambda function monitoring screen](/fundamentals/static/images/elastic/screenshots/aws-lambda-monitoring.png)
...
![Visualizing AWS Lambda log streams](/fundamentals/static/images/elastic/screenshots/aws-lambda-log-streams.png)
...
![Visualizing AWS Lambda log stream messages](/fundamentals/static/images/elastic/screenshots/aws-lambda-log-streams-messages.png)
...
1.  From Elastic Cloud, launch the Kibana console.
    ![Lauching Elastic Cloud Kibana console](/fundamentals/static/images/elastic/screenshots/elastic-cloud-console.png)
...
![Kibana Dev Tools Console tab showing a table of indices with column headings](/fundamentals/static/images/elastic/screenshots/elastic-kibana-dev-tools-console-1.png)
...
![Example of a Lambda function health check in Elastic Kibana Dev Tools console](/fundamentals/static/images/elastic/screenshots/elastic-kibana-dev-tools-console-2.png)
