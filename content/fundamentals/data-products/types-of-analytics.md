...
These analytics are accessed by [logging into the Cloudflare dashboard](https://dash.cloudflare.com/login), selecting your account and domain, and going to the **Analytics** application. You can access aggregated traffic, security, and performance metrics for each domain proxied through Cloudflare. Data available on the **Analytics** application includes:
...
* [Firewall Analytics](/waf/analytics) - Highlights attack and mitigation metrics detected by the Cloudflare Firewall.
