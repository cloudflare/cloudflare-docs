...
| Pages Write                                                   | Grants access to create, Write and delete Cloudflare Pages projects.                                   |
...
| API Gateway Write                 | Grants write access to API Gateway zone resources.                       |
...
| Dynamic Redirect Write            | Grants write access to zone-level Single Redirects.                      |
...
| Logs Write                        | Grants read and write access to Logpull and Logpush.                     |
...
| Waiting Room Write               | Grants write access to Waiting Room.                                    |
...
| Zaraz Settings Write              | Grants write access to Zaraz zone level settings.                        |
...
| Transform Rules Write             | Grants write access to Transform Rules at zone level.                    |
