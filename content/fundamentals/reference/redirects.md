...
| [Page Rules](/rules/page-rules/how-to/url-forwarding/) (deprecated) | As an option of last resort, since [Page Rules are deprecated](/rules/reference/page-rules-migration/). |