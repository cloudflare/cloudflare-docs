...
To avoid {{<glossary-tooltip term_id="rate limiting">}}rate limiting{{</glossary-tooltip>}} or blocking these requests, you will need to [allow Cloudflare IPs](/fundamentals/setup/allow-cloudflare-ip-addresses/) at your origin server.
