...
Once you have [added your domain to Cloudflare](/fundamentals/setup/account-setup/add-site/) and [updated your nameservers](/dns/zone-setups/full-setup/), you also might want to set up a subdomain.
