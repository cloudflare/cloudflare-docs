...
Privacy Pass allows a user to bypass CAPTCHAs. To help mitigate malicious usage of this, we automatically disable Privacy Pass anytime a domain is placed into [I'm Under Attack!](/fundamentals/security/under-attack-mode/) mode. A few key points you need to keep in mind when enabling the **I'm Under Attack!** mode:
