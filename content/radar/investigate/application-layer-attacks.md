...
For more information refer to [Get layer 7 attacks by mitigation technique, over time](/api/operations/radar_get_Kt).
...
For more information refer to [Get a summary of layer 7 attacks](/api/operations/radar_get__layer7_summary).
...
For more information refer to [Get layer 7 top target locations](/api/operations/radar_get_Jt).
...
For more information refer to [Get layer 7 top attack pairs](/api/operations/radar_get_es).
