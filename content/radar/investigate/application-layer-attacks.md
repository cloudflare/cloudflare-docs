...
Mitigated traffic is any HTTP request from an end-user that has a terminating action applied by the Cloudflare platform. These include actions like `BLOCK` or `CHALLENGE` in interactive non-interactive based challenges.
{{</Aside>}}
