...
![Example of a rule execution scenario. Defines a ruleset with four rules, where the first rule executes a Managed Ruleset.](https://developers.cloudflare.com/ruleset-engine/static/rulesets-rules-example.png)
