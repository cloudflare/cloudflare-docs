...
{{<Aside type="warning">}}
You can only use the `regex_replace()` function in [rewrite expressions of Transform Rules](/rules/transform/) and [Dynamic Redirects](/rules/url-forwarding/dynamic-redirects/).
{{</Aside>}}
