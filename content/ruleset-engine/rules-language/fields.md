...
<table>
  ...
  <tbody style='vertical-align:top'>
    ...
    <tr id="field-cf-hostname-metadata">
        ...
        <td>
          <p>Returns the string representation of the per-hostname <a href="/ssl/ssl-for-saas/ssl/hostname-specific-behavior/custom-metadata/">custom metadata</a> JSON object set by SSL for SaaS customers.
          </p>
        </td>
    </tr>
