...
HTTP DCV validation is no longer allowed for wildcard certificates. For more details and next steps, refer to [DCV Validation](/ssl/reference/migration-guides/dcv-update/).
