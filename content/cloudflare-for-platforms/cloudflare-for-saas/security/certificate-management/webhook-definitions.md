...
Cloudflare sends this alert when certificates remain in a `pending_validation` status.
...
Cloudflare sends this alert when certificates remain in status of `pending_deletion`.
