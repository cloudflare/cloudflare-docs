...
| [HTTP/2 prioritization](https://blog.cloudflare.com/better-http-2-prioritization-for-a-faster-web/) | Yes | Yes* | This feature must be enabled on the customer zone. |
...
| [Origin Rules](/rules/origin-rules/) | Yes | Yes |
...
| [Rate Limiting](/waf/rate-limiting-rules/) | Yes | Yes |
| [Security Level](/support/firewall/settings/understanding-the-cloudflare-security-level/) | Yes | Yes |
| [Spectrum](/spectrum/) | No | No |
| [Transform rules](/rules/transform/) | Yes | Yes |
| [WAF custom rules](/waf/custom-rules/) | Yes | Yes |
