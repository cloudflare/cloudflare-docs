...
Workers AI has [embedded function calling](/workers-ai/function-calling/embedded-function-calling/) which allows you to execute function code alongside your inference calls. We have a package called [`@cloudflare/ai-utils`]() to help facilitate this, which we've open-sourced on [Github]().
