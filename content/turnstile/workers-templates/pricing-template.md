...
The script below serves a page where the Turnstile widget will be embedded.
...
<head>
   ...
   <script src="https://pricing.httpmachine.com/pricing.js"></script>
</head>
<body>
   <h3>Pricing:</h3>
...
The script below returns a client script which embeds the Turnstile widget.
