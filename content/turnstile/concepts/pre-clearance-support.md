...
However, if a verified bot goes through the Turnstile widget with Pre-Clearance mode, users can create a [WAF custom rule](/waf/custom-rules/) to exclude the verified bot. 
