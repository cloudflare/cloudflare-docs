...
Please note that as of now, free plan users do not have access to any paid features. However, if you're already using a paid feature without a Workers Paid plan, you can continue to use it until September 10, 2023. After this date, you'll need to upgrade to keep using any paid features.
