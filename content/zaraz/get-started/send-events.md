...
6.  In the **Firing Triggers** field, choose the relevant trigger or triggers you [previously created](/get-started/create-trigger). If you choose more than one trigger, the event will only be sent to the third-party tool when all the selected triggers are matched.
