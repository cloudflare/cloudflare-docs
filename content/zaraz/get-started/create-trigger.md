...
6. In **Variable name**, choose the variable you want as the trigger from the drop-down list. For example, choose _Track Name_ if you are [using `zaraz.track()` in your website](/zaraz/web-api/track/).
