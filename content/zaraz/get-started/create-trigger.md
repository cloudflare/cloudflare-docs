...
6. In **Variable name**, input the variable you want as the trigger. For example, use _Track Name_ if you are using [`zaraz.track()`](/zaraz/web-api/track/) in your website. If you want to use a variable you [created in the Variables section](/zaraz/get-started/create-variables/), select the `+` sign in the drop-down menu, scroll to **Variables** and choose your variable.
