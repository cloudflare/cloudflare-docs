...
- **Actions**: Counts how many times a [specific action](/zaraz/get-started/create-actions/) was activated. It includes pre-configured Pageview actions, and any other action you set in Zaraz.