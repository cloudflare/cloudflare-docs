...
4. In **Consent model text** fill in any legal information required in your country. Use HTML code to format your information as you would in any other HTML editor.
5. Under **Purposes**, select the **Add new Purpose** button. Give your new Purpose a name and a description. Purposes are the reasons for using third-party tools in your website.
