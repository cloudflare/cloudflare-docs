...
- **Actions**: Counts how many times a [specific action](/zaraz/get-started/create-actions/) was activated. It includes the pre-configured Pageview action, and any other action you set in Zaraz.