...
If you select multiple regions or choose **All Regions** (Enterprise only), you may increase traffic to your servers. Each region sends individual health checks from three data centers. Using **All Regions** sends individual health checks from all existing Cloudflare data centers.
