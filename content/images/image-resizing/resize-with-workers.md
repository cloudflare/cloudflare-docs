...
The following is a list of parameters supported by Cloudflare products. For Workers, use the parameter without `=x`. See the example Workers below for more context.
