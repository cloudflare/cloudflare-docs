...
To request a one-time upload URL, call the [`direct_upload` endpoint](https://developers.cloudflare.com/api/operations/cloudflare-images-create-authenticated-direct-upload-url-v2) in your back-end (or Worker script):
