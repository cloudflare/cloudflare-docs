...
* Use a Cloudflare Worker to access your images, and a Route using your domain to execute the worker. See [an example worker here](https://developers.cloudflare.com/images/cloudflare-images/serve-images/serve-private-images-using-signed-url-tokens/)
