...
Refer to the [API documentation](https://developers.cloudflare.com/api/operations/cloudflare-images-variants-properties) for more information regarding creating variants via API.
