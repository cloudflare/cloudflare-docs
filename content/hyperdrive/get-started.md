...
4. **A publicly accessible PostgreSQL (or PostgreSQL compatible) database**. Cloudflare recommends [Neon](https://neon.tech/) or [Supabase](https://supabase.com) if you do not have an existing database. Read the [Neon's documentation to create your first database](https://neon.tech/docs/introduction) or the [Supabase guide to get started](https://supabase.com/docs/guides/getting-started).
