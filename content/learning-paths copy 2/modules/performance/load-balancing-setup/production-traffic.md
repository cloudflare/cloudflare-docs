...
1. If you update your pools and monitors, [review the pool health again](/learning-paths/modules/performance/load-balancing-setup/check-pool-health/) to make sure everything is working as expected.
