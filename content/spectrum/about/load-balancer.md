...
![Manage monitors dialog with TCP health check running on port 2408 and a 30 second refresh rate](https://developers.cloudflare.com/spectrum/img/load-balancing/spectrum-tcp-check.png)
