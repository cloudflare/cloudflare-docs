...
To create a Spectrum application using a Load Balancer, you will need to generate a Load Balancer from the dashboard or using the API. Follow the [Create a load balancer](/load-balancing/how-to/create-load-balancer/) workflow for help.
