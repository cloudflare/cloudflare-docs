...
| [Rules](/rules/) | Page Rules (deprecated), Bulk Redirects, Transform Rules, Origin Rules | Make adjustments to requests and responses, configure Cloudflare settings, and trigger specific actions for matching requests. |
