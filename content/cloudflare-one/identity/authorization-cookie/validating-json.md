...
You can also manually rotate the key using the [API](https://developers.cloudflare.com/api/operations/access-keys-configuration-rotate-access-keys). This can be done for testing or security purposes.
