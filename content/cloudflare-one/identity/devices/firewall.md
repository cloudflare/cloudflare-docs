...
macOS has two firewalls. The application based firewall and the port based firewall. The Zero Trust client will report a firewall is enabled if either firewall is running.
