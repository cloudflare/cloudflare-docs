...
- Client Secret
- Customer ID
- REST API URL (domain + domain suffix) 

To obtain these values:

1. Open your Uptycs console.
1. Navigate to **Account Settings** > **API Key**.
1. Generate and download your `.json` file. This file will contain your **Client key**, **Client Secret**, **Customer ID**, and **REST API URL (domain + domain suffix** .
