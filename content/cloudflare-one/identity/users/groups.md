...
![Rule configuration example for an Access Group that demonstrates the use of the Include and Require fields.](/cloudflare-one/static/identity/users/access-groups.png)

Once the group is set up, you can use it to configure rules within your applications as follows:

![Using the previously created Access Group to configure a rule.](/cloudflare-one/static/identity/users/access-groups-setup.png)
