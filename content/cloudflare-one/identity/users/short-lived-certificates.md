...
2. In the dropdown, choose the application that represents the resource you secured in Step 1.
    ...
    ![New Cert](https://developers.cloudflare.com/cloudflare-one/static/documentation/applications/non-http/slc-dropdown.png)
...
4. Save the key or keep it somewhere convenient for configuring your server.
    ...
    ![Pub Key Cert](https://developers.cloudflare.com/cloudflare-one/static/documentation/applications/non-http/slc-key.png)
