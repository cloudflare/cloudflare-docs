...
1. In the [Zero Trust dashboard](https://one.dash.cloudflare.com), navigate to **Settings** > **Authentication**.
...
2. In the [Zero Trust dashboard](https://one.dash.cloudflare.com), navigate to **My Team** > **Users**.
