...
1.  Log in to the Google Cloud Platform [console](https://console.cloud.google.com/). This is separate from your Google Workspace console.
    ...
    ![GCP Console](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/gcp-home.png)
...
2.  Click **Create Project** to create a new project. Name the project and click **Create**. You should now see a Dashboard for your project.
    ...
    ![Post Create](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/post-create.png)
...
5.  The API Library will load. Search for `admin` in the search bar.
    ...
    ![API Library](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/api-library.png)

6.  Select `Admin SDK API` by Google.

7.  Click **Enable** on the Admin SDK API page. The Admin SDK will be added to your project.

    ![Admin SDK](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/post-enable.png)
...
8.  Return to the APIs & Services page. Click **Credentials** in the navigation bar. You will see a warning that you need to configure a consent screen. Click **Configure Consent Screen**.
    ...
    ![Configure Consent Screen](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/configure-consent-screen.png)
...
9.  Cloudflare Access will gather information about users in your Google Workspace account, but not other accounts. Toggle `Internal` to limit this to members in your account.
    ...
    ![Internal Users](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/consent-internal.png)
...
![Internal Users](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/consent-screen-contact.png)

You will not need to configure scopes in this screen and can leave these fields blank.

![Consent Screen Scope](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/consent-screen-scope.png)

The summary page will load and you can save and exit.

![Consent Screen Summary](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/consent-screen-summary.png)

11. Return to the **Credentials** page. Click **+ Create Credentials**

    ![Create Credentials](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/create-credentials.png)

12. Select **OAuth client ID**.

    ![Select OAuth](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/select-oauth.png)
...
![Input Team Domain](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/input-auth-domain.png)
...
16. Google will present the OAuth Client ID and Secret values. The secret field functions like a password and should be kept securely and not shared. For the purposes of this tutorial, the secret field is kept visible. Copy both values.
    ...
    ![Secret Field](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/secret-field.png)

    The Client ID will now appear in the `APIs & Services` page.

    ![Client ID Visible](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/client-id-visible.png)
...
21. To complete setup, you must scroll below and visit the link generated. If you are not the Google Workspace administrator, share the link with the administrator.
  ...
  ![Enable trust internal apps](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/trust-internal-apps.png)
...
22. The generated link will prompt you to login to your Google account and to authorize Cloudflare Access to view group information.
    ...
    ![Authorize Groups](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/authorize-groups.png)

    A success page will then load from Cloudflare Access.

    ![Group Success](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/group-success.png)
...
23. You can now return to the list of identity providers in the **Authentication** page of the Cloudflare Zero Trust dashboard. Select Google Workspace and click **Test**.
    ...
    ![Connection Works](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/gsuite/connection-works.png)
