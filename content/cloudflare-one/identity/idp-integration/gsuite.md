...
6. Return to the **APIs & Services** page and go to **Credentials**.
   ...
   ![Location of credential settings at the top of the Google Cloud Platform dashboard.](/cloudflare-one/static/identity/google/click-configure-consent.png)
...
9. Return to the **Credentials** page and select **+ Create Credentials** > **OAuth client ID**.
   ...
   ![Location of OAuth client ID settings on Google Cloud Platform credentials page.](/cloudflare-one/static/identity/google/create-oauth.png)
...
14. On your [Google Admin console](https://admin.google.com), go to **Security** > **Access and data control** > **API controls**.  
    ![Location of Trust internal apps setting in the Google Admin dashboard](/cloudflare-one/static/identity/gsuite/trust-internal-apps.png)
