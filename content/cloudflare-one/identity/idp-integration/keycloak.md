...
1.  In Keycloak, select **Clients** in the navigation bar and create a new client.
    ...
    ![SAML Client](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/keycloak/create-client.png)
...
1.  Under **Client ID**, enter your [team domain](/cloudflare-one/glossary/#team-domain) followed by this callback at the end of the path: `/cdn-cgi/access/callback`. For example:
    ...
    ![SAML Client](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/keycloak/configure-client.png)
...
1.  Set the built-in protocol mapper for the `email` property.
    ...
    ![Mapper](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/keycloak/protocol-mapper.png)
