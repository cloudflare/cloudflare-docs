...
![Preview the SAML assertion from the Okta dashboard](/cloudflare-one/static/identity/saml-assertion.png)
![Determine the email attribute name from the SAML assertion](/cloudflare-one/static/identity/saml-attributes.png)
...
![Configure Okta to send SAML attributes](/cloudflare-one/static/identity/attribute-statements.png)

How to receive these SAML attributes in Cloudflare:

![Configure Cloudflare to receive SAML attributes](/cloudflare-one/static/identity/attributes-cloudflare.png)
