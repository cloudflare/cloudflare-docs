...
4. Enter an app name and select **Next**.
   ...
   ![Entering your Zero Trust callback URL into Okta](/cloudflare-one/static/identity/okta-saml/okta-saml-1.png)
...
![Configuring attribute statements in Okta](/cloudflare-one/static/identity/okta-saml/okta-saml-2.png)

8. Select **Next**.

9. Select **I’m an Okta customer adding an internal app** and check **This is an internal app that we have created**.

![Configuring feedback options in Okta](/cloudflare-one/static/identity/okta-saml/okta-saml-3.png)
...
![Assigning individuals and groups to Okta application](/cloudflare-one/static/identity/okta-saml/okta-saml-4.png)
...
![Retrieving SAML provider information in Okta](/cloudflare-one/static/identity/okta-saml/okta-saml-5.png)
...
![Adding optional SAML attributes in Zero Trust](/cloudflare-one/static/identity/okta-saml/okta-saml-6.png)
