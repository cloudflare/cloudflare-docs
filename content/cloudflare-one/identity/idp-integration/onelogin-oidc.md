...
1.  Select **Apps > Custom Connectors**.
    ...
    ![OneLogin OIDC](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/onelogin/onelogin-oidc-1.png)
...
1.  Name the connector. The _connector name_ card displays. Our example uses `access-oidc` for the connector name.
    ...
    ![OneLogin OIDC Application Basic Configuration page](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/onelogin/onelogin-oidc-3.png)
...
1.  Select **More Actions > Add App to Connector**.
    ...
    ![OneLogin OIDC Application Basic Configuration page More Actions menu](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/onelogin/onelogin-oidc-4.png)
...
1.  Select the **Access** tab.
    ...
    ![OneLogin OIDC Add Application Access page](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/onelogin/onelogin-oidc-6.png)

1.  Add the **Roles** that can access this application.

1.  Select the **SSO** tab.

    ![OneLogin OIDC Add Application SSO page](https://developers.cloudflare.com/cloudflare-one/static/documentation/identity/onelogin/onelogin-oidc-7.png)
