...
7. Under **Redirect URI**, select the _Web_ platform and enter the following URL:
   ...
   ![Registering an application in Azure](/cloudflare-one/static/identity/azure/name-app.png)
...
10. Select the app you just created. Copy the **Application (client) ID** and **Directory (tenant) ID**.
    ...
    ![Viewing the Application ID and Directory ID in Azure](/cloudflare-one/static/identity/azure/azure-values.png)
...
13. After the client secret is created, copy its **Value** field. Store the client secret in a safe place, as it can only be viewed immediately after creation.
    ...
    ![Location of client secret in Azure](/cloudflare-one/static/identity/azure/client-cert-value.png)
...
6. Select **Grant admin consent**.
   ...
   ![Configured permissions list in Azure](/cloudflare-one/static/identity/azure/configured-perms.png)
...
![Azure group names displayed in the Access policy builder](/cloudflare-one/static/identity/azure/azure-scim-groups.png)
...
2. On your Azure dashboard, note the `Object Id` for the Azure group. In the example below, the group named Admins has an ID of `61503835-b6fe-4630-af88-de551dd59a2`.
   ...
   ![Viewing the Azure group ID on the Azure dashboard](/cloudflare-one/static/identity/azure/object-id.png)
...
4. In the **Value** field, enter the `Object Id` for the Azure group.
   ...
   ![Entering an Azure group ID in Zero Trust](/cloudflare-one/static/identity/azure/configure-group-n.png)
