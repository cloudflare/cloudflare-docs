...
1.  Click **Next**. The **Configure Identifiers** step displays.
    ...
    ![Add relying party trust wizard with callback URL pasted into open form field](/cloudflare-one/static/identity/adfs/adfs-7.png)
...
1.  In the **Certificates** card, right-click on the entry under **Token-signing**, and select **View certificate**. The **Certificates** window displays.
    ...
    ![Certificates window with token-signing certificate selected](/cloudflare-one/static/identity/adfs/adfs-16.png)
