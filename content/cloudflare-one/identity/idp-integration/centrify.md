...
1.  Enter an **Application ID**.
    ...
    ![Centrify Settings with Application ID added](/cloudflare-one/static/identity/centrify/centrify-4.png)
...
1.  Under **Authorized Redirect URIs** enter your [team domain](/cloudflare-one/glossary/#team-domain) followed by this callback at the end of the path: `/cdn-cgi/access/callback`. For example:
    ...
    ![Centrify Trust Identity Provider Configuration with team domain and callback](/cloudflare-one/static/identity/centrify/centrify-6.png)
