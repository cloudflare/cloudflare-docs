...
You can generate a proxy endpoint in Zero Trust or through the Cloudflare API.
...
1. In the [Zero Trust dashboard](https://one.dash.cloudflare.com/), navigate to **Gateway** > **Proxy Endpoints**.
...
1. In the [Zero Trust dashboard](https://one.dash.cloudflare.com/), create an [HTTP policy](/cloudflare-one/policies/filtering/http-policies/) for testing purposes. For example:
