...
This page lists the available debug logs for desktop and mobile clients.

## Windows/macOS/Linux

The `warp-debugging-info.zip` archive generated by `warp-diag` contains the following information:
...
| **Routing table**  | equivalent to `netstat.txt`|
