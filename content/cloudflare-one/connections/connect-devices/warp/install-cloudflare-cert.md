...
![MacOS popup window for adding certificates](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/keychain-popup.png)
...
![Viewing certificate in MacOS Keychain Access application](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/listed-in-keych.png)

4. Double-click the certificate.

5. Click **Trust**.

![MacOS window for certificate configuration](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/cert-click-on-trust.png)

6. From the **When using this certificate** drop-down menu, select **Always Trust**.

![MacOS window for configuring certificate trust settings](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/cert-select-always-trust.png)
...
![iOS popup message asking for permission to download certificate](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/ios_cert_download.PNG)
...
![iOS screen for viewing certificate profile](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/ios_cert_profile.PNG)
...
![iOS message confirming certificate profile installation](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/ios_profile_installed.PNG)
...
![iOS screen for configuring certificate trust settings](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/ios_cert_trust1.PNG)
...
![iOS popup message asking to confirm trust setting](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/ios_cert_trust2.PNG)
...
![Window for Cloudflare certificate](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/windows_install_cert.png)
...
![Window for selecting certificate store location](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/windows_cert_location.png)

10. Click **Finish**.

![Window for finishing certificate installation](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/windows_cert_install_finished.png)
...
![Android **Settings** screen](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/android_security_settings.png)
...
|                                                                                                            |                                                                                                          |
| ---------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| ![Android **Security** settings screen](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/android_advanced_encrypt.png) | ![Android **Security** screen after expanding **Advanced** menu](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/android_advanced_encrypt2.png) |
...
|                                                                                                    |                                                                                          |
| -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| ![Android **Encryption & credentials** screen](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/android_install_cert.png) | ![Android **Install a certificate*** screen](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/android_ca_cert.png) |

{{</table-wrap>}}

5. Tap **Install Anyway**.

![Android screen asking to confirm certificate installation](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/android_install_anyway.png)

6. Verify your identity through the fingerprint, or by inserting the pin code.

7. Select the certificate you want to install.

![Selecting the Cloudflare certificate in the Android Google Drive app](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/android_choose_certificate.png)
...
![**Settings** cog in ChromeOS](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/chromeOS1_cert.png)

3. Navigate to **Apps** > **Google Play Store**.

![**Google Play Store** app in ChromeOS settings](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/chromeOS2_cert.png)

4. Click **Manage Android preferences**.

![**Manage Android preferences** in ChromeOS settings](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/chromeOS3_cert.png)
...
|                                                                                                   |                                                                                           |                                                                                                    |
| ------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| ![ChromeOS **Network & Internet** screen](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/chromeOS4_cert.png) | ![ChromeOS **Security & location** screen](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/chromeOS5_cert.png) | ![ChromeOS **Credentials** screen](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/chromeOS6_cert.png) |

{{</table-wrap>}}

6. In the file open dialog, select the `Cloudflare_CA.crt` file downloaded in step #1 and click **Open**.

![ChromeOS dialogue for selecting a certificate file](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/chromeOS7_cert.png)

7. Enter anything you want for the certificate name and click **OK**.

![ChromeOS dialogue for naming the certificate](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/chromeOS8_cert.png)
