...
- Create a [Split Tunnel rule](/cloudflare-one/connections/connect-devices/warp/exclude-traffic/split-tunnels.md) that excludes `75.75.75.75/32` and `75.75.75.76/32` from WARP.
