...
![Network diagram](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/private-ips-diagram.png)
...
1.  Ensure the Proxy is enabled and both TCP and UDP are selected.
    ...
    ![Enable UDP](https://developers.cloudflare.com/cloudflare-one/static/secure-origin-connections/warp-to-tunnel-internal-dns/enable-udp.png)
...
1.  Remain in **Network Settings** and scroll further down to **Local Domain Fallback**.
    ...
    ![Manage Local Domains](https://developers.cloudflare.com/cloudflare-one/static/secure-origin-connections/warp-to-tunnel-internal-dns/manage-local-domain-fallback.png)
...
![Create Local Domains](https://developers.cloudflare.com/cloudflare-one/static/secure-origin-connections/warp-to-tunnel-internal-dns/create-local-domain-fallback.png)
...
![Update Cloudflared](https://developers.cloudflare.com/cloudflare-one/static/secure-origin-connections/warp-to-tunnel-internal-dns/update-cfd.png)
