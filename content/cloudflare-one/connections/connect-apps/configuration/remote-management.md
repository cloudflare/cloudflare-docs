...
![Modify cloudflared service in the Registry Editor](https://developers.cloudflare.com/cloudflare-one/static/documentation/connections/connect-apps/remote-management-windows.png)
