...
6.  **Enable the Proxy setting in the Teams Dashboard.** Navigate to **Settings** > **Network** and enable the **Proxy** setting. This will allow you to create [Network policies](/cloudflare-one/policies/filtering/network-policies/).

7.  **Enable TLS decryption in the Teams Dashboard.** In the **Settings** > **Network** page, enable the **TLS decryption** switch. This will allow you to start routing your HTTP traffic to Gateway. You can also choose to enable the [FIPS compliance](/cloudflare-one/connections/connect-devices/warp/warp-settings/#fips-compliance) setting.
