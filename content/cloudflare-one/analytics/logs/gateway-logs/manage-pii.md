...
To add or remove the Cloudflare Zero Trust PII role for a user, refer to our [Account setup](/fundamentals/get-started/setup/account-setup/manage-account-members/) documentation.
