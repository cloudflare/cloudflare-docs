...
| **Query Category Name**   | The content category of the DNS query                                                                                                      |
| **Policy Name**           | The policy name at time of matched policy if there is one                                                                                  |
| **Query Type Name**       | The name of the type of DNS query                                                                                                          |
| **Matched Category Name** | The category of the DNS resolution                                                                                                         |
| **Device Name**           | The name of the device of the user who made the DNS request                                                                                |
| **Resolved IPs**          | The resolved IPs in the response (if any)                                                                                                  |
