...
| Topic                                                                       | Description                                                                                                                                                 |
| --------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [🏗️ **Documentation on setting up Teams**](/cloudflare-one/setup/)          | This section covers how to set up the [Teams dashboard](https://one.dash.cloudflare.com/).                                                                  |
...
| [📈 **Documentation on Analytics**](/cloudflare-one/insights/)             | This section explains our analytics pages on the Teams dash, as well as our logs pages.                                                                     |
