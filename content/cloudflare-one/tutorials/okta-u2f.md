...
![Test MFA](https://developers.cloudflare.com/cloudflare-one/static/zero-trust-security/require-yubikey/idp-list.png)
...
![Test MFA](https://developers.cloudflare.com/cloudflare-one/static/zero-trust-security/require-yubikey/with-mfa.png)
...
![Test MFA](https://developers.cloudflare.com/cloudflare-one/static/zero-trust-security/require-yubikey/with-hwk.png)
...
![Test MFA](https://developers.cloudflare.com/cloudflare-one/static/zero-trust-security/require-yubikey/app-list.png)

Click **Edit** to edit the existing `Allow` rule.

![Edit Rule](https://developers.cloudflare.com/cloudflare-one/static/zero-trust-security/require-yubikey/edit-app.png)
...
![Require Rule](https://developers.cloudflare.com/cloudflare-one/static/zero-trust-security/require-yubikey/require-hwk.png)
...
![Only Okta](https://developers.cloudflare.com/cloudflare-one/static/zero-trust-security/require-yubikey/only-okta.png)
...
![Blocked](https://developers.cloudflare.com/cloudflare-one/static/zero-trust-security/require-yubikey/blocked-user.png)
