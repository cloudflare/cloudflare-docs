...
![Add Location](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/secure-dns-network/add-location.png)
...
![Add Policy](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/secure-dns-network/create-dns-policy.png)
...
![Block Threats](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/secure-dns-network/block-threats.png)
...
![Include Location](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/secure-dns-network/include-location.png)

Finally, choose `Block` as the action and create the policy.

![Block Action](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/secure-dns-network/block-action.png)

The rule will appear in your DNS policies list.

![Rule Listed](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/secure-dns-network/rule-listed.png)
...
![Expand Location](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/secure-dns-network/expand-location.png)
...
![Expand Location](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/secure-dns-network/router-instructions.png)

## Review events

Once configured, you can review DNS queries made from your network in the **Analytics** > **Gateway** page.

![Gateway Analytics](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/secure-dns-network/gateway-analytics.png)
