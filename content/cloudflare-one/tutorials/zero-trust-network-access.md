...
1. Define [device enrollment rules](/cloudflare-one/connections/connect-devices/warp/deployment/device-enrollment/) under **Settings** > **Devices** > **Device enrollment permissions** > **Manage**.
...
2. Log in to [Zero Trust](https://one.dash.cloudflare.com/), select your account, and go to **Gateway** > **Firewall Policies**.
...
5. [Verify](/cloudflare-one/connections/connect-devices/warp/configure-warp/route-traffic/split-tunnels/) that you do not have the desired target private IP range in your Split Tunnel configuration.
