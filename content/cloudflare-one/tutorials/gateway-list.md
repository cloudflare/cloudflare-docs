...
1.  To begin, navigate to the [Zero Trust Dashboard](https://dash.teams.cloudflare.com) and go to **My Team > Lists** page.
    ...
    ![List Create](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/gateway-list/lists.png)
...
1.  Name the list and choose its type. A list can only include objects of the same type. You can add an optional comment. Next, click **select a file** and then **Create**.
    ...
    ![List Add](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/gateway-list/list-create.png)

The list will begin to upload and confirm if successful.

![List Upload](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/gateway-list/list-upload.png)
...
![List Upload](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/gateway-list/edit-list.png)
...
![List Upload](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/gateway-list/build-rule.png)

You can now modify the rule precedence of the list-based rule in the UI by dragging and dropping the row.

![List Upload](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/gateway-list/list-precedence.png)
