...
![Add Policy](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/block-uploads/add-http-policy.png)

Name the policy and provide an optional description.

![Add Policy](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/block-uploads/name-policy.png)
...
![Select Drive](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/block-uploads/select-google-drive.png)
...
![Block Drive](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/block-uploads/upload-mime-type.png)

Scroll to **Action** and choose "Block". Click **Create rule** to save the rule.

![Block Drive](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/block-uploads/block-action.png)
...
![Allow Drive](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/block-uploads/allow-users.png)

Select `Allow` for the action and save the rule.

![Allow Drive](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/block-uploads/allow-action.png)

Next, modify the existing rule order.

![Rule List](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/block-uploads/allow-last.png)

Drag the `Allow` rule higher than the `Block` rule.

![Rule List](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/block-uploads/allow-first.png)
...
![Block Action](https://developers.cloudflare.com/cloudflare-one/static/secure-web-gateway/block-uploads/block-result.png)
