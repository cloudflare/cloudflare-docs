...
| **Device Name**        | Display name of the device as returned by the operating system to the WARP Client. Typically this is the hostname of a device. Not all devices will have a device name. Device names are not guaranteed to be unique.                                                                                                                                                                                  |
