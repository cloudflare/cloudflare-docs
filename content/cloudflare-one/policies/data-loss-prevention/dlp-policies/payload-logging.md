...
- You can define sensitive data with [Exact Data Match (EDM)](/api/operations/zero-trust-gateway-rules-create-zero-trust-gateway-rule). All EDM-matched alphanumeric characters in the log will be redacted. For example, `123-45-6789` will become `XXX-XX-XXXX`.
