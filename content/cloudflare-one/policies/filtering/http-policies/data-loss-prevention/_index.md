...
By default, Gateway logs all HTTP requests in your [Activity log](/cloudflare-one/analytics/logs/gateway-logs/#http-logs). To view logs specific to DLP:
...
4. Select **Filter**.
5. Choose an item under one of the following dropdown menus:
