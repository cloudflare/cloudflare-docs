...
Gateway checks identity when a user logs in or re-authenticates. To check your users' identities at regular intervals, you can [enforce a WARP client session duration](/cloudflare-one/policies/filtering/enforce-sessions/).
