...
- **External Evaluation** - allows or denies access based on custom logic in an external API. For more information, refer to the [External Evaluation rules](c/cloudflare-one/policies/access/external-evaluation/) page.
