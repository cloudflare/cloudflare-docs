...
3. Name the policy and specify the [Destination IP](/cloudflare-one/policies/gateway/network-policies/#destination-ip) for your origin server. This can be done using a Public or Private IP. Please refer to [Configuring a Private Network](https://developers.cloudflare.com/cloudflare-one/connections/connect-networks/private-net/connect-private-networks/) to use a Private IP.
