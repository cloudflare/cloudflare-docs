...
### Require a specfic operating system (OS)

Perform a [file check](/cloudflare-one/identity/devices/warp-client-checks/file-check/) for system files to ensure users are running a specific operating system. For example, you can configure file checks to allow users running either macOS or Linux distributions.
...
Perform an [OS version check](/cloudflare-one/identity/devices/warp-client-checks/os-version/) to ensure users are running a minimum version.
