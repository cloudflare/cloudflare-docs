...
Remote browsing is invisible to the user who continues to use their browser normally without changing their preferred browser and habits. Every open tab and window is automatically isolated. The browsing session is cleared when the user closes the isolated browser, thus removing any malicious cookies or cached files.
