...
Cloudflare’s API-driven Cloud Access Security Broker (CASB) scans SaaS applications for misconfigurations, unauthorized user activity, {{<glossary-tooltip term_id="shadow IT">}}shadow IT{{</glossary-tooltip>}}, and other data security issues that can occur after a user has successfully logged in.
