...
![The process for adding a Gateway DNS policy to block AAAA records for example.com.](/cloudflare-one/static/documentation/faq/gateway-add-aaaa-dns-policy.png)
