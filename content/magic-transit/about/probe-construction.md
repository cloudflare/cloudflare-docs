...
![Wireshark example for tunnel health checks with ICMP reply packet](https://developers.cloudflare.com/magic-transit/static/tunnel-health-check-packets.png)
