...
![Ingress traffic from client machine to Magic Transit to origin router and flow of egress traffic](https://developers.cloudflare.com/magic-transit/static/mt-gre-tunnel-flow.png)
...
![Flow of packet encapsulation at Cloudflare's edge to user's tunnel endpoint router](https://developers.cloudflare.com/magic-transit/static/magic-transit-anycast-1.png)
...
![Multiple servers in data center preparing packets to send through GRE tunnel](https://developers.cloudflare.com/magic-transit/static/magic-transit-anycast-2.png)
