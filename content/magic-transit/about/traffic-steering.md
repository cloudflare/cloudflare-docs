...
![Three tunnel routes with Tunnels 1 and 2 with the same top priority](https://developers.cloudflare.com/magic-transit/static/mt-traffic-steering-ecmp-baseline.png)
...
![Traffic flow to Tunnels 1 and 2 using ECMP](https://developers.cloudflare.com/magic-transit/static/mt-traffic-steering-ecmp-normal.png)
...
![All traffic flowing to Tunnel 1 because of unhealthy Tunnel 2](https://developers.cloudflare.com/magic-transit/static/mt-traffic-steering-ecmp-failure-1.png)
...
![All traffic flowing to Tunnel 3 because of unhealthy Tunnels 1 and 2](https://developers.cloudflare.com/magic-transit/static/mt-traffic-steering-ecmp-failure-2.png)
