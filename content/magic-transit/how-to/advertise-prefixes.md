...
![Ingress traffic moving through Cloudflare network using BGP to control prefix status](https://developers.cloudflare.com/magic-transit/static/bgp-control-diagram.png)
