...
All other customers can set up subdomain-specific [Configuration Rules](/rules/configuration-rules/) or [Page Rules](https://support.cloudflare.com/hc/articles/218411427) to alter Cloudflare settings.
