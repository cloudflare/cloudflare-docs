...
2.  On **Overview**, copy the information from **Replace with Cloudflare's nameservers**.
    ...
    ![Find nameserver names on the Overview page of your domain](https://developers.cloudflare.com/dns/static/nameserver-names.png)
...
4.  Create new authoritative nameservers. If their names are not [copied exactly](#get-nameserver-names), your DNS will not resolve correctly. For additional details, refer to [provider-specific instructions](#provider-specific-instructions).
