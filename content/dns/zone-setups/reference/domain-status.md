...
If domains remain in the **Pending Nameserver Update** or **Moved** status for too long, Cloudflare automatically [removes them](https://support.cloudflare.com/hc/en-us/articles/221327488) from your account and the Cloudflare network.
