...
If your domain has [HTTP/2 or HTTP/3 enabled](/network/understanding-cloudflare-http2-and-http3-support/), Cloudflare automatically generates HTTPS records on the fly, to advertise to clients how they should connect to your Internet property.
