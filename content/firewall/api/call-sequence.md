...
![Recommended flow for calling the Cloudflare Filters API and Firewall Rules API when creating or editing rules](https://developers.cloudflare.com/firewall/static/recommended-flow.png)
...
![Simple flow for invoking the Firewall Rules API to create both a filter and a rule in a single call](https://developers.cloudflare.com/firewall/static/simple-flow.png)
