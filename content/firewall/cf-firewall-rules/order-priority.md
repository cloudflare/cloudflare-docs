...
![Flow chart of request evaluation at Cloudflare for security products that are not powered by the Ruleset Engine](https://developers.cloudflare.com/firewall/static/firewall-rules-order-and-priority-1.png)
...
![Animation of a firewall rule being moved into a new position in the rules list to reorder it](https://developers.cloudflare.com/firewall/static/firewall-rules-order-and-priority-2.gif)
...
2. In the **Edit firewall rule** panel, enter a positive integer value in **Priority**.
    ...
    ![Editing a firewall rule in the dashboard to define its Priority value](https://developers.cloudflare.com/firewall/static/firewall-rules-order-and-priority-4.png)
...
![When using priority order, the Firewall rules tab displays the priority of each rule (if any) in the first column of the rules list](https://developers.cloudflare.com/firewall/static/firewall-rules-order-and-priority-5.png)
