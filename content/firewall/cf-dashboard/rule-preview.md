...
![The Test Rule button next to the Action drop-down list allows you to check the traffic that would be affected by the current firewall rule](https://developers.cloudflare.com/firewall/static/firewall-rules-preview-1.png)
...
![Example chart of a rule preview operation, stating that about 8% of the zone requests would be blocked by the current rule](https://developers.cloudflare.com/firewall/static/cf-firewall-rules-preview-rule-plot-chart.png)
