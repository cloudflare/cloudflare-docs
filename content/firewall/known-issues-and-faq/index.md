...
![The Expression Editor displays rule values with special characters escaped using a backslash character](https://developers.cloudflare.com/firewall/static/cf-firewall-rules-escaping.png)
