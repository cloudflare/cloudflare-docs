...
This example blocks requests from IP addresses that score greater than 0. This is equivalent to setting the Security Level in **Security** > **Settings** to _High_. For more, refer to [Understanding the Cloudflare Security Level](https://support.cloudflare.com/hc/articles/200170056).
