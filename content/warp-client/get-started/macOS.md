...
1.  [Download **Cloudflare\_WARP.zip**](https://www.cloudflarewarp.com/Cloudflare_WARP.zip).
2.  Navigate to the downloads folder.
3.  Open **Cloudflare\_WARP.zip**.
4.  Open the **Cloudflare\_WARP.pkg** file that was extracted.
