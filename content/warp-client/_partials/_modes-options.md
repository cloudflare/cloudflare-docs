...
For the **Advanced** options, refer to [Exclude or include network traffic with WARP](/cloudflare-one/connections/connect-devices/warp/configure-warp/exclude-traffic/) for more information.