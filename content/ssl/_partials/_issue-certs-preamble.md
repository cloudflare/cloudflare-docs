...
Once issued, certificates are valid for 1 year. Renewals depend on your chosen method for [Domain Control Validation](/ssl/ssl-for-saas/common-tasks/certificate-validation-methods/).
