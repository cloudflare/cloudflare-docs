...
- When you have [Universal SSL](/ssl/edge-certificates/universal-ssl/) enabled and enable [AMP Real URL](/speed/amp-real-ulr/) or [SXG Signed Exchanges](/speed/signed-exchanges/).
