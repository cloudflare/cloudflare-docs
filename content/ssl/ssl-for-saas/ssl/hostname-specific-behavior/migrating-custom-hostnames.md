...
If you would like to migrate the custom hostname without end customers changing the DNS target, use [apex proxying](/ssl/ssl-for-saas/ssl/common-tasks/hostname-verification/#apex-verification).
