...
To set an SNI rewrite in the dashboard, choose your preferred option from **Origin SNI value** when [creating a custom hostname](/ssl/ssl-for-saas/ssl/common-tasks/issuing-certificates/).
