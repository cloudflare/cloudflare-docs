...
Before you can use WAF for SaaS, you need to create a custom hostname. Review [Get started with SSL for SaaS](https://developers.cloudflare.com/ssl/ssl-for-saas/getting-started/) if you have not already done so.
...
4. Plan your [custom metadata]((https://developers.cloudflare.com/ssl/ssl-for-saas/hostname-specific-behavior/custom-metadata/)). It is fully customizable. In the example below, we have chosen the tag “security_level” to which we expect to assign three values (low, medium, and high).
