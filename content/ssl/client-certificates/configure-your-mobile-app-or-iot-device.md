...
## Step 2 — create cloudflare@latest-issued certificates

Before you can use API Shield to protect your API or web application, you must create cloudflare@latest-issued client certificates.
