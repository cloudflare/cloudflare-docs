...
The following list presents a reference for three different security levels and how Cloudflare recommends that you set them up if you need to [restrict cipher suites](/ssl/edge-certificates/additional-options/cipher-suites/customize-cipher-suites/) used between Cloudflare and clients that access your website or application.

| Recommended security level | Description | Cipher suites [to specify](/ssl/edge-certificates/additional-options/cipher-suites/customize-cipher-suites/) | Other settings |
| --- | --- | --- | --- |
