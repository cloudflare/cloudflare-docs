...
meta:
  ...
  description: See how to troubleshoot issues when using Cloudflare Universal SSL certificate. 
---
...
- Send a PATCH request to the [validation endpoint](https://developers.cloudflare.com/api/operations/ssl-verification-edit-ssl-certificate-pack-validation-method) using the same DCV method (API only).
