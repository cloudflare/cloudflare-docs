...
- [Purchase Advanced Certificate Manager](https://dash.cloudflare.com/?to=/:account/:zone/ssl-tls/edge-certificates&utm_source=email&utm_medium=support&utm_content=community_1&utm_campaign=pgg122ap-ss-advanced-certificate-helper-support), to cover more than one level of subdomain, remove Cloudflare branding from the Universal certificate, or adjust the shortest certificate lifespan.
