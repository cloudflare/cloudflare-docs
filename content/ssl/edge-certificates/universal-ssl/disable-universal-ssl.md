...
{{<Aside type="note">}}Even with Universal SSL disabled, some features such as [AMP Real URL](/speed/amp-real-ulr/) and [Signed Exchanges](/speed/signed-exchanges/) will still provision certificates for your domain.{{</Aside>}}
