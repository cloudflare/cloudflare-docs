...
![With an encryption mode of Off, your application does not encrypt traffic between the visitor and Cloudflare or between Cloudflare and your server.](https://developers.cloudflare.com/ssl/static/ssl-encryption-mode-off.png)
...
![With an encryption mode of Full, your application encrypts traffic going to and coming from Cloudflare but does not validate your origin certificate.](https://developers.cloudflare.com/ssl/static/ssl-encryption-mode-full.png)
...
![With an encryption mode of Full (strict), your application encrypts traffic going to and coming from Cloudflare.](https://developers.cloudflare.com/ssl/static/ssl-encryption-mode-full-strict.png)
