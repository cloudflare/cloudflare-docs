...
- The value sent in the `"method"` field under the SSL object. Your integration should either use [`"http"`](/cloudflare-for-platforms//cloudflare-for-saas/domain-support/hostname-verification/#http) (only available for [non-wildcard hostnames](#non-wildcard-hostnames)) or [`"txt"`](/cloudflare-for-platforms//cloudflare-for-saas/domain-support/hostname-verification/#txt).
