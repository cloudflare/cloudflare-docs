...
If you [issue a custom hostname certificate](/ssl/ssl-for-saas/ssl/common-tasks/issuing-certificates/) with wildcards enabled, you cannot update TLS settings for these wildcard hostnames.
...
1.  **Exact hostname match**:
    ...
    2.  [Legacy Custom Hostname](/ssl/ssl-for-saas/ssl/reference/versioning/) (Belonging to a SaaS Provider)
...
Customer1 uses Cloudflare for authoritative DNS for the zone `shop.example.com`. Customer2 is a SaaS provider that creates and successfully [verifies the new Custom Hostname](/ssl/ssl-for-saas/ssl/common-tasks/hostname-verification/) `shop.*example.com*`. Afterward, traffic starts routing over Customer2’s zone:
