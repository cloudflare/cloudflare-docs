...
If your application has specific security requirements, Cloudflare recommends using the following values when you [restrict cipher suites](/ssl/reference/cipher-suites/disable-cipher-suites/).

| Recommended security level | Description | Cipher suites [to specify](/ssl/reference/cipher-suites/disable-cipher-suites/) | Other settings |
| --- | --- | --- | --- |
