...
If your system integrates with the Cloudflare API to [order advanced certificates](https://developers.cloudflare.com/api/operations/certificate-packs-order-advanced-certificate-manager-certificate-pack), you will need to update the following fields:
