...
3.  **Certificate priority**: If the hostname is the same, certain types of certificates take precedence over others.
    ...
    | 4        | [Advanced](/ssl/edge-certificates/advanced-certificate-manager/), which also includes certificates issued through [Total TLS](/ssl/edge-certificates/additional-options/total-tls/) |
