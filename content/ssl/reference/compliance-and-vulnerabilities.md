...
PCI standards recommend using TLS 1.2 or higher. Refer to [Compliance status](/ssl/edge-certificates/additional-options/cipher-suites/compliance-status/) for a list of recommended cipher suites.
