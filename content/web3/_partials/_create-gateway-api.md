...
To create a gateway using the API, send a [`POST`](https://developers.cloudflare.com/api/operations/web3-hostname-create-web3-hostname) request that includes the following parameters:
