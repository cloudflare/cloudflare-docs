...
| [Goerli Testnet](https://goerli.net/) | Append `/v1/goerli` to calls to your gateway. The Goerli Testnet is deprecated and [will will stop being supported](https://blog.ethereum.org/2023/11/30/goerli-lts-update) on April 13, 2024. Use the Sepolia Testnet instead. |
