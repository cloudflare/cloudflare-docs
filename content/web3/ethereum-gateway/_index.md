...
These interactions take place through the official [Ethereum JSONRPC API](https://github.com/ethereum/execution-apis) and use [Cloudflare-supported API methods](/web3/ethereum-gateway/reference/supported-api-methods/).