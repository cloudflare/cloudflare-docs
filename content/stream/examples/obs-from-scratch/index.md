---
type: example
summary: Set up and start your first Live Stream using OBS (Open Broadcaster Software) Studio
tags:
  - Live
...
![OBS Output Settings - Simple Mode](./obs-output-settings-1.png)

- Change **Output Mode** to "Advanced"

![OBS Output Settings - Advanced Mode](./obs-output-settings-2.png)
