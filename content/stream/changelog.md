...
You can now change the start and end times of a video uploaded to Cloudflare Stream. For more information, refer to [VOD clipping](/stream/edit-manage-videos/edit-videos/vod-clipping).
