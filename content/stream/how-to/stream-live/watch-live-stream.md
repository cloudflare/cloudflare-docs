...
The Stream player has full support for live viewer counts by default. To get the viewer count for a live video for use with third party players, make a `GET` request to the `/views` endpoint.
