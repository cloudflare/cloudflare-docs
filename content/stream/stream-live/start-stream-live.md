...
- Stream Live only supports H.264 video and AAC audio codecs as inputs, and AAC only supports ADTS and not LATM. This requirement does not apply to inputs that are relayed to Stream Connect outputs.
