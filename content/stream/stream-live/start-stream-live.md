...
- When possible it is better to select CBR (constant bitrate) over VBR (variable bitrate).  CBR helps to ensure a stable streaming experience while preventing buffering and interruptions.
