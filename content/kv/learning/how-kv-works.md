...
![Your data is written to central data stores when you write to KV.](/kv/static/kv-write.svg)
...
![Initial reads will miss the cache and go to the nearest central data store first.](/kv/static/kv-slow-read.svg)
...
![As mentioned above, frequent reads will return a cached value.](/kv/static/kv-fast-read.svg)
