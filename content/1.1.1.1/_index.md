...
Beyond the regular service, 1.1.1.1 also offers a [version made for families](/setup#1111-for-families) with additional protection against malware and adult content, and an encrypted service through [DNS over HTTPS (DoH)](/encryption/dns-over-https) or [DNS over TLS (DoT)](/encryption/dns-over-tls) for increased security and privacy. You can also access 1.1.1.1 [as a Tor hidden service](/other-ways-to-use-1.1.1.1/dns-over-tor).
