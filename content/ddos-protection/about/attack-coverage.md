...
| L7 (HTTP/HTTPS) | [HTTP DDoS Attack Protection](/ddos-protection/managed-rulesets/http/)             | HTTP flood attack<br/>HTTP/2 Rapid Reset attacks<br/>HTTP/2 Continuation flood<br/>Cache busting and bypassing attacks<br/>Low & Slow attacks<br/>Volumetric bot attacks<br/>Botnet attacks<br/>SSL/TLS negotiation attacks<br/>SSL/TLS exhaustion attacks<br/>WordPress pingback attack<br/>HULK attack<br/>LOIC attack<br/>Slowloris attack<br/>Mirai and Mirai-variant HTTP attacks |
