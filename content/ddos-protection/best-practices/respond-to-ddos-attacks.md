...
4. If you have [Managed IP Lists](/fundamentals/global-configurations/lists/managed-lists/#managed-ip-lists) or [Bot Management](/bots/plans/bm-subscription/), consider using these in WAF custom rules.
