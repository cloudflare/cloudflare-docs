...
- If you are a WAF/CDN customer, follow the steps in the [Responding to DDoS attacks](/ddos-protection/best-practices/respond-to-ddos-attacks/) page, which guides you on enabling the _Under Attack_ mode and creating rate limiting rules and firewall rules as needed.
