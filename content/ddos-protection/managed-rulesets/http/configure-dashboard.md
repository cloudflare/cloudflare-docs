...
1. In **Ruleset configuration**, select the action and sensitivity values for all the rules in the HTTP DDoS Attack Protection Managed Ruleset.
    ...
    ![Configuring the action and sensitivity of all the rules in the HTTP DDoS Managed Ruleset.](https://developers.cloudflare.com/ddos-protection/static/ddos/ddos-configure-ruleset.png)
...
1. Search for the rules you wish to configure using the available filters. You can search for tags.
    ...
    ![Configuring the action and sensitivity of specific rules in the HTTP DDoS Managed Ruleset.](https://developers.cloudflare.com/ddos-protection/static/ddos/ddos-configure-rules.png)
