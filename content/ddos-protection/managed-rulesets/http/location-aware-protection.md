...
To view traffic flagged by the geo-profiling rule, navigate to **Security** > **Overview** in the Cloudflare dashboard and filter by `Service equals HTTP DDoS` and `Rule ID equals a8c6333711ff4b0a81371d1c444be2c3`.
