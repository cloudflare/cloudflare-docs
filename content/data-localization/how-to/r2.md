...
4. After [connect a bucket to a custom domain](/r2/buckets/public-buckets/#connect-a-bucket-to-a-custom-domain).
...
With Customer Metadata Boundary set to `EU`, **R2** > **Bucket** > [**Metrics**](/r2/reference/metrics-analytics/) tab in the account dashboard will be populated.
