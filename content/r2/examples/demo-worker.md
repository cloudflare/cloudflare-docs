...
### Bind your bucket to a Worker
In your `wrangler.toml` file, you will need to bind your R2 bucket to a Worker. Add an `r2_bucket` property to the file with a binding property and bucket_name indication the bucket name you used to create your bucket. 

Find more detailed information on configuring your Worker in the [Wrangler Configuration documentation](/workers/wrangler/configuration/#r2-buckets).
