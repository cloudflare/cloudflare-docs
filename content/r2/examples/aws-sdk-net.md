...
In this example, we will pass credentials explicitly to the `IAmazonS3` initialisation. If you wish, you can use a
shared AWS credentials file or the SDK store in-line with other AWS SDKs. Refer to [Configure AWS credentials](https://docs.aws.amazon.com/sdk-for-net/v3/developer-guide/net-dg-config-creds.html).
