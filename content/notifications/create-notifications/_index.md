...
{{<Aside type="note">}}
Refer to [Available Notifications](/notifications/notification-available/) to learn more about what each Notification does and what do to when receiving one.
{{</Aside>}}
...
The browser will navigate back to the list of Notifications, where the new Notification will appear as **Enabled**. The list of notifications available depends on the [type of account you have](/notifications/notification-available/).
