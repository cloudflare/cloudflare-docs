...
If you would like to read more on the deprecated `wrangler.toml` fields that cause Wrangler v2 to error, refer to [Deprecations](/workers/wrangler/migration/deprecations/).
