...
Workers are highly extensible you can combine the functionalities mentioed above into one script but set them as variables to be re-used for other use cases. In this case, it can be done for a streaming platform.

## Caching based on file extensions and passing through `cf` values as variables
