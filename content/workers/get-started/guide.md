...
4. `tsconfig.json`: TypeScript configuration that includes [Workers types](https://github.com/cloudflare/workerd/tree/main/npm/workers-types). Only generated if indicated in `wrangler init` command.
