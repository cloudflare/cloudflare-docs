...
Gradual Deployments give users the ability to incrementally deploy new versions of Workers.

 This functionality is available now in beta only. We may make API changes before releasing this feature more broadly.
