...
![Service bindings are a zero-cost abstraction](/images/workers/configuration/bindings/service-bindings-comparison.png)
...
![Your team can view cross-service dependencies in the Cloudflare dashboard Account Home > Workers & Pages > your Worker > Triggers](/images/workers/configuration/bindings/service-bindings-triggers.png)
...
![Selecting Edit variables to create new bindings and edit existing bindings that enable Worker-to-Worker communication](/images/workers/configuration/bindings/service-bindings.png)
