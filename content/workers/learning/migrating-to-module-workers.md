...
The module Worker syntax has full support in the Cloudflare dashboard. Go to **Workers & Pages** > **Create** > **Worker** and pick the HTTP Handler example. After your Worker is created, select **Quick Edit** and it will launch the dashboard. Select **Send** at the top to test if your service is returning `“Hello world”`.
