...
Cloudflare Workers provides experimental support for WebSocket compression via the compatibility flag `web_socket_compression`. Refer to [Experimental Changes](/workers/platform/compatibility-dates/#experimental-changes) for more information.
