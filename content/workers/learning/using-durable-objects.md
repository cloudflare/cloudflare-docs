...
To prevent indefinite locking, there is a limit on how much time storage operations can take. For operations such as `deleteAll()` that make partial progress, it is safe to retry until success. Otherwise contact support.
