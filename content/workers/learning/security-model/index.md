...
<div class="security-page-workers-architecture-diagram">
  <img alt="Workers runtime architecture demonstrating design of Cloudflare's HTTP proxy and V8 isolates. Read below for more information." src="/images/workers/learning/Workers-architecture.svg">
</div>
