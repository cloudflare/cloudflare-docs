...
Refer to the documentation for [`addEventListener`](/workers/runtime-apis/add-event-listener/) and [`FetchEvent`](/workers/runtime-apis/handlers/fetch/) to learn more.
