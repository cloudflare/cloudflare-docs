...
<p>{{<button type="primary" href="/workers/platform/sites/start-from-scratch">}}Start from scratch{{</button>}}</p>
...
<p>{{<button type="primary" href="/workers/platform/sites/start-from-existing">}}Start from an existing static site{{</button>}}</p>
...
<p>{{<button type="primary" href="/workers/platform/sites/start-from-worker">}}Start from an existing Worker{{</button>}}</p>
