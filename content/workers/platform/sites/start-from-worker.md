...
Workers Sites require [Wrangler](https://github.com/cloudflare/wrangler-legacy) — make sure to use the [latest version](/workers/wrangler/install-and-update/#update-wrangler).
