...
![Service bindings are a zero-cost abstraction](https://developers.cloudflare.com/workers/platform/bindings/media/service-bindings-comparison.png)
...
![To configure a Service binding, go to your Worker > Settings > Variables and follow the steps above](https://developers.cloudflare.com/workers/platform/bindings/media/service-bindings-config.png)
...
![Your team can view cross-service dependencies in the Cloudflare dashboard Account Home > Workers > Triggers](https://developers.cloudflare.com/workers/platform/bindings/media/service-bindings-triggers.png)
...
![Selecting Edit variables to create new bindings and edit existing bindings that enable Worker-to-Worker communication](https://developers.cloudflare.com/workers/platform/bindings/media/service-bindings.png)
