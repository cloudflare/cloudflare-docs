...
![After selecting Triggers, add a trigger to execute time-based Workers](/workers/platform/triggers/custom-domains/media/workers-schedule-editor.png)
...
![Review the activity log of past cron triggers in Past Events](/workers/platform/triggers/custom-domains/media/workers-past-events.png)
