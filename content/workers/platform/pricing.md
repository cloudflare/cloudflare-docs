...
To change your account-wide usage model:

1. Log in to the [Cloudflare dashboard Open external link](https://dash.cloudflare.com/) and select your account.
2. In Account Home, select **Workers & Pages** > **Plans**.
3. Select plan you want to use.
