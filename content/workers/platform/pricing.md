...
Queues are only available on the Workers Paid plan. To learn more about Queues pricing, [visit the Queues pricing documentation](https://developers.cloudflare.com/queues/pricing/).
