...
* A Worker may consume up to **10ms** on the Free plan.
* A Worker may consume up to **50ms** with the Bundled usage model on the Paid Plan.
* A Worker may consume up to **30s** with the Unbound usage model on the Paid Plan.
