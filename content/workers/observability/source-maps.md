...
Miniflare can also [output source maps](https://miniflare.dev/developing/source-maps) for use local development or [testing](/workers/testing/integration-testing/#miniflares-api). 
