...
Currently, mTLS for Workers cannot be used for requests bound to another zone that is [proxied](/dns/manage-dns-records/reference/proxied-dns-records/) on Cloudflare.
