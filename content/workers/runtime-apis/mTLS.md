...
Currently, mTLS for Workers cannot be used for requests made to another zone that is [proxied](/dns/manage-dns-records/reference/proxied-dns-records/) on Cloudflare.
