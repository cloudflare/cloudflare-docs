...
Calling `waitUntil()` several times is acceptable and works similarly to `Promise.allSettled` where even if a previous promise fails, proceeding promises will continue.
