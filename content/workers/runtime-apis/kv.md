...
You can also [write key-value pairs from the command line with Wrangler](/workers/wrangler/commands/#kvkey) and [write data via the API](https://developers.cloudflare.com/api/operations/workers-kv-namespace-write-key-value-pair-with-metadata).
...
You can [write more than one key-value pair at a time with Wrangler](/workers/wrangler/commands/#kvbulk) or [via the API](https://developers.cloudflare.com/api/operations/workers-kv-namespace-write-multiple-key-value-pairs). The bulk API can accept up to 10,000 KV pairs at once.
...
You can also [write with an expiration on the command line via Wrangler](/workers/wrangler/commands/#kvkey) or [via the API](https://developers.cloudflare.com/api/operations/workers-kv-namespace-write-key-value-pair-with-metadata).
...
You can [read key-value pairs from the command line with Wrangler](/workers/wrangler/commands/#kvkey) and [from the API](https://developers.cloudflare.com/api/operations/workers-kv-namespace-read-key-value-pair).
...
You can also [delete key-value pairs from the command line with Wrangler](/workers/wrangler/commands/#kvkey) or [via the API](https://developers.cloudflare.com/api/operations/workers-kv-namespace-delete-key-value-pair).
...
You can also [list keys on the command line with Wrangler](/workers/wrangler/commands/#kvkey) or [via the API](https://developers.cloudflare.com/api/operations/workers-kv-namespace-list-a-namespace'-s-keys).
