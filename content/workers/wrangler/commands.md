...
{{<Aside type="warning">}}
This command only works on databases created during D1's alpha period. You can see which version your database uses with `wrangler d1 info <DATABASE_NAME>`.
