...
- `--private-host` {{<type>}}boolean{{</type>}} {{<prop-meta>}}optional{{</prop-meta>}}
  - Whether the provided host is connected to your Cloudflare Zero Trust private network. Pass this flag if your database is connected via a Cloudflare Tunnel or Magic WAN.
