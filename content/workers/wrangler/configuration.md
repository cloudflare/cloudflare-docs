...
- `entrypoint` {{<type>}}string{{</type>}} {{<prop-meta>}}optional{{</prop-meta>}}
  ...
  - The name of the [entrypoint](content/workers/runtime-apis/bindings/service-bindings/rpc/) to bind to. If you do not specify an entrypoint, the default export of the Worker will be used.
