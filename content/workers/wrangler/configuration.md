...
Changing routes in your `wrangler.toml` will behave in a similar way, overriding any routes currently deployed. At the moment, there is no way to disable this behaviour.
