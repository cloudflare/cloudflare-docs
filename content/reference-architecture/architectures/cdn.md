...
{{<figure img="/images/reference-architecture/cdn-reference-architecture-images/ref-arch-cdn-figure1.svg" alt="Figure 1: Diagram of HTTP web requests between DNS and origin server without a CDN." caption="Figure 1: HTTP Request with no CDN">}}
...
{{<figure img="/images/reference-architecture/cdn-reference-architecture-images/ref-arch-cdn-figure2.svg" alt="Figure 2 is a diagram representing the traffic between a client and a server on Cloudflare's global Anycast network at different client locations." caption="Figure 2: HTTP request to Cloudflare CDN with Anycast">}}
...
{{<figure img="/images/reference-architecture/cdn-reference-architecture-images/ref-arch-cdn-figure3.svg" alt="Figure 3: Diagram representing requests coming from an end user, protected by Cloudflare products including WAF and DDoS protection, and traveling through the Anycast Network to reach the origin server using Smart Tiered Cache." caption="Figure 3: Cloudflare CDN with Tiered Cache on global Anycast network">}}
...
{{<figure img="/images/reference-architecture/cdn-reference-architecture-images/ref-arch-cdn-figure4.svg" alt="Figure 4: The same diagram as Figure 3 demonstrating requests between end users and origin server over the Anycast Network, with bidirectional arrows indicating traffic flow enabled by Smart Tiered Cache." caption="Figure 4: HTTP requests and traffic flow through Cloudflare CDN">}}
...
{{<figure img="/images/reference-architecture/cdn-reference-architecture-images/ref-arch-cdn-figure5.svg" alt="Figure 5: Diagram illustrating requests between an end user and origin server with lower, regional and upper tiered caching enabled." caption="Figure 5: Cloudflare CDN with Tiered Cache and Regional Tiered Cache">}}
...
{{<figure img="/images/reference-architecture/cdn-reference-architecture-images/ref-arch-cdn-figure6.svg" alt="Figure 6: Diagram with bidirectional arrows indicating a request between an end user and origin server without Argo Smart Routing enabled." caption="Figure 6: Cloudflare CDN without Tiered Cache or Argo Smart Routing">}}
...
{{<figure img="/images/reference-architecture/cdn-reference-architecture-images/ref-arch-cdn-figure7.svg" alt="Figure 7: Diagram with bidirectional arrows indicating a request between an end user and origin server, with Argo Smart Routing enabled to improve speed." caption="Figure 7: Cloudflare CDN with Tiered Cache and Argo Smart Routing">}}
...
{{<figure img="/images/reference-architecture/cdn-reference-architecture-images/ref-arch-cdn-figure8.svg" alt="Figure 8: Traffic between end users and an origin server showing Cache Reserve as the final step in the architecture of the Cloudflare CDN solution." caption="Figure 8: Cloudflare CDN with Tiered Cache and Cache Reserve">}}
