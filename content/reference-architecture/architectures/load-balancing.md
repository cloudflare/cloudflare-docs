...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-1.png" alt="Origin load is not distributed evenly without a load balancer" caption="Figure 1: Origin performance can suffer without a load balancer">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-2.png" alt="A load balancer helps evenly distribute requests across multiple origins" caption="Figure 2: Load balancers help distribute load across origins">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-3.png" alt="Latency compounds based on the number of requests" caption="Figure 3: How latency can compound and affect the total time it takes to load a resource">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-4.png" alt="Global traffic management steers traffic to the proper region or data center" caption="Figure 4: Global traffic management load balancer overview">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-5.png" alt="Local traffic management is responsible for steering to the final origin or destination" caption="Figure 5: Local traffic management load balancer overview">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-6.png" alt="Cloudflare’s global Anycast network ensures that the closest data center is always selected" caption="Figure 6: Load balancers hosted on Cloudflare’s Global Anycast Network">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-7.png" alt="Cloudflare Layer 7 features can be used together to further secure a service" caption="Figure 7: Some of the processes a HTTP request passes through in the Cloudflare layer 7 stack">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-8.png" alt="Argo Smart Routing finds the fastest path between requester and origin" caption="Figure 8: Argo Smart Routing reduces latency to origins">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-9.png" alt="Requests take different paths depending on whether the origin is public or connected over Cloudflare Tunnel" caption="Figure 9: Paths to origins differ when connecting origins via Cloudflare Tunnel">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-10.png" alt="Combining GTM and LTM load balancing functions into a single load balancer configuration" caption="Figure 10: Cloudflare combines the function of GTM and LTM load balancing">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-11.png" alt="The steps within a Cloudflare Load Balancer" caption="Figure 11: The basic process flow through a Cloudflare Load Balancer">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-12.png" alt="A pair of origin pools with equal probability of being selected" caption="Figure 12: A pair of origin pools with equal capacity">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-13.png" alt="A set of three origin pools all with equal probability" caption="Figure 13: Three origin pools with equal weight">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-14.png" alt="Three origin pools with different numbers of origins" caption="Figure 14: Illustrates how to use weight to balance load across origin pools with different capacity">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-15.png" alt="Three origin pools with different numbers of origins and origins of different capacity" caption="Figure 15: Using weight to balance load across origin pools with different capacities and origins">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-16.png" alt="HTTPS health monitor to monitor the status of an origin web server" caption="Figure 16: HTTPS health monitor configuration">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-17.png" alt="Comparison of three origin pools with different numbers of healthy origins" caption="Figure 17: When origins pool are considered healthy, degraded, or critical">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-18.png" alt="Origin pool settings to further customize the health monitors" caption="Figure 18: Health Threshold and region selection for an origin pool configuration">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-19.png" alt="Load balancing is the last process before dispatching to the origin" caption="Figure 19: Differences in the Layer 7 paths between load balancer and origin">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-20.png" alt="A single cloudflared instance tunnels traffic for multiple origins" caption="Figure 20: A shared cloudflared deployed on a separate server tunnels traffic for multiple origins">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-21.png" alt="Mismatched Host headers may result in the origin rejecting the request" caption="Figure 21: How the load balancer can rewrite the Host header to match the origin">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-22-ALT.png" alt="All the possible combinations of load balancer and origin types" caption="Figure 22: The combinations of public and private load balancers and origins and how they connect">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-23-ALT.png" alt="Layer 7 load balancing request flow to two different types of origins" caption="Figure 23: How Cloudflare’s Layer 7 load balancers can steer traffic to both public and private origins">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-24.png" alt="The orange cloud icon represents a proxied Layer 7 Cloudflare Load Balancer" caption="Figure 24: A proxied load balancer configuration">}}

{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-25.png" alt="The gray cloud icon represents an unproxied (DNS-only) load balancer" caption="Figure 25: An unproxied (DNS-only) load balancer configuration">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-26.png" alt="DNS-only load balancers only use Cloudflare to respond to a DNS request" caption="Figure 26: How Cloudflare’s DNS-only load balancer functions">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-27.png" alt="DNS-only load balancers can respond to DNS requests with one or many IP addresses" caption="Figure 27: How weight affects the DNS response from a DNS-only load balancer">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-28-ALT.png" alt="Spectrum-based load balancing supports public origins" caption="Figure 28: Spectrum Layer 4 load balancers support both TCP and UDP protocols">}}
...
{{<figure img="/images/reference-architecture/load-balancing-reference-architecture-images/lb-ref-arch-30.png" alt="Origin draining in process from web user interface" caption="Figure 30: Origin draining occurring within a Cloudflare Load Balancer">}}
