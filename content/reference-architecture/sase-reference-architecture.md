...
![Typical enterprise network today](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-1.svg)
...
![SASE Cloud Platform](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-2.svg)
...
![Cloudflare Connectivity Cloud](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-4.svg)
...
Using Anycast ensures the Cloudflare network is well balanced. If there is a sudden increase in traffic on the network, the load can easily be distributed across multiple data centers – which in turn, helps maintain consistent and reliable connectivity for users. Further, Cloudflare’s large [network capacity](https://www.cloudflare.com/network/) and [AI/ML-optimized smart routing](https://blog.cloudflare.com/meet-traffic-manager/) also help ensure that performance is constantly optimized.
...
![Anycast versus Unicast networking](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-5.svg)
...
![A typical enterprise IT infrastructure](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-6.svg)
...
![Cloudflared connecting applications to Cloudflare](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-7.svg)
...
![SSO flow from user, to Cloudflare, to Salesforce, to IdP](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-8.svg)
...
![Applications now connected to Cloudflare](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-9.svg)
...
![Using cloudflared for private network connectivity](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-10.svg)
...
![Using WARP Connector for private network connectivity](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-11.svg)
...
![Summary of options for private network connectivity](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-12.svg)
...
![Cloudflare Anycast network with tunnels](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-13.svg)
...
In situations where deploying the WAN Connector is not feasible or desirable, organizations can securely connect their site networks to Cloudflare by configuring IPsec tunnels from their existing IPsec-capable network devices, including WAN or SD-WAN routers, firewalls, and cloud VPN gateways. Please refer to the Cloudflare [documentation](/magic-wan/third-party/) for up-to-date examples of validated IPsec devices.

There may also be situations where network-layer encryption is not necessary — for example, when a site’s WAN-bound traffic is already encrypted at the application layer (via TLS), or when an IPsec network device offers very limited throughput performance as it encrypts and decrypts IPsec traffic. Under these circumstances, organizations can connect to the Cloudflare network using [GRE tunnels](/magic-wan/get-started/configure-tunnels/).

Organizations may also connect their network locations directly to the Cloudflare network via [Network Interconnect](https://www.cloudflare.com/network-services/products/network-interconnect/) (CNI). Currently, Cloudflare supports two types of [network interconnect](/network-interconnect/about/interconnect-types/):
...
![Methods of connecting and routing traffic to Cloudflare](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-14.svg)
...
![Connecting networks to Cloudflare](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-15.svg)
...
<thead>
  <tr>
    <th></th>
    <th colspan="5"><p style="text-align: center;">Connection method (for traffic source)</p></th>
  </tr>
</thead>
<tbody>
  <tr>
    <td></td>
    <td>IP tunnel or Interconnect (Magic WAN)</td>
    <td>Device Agent (WARP) <sub>*1</sub></td>
  ...
  <tr>
    <th colspan="6">Data available in policies</th>
  </tr>
  ...
  <tr>
    ...
    <td>Enforce <a href="/cloudflare-one/policies/gateway/egress-policies/dedicated-egress-ips/">egress IP</a></td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
    <td>Yes</td>
...
![Forwarding device traffic to Cloudflare](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-17.svg)
...
![Identity provider selection prior to Cloudflare One access](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-18.svg)
...
![Protecting email with Cloudflare using MX records](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-19.svg)
...
![Protecting email with Cloudflare using APIs](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-20.svg)
...
![A complete SASE architecture with Cloudflare](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-21.svg)
...
![Request flows for SWG and ZTNA in Cloudflare One](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-23.svg)
...
![An example Access Group in Cloudflare One](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-24.svg)
...
![An example Access Group in Cloudflare One](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-25.svg)
...
![Block high risk websites policy](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-26.svg)
...
![Isolate all social media websites policy](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-27.svg)
...
![Isolate all social media websites policy](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-28.svg)
...
![Prevent upload of sensitive company data policy](/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-29.svg)
