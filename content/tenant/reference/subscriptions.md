...
The following values are samples and not exhaustive. For the complete list of subscription values available to you, make an API call to the [zone subscriptions](https://developers.cloudflare.com/api/operations/zone-rate-plan-list-available-rate-plans) or [account subscriptions](https://api.cloudflare.com/#account-subscriptions-list-subscriptions) endpoints.
