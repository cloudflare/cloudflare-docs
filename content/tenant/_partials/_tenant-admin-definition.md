...
Tenant admins then become the default [**Super administrator(s)**](/fundamentals/account-and-billing/members/roles/) for all accounts and zones contained within the Tenant. 
