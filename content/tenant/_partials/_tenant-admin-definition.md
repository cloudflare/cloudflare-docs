...
Tenant admins then become the default [**Super administrator(s)**](/fundamentals/account-and-billing/account-setup/account-roles/) for all accounts and zones contained within the Tenant. 
