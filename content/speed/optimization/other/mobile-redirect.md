...
To allow your end users to view the full site on mobile, you'll need to set the value of the following cookie _on the apex domain only_ to 0 (zero) at your origin server:
