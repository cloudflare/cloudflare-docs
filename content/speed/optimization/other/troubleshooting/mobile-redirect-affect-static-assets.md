...
Cloudflare's [mobile redirect](/speed/optimization/other/mobile-redirect/) will redirect all traffic from your root domain (`example.com`) to whatever is configured as your mobile redirect (`mobile.example.com`). This includes all the resources under the domain.
