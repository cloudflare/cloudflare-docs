...
If you use create-cloudflare to create your new Astro project, after installing all dependencies you will be prompted to deploy via the CLI. Your site will be live and you will be provided with a deployment URL.  
