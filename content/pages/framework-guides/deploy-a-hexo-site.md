...
![Follow the instructions above to set up an environment variable in the Pages dashboard](https://developers.cloudflare.com/pages/framework-guides/media/node-version-pages.png)
