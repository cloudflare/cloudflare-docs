...
![Bulk redirects option](https://developers.cloudflare.com/pages/how-to/media/bulk_redirects_option.png)

In **Bulk Redirects**, select **Create a new Bulk Redirects list**.

![Create a new Bulk redirects list](https://developers.cloudflare.com/pages/how-to/media/create_a_new_bulk_redirect_list.png)
...
![Create a new Bulk redirects](https://developers.cloudflare.com/pages/how-to/media/create_new_bulk_redirect.png)
