...
![Set up builds and deployments page with Project name and Production branch filled in](https://developers.cloudflare.com/pages/get-started/images/configuration.png)
...
![Build setting fields that need to be filled in](https://developers.cloudflare.com/pages/get-started/images/build-settings.png)
...
![Root directory field to be filled in](https://developers.cloudflare.com/pages/get-started/images/root-directory.png)
...
![Deployment details in the Cloudflare dashboard](https://developers.cloudflare.com/pages/get-started/images/deploy-log.png)
...
![Site dashboard displaying your environments and deployments](https://developers.cloudflare.com/pages/get-started/images/site-dashboard.png)
...
![Adding a custom domain for your Pages project through the Cloudflare dashboard](https://developers.cloudflare.com/pages/get-started/images/domains.png)
...
![Configuring your Pages project settings in the Cloudflare dashboard](https://developers.cloudflare.com/pages/get-started/images/settings.png)
