---
title: create-cloudflare cli (C3)
pcx_content_type: get-started
weight: 2
layout: single
meta:
  title: Create projects with the create-cloudflare CLI (C3)
---

# Create and deploy a new application with the create-cloudflare cli (C3)
