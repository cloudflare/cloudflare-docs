...
C3 accepts CLI arguments allowing you to to specify your preference in such a was and thus skipping the relative wizard steps. Using CLI arguments you can even create C3 invocations that do not require any user interaction, making automated or repetitive uses of C3 very convenient.
...
- `--deploy` {{<type>}}boolean{{</type>}} {{<prop-meta>}}(default: true){{</prop-meta>}}

  - Deploy your application after it has been created.

- `--ts`{{<type>}}boolean{{</type>}} {{<prop-meta>}}(default: true){{</prop-meta>}}

  - Use TypeScript in your application.

- `--git` {{<type>}}boolean{{</type>}} {{<prop-meta>}}(default: true){{</prop-meta>}}

  - Initialize a local git repository for your application.

- `--open` {{<type>}}boolean{{</type>}} {{<prop-meta>}}(default: true){{</prop-meta>}}

  - Open with your browser the deployed application (this option is ignored if the application is not deployed).

- `-y`, `--accept-defaults` {{<type>}}boolean{{</type>}}

  - Use all the default C3 options each can also be overridden by specifying it.

- `--auto-update` {{<type>}}boolean{{</type>}} {{<prop-meta>}}(default: true){{</prop-meta>}}

  - Automatically uses the latest version of C3.

- `-v`, `--version` {{<type>}}boolean{{</type>}}

  - Show version number.

- `-h`, `--help` {{<type>}}boolean{{</type>}}
