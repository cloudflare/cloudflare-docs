...
| Node.js   | 12.18.0         | 12.18.0 and any version that nvm can install.|`NODE_VERSION`       | `.nvmrc`, `.node-version` |
...
| Swift     | 5.x | Installed by default. Pages supports any `5.x` version. |`SWIFT_VERSION`| `.swift-version` |
| .NET      | 3.1.302         | |                     |                           |
