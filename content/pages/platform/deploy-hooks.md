...
![Adding a deploy hook on the Cloudflare dashboard](https://developers.cloudflare.com/pages/platform/media/deploy-hooks-add.png)
...
![Choosing Deploy Hook name and branch to build on Cloudflare dashboard](https://developers.cloudflare.com/pages/platform/media/deploy-hooks-configure.png)
...
![Reviewing the Deploy Hook's newly generated unique URL](https://developers.cloudflare.com/pages/platform/media/deploy-hooks-details.png)
...
![Reviewing which deployment was triggered by a Deploy Hook](https://developers.cloudflare.com/pages/platform/media/deploy-hooks-deployment-logs.png)
...
![Configuring Deploy Hooks with Contentful](https://developers.cloudflare.com/pages/platform/media/contentful.png)
...
![Configuring Deploy Hooks with Ghost](https://developers.cloudflare.com/pages/platform/media/ghost.png)
...
![Configuring Deploy Hooks with Sanity](https://developers.cloudflare.com/pages/platform/media/sanity.png)
...
![Configuring Deploy Hooks with WordPress](https://developers.cloudflare.com/pages/platform/media/wordpress.png)
...
![Configuring Deploy Hooks with Strapi](https://developers.cloudflare.com/pages/platform/media/strapi.png)
