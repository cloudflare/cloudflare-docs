...
After you have deployed the JavaScript Worker, set a cron trigger through the Workers dashboard to run this script periodically. Refer to the [Cron Triggers guide](/workers/platform/triggers/custom-domains/) for more details.
...
After you have deployed the JavaScript Worker, you can set a cron trigger through the Workers dashboard to run this script periodically. Refer to the [Cron Triggers guide](/workers/platform/triggers/custom-domains/) for more details.
...
- [Workers Cron Triggers](/workers/platform/triggers/custom-domains/)
