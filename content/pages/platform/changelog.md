...
* The V2 build system is now available in open beta, you can enable within the [Build & deployments settings](https://dash.cloudflare.com?to=/:account/pages/view/:pages-project/settings/builds-deployments)

## 2023-05-16

* [Smart placement](/workers/configuration/smart-placement/) can now be enabled for Pages within the [Functions settings](https://dash.cloudflare.com?to=/:account/pages/view/:pages-project/settings/functions)

## 2023-03-23

* Files uploaded are now visible for Git projects, you can view them [here](https://dash.cloudflare.com?to=/:account/pages/view/:pages-project/:pages-deployment/files)

## 2023-03-20

* Notifications for Pages events are now available in the [Cloudflare dashboard](https://dash.cloudflare.com?to=/:account/notifications)
  * Events supported:
  * Deployment started
