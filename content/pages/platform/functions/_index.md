...
![Editing a KV namespace Binding and adding a Variable name](https://developers.cloudflare.com/pages/platform/media/KV-functions.png)
...
![Editing a Durable Object namespace Binding and adding a Variable name](https://developers.cloudflare.com/pages/platform/media/DO-functions.png)
...
![Editing an environment variable by adding a variable name and value](https://developers.cloudflare.com/pages/platform/media/ENV-functions.png)
