...
![Editting a KV namespace Binding and adding a Variable name](../KV-functions.png)
...
![Editting a Durable Object namespace Binding and adding a Variable name](../DO-functions.png)
...
![Editting an environment variable by adding a variable name and value](../ENV-functions.png)
