...
- A Direct Upload of a `/functions` directory does not work (refer to [Using Functions in Direct Upload](https://developers.cloudflare.com/pages/platform/direct-upload/#using-functions)).
