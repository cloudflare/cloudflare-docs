...
- Direct Upload of `/functions` directory does not work (see [Using Functions in Direct Upload](https://developers.cloudflare.com/pages/platform/direct-upload/#using-functions))
