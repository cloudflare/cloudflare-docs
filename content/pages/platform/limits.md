...
An individual header in a `_headers` can have a maximum of 2,000 characters. For managing larger headers, it is recommended to implement  [Pages Functions](/pages/platform/functions/).
