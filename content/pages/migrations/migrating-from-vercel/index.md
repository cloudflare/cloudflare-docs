...
![Selecting a site in the Vercel Dashboard](https://developers.cloudflare.com/pages/migrations/migrating-from-vercel/vercel-deploy-1.png)

Inside of your site dashboard, select **Settings**.

![Selecting Site Settings in site dashboard](https://developers.cloudflare.com/pages/migrations/migrating-from-vercel/vercel-deploy-2.png)
...
![Finding the Build Command and Output Directory fields](https://developers.cloudflare.com/pages/migrations/migrating-from-vercel/vercel-deploy-3.png)
