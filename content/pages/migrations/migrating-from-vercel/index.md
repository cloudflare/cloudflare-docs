...
![Selecting a site in the Vercel Dashboard](/pages/vercel-deploy-1.png)

Inside of your site dashboard, select **Settings**.

![Selecting Site Settings in site dashboard](/pages/vercel-deploy-2.png)
...
![Finding the "Build Command" and "Output Directory" fields](/pages/vercel-deploy-3.png)
