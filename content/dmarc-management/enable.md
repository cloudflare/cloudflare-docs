...
4. DMARC Management will scan your zone for DMARC records. 
    ...
    {{<Aside type="note">}}When DMARC Management finds a DMARC record in your zone, it  adds an additional `rua` tag to it. This additional tag has a Cloudflare email address to properly process your DMARC reports.{{</Aside>}}
