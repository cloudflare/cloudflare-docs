...
Cloudflare-sourced traffic is also subject to the Magic Firewall rules you configure. If you block all ICMP traffic, you will also block Cloudflare's {{<glossary-tooltip term_id="health-check" link="/magic-transit/reference/tunnel-health-checks/#endpoint-health-checks">}}endpoint health checks{{</glossary-tooltip>}}. When blocking ICMP traffic, ensure your rules first allow ICMP sourced from Cloudflare public IPs to your prefix endpoint IPs before applying a block ICMP rule.
