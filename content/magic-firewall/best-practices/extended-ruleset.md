...
1.  Create [an IP list](/fundamentals/global-configurations/lists/custom-lists/), **Internal routers** for example, list your IP addresses.
...
1.  Create [an IP list](/fundamentals/global-configurations/lists/custom-lists/), **web servers** for example, to list IP addresses for your web servers.
