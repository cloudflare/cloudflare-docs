...
1.  Create [an IP List](/waf/tools/lists/ip-lists/), **Internal routers** for example, list your IP addresses.
...
1.  Create [an IP List](/waf/tools/lists/ip-lists/), **web servers** for example, to list IP addresses for your web servers.
