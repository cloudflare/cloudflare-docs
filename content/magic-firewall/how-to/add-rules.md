...
You can  create rules with managed lists. Managed lists are lists of IP addresses maintained by Cloudflare and updated frequently, divided into the following groups: 
- Anonymizers
