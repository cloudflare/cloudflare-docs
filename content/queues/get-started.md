...
Queues also supports [pull-based consumers](/queues/reference/pull-consumers/), which allows any HTTP-based client to consume messages from a queue. This guide focuses on creating a push-based consumer using Cloudflare Workers.
