...
Billing for consumers follows the [Workers unbound usage model](/workers/platform/pricing/#workers) meaning a developer is billed for the request and the duration of the request. 
