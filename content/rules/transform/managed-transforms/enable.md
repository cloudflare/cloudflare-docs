...
1. Check the Managed Transform's current status and availability using the Get Managed Transforms operation.
2. Change the status of the [desired Managed Transforms](/rules/transform/managed-transforms/reference/) using the Update Managed Transforms operation.
