    ...
    <tr>
      ...
      <td>
        ...
        <ul>
          ...
          <li><code>cf-region-code</code>: The code of the visitor's region (value from the <a href="/ruleset-engine/rules-language/fields/#field-ip-src-region_code"><code>ip.src.region_code</code></a> field).</li>
