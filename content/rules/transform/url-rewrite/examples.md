...
![URL Rewrite Rule configuration to perform a static query rewrite according to the blog example described in the page.](https://developers.cloudflare.com/rules/static/transform/use-case-blog.png)
