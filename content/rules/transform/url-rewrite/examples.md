...
![URL Rewrite Rule configuration to perform a static query rewrite according to the blog example described in the page.](/rules/static/transform/use-case-blog.png)
