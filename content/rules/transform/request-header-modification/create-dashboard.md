...
3.  Click **Create transform rule** > **Modify Request Header**.
    ...
    ![The HTTP Request Header Modification Rule creation page in the Cloudflare dashboard.](https://developers.cloudflare.com/rules/static/transform/create-request-header-modification-rule.png)
...
8.  To modify another HTTP request header in the same rule, click **+ Set new header**.
    ...
    ![Example configuration performing three request header modifications: set a dynamic header value, set a static header value, and remove an existing header.](https://developers.cloudflare.com/rules/static/transform/request-header-modification-example.png)
