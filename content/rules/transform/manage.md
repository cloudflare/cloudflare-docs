...
![The Transform Rules tab in the Cloudflare dashboard](https://developers.cloudflare.com/rules/static/transform/transform-rules-tab.png)
...
![For each rule in the rules list, you can change its order, enable/disable the rule, edit the rule, or delete the rule.](https://developers.cloudflare.com/rules/static/transform/rule-operations.png)
