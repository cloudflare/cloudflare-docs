...
summary: You can use the example below for a demo Configuration rule using Terraform where mail Obfuscation and Browser Integrity Check for API requests are disabled for a zone.
tags:
  - Configuration
