...
summary: You can use the example below for a demo Origin rule using Terraform where the `Host` header, the resolved hostname, and the destination port of API requests is overridden.
tags:
  - Origin
