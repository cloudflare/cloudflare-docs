...
*   **Source URL** <Type>String</Type>
    ...
    *   The exact behavior of the [URL matching algorithm](/bulk-redirects/how-it-works#url-matching-algorithm), which matches an incoming request with the redirect’s source URL, depends on the values of the **Include subdomains** and **Subpath matching** parameters.
...
*   **Subpath matching** <Type>Boolean</Type>
    ...
    *   For more information, refer to [Matching the source URL of redirects](/bulk-redirects/how-it-works#matching-the-source-url-of-redirects).
