...
### Important notes about wildcard matching

- To perform case-insensitive or case-sensitive [wildcard matching](/ruleset-engine/rules-language/operators/#wildcard-matching), use the `wildcard` or `strict wildcard` operators, respectively.
