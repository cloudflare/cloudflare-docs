...
The following table shows how different [URL normalization settings](/rules/normalization/settings/) affect URLs of incoming requests before they pass to other Cloudflare features and to the origin server:
