...
1.  Go to **Rules** > **Settings**.
    ...
    ![Available URL normalization settings in the Cloudflare dashboard](https://developers.cloudflare.com/rules/static/normalization/url-normalization-settings.png)
