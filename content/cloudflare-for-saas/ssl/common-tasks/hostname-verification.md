...
If a custom hostname is already on Cloudflare, then traffic will only shift to your fallback origin once the [DNS target has changed](/cloudflare-for-saas/getting-started/#step-5--have-customer-create-a-cname-record).
