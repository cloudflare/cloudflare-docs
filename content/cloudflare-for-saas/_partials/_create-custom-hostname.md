...
If you [issue a custom hostname certificate](/cloudflare-for-saas/ssl/common-tasks/issue-and-validate/) with wildcards enabled, you cannot customize TLS settings for these wildcard hostnames.
