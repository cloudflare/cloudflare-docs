...
For use cases and limitations, refer to [custom certificates](/cloudflare-for-saas/security/certificate-management/custom-certificates/).

## Upload certificates

### With the dashboard

To upload a custom certificate in the dashboard, follow the steps for [issuing new certificates](/cloudflare-for-saas/security/certificate-management/issue-and-validate/#via-the-dashboard), but change the **Certificate type** to **Custom certificate**.
...
{{<render file="../../ssl/_partials/_custom-cert-file-example.md">}}
