...
* Control your traffic's level of encryption with [TLS settings](/cloudflare-for-saas/security/certificate-management/enforce-mtls/)
    * Specify the type of encryption that will be used between client and server computers communicating securely via TLS by choosing a [cipher suite](/cloudflare-for-saas/security/certificate-management/enforce-mtls/#cipher-suites).
