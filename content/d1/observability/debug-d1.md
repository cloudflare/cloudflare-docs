...
The D1 [client API](/d1/manage-databases/query-databases/) returns detailed [error messages](/d1/manage-databases/query-databases/#errors) within an `Error` object. 
...
* The Worker code that makes the query, including any calls to `bind()` using the [client API](/d1/manage-databases/query-databases/).
