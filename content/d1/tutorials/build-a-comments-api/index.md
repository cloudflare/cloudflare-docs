...
The above code makes use of the `prepare`, `bind`, and `all` functions on a D1 binding to prepare and execute a SQL statement. Refer to [Client API](/d1/reference/client-api) for a list of all methods available in D1's client API.
