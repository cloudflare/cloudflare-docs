...
Developers using the Workers free plan and D1's free tier will not be charged.

See the [announcement blog](https://blog.cloudflare.com/d1-open-beta-is-here/) for more details about what's new in the beta and what's coming in the future.
...
Note: These free limits are not currently enforced during the public beta.
