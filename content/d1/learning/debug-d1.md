...
The D1 [client API](/d1/reference/client-api/) returns detailed [error messages](/d1/reference/client-api/#errors) within an `Error` object. 
...
* The Worker code that makes the query, including any calls to `bind()` using the [client API](/d1/reference/client-api/).
