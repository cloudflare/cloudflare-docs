...
From here, you can now query our new table from our Worker [using the D1 client API](/d1/reference/client-api/).
...
* Learn how to [use the D1 client API](/d1/reference/client-api/) from within a Worker
