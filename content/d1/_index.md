...
Create your first D1 database by [following the Get started guide](/d1/get-started/), learn how to [import data into a database](/d1/manage-databases/import-data/), and how to [query your database](/d1/manage-databases/query-databases/) directly from [Workers](/workers/) or [Pages](/pages/functions/bindings/#d1-databases).
