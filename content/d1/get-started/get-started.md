...
This guide will instruct you through setting up and deploying your first database with D1.

## Prerequisite: Create a Cloudflare account

In order to use D1, you need a [Cloudflare account](/fundamentals/account-and-billing/account-setup/). If you already have an account, skip this step.
