...
* If you configured a [binding](/pages/functions/bindings/#d1-databases) named `DB`, then you would access D1's [client API](/d1/manage-databases/query-databases/#query-statement-methods) methods via `context.env.DB`.
