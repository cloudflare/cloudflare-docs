...
For example, when a Worker executes via a [scheduled event](/runtime-apis/scheduled-event), it executes for 4 seconds, including network-bound IO time: `4s x 0.125GB (or 128Mb) = .5 GB-s`.
