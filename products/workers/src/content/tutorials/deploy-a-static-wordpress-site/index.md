...
To start, install the [WP2Static](https://github.com/leonstafford/wp2static) plugin to export your WordPress site to a zip file. In your WordPress administrator settings, navigate to the **Add Plugins** page, by default at `/wp-admin/plugin-install.php`. In the search bar, search WP2Static and confirm that the resulting plugin that you will be installing matches the plugin below.
...
When your application refreshes, you should see a new section of your sidebar called WP2Static. Navigate to that section and begin your first static WordPress export.
...
With an export ready of our site, it’s time to get to work deploying it. To do this, use [Wrangler](https://github.com/cloudflare/wrangler), the command-line tool for Cloudflare Workers. If you have not yet installed and configured Wrangler, refer to the [Get started](/get-started/guide) guide.
...
When your site looks correct in Wrangler’s preview, you can move onto publishing your project to a domain. For a guide on how to do this, refer to the [Get started](/get-started/guide#6-configure-your-project-for-deployment) guide.
...
- Save on cost by downgrading your WordPress hosting plan. Because the memory and bandwidth requirements for your WordPress instance are now much smaller, you can often get away with hosting it on a more affordable plan, or moving to shared hosting. Your Cloudflare Workers plan is priced per-request, and because you can host up to thirty sites on your account, serving a high number of static WordPress sites can be an order of magnitude cheaper on Workers.

If you would like to share what you are building on Workers and WordPress, join the [Workers Community Discord](https://discord.gg/cloudflaredev).
