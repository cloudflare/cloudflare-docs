...
As of August 2020, the WP2Static plugin is closed for downloads on WordPress.org but is still available on their GitHub repo. [WP2Static](https://github.com/leonstafford/wp2static), try [Simply Static](https://wordpress.org/plugins/simply-static/). 
