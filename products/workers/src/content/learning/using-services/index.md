...
This authentication Workers Service does not need to have `*.workers.dev` or custom domain public endpoint, it is accessed through a Workers Service binding from the other Workers Service scripts directly.
