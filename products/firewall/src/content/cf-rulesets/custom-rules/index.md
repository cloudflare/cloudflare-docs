...
Custom Rules are built upon the ruleset engine which you can use to define rules and actions in several Cloudflare products. Custom Rules run in the `http_request_firewall_custom` phase.