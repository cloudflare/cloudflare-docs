...
You cannot edit Managed Rulesets, but you can add overrides to Managed Rulesets executed in a phase. Overrides take precedence over the default behavior of the Managed Ruleset.
