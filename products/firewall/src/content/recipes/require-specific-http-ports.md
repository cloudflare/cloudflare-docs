...
You can target requests based on their HTTP port with the `cf.edge.server_port` [dynamic field](https://developers.cloudflare.com/firewall/cf-firewall-language/fields#dynamic-fields).

Use the `in` [comparison operator](https://developers.cloudflare.com/firewall/cf-firewall-language/operators#comparison-operators) to target a set of ports.
