...
By default, Cloudflare allows requests on a number of different HTTP ports (see [_Identifying network ports compatible with Cloudflare's proxy_](https://developers.cloudflare.com/fundamentals/get-started/network-ports).
