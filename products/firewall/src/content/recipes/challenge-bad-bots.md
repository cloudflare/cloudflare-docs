...
When a request is definitely automated (score of 1) or likely automated (scores 2 to 29) and is _not_ on the list of known good bots, Cloudflare **blocks** the request.
...
Since Bot Management detects automated users, you need to explicitly allow through your **good** automated traffic⁠ — this includes your APIs and partner APIs.
...
Just make sure to set aside time to review [Bot Analytics](/bots/bot-analytics/bm-subscription) and [Firewall Events](https://support.cloudflare.com/hc/articles/360024520152) to see if your rules need additional tuning.