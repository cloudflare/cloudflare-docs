...
The first expression uses the `http.request.uri.path` [field](https://developers.cloudflare.com/ruleset-engine/rules-language/fields#standard-fields) to target the paths to secure from R.U.D.Y.:
