...
* Use [Mass Redirect Lists](https://developers.cloudflare.com/rules/mass-redirects) to define lists of redirects that you enable by creating a Mass Redirect Rule.
...
To use an IP List in an expression, see [_Values: IP Lists_](/cf-firewall-language/values/#ip-lists) in the Firewall Rules language documentation.
