...
To use an IP List in a rule expression, refer to [Values: IP Lists](https://developers.cloudflare.com/ruleset-engine/rules-language/values/#ip-lists) in the Rules language documentation.
