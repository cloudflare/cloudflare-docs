---
title: Manage via the APIs
order: 400
---

# Manage rules via the APIs

When it comes to programmatic rule management, Cloudflare offers APIs that work together to achieve the same effect as the UI based **Firewall Rules** feature of the Cloudflare dashboard **Firewall** app.
