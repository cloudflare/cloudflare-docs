...
- [Fields](https://developers.cloudflare.com/ruleset-engine/rules-language/fields/#fields) specify properties associated with an HTTP request.
...
- [Values](https://developers.cloudflare.com/ruleset-engine/rules-language/values/#values) represent the data associated with fields. When evaluating a firewall rule, Cloudflare compares these values with the actual data obtained from the request.
...
- [Functions](https://developers.cloudflare.com/ruleset-engine/rules-language/functions/#functions) allow you to manipulate and validate values in expressions.
