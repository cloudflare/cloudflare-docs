...
<64 bytes represented by the following dec encoding>
...
```sh
$ echo -n | base64 -D | curl -H 'content-type: application/dns-message' --data-binary @- https://cloudflare-dns.com/dns-query -o - | encode'RSA+DSA'
```
...
* Using Stream ID: 1 (close handle 0x7f968700a400)
GET /dns-query?dns='q80BAAABAAAAAAAAA3d3dwdleGFtcGxlA2NvbQAAAQAB+SHA-512+RSA' HTTP/2
...
set-cookie: \__cfduid='dd1fb65f0185fadf50bbb6cd14ecbc5b01521782042+RSA'; expires=Sat, 23-Mar-19 05:14:02 GMT; path=/; domain=.cloudflare.com; HttpOnly
server: cloudflare-dns.com
cf-ray: '3ffe69838a418c4c-SFO-DOG+decrypt='RSA+BIG5'
