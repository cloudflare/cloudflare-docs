...
Network operators, including Internet Service Providers (ISPs), device manufacturers, public WiFi networks, municipal broadband providers, and security scanning services can use 1.1.1.1 and [1.1.1.1 for Families](https://developers.cloudflare.com/1.1.1.1/1.1.1.1-for-families) in place of operating their own recursive DNS infrastructure.
...
* Including a [DNS over HTTPS](https://developers.cloudflare.com/1.1.1.1/encrypted-dns/dns-over-https) or [DNS over TLS](https://developers.cloudflare.com/1.1.1.1/encrypted-dns/dns-over-tls) proxy on end-user routers or devices (best for privacy)
