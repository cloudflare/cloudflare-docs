...
<p><Link to="/set-up" className="Button Button-is-docs-primary">Set up Magic Transit</Link> &nbsp; <Link to="/about" class="Button Button-is-docs-secondary">Learn more</Link></p>
