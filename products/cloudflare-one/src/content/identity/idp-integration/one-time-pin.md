...
To set up OTP to allow guest-user access, you simply add the guest user’s email address to a [Policy rule](/policies/zero-trust/policy-management#add-a-policy) and to the [Access Group](/identity/users/groups) that allows your team to reach the application.
