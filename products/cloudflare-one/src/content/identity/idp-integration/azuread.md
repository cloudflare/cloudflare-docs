...
1. Name your application, select _Web_ from the **Select a platform** dropdown, and enter your [team domain](/glossary#team-domain) followed by this callback at the end of the path: `/cdn-cgi/access/callback`. For example:
