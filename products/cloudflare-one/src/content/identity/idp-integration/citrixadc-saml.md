...
6. Navigate to your **Cloudflare** dashboard, select the **Access** app, and click **Login Methods**.
    ...
    ![Access Login Methods](../../static/documentation/identity/citrixadc/citrixadc-saml-5.png)

7. Select **SAML** from the identity provider options.

    ![Access SAML IdP](../../static/documentation/identity/citrixadc/citrixadc-saml-6.png)
