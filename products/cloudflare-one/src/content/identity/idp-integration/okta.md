...
1. (optional) Create an Okta API Token and input the token (it can be a read-only token). This will prevent your Okta groups from failing if you have more than 100 groups.
1. Click **Save**.
