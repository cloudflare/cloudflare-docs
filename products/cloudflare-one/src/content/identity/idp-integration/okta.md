...
1. (optional) Create an Okta API token and enter it in the Teams dash (the token can be read-only). This will prevent your Okta groups from failing if you have more than 100 groups.
1. Click **Save**.
