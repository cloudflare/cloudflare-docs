...
1. In your **Cloudflare Access** dashboard, scroll to the **Login Methods** card, click **Add**, and select the **SAML** icon.
    ...
    ![Cloudflare Access Login Methods](../../static/documentation/identity/signedauthn/signed-authn-1.png)

    The _Add a SAML identity provider_ dialog displays.

1. Complete the fields in the dialog.

    ![Cloudflare Access Add a SAML identity provider dialog](../../static/documentation/identity/signedauthn/signed-authn-2.png)

1. Go to this URL to find the certificate:

    ```txt
    https://{access-domain}/cdn-cgi/access/public-cert
    ```
