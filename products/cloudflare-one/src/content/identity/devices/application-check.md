...
You can create multiple instances of the Application Check for each operative system you need to run it on, or if you need to check for multiple applications.
...
1. Next, you can choose to enter a [**Signing certificate thumbprint**](#determine-the-signing-thumbprint). 
    ...
    Adding this information will enable the check to ensure that the application was signed by the software developer you expect it to be signed from. 
...
The process to determine the signing thumbprint of an application varies depending on the operative system. This is how you would look up the signing thumbrpint of the Cloudflare WARP application on macOS and Windows.
