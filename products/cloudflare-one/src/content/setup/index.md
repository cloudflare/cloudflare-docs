...
1. Insert your email address and choose a password.

1. Click **Create account**.

You can now choose to:

1. Set up [Cloudflare Access](#set-up-cloudflare-access).
1. Set up [Cloudflare Gateway](#set-up-cloudflare-gateway).
