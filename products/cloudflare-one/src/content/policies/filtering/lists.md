...
With Teams, you can create lists of URLs to reference when creating Secure Web Gateway policies. This allows you to quickly create rules that match and take actions against several items. 
