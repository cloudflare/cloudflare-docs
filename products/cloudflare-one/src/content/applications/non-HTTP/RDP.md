...
1. Create an [application](/applications/) for the subdomain of your RDP.

For example, if you share the desktop at `rdp.site.com`, that is the subdomain you will configure for the application).

2. Build a [policy](/policies/) to restrict user access to that subdomain.
...
![kubectl](../../static/documentation/applications/non-http/rdp.png)
