...
Next, protect the subdomain you plan to register with a Cloudflare Access application policy. Follow [these instructions](../access/getting-started/policies) to build a new policy to control who can connect to the drive.
