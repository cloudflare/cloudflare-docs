...
## team name
The customizable portion of your [team domain](#team-domain). You can change this name at any time in the Teams dashboard, under the **Authentication** tab. However, changing your team name may disrupt integrations with identity providers and other applications. If you do change it, you may need to update these configurations to reflect your new team name.
