...
### Using TryCloudflare
1. Follow the instructions [here](/connections/connect-apps/install-and-setup/installation) to install `cloudflared`. If you have an older copy, update to 2019.4.0 or later.
