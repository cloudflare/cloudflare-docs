module.exports = {
  ...
  contentRepoFolder: "products/bot-management",
  externalLinks: [{
  ...
  siteMetadata: {
      ...
      description: "Cloudflare’s bot solutions identify and mitigate automated traffic to protect your site from bad bots.",
      author: "@cloudflare",
      url: "https://developers.cloudflare.com/bot-managemenet",
