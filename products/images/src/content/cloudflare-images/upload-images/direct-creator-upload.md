...
To request a one-time upload URL, simply have your back-end (or Worker script) call the [`direct_upload` endpoint](https://api.cloudflare.com/#cloudflare-images-create-authenticated-direct-upload-url-v2):
