...
Bulk Redirects are essentially static — they do not support any string replacement operations. However, you can configure URL Redirect options that affect their URL matching behavior and their runtime behavior.
