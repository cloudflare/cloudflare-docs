...
* A **dynamic rewrite** supports more advanced scenarios where you use a [rewrite expression](/transform/url-rewrite/reference/fields-functions#rewrite-expressions) to define the resulting path or query string.
