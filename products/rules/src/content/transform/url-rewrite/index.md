...
* A **dynamic rewrite** supports more advanced scenarios where you use an [expression](https://developers.cloudflare.com/ruleset-engine/rules-language/expressions) to define the resulting path or query string.
