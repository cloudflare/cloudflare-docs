...
If you want to send your DNS queries over an encrypted connection, you can use the hostname that we provide in the dashboard to send queries using DNS over HTTPS. Head to the [Getting started](/gateway/getting-started/) to learn more on how to setup a location.
...
See how you can start sending DNS queries by visiting the [Getting started](/gateway/getting-started/) section.
