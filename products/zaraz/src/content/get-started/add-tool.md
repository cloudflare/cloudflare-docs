...
1. Click on the **Events** tab and give your Event a name. You need to configure the first event that will trigger the loading of the tool on your website. For most tools, this will be a simple **Page view** event type, for which Zaraz offers a `__zarazPageview` preset configuration.
...
If you go back to the main Zaraz page, you will see your tool listed under the **Third-party tools** card, and the type of Event associated with it. From here you can toggle the **Active** button to activate and deactivate your tool.
