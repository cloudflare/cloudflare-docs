...
From this page you can configure the tool's **Settings** and add additional events, by clicking **Create event**. You can also edit the events listed by clicking their names.
