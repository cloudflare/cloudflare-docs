...
Your trigger is now complete. If you go back to the main page you will see it listed under the **Triggers** card. From here, you can see where your trigger is used, and click the trigger to edit it.