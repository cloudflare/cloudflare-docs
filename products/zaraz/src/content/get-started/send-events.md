...
1. In the **Firing triggers** field choose the relevant trigger you [previously created](/create-trigger). You may choose more than one trigger for your Event. In this case, only when all the triggers you chose are valid will the event be sent to the third-party tool.
