...
Start by [adding a third-party tool](/get-started/add-tool) to your Zaraz dashboard, if the tool you need just requires a simple `pageview` trigger to operate.
