...
If you see a [_Managed Challenge_](https://support.cloudflare.com/hc/en-us/articles/200170136-Understanding-Cloudflare-Captchas-and-Challenge-Passage#managed-challenge), it could be related to the following security products (Firewall Rules, IP Access Rules, User Agent Blocking, Rate Limiting, Custom Rules or Bot Fight Mode).
