...
* The examples add a new rule at the zone level with the `skip` action. If you wish to edit an existing rule, refer to [Update a rule in a ruleset](https://developers.cloudflare.com/ruleset-engine/rulesets-api/update-rule) for more information.
...
This example uses the [Add individual rule](https://developers.cloudflare.com/ruleset-engine/rulesets-api/add-rule) API operation to add a rule that skips the remaining rules in the current ruleset:
...
This example uses the [Add individual rule](https://developers.cloudflare.com/ruleset-engine/rulesets-api/add-rule) API operation to add a rule that skips the `http_ratelimit` phase:
...
Refer to [Available skip options](/custom-rules/custom-firewall/skip/options) for the list of phases you can skip.

## Skip security products

This example uses the [Add individual rule](https://developers.cloudflare.com/ruleset-engine/rulesets-api/add-rule) API operation to add a rule that skips the Zone Lockdown and User Agent Blocking products:
...
Refer to [Available skip options](/custom-rules/custom-firewall/skip/options) for the list of products you can skip.
