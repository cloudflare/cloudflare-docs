...
Check for exposed credentials events in the Firewall Analytics dashboard (**Overview** tab of the **Firewall** app), filtering by a specific Rule ID. For more information on filtering the Firewall Activity log, check [Understanding Firewall Analytics](https://support.cloudflare.com/hc/articles/360024520152#1eYXCEA5ZrNHxDm9tte0Bo) in the Support KB.
