...
- SMCP
- NTP
  - Common vector for reflection attacks. Consider using [Cloudflare Web3 Gateway](https://developers.cloudflare.com/web3), [1.1.1.1's DNS over HTTPs (DoH)](https://developers.cloudflare.com/1.1.1.1/), or an internal DNS service if possible. Consider restricting your firewall rules to only allow the source and destination of DNS traffic.
- MS-SQL
