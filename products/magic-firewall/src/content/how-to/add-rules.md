...
By default, you can create a maximum of 100 rules, and you can create lists of IP addresses for referencing within rules to minimize the number of rules you need to configure.
