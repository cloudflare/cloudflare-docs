...
The example below **blocks** all packets with a **source** or **destination** IP address coming from Brazil by using its 2-letter country code in in <a href="https://www.iso.org/obp/ui/#search/code/">ISO 3166-1 Alpha 2</a> format. 
