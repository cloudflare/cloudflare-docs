...
If you are a customer with an add-on to your Enterprise plan, Cloudflare will apply additional mechanisms to detect and report any potentially malicious scripts in your zone. For more information, refer to [Review changed scripts](/use-dashboard/review-changed-scripts) and [Detecting malicious scripts](/about/malicious-script-detection).
