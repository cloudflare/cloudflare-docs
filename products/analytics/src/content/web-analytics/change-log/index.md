...
---------------|-------------
2021-11-16 | When using automatic installation of the JavaScript Beacon (available only to customers proxied through Cloudflare - orange-clouded), [Subresource Integrity (SRI)](https://developer.mozilla.org/en-US/docs/Web/Security/Subresource_Integrity) is now enabled by default. SRI is a security feature that enables browsers to verify that resources they fetch are delivered without unexpected manipulation. 
