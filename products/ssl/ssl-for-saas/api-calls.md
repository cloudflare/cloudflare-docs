...
```
$ curl -sXGET https://api.cloudflare.com/client/v4/zones/{zone_id}/custom_hostnames?page=1\
...
```
$ curl -sXGET https://api.cloudflare.com/client/v4/zones/{zone_id}/custom_hostnames?hostname=app.example.com\
...
```
$ curl -XPUT "https://api.cloudflare.com/client/v4/zones/:zone_id/custom_hostnames/fallback_origin"\ 
-H "X-Auth-Email: {email}" -H "X-Auth-Key: {key}"\ 
-H "Content-Type: application/json"\ 
