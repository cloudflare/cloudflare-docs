...
Note that this step is completely optional. Cloudflare will present the cipher suites listed [here](/ssl/origin/cipher-suites/) to your origin, and your server will select whichever cipher suite it prefers.
