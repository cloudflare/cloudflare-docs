...
The following [API](https://api.cloudflare.com/#zone-level-authenticated-origin-pulls-set-enablement-for-zone) call enables Authenticated origin pull at zone level:
...
1. Upload the new certificate using [Cloudflare API](https://api.cloudflare.com/#per-hostname-authenticated-origin-pull-upload-a-hostname-client-certificate) 
...
1. Upload the new certificate using [Cloudflare API](https://api.cloudflare.com/#zone-level-authenticated-origin-pulls-upload-certificate).

2. Check that new certificate is in Active static using [Cloudflare API](https://api.cloudflare.com/#zone-level-authenticated-origin-pulls-get-certificate-details).

3. Once certificate is active, then delete the old certificate using [Cloudflare API](https://api.cloudflare.com/#zone-level-authenticated-origin-pulls-delete-certificate).
