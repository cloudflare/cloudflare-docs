...
Note that this step is completely optional. Cloudflare will [present the cipher suites to your origin](/origin/cipher-suites/), and your server will select whichever cipher suite it prefers.
