...
If your application uses a partial (CNAME) setup and also uses HTTP DCV validation, you will need to [change your DCV method](/edge-certificates/changing-dcv-method) to either TXT or Email.
