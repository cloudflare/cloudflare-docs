...
Keyless Delegation is our implementation of the emerging 
[delegated credentials](https://datatracker.ietf.org/doc/draft-ietf-tls-subcerts/)
standard.  When you upload a certificate for use with Keyless that has
...
the Keyless Server. There are additional advantages to flexibility in
algorithm choice that you can learn about in our [blog post](https://blog.cloudflare.com/keyless-delegation/).
