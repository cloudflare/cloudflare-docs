...
1. Choose how your site should respond to various types of traffic:
    - See [Static resource protection](/about/static-resources/) for more additional details on supported file types
    - See [Javascript detections](https://support.cloudflare.com/hc/articles/360045224651) for more information on invisible code injection