...
Although these products are designed to fight malicious actors on the Internet, it may challenge API or mobile app traffic. For more granular control, upgrade to [Bot Management for Enterprise](../bm-subscription).