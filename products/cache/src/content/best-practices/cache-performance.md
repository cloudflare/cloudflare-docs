...
- **Dynamic**: Default response for many file types including HTML. To cache additional content, refer to [custom caching with page rules](https://support.cloudflare.com/hc/en-us/articles/360021023712-Best-Practices-Speed-up-your-Site-with-Custom-Caching-via-Cloudflare-Page-Rules).
...
- Need to enable Tiered Cache or Custom Cache Key 
  ...
  - Resolution: Enable Argo Tiered Caching or [create a custom cache key](https://developers.cloudflare.com/cache/about/cache-keys).