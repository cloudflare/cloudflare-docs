...
- [Secondary DNS](secondary-dns): Keep your primary DNS provider and use Cloudflare as a secondary DNS provider. DNS records will be transferred from your primary DNS provider to Cloudflare via zone transfer using AXFR or IXFR.
