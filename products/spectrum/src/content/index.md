...
Spectrum is available on all paid plans. Pro and Business support selected protocols only (for instance, Minecraft Java edition (TCP) is supported, but Bedrock (UDP) is not supported), and Enterprise supports all TCP and UDP based traffic. For information on how billing is calculated, refer to [Billing for Spectrum](https://support.cloudflare.com/hc/articles/360041721872) for an in-depth breakdown.
