...
- [Geo steering](https://developers.cloudflare.com/load-balancing/understand-basics/traffic-steering#geo-steering): Traffic goes to specific geographical region or — for Enterprise customers only — specific data centers.
