...
In order to use Browser Isolation with administrative controls you will need your own Cloudflare for Teams account with the Browser Isolation add-on subscrition. Follow [this guide](/administration/setup-teams) to get started.
