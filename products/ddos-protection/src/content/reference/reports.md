...
To download an ad-hoc DDoS report, [export a report from the Firewall Analytics dashboard](https://developers.cloudflare.com/waf/analytics/paid-plans#print-or-download-pdf-report).
