...
To create the connection between WordPress and Cloudflare, you'll create an API token from your Cloudflare dashboard and add it to WordPress. To setup APO on a subdomain, see [Subdomains and subdirectories](/reference/subdomain-subdirectories).
