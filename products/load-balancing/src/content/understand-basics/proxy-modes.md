...
If your load balancer is attached to a hostname used for an [MX, SRV, or TXT record](/reference/dns-records#supported-records) — and not an A, AAAA, or CNAME record — its proxy mode should be **DNS-only**.
