...
A product has been migrated if it is listed in the [__Products__ table](https://github.com/cloudflare/cloudflare-docs#products) in the content repo’s README.
