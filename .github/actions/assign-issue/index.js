...
var F2 = (e, p, a, d) => {
	if ((p && typeof p == 'object') || typeof p == 'function')
		for (let t of k2(p))
			!U2.call(e, t) &&
				t !== a &&
				rp(e, t, { get: () => p[t], enumerable: !(d = V2(p, t)) || d.enumerable });
	return e;
};
var ip = (e, p, a) => (
	(a = e != null ? G2(R2(e)) : {}),
	F2(p || !e || !e.__esModule ? rp(a, 'default', { value: e, enumerable: !0 }) : a, e)
);
var xe = c(ve => {
	'use strict';
	...
	var L2 =
		...
		q2 =
			...
			function (e) {
				...
				var p = {};
				if (e != null)
					for (var a in e) a !== 'default' && Object.hasOwnProperty.call(e, a) && L2(p, e, a);
				return j2(p, e), p;
			};
	Object.defineProperty(B, '__esModule', { value: !0 });
	B.issue = B.issueCommand = void 0;
	var I2 = q2(require('os')),
		op = xe();
	function mp(e, p, a) {
		let d = new o1(e, p, a);
		process.stdout.write(d.toString() + I2.EOL);
	}
	B.issueCommand = mp;
	function x2(e, p = '') {
		mp(e, {}, p);
	...
	var sp = '::',
		o1 = class {
			...
			toString() {
				...
				return (p += `${sp}${M2(this.message)}`), p;
			}
		};
	function M2(e) {
		return op.toCommandValue(e).replace(/%/g, '%25').replace(/\r/g, '%0D').replace(/\n/g, '%0A');
	}
	function H2(e) {
		return op
			.toCommandValue(e)
	...
	var $2 =
		...
		up =
			...
			function (e) {
				...
				var p = {};
				if (e != null)
					for (var a in e) a !== 'default' && Object.hasOwnProperty.call(e, a) && $2(p, e, a);
				return z2(p, e), p;
			};
	Object.defineProperty(H, '__esModule', { value: !0 });
	H.issueCommand = void 0;
	var np = up(require('fs')),
		W2 = up(require('os')),
		K2 = xe();
	function J2(e, p) {
		let a = process.env[`GITHUB_${e}`];
		if (!a) throw new Error(`Unable to find environment variable for file command ${e}`);
		if (!np.existsSync(a)) throw new Error(`Missing file at path: ${a}`);
		np.appendFileSync(a, `${K2.toCommandValue(p)}${W2.EOL}`, { encoding: 'utf8' });
	}
	H.issueCommand = J2;
});
var hp = c(he => {
...
var _p = c(fe => {
	...
	fe.httpsOverHttp = pd;
	fe.httpOverHttps = ad;
	fe.httpsOverHttps = dd;
	function ed(e) {
		var p = new Y(e);
		return (p.request = m1.request), p;
	}
	function pd(e) {
		var p = new Y(e);
		return (p.request = m1.request), (p.createSocket = gp), (p.defaultPort = 443), p;
	}
	function ad(e) {
		var p = new Y(e);
		return (p.request = fp.request), p;
	}
	function dd(e) {
		var p = new Y(e);
		return (p.request = fp.request), (p.createSocket = gp), (p.defaultPort = 443), p;
	}
	function Y(e) {
		var p = this;
		(p.options = e || {}),
			(p.proxyOptions = p.options.proxy || {}),
			(p.maxSockets = p.options.maxSockets || m1.Agent.defaultMaxSockets),
			(p.requests = []),
			(p.sockets = []),
			p.on('free', function (d, t, r, i) {
				for (var o = wp(t, r, i), s = 0, m = p.requests.length; s < m; ++s) {
					var l = p.requests[s];
	...
	Q2.inherits(Y, X2.EventEmitter);
	Y.prototype.addRequest = function (p, a, d, t) {
		var r = this,
			i = l1({ request: p }, r.options, wp(a, d, t));
	...
	Y.prototype.createSocket = function (p, a) {
		...
		function m(n, h, _) {
			if ((i.removeAllListeners(), h.removeAllListeners(), n.statusCode !== 200)) {
				ae('tunneling socket could not be established, statusCode=%d', n.statusCode), h.destroy();
				var g = new Error('tunneling socket could not be established, statusCode=' + n.statusCode);
				(g.code = 'ECONNRESET'), p.request.emit('error', g), d.removeSocket(t);
				return;
			}
			if (_.length > 0) {
				ae('got illegal response body from proxy'), h.destroy();
				var g = new Error('got illegal response body from proxy');
				(g.code = 'ECONNRESET'), p.request.emit('error', g), d.removeSocket(t);
				return;
			}
			return (
				ae('tunneling connection has established'), (d.sockets[d.sockets.indexOf(t)] = h), a(h)
			);
		}
		function l(n) {
...
`,
			...
			var h = new Error('tunneling socket could not be established, cause=' + n.message);
			(h.code = 'ECONNRESET'), p.request.emit('error', h), d.removeSocket(t);
		}
	};
	...
	function gp(e, p) {
		...
		Y.prototype.createSocket.call(a, e, function (d) {
			var t = e.request.getHeader('host'),
				r = l1({}, a.options, { socket: d, servername: t ? t.replace(/:.*$/, '') : e.host }),
				i = Z2.connect(0, r);
...
var c1 = c(f => {
	...
	var td =
		...
		We =
			...
			function (e) {
				...
				var p = {};
				if (e != null)
					for (var a in e) a !== 'default' && Object.hasOwnProperty.call(e, a) && td(p, e, a);
				return rd(p, e), p;
			},
		S =
			(f && f.__awaiter) ||
	...
	function id(e) {
		let p = bp.getProxyUrl(new URL(e));
		return p ? p.href : '';
	}
	f.getProxyUrl = id;
	var sd = [
		...
		od = [I.BadGateway, I.ServiceUnavailable, I.GatewayTimeout],
		md = ['OPTIONS', 'GET', 'DELETE', 'HEAD'],
		ld = 10,
		nd = 5,
	...
	var u1 = class {
		...
		request(p, a, d, t) {
			return S(this, void 0, void 0, function* () {
				...
				let r = new URL(a),
					...
					o = this._allowRetries && md.includes(p) ? this._maxRetries + 1 : 1,
					s = 0,
					m;
				do {
					if (
					...
					for (
						...
						sd.includes(m.message.statusCode) &&
						...
						if ((yield m.readBody(), h.hostname !== r.hostname))
							for (let _ in t) _.toLowerCase() === 'authorization' && delete t[_];
						(i = this._prepareRequest(p, h, t)), (m = yield this.requestRaw(i, d)), l--;
					}
					if (!m.message.statusCode || !od.includes(m.message.statusCode)) return m;
		...
		_getAgent(p) {
			...
			if (this._keepAlive && !a) {
				...
				(a = r ? new n1.Agent(o) : new Me.Agent(o)), (this._agent = a);
			}
			return (
				a || (a = r ? n1.globalAgent : Me.globalAgent),
				r &&
...
var yp = c($ => {
	...
	$.PersonalAccessTokenCredentialHandler = f1;
});
var Np = c(we => {
	'use strict';
	var Sp =
	...
	var cd = c1(),
		...
		te = class {
			static createHttpClient(p = !0, a = 10) {
				...
				return new cd.HttpClient(
					'actions/oidc-client',
					[new vd.BearerCredentialHandler(te.getRequestToken())],
					d
				);
			}
			...
			static getIDToken(p) {
				return Sp(this, void 0, void 0, function* () {
					try {
						...
						Dp.debug(`ID token url is ${a}`);
						let d = yield te.getCall(a);
						return Dp.setSecret(d), d;
					} catch (a) {
...
var b1 = c(G => {
	...
	var hd = require('os'),
		T1 = require('fs'),
		{ access: fd, appendFile: gd, writeFile: wd } = T1.promises;
	...
	var E1 = class {
			...
			filePath() {
				return _1(this, void 0, void 0, function* () {
					...
					try {
						yield fd(p, T1.constants.R_OK | T1.constants.W_OK);
					} catch {
						throw new Error(
			...
			write(p) {
				return _1(this, void 0, void 0, function* () {
					...
					return yield (a ? wd : gd)(d, this._buffer, { encoding: 'utf8' }), this.emptyBuffer();
				});
			}
			clear() {
				return _1(this, void 0, void 0, function* () {
							...
							let r = t
								.map(i => {
									...
									let { header: o, data: s, colspan: m, rowspan: l } = i,
										n = o ? 'th' : 'td',
										h = Object.assign(Object.assign({}, m && { colspan: m }), l && { rowspan: l });
									return this.wrap(n, s, h);
								})
								.join('');
...
var w1 = c(u => {
	...
	var _d =
		...
		Pp =
			...
			function (e) {
				...
				var p = {};
				if (e != null)
					for (var a in e) a !== 'default' && Object.hasOwnProperty.call(e, a) && _d(p, e, a);
				return Td(p, e), p;
			},
		Op =
			(u && u.__awaiter) ||
	...
	u.setSecret = Sd;
	function Dd(e) {
		process.env.GITHUB_PATH || '' ? Gp.issueCommand('PATH', e) : L.issueCommand('add-path', {}, e),
			(process.env.PATH = `${e}${Ed.delimiter}${process.env.PATH}`);
	}
	u.addPath = Dd;
	function y1(e, p) {
...
Support boolean input list: \`true | True | TRUE | false | False | FALSE\``);
	...
	u.setCommandEcho = Od;
	function Gd(e) {
		(process.exitCode = Vp.Failure), kp(e);
	}
	u.setFailed = Gd;
	function Vd() {
	...
	function jd(e) {
		return Op(this, void 0, void 0, function* () {
			return yield bd.OidcClient.getIDToken(e);
		});
	}
	u.getIDToken = jd;
	var qd = b1();
		...
		S1 = class {
			constructor() {
				...
				if (((this.payload = {}), process.env.GITHUB_EVENT_PATH))
					if (Fp.existsSync(process.env.GITHUB_EVENT_PATH))
						this.payload = JSON.parse(
							Fp.readFileSync(process.env.GITHUB_EVENT_PATH, { encoding: 'utf8' })
						);
					else {
						let t = process.env.GITHUB_EVENT_PATH;
						process.stdout.write(`GITHUB_EVENT_PATH ${t} does not exist${xd.EOL}`);
					}
...
var Cp = c(V => {
	...
	var Md =
		...
		$d =
			...
			function (e) {
				...
				var p = {};
				if (e != null)
					for (var a in e) a !== 'default' && Object.hasOwnProperty.call(e, a) && Md(p, e, a);
				return Hd(p, e), p;
			};
	...
	V.getAuthString = Wd;
	function Kd(e) {
		return new zd.HttpClient().getAgent(e);
	}
	V.getProxyAgent = Kd;
	function Jd() {
...
var Yp = c((G0, Ge) => {
	var Wp = jp(),
		...
		$p = Hp.bind(Hp);
	function Kp(e, p, a) {
		var d = $p(e6, null).apply(null, a ? [p, a] : [p]);
		(e.api = { remove: d }),
			(e.remove = d),
			['before', 'error', 'after', 'wrap'].forEach(function (t) {
				var r = a ? [p, t, a] : [p, t];
				e[t] = e.api[t] = $p(Qd, null).apply(null, r);
			});
	}
	function p6() {
		var e = 'h',
	...
	function a6(e) {
		...
		return Zp(e) === !1
			...
			: ((p = e.constructor),
			  p === void 0
					? !0
					: ((a = p.prototype), !(Zp(a) === !1 || a.hasOwnProperty('isPrototypeOf') === !1)));
	}
	A1.isPlainObject = a6;
});
var ta = c(V1 => {
	...
	function G1(e, p, a) {
		...
		(a.headers = r6(a.headers)), Xp(a), Xp(a.headers);
		let d = ea(e || {}, a);
		return (
			e &&
	...
	function m6(e) {
		let p = e.match(s6);
		return p ? p.map(o6).reduce((a, d) => a.concat(d), []) : [];
	}
	function Qp(e, p) {
	...
	function Ve(e, p, a) {
		return (p = e === '+' || e === '#' ? pa(p) : Ee(p)), a ? Ee(a) + '=' + p : p;
	}
	function Te(e) {
		return e != null;
	}
		...
		if (Te(t) && t !== '')
			if (typeof t == 'string' || typeof t == 'number' || typeof t == 'boolean')
				(t = t.toString()),
					...
					r.push(Ve(p, t, O1(p) ? a : ''));
			else if (d === '*')
				Array.isArray(t)
					? t.filter(Te).forEach(function (i) {
							r.push(Ve(p, i, O1(p) ? a : ''));
					  })
				...
				Array.isArray(t)
					...
					O1(p) ? r.push(Ee(a) + '=' + i.join(',')) : i.length !== 0 && r.push(i.join(','));
			}
		else
			p === ';'
				? Te(t) && r.push(Ee(a))
	...
	function aa(e) {
		let p = e.method.toUpperCase(),
			...
			t,
			r = Qp(e, ['method', 'baseUrl', 'url', 'headers', 'request', 'mediaType']),
			i = m6(a);
		(a = n6(a).expand(r)), /^http/.test(a) || (a = e.baseUrl + a);
		let o = Object.keys(e)
		...
		if (
			...
			d.accept = l
				...
				.map(n => {
					let h = e.mediaType.format ? `.${e.mediaType.format}` : '+json';
					return `application/vnd.github.${n}-preview${h}`;
				})
				.join(',');
		}
		return (
	...
	function da(e, p) {
		...
		return Object.assign(d, {
			DEFAULTS: a,
			defaults: da.bind(null, a),
			merge: G1.bind(null, a),
			parse: aa,
		});
	}
	var v6 = '6.0.12',
		h6 = `octokit-endpoint.js/${v6} ${t6.getUserAgent()}`,
		f6 = {
			method: 'GET',
			baseUrl: 'https://api.github.com',
			headers: { 'accept': 'application/vnd.github.v3+json', 'user-agent': h6 },
...
var sa = c((R0, ia) => {
	...
	function re(e, p) {
		...
		return function (i, o) {
			...
			if (o.enforceRange) {
				...
				if (((s = ra(s) * Math.floor(Math.abs(s))), s < a || s > d))
					throw new TypeError('Argument is not in byte range');
				return s;
			}
			if (!isNaN(s) && o.clamp) return (s = w6(s)), s < a && (s = a), s > d && (s = d), s;
			if (!Number.isFinite(s) || s === 0) return 0;
			if (((s = ra(s) * Math.floor(Math.abs(s))), (s = s % t), !p.unsigned && s >= r)) return s - t;
			if (p.unsigned) {
				if (s < 0) s += t;
	...
	T.byte = re(8, { unsigned: !1 });
	T.octet = re(8, { unsigned: !0 });
	T.short = re(16, { unsigned: !1 });
	T['unsigned short'] = re(16, { unsigned: !0 });
	T.long = re(32, { unsigned: !1 });
	T['unsigned long'] = re(32, { unsigned: !0 });
	T['long long'] = re(32, { unsigned: !1, moduloBitLength: 64 });
	T['unsigned long long'] = re(32, { unsigned: !0, moduloBitLength: 64 });
	T.double = function (e) {
		let p = +e;
...
var ha = c((C0, Xe) => {
	...
	var T6 = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g;
	function va(e) {
		return e.replace(T6, '_').length;
	}
	function E6(e, p, a) {
		for (var d = !1, t = '', r = va(e), i = 0; i < r; ++i) {
	...
	function y6(e, p) {
		e.substr(0, 4) === 'xn--' && ((e = na.toUnicode(e)), (p = be.NONTRANSITIONAL));
		var a = !1;
		(ua(e) !== e ||
			(e[3] === '-' && e[4] === '-') ||
			e[0] === '-' ||
			...
			e.search(b6) === 0) &&
			(a = !0);
		for (var d = va(e), t = 0; t < d; ++t) {
			var r = ca(e.codePointAt(t));
			if (
...
var z = c((B0, F) => {
	...
	function V6(e) {
		let p = new Buffer(e),
			a = '';
		for (let d = 0; d < p.length; ++d) a += ba(p[d]);
		return a;
	}
	function k6(e) {
		let p = new Buffer(e),
	...
	var R6 = new Set([32, 34, 35, 60, 62, 63, 96, 123, 125]);
	function ya(e) {
		return Qe(e) || R6.has(e);
	}
	var U6 = new Set([47, 58, 59, 61, 64, 91, 92, 93, 94, 124]);
	function U1(e) {
		return ya(e) || U6.has(e);
	}
	function le(e, p) {
	...
	function C6(e) {
		...
		for (let r = 0; r < a.length - 1; ++r) if (a[r] > 255) return v;
		if (a[a.length - 1] >= Math.pow(256, 5 - a.length)) return v;
		let d = a.pop(),
			t = 0;
	...
	function L6(e) {
		...
		for (; t < e.length; ) {
			...
			let r = 0,
				i = 0;
			for (; i < 4 && x(e[t]); ) (r = r * 16 + parseInt(wa(e, t), 16)), ++t, ++i;
			if (e[t] === 46) {
				if (i === 0 || ((t -= i), a > 6)) return v;
				let o = 0;
				for (; e[t] !== void 0; ) {
					let s = null;
					if (o > 0)
				...
				if ((++t, e[t] === void 0)) return v;
			} else if (e[t] !== void 0) return v;
			(p[a] = r), ++a;
		}
		if (d !== null) {
			let r = a - d;
	...
	function R1(e, p) {
		if (e[0] === '[') return e[e.length - 1] !== ']' ? v : L6(e.substring(1, e.length - 1));
		if (!p) return q6(e);
		let a = k6(e),
			d = fa.toASCII(a, !1, fa.PROCESSING_OPTIONS.NONTRANSITIONAL, !1);
		if (d === null || P6(d)) return v;
		let t = C6(d);
		return typeof t == 'number' || t === v ? t : d;
	}
	function q6(e) {
		if (O6(e)) return v;
		let p = '',
	...
	function F1(e) {
		return typeof e == 'number' ? B6(e) : e instanceof Array ? '[' + j6(e) + ']' : e;
	}
	function x6(e) {
		return e.replace(/^[\u0000-\u001F\u0020]+|[\u0000-\u001F\u0020]+$/g, '');
	}
	...
	function Sa(e) {
		let p = e.path;
		p.length !== 0 && ((e.scheme === 'file' && p.length === 1 && $6(p[0])) || p.pop());
	}
	function Da(e) {
	...
	E.prototype['parse scheme start'] = function (p, a) {
		if (Re(p)) (this.buffer += a.toLowerCase()), (this.state = 'scheme');
		else if (!this.stateOverride) (this.state = 'no scheme'), --this.pointer;
		else return (this.parseError = !0), v;
		return !0;
	};
	E.prototype['parse scheme'] = function (p, a) {
		if (S6(p) || p === 43 || p === 45 || p === 46) this.buffer += a.toLowerCase();
		else if (p === 58) {
			if (
				(this.stateOverride &&
					((D(this.url) && !k1(this.buffer)) ||
						(!D(this.url) && k1(this.buffer)) ||
						((Da(this.url) || this.url.port !== null) && this.buffer === 'file') ||
	...
	E.prototype['parse authority'] = function (p, a) {
		if (p === 64) {
			(this.parseError = !0),
				this.atFlag && (this.buffer = '%40' + this.buffer),
				(this.atFlag = !0);
			let d = ga(this.buffer);
			for (let t = 0; t < d; ++t) {
			...
			if (this.atFlag && this.buffer === '') return (this.parseError = !0), v;
			(this.pointer -= ga(this.buffer) + 1), (this.buffer = ''), (this.state = 'host');
		} else this.buffer += a;
		return !0;
	};
	E.prototype['parse hostname'] = E.prototype['parse host'] = function (p, a) {
		if (this.stateOverride && this.url.scheme === 'file')
			--this.pointer, (this.state = 'file host');
		else if (p === 58 && !this.arrFlag) {
			if (this.buffer === '') return (this.parseError = !0), v;
			let d = R1(this.buffer, D(this.url));
			if (d === v) return v;
			if (
				((this.url.host = d),
				(this.buffer = ''),
			...
			if ((--this.pointer, D(this.url) && this.buffer === '')) return (this.parseError = !0), v;
			if (this.stateOverride && this.buffer === '' && (Da(this.url) || this.url.port !== null))
	...
	E.prototype['parse port'] = function (p, a) {
		if (ke(p)) this.buffer += a;
			...
			if (this.buffer !== '') {
				...
				if (d > Math.pow(2, 16) - 1) return (this.parseError = !0), v;
				(this.url.port = d === G6(this.url.scheme) ? null : d), (this.buffer = '');
			}
			...
			p === 47 || p === 92
				...
				? isNaN(p)
					...
					: (this.input.length - this.pointer - 1 === 0 ||
					  !N6(p, this.input[this.pointer + 1]) ||
					  (this.input.length - this.pointer - 1 >= 2 && !z6.has(this.input[this.pointer + 2]))
							? ((this.url.host = this.base.host),
							  (this.url.path = this.base.path.slice()),
							  Sa(this.url))
							: (this.parseError = !0),
	...
	E.prototype['parse file host'] = function (p, a) {
		if (isNaN(p) || p === 47 || p === 92 || p === 63 || p === 35)
			if ((--this.pointer, !this.stateOverride && Ea(this.buffer)))
	...
	E.prototype['parse path'] = function (p) {
		if (
			...
			if (
				...
				D6(this.buffer)
					? (Sa(this.url), p !== 47 && !(D(this.url) && p === 92) && this.url.path.push(''))
					: _a(this.buffer) && p !== 47 && !(D(this.url) && p === 92)
					? this.url.path.push('')
					: _a(this.buffer) ||
					  (this.url.scheme === 'file' &&
	...
	E.prototype['parse query'] = function (p, a) {
	...
	function K6(e) {
		let p = e.scheme + '://';
		return (p += F1(e.host)), e.port !== null && (p += ':' + e.port), p;
	}
	F.exports.serializeURL = W6;
	F.exports.serializeURLOrigin = function (e) {
		switch (e.scheme) {
			...
			case 'ws':
			case 'wss':
				return K6({ scheme: e.scheme, host: e.host, port: e.port });
			case 'file':
				return 'file://';
			default:
				return 'null';
	...
	F.exports.basicURLParse = function (e, p) {
		p === void 0 && (p = {});
		let a = new E(e, p.baseURL, p.encodingOverride, p.url, p.stateOverride);
		return a.failure ? 'failure' : a.url;
	};
	F.exports.setTheUsername = function (e, p) {
		e.username = '';
		let a = ye.ucs2.decode(p);
		for (let d = 0; d < a.length; ++d) e.username += le(a[d], U1);
	};
	F.exports.setThePassword = function (e, p) {
		e.password = '';
		let a = ye.ucs2.decode(p);
		for (let d = 0; d < a.length; ++d) e.password += le(a[d], U1);
	};
	F.exports.serializeHost = F1;
	F.exports.cannotHaveAUsernamePasswordPort = H6;
...
var Aa = c(Na => {
	'use strict';
	var b = z();
	Na.implementation = class {
		constructor(p) {
			let a = p[0],
				d = p[1],
				t = null;
			if (d !== void 0 && ((t = b.basicURLParse(d)), t === 'failure'))
				throw new TypeError('Invalid base URL');
			let r = b.basicURLParse(a, { baseURL: t });
			if (r === 'failure') throw new TypeError('Invalid URL');
			this._url = r;
		}
		get href() {
			return b.serializeURL(this._url);
		}
		set href(p) {
			let a = b.basicURLParse(p);
			if (a === 'failure') throw new TypeError('Invalid URL');
			this._url = a;
		}
		get origin() {
			return b.serializeURLOrigin(this._url);
		}
		get protocol() {
			return this._url.scheme + ':';
		}
		set protocol(p) {
			b.basicURLParse(p + ':', { url: this._url, stateOverride: 'scheme start' });
		}
		get username() {
			return this._url.username;
		}
		set username(p) {
			b.cannotHaveAUsernamePasswordPort(this._url) || b.setTheUsername(this._url, p);
		}
		get password() {
			return this._url.password;
		}
		set password(p) {
			b.cannotHaveAUsernamePasswordPort(this._url) || b.setThePassword(this._url, p);
		}
		get host() {
			let p = this._url;
			return p.host === null
				? ''
				: p.port === null
				? b.serializeHost(p.host)
				: b.serializeHost(p.host) + ':' + b.serializeInteger(p.port);
		}
		set host(p) {
			this._url.cannotBeABaseURL || b.basicURLParse(p, { url: this._url, stateOverride: 'host' });
		}
		get hostname() {
			return this._url.host === null ? '' : b.serializeHost(this._url.host);
		}
		set hostname(p) {
			this._url.cannotBeABaseURL ||
				b.basicURLParse(p, { url: this._url, stateOverride: 'hostname' });
		}
		get port() {
			return this._url.port === null ? '' : b.serializeInteger(this._url.port);
		}
		set port(p) {
			b.cannotHaveAUsernamePasswordPort(this._url) ||
				(p === ''
					? (this._url.port = null)
					: b.basicURLParse(p, { url: this._url, stateOverride: 'port' }));
		}
		get pathname() {
		...
		set pathname(p) {
			this._url.cannotBeABaseURL ||
				((this._url.path = []),
				b.basicURLParse(p, { url: this._url, stateOverride: 'path start' }));
		}
		get search() {
		...
		set search(p) {
			...
			(a.query = ''), b.basicURLParse(d, { url: a, stateOverride: 'query' });
		}
		get hash() {
		...
		set hash(p) {
			...
			(this._url.fragment = ''), b.basicURLParse(a, { url: this._url, stateOverride: 'fragment' });
		}
		toJSON() {
			return this.href;
		}
...
var Ga = c((q0, Ue) => {
	...
	var j = sa(),
		...
		w = Oa.implSymbol;
	function N(e) {
		if (!this || this[w] || !(this instanceof N))
			throw new TypeError(
		...
		(p[0] = j.USVString(p[0])),
			p[1] !== void 0 && (p[1] = j.USVString(p[1])),
	...
	N.prototype.toJSON = function () {
		...
		return this[w].toJSON.apply(this[w], p);
	};
	...
	Object.defineProperty(N.prototype, 'protocol', {
		...
		set(e) {
			(e = j.USVString(e)), (this[w].protocol = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	Object.defineProperty(N.prototype, 'username', {
		...
		set(e) {
			(e = j.USVString(e)), (this[w].username = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	Object.defineProperty(N.prototype, 'password', {
		...
		set(e) {
			(e = j.USVString(e)), (this[w].password = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	...
	Object.defineProperty(N.prototype, 'hostname', {
		...
		set(e) {
			(e = j.USVString(e)), (this[w].hostname = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	...
	Object.defineProperty(N.prototype, 'pathname', {
		...
		set(e) {
			(e = j.USVString(e)), (this[w].pathname = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	Object.defineProperty(N.prototype, 'search', {
		...
		set(e) {
			(e = j.USVString(e)), (this[w].search = e);
		},
		enumerable: !0,
		configurable: !0,
	});
	...
	Ue.exports = {
		is(e) {
			return !!e && e[w] instanceof Pa.implementation;
		},
		create(e, p) {
		...
		setup(e, p, a) {
			a || (a = {}),
				(a.wrapper = e),
				(e[w] = new Pa.implementation(p, a)),
				(e[w][Oa.wrapperSymbol] = e);
		},
		interface: N,
...
var Ma = c((J, xa) => {
	...
	function La(e) {
		...
		return (
			d instanceof M &&
				...
				((p = new ka()), (a = new ka()), d.pipe(p), d.pipe(a), (e[Q].body = p), (d = a)),
			d
		);
	}
	function ja(e) {
	...
	function Ra(e) {
		if (((e = `${e}`), q1.test(e))) throw new TypeError(`${e} is not a legal HTTP header value`);
	}
	function De(e, p) {
		p = p.toLowerCase();
	...
	var y = Symbol('map'),
		k = class {
			constructor() {
				...
				if (((this[y] = Object.create(null)), p instanceof k)) {
					let a = p.raw(),
						d = Object.keys(a);
			...
			get(p) {
				(p = `${p}`), Fe(p);
				let a = De(this[y], p);
				return a === void 0 ? null : this[y][a].join(', ');
			}
			forEach(p) {
				...
				for (; t < d.length; ) {
					...
					let i = r[0],
						o = r[1];
					p.call(a, o, i, this), (d = I1(this)), t++;
				}
			}
			set(p, a) {
				(p = `${p}`), (a = `${a}`), Fe(p), Ra(a);
				let d = De(this[y], p);
				this[y][d !== void 0 ? d : p] = [a];
			}
			append(p, a) {
				(p = `${p}`), (a = `${a}`), Fe(p), Ra(a);
				let d = De(this[y], p);
				d !== void 0 ? this[y][d].push(a) : (this[y][p] = [a]);
			}
			has(p) {
				return (p = `${p}`), Fe(p), De(this[y], p) !== void 0;
			}
			delete(p) {
				(p = `${p}`), Fe(p);
				let a = De(this[y], p);
				a !== void 0 && delete this[y][a];
			}
			raw() {
				return this[y];
			}
		...
		return Object.keys(e[y])
			...
			.map(
				p === 'key'
					...
					: function (d) {
							return [d.toLowerCase(), e[y][d].join(', ')];
					  }
			);
	}
	var x1 = Symbol('internal');
	function B1(e, p) {
		let a = Object.create(H1);
		return (a[x1] = { target: e, kind: p, index: 0 }), a;
	}
	var H1 = Object.setPrototypeOf(
		{
			next() {
				if (!this || Object.getPrototypeOf(this) !== H1)
				...
				return d >= r
					? { value: void 0, done: !0 }
					: ((this[x1].index = d + 1), { value: t[d], done: !1 });
			},
		},
		Object.getPrototypeOf(Object.getPrototypeOf([][Symbol.iterator]()))
	);
	Object.defineProperty(H1, Symbol.toStringTag, {
	...
	function Q6(e) {
		let p = Object.assign({ __proto__: null }, e[y]),
			a = De(e[y], 'Host');
		...
		for (let a of Object.keys(e))
			if (!Ia.test(a))
				if (Array.isArray(e[a]))
					for (let d of e[a])
						q1.test(d) || (p[y][a] === void 0 ? (p[y][a] = [d]) : p[y][a].push(d));
				else q1.test(e[a]) || (p[y][a] = [e[a]]);
		return p;
	}
	...
	var X = Symbol('Request internals'),
		...
		t4 = p1.format;
	function L1(e) {
		return /^[a-zA-Z][a-zA-Z\d+\-.]*:/.exec(e) && (e = new a4(e).toString()), d4(e);
	}
	var r4 = 'destroy' in M.Readable.prototype;
	function e1(e) {
	...
	var K = class {
		constructor(p) {
			let a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
				d;
			e1(p) ? (d = L1(p.url)) : (p && p.href ? (d = L1(p.href)) : (d = L1(`${p}`)), (p = {}));
			...
			let r = a.body != null ? a.body : e1(p) && p.body !== null ? La(p) : null;
			...
			if (('signal' in a && (o = a.signal), o != null && !i4(o)))
	...
	function s4(e) {
		...
		if (e.signal && e.body instanceof M.Readable && !r4)
			throw new Error(
		...
		return (
			...
			Object.assign({}, p, { method: e.method, headers: Q6(a), agent: t })
		);
	}
	function Ce(e) {
		Error.call(this, e),
	...
	var M1 = p1.URL || Ca.URL,
		Ua = M.PassThrough,
		o4 = function (p, a) {
			let d = new M1(a).hostname,
				t = new M1(p).hostname;
	...
	function oe(e, p) {
		...
		return (
			...
			new oe.Promise(function (a, d) {
				let t = new K(e, p),
					r = s4(t),
					i = (r.protocol === 'https:' ? J6 : Fa).request,
					o = t.signal,
					s = null,
					m = function () {
				...
				function _() {
					n.abort(), o && o.removeEventListener('abort', l), clearTimeout(h);
				}
				t.timeout &&
					n.once('socket', function (g) {
						h = setTimeout(function () {
							d(new P(`network timeout at: ${t.url}`, 'request-timeout')), _();
						}, t.timeout);
					}),
					n.on('error', function (g) {
						d(new P(`request to ${t.url} failed, reason: ${g.message}`, 'system', g)), _();
					}),
					n.on('response', function (g) {
						clearTimeout(h);
						let ee = e4(g.headers);
						if (oe.isRedirect(g.statusCode)) {
							let Ie = ee.get('Location'),
								pe = null;
							try {
								pe = Ie === null ? null : new M1(Ie, t.url).toString();
							} catch {
							...
							switch (t.redirect) {
								...
								case 'follow':
									...
									if (t.counter >= t.follow) {
										d(new P(`maximum redirect reached at: ${t.url}`, 'max-redirect')), _();
										return;
									}
									let ce = {
									...
									if (!o4(t.url, pe))
										for (let s1 of ['authorization', 'www-authenticate', 'cookie', 'cookie2'])
											ce.headers.delete(s1);
									if (g.statusCode !== 303 && t.body && qa(t) === null) {
										d(
											new P(
									...
									(g.statusCode === 303 ||
										((g.statusCode === 301 || g.statusCode === 302) && t.method === 'POST')) &&
						...
						let O2 = { flush: ne.Z_SYNC_FLUSH, finishFlush: ne.Z_SYNC_FLUSH };
						if (ue == 'gzip' || ue == 'x-gzip') {
							(U = U.pipe(ne.createGunzip(O2))), (s = new C(U, Pe)), a(s);
							return;
						}
						if (ue == 'deflate' || ue == 'x-deflate') {
							g.pipe(new Ua()).once('data', function (pe) {
								(pe[0] & 15) === 8
...
var Qa = c(J1 => {
	...
	var Za = Ha(),
		Xa = m4(Ya()),
		l4 = Xa(e => console.warn(e)),
		n4 = Xa(e => console.warn(e)),
...
var Q1 = c(X1 => {
	...
	function e2(e) {
		...
		(h4.isPlainObject(e.body) || Array.isArray(e.body)) && (e.body = JSON.stringify(e.body));
		let a = {},
			d,
			t;
		return ((e.request && e.request.fetch) || f4)(
			e.url,
			Object.assign(
				...
				if (!(d === 204 || d === 205)) {
					...
					if (d === 304)
						throw new Le.RequestError('Not modified', d, {
							response: { url: t, status: d, headers: a, data: await Y1(i) },
							request: e,
						});
					if (d >= 400) {
						let o = await Y1(i);
						throw new Le.RequestError(_4(o), d, {
	...
	function Z1(e, p) {
		...
		return Object.assign(
			function (t, r) {
				let i = a.merge(t, r);
				if (!i.request || !i.request.hook) return e2(a.parse(i));
				let o = (s, m) => e2(a.parse(a.merge(s, m)));
				return Object.assign(o, { endpoint: a, defaults: Z1.bind(null, a) }), i.request.hook(o, i);
			},
			{ endpoint: a, defaults: Z1.bind(null, a) }
		);
	}
	var T4 = Z1(c4.endpoint, {
		headers: { 'user-agent': `octokit-request.js/${g4} ${v4.getUserAgent()}` },
	});
	X1.request = T4;
});
var d2 = c(je => {
...
`)
	...
	var d1 = class extends Error {
		...
		S4 = ['method', 'baseUrl', 'url', 'headers', 'request', 'query', 'mediaType'],
		D4 = ['query', 'method', 'url'],
		p2 = /\/api\/v3\/?$/;
	function N4(e, p, a) {
		if (a) {
		...
		return (
			p2.test(r) && (t.url = r.replace(p2, '/api/graphql')),
			e(t).then(i => {
				if (i.data.errors) {
					let o = {};
	...
	function ep(e, p) {
		let a = e.defaults(p);
		return Object.assign((t, r) => N4(a, t, r), {
			defaults: ep.bind(null, a),
			endpoint: a2.request.endpoint,
		});
	}
	var A4 = ep(a2.request, {
		headers: { 'user-agent': `octokit-graphql.js/${b4} ${E4.getUserAgent()}` },
		method: 'POST',
		url: '/graphql',
	});
	function P4(e) {
		return ep(e, { method: 'POST', url: '/graphql' });
	}
	je.GraphqlResponseError = d1;
	je.graphql = A4;
	je.withCustomRequest = P4;
});
var t2 = c(pp => {
	'use strict';
	...
	async function U4(e, p, a, d) {
		let t = p.endpoint.merge(a, d);
		return (t.headers.authorization = R4(e)), p(t);
	}
	var F4 = function (p) {
		...
		return (
			...
			Object.assign(k4.bind(null, p), { hook: U4.bind(null, p) })
		);
	};
	pp.createTokenAuth = F4;
});
var s2 = c(ap => {
	'use strict';
	...
	var i2 = '3.6.0',
		...
		qe = class {
			constructor(p = {}) {
				let a = new B4.Collection(),
					d = {
						baseUrl: r2.request.endpoint.DEFAULTS.baseUrl,
						headers: {},
						request: Object.assign({}, p.request, { hook: a.bind(null, 'request') }),
						mediaType: { previews: [], format: '' },
					};
				if (
					((d.headers['user-agent'] = [p.userAgent, `octokit-core.js/${i2} ${C4.getUserAgent()}`]
						.filter(Boolean)
						.join(' ')),
					p.baseUrl && (d.baseUrl = p.baseUrl),
					p.previews && (d.mediaType.previews = p.previews),
					p.timeZone && (d.headers['time-zone'] = p.timeZone),
					(this.request = r2.request.defaults(d)),
					(this.graphql = L4.withCustomRequest(this.request).defaults(d)),
					...
					let r = j4.createTokenAuth(p.auth);
...
var h2 = c(t1 => {
	...
	function m2(e) {
		for (var p = 1; p < arguments.length; p++) {
			...
			p % 2
				? o2(Object(a), !0).forEach(function (d) {
						M4(e, d, a[d]);
				  })
				: Object.getOwnPropertyDescriptors
				? Object.defineProperties(e, Object.getOwnPropertyDescriptors(a))
				: o2(Object(a)).forEach(function (d) {
	...
	function u2(e, p) {
		...
		for (let [d, t] of Object.entries(p))
			for (let [r, i] of Object.entries(t)) {
				let [o, s, m] = i,
					[l, n] = o.split(/ /),
					h = Object.assign({ method: l, url: n }, s);
				a[d] || (a[d] = {});
				let _ = a[d];
				if (m) {
					_[r] = H4(e, d, r, h, m);
				...
				_[r] = e.request.defaults(h);
			}
		return a;
	}
	function H4(e, p, a, d, t) {
	...
	function v2(e) {
		let p = u2(e, l2);
		return m2(m2({}, p), {}, { rest: p });
	}
	v2.VERSION = n2;
	t1.legacyRestEndpointMethods = v2;
	t1.restEndpointMethods = c2;
});
var b2 = c(Ae => {
	'use strict';
	...
	function g2(e) {
		for (var p = 1; p < arguments.length; p++) {
			var a = arguments[p] != null ? arguments[p] : {};
			p % 2
				? f2(Object(a), !0).forEach(function (d) {
						z4(e, d, a[d]);
				  })
				: Object.getOwnPropertyDescriptors
				? Object.defineProperties(e, Object.getOwnPropertyDescriptors(a))
				: f2(Object(a)).forEach(function (d) {
						Object.defineProperty(e, d, Object.getOwnPropertyDescriptor(a, d));
				  });
		}
		return e;
	...
	function w2(e, p, a, d) {
		return (
			...
			_2(e, [], dp(e, p, a)[Symbol.asyncIterator](), d)
		);
	}
	function _2(e, p, a, d) {
		return a.next().then(t => {
			...
			return (p = p.concat(d ? d(t.value, i) : t.value.data)), r ? p : _2(e, p, a, d);
		});
	}
	var K4 = Object.assign(w2, { iterator: dp }),
		T2 = [
	...
	function J4(e) {
		return typeof e == 'string' ? T2.includes(e) : !1;
	}
	function E2(e) {
		return { paginate: Object.assign(w2.bind(null, e), { iterator: dp.bind(null, e) }) };
	}
	E2.VERSION = $4;
	Ae.composePaginateRest = K4;
	Ae.isPaginatingEndpoint = J4;
	Ae.paginateRest = E2;
	Ae.paginatingEndpoints = T2;
});
var D2 = c(R => {
	'use strict';
	var Y4 =
		...
		S2 =
			...
			function (e) {
				...
				var p = {};
				if (e != null)
					for (var a in e) a !== 'default' && Object.hasOwnProperty.call(e, a) && Y4(p, e, a);
				return Z4(p, e), p;
			};
	...
	var X4 = S2(D1()),
		...
		e0 = h2(),
		p0 = b2();
	R.context = new X4.Context();
	var y2 = tp.getApiBaseUrl(),
		a0 = { baseUrl: y2, request: { agent: tp.getProxyAgent(y2) } };
	R.GitHub = Q4.Octokit.plugin(e0.restEndpointMethods, p0.paginateRest).defaults(a0);
	function d0(e, p) {
		let a = Object.assign({}, p || {}),
			d = tp.getAuthString(e, a);
		return d && (a.auth = d), a;
	}
	R.getOctokitOptions = d0;
});
var A2 = c(q => {
	'use strict';
	var t0 =
		...
		i0 =
			...
			function (e) {
				...
				var p = {};
				if (e != null)
					for (var a in e) a !== 'default' && Object.hasOwnProperty.call(e, a) && t0(p, e, a);
				return r0(p, e), p;
			};
	Object.defineProperty(q, '__esModule', { value: !0 });
	q.getOctokit = q.context = void 0;
	var s0 = i0(D1()),
		N2 = D2();
	q.context = new s0.Context();
	function o0(e, p) {
		return new N2.GitHub(N2.getOctokitOptions(e, p));
	}
	q.getOctokit = o0;
});
var r1 = ip(w1()),
...
function m0(e) {
	return (
		...
		e === 'image-optimization' ? 'images' : e === 'pub/sub' ? 'pub-sub' : e.replace(/\//g, '')
	);
}
(async function () {
	try {
		let e = r1.getInput('GITHUB_TOKEN', { required: !0 }),
			p = i1.context.payload;
		console.log('event payload:', JSON.stringify(p, null, 2));
		let { action: a, repository: d, issue: t } = p;
		if (!t) throw new Error('Missing "issue" object!');
		if (a !== 'opened') throw new Error('Must be "issues.opened" event!');
		if ((t.labels || []).map(n => n.name).includes('engineering'))
			return console.log('ignore "engineering" issues');
		let i = t.body;
		if (!i) throw new Error('Missing "issue.body" content!');
		if (!t.number) throw new Error('Missing "issue.number" value!');
		if (!i.startsWith('### Which Cloudflare product'))
			throw new Error('Missing "Which Cloudflare product(s)" dropdown!');
		let [, o] = /\n\n([^\n]+)\n\n/.exec(i) || [];
		if (!o) throw new Error('Error parsing "products" response');
		let s = new Set(),
			m = o.split(/,\s*/g).filter(Boolean);
		for (let n of m) {
			let h = m0(n),
				_ = P2[h];
			if (!_) throw (console.error({ name: n, slug: h }), new Error('Unknown product!'));
			_.length > 0 ? _.forEach(g => s.add(g)) : s.add('haleycode');
		}
		for (let n of t.assignees) s.delete(n.login);
		console.log({ products: m, users: s }),
			await i1.getOctokit(e).rest.issues.addAssignees({
				owner: d.owner.login,
