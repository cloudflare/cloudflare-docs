// Binary templates (reused across types)
const binaryData = (type: string) =>
	`Raw binary ${type} data sent as request body`;
export const binaryAudio = () => binaryData("audio");
...
const binaryImage = () => binaryData("image");

export const objectDetectionBinary = binaryImage;
...
export const imageToTextBinary = binaryImage;
export const imageToTextImage = () => `{
  "image": [255, 255, 255, ...],
  "prompt": "Describe this image"
}`;

export const imageToTextOutput = () => `{
  "description": "A detailed description of the image content generated by the model"
}`;

export const imageClassificationBinary = binaryImage;
export const imageClassificationImage = () => `{
  "image": [255, 255, 255, ...]
}`;

export const imageClassificationOutput = () => `[
  {
    "score": 0.8234,
