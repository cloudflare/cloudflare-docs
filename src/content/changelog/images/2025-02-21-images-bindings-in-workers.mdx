...
You can now [interact with the Images API](/images/optimization/binding/) directly in your Worker.
...
For more information, refer to [Images Bindings](/images/optimization/binding/).
