...
You can now [interact with the Images API](/images/optimization/transformations/bindings/) directly in your Worker.
...
For more information, refer to [Images Bindings](/images/optimization/transformations/bindings/).
