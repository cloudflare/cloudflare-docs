...
This list is based on the following IP ranges: [https://www.cloudflare.com/en-gb/ips/](https://www.cloudflare.com/en-gb/ips/)  
...
Note: IP Lists requires an advanced magic firewall subscription, for more details about Magic Firewall plans, refer to [Plans](/magic-firewall/plans).