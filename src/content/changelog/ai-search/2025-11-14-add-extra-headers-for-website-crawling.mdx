...
To add custom headers when creating an AI Search instance, select **Parse options**. Through the **Extra headers** section, you can add up to five custom headers per Website data source.
