---
title: Custom headers support for website crawling in AI Search
description: Add up to five custom HTTP headers to access protected content when crawling websites, including support for Cloudflare Access service tokens.
products:
  - ai-search
date: 2025-11-14
---

[AI Search](/ai-search/) now supports [custom HTTP headers](/ai-search/configuration/data-source/website/#access-protected-content) for website crawling, solving a common problem where valuable content behind authentication or access controls couldn't be indexed.
...
To add custom headers, when creating an AI Search instance select **Parse options** and through the **Extra headers** section you can add up to five custom headers per Website data source.
