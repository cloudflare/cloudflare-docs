...
You can now filter [AutoRAG](/ai-search/) search results by `folder` and `timestamp` using [metadata filtering](/ai-search/configuration/retrieval/metadata) to narrow down the scope of your query.
