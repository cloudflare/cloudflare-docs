...
The most common use case is automation. You can trigger a sync job from your CI or automated pipelines with `jobs create` so your index refreshes whenever your content changes.
