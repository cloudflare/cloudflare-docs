...
The `create` command guides you through setup, picking a name, source type (`r2` or `web`), and data source. You can also pass all options as flags for non-interactive use:
