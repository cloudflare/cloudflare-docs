...
-   **Email Notifications:** We now automatically notify users by email when they provide an invalid submission, educating them on the correct format. To disable this, go to [Settings](https://one.dash.cloudflare.com/?to=/:account/email-security/settings) → **Invalid submission emails** and toggle the feature off.
