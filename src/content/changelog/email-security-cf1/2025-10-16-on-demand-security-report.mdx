...
-   **Executive Summary:** Quickly view the performance of your Email Security with a high-level executive summary.
...
To get started, learn how to [download a security report](https://developers.cloudflare.com/cloudflare-one/email-security/email-monitoring/download-report/#download-a-security-report).
