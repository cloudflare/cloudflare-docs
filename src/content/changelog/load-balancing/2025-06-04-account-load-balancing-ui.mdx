...
We're excited to announce a significant enhancement to the Cloudflare Load Balancing experience! We've launched a redesigned user interface, now centralized at the **account level**, and introduced [**Private Load Balancers**](/load-balancing/private-network/) to the UI, enabling you to manage traffic for all of your external and internal applications in a single spot.
