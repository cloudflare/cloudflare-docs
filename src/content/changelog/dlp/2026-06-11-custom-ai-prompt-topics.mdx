...
Custom topics run through the same [application granular controls](/cloudflare-one/traffic-policies/policy-types/http-policies/selectors/#granular-controls) path as predefined AI prompt topics. Custom topics are available for ChatGPT, Google Gemini, Perplexity, and Claude.
