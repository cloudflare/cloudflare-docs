...
description: Cloudflare now predicts the key agreement algorithm preferred by origin servers, helping establish TLS 1.3 connections faster.
date: 2026-07-21
products:
  - ssl
---
...
Automatic key exchange is on for all existing zones and on by default for new zones. When an origin supports both classical and post-quantum key agreements, Cloudflare prefers the standardized `X25519MLKEM768` hybrid key agreement.
