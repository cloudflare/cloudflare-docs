...
### Analyzing navigation types in the Cloudflare dashboard
...
To see the list of popular Navigation Types, navigate to the "Page views" tab on the left-hand side of Web Analytics and scroll down to the bottom:
