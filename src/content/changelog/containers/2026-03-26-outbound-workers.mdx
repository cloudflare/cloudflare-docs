...
Refer to [Containers outbound traffic](/containers/platform-details/outbound-traffic/) and [Sandboxes outbound traffic](/sandbox/guides/outbound-workers/) for more details and examples.
