...
Refer to [Containers outbound traffic](/containers/concepts/outbound-traffic/) and [Sandboxes outbound traffic](/sandbox/guides/outbound-traffic/) for more details and examples.
