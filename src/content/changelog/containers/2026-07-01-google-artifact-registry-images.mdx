...
Only `*-docker.pkg.dev` hosts are supported. To configure credentials, refer to [Use private Google Artifact Registry images](/containers/guides/image-management/#use-private-google-artifact-registry-images).

For more information, refer to [Image management](/containers/guides/image-management/).
