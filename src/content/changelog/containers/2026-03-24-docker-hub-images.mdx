...
Containers also support private Docker Hub images. To configure credentials, refer to [Use private Docker Hub images](/containers/guides/image-management/#use-private-docker-hub-images).
