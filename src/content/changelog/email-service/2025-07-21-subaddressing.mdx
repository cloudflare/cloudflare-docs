...
![Subaddressing](~/assets/images/changelog/email-service/subaddressing.png)

Check our [Developer Docs](/email-service/configuration/email-routing-addresses/#subaddressing) to learn how to enable subaddressing in Email Routing.
