...
Local development is a critical part of the development flow, and also works for sending, replying and forwarding emails. See [local development for email routing](/email-service/guides/local-development/routing/) for more information.
