...
Start sending and receiving emails from Workers and agents today. Read the [Email Service documentation](/email-service/) to get started. Email Sending is available on the Workers paid plan.
