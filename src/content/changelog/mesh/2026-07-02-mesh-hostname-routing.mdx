...
You can now add [hostname routes](/mesh/features/routes/#hostname-routes) to a Cloudflare Mesh node, in addition to CIDR routes.
...
For setup steps, prerequisites, and DNS options, refer to [Hostname routes](/mesh/features/routes/#hostname-routes).
