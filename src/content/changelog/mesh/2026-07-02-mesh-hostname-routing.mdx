...
You can now add [hostname routes](/cloudflare-one/networks/connectors/cloudflare-mesh/features/routes/#hostname-routes) to a Cloudflare Mesh node, in addition to CIDR routes.
...
For setup steps, prerequisites, and DNS options, refer to [Hostname routes](/cloudflare-one/networks/connectors/cloudflare-mesh/features/routes/#hostname-routes).
