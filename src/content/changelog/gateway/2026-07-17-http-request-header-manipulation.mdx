...
Cloudflare Gateway now supports advanced header control on [Allow policies](/cloudflare-one/traffic-controls/http-policies/#allow). Administrators can add, overwrite, or delete headers on matching requests using static values or dynamic variables.
