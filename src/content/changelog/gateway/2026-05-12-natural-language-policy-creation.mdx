...
Cloudflare Gateway now supports natural language policy creation for [DNS](/cloudflare-one/traffic-policies/policy-types/dns-policies/), [HTTP](/cloudflare-one/traffic-policies/policy-types/http-policies/), and [Network](/cloudflare-one/traffic-policies/policy-types/network-policies/) firewall policies. Administrators can describe the outcome they want in plain language, and Cloudflare will generate a complete policy rule that populates the policy builder form.
