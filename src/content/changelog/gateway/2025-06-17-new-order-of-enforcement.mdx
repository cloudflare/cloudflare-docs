...
[Gateway](/cloudflare-one/traffic-controls/) will now evaluate [Network (Layer 4) policies](/cloudflare-one/traffic-controls/network-policies/) **before** [HTTP (Layer 7) policies](/cloudflare-one/traffic-controls/http-policies/). This change preserves your existing security posture and does not affect which traffic is filtered — but it may impact how notifications are displayed to end users.
...
To learn more, visit the [Gateway order of enforcement documentation](/cloudflare-one/traffic-controls/order-of-enforcement/).
