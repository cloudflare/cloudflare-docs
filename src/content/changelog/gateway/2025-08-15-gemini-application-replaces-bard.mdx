...
For more information about application policies, please see the [Cloudflare Gateway documentation](/cloudflare-one/traffic-policies/reference/application-app-types/).
