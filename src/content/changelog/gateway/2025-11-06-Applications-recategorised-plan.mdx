...
We have previously added new application categories to better reflect their content and improve HTTP traffic management: [see changelog](cloudflare-one/changelog/gateway/#2025-10-28). 
