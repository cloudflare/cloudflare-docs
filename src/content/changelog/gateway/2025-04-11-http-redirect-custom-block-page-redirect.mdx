...
Learn more in our documentation for [HTTP Redirect](/cloudflare-one/traffic-controls/http-policies/#redirect) and [Block page redirect](/cloudflare-one/reusable-components/custom-pages/gateway-block-page/#redirect-to-a-block-page).
