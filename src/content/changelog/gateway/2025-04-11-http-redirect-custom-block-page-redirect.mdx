...
Learn more in our documentation for [HTTP Redirect](/cloudflare-one/traffic-policies/policy-types/http-policies/actions/#redirect) and [Block page redirect](/cloudflare-one/reusable-components/custom-pages/gateway-block-page/#redirect-to-a-block-page).
