...
Gateway users can now apply granular controls to their file sharing and AI chat applications through [HTTP policies](/cloudflare-one/traffic-policies/policy-types/http-policies/).
...
Get started using [Application Granular Controls](/cloudflare-one/traffic-policies/policy-types/http-policies/granular-controls) and refer to the list of [supported applications](/cloudflare-one/traffic-policies/policy-types/http-policies/granular-controls/#compatible-applications).
