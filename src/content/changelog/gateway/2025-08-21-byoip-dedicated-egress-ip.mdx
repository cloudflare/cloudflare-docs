...
For more information, refer to [BYOIP for dedicated egress IPs](/cloudflare-one/traffic-controls/egress-policies/dedicated-egress-ips/#bring-your-own-ip-address-byoip).
