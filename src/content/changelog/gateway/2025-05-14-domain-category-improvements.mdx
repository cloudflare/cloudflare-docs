...
description: We've added 7 new Domain Categories and renamed 3 Domain Categories, to better reflect online content and enable DNS filtering
...
Learn more in the [Gateway domain categories developer docs](/cloudflare-one/policies/gateway/domain-categories/) 
