...
- **Upload Health**: See how much data was successfully uploaded, where drops occurred, and how your jobs are performing overall, including data completeness, success rate, and upload volume.
...
For more details, refer to our [**Logpush Health Dashboards**](/logs/logpush/logpush-health) documentation, which includes a comprehensive troubleshooting guide to help interpret and resolve common issues.
