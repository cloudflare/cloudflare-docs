...
### What's new
- New subrequest_merging field on Logpush jobs — Set "subrequest_merging": true when creating or updating an http_requests Logpush job to enable the feature.
...
- Subrequests must complete within 5 minutes of the parent request. Subrequests that exceed this window are passed through unmodified.
