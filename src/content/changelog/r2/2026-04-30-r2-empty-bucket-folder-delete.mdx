...
You can now empty an entire [R2](/r2/) bucket or delete folders directly from the dashboard. Emptying a bucket is required before you can delete it. Previously, this required scripting or configuring [lifecycle rules](/r2/buckets/object-lifecycles/). Now, the dashboard can handle it in a single action.
