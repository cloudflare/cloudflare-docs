...
**Update:** We later reinstated the maximum request-payload size the Cloudflare WAF inspects. Refer to [Updating the WAF maximum payload values](/changelog/2025-12-05-waf-max-payload-size-change/) for details.
