...
<table style="width: 100%">
   ...
   <tr>
    ...
    <tr>
      ...
      <td>Log</td>
      <td>Block</td>
      <td>This rule has been merged into the original rule "PHP, vBulletin, jQuery File Upload - Code Injection, Dangerous File Upload - CVE:CVE-2018-9206, CVE:CVE-2019-17132" (ID: <RuleID id="0f2da91cec674eb58006929e824b817c" />)
    </tr>
  </tbody>    
</table>
