...
<table style="width: 100%">
	...
	<tbody>
		<tr>
			...
			<td>Block</td>
			<td>
				This rule has been merged into the original rule "Command Injection -
				Common Attack Commands" (ID:{" "}
				<RuleID id="89557ce9b26e4d4dbf29e90c28345b9b" />) for New WAF customers
				only.
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>Block</td>
			<td>
				This rule is merged into the original rule "Common Payloads for
				Server-Side Template Injection" (ID:{" "}
		...
		<tr>
			...
			<td>100872</td>
			<td>
				WordPress:Plugin:InfiniteWP Client - Missing Authorization -
				CVE:CVE-2020-8772
			</td>
			<td>Log</td>
			<td>Block</td>
