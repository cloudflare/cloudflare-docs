...
![Vite local dev tunnel demo](~/assets/images/changelog/workers/local-dev-tunnel-demo.gif)
...
- use an existing [named tunnel](/tunnel/setup/#create-a-tunnel) for a stable hostname and Access-protected sharing.
