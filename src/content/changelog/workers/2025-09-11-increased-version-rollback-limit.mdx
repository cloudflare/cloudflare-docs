...
- Split traffic using [split deployments](/workers/configuration/versions-and-deployments/split-deployments/) between your latest code and any of the 100 most recent versions.
