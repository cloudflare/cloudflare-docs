...
Now, you can use [remote bindings with your OpenNext applications](https://opennext.js.org/cloudflare/bindings#remote-bindings) by enabling the experimental feature in your `next.config.ts`:
