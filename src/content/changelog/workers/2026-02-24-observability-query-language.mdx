...
![Workers Observability query language help modal showing operators, functions, and example queries](~/assets/images/changelog/workers/observability/2026-02-24-query-language.png)
...
Head to the [Workers Observability dashboard](https://dash.cloudflare.com/?to=/:account/workers-and-pages/observability/) to try the query language today.
