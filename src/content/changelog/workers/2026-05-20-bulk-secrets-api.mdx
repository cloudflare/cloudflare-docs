...
You can now create, update, or delete multiple secrets on a Worker script in a single request using the new [`PATCH /secrets-bulk` endpoint](/api/resources/workers/subresources/scripts/subresources/secrets/methods/bulk_update/).
