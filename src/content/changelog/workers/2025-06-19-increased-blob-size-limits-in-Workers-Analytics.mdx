...
We’ve increased the total allowed size of [`blob`](/analytics/analytics-engine/get-started/#2-write-data-points-from-your-worker) fields per request from **5 KB to 16 KB** in the Workers Analytics Engine.
