---
title: Workers traces now automatically include JavaScript RPC session spans
...
Enable tracing with one setting in your [Wrangler configuration file](/workers/wrangler/configuration/#observability):
...
For supported spans and attributes, refer to [Spans and attributes](/workers/observability/traces/spans-and-attributes/).
