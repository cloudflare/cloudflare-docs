...
(through the [`deploy` command](https://developers.cloudflare.com/workers/wrangler/commands/#deploy)), would allow the user to override the Worker's dashboard settings without providing details on
