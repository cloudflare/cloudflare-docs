...
Now you can easily compare metrics across Worker versions, understand the current state of a [split deployment](/workers/configuration/versions-and-deployments/split-deployments/), and review key Workers metrics in a single view. This new interface enables you to:
...
- Monitor and compare active split deployments.
