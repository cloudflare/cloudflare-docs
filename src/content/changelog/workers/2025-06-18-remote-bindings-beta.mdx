...
- [Wrangler v4.20.3](/workers/local-development/#remote-bindings): Use the `wrangler dev --x-remote-bindings` command.
- The [Cloudflare Vite Plugin](/workers/local-development/#remote-bindings): Refer to the documentation for how to enable in your Vite config.
- The [Cloudflare Vitest Plugin](/workers/local-development/#remote-bindings): Refer to the documentation for how to enable in your Vitest config.
