...
Check out the [Developing with multiple Workers](/workers/local-development/multi-workers) guide to learn more about the different approaches and when to use each one.
