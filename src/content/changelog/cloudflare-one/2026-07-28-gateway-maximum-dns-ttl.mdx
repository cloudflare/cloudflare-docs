...
- **Per-location** - Each [DNS location](/cloudflare-one/traffic-controls/resolver-endpoints/) can inherit the account setting, disable the cap, or override it with a custom value.
...
For more information, refer to [Maximum DNS TTL](/cloudflare-one/traffic-controls/dns-policies/maximum-dns-ttl/).
