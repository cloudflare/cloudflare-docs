...
To access the new overview, log in to your Cloudflare [Zero Trust dashboard](https://dash.cloudflare.com/one/) and go to Analytics in the side navigation bar.
