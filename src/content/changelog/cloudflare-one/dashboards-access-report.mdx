...
Both features are accessible in the Cloudflare [Zero Trust dashboard](https://dash.cloudflare.com/one/), empowering organizations with better visibility and control.
