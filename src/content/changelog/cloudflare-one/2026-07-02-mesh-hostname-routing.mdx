...
You can now add **hostname routes** to a [Cloudflare Mesh](/cloudflare-one/networks/connectors/cloudflare-mesh/) node, in addition to CIDR routes.
...
Add a hostname route from **Networking** > **Mesh** > select a node > **Routes** > **Add route** > **Private hostname**.
