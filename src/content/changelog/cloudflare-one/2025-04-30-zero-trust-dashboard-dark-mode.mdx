...
The [Cloudflare Zero Trust dashboard](https://dash.cloudflare.com/one/) now supports Cloudflare's native dark mode for all accounts and plan types.
...
1. Log into the [Zero Trust dashboard](https://dash.cloudflare.com/one/).
