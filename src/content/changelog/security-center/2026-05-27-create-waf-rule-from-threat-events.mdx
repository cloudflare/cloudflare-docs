...
* **Dashboard:** Navigate to **Cloudflare Dashboard > Application Security > Threat Intelligence > Manage Views**, select your desired view, and click **Create WAF Rule**. This will automatically pre-populate the [WAF rule builder](https://developers.cloudflare.com/firewall/cf-dashboard/create-edit-delete-rules/) with the matching threat event IP indicators.
* **API:** You can also automate this workflow by utilizing the [**WAF Rule Builder API**](https://developers.cloudflare.com/firewall/api/cf-firewall-rules/) alongside your [Threat Events saved views endpoints](https://developers.cloudflare.com/firewall/api/cf-firewall-rules/).
