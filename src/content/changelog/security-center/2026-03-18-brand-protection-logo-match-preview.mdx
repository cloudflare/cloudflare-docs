...
Ready to test your brand assets? Head over to the [Brand Protection dashboard](https://developers.cloudflare.com/security-center/brand-protection/) to try the new preview tool.
