...
To set up an alert, go to **Security Center** > **Cloudforce One** > **Threat Events**. From there:
 
1. Apply your desired filters and select **Save View** (or select an existing one).
