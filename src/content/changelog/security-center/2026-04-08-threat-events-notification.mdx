...
To set up an alert, navigate to **Security Center > Cloudforce One > Threat Events**. From there:
 
1. Apply your desired filters and click **Save View** (or select an existing one).
2. Open the **Manage Saved Views** menu.
3. Click **Add Alert** next to your chosen view to configure your notification preferences in the Cloudflare Dashboard.
 
For more technical details on configuring notifications, refer to the [Threat Events documentation](/security-center/threat-intelligence/threat-events/).
