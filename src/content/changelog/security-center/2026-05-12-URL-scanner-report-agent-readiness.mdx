...
* **Dashboard:** Navigate to **Protect & Connect > Application Security > Investigate**. After running a scan, select the **Agent Readiness** tab in the report.
...
To learn more about the methodology behind these scores, read the [blogpost](https://blog.cloudflare.com/agent-readiness/).
