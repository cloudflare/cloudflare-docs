...
We have significantly upgraded our Logo Matching capabilities within Brand Protection. While previously limited to ~100% matches, users can now detect a wider range of brand assets through a redesigned matching model and UI.
...
- **Direct logo previews:** Available in the dashboard — similar to string matches — to verify infringements at a glance.
