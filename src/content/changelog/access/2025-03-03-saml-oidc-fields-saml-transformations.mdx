---
title: More configuration options for Access for SaaS
...
![OIDC field additions](~/assets/images/access/oidc-claims.png)

SAML apps now include improved SAML attribute mapping from an IdP.

![SAML field additions](~/assets/images/access/saml-attribute-statements.png)
...
![Configured SAML statement sent to application](~/assets/images/access/transformation-box.png)
