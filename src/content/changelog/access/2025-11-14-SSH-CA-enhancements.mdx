...
Previously, users had to generate this certificate by using the [Cloudflare API](https://developers.cloudflare.com/api/) directly. With this update, certificates can now be created and referenced directly from the dashboard.

Go to the [Cloudflare dashboard](https://one.dash.cloudflare.com/), navigate to "Access controls" and then "Service credentials" to see where you can generate an SSH CA.
