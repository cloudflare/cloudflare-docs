...
Previously, users had to generate this certificate by using the [Cloudflare API](https://developers.cloudflare.com/api/) directly. With this update, you can now create and manage this certificate in the [Cloudflare One dashboard](https://dash.cloudflare.com/one/) from the **Access controls** > **Service credentials** page.
