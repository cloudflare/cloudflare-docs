...
For configuration details, refer to [Configure Automatic Return Routing](/cloudflare-wan/configuration/manually/how-to/configure-routes/#configure-automatic-return-routing-beta).
