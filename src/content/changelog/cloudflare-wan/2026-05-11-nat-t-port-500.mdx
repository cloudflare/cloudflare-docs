...
Cloudflare IPsec now supports the standard NAT traversal (NAT-T) flow defined in [RFC 3947](https://datatracker.ietf.org/doc/rfc3947/) and [RFC 7296](https://datatracker.ietf.org/doc/rfc7296/), where IKE begins on UDP port `500` and switches to UDP port `4500` after NAT is detected.
