...
To access the new overview, log in to your Cloudflare [Zero Trust dashboard](https://dash.cloudflare.com/one/) and find Browser Isolation in the side navigation bar.
