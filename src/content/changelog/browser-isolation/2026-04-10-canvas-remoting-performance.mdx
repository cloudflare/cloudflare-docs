...
Currently supports 2D Canvas contexts only. WebGL and 3D graphics applications continue using bitmap rendering. For more information, refer to [Canvas rendering](/cloudflare-one/remote-browser-isolation/canvas-rendering/).
