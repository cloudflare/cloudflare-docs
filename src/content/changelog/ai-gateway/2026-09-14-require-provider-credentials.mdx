---
title: Force BYOK for third-party requests
...
For configuration details and request-level controls, refer to [Force BYOK for third-party requests](/ai-gateway/features/unified-billing/#force-byok-for-third-party-requests).
