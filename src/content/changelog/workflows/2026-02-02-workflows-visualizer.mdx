...
Your Workflow definition is parsed to provide a visual map of the Workflow structure, allowing you to:
...
You can also collapse loops and nested logic to see the high-level flow, or expand them to see every step.
