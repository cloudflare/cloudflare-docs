...
[Workflows](/workflows/) created on or after August 27, 2026, on the Workers Paid plan retain completed and errored instance state for seven days by default instead of 30 days. The maximum retention [limit](/workflows/reference/limits/) remains 30 days. 
