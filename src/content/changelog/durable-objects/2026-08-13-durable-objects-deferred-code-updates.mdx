...
For more information, including how this interacts with gradual deployments and the REST API, refer to [Delay code updates until hibernation](/durable-objects/reference/durable-objects-code-updates/).
