...
![Try out the free version of Magic Network Monitoring](~/assets/images/changelog/network-flow/get-started.png)

For more details, refer to the [Get started guide](/network-flow/get-started/).
