...
- **Broad resource type support** -- Tag resources like Workers scripts, zones, custom hostnames, D1 databases, R2 buckets, KV namespaces, Access application policies, and more.
