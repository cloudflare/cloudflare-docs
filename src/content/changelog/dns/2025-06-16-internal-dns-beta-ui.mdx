---
title: Internal DNS beta UI release
description: The Internal DNS beta is now fully available in the Cloudflare dashboard.
date: 2025-06-16T16:00:00Z
---

Participating beta testers can now fully configure Internal DNS directly in the [Cloudflare dashboard](https://dash.cloudflare.com/?to=/:account/internal-dns).
...
![Internal DNS UI](~/assets/images/changelog/dns/internal-dns-ui.png)
