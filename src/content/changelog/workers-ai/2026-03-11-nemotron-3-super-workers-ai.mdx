...
<Render file="session-affinity-note" product="workers-ai" />

Use Nemotron 3 Super through the [Workers AI binding](/workers-ai/configuration/bindings/) (`env.AI.run()`), the REST API at `/run` or `/v1/chat/completions`, or the [OpenAI-compatible endpoint](/workers-ai/configuration/open-ai-compatibility/).
