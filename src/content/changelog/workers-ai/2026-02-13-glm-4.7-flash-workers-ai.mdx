...
Use GLM-4.7-Flash through the [Workers AI binding](/pages/functions/bindings/#workers-ai) (`env.AI.run()`), the REST API at `/run` or `/v1/chat/completions`, [AI Gateway](/ai-gateway/), or via [workers-ai-provider](/workers-ai/configuration/ai-sdk/) for the Vercel AI SDK.
