...
Use GLM-4.7-Flash through the [Workers AI binding](/workers-ai/configuration/workers-ai-binding/) (`env.AI.run()`), the REST API at `/run` or `/v1/chat/completions`, [AI Gateway](/ai-gateway/), or via [workers-ai-provider](/workers-ai/configuration/ai-sdk/) for the Vercel AI SDK.
