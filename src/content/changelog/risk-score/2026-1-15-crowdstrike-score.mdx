...
Cloudflare One has expanded its [User Risk Scoring](/cloudflare-one/team-and-resources/users/risk-score/) capabilities by introducing two new behaviors for organizations using the [CrowdStrike integration](/cloudflare-one/integrations/service-providers/crowdstrike/).
