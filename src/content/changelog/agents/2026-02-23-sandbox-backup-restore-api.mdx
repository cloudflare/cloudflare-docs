...
Backups are stored in [R2](/r2) and can take advantage of [R2 object lifecycle rules](/sandbox/sdk/guides/backup-restore/#configure-r2-lifecycle-rules-for-automatic-cleanup) to ensure they do not persist forever.
...
To get started, refer to the [backup and restore guide](/sandbox/sdk/guides/backup-restore/) for setup instructions and usage patterns, or the [Backups API reference](/sandbox/sdk/api/backups/) for full method documentation.
