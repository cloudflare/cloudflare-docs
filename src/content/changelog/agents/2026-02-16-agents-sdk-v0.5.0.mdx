...
The latest release of the [Agents SDK](https://github.com/cloudflare/agents) adds built-in retry utilities, a fully rewritten `@cloudflare/ai-chat` with zero braking changes, and several bug fixes.
