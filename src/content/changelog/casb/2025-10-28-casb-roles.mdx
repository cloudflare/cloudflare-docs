...
To configure [Data Loss Prevention (DLP)](/cloudflare-one/data-loss-prevention/dlp-profiles/), you need to be an admin with the **Cloudflare Zero Trust** role.
...
To learn more about managing user permissions, refer to the [Manage account members and roles documentation](/fundamentals/setup/manage-members/roles/).
