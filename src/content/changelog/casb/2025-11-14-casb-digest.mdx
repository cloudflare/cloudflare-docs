...
To opt-in, navigate to the Navigations tab under Manage account in the Cloudflare dashboard to configure the 'CASB Weekly Digest' alert type.
...
- **Easy to configure** — users can opt-in by enabling the notification in the main Cloudflare dashboard under `Manage account` > `Notifications`.

### Learn more
- [Learn how to configure notifications](https://developers.cloudflare.com/notifications/)

The CASB Weekly Digest notification is available to all Cloudflare customers today.