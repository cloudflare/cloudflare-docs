...
[Cloudflare CASB](/cloudflare-one/integrations/cloud-and-saas/) now integrates with [Zoom](/cloudflare-one/integrations/cloud-and-saas/zoom/). The integration connects through Cloudflare's pre-built OAuth application — no manual app setup in Zoom is required. After an initial scan, CASB continuously scans your Zoom account to surface new findings as your environment changes.
