...
description: Cloudflare's CASB integration with the Claude Compliance API gives security teams agentless visibility into posture, data, and compliance risks across their organization's use of Claude.
products:
  - casb
date: 2026-05-19
---
