...
You can now pause message delivery from a queue, and purge all messages from a queue. These operations are useful to manage downtime, handle invalid messages in a queue, or run migrations.
...
As seen above, you can do these operations using Wrangler. You can also do these operations using our REST API, or the dashboard page for a queue.
