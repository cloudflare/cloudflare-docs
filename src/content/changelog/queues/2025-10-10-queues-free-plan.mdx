...
description: Cloudflare Queues now available on Workers Free plan, including unlimited read & delete operations, 100,000k write operatins, and 10,000 queues per account.
products:
  - queues
