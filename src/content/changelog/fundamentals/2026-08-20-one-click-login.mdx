...
**Built for multi-account workflows**: Up to five login profiles can be saved per device, and saved profiles can be removed from the profile list at any time.
