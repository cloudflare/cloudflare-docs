...
Read our [developer documentation](/fundamentals/reference/markdown-for-agents/) and our [blog announcement](https://blog.cloudflare.com/markdown-for-agents/) for more details.