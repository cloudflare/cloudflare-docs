...
- Finally, we’ve tripled [limits](/browser-rendering/limits/#workers-paid) for paid plans across both the [REST API](/browser-rendering/quick-actions/) and [Workers Bindings](/browser-rendering/workers-bindings/) to help you scale.
