...
Cache Rules expressions support combining these fields with other criteria. The following example caches static assets for a shorter duration when the request originates from a high-risk bot or an unexpected ASN:
