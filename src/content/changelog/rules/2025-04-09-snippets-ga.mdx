...
[Cloudflare Snippets](/rules/snippets/) are now generally available at no cost across all paid plans — giving you a fast, flexible way to programmatically control HTTP traffic using lightweight JavaScript.
...
- **Snippets are now GA** – Available at no cost on all Pro, Business, and Enterprise plans.
