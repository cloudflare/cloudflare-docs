...
For compatibility dates of `2026-08-04` or later, do not add `nodejs_compat` or `nodejs_compat_v2` explicitly. To turn off Node.js compatibility completely, add both `no_nodejs_compat` and `no_nodejs_compat_v2`.
