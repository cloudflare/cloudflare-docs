...
{props.productName} steers traffic to tunnels based on priorities you set when you [assign tunnel route priorities during onboarding](https://developers.cloudflare.com/magic-transit/how-to/configure-static-routes/). Tunnel routes with lower values have priority over those with higher values.
