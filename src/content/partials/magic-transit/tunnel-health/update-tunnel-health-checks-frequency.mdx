...
{ props.magicProduct === "Magic WAN" && (
  <>
		...
		<Markdown
		text={`
			1. Log in to the [Cloudflare dashboard](https://dash.cloudflare.com/) and select your account. <br/>
			2. Go to **Magic WAN** > **Sites**. <br/>
			3. Select your site > **Edit**. <br/>
			4. In **Network** > **WAN configuration** > select your WAN > **Edit**. <br/>
			5. Change the **Health check rate** to your desire rate. <br/>
			6. Select **Save**. <br/>
		`}
		/>
  </>
