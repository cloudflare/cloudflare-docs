...
Bidirectional health checks do not work when you use Direct CNI to onboard your traffic to Cloudflare. You will need to resort to the <a hred={ props.legacyHCLink }>legacy health check system</a>.
