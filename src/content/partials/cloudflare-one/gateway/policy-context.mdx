...
| URL category          | [Domain categories](/cloudflare-one/traffic-policies/reference/domain-categories/) of the URL to be redirected.         | `&cf_request_categories=New%20Domains,Newly%20Seen%20Domains`            |
