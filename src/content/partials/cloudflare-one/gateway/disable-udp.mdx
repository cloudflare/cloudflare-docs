...
HTTP/3 traffic not supported - DLS does not support UDP traffic with Cloudflare Secure Web Gateway. To prevent traffic bypass, disable UDP in your account.
