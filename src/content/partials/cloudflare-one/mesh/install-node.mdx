...
IP forwarding is not required to reach the node by its Mesh IP. If the node will advertise [CIDR routes](/mesh/features/routes/), enable persistent forwarding before connecting it:
