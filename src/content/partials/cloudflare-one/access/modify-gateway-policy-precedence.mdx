...
By default, Cloudflare will evaluate Access application policies after evaluating all [Gateway Network policies](/cloudflare-one/traffic-policies/network-policies/). If you have not configured Gateway Network policies, refer to [Get started with network filtering](/cloudflare-one/traffic-policies/initial-setup/network/).
