...
(<> <li> (Optional) Under <b>WARP authentication identity</b>, allow users to authenticate to the application using their <a href="/cloudflare-one/team-and-resources/devices/cloudflare-one-client/configure/client-sessions/"> WARP session identity</a>. </li> </>)
}
