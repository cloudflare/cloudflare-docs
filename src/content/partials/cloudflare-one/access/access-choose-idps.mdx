...
{ props.appType === "rdp" ?
(<> <li> <b>Device authentication identity</b> is not supported for browser-based RDP and should remain turned off. </li> </>) :
(<> <li> (Optional) Under <b>Device authentication identity</b>, allow users to authenticate to the application using their <a href="/cloudflare-one/team-and-resources/devices/cloudflare-one-client/configure/client-sessions/"> Cloudflare One Client session identity</a>. </li> </>)
}
