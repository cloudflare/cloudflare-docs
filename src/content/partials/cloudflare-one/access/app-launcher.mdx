...
3. On the **Rules** tab, [build a rule](/cloudflare-one/access-controls/policies/access/) to define who can access your App Launcher portal. These rules do not impact permissions for the applications secured behind Access.
