...
3. In the **Policies** tab, configure one or more [Access policies](/cloudflare-one/access-controls/policies/access/) to define who can join their device. For example, you could allow all users with a company email address:
