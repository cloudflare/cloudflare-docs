...
<ul>
	...
	{props.sshMode ? (
		<>
			<li>
				<label>
					...
					the <code>sshd</code> logs you collected in{" "}
					<a href="/cloudflare-one/networks/connectors/cloudflare-tunnel/use-cases/ssh/ssh-infrastructure-access/#review-your-sshd-logs">
						step 4: Debug <code>sshd_config</code> file misconfiguration
					</a>
					.
				</label>
			</li>
		...
		<>
			...
			<li>
				<label>
					<input type="checkbox" /> Tunnel logs: Include the{" "}
					<a href="/cloudflare-one/networks/connectors/cloudflare-tunnel/monitor-tunnels/logs/#view-logs-on-your-local-machine">
						logs from your local machine
					</a>
					.
				</label>
			</li>
			<li>
				<label>
					<input type="checkbox" /> Tunnel diagnostic logs: Include{" "}
					<a href="/cloudflare-one/networks/connectors/cloudflare-tunnel/troubleshoot-tunnels/diag-logs/">
