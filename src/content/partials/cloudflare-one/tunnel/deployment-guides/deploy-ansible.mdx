...
{props.product === "cloudflare-one" ? (
<>It may take several minutes for the GCP instance and tunnel to come online. You can view your new tunnel in <a href="https://one.dash.cloudflare.com">Cloudflare One</a> under <strong>Networks</strong> &gt; <strong>Connectors</strong> &gt; <strong>Cloudflare Tunnels</strong>.</>
) : (
