...
This page contains terminology specific to locally-managed Cloudflare Tunnels. For general Tunnel terminology, refer to the <a href={props.generalTermsURL}>Get started section</a>.
