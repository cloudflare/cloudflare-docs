...
1. <a href={props.publishedAppRouteURL}>Add a published application route</a>
   for the health check: - **Hostname**: `health-check.example.com` - **Service
   Type**: _HTTP_STATUS_ - **HTTP Status Code**: `200`
