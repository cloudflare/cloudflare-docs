...
- **Verify DNS traffic**: Ensure your devices are actually sending queries to Gateway. Check your [DNS locations](/cloudflare-one/connections/connect-devices/agentless/dns/) and verify the source IPv4 address.
