...
Additionally, you can automatically remediate certain finding types directly from CASB. For more information, refer to [Remediate findings](/cloudflare-one/cloud-and-saas-findings/manage-findings/#remediate-findings).
