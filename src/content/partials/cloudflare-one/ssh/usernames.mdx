...
Since this will put the security of your server entirely dependent on your Access configuration, make sure your [Access policies](/cloudflare-one/access-controls/policies/access/policy-management/) are correctly configured.
