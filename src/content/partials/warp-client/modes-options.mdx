...
For the **Advanced** options, refer to [Exclude or include network traffic with WARP](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/configure/route-traffic/) for more information.
