...
For the **Advanced** options, refer to [Exclude or include network traffic with WARP](/cloudflare-one/team-and-resources/devices/warp/configure-warp/route-traffic/) for more information.
