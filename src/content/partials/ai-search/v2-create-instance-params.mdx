...
- `web_crawler` <Type text="object" /> <MetaInfo text="optional" />
  ...
  - `parse_type` <Type text="string" /> <MetaInfo text="optional" />
    - How pages are discovered. Valid values: `sitemap` (reads XML sitemaps), `discover` (starts at the source URL and, by default, uses both sitemaps and links found on crawled pages). Defaults to `sitemap`. Refer to [Parse types](/ai-search/configuration/data-source/website/parse-types/).
  ...
  - `discover_options` <Type text="object" /> <MetaInfo text="optional" />
    ...
    - `max_age` <Type text="number" /> <MetaInfo text="optional" />
    ...
    - `include_external_links` <Type text="boolean" /> <MetaInfo text="optional" />
      - Whether to follow links that point to other domains. Defaults to `false`.
    - `include_subdomains` <Type text="boolean" /> <MetaInfo text="optional" />
...
`cache_ttl` <Type text="number" /> <MetaInfo text="optional" />
