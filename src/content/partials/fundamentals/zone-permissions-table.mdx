...
| { props.src === "dash" ? "New Product" : "Email Security DMARC Reports" } Read             | Grants read access to [New Product](/new-product/).                                                         |
| { props.src === "dash" ? "New Product" : "Email Security DMARC Reports" } {props.editWord} | Grants write access to [New Product](/new-product/).                                                        |
