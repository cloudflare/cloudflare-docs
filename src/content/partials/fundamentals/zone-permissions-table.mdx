...
| Access: Apps and Policies {props.editWord}                                                      | Grants write access to [Cloudflare Access](/cloudflare-one/access-controls/policies/) zone resources.                 |
...
| { props.src === "api" && "Domain" } Page Shield Read                                            | Grants read access to [Client-Side Security](/client-side-security/) (previously known as Page Shield).               |
| { props.src === "api" && "Domain" } Page Shield {props.editWord}                                | Grants write access to [Client-Side Security](/client-side-security/) (previously known as Page Shield).              |
...
| Zone Security Center Insights                                                                   | Grants read access to zone level [Security Center Insights](/security-center/security-insights/).                     |
| Zone Security Center Insights {props.editWord}                                                  | Grants write access to zone level [Security Center Zone Insights](/security-center/security-insights/).               |
