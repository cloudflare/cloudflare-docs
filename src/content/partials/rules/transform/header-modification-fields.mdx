...
{ props.location === "response" && (
  ...
  <>
    <ul>
      ...
      <li><code>http.response.headers.*</code></li>
      <li><code>raw.http.response.headers</code></li>
      <li><code>raw.http.response.headers.*</code></li>
      <li><code>cf.response.1xxx_code</code></li>
      <li><code>cf.response.error_type</code></li>
      <li><code>cf.timings.edge_msec</code></li>
      <li><code>cf.timings.origin_ttfb_msec</code></li>
      <li><code>cf.timings.worker_msec</code></li>
    </ul>
  </>
)}
