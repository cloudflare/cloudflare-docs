...
- **Public TCP/UDP to private origins** — Expose a private backend to the Internet for TCP or UDP traffic through a Spectrum application (/spectrum/get-started/#create-a-spectrum-application-using-a-virtual-network-private-origin), without requiring a Load Balancer. The virtual network determines which tunnel or WAN connection carries the traffic to your origin.
