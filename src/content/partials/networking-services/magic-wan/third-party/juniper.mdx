...
<a href={props.magicStaticRoutesUrl}>Magic static routes</a> effectively tell {props.productName} which tunnels to route traffic destined for a given {props.productName} site.
