...
2. After you create your tunnel, Cloudflare dashboard will load a list of tunnels set up for your account. Select the IPsec tunnel you have just created, and check the following setting:
...
Follow the [Configure static routes](/magic-wan/configuration/manually/how-to/configure-routes/) instructions to create a static route (settings not mentioned here can be left with their default values):
