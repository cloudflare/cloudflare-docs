...
You can connect your SonicWall appliance through [IPsec tunnels]({props.ipsecTunnelsUrl}) to {props.productName}. Generic Routing Encapsulation (GRE) is not supported on SonicWall.
...
1. Start by [creating your IPsec tunnels]({props.creatingYourIpsecTunnelsUrl}) on Cloudflare. Name and describe the tunnels as needed, and add the following settings:
...
1. [Create your static routes]({props.createYourStaticRoutesUrl}). Name and describe them as needed, and add the following settings:
