...
You can connect your SonicWall appliance through <a href={props.ipsecTunnelsUrl}>IPsec tunnels</a> to Magic WAN. Generic Routing Encapsulation (GRE) is not supported on SonicWall.
...
![Enable ping so that your interface can be pinged for debugging and Magic WAN health checks](~/assets/images/magic-wan/third-party/sonicwall/6-vpn-ping.png)
