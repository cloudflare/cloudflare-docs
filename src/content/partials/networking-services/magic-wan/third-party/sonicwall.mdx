...
You can connect your SonicWall appliance through <a href={props.ipsecTunnelsUrl}>IPsec tunnels</a> to {props.productName}. Generic Routing Encapsulation (GRE) is not supported on SonicWall.

## Topology

![Topology diagram showing how to connect SonicWall appliances to {props.productName}](~/assets/images/magic-wan/third-party/sonicwall/topology.png)
...
![Enable ping to that your interface can be pinged for debugging and {props.productName} health checks](~/assets/images/magic-wan/third-party/sonicwall/6-vpn-ping.png)
...
![Enable Asymmetric Route Support. It is required for {props.productName} health checks](~/assets/images/magic-wan/third-party/sonicwall/6-vpn-assymetric.png)
