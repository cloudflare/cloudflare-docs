...
1. Go to Magic WAN's **Network Health** page.
	<DashButton url="/?to=/:account/magic-wan/tunnel-healthchecks" />
2. On the banner in the top of the page, select **Magic Tunnel Health Dashboard** to enable the new health checks experience.
...
**Tunnel down:**
- Verify Peer IP, pres-hared key, and IPsec settings match on both sides
...
3. Under **Policy Engine** select **Create New Policy** >
   - Select `Route`
