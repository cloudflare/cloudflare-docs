...
inline={false}
/>
)} 2. Select **IPsec tunnel** > **Next**, and fill in the following settings: - **Name**: `unifi-gw-primary` - **IPv4 Interface Address**: `10.252.2.28/31` or refer to the [Tunnel endpoints documentation](/magic-wan/configuration/manually/how-to/configure-tunnel-endpoints/) - **Customer Endpoint**: This should be your UniFi Gateway's WAN IP (for example, `203.0.113.10`)
...
inline={false}
/>
)} 3. Select your tunnel and then **Edit**. 4. Paste the preshared key from [Step 2](#2-configure-site-to-site-vpn-on-unifi). 5. Select **Save**.
