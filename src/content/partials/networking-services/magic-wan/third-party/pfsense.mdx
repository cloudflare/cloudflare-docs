...
The following information is required for this tutorial:

- Anycast IP addresses (provided by Cloudflare)
...
Use the Cloudflare dashboard or API to <a href={props.configureTwoIpsecTunnelsUrl}>configure two IPsec tunnels</a>. The settings mentioned below are used for the IPsec tunnels referenced throughout the remainder of this guide.
...
- **Phase 1 Proposal (Authentication)**
  ...
  - **My identifier**: _User Fully qualified domain name_ > `ipsec@long_string_of_letters_and_numbers` <br/> (This identifier can be found in the Cloudflare IPsec tunnel configuration > **User ID**)
...
- **Interface Assignments**
  ...
  - Add the **CF_IPsec_1** interface created above for Phase 1.
