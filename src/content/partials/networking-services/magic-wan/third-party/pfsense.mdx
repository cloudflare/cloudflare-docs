...
:::note
If site-to-site traffic is a requirement for your use case, you need to enable replay protection. Refer to <a href={props.addTunnelsUrl}>Add tunnels</a> > IPsec tunnel to learn how to enable this feature.
:::
...
1. Go to [**IPSec/GRE tunnels**](https://dash.cloudflare.com/?to=/:account/magic-networks/connections/tunnels) in the Cloudflare dashboard.
