...
- Cloudflare provisions Magic WAN and Secure Web Gateway.
...
![Established GRE tunnel in Cloudflare dashboard](~/assets/images/magic-wan/third-party/viptela/viptela-gre-tunnel.png)
