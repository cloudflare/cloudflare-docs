...
Refer to [Configure tunnel endpoints]({props.configureTunnelEndpointsUrl}) for more information on creating a GRE tunnel.
...
Refer to [Configure static routes]({props.configureStaticRoutesUrl}) for more information on configuring your static routes.
...
IPsec tunnels to Cloudflare can only be created on Cisco 8000v in the router mode today. Refer to the [Cisco IOS XE]({props.ciscoIosXeUrl}) for more information.
