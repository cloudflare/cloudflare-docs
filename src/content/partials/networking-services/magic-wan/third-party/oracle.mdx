...
This tutorial shows how to configure IPsec (Internet Protocol Security) between Cloudflare Magic WAN and an Oracle Cloud Site-to-site VPN.
...
3. Select the following settings (you can leave settings not mentioned here with their default values):
   ...
   - **Routes to your on-premises network**: Enter a CIDR (Classless Inter-Domain Routing) range you want to route to Magic WAN.
   - **Tunnel 1**
      - **Name**: Enter a name.
...
After configuring the Oracle Site-to-site VPN connection and the tunnels, go to the Cloudflare dashboard and create the corresponding IPsec tunnel and static routes on the Magic WAN side.
