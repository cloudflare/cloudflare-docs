...
By default, TCP, UDP, and ICMP traffic routed through {props.magicWANName} tunnels and destined to routes behind <a href="/cloudflare-one/networks/connectors/cloudflare-tunnel/">Cloudflare Tunnel</a> will be proxied/filtered through Cloudflare Gateway.
