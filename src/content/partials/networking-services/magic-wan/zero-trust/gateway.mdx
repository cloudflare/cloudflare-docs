...
If your organization onboards users to Magic WAN via an <a href={props.mwanOnrampsURL}>on-ramp other than WARP</a>, you can exempt devices from inspection using the IP addresses for your Magic IPsec tunnels:
...
By default, TCP, UDP, and ICMP traffic routed through Magic WAN tunnels and destined to routes behind <a href={props.cloudflareTunnelURL}>Cloudflare Tunnel</a> will be proxied/filtered through Cloudflare Gateway.
