...
To set up a public hostname that proxies to a private origin, refer to [Set up a private origin via Cloudflare WAN](/dns/manage-dns-records/how-to/private-origin-via-cloudflare-wan/).
