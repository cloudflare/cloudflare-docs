...
import { CardGrid, GlossaryTooltip, LinkTitleCard, Markdown } from "~/components";
...
For more information, refer to [Cloudflare Gateway](/cloudflare-one/policies/gateway/) and [Cloudflare Network Firewall](/cloudflare-network-firewall/).
...
<LinkTitleCard title="Get started" href={props.getStartedUrl} icon="open-book">
Set up Cloudflare WAN with the Cloudflare One Appliance or a third-party device.
</LinkTitleCard>

<LinkTitleCard title="Connectivity options" href={props.connectivityOptionsUrl} icon="puzzle">
Compare all Cloudflare One connectivity options and choose the right combination for your deployment.
</LinkTitleCard>

<LinkTitleCard title="On-ramps" href={props.onRampsUrl} icon="seti:pipeline">
Review the full list of supported on-ramps for connecting your networks.
</LinkTitleCard>

<LinkTitleCard title="SASE reference architecture" href="/reference-architecture/architectures/sase/" icon="pen">
Deep dive into the architecture of Cloudflare One as a SASE platform.
</LinkTitleCard>
