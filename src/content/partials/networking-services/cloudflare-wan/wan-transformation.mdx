...
- <a href={props.getStartedUrl}>Get started</a>: Set up Cloudflare WAN with the
  Cloudflare One Appliance or a third-party device.
- <a href={props.connectivityOptionsUrl}>Connectivity options</a>: Compare all
  Cloudflare One connectivity options and choose the right combination for your
  deployment.
- <a href={props.onRampsUrl}>On-ramps</a>: Review the full list of supported
  on-ramps for connecting your networks.
