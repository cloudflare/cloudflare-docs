...
Refer to <a href={props.configureTunnelEndpointsUrl}>Configure tunnel endpoints</a> for more information on creating a GRE tunnel.
...
Refer to <a href={props.configureStaticRoutesUrl}>Configure static routes</a> for more information on configuring your static routes.
...
IPsec tunnels to Cloudflare can only be created on Cisco 8000v in the router mode today. Refer to the <a href={props.ciscoIosXeUrl}>Cisco IOS XE</a> for more information.
