...
![This example was left blank. You should configure this based on your environment.](~/assets/images/cloudflare-wan/third-party/velocloud/image1.png)
...
![Note the indicator next to GE3.](~/assets/images/cloudflare-wan/third-party/velocloud/image2.png)
...
![An example of how the Site Subnets tab should look like when configured as indicated.](~/assets/images/cloudflare-wan/third-party/velocloud/image3.png)
