...
Define an [HTTP policy](/cloudflare-one/traffic-policies/policy-types/http-policies/) to permit the tunnel monitoring probe source IP address to reach the IP/URL (HTTP — port 80/tcp).
