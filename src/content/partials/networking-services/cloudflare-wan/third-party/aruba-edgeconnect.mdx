...
To begin filtering traffic and gathering analytics, refer to the <a href={props.magicFirewallUrl}>Cloudflare Network Firewall documentation</a> to learn how to create filters for east-west inter-branch traffic and the <a href={props.gatewayUrl}>Secure Web Gateway documentation</a> to learn how to configure Gateway policies if you decide to send traffic from your local private subnets to the Internet through Cloudflare Gateway.
