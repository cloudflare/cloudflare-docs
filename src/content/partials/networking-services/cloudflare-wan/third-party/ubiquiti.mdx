...
{props.magicWord === "Cloudflare WAN" ? (
	<>
		<Markdown
			text={`
			1. Refer to [Add tunnels](/cloudflare-wan/configuration/manually/how-to/configure-tunnel-endpoints/#add-tunnels) to learn how to add IPsec tunnels.`}
			inline={false}
		/>
	</>
) : (
...
2. Select **IPsec tunnel** > **Next**, and fill in the following settings:
	   ...
	   - **IPv4 Interface Address**: `10.252.2.28/31` or refer to the [Tunnel endpoints documentation](/cloudflare-wan/configuration/manually/how-to/configure-tunnel-endpoints/)
...
3. Configure the following settings:
   ...
   - **Tunnel IP:** `10.252.2.29/31` or refer to the [Tunnel endpoints documentation](/cloudflare-wan/configuration/manually/how-to/configure-tunnel-endpoints/).
