...
![Topology diagram showing how to connect SonicWall appliances to Cloudflare WAN](~/assets/images/magic-wan/third-party/sonicwall/topology.png)
...
![Enable ping so that your interface can be pinged for debugging and Cloudflare WAN health checks](~/assets/images/magic-wan/third-party/sonicwall/6-vpn-ping.png)
...
![Enable Asymmetric Route Support. It is required for Cloudflare WAN health checks](~/assets/images/magic-wan/third-party/sonicwall/6-vpn-assymetric.png)
...
![Enter the appropriate settings for your object](~/assets/images/magic-wan/third-party/sonicwall/7-address-objects-settings.png)
