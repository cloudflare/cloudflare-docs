...
You can connect your SonicWall appliance through <a href={props.ipsecTunnelsUrl}>IPsec tunnels</a> to Cloudflare WAN. Generic Routing Encapsulation (GRE) is not supported on SonicWall.
...
1. Start by <a href={props.creatingYourIpsecTunnelsUrl}>creating your IPsec tunnels</a> on Cloudflare. Name and describe the tunnels as needed, and add the following settings:
...
1. <a href={props.createYourStaticRoutesUrl}>Create your static routes</a>. Name and describe them as needed, and add the following settings:
...
5. Select **Advanced**.
6. Enable the **Enable Asymmetric Route Support** option. This is required for the Cloudflare WAN tunnel health check.
...
You have to [configure Cloudflare WAN health checks](/cloudflare-wan/configuration/manually/how-to/configure-tunnel-endpoints/#add-tunnels) correctly. Here is an example of how to set up health checks:
