...
Use the Cloudflare dashboard or API to <a href={props.configureTwoIpsecTunnelsUrl}>configure two IPsec Tunnels</a>. The settings mentioned in [Add IPsec tunnels](#add-ipsec-tunnels) below are used for the IPsec tunnels referenced throughout the remainder of this guide.
...
:::caution
You need to <a href={props.configureBidirectionalHealthChecksUrl}>configure bidirectional health checks</a> with Cloudflare WAN. The settings must include custom target IP addresses for each tunnel. Additionally, Cloudflare recommends that you lower the rate at which health check probes are sent.
:::
...
![IPsec Tunnels - No PSK](~/assets/images/cloudflare-wan/third-party/palo-alto/cloudflare_dash_ipsec/03_magic_ipsec_tun_no_psk.png)
...
2. Select **Generate a new pre-shared key** > **Update and generate pre-shared key**.
   ![Generate a new pre-shared key for each of your IPsec tunnels](~/assets/images/cloudflare-wan/third-party/palo-alto/cloudflare_dash_ipsec/04_magic_ipsec_tun_01_gen_psk.png)
3. Copy the pre-shared key value for each of your IPsec tunnels, and save these values somewhere safe. Then, select **Done**.
   ![Take note of your pre-shared key, and keep it in a safe place](~/assets/images/cloudflare-wan/third-party/palo-alto/cloudflare_dash_ipsec/05_magic_ipsec_tun_01_show_psk.png)
...
![Take note of the FQDN ID value for each of your IPsec tunnels](~/assets/images/cloudflare-wan/third-party/palo-alto/cloudflare_dash_ipsec/08_magic_ipsec_tun_01_fqdn.png)
...
Create a <a href={props.staticRouteUrl}>static route</a> for each of the two IPsec tunnels configured in the previous section, with the following settings (settings not mentioned here can be left with their default settings):
...
![Add static routes for each of the IPsec tunnels you created in the previous step](~/assets/images/cloudflare-wan/third-party/palo-alto/cloudflare_dash_ipsec/10_magic_ipsec_static_routes.png)
...
![Interface Mgmt Profile](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/01_int_mgmt_prof.png)

![Interface Mgmt Profile](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/02_int_mgmt_prof.png)
...
![Set up ethernet1/1 on the dashboard](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Ethernet_Interfaces/01_ethernet-1-1_page1.png)
![Set up ethernet1/1 on the dashboard](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Ethernet_Interfaces/02_ethernet-1-1_page2.png)
![Set up ethernet1/1 on the dashboard](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Ethernet_Interfaces/03_ethernet-1-1_page3.png)
...
![Set up ethernet1/2 on the dashboard](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Ethernet_Interfaces/04_ethernet-1-2_page1.png)
![Set up ethernet1/2 on the dashboard](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Ethernet_Interfaces/05_ethernet-1-2_page2.png)
![Set up ethernet1/2 on the dashboard](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Ethernet_Interfaces/06_ethernet-1-2_page3.png)

After setting up your Ethernet interfaces, they should show up on the overview page:

![Ethernet Interfaces - Overview](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Ethernet_Interfaces/07_ethernet_interfaces_overview.png)
...
![Set up tunnel 1](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Tunnel_Interfaces/01_tunnel_1_page1.png)
![Set up tunnel 1](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Tunnel_Interfaces/02_tunnel_1_page2.png)
![Set up tunnel 1](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Tunnel_Interfaces/03_tunnel_1_page3.png)
...
![Set up tunnel 2](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Tunnel_Interfaces/04_tunnel_2_page1.png)
![Set up tunnel 2](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Tunnel_Interfaces/05_tunnel_2_page2.png)
![Set up tunnel 2](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Tunnel_Interfaces/06_tunnel_2_page3.png)

_Note: Labels in these images may reflect previous product names._

After setting up your Tunnel interfaces, they should show up on the overview page:

![Tunnel Interfaces - Overview](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_interfaces/Tunnel_Interfaces/07_tunnel_interfaces_overview.png)
...
![The Palo Alto interface showing the Trust_L3_Zone](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_zones/01_trust_zone.png)
...
![The Palo Alto interface showing the Untrust_L3_Zone](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_zones/02_untrust_zone.png)
...
![The Palo Alto interface showing the Cloudflare_L3_Zone](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_zones/03_cloudflare_zone.png)
![The Palo Alto interface showing the Tunnel Interfaces overview section](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_zones/04_zones_overview.png)
...
![IKE gateway settings for tunnel 1](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_ipsec_tunnels/03_ike_gw01_page1.png)
![IKE gateway settings for tunnel 1](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_ipsec_tunnels/04_ike_gw01_page2.png)
...
![IKE gateway settings for tunnel 2](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_ipsec_tunnels/05_ike_gw02_page1.png)
![IKE gateway settings for tunnel 2](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_ipsec_tunnels/06_ike_gw02_page2.png)
...
![Set up the IPsec tunnel](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_ipsec_tunnels/07_ipsec_tun01_page1.png)
![Set up the IPsec tunnel](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_ipsec_tunnels/08_ipsec_tun01_page2.png)
...
![Set up the IPsec tunnel](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_ipsec_tunnels/09_ipsec_tun02_page1.png)
![Set up the IPsec tunnel](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_ipsec_tunnels/10_ipsec_tun02_page2.png)
...
Cloudflare WAN implements <a href={props.equalcostMultipathEcmpRoutingUrl}>equal-cost multi-path (ECMP) routing</a> to steer traffic across IPsec tunnels. The default behavior is to load balance traffic equally across both tunnels.
...
![Make sure the Ethernet and tunnel interfaces show up in Virtual Router](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_virtual_router/01_virtual_router_interfaces.png)
...
![Make sure all checkboxes are selected](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_virtual_router/02_virtual_router_ecmp.png)
...
![Static Route - VLAN0010 (10.1.10.0/24 via tunnel.1)](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_virtual_router/03_virtual_router_static_vlan0010_tun01.png)
...
![Static Route - VLAN0010 (10.1.10.0/24 via tunnel.2)](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_virtual_router/04_virtual_router_static_vlan0010_tun02.png)
...
![Static Route - VLAN0020 (10.1.20.0/24 via tunnel.1)](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_virtual_router/05_virtual_router_static_vlan0020_tun01.png)
...
![Static Route - VLAN0020 (10.1.20.0/24 via tunnel.1)](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_virtual_router/06_virtual_router_static_vlan0020_tun02.png)
...
![Bidirectional Health Check Rule - General](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/01_bidirect_hc_general.png)
![Bidirectional Health Check Rule - Source](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/02_bidirect_hc_source.png)
![Bidirectional Health Check Rule - Destination](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/03_bidirect_hc_dest.png)
![Bidirectional Health Check Rule - Apps](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/04_bidirect_hc_apps.png)
![Bidirectional Health Check Rule - Service/URL Category](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/05_bidirect_hc_service-url.png)
![Bidirectional Health Check Rule - Action](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/06_bidirect_hc_action.png)
...
![Bidirectional Health Checks via tunnel.1 - General](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/01_pbf_hc_01_general.png)
![Bidirectional Health Checks via tunnel.1 - Source](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/02_pbf_hc_01_source.png)
![Bidirectional Health Checks via tunnel.1 - Destination](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/03_pbf_hc_01_dest-app-service.png)
![Bidirectional Health Checks via tunnel.1 - Forwarding](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/04_pbf_hc_01_forwarding.png)
...
![Bidirectional Health Checks via tunnel.2 - General](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/05_pbf_hc_02_general.png)
![Bidirectional Health Checks via tunnel.2 - Source](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/06_pbf_hc_02_source.png)
![Bidirectional Health Checks via tunnel.2 - Destination](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/07_pbf_hc_02_dest-app-service.png)
![Bidirectional Health Checks via tunnel.2 - Forwarding](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/08_pbf_hc_02_forwarding.png)
...
![Bidirectional health check logging - Filter by rule name](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_logging/02_logging_tunnel_hc_filter_rulename.png)
...
![Bidirectional health check logging - filter by health check anycast IPs](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_logging/01_logging_tunnel_hc_filter_ip.png)
...
![Bidirectional Health Check Logging - tunnel.1](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_logging/03_logging_tunnel_hc_tun01.png)
...
![Bidirectional Health Check Logging - tunnel.2](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_logging/04_logging_tunnel_hc_tun02.png)
...
![Trust to Cloudflare WAN - General](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/07_trust_to_mwan_general.png)
![Trust to Cloudflare WAN - Source](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/08_trust_to_mwan_source.png)
![Trust to Cloudflare WAN - Destination](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/09_trust_to_mwan_dest.png)
![Trust to Cloudflare WAN - Applications](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/10_trust_to_mwan_apps.png)
![Trust to Cloudflare WAN - Services/URL Categories](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/11_trust_to_mwan_service-url.png)
![Trust to Cloudflare WAN - Action](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/12_trust_to_mwan_action.png)
...
![Cloudflare WAN to Trust - General](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/13_mwan_to_trust_general.png)
![Cloudflare WAN to Trust - Source](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/14_mwan_to_trust_source.png)
![Cloudflare WAN to Trust - Destination](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/15_mwan_to_trust_dest.png)
![Cloudflare WAN to Trust - Applications](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/16_mwan_to_trust_apps.png)
![Cloudflare WAN to Trust - Services/URL Categories](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/17_mwan_to_trust_service-url.png)
![Cloudflare WAN to Trust - Action](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_security_rules/18_mwan_to_trust_action.png)
...
![PBF: Trust to Cloudflare WAN via tunnel.1 - General](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/09_pbf_mwan_sites_tun01_general.png)
![PBF: Trust to Cloudflare WAN via tunnel.1 - Source](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/10_pbf_mwan_sites_tun01_source.png)
![PBF: Trust to Cloudflare WAN via tunnel.1 - Destinations](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/11_pbf_mwan_sites_tun01_dest-app-service.png)
![PBF: Trust to Cloudflare WAN via tunnel.1 - Forwarding](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/12_pbf_mwan_sites_tun01_forwarding.png)
...
![PBF: Trust to Cloudflare WAN via tunnel.2 - General](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/13_pbf_mwan_sites_tun02_general.png)
![PBF: Trust to Cloudflare WAN via tunnel.2 - Source](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/14_pbf_mwan_sites_tun02_source.png)
![PBF: Trust to Cloudflare WAN via tunnel.2 - Destinations](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/15_pbf_mwan_sites_tun02_dest-app-service.png)
![PBF: Trust to Cloudflare WAN via tunnel.2 - Forwarding](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_pbf/16_pbf_mwan_sites_tun02_forwarding.png)
...
![Trust to Cloudflare WAN Egress - General](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/01_trust_mwan_egress_general.png)
![Trust to Cloudflare WAN Egress - Source](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/02_trust_mwan_egress_source.png)
![Trust to Cloudflare WAN Egress - Destination](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/03__trust_mwan_egress_destination.png)
![Trust to Cloudflare WAN Egress - Applications](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/04_trust_mwan_egress_apps.png)
![Trust to Cloudflare WAN Egress - Services/URL Categories](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/05_trust_mwan_egress_service-url.png)
![Trust to Cloudflare WAN Egress - Action](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/06_trust_mwan_egress_actions.png)
...
![PBF: Trust to Cloudflare WAN Egress via tunnel.1 - General](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/07_pbf_trust_mwan_egress_tun01_general.png)
![PBF: Trust to Cloudflare WAN via tunnel.1 - Source](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/02_trust_mwan_egress_source.png)
![PBF: Trust to Cloudflare WAN via tunnel.1 - Destinations](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/09_pbf_trust_mwan_egress_tun01_dest.png)
![PBF: Trust to Cloudflare WAN via tunnel.1 - Forwarding](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/10_pbf_trust_mwan_egress_tun01_forward.png)
...
![PBF: Trust to Cloudflare WAN Egress via tunnel.2 - General](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/11_pbf_trust_mwan_egress_tun02_general.png)
![PBF: Trust to Cloudflare WAN via tunnel.2 - Source](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/12_pbf_trust_mwan_egress_tun02_source.png)
![PBF: Trust to Cloudflare WAN via tunnel.2 - Destinations](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/13_pbf_trust_mwan_egress_tun02_dest.png)
![PBF: Trust to Cloudflare WAN via tunnel.2 - Forwarding](~/assets/images/cloudflare-wan/third-party/palo-alto/panw_mwan_egress/14_pbf_trust_mwan_egress_tun02_forward.png)
