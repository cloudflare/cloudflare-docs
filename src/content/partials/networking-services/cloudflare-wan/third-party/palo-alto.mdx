...
:::note
This compatibility matrix was last validated before Cloudflare added support for NAT-T starting on UDP port `500`. Refer to the [changelog entry](/changelog/2026-05-11-nat-t-port-500/) for details.
:::
