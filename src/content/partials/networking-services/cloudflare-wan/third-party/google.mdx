...
5. For **Remote Peer IP Address**, use one of the public anycast Cloudflare WAN IPs given to you by your account team.
...
:::note
Do not forget to create a route in the corresponding GCP VPC covering for the healthcheck configuration of the tunnel. The route subnet should match the interface address CIDR block of the Cloudflare WAN tunnel (`169.254.244.2` in the example above).
