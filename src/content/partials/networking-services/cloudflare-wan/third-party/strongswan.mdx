...
Configure the <a href={props.bidirectionalHealthChecksUrl}>bidirectional health checks</a> target for Cloudflare WAN. For this tutorial, use `172.64.240.252` as the target IP address, and `type` as the request.
