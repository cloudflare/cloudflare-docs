...
<a href={props.magicStaticRoutesUrl}>Static routes</a> effectively tell Cloudflare WAN which tunnels to route traffic destined for a given Cloudflare WAN site.
