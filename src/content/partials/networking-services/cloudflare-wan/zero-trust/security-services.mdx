...
Once traffic reaches Cloudflare through WAN on-ramps (IPsec tunnels, GRE tunnels, CNI, or Connector), you can apply multiple security services inline. This page explains which services apply to WAN traffic, when to use each one, and how they work together.
...
- **Included with**: Cloudflare WAN by default
