...
<a href={props.networkFirewallURL}>Cloudflare Network Firewall</a> provides
packet-level filtering at layers 3 and 4. You define allow or block rules based
...
- <a href={props.gatewaySetupURL}>
  	Connect to Cloudflare Gateway with Cloudflare WAN
  </a>
  : Detailed setup guide for Gateway integration with WAN traffic.
- <a href={props.networkFirewallURL}>Cloudflare Network Firewall</a>: Configure
  packet-level filtering rules.
...
- <a href={props.wanTransformationURL}>WAN transformation</a>: Plan your
  migration from traditional WAN to Cloudflare.
