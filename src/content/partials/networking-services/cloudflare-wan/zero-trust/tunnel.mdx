...
| `100.80.0.0/16` | [Initial resolved IPs](/cloudflare-one/traffic-policies/policy-types/egress-policies/host-selectors/) |
...
[Hostname-based routing](/cloudflare-one/traffic-policies/policy-types/egress-policies/host-selectors/) uses Gateway DNS to resolve hostnames to Initial resolved IPs, which then map to specific next hops.
