...
Cloudflare will assign IP addresses from the virtual IP (VIP) space to your devices. To view your virtual IP address, go to the [Cloudflare dashboard](https://dash.cloudflare.com/), and select **Zero Trust** > **{props.ztDashPath}**.
...
To learn which IP addresses and UDP ports you should exclude to accomplish this, refer to <a href={props.warpIngressIpURL}>Cloudflare One Client ingress IP</a>.
