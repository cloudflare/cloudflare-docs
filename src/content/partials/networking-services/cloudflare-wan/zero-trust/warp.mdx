...
Cloudflare will assign IP addresses from the virtual IP (VIP) space to your devices. To view your virtual IP address, go to [Cloudflare One](https://dash.cloudflare.com/one/), and select **{props.ztDashPath}**.
