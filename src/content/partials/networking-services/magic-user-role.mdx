...
You can determine which users have, or do not have, configuration edit access for {props.magicWord === "WAN Tunnels" ? "WAN Tunnels" : "Magic products, including Magic Transit, Magic WAN, and Magic Firewall"}.
