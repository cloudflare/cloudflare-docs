...
For detailed information about the expected behavior of high availability configurations, refer to <a href={props.hcConfigsURL}>High availability configurations</a>.
