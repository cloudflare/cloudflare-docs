...
You can install up to two instances of { props.magicWord === "virtual" ? props.productNameVirtual : props.productName } for redundancy at each of your sites. If one of your devices fails, traffic will fail over to the other { props.magicWord === "virtual" ? props.productNameVirtual : props.productName } ensuring that you never lose connectivity to that site.
