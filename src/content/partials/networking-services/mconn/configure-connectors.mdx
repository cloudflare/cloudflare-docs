...
{ props.dashName === "CF1 Cloudflare WAN" && (
	<>
		<ol>
			<li>Log in to <a href="https://dash.cloudflare.com/one/">Cloudflare One</a>, and go to <strong>Networks</strong>.</li>
...
{ props.dashName === "CF1 Cloudflare WAN" ? (
	<>
		<Markdown
	text={`
		1. Log in to <a href="https://dash.cloudflare.com/one/">Cloudflare One</a>, and go to **Networks**.
...
{ props.dashName === "CF1 Cloudflare WAN" ? (
	<>
		<Markdown
	text={`
		1. Log in to <a href="https://dash.cloudflare.com/one/">Cloudflare One</a>, and go to **Connectors**.
