...
{ props.dashName !== "WAN Tunnels" && (
	<>
		<ol>
			<li>Go to <strong>Connectors</strong> page.
			<br />
			<DashButton url="/?to=/:account/magic-wan/configuration" buttonName="Connectors" />
			</li>
			<li>Go to <strong>Appliances</strong> &gt; <strong>Create a new profile</strong>.</li>
		</ol>
	</>
)
}
...
4. You need to decide if you want to turn on high availability for the { props.magicWord === "virtual" ? props.productNameVirtual : props.productName }. Refer to [About high availability configurations](#about-high-availability-configurations) for more information.
5. Select **Create and continue**.
6. Select **Add Appliance**. This will show you a list of devices associated with your account. <Markdown text={props.noConnectorShows} />
...
{ props.magicWord === "virtual" && (
  <>
		...
		<AnchorHeading title="Default password to access Virtual Connector" depth={3} />
...
15. {props.magicWord === "hardware" && (<>Follow the instructions in <a href="#set-up-your-magic-wan-connector">Set up your Magic WAN Connector</a> and <a href="#activate-appliance">Activate appliance</a> to finish setting up your Connectors.</>)} {props.magicWord === "virtual" && (<>Follow the instructions in <a href="#activate-appliance">Activate appliance</a> to finish setting up your Connectors.</>)}
...
{ props.dashName === "WAN Tunnels" ? (
	...
	<>
		<Markdown
	text={`
		1. Go to **Network health** page.`}
	inline={false}
	/>

   <DashButton url="/?to=/:account/magic-wan/network" buttonName="Network health" />
