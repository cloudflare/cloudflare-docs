...
7. Select **Add Connector**. This will show you a list of { props.magicWord === "virtual" ? props.productNameVirtual : props.productName } devices associated with your account. <Markdown text={props.noConnectorShows} />
