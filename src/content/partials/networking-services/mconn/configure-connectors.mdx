...
{ props.magicWord === "hardware" && (
  <>
		...
		<Render file="register-hardware-appliance" product="networking-services/mconn" params={{ productDashName: "Magic WAN's **Configuration** page", dashPath: "Under **Connectors**, select **Register your appliance**." }} />
  </>
  )
}
