...
5. In **Static addressing** > **Static address** give your Connector's LAN interface its IP address. You can also enable the following options if they suit your use case:
   - **This is a DHCP server**: If your Connector is a <a href={props.dhcpServerURL}>DHCP server</a>.
   - **This is a DHCP relay**: If your Connector is a <a href={props.dhcpRelayURL}>DHCP relay</a>.
