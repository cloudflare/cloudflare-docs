...
{ props.dashName === "WAN Tunnels" ? (
	<>
		<Markdown
	text={`
		1. Log in to <a href="https://one.dash.cloudflare.com/">Cloudflare One</a>, and go to **Connectors**.
		2. In **WAN Tunnels** you can inspect the IPsec tunnels created by your ${props.magicWord === "virtual" ? props.productNameVirtual : props.productName }.
