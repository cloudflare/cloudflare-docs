...
{ props.magicWord === "hardware" && (
  <>
		...
		<Aside type="note">The `reset device` option in your Connector clears most of the configuration that is locally cached, resets the password to the default, and reboots.</Aside>
		<ol>
