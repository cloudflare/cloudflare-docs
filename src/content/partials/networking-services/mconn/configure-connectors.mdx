...
12. In **Virtual static address**, enter the IP that the LAN south of the { props.magicWord === "virtual" ? props.productNameVirtual : props.productName } will forward traffic to. For example, `192.168.10.3/24`.
13. Select **Save**.
