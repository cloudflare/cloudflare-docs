...
For more information on how to a create a NAT for a subnets, refer to **Create a LAN**, either in <a href={props.hardConnectorURL}>{props.configHardProductName}</a> or in <a href={props.virtualConnectorURL}>{props.configVirtualProductName}</a>.
