...
The following guide assumes you have already created a site and configured your {props.productName}. To learn how to create a site and configure your {props.productName}, refer to <a href={props.hardConnectorURL}>{props.configHardProductName}</a> or <a href={props.virtualConnectorURL}>{props.configVirtualProductName}</a>, depending on the type of {props.productName} you have on your premises.
