...
The following guide assumes you have already created a site and configured your Cloudflare One Appliance. For instructions to create a site and configure your Cloudflare One Appliance, refer to <a href={props.hardConnectorURL}>Configure hardware Appliance</a> or <a href={props.virtualConnectorURL}>Configure Virtual Appliance</a>, depending on the type of Cloudflare One Appliance you have on your premises.
...
5. Select **LAN policies** > **{props.dashName === "Cloudflare WAN" ? "Create Policy" : "Create"}**.
