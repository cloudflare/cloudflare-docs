...
{ props.magicWord === "breakout" && (
	...
	<AnchorHeading title="WARP traffic" depth={2} />
		<Render file="mconn/network-options/app-aware-policies/warp-traffic" product="networking-services" />
	</>
	)
}
