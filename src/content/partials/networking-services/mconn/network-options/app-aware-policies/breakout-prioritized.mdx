...
{ props.magicWord === "breakout" && (
	<>
		<pre class="mermaid">
			{`
			flowchart LR
			accTitle: In this graph, Applications 1 and 2 are configured to bypass Cloudflare's security filtering, and go straight to the Internet.
