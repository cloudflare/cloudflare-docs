...
For more information on how to create routed subnets, refer to **Create a LAN**, either in either in <a href={props.hardConnectorURL}>Configure hardware Connector</a> or in <a href={props.virtualConnectorURL}>Configure Virtual Connector</a>.
