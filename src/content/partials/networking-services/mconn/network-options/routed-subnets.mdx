...
For instructions on creating routed subnets, refer to **Create a LAN** in either <a href={props.hardConnectorURL}>Configure hardware Connector</a> or <a href={props.virtualConnectorURL}>Configure Virtual Connector</a>.
