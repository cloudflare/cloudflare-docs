...
{ props.dashName === "WAN Tunnels" ? (
	...
	/>
		...
		<Markdown
	text={`
		2. In the **Magic WAN Connector** tab, find your Magic WAN Connector, and place your cursor over the icon on the **Status** column to check the timestamp. The timestamp shows you the last time Magic WAN Connector successfully contacted Cloudflare.
	`}
	inline={false}
	/>
	</>
