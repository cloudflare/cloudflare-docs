...
{ props.dashName === "WAN Tunnels" ? (
	...
	text={`
		...
		3. Find your Magic WAN Connector, and place your cursor over the icon on the **Status** column to check the timestamp. The timestamp displays the last time Magic WAN Connector successfully contacted Cloudflare.
	`}
	inline={false}
	/>
	</>
	...
	text={`
		...
		3. From the list, find your Magic WAN Connector, and place your cursor over the icon on the **Status** column to check the timestamp. The timestamp displays the last time Magic WAN Connector successfully contacted Cloudflare.
	`}
	inline={false}
	/>
	</>
