...
Before you can add or remove apps to {props.featureName} your Connector, you need to create a list of the apps that you want to configure. Currently, adding to or modifying this list is only possible through the [`managed_app_id` endpoint](/api/resources/magic_transit/subresources/apps/methods/create/). The instructions below explain how to add or edit an already existing app to Connector.
