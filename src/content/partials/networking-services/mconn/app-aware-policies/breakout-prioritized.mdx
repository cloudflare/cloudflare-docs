...
Before you can add or remove {props.featureName} apps to your Connector, you need to create a list of the apps that you want to configure. Currently, adding to or modifying this list is only possible through the [`managed_app_id`](/api/resources/magic_transit/subresources/apps/methods/create/) endpoint.

The instructions below explain how to add or edit an app to Connector that already exists on this list.
