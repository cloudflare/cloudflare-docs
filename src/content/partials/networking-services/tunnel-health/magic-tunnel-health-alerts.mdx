...
8. Select the **Alert Sensitivity Level** threshold from the dropdown menu. It is predefined for _Medium_, but you can choose between several options:
	- Minimum (95.0)
	- Very low (96.0)
	- Low (97.0)
	- Medium (98.0)
...
<Details header="Alert by data center">
