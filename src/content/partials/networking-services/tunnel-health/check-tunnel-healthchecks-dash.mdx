...
{ props.magicWord === "CF1 Cloudflare WAN" ? (
	...
	<Markdown
		text={`
		1. Log in to [Cloudflare dashboard](https://dash.cloudflare.com/) and go to **Zero Trust** > **Insights**.
...
- Network Analytics: Leverage real-time insights into <a href={props.networkAnalytics}>network analytics</a>.
