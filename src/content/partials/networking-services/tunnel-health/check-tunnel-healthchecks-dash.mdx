...
Beyond having a wide view into all connections, you can drill down into a specific tunnel to check its health status and other information. Make sure you changed into the new dashboard experience, and:
