...
import { Aside, AnchorHeading, GlossaryTooltip, Markdown } from "~/components";
...
{ props.magicWord === "WAN Tunnels" ? (
	...
	<>
		...
		<Markdown
			text={`
			1. Go to the [**Connector health**](https://dash.cloudflare.com//?to=/:account/networking-insights/health/tunnel-health/list) page.
			2. In this screen you can access a list of your tunnels and their current health status. You can also check the amount of health checks passed in the last hour as well as traffic volume for each tunnel.
