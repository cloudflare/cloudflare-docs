...
import { Aside, AnchorHeading, GlossaryTooltip, Markdown, Tabs, TabItem } from "~/components";
...
<AnchorHeading title="Check tunnel health" depth={2} />
...
You can drill down into a specific tunnel to check its health status and other information.{props.magicWord !== "WAN Tunnels" && <> To switch dashboard experiences, use the banner at the top of the dashboard.</>}
