...
6. **Health check direction**: {props.productName} defaults to *{props.healthCheckDefault}*.
...
For more information, refer to [Magic Firewall rules and endpoint health checks](https://developers.cloudflare.com/magic-firewall/about/ruleset-logic/#magic-firewall-rules-and-magic-transit-endpoint-health-checks).
