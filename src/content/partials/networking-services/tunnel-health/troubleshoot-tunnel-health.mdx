...
5. **IPsec parameters**: Confirm your cryptographic parameters match [Cloudflare's supported configuration](https://developers.cloudflare.com/magic-wan/reference/tunnels-and-encapsulation/#supported-configuration-parameters).
...
The [Cloudflare dashboard](https://dash.cloudflare.com/?to=/:account/networking-insights/health) displays three tunnel health states:
