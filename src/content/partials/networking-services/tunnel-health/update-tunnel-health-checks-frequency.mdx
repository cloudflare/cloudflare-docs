...
{ (props.magicWord === "Magic WAN" || props.magicWord === "WAN Tunnels") && (
  <>
		<p>For {props.magicWord === "Magic WAN" ? "Magic WAN Connector" : "Magic WAN Connector"}, health checks are sent to IPsec tunnel endpoints.</p>
  </>
  )
}
...
{ (props.magicWord === "Magic WAN" || props.magicWord === "WAN Tunnels") && (
  ...
  <>
		<AnchorHeading depth={2} title={props.magicWord === "Magic WAN" ? "Configure Connector" : "Configure Connector"} />
