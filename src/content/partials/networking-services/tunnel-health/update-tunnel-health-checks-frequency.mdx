...
{ (props.magicWord === "Magic WAN" || props.magicWord === "WAN Tunnels") && (
  <>
		<p>To configure health checks frequency in {props.magicWord === "Magic WAN" ? "Magic WAN Connector" : "Magic WAN Connector"}, refer to <a href="#configure-connector">Configure Connector</a></p>
  </>
  )
}
