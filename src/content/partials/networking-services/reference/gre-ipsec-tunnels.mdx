...
:::note
By default, egress packets are routed by your Internet Service Provider (ISP) interface, not Cloudflare.
:::
...
- **Perfect Forward Secrecy (PFS) group**
	...
	Sometimes referred to as Phase 2 Diffie-Hellman Group. Not to be confused with PRF. Cloudflare supports the following Diffie-Hellman (DH) groups.
