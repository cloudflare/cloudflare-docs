...
- **Key Exchange Method** (formerly Diffie-Hellman group):
  ...
  - **Post-quantum hybrid (recommended)**: ML-KEM-768 in parallel with DH Group 20 (per RFC 9370 and [draft-ietf-ipsecme-ikev2-mlkem](https://datatracker.ietf.org/doc/draft-ietf-ipsecme-ikev2-mlkem/))
