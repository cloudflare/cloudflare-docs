...
- Support for Cloudflare Mesh client and IPsec/GRE/CNI connectivity
		`}
		inline={false}
		/>
	</>
...
| Basic packet captures | Do not include Automatic Return Routing or BGP-over-tunnels traffic |
| Full packet captures | Not yet supported |
| Advanced Magic Firewall features | GeoIP/Country rules, IP Lists, ASN Lists, Threat Intel Lists, IDS, Rate Limiting, SIP, Managed Rulesets |
...
Using BGP peering allows you to:
