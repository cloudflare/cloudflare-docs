...
Refer to <a href={props.productPath}>Add tunnels</a> to learn how to set up replay protection. This page explains replay attacks, why we recommend disabling IPsec anti-replay, and related considerations.
