...
<Render
	...
	params={{
		productName:
			props.magicWord === "Magic Transit" ? "Magic Transit" : "Cloudflare WAN",
	}}
/>
...
<Render
	...
	params={{
		...
		mFirewallURL:
			"/cloudflare-network-firewall/about/ruleset-logic/#cloudflare-network-firewall-rules-and-magic-transit-endpoint-health-checks",
	}}
/>
