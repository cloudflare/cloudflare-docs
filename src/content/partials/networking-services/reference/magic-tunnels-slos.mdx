...
- 99.2% (short window) + 99% (long window) = 99%. Cloudflare would not trigger an alert because the short window is above the threshold.
- 98% (short window) + 98% (long window) = 98%. Cloudflare would trigger an alert because both windows are below the threshold.
