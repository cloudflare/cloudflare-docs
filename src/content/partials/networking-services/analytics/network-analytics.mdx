...
5. In the **New filter** popover, choose the data type from the left dropdown menu, an operator from the middle dropdown menu, and an action from the right dropdown menu. For example:
