...
import { AnchorHeading, Aside, APIRequest, Markdown, Render, TabItem, Tabs } from "~/components";
...
{ props.magicWord !== "WAN Tunnels" && (
	<>
		<Markdown
			text={`
			1. Go to ${props.productName}'s <a href="${props.dashRoutesPath}">**Routes**</a> page.
...
{ props.magicWord !== "WAN Tunnels" && (
	<>
		<Markdown
			text={`
			1. Go to ${props.productName}'s <a href="${props.dashWanPath}">**WAN configuration**</a> page.
