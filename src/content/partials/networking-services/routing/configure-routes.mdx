...
{ props.magicWord === "WAN Tunnels" && (
	...
	<Markdown
		text={`
			1. In **Routes** > **WAN Routes**, select the three dots > **Edit** next to the route you want to modify.
		`}
		inline={false}
	/>
	</>
...
{ props.magicWord !== "WAN Tunnels" && (
	...
	<Markdown
		text={`
			1. In **Routes**, select the three dots > **Edit** next to the route you want to modify.
		`}
		inline={false}
	/>
	</>
...
{ props.magicWord === "WAN Tunnels" && (
	...
	<Markdown
		text={`
			1. In **Routes** > **WAN Routes**, locate the static route you want to modify, select the three dots > **Delete**.
		`}
		inline={false}
	/>
	</>
...
{ props.magicWord !== "WAN Tunnels" && (
	...
	<Markdown
		text={`
			1. In **Routes**, locate the static route you want to modify, select the three dots > **Delete**.
		`}
		inline={false}
	/>
	</>
