...
1. Go to Magic WAN's [**Custom IPs**](https://dash.cloudflare.com/?to=/:account/ip-addresses/address-space/custom-ips) page.
2. Find the prefix you want to update.
3. Select the three dots to the right of the prefix > **Edit**.
4. Enter a new prefix in the **IP address** field.
5. Select **Save**.
