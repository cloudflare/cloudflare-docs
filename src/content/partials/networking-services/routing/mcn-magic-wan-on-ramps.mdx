...
After setting up your on-ramps you need to update your network security groups in the VPC to allow traffic to/from Magic WAN. Refer to the [Cloud on-ramps](/magic-cloud-networking/reference/) reference page for more information.
