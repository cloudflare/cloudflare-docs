...
- {props.mwanAccount}
- Went through the process of [setting up your cloud provider](/magic-cloud-networking/get-started/).
- Have the correct cloud resources. Refer to [Reference](/magic-cloud-networking/reference/) to check resources by cloud provider.
...
After setting up your on-ramps, you need to update your network security groups in your cloud provider to allow traffic to/from Cloudflare WAN. Refer to the [Cloud on-ramps](/magic-cloud-networking/reference/) reference page for more information.
