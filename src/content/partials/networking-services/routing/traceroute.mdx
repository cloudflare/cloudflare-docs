...
If you have a Magic WAN client connected through <a href={props.greIpsecURL}>GRE</a>, <a href={props.greIpsecURL}>IPsec</a>, [CNI](/network-interconnect/), or <a href={props.warpURL}>WARP</a>, you can perform a `traceroute` to an endpoint behind a <a href={props.cfTunnelURL}>Cloudflare Tunnel</a>. Apply the following settings for the command to return useful information.
