...
{ props.magicWord !== "Magic Transit" && (
  <>
    ...
    <Markdown
      text={`
			- Now that you have set up your tunnel endpoints you need to configure routes to route your traffic through Cloudflare. Refer to [Configure routes](${props.configureRoutesURL}) to learn more about static routing and BGP peering.
