...
import { APIRequest, CURL, Details, GlossaryTooltip, Render, TabItem, Tabs, DashButton } from "~/components";
...
10. _(Optional)_ If you keep **Tunnel health checks** enabled, choose the <a href={props.updateHCFrequencyPage}>**Health check rate**</a> for your tunnel. Available options are _Low_, _Medium_ and _High_.
