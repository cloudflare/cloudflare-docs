...
To use a site, start by setting up your on-ramps. These can be <a href={props.greIpsecTunnelsURL}>GRE or IPsec tunnels</a>, a <a href={props.connectorURL}>Magic WAN Connector</a>, or a direct [CNI link](/magic-wan/network-interconnect/). When you are finished setting these up, refer to the steps below to learn how to set up a site.
