...
{ props.magicWord === "CF1 Cloudflare WAN" ? (
	...
	<Markdown
		...
		11. In **Alert sensitivity level** define the threshold for Tunnel health alerts to be fired. For details, refer to [How Cloudflare calculates Tunnel health alerts](/cloudflare-wan/reference/how-cloudflare-calculates-magic-tunnel-health-alerts/).
	...
	<DashButton url="/?to=/:account/networking-insights/health" />
		...
		10. In **Alert sensitivity level** define the threshold for Tunnel health alerts to be fired. For details, refer to [How Cloudflare calculates Tunnel health alerts](/cloudflare-wan/reference/how-cloudflare-calculates-magic-tunnel-health-alerts/).
...
<Render
	...
	params={{
		...
		networkOverviewPageName: props.magicWord === "CF1 Cloudflare WAN" ? "Network visibility" : "Network overview (beta)",
