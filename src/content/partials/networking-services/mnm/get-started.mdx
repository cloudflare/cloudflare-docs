...
1. Go to [Network flow](https://dash.cloudflare.com//?to=/:account/networking-insights/analytics/network-analytics/flow-analytics) page.
...
Go to the [Network flow](https://dash.cloudflare.com//?to=/:account/networking-insights/analytics/network-analytics/flow-analytics) page. The default view will be the analytics dashboard for Magic Network Monitoring.
