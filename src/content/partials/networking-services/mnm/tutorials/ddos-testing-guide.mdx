...
Customers who want to effectively test Cloudflare's Magic Network Monitoring in a repeatable manner can devise a simulated DDoS attack. At a high level, you would need to:
