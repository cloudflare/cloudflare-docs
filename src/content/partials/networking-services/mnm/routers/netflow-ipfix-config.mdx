...
Network Flow (formerly Magic Network Monitoring) supports the NetFlow v5, NetFlow v9, and IPFIX network <GlossaryTooltip term="flow data">flow data</GlossaryTooltip> formats.
...
5. Verify your router's NetFlow template does not contain duplicated fields.