...
To review an example static threshold rule, go to the [Rules](https://api.cloudflare.com/#magic-network-monitoring-rules-properties) section in the Network Flow API documentation.
