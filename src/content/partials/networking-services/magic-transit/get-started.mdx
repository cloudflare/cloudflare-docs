...
{ props.magicWord === "Magic Transit" && (
  <>
	...
	<ul>
		...
		<li>Consider enabling <a href="/ddos-protection/advanced-ddos-systems/overview/advanced-tcp-protection/">Advanced TCP Protection</a> and <a href="/ddos-protection/advanced-ddos-systems/overview/advanced-dns-protection/">Advanced DNS Protection</a> for additional security.</li>
	</ul>
