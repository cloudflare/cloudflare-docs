...
<Width size="large">
![Cloudflare automatically notifies you when Cloudflare detects an attack based on your flow data.](~/assets/images/magic-network-monitoring/2-flowdata.png)
</Width>
