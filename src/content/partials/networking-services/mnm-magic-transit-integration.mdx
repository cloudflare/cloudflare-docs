...
<Width size="large">
	![The diagram shows the flow of traffic when you send flow data from your
	network to Cloudflare for
	analysis.](~/assets/images/network-flow/1-flowdata.png)
</Width>

<Width size="large">
	![Cloudflare automatically notifies you when Cloudflare detects an attack
	based on your flow data.](~/assets/images/network-flow/2-flowdata.png)
</Width>

<Width size="large">
	![You can create rules to activate Magic Transit automatically, to protect
	your IP addresses from a DDoS
