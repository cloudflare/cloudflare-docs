...
3. **Prefix advertisement status** (Magic Transit): Confirm prefixes show **Advertised** in the dashboard, not **Withdrawn** or **Approved**.
4. **Route propagation timing** (Magic Transit): Allow two to five minutes for changes to propagate globally. Cloudflare propagates changes within minutes, but has no control over how quickly external ISPs refresh their BGP tables.
...
When you advertise or withdraw a Magic Transit BYOIP prefix, changes propagate across Cloudflare's network within minutes.
...
This section covers BGP peering sessions between your network and Cloudflare, established over [CNI](/network-interconnect/) or tunnels.
...
### Prefixes not reachable after advertisement (Magic Transit)
...
### Traffic loss during prefix withdrawal (Magic Transit)
...
- **External BGP visibility** (Magic Transit): Results from looking glass tools showing your prefix
...
- [Advertise prefixes](/magic-transit/how-to/advertise-prefixes/) (Magic Transit): BGP control methods and safe withdrawal procedures
