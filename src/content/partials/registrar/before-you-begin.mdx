...
* Create [a Cloudflare account](/fundamentals/account/create-account/) preferably using an email domain that is not associated with the domain you are transferring to Cloudflare. Using a different email domain will alow you to continue to receive communications from Cloudflare and recover your domain in the event your domain becomes suspended.
