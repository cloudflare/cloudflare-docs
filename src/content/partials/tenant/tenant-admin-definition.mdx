...
Tenant admins then become the default [**Super administrator(s)**](/fundamentals/manage-members/roles/) for all accounts and zones contained within the Tenant.
...
If needed, you can also [create additional **Super administrators**](/fundamentals/manage-members/manage/).
