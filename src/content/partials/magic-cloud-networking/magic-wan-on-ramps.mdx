...
- {props.one}
- Went through process of [setting up your cloud](/magic-cloud-networking/get-started/).
- You have the correct cloud resources. Refer to [Reference](/magic-cloud-networking/reference/) to check resource by cloud provider.
