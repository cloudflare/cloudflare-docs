...
1. Log in to the [Cloudflare dashboard](https://dash.cloudflare.com/), and select your account.
2. Select **Magic WAN** > **Cloud on-ramps**.
3. Find the cloud on-ramp for which you want to check the costs.
4. Select the three dots > **Associated Resources**.

The Cloudflare dashboard shows you the estimated monthly costs for all the resources associated with the on-ramp you chose.
