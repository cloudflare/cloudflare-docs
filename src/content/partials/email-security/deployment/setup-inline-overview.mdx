...
More technically, Cloud Email Security becomes a hop in the <GlossaryTooltip term="SMTP">SMTP</GlossaryTooltip> processing chain and physically interacts with incoming email messages. Based on your policies, various messages are blocked before reaching the inbox.

![With inline deployment, messages travel through Cloud Email Security's email filter before reaching your users.](~/assets/images/email-security/deployment/inline-setup/inline-deployment-diagram.png)
