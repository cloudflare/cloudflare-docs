...
You can add one or more types of bindings to your [Wrangler configuration](/workers/wrangler/configuration) file. However, each attribute must be on its own line:
