...
<Tabs syncKey="dashNewNav">
    ...
    <TabItem label="New dashboard" icon="rocket">
        <Steps>
         ...
         5. Select the toggle to disable **Bot Fight Mode**.
         6. For all bot groupings (**Definitely automated**, **Verified bots**, etc.), select the edit icon and set the value to **Allow**.
         7. For all other options (**Static resource protection**, **JavaScript Detections**), select the edit icon and ensure the toggles are **Off**.
        </Steps>
    </TabItem>
</Tabs>