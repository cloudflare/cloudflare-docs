...
| Type | Name     | Content                 |
| ---- | -------- | ----------------------- |
| NS   | internal | `ns1.externalhost.com`  |
| NS   | internal | `ns2.externalhost.com`  |
| NS   | internal | `ns3.externalhost.com`  |
| NS   | internal | `ns4.externalhost.com`  |
| NS   | internal | `ns5.externalhost.com`  |
| NS   | internal | `ns6.externalhost.com`  |
| NS   | internal | `ns7.externalhost.com`  |
| NS   | internal | `ns8.externalhost.com`  |
| NS   | internal | `ns9.externalhost.com`  |
| NS   | internal | `ns10.externalhost.com` |

In this example, Cloudflare would prevent you from adding another NS record for the delegation name `internal`.
