...
Cloudflare will not bill step and storage usage before the start date announced in the [Workflows billing changelog](/changelog/post/2026-07-01-workflows-billing-updates/).
