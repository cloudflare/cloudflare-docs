...
You can connect PlanetScale to Cloudflare using the [native integration](/workers/databases/third-party-integrations/planetscale/) which automatically creates a Hyperdrive configuration without manually copying credentials.
