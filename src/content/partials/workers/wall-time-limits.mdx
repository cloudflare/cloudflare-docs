...
| ------------------------------------------------------------------ | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Incoming HTTP request                                              | 30 seconds      | The response must be returned within 30 seconds. [`waitUntil()`](/workers/runtime-apis/handlers/fetch/) allows work to continue after the response is sent, but all tasks must complete within the same 30-second total limit. |
