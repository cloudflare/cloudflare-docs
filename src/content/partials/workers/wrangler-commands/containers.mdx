...
[Read more](/containers/guides/image-management/#using-amazon-ecr-container-images) about our currently supported external registries.
...
Connect to a running Container instance using SSH. Refer to [SSH](/containers/guides/ssh/) for configuration details.
