...
- `CONTAINER_ID` <Type text="string" /> <MetaInfo text="required" />
  - The ID of the Container to SSH into.
- `--cipher` <Type text="string" /> <MetaInfo text="optional" />
  - SSH option for cipher_spec
- `--log-file` <Type text="string" /> <MetaInfo text="optional" />
...
- `--identity-file` <Type text="string" /> <MetaInfo text="optional" />
  - SSH option for identity_file
- `--mac-spec` <Type text="string" /> <MetaInfo text="optional" />
...
- `--tag` <Type text="string" /> <MetaInfo text="optional" />
  - SSH option for tag
- `--ctl-path` <Type text="string" /> <MetaInfo text="optional" />
  - SSH option for ctl_path
