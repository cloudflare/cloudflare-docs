...
- `--binding` <Type text="string" />
  - The binding name of the namespace, as stored in the [Wrangler configuration](/workers/wrangler/configuration) file, to delete.
...
- `--binding` <Type text="string" />
  - The binding name of the namespace, as stored in the [Wrangler configuration](/workers/wrangler/configuration) file, to get from.
- `--namespace-id` <Type text="string" />
