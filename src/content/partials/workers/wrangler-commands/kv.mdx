...
To restrict where a namespace durably stores data, specify `--jurisdiction` when creating it. Refer to [Data location](/kv/reference/data-location/) for supported jurisdictions.
