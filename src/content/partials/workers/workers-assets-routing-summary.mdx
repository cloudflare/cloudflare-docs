...
For example, if you have requests for `/logo.png` and `/blog/hello-world.html` in your assets directory, and make requests for `/logo.png` and `/blog/hello-world`, those files will be served respectively. The [`html_handling`](/workers/configuration/assets/#html_handling) option allows you to customize the serving of HTML files if you have specific needs around redirects and trailing slashes.
