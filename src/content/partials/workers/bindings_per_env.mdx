...
[^1]: Refer to [Using remote resources with Durable Objects and Workflows](/workers/development-testing/remote-bindings/#using-remote-resources-with-durable-objects-and-workflows) for recommended workarounds.
