...
To accurately track your usage, use the [meta object](/d1/build-with-d1/d1-client-api/#return-object) or the [Cloudflare dashboard](https://dash.cloudflare.com/login). From your dashboard, navigate to: Storage & Databases > D1 > `[YOUR_DATABASE]` > Metrics > Row Metrics.
:::
