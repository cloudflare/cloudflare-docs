...
| Vector search & embeddings queries | [Vectorize](/vectorize/)                         | Storing [embeddings](/workers-ai/models/?tasks=Text+Embeddings) from AI models for semantic search and classification tasks.  |
