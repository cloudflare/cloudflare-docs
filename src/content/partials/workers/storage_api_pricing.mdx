...
Durable Objects do not have to use the Storage API, but if your code does call methods on `ctx.storage`, it will additional charges.

### Key-value storage billing
