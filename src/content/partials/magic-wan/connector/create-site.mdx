...
6. Under **Connector**, select **Add Connector**. This will show you a list of Magic WAN Connector devices associated with your account. <Markdown text={props.three} />
...
3. **Interface number** <Markdown text={props.two} />
