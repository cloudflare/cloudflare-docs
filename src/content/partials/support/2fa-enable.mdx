...
2. Select the **My Profile** icon in the top right of the screen.
3. Select **Access Management** > [**Authentication**](https://dash.cloudflare.com/profile/access-management/authentication/two-factor). 
