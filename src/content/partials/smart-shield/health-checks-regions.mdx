...
* Regional Aggregates: Combined results from the three colos within a specific region.
* Global Aggregates: Total results across all configured regions and colos.

In the event log, entries are labeled by region or as "Global." We do not provide granular data for individual colos.
