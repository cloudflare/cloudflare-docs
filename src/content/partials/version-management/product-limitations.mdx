...
<Details header="Workers Routes">

</Details>

- When editing Worker Routes in the dashboard, those edits need to be managed in the [Workers & Pages](/workers/configuration/routing/routes/#set-up-a-route-in-the-dashboard) dashboard.
