...
- Changes made to [Image Transformations](/images/optimization/transformations/overview/) are not cloned when a new zone version is created.
...
<Details header="Client-side security">
...
- [Security Insights](/security/security-insights/) are not shown when Zone Versioning is enabled and the first version is deployed to production.
