...
- Send a request to [`/$page/index.md`](index.md) — Add `/index.md` to the end of any page to get the Markdown version. For example, [`/style-guide/index.md`](/style-guide/index.md).
