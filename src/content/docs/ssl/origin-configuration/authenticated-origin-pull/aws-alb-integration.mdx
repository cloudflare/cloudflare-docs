...
If you need to disable or remove this configuration, refer to [Rollback authenticated origin pulls configuration](/ssl/origin-configuration/authenticated-origin-pull/set-up/rollback/).
