...
- **October 21, 2024**: Zones created on or after this date will be enrolled in the Upgrader.
...
- **December 4, 2024**: All non-Enterprise zones that have never used the Recommender or Automatic Upgrader will be migrated. Automatic upgrade scans for these zones will begin on or after this date.
- **January 6, 2025**: All Enterprise zones that have never used the Recommender or Automatic Upgrader will be migrated. Automatic upgrade scans for these zones will begin on or after this date.
