...
Custom Origin Trust Store accepts ML-DSA (FIPS 204) post-quantum certificate authorities. Refer to [Post-quantum signatures](/ssl/post-quantum-cryptography/pqc-to-origin/#post-quantum-signatures) for certificate generation and upload guidance.
