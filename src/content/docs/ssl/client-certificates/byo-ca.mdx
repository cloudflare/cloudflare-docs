...
:::note
Uploading the CA private key is only required if you wish to use [Zero Trust's block page](/cloudflare-one/team-and-resources/devices/user-side-certificates/custom-certificate/) and can only be achieved via API.
:::
...
5. Select **Continue**.
6. On the **Associate Hostnames** page, enter the fully qualified domain name that should use this CA for mTLS validation and select **Add** for each one. You can also skip this step and associate hostnames later.
