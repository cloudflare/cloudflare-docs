...
3. Make requests to the hostname and/or path configured, with and without sending the mTLS client cert. Then, compare the responses against expected values:
