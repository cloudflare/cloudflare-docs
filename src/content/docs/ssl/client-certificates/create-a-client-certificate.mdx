...
2. Select **Add Certificate** and fill in the required fields. You can choose one of the following options:
...
:::note
Client certificates created on the dashboard are issued by a [Cloudflare-managed CA](/ssl/client-certificates/#how-it-works). If you need to use certificates issued by another CA, refer to [Bring your own CA](/ssl/client-certificates/byo-ca/) instead.
:::
