...
This fallback schedule does not apply to Custom Hostname certificates. For more information, refer to [Renew Custom Hostname certificates](/cloudflare-for-platforms/cloudflare-for-saas/security/certificate-management/issue-and-validate/renew-certificates/).
