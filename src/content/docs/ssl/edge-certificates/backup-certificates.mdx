...
Enterprise customers can opt out of backup certificates. To disable backup certificates for your domain, [contact Cloudflare Support](/support/contacting-cloudflare-support/).
