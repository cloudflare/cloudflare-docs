...
### Backup certificate deleted after re-enabling Universal SSL

After you disable and quickly re-enable Universal SSL, your domain may end up without a backup certificate.
...
1. Wait several minutes after disabling Universal SSL before re-enabling it.
2. Re-enable Universal SSL, then allow time for a new backup certificate to be issued.
