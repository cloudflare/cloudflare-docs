...
* [Per-hostname](/api/resources/hostnames/subresources/settings/subresources/tls/methods/update/) (Regular zones only. For custom hostnames, consider the following section.)
