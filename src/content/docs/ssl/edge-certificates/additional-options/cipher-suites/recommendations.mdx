...
:::caution
When opting for [compatible](#compatible) or [modern](#modern), make sure to review the [related SSL/TLS settings](/ssl/edge-certificates/additional-options/cipher-suites/#related-ssltls-settings)[^4].
:::
...
[^4]: Although configured independently, cipher suites interact with **Minimum TLS version** and **TLS 1.3**.