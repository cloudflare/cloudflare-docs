...
Please note that it's not possible to use a different CSR with the same certificate. In this case you will need to upload the certificate as a new certificate, selecting the new CSR.
