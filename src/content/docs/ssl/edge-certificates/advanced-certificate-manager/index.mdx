...
- Use [delegated DCV](/ssl/edge-certificates/changing-dcv-method/methods/delegated-dcv/) to delegate the <GlossaryTooltip term="domain control validation (DCV)">DCV process</GlossaryTooltip> of your partial zones (<GlossaryTooltip term="CNAME setup" link="/dns/zone-setups/partial-setup/">CNAME setup</GlossaryTooltip>) to Cloudflare.
