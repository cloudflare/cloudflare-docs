...
The related value for the `bundle_method` parameter when using the [API](https://developers.cloudflare.com/api/operations/custom-ssl-for-a-zone-create-ssl-configuration) is `ubiquitous`.
...
The related value for the `bundle_method` parameter when using the [API](https://developers.cloudflare.com/api/operations/custom-ssl-for-a-zone-create-ssl-configuration) is `optimal`.
...
The related value for the `bundle_method` parameter when using the [API](https://developers.cloudflare.com/api/operations/custom-ssl-for-a-zone-create-ssl-configuration) is `force`.
