...
description: >-
  This tutorial uses Google Cloud HSM — a FIPS 140-2 Level 3 certified implementation. To set up the Google Cloud. HSM, [create a key ring] and indicate its location.
---
