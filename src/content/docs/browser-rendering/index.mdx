...
- [Crawled web content](/browser-rendering/rest-api/crawl-endpoint/)
...
- **Easy to integrate**: [REST APIs](/browser-rendering/rest-api/) for common actions, [Puppeteer](/browser-rendering/puppeteer/) and [Playwright](/browser-rendering/playwright/) for complex workflows, and [CDP](/browser-rendering/cdp/) for direct browser control from any environment
