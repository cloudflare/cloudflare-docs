...
- [Markdown](/browser-rendering/quick-actions/markdown-endpoint/)
- [Screenshots](/browser-rendering/quick-actions/screenshot-endpoint/)
- [PDFs](/browser-rendering/quick-actions/pdf-endpoint/)
- [Snapshots](/browser-rendering/quick-actions/snapshot/)
- [Links](/browser-rendering/quick-actions/links-endpoint/)
- [HTML elements](/browser-rendering/quick-actions/scrape-endpoint/)
- [Structured data](/browser-rendering/quick-actions/json-endpoint/)
- [Crawled web content](/browser-rendering/quick-actions/crawl-endpoint/)
...
- **Easy to integrate**: [Quick Actions](/browser-rendering/quick-actions/) for common tasks, [Puppeteer](/browser-rendering/puppeteer/) and [Playwright](/browser-rendering/playwright/) for complex workflows, and [CDP](/browser-rendering/cdp/) for direct browser control from any environment
- **Session management**: [Reuse browser sessions](/browser-rendering/features/reuse-sessions/) across requests to improve performance and reduce cold-start overhead
...
A globally distributed coordination API with strongly consistent storage. Using Durable Objects to [persist browser sessions](/browser-rendering/how-to/browser-rendering-with-do/) improves performance by eliminating the time that it takes to spin up a new browser session.
