...
As seen in the [Deploy a Browser Rendering Worker](/browser-rendering/how-to/deploy-worker/) guide, Browser Rendering can be used to generate screenshots for any given URL. Alongside screenshots, you can also generate full PDF documents for a given webpage, and can also provide the webpage markup and style ourselves.
