...
As seen in [this guide](/browser-rendering/how-to/deploy-worker/), Browser Rendering can be used to generate screenshots for any given URL. Alongside screenshots, you can also generate full PDF documents for a given webpage, and can also provide the webpage markup and style ourselves.

You can generate PDFs with Browser Rendering in two ways:

- **[Quick Actions](/browser-rendering/quick-actions/)**: Use the [/pdf endpoint](/browser-rendering/quick-actions/pdf-endpoint/). This is ideal if you do not need to customize rendering behavior.
- **[Puppeteer](/browser-rendering/puppeteer/)** or **[Playwright](/browser-rendering/playwright/)**: Use browser automation within Workers for additional control and customization.
