...
Users on the Workers Free plan are subject to [standard Browser Rendering limits](/browser-rendering/platform/limits/#workers-free), plus the following crawl-specific restrictions:

- **5 crawl jobs per day** — You can initiate up to 5 crawl jobs per day.
- **Maximum 100 pages per crawl** — The `limit` parameter cannot exceed 100 pages.

To remove these restrictions, [upgrade to a Workers Paid plan](/workers/platform/pricing/).
:::
