...
If you are on a Workers Free plan, your crawl may fail if it hits the [limit of 10 minutes per day](/browser-rendering/pricing/). To avoid this, you can either [upgrade to a Workers Paid plan](/workers/pricing/) or you can [put limitations on timeouts](/browser-rendering/reference/timeouts/) to get the most out of the 10 minutes of your crawl request.
:::
...
- `cancelled_due_to_timeout` — The crawl job exceeded the maximum run time of 7 days.
- `cancelled_due_to_limits` — The crawl job was cancelled because it hit [account limits](/browser-rendering/platform/limits/).
