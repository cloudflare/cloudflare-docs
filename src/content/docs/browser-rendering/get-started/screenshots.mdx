...
<Render file="c3-run-command-with-directory" product="workers" params={{ one: "browser-worker" }} />

<Render file="c3-post-run-steps" product="workers" params={{ one: "Hello World example", two: "Hello World Worker", three: "JavaScript / Typescript" }} />
