...
2. Make sure you have the [browser rendering](/browser-rendering/) and [durable object](/durable-objects/) bindings and [migrations](/durable-objects/how-to/configure-migrations/) in your Wrangler configuration file.
