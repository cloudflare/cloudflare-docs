...
Browser Rendering service is currently available at no cost. You can use the service within the limits specified above without incurring charges **until billing begins**. We will provide advance notice before any billing begins.
