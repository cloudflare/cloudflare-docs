...
title: Wrangler
description: Wrangler: Command-line tool for deploying projects using Cloudflare's Workers Browser Rendering API. Install, configure bindings, and deploy with ease.
sidebar:
  order: 20
---
