...
- [**Quick Actions**](/browser-rendering/quick-actions/): Charged for browser hours only.
- **Browser Sessions** ([Puppeteer](/browser-rendering/puppeteer/), [Playwright](/browser-rendering/playwright/), [CDP](/browser-rendering/cdp/)): Direct browser control, charged for both browser hours and concurrent browsers.
