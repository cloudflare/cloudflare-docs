...
- If you use a [Workers binding](/browser-rendering/workers-bindings/) with [Puppeteer](/browser-rendering/puppeteer/) or [Playwright](/browser-rendering/playwright/), refer to the [Workers binding](#workers-binding) section.
- If you use the [REST API](/browser-rendering/rest-api/), refer to the [REST API](#rest-api) section.
