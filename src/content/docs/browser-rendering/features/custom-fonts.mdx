...
- If you are using [Puppeteer](/browser-rendering/puppeteer/) or [Playwright](/browser-rendering/playwright/), refer to the [Puppeteer and Playwright](#puppeteer-and-playwright) section.
