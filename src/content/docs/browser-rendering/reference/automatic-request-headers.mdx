...
The bot detection ID for Browser Rendering is `128292352`. You can use this ID to create [WAF custom rules](/waf/custom-rules/) that specifically match Browser Rendering traffic.
