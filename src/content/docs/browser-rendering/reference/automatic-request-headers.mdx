...
| [Puppeteer](/browser-rendering/puppeteer/), [Playwright](/browser-rendering/playwright/), [CDP](/browser-rendering/cdp/) | The default User-Agent of the underlying Chrome version | Yes, via Puppeteer/Playwright configuration |
