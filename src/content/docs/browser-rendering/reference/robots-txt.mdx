...
Browser Rendering has a bot detection ID of `128292352`. Use this to create WAF rules that allow or block Browser Rendering traffic.

The default user agent for Browser Rendering crawl requests is `CloudflareBrowserRenderingCrawler/1.0`. Users can override this value when making requests.
...
| `<priority>` | Relative importance (0.0-1.0) | Not currently respected by Browser Rendering, but may be supported in future. |
