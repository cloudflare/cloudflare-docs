...
This page provides general guidance on configuring `robots.txt` and sitemaps for websites you plan to access with Browser Run (formerly Browser Rendering).
...
- [FAQ: Will Browser Run be detected by Bot Management?](/browser-run/faq/#will-browser-rendering-be-detected-by-bot-management) — How Browser Run interacts with bot protection and how to create a WAF skip rule
