...
If you have not yet added a payment method follow [Add or update payment methods](#add-or-update-payment-methods) and enter your VAT/GST details when prompted on Step 5. Otherwise, follow the steps below.
