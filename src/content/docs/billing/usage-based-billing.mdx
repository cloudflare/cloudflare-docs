...
You can choose the product that you want to be notified about and the threshold that triggers the notification. Thresholds depend on the product chosen.
