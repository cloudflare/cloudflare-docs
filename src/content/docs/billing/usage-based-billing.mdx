...
The billable usage dashboard gives Pay-as-you-go (PayGo) customers daily visibility into usage-based costs across their Cloudflare account. The data comes from the same system that generates your monthly invoice, so the figures match your bill.
