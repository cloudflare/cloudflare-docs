...
To avoid being charged for the next billing period, complete any downgrade at least 24 hours before your next billing date.

If you downgrade your plan, your plan may have access to [fewer Page Rules](/rules/page-rules/). If you continue to use more page rules than is allowed by your plan limit, you may be charged for additional rules. Remove excess rules and [cancel additional subscriptions](/billing/manage/cancel-subscription/) if you do not want to be charged.
