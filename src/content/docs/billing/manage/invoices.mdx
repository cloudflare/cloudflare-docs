...
Only Super Administrators can access invoices through the Cloudflare dashboard. An invoice is typically available within 24 hours of the account change that triggered it.
