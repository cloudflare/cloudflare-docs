...
6. Configure the alert:
   ...
   ![The Create Budget Alert dialog with fields for alert name, description, budget threshold in USD, and email recipients.](~/assets/images/billing/create-budget-alert.png)
