...
If you cannot resolve this using your current payment method, you may wish to try an alternative payment method. We support multiple different credit card types and PayPal. To try this, refer [add a new payment method](/billing/get-started/update-billing-info/#update-payment-methods).
