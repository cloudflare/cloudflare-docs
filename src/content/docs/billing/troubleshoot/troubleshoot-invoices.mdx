...
If your billing contact information has changed, [update your Cloudflare email address](/billing/get-started/update-billing-info/#update-billing-email-address) as soon as possible.
...
To add your business or company name, VAT ID, or Tax ID/EIN on an invoice, add the company name when [updating billing information](/billing/get-started/update-billing-info/).
