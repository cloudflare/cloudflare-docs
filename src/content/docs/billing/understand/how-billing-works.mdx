...
sidebar:
  order: 0
description: Understand the Cloudflare billing lifecycle, charge types, billing cycles, and how to read your invoice.
---
...
:::note
Cloudflare does not currently retry your secondary payment method if the primary one fails. You must manually update your payment method or pay the balance yourself.
:::
...
### 1. Plan charges (flat rate, billed in advance)
...
> **Cloudflare Pro Plan** (example1.com, example2.com, example3.com) -- Qty 3 -- $25.00 -- $75.00

### 2. Subscription and add-on charges (flat rate, billed in advance)
...
> **Basic Load Balancing** -- Apr 14 - May 13, 2026 -- Qty 1 -- $5.00<br/>
> **Images Stream Bundle Basic** -- Apr 14 - May 13, 2026 -- Qty 1 -- $5.00<br/>
> **Smart Shield Argo Zone Level Plan - Basic** -- Apr 14 - May 13, 2026 -- Qty 1 -- $5.00
...
### 3. Usage-based charges (metered, billed in arrears)

Products like Workers, R2, Cache Reserve operations, Stream minutes viewed, and Argo data transfer are billed based on actual usage from the **previous** billing period. These line items show a date range for the prior period (for example, "Mar 14 - Apr 13") and a quantity representing your consumption.

For example:

> **Cache Reserve Reads** -- Mar 14 - Apr 13, 2026 -- Qty 166,865 -- $0.36 per 1,000,000 -- $0.36<br/>
> **Smart Shield Argo Accelerated Gigabytes** (First GB is included) -- Mar 14 - Apr 13, 2026 -- Qty 34 -- $0.10 -- $3.40<br/>
> **Stream Bundle Basic Minutes of Video Viewed** (in thousands) -- Mar 14 - Apr 13, 2026 -- Qty 198 -- $1.00 per 1,000 -- $1.00
...
|---|---|---|
| Usage-based charges | Previous period (for example, Mar 14 - Apr 13) | Metered consumption from the billing period that just ended |
...
### Why are there so many $0.00 line items?
...
For example, if you upgrade to the Pro plan on January 10, all monthly charges will bill on the 10th of each month going forward.
...
- **Cancellations** follow the same timing as downgrades -- service continues until the end of the billing period. No refunds are issued for the remaining time.
