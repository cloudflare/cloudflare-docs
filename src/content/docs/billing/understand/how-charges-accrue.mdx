...
| Cache Reserve reads | If Cache Reserve is enabled and the asset is served from tiered cache storage, reads are metered. Refer to [Cache Reserve pricing](/cache/how-to/cache-reserve/) for current rates. |
...
| Resource | Billing impact |
|---|---|
| Cache Reserve writes | If Cache Reserve is enabled, writes are metered. Refer to [Cache Reserve pricing](/cache/how-to/cache-reserve/) for current rates. |
