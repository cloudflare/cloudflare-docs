...
:::note
If you are a US-based customer, you can [file for sales tax exemption](/billing/understand/sales-tax/#filing-for-us-sales-tax-exemption).
:::
...
## Zero Trust free plan billing

A payment method is required when you first set up a Zero Trust free plan. Cloudflare stores this payment method for future upgrades, but does not charge it while you stay on the Zero Trust Free plan.

- You will not be charged while on the Zero Trust Free plan.
- To manage your Zero Trust subscription, go to **Account** > **Billing** in the [Zero Trust dashboard](https://one.dash.cloudflare.com/).
- If you downgrade during a billing cycle, the new pricing takes effect at the start of the next billing cycle.
- If you upgrade during a billing cycle, you are billed immediately for the new plan.

## Related resources

- [Cloudflare Self-Serve Subscription Agreement](https://www.cloudflare.com/terms/)
- [Understanding Cloudflare Invoices](/billing/manage/invoices/)
- [Understanding Cloudflare sales tax](/billing/understand/sales-tax/)
