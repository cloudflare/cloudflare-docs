...
Changes to your billing profile are reflected on your next invoice, not the current one. If you update your billing details on the same date an invoice is issued, the changes will not appear on that invoice. Invoices reflect the details that were entered in the **Billing** section of the Cloudflare dashboard at the time the invoice was generated.
...
Your billing email address is particularly important if you have [opted into email invoices](/billing/manage/invoices/#enable-email-invoices-from-cloudflare).
