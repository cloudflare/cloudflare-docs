...
Cloudflare only accepts Visa, Mastercard, American Express, Discover, PayPal, Link (not available for Registrar), and UnionPay. No other payment methods (for example, Maestro) are possible at this time.
