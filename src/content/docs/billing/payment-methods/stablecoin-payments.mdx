...
If you need to request a refund or cancel your services, please follow the steps below.

### Requesting a Refund

To request a refund, contact Cloudflare Support with your refund request and reason. Refunds are typically processed within 5-10 business days. Please note that refunds for stablecoin payments are returned as USDC to the wallet you paid from.

### Accidental Renewals

If you have been accidentally charged for a renewal, contact Cloudflare Support as soon as possible. We will review your case and process a refund if eligible.

### Cancelling Unused Services

To cancel unused services, log in to the Cloudflare dashboard, go to **Manage Account** > **Billing**, and select the service you want to cancel. You can cancel services at any time, but please note that you will not receive a refund for the current billing cycle.

### Associated Fees

There are no additional fees for cancelling services, but you may be subject to fees for early termination of certain services. Please review your service agreement for more information.
