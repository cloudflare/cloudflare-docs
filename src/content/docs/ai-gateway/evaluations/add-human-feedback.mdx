...
1. After providing feedback on your logs, it becomes part of the evaluation process.
   ...
   - Note: You need to select human feedback as an evaluator to receive its metrics.
2. The human feedback score is displayed as a percentage, showing how much of the dataset's responses were rated positively by human reviewers.
...
For more information on running evaluations, refer to the official Cloudflare documentation:

- [Set Up Evaluations](/ai-gateway/evaluations/set-up-evaluations/)
