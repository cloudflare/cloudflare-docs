...
Customers who create their first gateway on or after September 24, 2026 follow [Workers Logs pricing and retention](/workers/observability/logs/workers-logs/#pricing).

### Existing AI Gateway customers

Customers who created a gateway before September 24, 2026 use [Legacy Logs](/ai-gateway/observability/logging/legacy-logs/). Persistent log storage is available on all plans with these limits:
