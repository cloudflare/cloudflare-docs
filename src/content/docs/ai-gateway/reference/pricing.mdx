...
A 5% fee is applied to all credits purchased through [Unified Billing](/ai-gateway/features/unified-billing/). For example, a $100 credit purchase will result in a $105 charge.
