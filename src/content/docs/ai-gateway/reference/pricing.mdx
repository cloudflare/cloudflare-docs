...
These accounts use [Logs](/ai-gateway/observability/logging/) powered by Workers Observability. Refer to [Workers Logs pricing](/workers/observability/logs/workers-logs/#pricing) for current pricing and retention.
