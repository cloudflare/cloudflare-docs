...
These accounts use [Logs](/ai-gateway/observability/logging/) powered by Workers Observability. Refer to [Workers Logs limits](/workers/observability/logs/workers-logs/#limits) and [Workers Logs pricing](/workers/observability/logs/workers-logs/#pricing).

### Accounts created before September 24, 2026

These accounts use [Legacy Logs](/ai-gateway/observability/logging/legacy-logs/). The following limits apply:
...
These limits apply to both Logs and Legacy Logs:
