...
[Logpush](/ai-gateway/observability/logging/logpush/) to export logs to external
storage. Refer to [Automatic log
deletion](/ai-gateway/observability/logging/#automatic-log-deletion) for more
details.

<sup>2</sup> On the free plan, the log storage limit applies to total logs
across all gateways in your account. Same auto-delete or stop-saving behavior as
<sup>1</sup>.
