...
| Maximum logs stored [paid plan](/ai-gateway/reference/pricing/) | 10 million per gateway     |
| Maximum logs stored [free plan](/ai-gateway/reference/pricing/) | 100,000 per account        |
