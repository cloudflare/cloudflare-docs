...
For accounts created on or after September 24, 2026, refer to [Workers Logs limits](/workers/observability/logs/workers-logs/#limits) and [Workers Logs pricing](/workers/observability/logs/workers-logs/#pricing).
