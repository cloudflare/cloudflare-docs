...
:::note
You can also access third-party models through AI Gateway using the Workers AI binding. Refer to the [Workers AI binding reference](/ai-gateway/integrations/worker-binding-methods/#envairun) for details.
:::
