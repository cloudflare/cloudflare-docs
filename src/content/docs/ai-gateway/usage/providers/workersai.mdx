...
:::note
You can also access third-party models through AI Gateway using the Workers AI binding. Refer to [Call third-party models](/ai-gateway/integrations/worker-binding-methods/#call-third-party-models) for details.
:::
