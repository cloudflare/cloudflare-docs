...
- `{gateway_id}` refers to the name of your existing [AI Gateway](/ai-gateway/configuration/manage-gateway/#create-gateway).
...
- `id` string
  - Name of your existing [AI Gateway](/ai-gateway/configuration/manage-gateway/#create-gateway). Must be in the same account as your Worker.
