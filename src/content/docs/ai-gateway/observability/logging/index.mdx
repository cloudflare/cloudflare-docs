...
For Cloudflare accounts created on or after September 24, 2026, AI Gateway logging follows [Workers Logs pricing and retention](/workers/observability/logs/workers-logs/#pricing).
