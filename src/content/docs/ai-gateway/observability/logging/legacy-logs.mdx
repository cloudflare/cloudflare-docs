...
Legacy Logs applies only to Cloudflare accounts created before September 24, 2026. Accounts created on or after September 24, 2026 use [Logs](/ai-gateway/observability/logging/) powered by Workers Observability.
:::
