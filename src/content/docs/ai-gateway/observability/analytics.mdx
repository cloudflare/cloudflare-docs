...
- **Requests**: View the total number of requests processed by AI Gateway.
- **Token Usage**: Analyze token consumption across all requests, giving insight into usage patterns.
