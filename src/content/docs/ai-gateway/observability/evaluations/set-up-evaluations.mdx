...
Datasets are collections of logs stored for analysis that can be used in an evaluation. You can create datasets by applying filters in the Logs or Evaluations tab, which helps narrow down specific logs for evaluation. Datasets will update automatically based on the set filters.
...
While datasets automatically update based on filters, evaluations do not. You will have to create a new evaluation if you want to use new logs.
