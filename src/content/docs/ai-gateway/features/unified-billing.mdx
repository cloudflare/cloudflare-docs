...
When calling models through the [Workers AI binding](/ai-gateway/integrations/worker-binding-methods/#envairun) (`env.AI.run()`), Unified Billing is supported for all available third-party models. Browse the full list in the [model catalog](https://developers.cloudflare.com/ai/models/).
