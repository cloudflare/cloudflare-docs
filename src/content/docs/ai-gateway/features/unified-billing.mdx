...
:::caution
In rare instances, your credit balance may go negative. If this happens, Cloudflare will charge the payment method on file for the outstanding amount at the beginning of each month for the previous month.
:::
...
Refer to the [binding reference](/ai-gateway/usage/worker-binding-methods/) for the full API surface.
