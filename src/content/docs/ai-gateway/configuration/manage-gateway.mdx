...
### Force BYOK for third-party requests

To prevent Unified Billing fallback for third-party provider requests, turn on **Require provider credentials**. Refer to [Force BYOK for third-party requests](/ai-gateway/features/unified-billing/#force-byok-for-third-party-requests) for dashboard and API instructions.
