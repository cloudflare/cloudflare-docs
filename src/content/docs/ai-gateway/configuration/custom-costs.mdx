...
The cost metric is an **estimation** based on the number of tokens sent and received in requests.
...
While this metric can help you monitor and predict cost trends, refer to your provider’s dashboard for the most **accurate** cost details.

Providers may add new models or change pricing. If you believe a cost is out of date or you are using a model that does not yet have costs supported, please let us know through Discord/your account team what models you would like to see added.
