...
[**Context**](/style-guide/documentation-content-strategy/component-attributes/context/): an introductory paragraph on the section and what users can expect from it.
...
[**Context**](/style-guide/documentation-content-strategy/component-attributes/context/) (page): an introductory paragraph on the section and what users can expect from it.

Section titles

[**Context**](/style-guide/documentation-content-strategy/component-attributes/context/) (section): a one-liner describing what users will find in that sub-section
