...
- [**Context**](/style-guide/documentation-content-strategy/component-attributes/context/) opens the page with a short paragraph on the topic and what the reader can expect to find.
...
- [**Links**](/style-guide/documentation-content-strategy/component-attributes/links/) carry the reader from a called-out question to the how-to, tutorial, or glossary entry that answers it in full.
