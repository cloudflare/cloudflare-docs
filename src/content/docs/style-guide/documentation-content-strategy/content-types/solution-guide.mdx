...
Solution guides live at `/use-cases/{guide-slug}/` — centrally housed outside any product vertical. This placement ensures they are discoverable by users who have not yet chosen a product, and aligns with industry conventions for this content type.
