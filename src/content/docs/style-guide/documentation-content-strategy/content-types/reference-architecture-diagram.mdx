...
This page describes the content strategy for a reference architecture diagram. For help with Cloudflare products, refer to [Reference architectures diagrams](/reference-architecture/diagrams/).
...
- [`PublicStats`](/style-guide/components/public-stats/): <Render file="public-stats-definition" product="style-guide" />
