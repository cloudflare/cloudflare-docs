...
- [**DirectoryListing**](/style-guide/components/directory-listing/) carries the body of the page: it displays the child pages of a folder as a list of links, generated automatically so the listing stays current as pages are added or removed.
