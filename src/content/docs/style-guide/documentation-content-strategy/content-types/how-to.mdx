...
- [**Tabs and code groups**](/style-guide/components/tabs/) carry variant axes such as language, platform, or CLI versus dashboard inside one canonical page. For alternative methods, pick the recommended one and link the rest, and never duplicate the page.
