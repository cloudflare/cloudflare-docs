...
- [**Related links**](/style-guide/style-and-grammar/formatting/structure/links/) point to the reference architecture and product documentation the design draws on.
