...
- [**Introduction**](/style-guide/documentation-content-strategy/component-attributes/introduction/) opens with two to three paragraphs describing the subject matter and the end state of the solution the guide details.
- [**Intended audience**](/style-guide/documentation-content-strategy/component-attributes/intended-audience/) summarizes who the guide is for and what they will learn.
- [**Diagrams**](/style-guide/documentation-content-strategy/component-attributes/diagrams/) show the architecture, which is central to a design guide.
...
- [**Related links**](/style-guide/documentation-content-strategy/component-attributes/links/) point to the reference architecture and product documentation the design draws on.
