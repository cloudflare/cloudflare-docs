...
When creating a changelog, you need a Markdown page file and a corresponding YAML file in the [`src/content/changelogs` folder](https://github.com/cloudflare/cloudflare-docs/tree/production/src/content/changelogs).
...
```mdx title="src/content/queues/platform/changelog.mdx"
---
