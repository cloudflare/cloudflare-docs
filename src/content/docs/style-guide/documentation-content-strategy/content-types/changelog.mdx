...
entries:
  ...
  - publish_date: "2023-03-15"
    ...
    description: |-
      ...
      **To opt-out, or to configure a fixed maximum concurrency**, set `max_concurrency = 1` in your [Wrangler configuration](/workers/wrangler/configuration) file or via [the queues dashboard](https://dash.cloudflare.com/?to=/:account/queues).
