...
- **An overview.** An overview routes the reader onward; a concept explains. Keep one concept per page.
...
- [**Comparison tables**](/style-guide/formatting/structure/tables/) fit where there is a genuine either/or, alongside the boundaries the concept is confused with.
- **What does not fit:** Steps, because a concept has no procedural steps or walkthroughs; Tabs, because a concept does not vary by platform, and if it does it is two concepts; and Cards.
