...
- [**Tables**](/style-guide/formatting/structure/tables/) are the signature: a reference table with a 1:1 correspondence between each setting the reader can change and the value to enter or select for a given use case.
