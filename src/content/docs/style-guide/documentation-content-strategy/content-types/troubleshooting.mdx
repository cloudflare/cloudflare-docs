...
- [**Details**](/style-guide/build-the-page/components/details/) accordions fit the inline form at a feature page's end, but on a dedicated page the entries stay open, because a hidden symptom is unfindable.
