...
[Bullets vs. Numbered Lists](/style-guide/style-and-grammar/formatting/structure/lists/)
...
If the user has to turn a setting on or off, use "turn &lt;FEATURE_NAME> on/off" — or "turn on/off &lt;FEATURE_NAME>" for features with long names — instead of "enable/disable".
