...
For the full set of required cross-linking patterns by content type, refer to [Cross-linking requirements](/style-guide/formatting/structure/links/#cross-linking-requirements).
