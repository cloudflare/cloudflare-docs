...
The Last Updated date will be refreshed for any change to a page's content, while the [Reviewed](/style-guide/build-the-page/frontmatter/custom-properties/#reviewed) property indicates when the page was last explicitly reviewed from beginning to end.
