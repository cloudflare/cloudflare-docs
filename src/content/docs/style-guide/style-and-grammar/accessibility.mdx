...
When using technical terms that may be unfamiliar to your audience, provide clear definitions, use the [`GlossaryDefinition` component](/style-guide/build-the-page/components/glossary-definition/), or link to the relevant glossary.
