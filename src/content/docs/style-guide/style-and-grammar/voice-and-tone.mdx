...
For comprehensive accessibility guidelines aligned with WCAG 2.1 standards, refer to the [Accessibility guidelines](/style-guide/style-and-grammar/accessibility/) page.
...
For detailed guidance and examples, refer to [Writing a description](/style-guide/build-the-page/frontmatter/#writing-a-description).
