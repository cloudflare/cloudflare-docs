...
If set to `true`, a [`Run Worker in Playground`](/style-guide/style-and-grammar/formatting/code-block-guidelines/#workers-playground) button will appear on the JavaScript tab.
