...
- `showLastUpdated` <Type text="boolean" /> <MetaInfo text="optional (default false)" />
  ...
  If set to `true`, will add the last updated date, which is added in the [`updated` frontmatter value](/style-guide/build-the-page/frontmatter/custom-properties/#properties).
