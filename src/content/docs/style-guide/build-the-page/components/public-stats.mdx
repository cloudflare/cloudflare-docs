...
<Render file="public-stats-definition" product="style-guide" />
...
- [Reference Architecture Diagrams](/style-guide/documentation-content-strategy/content-types/reference-architecture/#reference-architecture-diagrams)
