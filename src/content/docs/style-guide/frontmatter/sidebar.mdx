...
<Steps>1. `sidebar.label` 2. `title`</Steps>
...
<Steps>1. `sidebar.group.label` 2. `title`</Steps>
...
<FileTree>- GroupTitle - IndexTitle - PageTitle</FileTree>

If we remove the `sidebar` property from both, it will now look like this:

<FileTree>- Bar - Overview - Baz</FileTree>
...
<FileTree>- Beta - ... - Alpha - ...</FileTree>

If we remove the `sidebar` property from both, it will now look like this:

<FileTree>- Alpha - ... - Beta - ...</FileTree>
