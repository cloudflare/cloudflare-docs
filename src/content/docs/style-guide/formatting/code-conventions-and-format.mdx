...
[Learn about code block formatting guidelines](/style-guide/formatting/code-block-guidelines/) and [code block syntax](/style-guide/formatting/code-conventions-and-format/).
