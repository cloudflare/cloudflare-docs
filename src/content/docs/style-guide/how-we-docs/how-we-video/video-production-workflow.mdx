...
#### Diagrams
Diagrams are used to clarify complex concepts or show relationships that are difficult to convey through text alone. Diagrams are referenced in the script and visually timed to appear alongside the corresponding narration. To learn more about how we diagram, refer to [Diagrams](/style-guide/how-we-docs/how-we-video/diagrams/). 
