...
- Append `/index.md` to the URL — for example, [`/workers/get-started/guide/index.md`](/workers/get-started/guide/index.md)
- Send a request with an `Accept: text/markdown` header:

  ```bash
  curl "https://developers.cloudflare.com/workers/get-started/guide/" \
