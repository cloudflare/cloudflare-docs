...
Allowing AI crawlers to crawl your documentation enables end users to extract useful information from their preferred AI tool. For example, it enables users to ask tools such as ChatGPT questions about your documentation, rather than being forced to read entire pages. However, it is important to control how the AI crawlers interact with your site for optimal results.
...
To ensure complete blocking, you can use security controls such as Cloudflare' [AI Crawl Control](/ai-crawl-control/) or [bot solutions](/bots/) or some other security tool.
...
To further reduce crawlers from accessing incomplete information, we promptly implemented a security rule to completely block all access to our preview sites, which simply reduced the number of crawls on our preview sites from 20% to 0% (the security rule completely blocked access to our preview sites).
...
This case study highlights the importance of understanding and controlling how AI crawlers interact with our documentation sites.
</Example>
...
- If you wish to completely block access to certain pages from AI crawlers, use security controls such as Cloudflare' [AI Crawl Control](/ai-crawl-control/) or [bot solutions](/bots/) or some other security tool to completely block access to certain pages.
