...
After the discovery, we promptly implemented a security rule to block all access to our preview sites, which dramatically reduced the number of crawls on our preview sites from 80% to 1.05%.
