...
<table>
	...
	<tr>
		...
		<td>
			A <b>CAPTCHA</b> is a puzzle used to challenge users and ensure they are
			not bots.
		</td>
	</tr>
	<tr>
		...
		<td>Cloud, "cloud"</td>
		<td>
			The <b>cloud</b> is a network of remote servers used to store and maintain
			data.{" "}
		</td>
	</tr>
	<tr>
		...
		<td>ddos, DDOS</td>
		<td>
			A <b>DDoS</b> attack is a malicious attempt to disrupt normal traffic of a
			targeted server.
		</td>
	</tr>
	<tr>
		...
		<td>
			denial of service, Denial-of-Service, Denial-Of-Service, Denial of
			Service, dos, Dos, DOS
		</td>
		<td>
			DDoS is a type of <b>DoS</b> attack.
		</td>
	</tr>
	<tr>
		...
		<td>ent, ENT</td>
		<td>
			Capitalized - Refers to the official Cloudflare <b>Enterprise</b> Plan or
			a customer on the <b>Enterprise</b> plan. Sentence-case - All Enterprise
			customers are enterprise companies, but not all enterprises are Enterprise
			customers.{" "}
		</td>
	</tr>
	<tr>
		...
		<td>internet</td>
		<td>
			Disabling this option may cause all devices to lose <b>Internet</b>{" "}
			connectivity.
		</td>
	</tr>
	<tr>
		...
		<td>ssl</td>
		<td>
			<b>SSL</b> is an encryption-based Internet security protocol.
		</td>
	</tr>
	<tr>
		<td>TLS</td>
		<td>tls</td>
		<td>
			<b>TLS</b> is a security protocol designed to facilitate privacy and data
	...
	<tr>
		...
		<td>waf</td>
		<td>
			<b>WAF</b> is a security system that helps protect web applications by
	...
	<tr>
		...
		<td>zero trust</td>
		<td>
			<b>Cloudflare</b> Access is a Zero Trust solution that secures inbound
			connections to your protected applications.
		</td>
	</tr>
</table>
