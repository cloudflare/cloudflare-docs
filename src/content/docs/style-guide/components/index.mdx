...
| [`ResourcesBySelector`](/style-guide/components/resources-by-selector/) | <p>Filterable code example library. Pull and display lists of code examples and resources based on content type and products.</p> <Example> ![ResourcesBySelector component example](~/assets/images/style-guide/ui-elements/resourcesbyselector-example.png) </Example>                                                                                   |
