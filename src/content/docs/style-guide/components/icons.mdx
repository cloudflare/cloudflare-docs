...
Content authored before the Nimbus migration may still use Starlight-style icon names (for example `icon="seti:shell"`). The build automatically maps these to an equivalent iconify icon. New content should use iconify names directly.
