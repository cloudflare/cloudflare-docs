...
<FAQList>
	...
	<FAQItem question="How do I give Command Code access to my Cloudflare account?">
		Run `cmd mcp add --transport http cloudflare
		https://mcp.cloudflare.com/mcp`. When Command Code prompts you, complete the
		OAuth flow in your browser and choose the permissions to grant.
	</FAQItem>
