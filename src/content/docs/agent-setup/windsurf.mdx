...
<Steps>
	...
	3. **Configure Cloudflare MCP servers**
		...
		Add the Cloudflare API and docs servers to `~/.codeium/windsurf/mcp_config.json`. See all available Cloudflare MCP servers on [GitHub](https://github.com/cloudflare/mcp-server-cloudflare).
