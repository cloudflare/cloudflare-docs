...
6. **Start the server**
	...
	![Visual Studio Code showing the Start CodeLens on the Cloudflare MCP server definition in mcp.json](~/assets/images/agent-setup/visual-studio-code/vscode-start-cloudflare-mcp.png)
