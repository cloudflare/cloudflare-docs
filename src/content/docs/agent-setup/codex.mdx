...
description: "OpenAI coding agent available as a terminal CLI and standalone app. It reads and writes files, runs commands, and browses the web in a sandbox."
template: splash
	...
	<TabItem label="Standalone">
		<Steps>
			...
			2. **Install the Cloudflare plugin**
				...
				![Install the Cloudflare plugin in the Codex standalone app.](~/assets/images/agent-setup/codex-standalone.png)
		</Steps>
	</TabItem>
</Tabs>
