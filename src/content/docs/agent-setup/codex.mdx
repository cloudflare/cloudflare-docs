...
<Steps>
	...
	3. **Add Cloudflare MCP servers**
		...
		See all available Cloudflare MCP servers on [GitHub](https://github.com/cloudflare/mcp-server-cloudflare).
...
<FAQList>
	...
	<FAQItem question="How do I connect Codex to my Cloudflare account?">
		The first time Codex calls a Cloudflare tool, you'll be redirected to
