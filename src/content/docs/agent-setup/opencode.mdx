...
<Steps>
	...
	3. **Add Cloudflare MCP servers**
		...
		Add MCP servers to `.opencode.jsonc`. See all available Cloudflare MCP servers on [GitHub](https://github.com/cloudflare/mcp-server-cloudflare).
...
<FAQList>
	...
	<FAQItem question="How do I connect OpenCode to Cloudflare?">
		The first time OpenCode calls a Cloudflare tool, you'll be redirected to
