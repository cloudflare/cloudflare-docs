...
IPv6 compatibility needs to be enabled to allow IPv6-only clients to connect. Pseudo IPv4 will allow IPv6-only clients to connect to IPv4-only origins when IPv6 with compatibility enabled.
:::
