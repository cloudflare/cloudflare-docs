...
:::note
To allow IPv6-only clients to connect to IPv4-only origin web servers, keep [IPv6 compatibility](/network/ipv6-compatibility/) enabled and configure Pseudo IPv4.
:::
