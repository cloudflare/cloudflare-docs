...
Cloudflare Security (beta) is your starting point to better understand the security posture of your web applications, and to configure rules to protect them.

The new Cloudflare Security navigation in the Cloudflare dashboard is currently available in beta for users that decide to opt in into the new user interface.
...
The following products are available separately in the previous navigation structure in the Cloudflare dashboard. The documentation for these products contains additional information about individual security features not covered in the Cloudflare Security documentation.
