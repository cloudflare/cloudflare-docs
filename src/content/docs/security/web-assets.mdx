...
:::note
The **Client-side resources** tab includes functionality available in [Client-Side Security](/page-shield/) (formerly known as Page Shield) in the previous dashboard navigation structure.
:::
