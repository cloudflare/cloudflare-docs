...
Use **Client-side resources** to [monitor scripts, connections, and cookies](/client-side-security/detection/monitor-connections-scripts/) on your domain.
...
Customers with Client-Side Security Advanced will have their connections and scripts [classified as potentially malicious](/client-side-security/how-it-works/malicious-script-detection/) based on threat feeds.

:::note
The **Client-side resources** tab includes functionality available in [client-side security](/client-side-security/) (formerly known as Page Shield) in the previous dashboard navigation structure.
:::
