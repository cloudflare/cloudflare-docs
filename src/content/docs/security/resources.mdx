...
sidebar:
  order: 4
description: Use web asset discovery to discover your web assets and instruct Cloudflare how to best protect them.
---

Use web asset discovery to discover your web assets and instruct Cloudflare how to best protect them.
...
This will add the specified endpoints to your list of managed endpoints. You can view your list of managed endpoints in the Endpoints page.
...
Use **Discovery** to generate a map of your active APIs via path normalization.

[Add endpoints](/api-shield/management-and-monitoring/#add-endpoints-from-api-discovery) to produce recommendations and analytics of your APIs. Your [session identifiers](/api-shield/management-and-monitoring/session-identifiers/) must match your API traffic.
