...
The **Traffic** tab displays information about all incoming HTTP requests for your domain / zone, including requests not handled by Cloudflare security products.
