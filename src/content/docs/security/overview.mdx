...
Refer to our [Threat intelligence API documentation](/api/resources/security_center) to review the action item audit logs by account, domain, or a specific `issue_id`.
