...
:::note
The client-side abuse security category includes features and settings from [Page Shield](/page-shield/) and [Scrape Shield](/waf/tools/scrape-shield/) in the previous dashboard navigation structure.
:::
