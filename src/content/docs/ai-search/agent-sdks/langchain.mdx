...
Because this step calls [Workers AI](/workers-ai/) to generate the answer, the token you pass here also needs the **Workers AI** permission. Add it to the token you already created, or pass a separate token.
