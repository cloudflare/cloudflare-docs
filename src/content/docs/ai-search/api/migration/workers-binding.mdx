...
For more details on the difference, refer to [Namespaces](/ai-search/concepts/namespaces/). For the full API reference, refer to the [Search](/ai-search/api/search/workers-binding/), [Instances](/ai-search/api/instances/workers-binding/), and [Items](/ai-search/api/items/workers-binding/) Workers binding pages.
