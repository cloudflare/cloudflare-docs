...
This page documents the filter format used by the legacy AutoRAG REST API. For the new AI Search REST API filter syntax, refer to [Metadata filtering](/ai-search/configuration/retrieval/filtering/).
...
- [Metadata filtering](/ai-search/configuration/retrieval/filtering/) - New AI Search REST API filter format
- [Migrate from AutoRAG Search API](/ai-search/api/migration/rest-api/) - Migration guide with before/after examples
