...
This page documents the filter format used by the legacy AutoRAG REST API. For the new AI Search REST API filter syntax, refer to [Metadata filtering](/ai-search/configuration/retrieval/metadata/).
...
- [Metadata filtering](/ai-search/configuration/retrieval/metadata/) - New AI Search REST API filter format
