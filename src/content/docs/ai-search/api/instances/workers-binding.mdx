...
Use the AI Search [namespace binding](/ai-search/concepts/namespaces/) to manage instances from a [Cloudflare Worker](/workers/). For binding setup, refer to [Configure the binding](/ai-search/api/#configure-the-binding).

## Namespace methods

The namespace binding (`env.AI_SEARCH`) exposes methods for managing instances within the namespace.
