...
Search and chat APIs are scoped to a [namespace](/ai-search/concepts/namespaces/):
...
Search a specific instance. The search endpoint also accepts a `query` string parameter. For the full specification, refer to the [Search API reference](/api/resources/ai_search/subresources/namespaces/subresources/instances/methods/search/).
...
Generate a response from a specific instance. For the full specification, refer to the [Chat completions API reference](/api/resources/ai_search/subresources/namespaces/subresources/instances/methods/chat_completions/).
