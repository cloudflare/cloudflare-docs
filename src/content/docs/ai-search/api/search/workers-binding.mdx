...
Use the AI Search [namespace binding](/ai-search/concepts/namespaces/) to query your AI Search instances from a [Cloudflare Worker](/workers/). For binding setup, refer to [Configure the binding](/ai-search/api/#configure-the-binding).
