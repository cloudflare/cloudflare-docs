...
For all parameters and options, refer to the [AutoRAG ai-search API reference](/api/resources/autorag/subresources/rags/methods/ai_search/).
...
For all parameters and options, refer to the [AutoRAG search API reference](/api/resources/autorag/subresources/rags/methods/search/).
...
The new AI Search REST API uses Vectorize-style metadata filtering, which differs from the AutoRAG API format. For full documentation of the old format, refer to [AutoRAG API filter format](/ai-search/autorag-filter-format/).
