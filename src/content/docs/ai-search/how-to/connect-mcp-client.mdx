...
To require authentication, add a [custom domain](/ai-search/configuration/retrieval/public-endpoint/custom-domains/) and protect it with [Cloudflare Access](/ai-search/configuration/retrieval/public-endpoint/cloudflare-access/). MCP clients then authenticate with an Access [service token](/cloudflare-one/access-controls/service-credentials/service-tokens/) sent as request headers.
