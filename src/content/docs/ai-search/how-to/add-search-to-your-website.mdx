...
<PackageManagers type="exec" pkg="wrangler" args="ai-search create my-search --type web-crawler --source <YOUR_DOMAIN>" />
...
<PackageManagers type="exec" pkg="wrangler" args="ai-search search my-search --query 'What is this site about?'" />
