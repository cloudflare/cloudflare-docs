...
AI Search lets you add search to any application or agent without building retrieval infrastructure. Create an instance, give it your data, and search it with natural language.
...
<Feature header="Metadata filtering" href="/ai-search/configuration/retrieval/metadata/" cta="Add filters">
