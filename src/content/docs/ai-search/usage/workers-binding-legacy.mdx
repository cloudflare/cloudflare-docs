...
The `env.AI.autorag()` binding is deprecated but will continue to work indefinitely. New projects should use [`env.AI.aiSearch()`](/ai-search/usage/workers-binding/) instead.
