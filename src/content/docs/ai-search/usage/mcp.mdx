...
You can customize the tool description in your AI Search instance settings. For more details, refer to [Public endpoint configuration](/ai-search/configuration/public-endpoint/).
