...
| Tool     | Description                                                      |
| -------- | ---------------------------------------------------------------- |
| `search` | Search content to find relevant information and answer questions |

You can customize the tool description in your AI Search instance settings. For more details, see [Public endpoint configuration](/ai-search/configuration/public-endpoint/).
