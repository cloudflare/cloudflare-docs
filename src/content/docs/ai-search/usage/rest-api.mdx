...
:::note
The previous [AutoRAG API endpoints](/api/resources/autorag/) are no longer recommended for use. See [Migrate from AutoRAG Search API](/ai-search/how-to/migrate-from-autorag-api/) for details.
:::
