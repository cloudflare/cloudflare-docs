...
2. Select your profile icon and go to **My Profile** > **API Tokens**.
3. Select **Create Token**.
4. Select **Create Custom Token**.
5. Enter a name for your token.
6. Under **Permissions**, select **AI Search** and **Run**.
7. Under **Account Resources**, select the account you want to use.
8. Select **Continue to summary**, then select **Create Token**.
9. Copy and save your API token for future use.
