...
You can boost by the built-in `timestamp` field or by any field defined in your [custom metadata schema](/ai-search/configuration/retrieval/metadata/#define-a-schema).
