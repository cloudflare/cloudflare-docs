...
| [Custom metadata schema](/ai-search/configuration/metadata/#define-a-schema)   | no                      | Define custom metadata fields for filtering (max 5 fields)                                                     |
...
| [Boosting](/ai-search/configuration/boosting/)                                 | yes                     | Bias search results toward documents with specific metadata characteristics (for example, recency or priority) |
...
| [Hybrid search](/ai-search/configuration/hybrid-search/)                       | yes                     | Combine vector and keyword (BM25) search to improve retrieval quality                                          |
...
| [Public endpoint](/ai-search/configuration/public-endpoint/)                   | yes                     | Enable public access to search, chat, and MCP endpoints                                                        |
| [UI snippets](/ai-search/configuration/embed-search-snippets/)                 | yes                     | Embed pre-built search and chat components in your website                                                     |
