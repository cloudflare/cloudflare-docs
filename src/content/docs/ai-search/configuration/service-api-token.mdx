...
## Option 1: Create via the dashboard

The simplest way to get a service API token is to create an AI Search instance through the [dashboard](/ai-search/get-started/dashboard/) at least once. Cloudflare creates and registers a service token for you automatically during the setup flow.
