...
| -------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| [Built-in storage](/ai-search/configuration/data-source/built-in-storage/) | Upload files directly to an instance. Available by default on every instance. |
...
For website data sources, [Parse types](/ai-search/configuration/data-source/website/parse-types/) covers how AI Search finds the pages to index.
