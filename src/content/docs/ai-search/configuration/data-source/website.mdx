...
The following fields are automatically extracted without defining them in your schema:
...
Standard meta tags take precedence over Open Graph tags when both are present.
