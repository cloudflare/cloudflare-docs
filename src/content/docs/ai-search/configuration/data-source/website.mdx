...
3. [Add your self-hosted application to Access](/access-controls/applications/http-apps/self-hosted-public-app/#1-add-your-application-to-access) and with the following configuration:
    - In Access policies, click **Select existing policies**
    - Select the policy that you have just created and select **Confirm**
4. In the [Cloudflare dashboard](https://dash.cloudflare.com/), go to **AI Search** and select **Create**.
5. Select **Website** as your data source.
6. Under **Parse options**, locate **Extra headers** and add the following two headers using your saved credentials:
   - Header 1:
...
7. Complete the AI Search setup process to create your search instance.
