...
Before custom metadata can be extracted, you must [define a schema](/ai-search/configuration/retrieval/metadata/#define-a-schema) in your AI Search configuration.
