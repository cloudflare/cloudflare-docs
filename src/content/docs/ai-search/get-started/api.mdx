...
Use the [Create instance API](/api/resources/ai_search/subresources/namespaces/subresources/instances/methods/create/) to create an instance. Replace `<ACCOUNT_ID>` with your [account ID](/fundamentals/account/find-account-and-zone-ids/).
