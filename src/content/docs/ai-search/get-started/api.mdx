...
If you did not connect a data source, upload files using the [Items API](/api/resources/ai_search/subresources/items/methods/upload/). Skip this step if you connected a website or R2 bucket.
