...
2. Select **Create**.
3. Optionally connect a [data source](/ai-search/configuration/data-source/) such as a website you own or an R2 bucket. You can skip this step and upload files later.
4. Name your AI Search instance and configure [chunking](/ai-search/configuration/chunking/), [embedding](/ai-search/configuration/models/), and [retrieval settings](/ai-search/configuration/retrieval-configuration/).
5. Select **Create**.
...
If you did not connect a data source, you can upload files directly from the dashboard.
