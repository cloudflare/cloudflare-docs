...
- Clone private repositories by adding a GitHub token in the `Outbound` entrypoint. Refer to [Call an authenticated API from a sandbox](/sandbox/network/call-an-authenticated-api/).
