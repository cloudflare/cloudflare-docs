...
The Sandbox SDK is built on [Cloudflare Containers](/containers/). Your configuration requires three sections:
...
3. **migrations** - Initialize the [Durable Object class](/durable-objects/get-started/#2-write-a-durable-object-class-using-sql-api)
