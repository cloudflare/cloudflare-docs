...
You do not need to configure a Durable Object binding explicitly. Access the Sandbox class via `ctx.exports.Sandbox` using [automatic loopback bindings](/changelog/2025-09-26-ctx-exports/).
...
**Solution**: Ensure your Worker exports the Sandbox class from `@cloudflare/sandbox`:
