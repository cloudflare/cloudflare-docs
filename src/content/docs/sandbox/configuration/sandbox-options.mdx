...
const sandbox2 = getSandbox(ctx.exports.Sandbox, 'user-456', {
...
const sandbox = getSandbox(ctx.exports.Sandbox, 'data-processor', {
  containerTimeouts: {
...
const sandbox2 = getSandbox(ctx.exports.Sandbox, 'user-env', {
containerTimeouts: {
...
// Wait longer during traffic spikes
const sandbox3 = getSandbox(ctx.exports.Sandbox, 'user-env', {
containerTimeouts: {
instanceGetTimeoutMS: 60_000 // 1 minute for provisioning
}
});
...
const sandbox1 = getSandbox(ctx.exports.Sandbox, 'MyProject-123');
...
// With normalization
const sandbox2 = getSandbox(ctx.exports.Sandbox, 'MyProject-123', {
normalizeId: true
});
// Creates Durable Object with ID: "myproject-123"
// Preview URL: 8000-myproject-123.example.com
