...
In the **1.0 preview** (`@next`), `enableDefaultSession` is removed and top-level execution is sessionless. Transport selection options are also gone. Refer to [Migrate to the 1.0 preview](/sandbox/1-0-preview/migrate/).
:::
