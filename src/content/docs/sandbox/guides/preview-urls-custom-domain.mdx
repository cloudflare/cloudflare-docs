...
Set up wildcard DNS, routes, and TLS so `exposePort()` preview URLs work on your domain.

This does not deploy your sandbox image. To deploy the Worker and image, refer to [Deploy a Sandbox application](/sandbox/guides/deploy/).
