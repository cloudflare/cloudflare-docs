...
This guide configures **preview URLs** for `exposePort()` on a custom domain. It does **not** deploy or roll out your sandbox container image. For Worker and image deploys, see [Deploy a Sandbox application](/sandbox/guides/deploy/).
...
- [Deploy a Sandbox application](/sandbox/guides/deploy/) — Worker and image deploy and rollouts
