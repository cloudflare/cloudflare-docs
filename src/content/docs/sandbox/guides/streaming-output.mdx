...
In `@cloudflare/sandbox@next`, streaming command output moves to the consolidated `exec()` process API. For more information, refer to [Migrate to Sandbox SDK 1.0](/sandbox/guides/migrating-to-1-0/).
:::
