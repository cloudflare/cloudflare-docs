...
This page documents `sandbox.gitCheckout()` on today's stable `@cloudflare/sandbox` package. Preview docs for a Git extension are not published yet; keep using this stable surface for Git workflows until they are.
:::
