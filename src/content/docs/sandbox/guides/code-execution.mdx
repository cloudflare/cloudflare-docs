...
In the **1.0 preview** (`@next`), the interpreter is an opt-in extension. Refer to [Code interpreter](/sandbox/1-0-preview/interpreter/) and the [Interpreter API](/sandbox/1-0-preview/api/interpreter/).
:::
