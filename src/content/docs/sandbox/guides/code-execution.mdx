...
In `@cloudflare/sandbox@next`, Code Interpreter moves from the core SDK into a plugin. For more information, refer to [Migrate to Sandbox SDK 1.0](/sandbox/guides/migrating-to-1-0/).
:::
