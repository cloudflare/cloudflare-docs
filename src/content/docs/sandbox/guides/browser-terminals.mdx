...
If you adopt the [1.0 preview](/sandbox/1-0-preview/), confirm terminal connect helpers against your installed `@next` package. Process handles are not a substitute for a PTY.
:::
