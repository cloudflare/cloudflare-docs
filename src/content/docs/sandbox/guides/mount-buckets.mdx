...
:::note
You can use an environment variable to toggle `localBucket` between local development and production. Set `LOCAL_DEV` in your Wrangler configuration using `vars` for local development, then reference it in your code:
