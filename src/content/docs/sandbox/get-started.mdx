...
- `ctx.exports.Sandbox` - The [automatic loopback binding](/changelog/2025-09-26-ctx-exports/) for the Sandbox Durable Object. No explicit binding configuration required.
...
- **compatibility_flags** - The `enable_ctx_exports` flag enables [automatic loopback bindings](/changelog/2025-09-26-ctx-exports/), so you do not need to configure a Durable Object binding explicitly. Access the Sandbox class via `ctx.exports.Sandbox`.
