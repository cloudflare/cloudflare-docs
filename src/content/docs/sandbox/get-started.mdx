...
Worker code can become active before every sandbox instance runs the new image. For rollouts, package/image pairing, and Workers Builds, see [Deploy a Sandbox application](/sandbox/guides/deploy/) and [Containers deployments](/containers/deployments/).
