...
Coding agents: install [Cloudflare Skills](https://github.com/cloudflare/skills) ([Agent setup](/agent-setup/)). Use **`sandbox-stable`** with this guide; use **`sandbox-sdk`** for `@next`; use **`sandbox-migrate-to-next`** when porting.
:::
