...
Worker code can become active before every sandbox instance runs the new image. For package/image pairing and day-to-day deploys, see [Deploy a Sandbox application](/sandbox/guides/deploy/). For the platform deploy model, see [Deploy Containers](/containers/deploy/).
