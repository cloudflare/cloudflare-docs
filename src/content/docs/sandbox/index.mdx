...
<Feature header="Deploy Worker and sandbox image" href="/sandbox/guides/deploy/" cta="Deploy a Sandbox app">

Ship package and container image changes together, choose gradual or immediate rollouts, and avoid preview CI skew with Workers Builds.
...
<LinkTitleCard title="Deploy" href="/sandbox/guides/deploy/" icon="document">
	Worker and container image deploys, rollouts, and Workers Builds.
</LinkTitleCard>
