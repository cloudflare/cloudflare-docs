...
Keep the Worker package and sandbox image on the same release line, choose gradual or immediate rollouts, and avoid preview CI skew.
...
<LinkTitleCard
	...
	icon="document"
>
	Package and image pairing, rollouts, and CI defaults.
</LinkTitleCard>
