...
<Tabs>
  <TabItem label="Execute Commands">
	...
	<TabItem label="Terminal Access">
		...
		Connect browser terminals directly to sandbox shells via WebSocket. Learn more: [Build Terminal UIs](/sandbox/guides/build-terminal-ui/).
	</TabItem>
...
<Feature header="Build interactive terminals" href="/sandbox/guides/build-terminal-ui/" cta="Learn about terminal UIs">
