...
This page documents terminal connections on today's stable `@cloudflare/sandbox` package.

In the **1.0 preview** (`@next`), terminals remain the interactive PTY path and stay separate from argv process handles. Refer to [processes versus terminals](/sandbox/1-0-preview/processes/#processes-versus-terminals).
:::
