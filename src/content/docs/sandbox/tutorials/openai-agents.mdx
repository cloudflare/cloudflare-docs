...
This tutorial deploys the **stable** bridge template (`main`) and stable-era HTTP routes.

For the **1.0 preview** bridge (`next` template, process/terminal HTTP resources), see [Bridge](/sandbox/1-0-preview/bridge/).
:::
