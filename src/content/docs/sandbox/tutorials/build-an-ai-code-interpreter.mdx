...
When you finish, the Worker answers a question about prime numbers with the answer and the code the model ran:
...
1. Start a local development server:
   ...
   During `wrangler dev`, the Dynamic Worker runs locally. Workers AI requests always run on Cloudflare and count toward your [Workers AI usage](/workers-ai/platform/pricing/).
