...
This page documents sandbox lifecycle on `@cloudflare/sandbox@next`, the preview of Sandbox SDK 1.0. For the current stable package, also refer to [Sandbox lifecycle](/sandbox/concepts/sandboxes/). Platform placement and shutdown details live in [Lifecycle of a Container](/containers/concepts/architecture/).
:::
