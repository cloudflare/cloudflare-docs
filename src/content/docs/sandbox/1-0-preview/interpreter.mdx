...
Use the same preview Worker package and container image line. Refer to [Dockerfile](/sandbox/configuration/dockerfile/).
...
For result fields, streaming (`runCodeStream`), and list/delete context methods, refer to the [Interpreter API](/sandbox/1-0-preview/api/interpreter/).

Contexts exist only in the **current container**. After stop or replace, create new ones. Refer to [Sandbox lifecycle](/sandbox/1-0-preview/lifecycle/).
