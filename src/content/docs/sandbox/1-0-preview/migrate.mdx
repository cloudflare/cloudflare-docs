...
For routine deploys after migration, refer to [Deploy a Sandbox application](/sandbox/guides/deploy/). For rollout options, refer to [Rollouts](/containers/platform-details/rollouts/).
