...
For day-to-day Sandbox deploys, refer to [Deploy a Sandbox application](/sandbox/guides/deploy/). For rollouts, refer to [Rollouts](/containers/platform-details/rollouts/).
