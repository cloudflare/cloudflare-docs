...
Background on container rollouts: [Rollouts](/containers/platform-details/rollouts/). For day-to-day Sandbox deploys (not only this migration), see [Deploy a Sandbox application](/sandbox/guides/deploy/) and [Container deployments](/containers/deployments/).
