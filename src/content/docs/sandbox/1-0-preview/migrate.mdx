...
Install [Cloudflare Skills](https://github.com/cloudflare/skills) for your agent ([Agent setup](/agent-setup/)). The **`sandbox-v1-migration`** skill performs this migration. For new apps on `@next`, use **`sandbox-sdk`**. For stable-only deprecated-API cleanup, use **`sandbox-2026-deprecation`** before or instead of this guide.
