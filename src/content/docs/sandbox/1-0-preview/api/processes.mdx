...
Process handles have **no standard input**. Use `cwd`, `env`, and argv (or an explicit shell script) for non-interactive work. Use a [terminal](/sandbox/1-0-preview/terminals/) when you need an interactive PTY.
