...
This page documents terminals on `@cloudflare/sandbox@next`, the preview of Sandbox SDK 1.0. For the current stable terminal helpers, refer to [Terminal connections](/sandbox/concepts/terminal/) and [Terminal API](/sandbox/api/terminal/).
:::
...
Both kinds of resource live only in the current container for a sandbox ID. Lookup methods do not start a container. Refer to [Sandbox lifecycle](/sandbox/1-0-preview/lifecycle/) and [How long a process lives](/sandbox/1-0-preview/processes/#how-long-a-process-lives).
