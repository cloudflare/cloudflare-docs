...
Both kinds of resource live only in the current container for a sandbox ID. Lookup methods do not start a container. See [How long a process lives](/sandbox/1-0-preview/processes/#how-long-a-process-lives).
