...
- **RPC transport.** Calling `sandbox.tunnels` on HTTP/Websocket transports will throw `"RPC transport required"`. Refer to [Transport configuration](/sandbox/configuration/transport/).
