...
- `options` - Backup configuration (see [`BackupOptions`](#backupoptions)):
  ...
  - `ttl` (optional) - Time-to-live in seconds until the backup expires. Default: `86400` (24 hours). Must be a positive number.
...
- `ttl` (optional) - Time-to-live in seconds. Default: `86400` (24 hours). Must be a positive number.
