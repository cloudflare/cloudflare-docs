...
- `port` - Port number to expose (1024-65535, excluding 3000 which is reserved for the sandbox control plane)
- `options`:
...
- `port` - Port number (1024-65535, excluding 3000 which is reserved for the sandbox control plane)
