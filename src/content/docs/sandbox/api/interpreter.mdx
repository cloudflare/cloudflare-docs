...
In the **1.0 preview** (`@next`), attach `withInterpreter` from `@cloudflare/sandbox/interpreter`. Refer to [Code interpreter](/sandbox/1-0-preview/interpreter/) and the [Interpreter API](/sandbox/1-0-preview/api/interpreter/).
:::
