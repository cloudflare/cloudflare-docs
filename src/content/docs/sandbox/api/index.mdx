...
<LinkTitleCard
	...
	icon="view"
>
	Monitor filesystem changes in real-time using Linux inotify. Get notified of file creation, modification, deletion, and moves.
</LinkTitleCard>
...
<LinkTitleCard
	title="File Watching"
	href="/sandbox/api/watching/"
	icon="view"
>
	Monitor filesystem changes in real-time using inotify. Watch for file creation, modification, deletion, and move operations with event-based notifications.
</LinkTitleCard>
