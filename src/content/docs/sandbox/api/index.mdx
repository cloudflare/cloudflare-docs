...
<LinkTitleCard
	title="Terminals"
	href="/sandbox/api/terminals/"
	icon="terminal"
>
	Integrate browser-based terminals with sandbox sessions using xterm.js and WebSocket connections for real-time terminal interfaces.
</LinkTitleCard>
