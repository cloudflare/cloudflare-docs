...
<LinkTitleCard
	...
	icon="eye"
>
	Monitor filesystem changes in real-time using native inotify. Watch directories, filter events, and respond to file modifications.
</LinkTitleCard>
...
<LinkTitleCard
	...
	icon="eye"
>
	Watch for real-time file system changes using native inotify. Monitor files and directories for creates, modifications, deletes, and renames.
</LinkTitleCard>
