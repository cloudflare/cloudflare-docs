...
**Sandbox SDK 1.0** (preview on `@next`) treats terminals as first-class resources separate from process handles. Confirm method names in your installed `@next` package and read [processes versus terminals](/sandbox/1-0-preview/processes/#processes-versus-terminals).
:::
