...
sidebar:
  order: 2
description: Upload CSV files, generate analysis code with Claude, and return visualizations with the Sandbox SDK 0.x.
reviewed: 2025-10-15
products:
  - sandbox
head:
  - tag: title
    content: "Analyze data with AI (Sandbox SDK 0.x)"
---
...
<PackageManagers
	...
	args={"analyze-data --template=cloudflare/sandbox-sdk/examples/minimal#v0"}
/>
...
- [Code Interpreter API](/sandbox/sdk/api/interpreter/) - Use the built-in code interpreter
- [File operations](/sandbox/sdk/guides/manage-files/) - Advanced file handling
- [Streaming output](/sandbox/sdk/guides/streaming-output/) - Real-time progress updates
