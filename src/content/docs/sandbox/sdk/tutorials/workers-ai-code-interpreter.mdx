...
sidebar:
  order: 3
description: Build a Sandbox SDK 0.x code interpreter using the Workers AI GPT-OSS model and the workers-ai-provider package.
reviewed: 2026-01-28
products:
  - sandbox
  - workers-ai
head:
  - tag: title
    content: "Code interpreter with Workers AI (Sandbox SDK 0.x)"
---

import { Render, PackageManagers, WranglerConfig } from "~/components";

<Render file="sdk-0x-note" product="sandbox" params={{ href: "/sandbox/get-started/build-an-ai-code-interpreter/", title: "Build an AI code interpreter" }} />
...
<PackageManagers
	...
	args={
		"workers-ai-interpreter --template=cloudflare/sandbox-sdk/examples/code-interpreter#v0"
	}
/>
...
- [Analyze data with AI](/sandbox/sdk/tutorials/analyze-data-with-ai/) - Add pandas and matplotlib for advanced data analysis
- [Code Interpreter API](/sandbox/sdk/api/interpreter/) - Use the built-in code interpreter with structured outputs
- [Streaming output](/sandbox/sdk/guides/streaming-output/) - Show real-time execution progress
- [API reference](/sandbox/sdk/api/) - Explore all available sandbox methods
