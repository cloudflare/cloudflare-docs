...
difficulty: Beginner
description: Run Claude Managed Agents on self-managed Cloudflare environments with the Sandbox SDK 0.x.
sidebar:
  order: 3
products:
  - sandbox
...
head:
  - tag: title
    content: "Set up Claude Managed Agents (Sandbox SDK 0.x)"
---
