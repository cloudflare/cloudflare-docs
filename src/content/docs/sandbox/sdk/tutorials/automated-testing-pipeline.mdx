...
sidebar:
  order: 5
description: Build a Sandbox SDK 0.x testing pipeline that clones Git repositories, installs dependencies, runs tests, and reports results.
reviewed: 2025-10-15
products:
  - sandbox
head:
  - tag: title
    content: "Automated testing pipeline (Sandbox SDK 0.x)"
---
...
<PackageManagers
	...
	args={"test-pipeline --template=cloudflare/sandbox-sdk/examples/minimal#v0"}
/>
...
- [Streaming output](/sandbox/sdk/guides/streaming-output/) - Add real-time test output
- [Background processes](/sandbox/sdk/guides/background-processes/) - Handle long-running tests
- [Sessions API](/sandbox/sdk/api/sessions/) - Cache dependencies between runs
