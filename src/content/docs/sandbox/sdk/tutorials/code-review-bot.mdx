...
sidebar:
  order: 3
description: Clone repositories, analyze code with Claude, and post review comments to GitHub pull requests with the Sandbox SDK 0.x.
reviewed: 2025-10-15
products:
  - sandbox
head:
  - tag: title
    content: "Build a code review bot (Sandbox SDK 0.x)"
---
...
<PackageManagers
	...
	args={"code-review-bot --template=cloudflare/sandbox-sdk/examples/minimal#v0"}
/>
...
- [Git operations](/sandbox/sdk/api/files/#gitcheckout) - Advanced repository handling
- [Sessions API](/sandbox/sdk/api/sessions/) - Manage long-running sandbox operations
