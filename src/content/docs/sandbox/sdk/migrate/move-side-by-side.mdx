...
- Your 1.0 class is written under a new name, such as `SandboxV1`. Choose a name you want to keep, because renaming a class later is another class migration. For the class, refer to [Move to your own Durable Object](/sandbox/sdk/migrate/your-own-durable-object/).
...
1. Install version 1 of the package, and keep 0.12 under the alias `sandbox-0x`:
   ...
   <PackageManagers pkg="@cloudflare/sandbox@1 sandbox-0x@npm:@cloudflare/sandbox@0.12.10" />
