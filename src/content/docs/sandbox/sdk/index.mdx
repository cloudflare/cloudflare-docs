...
<Tabs>
  <TabItem label="Execute Commands">
    ...
    <TabItem label="Terminal Access">
    	...
    	Connect browser terminals directly to sandbox shells via WebSocket. Learn more: [Browser terminals](/sandbox/sdk/guides/browser-terminals/).
    </TabItem>
    ...
    <TabItem label="WebSocket connections">
    	...
    	Connect to WebSocket servers running in sandboxes. Learn more: [WebSocket Connections](/sandbox/sdk/guides/websocket-connections/).
    </TabItem>

</Tabs>

<LinkButton variant="primary" href="/sandbox/sdk/get-started/">
	Get started
</LinkButton>
<LinkButton variant="secondary" href="/sandbox/sdk/api/">
	API Reference
</LinkButton>
...
<Feature header="Deploy a Sandbox application" href="/sandbox/sdk/guides/deploy/" cta="Deploy a Sandbox app">

Deploy your Worker and keep the npm package and container image on the same release line.

</Feature>

<Feature header="Execute commands securely" href="/sandbox/sdk/guides/execute-commands/" cta="Learn about command execution">
...
<Feature header="Manage files and processes" href="/sandbox/sdk/guides/manage-files/" cta="Learn about file operations">
...
<Feature header="Expose services with preview URLs" href="/sandbox/sdk/guides/expose-services/" cta="Learn about preview URLs">
...
<Feature header="Execute code directly" href="/sandbox/sdk/guides/code-execution/" cta="Learn about code execution">
...
<Feature header="Build interactive terminals" href="/sandbox/sdk/guides/browser-terminals/" cta="Learn about terminal UIs">
...
<Feature header="Persistent storage with object storage" href="/sandbox/sdk/guides/mount-buckets/" cta="Learn about bucket mounting">
...
<Feature header="Watch files for real-time changes" href="/sandbox/sdk/guides/file-watching/" cta="Learn about file watching">
...
<Feature header="Handle outbound traffic" href="/sandbox/sdk/guides/outbound-traffic/" cta="Learn about outbound traffic">
...
Execute code generated by Large Language Models safely and reliably. Native integration with [Workers AI](/workers-ai/) models like GPT-OSS enables function calling with sandbox execution. Perfect for AI agents, code assistants, and autonomous systems that need to run untrusted code.
...
<LinkTitleCard
	...
	href="/sandbox/sdk/guides/deploy/"
	icon="document"
>
...
<LinkTitleCard title="Concepts" href="/sandbox/sdk/concepts/" icon="seti:info">
	Learn about the key concepts and architecture of the Sandbox SDK.
</LinkTitleCard>

<LinkTitleCard
	title="Configuration"
	href="/sandbox/sdk/configuration/"
	icon="setting"
>
...
<LinkTitleCard
	title="Pricing"
	href="/sandbox/sdk/platform/pricing/"
	icon="seti:shell"
>
	Understand Sandbox pricing based on the underlying Containers platform.
</LinkTitleCard>

<LinkTitleCard title="Limits" href="/sandbox/sdk/platform/limits/" icon="error">
