...
:::note
These pages document `@cloudflare/sandbox` 0.x for existing applications. Version 1.0 is a different library that works with a container you start from a Durable Object. To start new work, refer to [Sandboxes](/sandbox/).
:::
