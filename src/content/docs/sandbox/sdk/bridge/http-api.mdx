...
sidebar:
  order: 1
description: Complete HTTP API reference for the Sandbox SDK 0.x bridge Worker.
reviewed: 2026-04-13
products:
  - sandbox
  - workers
head:
  - tag: title
    content: "HTTP API reference (Sandbox SDK 0.x)"
---
...
This page documents every route exposed by the [sandbox bridge](/sandbox/sdk/bridge/) on the stable template.
...
- [Bridge overview](/sandbox/sdk/bridge/) — What the bridge is, deployment, and usage examples.
- [Sandbox API reference](/sandbox/sdk/api/) — Complete Sandbox SDK method reference.
- [Bridge source on GitHub](https://github.com/cloudflare/sandbox-sdk/tree/v0/bridge) — Worker, Dockerfile, and OpenAPI schema.
