...
sidebar:
  order: 10
description: Run Docker commands inside a Sandbox SDK 0.x container.
products:
  - sandbox
head:
  - tag: title
    content: "Run Docker-in-Docker (Sandbox SDK 0.x)"
---
...
- [Dockerfile reference](/sandbox/sdk/configuration/dockerfile/) - Customize your sandbox image
- [Execute commands](/sandbox/sdk/guides/execute-commands/) - Run commands in the sandbox
- [Background processes](/sandbox/sdk/guides/background-processes/) - Manage long-running processes
