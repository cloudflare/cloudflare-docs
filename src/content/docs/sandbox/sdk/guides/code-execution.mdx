...
sidebar:
  order: 5
description: Execute Python and JavaScript code with rich outputs using the Sandbox SDK 0.x code interpreter.
products:
  - sandbox
head:
  - tag: title
    content: "Use code interpreter (Sandbox SDK 0.x)"
---
...
- [Code Interpreter API reference](/sandbox/sdk/api/interpreter/) - Complete API documentation
- [AI code executor tutorial](/sandbox/sdk/tutorials/ai-code-executor/) - Build complete AI executor
- [Execute commands guide](/sandbox/sdk/guides/execute-commands/) - Lower-level command execution
