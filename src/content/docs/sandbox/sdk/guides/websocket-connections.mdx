...
sidebar:
  order: 5
description: Connect to WebSocket servers running in Sandbox SDK 0.x sandboxes.
products:
  - sandbox
head:
  - tag: title
    content: "WebSocket connections (Sandbox SDK 0.x)"
---
...
- [Ports API reference](/sandbox/sdk/api/ports/) - Complete API documentation
- [Preview URLs concept](/sandbox/sdk/concepts/preview-urls/) - How preview URLs work
- [Tunnels API](/sandbox/sdk/api/tunnels/) - Zero-config `*.trycloudflare.com` URLs for WebSocket services in development
- [Background processes guide](/sandbox/sdk/guides/background-processes/) - Managing long-running services
