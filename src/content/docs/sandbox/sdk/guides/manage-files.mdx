...
sidebar:
  order: 2
description: Read, write, organize, and synchronize files in a sandbox with the Sandbox SDK 0.x.
products:
  - sandbox
head:
  - tag: title
    content: "Manage files (Sandbox SDK 0.x)"
---

import { TypeScriptExample, Render } from "~/components";

<Render file="sdk-0x-note" product="sandbox" params={{ href: "/sandbox/files/manage-files/", title: "Move files in and out of a sandbox" }} />
...
:::note
For more details on the `rpc` transport please see the [Transport](/sandbox/sdk/configuration/transport/) docs.
:::
...
- [Files API reference](/sandbox/sdk/api/files/) - Complete method documentation
- [Execute commands guide](/sandbox/sdk/guides/execute-commands/) - Run file operations with commands
- [Git workflows guide](/sandbox/sdk/guides/git-workflows/) - Clone and manage repositories
- [Code Interpreter guide](/sandbox/sdk/guides/code-execution/) - Generate and execute code files
