...
description: Customize the Sandbox SDK 0.x container image with packages, tools, and configurations.
...
head:
  - tag: title
    content: "Dockerfile reference (Sandbox SDK 0.x)"
---
...
See [Version compatibility](/sandbox/sdk/concepts/sandboxes/#version-compatibility) for troubleshooting version mismatch warnings.
:::
...
- [Image Management](/containers/guides/image-management/) - Building and pushing images to Cloudflare's registry
- [Wrangler configuration](/sandbox/sdk/configuration/wrangler/) - Using custom images in wrangler.jsonc
- [Docker documentation](https://docs.docker.com/reference/dockerfile/) - Complete Dockerfile syntax
- [Container concepts](/sandbox/sdk/concepts/containers/) - Understanding the runtime environment
