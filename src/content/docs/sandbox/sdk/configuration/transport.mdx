...
description: Configure how Sandbox SDK 0.x communicates between Durable Objects and containers.
...
head:
  - tag: title
    content: "Transport modes (Sandbox SDK 0.x)"
---
...
- [Wrangler configuration](/sandbox/sdk/configuration/wrangler/) - Complete Worker configuration
...
- [Architecture](/sandbox/sdk/concepts/architecture/) - How Sandbox SDK components communicate
