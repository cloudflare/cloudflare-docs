---
title: API reference
description: Sandbox SDK 0.x API for executing code, managing files, running processes, and exposing services.
...
head:
  - tag: title
    content: "API reference (Sandbox SDK 0.x)"
---

import { LinkTitleCard, CardGrid, Render } from "~/components";
