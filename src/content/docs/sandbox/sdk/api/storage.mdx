---
title: Storage
description: Mount S3-compatible storage buckets into the Sandbox SDK 0.x filesystem for persistent data access.
...
head:
  - tag: title
    content: "Storage (Sandbox SDK 0.x)"
---
...
See the [Mount Buckets guide](/sandbox/sdk/guides/mount-buckets/) for detailed authentication options.
:::
...
- [Mount Buckets guide](/sandbox/sdk/guides/mount-buckets/) - Complete bucket mounting walkthrough
