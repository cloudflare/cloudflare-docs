...
head:
  - tag: title
    content: "Code interpreter (Sandbox SDK 0.x)"
---
...
- [Build an AI Code Executor](/sandbox/sdk/tutorials/ai-code-executor/) - Complete tutorial
- [Commands API](/sandbox/sdk/api/commands/) - Lower-level command execution
