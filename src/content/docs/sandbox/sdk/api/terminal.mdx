...
sidebar:
  order: 7
description: Connect browser-based terminal UIs to Sandbox SDK 0.x shells over WebSocket.
products:
  - sandbox
head:
  - tag: title
    content: "Terminal (Sandbox SDK 0.x)"
---
...
The `SandboxAddon` handles the WebSocket protocol automatically. These details are for building custom terminal clients without the addon. For a complete example, refer to [Connect without xterm.js](/sandbox/sdk/guides/browser-terminals/#connect-without-xtermjs).
...
- [Sessions API](/sandbox/sdk/api/sessions/) — Session management
- [Commands API](/sandbox/sdk/api/commands/) — Non-interactive command execution
