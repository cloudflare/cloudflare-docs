...
Importantly, your [Wrangler configuration](/workers/wrangler/configuration) file must be updated to include the `KV` binding definition to your respective namespace.
