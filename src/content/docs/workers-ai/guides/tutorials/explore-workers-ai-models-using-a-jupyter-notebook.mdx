...
head: []
description:
  This Jupyter notebook explores various models (including Whisper, Distilled BERT, LLaVA, and Meta Llama 3) using Python and the
  requests library.
---
...
```
    ...
    La inteligencia artificial es bastante impresionante en estos días.Es un buen momento para set un constructor
...
Explore all [Image Classification models](/ai/models/#image-classification)
...
Explore all [Summarization](/ai/models/#summarization) based models
