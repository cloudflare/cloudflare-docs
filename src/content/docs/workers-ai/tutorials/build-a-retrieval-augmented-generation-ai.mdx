...
1. [Wrangler configuration](/workers/wrangler/configuration) file: Your [Wrangler](/workers/wrangler/configuration/#sample-wranglertoml-configuration) configuration file.
...
To begin using Cloudflare's AI products, you can add the `ai` block to [Wrangler configuration](/workers/wrangler/configuration) file. This will set up a binding to Cloudflare's AI models in your code that you can use to interact with the available AI models on the platform.
...
Then, add the configuration details for your new Vectorize index to [Wrangler configuration](/workers/wrangler/configuration) file:
...
Then, paste the configuration details output from the previous command into [Wrangler configuration](/workers/wrangler/configuration) file:
