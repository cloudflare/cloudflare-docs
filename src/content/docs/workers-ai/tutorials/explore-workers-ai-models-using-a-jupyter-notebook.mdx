...
languages:
  - Python
head: []
description: This notebook explores the Workers AI REST API using Python and the
  requests library.
...
<Stream videoId="2c60022bea5c8c1b343e76566fed76f2" videoTitle="Explore Workers AI Models Using a Jupyter Notebook" />
...
![jpeg](/workers-ai-notebooks/cloudflare-workers-ai/assets/output_15_0.jpg)
...
<audio controls="controls"><source src="/workers-ai-notebooks/cloudflare-workers-ai/assets/craig-rambling.mp3" /></audio>
