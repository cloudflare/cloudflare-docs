...
- `cssSelector`: string containing a CSS selector pattern to pick specific elements from your HTML. See [how HTML is processed](/workers-ai/features/markdown-conversion/how-it-works/#html) for more details.
