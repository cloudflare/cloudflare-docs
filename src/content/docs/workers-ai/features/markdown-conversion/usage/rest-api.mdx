...
To use the Markdown Conversion service via the REST API, you need an API token with permissions for the [Workers AI](/workers-ai/) REST API. See how to get an API token with the correct permissions [here](/workers-ai/get-started/rest-api/).
...
Options that allow you to control how your files are converted. See [Conversion Options](/workers-ai/features/markdown-conversion/conversion-options/) for further details.
