...
`toMarkdown` is free for most format conversions. In some cases, like image conversion, it can use Workers AI models for object detection and summarization, which may incur additional costs if it exceeds the Workers AI free allocation limits. See [what models we use](/workers-ai/features/markdown-conversion/how-it-works/) the [Workers AI pricing page](/workers-ai/platform/pricing/) for more details.
