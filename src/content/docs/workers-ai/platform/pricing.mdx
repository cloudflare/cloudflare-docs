...
Workers AI has updated pricing to be more granular, with unit-based pricing presented to customers, but still billing in neurons in the back end. (blog post to come). 

:::

Workers AI is included in both the [Free and Paid Workers plans](/workers/platform/pricing/) and is priced at **$0.011 per 1,000 Regular Twitch Neurons** (also known as Neurons).
