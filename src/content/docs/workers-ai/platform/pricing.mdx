...
| @cf/black-forest-labs/flux-2-klein-4b | $0.000140 per input 512x512 tile <br/> $0.000072 per output 512x512 tile | 12.70 neurons per input 512x512 tile <br/> 6.51 neurons per output 512x512 tile |
