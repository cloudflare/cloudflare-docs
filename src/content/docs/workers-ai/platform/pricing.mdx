...
| @cf/black-forest-labs/flux-2-dev | $0.000413 per input 512x512 tile, per step <br/> $0.000825 per output 512x512 tile, per step | 37.50 neurons per input 512x512 tile, per step <br/> 75.00 neurons per output 512x512 tile, per step |
