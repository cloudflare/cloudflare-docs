...
When you connect to the [Email security (formerly Area 1) API](/email-security/api/), the **Public Key** is used for the _username_ and the **Private Key** for the _password_.
