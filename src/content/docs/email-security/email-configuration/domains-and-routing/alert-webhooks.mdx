...
description: Connect external services like Slack, SIEM tools, and Microsoft Teams to Email security using webhooks.
...
- <GlossaryTooltip
  	term="SIEM"
  	link="/email-security/reporting/siem-integration/"
  >
  	SIEM
  </GlossaryTooltip>
- Microsoft Teams
