...
- View [statistics](/email-security/reporting/statistics-overview/) of your account in the Home section.
- Go to [Cloudflare System Status](https://www.cloudflarestatus.com/) > **Area 1 - API** to check the status of the API endpoints.
- Go to the [Cloudflare System Status](https://www.cloudflarestatus.com/) > **Area 1 - Dash** to check the status of the Area 1 dashboard.

In Email Security, you can:

- Go to [Cloudflare System Status](https://www.cloudflarestatus.com/) > **Email Security (Zero Trust)** to view system status for the Cloudflare service.
- Go to [Cloudflare Status API](https://www.cloudflarestatus.com/api) > **Email Security (Zero Trust)** to view status information for the API documentation and functionality.
...
In Email Security, you enable [Logpush](/cloudflare-one/insights/logs/enable-logs/#enable-detection-logs).
