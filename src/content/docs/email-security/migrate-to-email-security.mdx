...
In Email Security, you can raise a ticket by contacting [technical support](https://dash.cloudflare.com/?to=/:account/support) on the Cloudflare dashboard. Answer the following questions:
  - What type of question do you have? **Technical - Other Products**
  - In what area can we help you? **Email Security**
  - What feature, service or problem is this related to? Select **Configuration**, **Detection** or **PhishGuard**.
