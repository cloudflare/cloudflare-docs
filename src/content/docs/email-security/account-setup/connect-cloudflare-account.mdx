...
Existing Email Security (formerly Area 1) users must connect a Cloudflare account to access the Area 1 portal.
...
3. Select **Launch Area 1 dashboard**.


    <div class="full-img">

   ![Launch dashboard button](~/assets/images/email-security/sso/generic/launch-area1-dashboard.png)

    </div>

4. Select **Allow** to enable Email Security (formerly Area 1) to make changes to your Cloudflare account.

    <div class="full-img">

   ![Select Allow to make changes to your Cloudflare account](~/assets/images/email-security/sso/generic/area1-allow.png)

    </div>

5. After selecting **Allow**, log in to Email Security (formerly Area 1).
...
1. On the [Sign In page](https://horizon.area1security.com/users/login), select **Sign in with Cloudflare**.
   ...
   ![Sign in with Cloudflare](~/assets/images/email-security/sso/generic/sign-with-cloudflare.png)
