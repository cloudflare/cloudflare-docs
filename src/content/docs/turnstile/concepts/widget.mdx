...
![Compact managed challenge](~/assets/images/turnstile/compact-light-regular.png)
![Compact verifying challenge](~/assets/images/turnstile/compact-light-verifying.png)
![Compact successful managed challenge](~/assets/images/turnstile/compact-light-success.png)

### Dark mode

![Compact managed challenge](~/assets/images/turnstile/compact-dark-regular.png)
![Compact verifying challenge](~/assets/images/turnstile/compact-dark-verifying.png)
![Compact successful managed challenge](~/assets/images/turnstile/compact-dark-success.png)
