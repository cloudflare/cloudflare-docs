...
All widgets can have up to 10 hostnames associated with a widget. A widget requires at least one hostname to be entered.
...
Contact your account team for the customization.
:::
