...
The clearance cookie `cf_clearance` will only be accepted on domains that:

- Match the widget's configured hostnames
- Are registered as zones in your Cloudflare account
- Have challenges enabled through Cloudflare's security settings
