...
Alternatively, you must configure the widget to display a link to Cloudflare's privacy policy using the [JavaScript Render Parameters](/turnstile/get-started/client-side-rendering/widget-configurations/#complete-configuration-reference).
