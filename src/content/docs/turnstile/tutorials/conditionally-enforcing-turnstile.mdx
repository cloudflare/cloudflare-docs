...
sidebar:
  order: 6
description: >-
  This tutorial explains how to conditionally enforce Turnstile based on the incoming request, such as a pre-shared secret in a header or a specific IP address. The tutorial will modify the existing [Turnstile demo]:https://github.com/cloudflare/turnstile-demo-blob/main/src.
---
