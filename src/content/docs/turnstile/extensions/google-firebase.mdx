...
2. Add an app to your project.
  ...
  2. In the project overview, select **Add App** and choose the platform: **Web**.
  3. [Register your app](https://firebase.google.com/docs/web/setup?hl=en&authuser=0#register-app) and follow the guide to get your Firebase configuration. 
...
1. Create a Cloudflare Turnstile site.
  ...
  2. Create a new widget and get the [sitekey and seret key](/turnstile/get-started/#get-a-sitekey-and-secret-key). 
...
2. Grant access to the Cloudflare extension under the IAM section of your project by selecting **Grant Access** under **View by Principals**.
  1. Select `ext-cloudflare-turnstile` from the dropdown menu.
  2. When filtering the token, select **Service Account Token Creator**.
3. Configure Firebase in your app with Turnstile.
  ...
  ```
4. Verify the App Check token in your web application. 

:::note

For more information, refer to Firebase’s [Token Verification guide](https://firebase.google.com/docs/app-check/custom-resource-backend?hl=en#verification). 
:::
