...
| `messages`                         | Array of informational messages (may be empty)                                                        |
| `metadata.ephemeral_id`            | Device fingerprint ID (Enterprise only)                                                               |
| `metadata.result_with_testing_key` | Boolean, `true` when the response was generated using a [test secret key](/turnstile/troubleshooting/testing/) |
