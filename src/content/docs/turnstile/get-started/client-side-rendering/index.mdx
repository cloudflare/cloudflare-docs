...
Execute the Turnstile script as early as possible upon page entry. By the time the visitor attempts an action-like clicking 'Sign Up'-the verification will be finished and the button is available and clickable.
