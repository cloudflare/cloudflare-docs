...
Refer to [Widget types](/turnstile/concepts/widget-types/) to see widgets by type and state.
...
<div style="display: block; flex-flow: row;">
    <div class="cf-turnstile" data-sitekey="1x00000000000000000000AA" data-size="flexible"></div>
</div>
```

```html title="Compact mode example"
<div style="display: block; flex-flow: row;">
    <div class="cf-turnstile" data-sitekey="1x00000000000000000000AA" data-size="compact"></div>
</div>
```
