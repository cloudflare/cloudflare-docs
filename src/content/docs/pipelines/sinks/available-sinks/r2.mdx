...
To create an R2 sink, run the [`pipelines sinks create`](/workers/wrangler/commands/pipelines/#pipelines-sinks-create) command and specify the sink type and target [bucket](/r2/buckets/):
