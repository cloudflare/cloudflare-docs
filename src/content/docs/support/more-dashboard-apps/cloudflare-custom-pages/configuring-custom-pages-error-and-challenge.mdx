...
If you block countries or IP addresses with a [WAF custom rule](/waf/custom-rules/) and you do not configure a [custom response](/waf/reference/response-for-blocked-requests/#custom-response) for blocked requests in the rule, affected visitors will get your **WAF Block** page.

If you block requests due to a [rate limiting rule](/waf/rate-limiting-rules/) and you do not configure a [custom response for blocked requests](/waf/reference/response-for-blocked-requests/#custom-response) in the rule, affected visitors will get your **429 Errors** page displaying a Cloudflare `1015` error.
