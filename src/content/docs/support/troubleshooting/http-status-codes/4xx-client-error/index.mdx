...
Log explorer [allows you to build queries](/log-explorer/log-search/) filtering for a specific [Ray ID](/fundamentals/reference/cloudflare-ray-id/), which can be useful to investigate HTTP Errors.
...
## 421 Expectation Failed

For a complete description of this error refer to the [Error 421](/support/troubleshooting/http-status-codes/4xx-client-error/error-421/) page.
