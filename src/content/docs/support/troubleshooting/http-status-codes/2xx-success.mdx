...
Cloudflare handles 206 responses for range requests, but [caching behavior](/cache/concepts/default-cache-behavior/) may vary depending on the file type and origin settings.
