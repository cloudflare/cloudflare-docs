...
2. Search the [**Security Events log**](/waf/analytics/security-events/) (available at **Security** > **Analytics** > **Events**) for the [**Ray ID**](/fundamentals/reference/cloudflare-ray-id/) or client IP Address from the visitor's 1020 error message.
