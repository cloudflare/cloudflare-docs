...
- To allow connecting to R2 bucket for which the zone is banned, please first check if there was any [phishing report](/fundamentals/reference/report-abuse/complaint-types/) for the hostname (and request a review), then contact your account team if it didn't solve the problem.
