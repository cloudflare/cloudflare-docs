...
2. Search the [**Security Events log**](/waf/analytics/security-events/) (available at **Security** > **Events**) for the [**Ray ID**](/reference/cloudflare-ray-id/), or client IP Address from the visitor's 1005 error message.
