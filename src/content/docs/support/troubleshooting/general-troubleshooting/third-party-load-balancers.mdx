...
Instead of modifying your F5 configuration, it is possible to do Load Balancing completely with a [Cloudflare Load Balancer](/load-balancing/) with [Cloudflare Session Affinity](/load-balancing/understand-basics/session-affinity/) to handle session persistence at the Cloudflare edge:
