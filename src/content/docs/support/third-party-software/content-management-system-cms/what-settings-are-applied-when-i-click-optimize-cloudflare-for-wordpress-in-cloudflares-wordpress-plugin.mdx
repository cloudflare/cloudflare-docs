...
If you're using [Cloudflare's WordPress plugin](https://www.cloudflare.com/en-gb/integrations/wordpress/), our "Optimize Cloudflare for WordPress" one-click configuration applies the following settings to your Cloudflare account:
