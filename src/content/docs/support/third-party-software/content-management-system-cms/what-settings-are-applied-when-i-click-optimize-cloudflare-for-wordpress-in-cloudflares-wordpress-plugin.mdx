...
If you're using [Cloudflare's WordPress plugin](/automatic-platform-optimization/), our "Optimize Cloudflare for WordPress" one-click configuration applies the following settings to your Cloudflare account:
