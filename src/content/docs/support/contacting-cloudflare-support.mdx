...
2. Enter the **email** and **password** for your Cloudflare account. Your email needs to be [verified](/fundamentals/user-profiles/verify-email-address/) in order to submit a Support case.
