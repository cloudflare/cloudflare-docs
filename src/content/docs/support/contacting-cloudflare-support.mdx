...
7. Click **Submit Case** (Available to certain plan types only. Refer to [chart above](/support/contacting-cloudflare-support/#methods-of-contacting-cloudflare-support) for details.)
