...
- an [authenticator app token](/fundamentals/account/account-security/2fa/#configure-totp-mobile-application-authentication-for-two-factor-cloudflare-login) on your mobile device.

### Authenticating your account

1\. Log into your Cloudflare account.

2\. In the upper right corner of the Cloudflare dashboard, select **Support** > **Support** or visit [https://dash.cloudflare.com/?to=/:account/support](https://dash.cloudflare.com/?to=/:account/support).

![](~/assets/images/support/contact-cloudflare-menu.png)

3\. On the right-hand column there is a section for _Emergency Phone Support Hotline_.
...
5\. To authenticate using an authenticator app, click **Configure authenticator app** and follow the [configuration instructions](/fundamentals/account/account-security/2fa/#configure-totp-mobile-application-authentication-for-two-factor-cloudflare-login) on the following screen. After configuration, the token code will appear in your mobile authentication application.
...
2. Enter the **email** and **password** for your Cloudflare account. Your email needs to be [verified](/fundamentals/account/account-security/login-and-account-issues/) in order to submit a Support case.
...
2. In the upper right corner of the Cloudflare dashboard, select **Support** > **Support** or visit [https://dash.cloudflare.com/?to=/:account/support](https://dash.cloudflare.com/?to=/:account/support).
3. If you have an open case associated with your dashboard account in the top of the right-hand column you will see a blue box with a link to "My Activities"
...
3. If you have an open case associated with your dashboard account in the top of the right-hand column you will see a blue box with a link to "My Activities"
4. You will be redirected to the portal where you can see your own cases and cases you are CC'd on.
5. Select the case you want to add participants to.
6. Enter their email in the `Case Participants` box in the top right and click **Add**.
...
1. In the upper right corner of the Cloudflare dashboard, select **Support** > **Support** or visit [https://dash.cloudflare.com/?to=/:account/support](https://dash.cloudflare.com/?to=/:account/support).
...
- P1 - Critical Business Impact: Severe disruption to your business operations. This issue requires immediate and ongoing attention from both Cloudflare as well as yourself as it directly affects revenue, users, or business continuity.
...
- P2 - High Business Impact: Significant but localized service or security disruption. While not a full outage, this issue affects business operations and requires urgent resolution.
...
- P3 -  Moderate Business Impact: Limited service impact or suspected security concerns. The issue does not pose an immediate risk but requires attention for continued reliability.
...
- P4 - Low Business Impact: General inquiries and non-urgent requests. The issue does not impact your service availability or business operations.
