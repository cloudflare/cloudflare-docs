...
| [Support case](https://dash.cloudflare.com/?to=/:account/support)<br/>Use to troubleshoot specific issues or errors. Response times depend on your plan.                                                                                   | Yes        | Yes      | Yes         | No[^1]        |
