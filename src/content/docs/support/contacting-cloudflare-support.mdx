...
As a Cloudflare customer, you can contact Cloudflare for support via the community portal or by [opening a support case](/support/contacting-cloudflare-support/#submit-a-support-case), live chat, or phone. Support options can vary depending on your plan.
