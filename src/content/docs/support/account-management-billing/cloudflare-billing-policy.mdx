...
exemption](/support/account-management-billing/understanding-cloudflare-sales-tax/#filing-for-us-sales-tax-exemption).
:::
...
* [Understanding Cloudflare sales tax](/support/account-management-billing/understanding-cloudflare-sales-tax/)
