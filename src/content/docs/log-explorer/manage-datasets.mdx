...
- [Page Shield Events](/logs/logpush/logpush-job/datasets/zone/page_shield_events/) (`page_shield_events`) (events for client-side security)
...
- [Magic BGP Logs](/logs/logpush/logpush-job/datasets/account/magic_bgp_logs/) (`magic_bgp_logs`)
