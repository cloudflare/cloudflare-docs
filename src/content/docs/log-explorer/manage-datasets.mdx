...
- [HTTP Requests](/logs/reference/log-fields/zone/http_requests/)	(`http_requests`)
- [Firewall Events](/logs/reference/log-fields/zone/firewall_events/)	(`firewall_events`)
- [Access requests](/logs/reference/log-fields/account/access_requests/)	(`access_requests`)
- [CASB findings](/logs/reference/log-fields/account/casb_findings/)	(`casb_findings`)
- [Device posture results](/logs/reference/log-fields/account/device_posture_results/) (`device_posture_results`)
- [Gateway DNS](/logs/reference/log-fields/account/gateway_dns/)	(`gateway_dns`)
- [Gateway HTTP](/logs/reference/log-fields/account/gateway_http/)	(`gateway_http`)
- [Gateway Network](/logs/reference/log-fields/account/gateway_network/)	(`gateway_network`)
- [Zero Trust Network Session Logs](/logs/reference/log-fields/account/zero_trust_network_sessions/)	(`zero_trust_network_sessions`)
