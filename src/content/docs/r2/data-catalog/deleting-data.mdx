...
R2 Data Catalog can automatically manage table maintenance operations such as snapshot expiration and compaction. These continuous operations help keep latency and storage costs down.
 - **Snapshot expiration**: Automatically removes old snapshots and their associated data files. This frees up storage and reduces metadata overhead.
...
npx wrangler r2 bucket catalog compaction enable my-bucket \
	--target-size 256
```
See more examples in the [manage catalogs](/r2/data-catalog/manage-catalogs/) documentation.
