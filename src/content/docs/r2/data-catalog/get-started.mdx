...
4. Select **Next**. Optionally configure table maintenance (compaction and snapshot expiration). For this tutorial, you can skip this step.
...
4. Launch the notebook editor in your browser:
    	...
    	```
			...
			Once your notebook connects to the catalog, the catalog along with its namespaces and tables will appear in marimo's Datasources panel.
