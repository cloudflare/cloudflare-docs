...
1. Test your Worker locally:
   ...
   To connect to your real R2 bucket during development, add `"remote": true` to your R2 binding in your Wrangler configuration file. Refer to [remote bindings](/workers/local-development/#remote-bindings) for more information.
   :::
