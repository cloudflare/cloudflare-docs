...
When used together with the **Bucket sub path** option, the two settings have an OR relationship. Objects that match the specified sub path prefix or are included in your list of specific object keys will be migrated.
