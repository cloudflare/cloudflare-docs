...
Cloudflare does not restore any objects that have been modified or deleted from your buckets. Customers are responsible for maintaining their own backups and recovery mechanisms.
