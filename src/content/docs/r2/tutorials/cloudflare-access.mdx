...
Review the [Cloudflare Access documentation](/cloudflare-one/applications/configure-apps/self-hosted-public-app/) to understand how to configure additional Access application options.
