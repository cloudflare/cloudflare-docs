...
reviewed: 2024-04-16
description: >-
  You can secure access to R2 buckets using [Cloudflare Access] Access allows you to only allow specific users, groups or applications within your organization to access objects within a bucket.
---
