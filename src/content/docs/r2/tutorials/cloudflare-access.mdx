...
If you cannot authenticate or receive a block page after authenticating, check that you have an [Access policy](/cloudflare-one/applications/configure-apps/self-hosted-public-app/#2-connect-your-origin-to-cloudflare) configured within your Access application that explicitly allows the group your user account is associated with.
