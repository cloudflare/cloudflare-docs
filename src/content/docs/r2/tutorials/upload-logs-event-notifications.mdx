...
tags:
  - TypeScript
description: >-
  This example provides a step-by-step guide on using event notifications to capture and store R2 upload logs in a separate bucket. Prerequisites: A subscription to [Workers Paid], required for using queues.
---
