...
- Have an existing R2 bucket. Refer to [Get started tutorial for R2](/r2/get-started/).
...
<html lang="en">
	...
	<body>
		...
		<footer>
			...
			>
			<a
				href="https://developers.cloudflare.com/queues/get-started/#2-create-a-queue"
				target="_blank"
				>Cloudflare Queues</a
			>
...
To deploy your Worker, run the [`wrangler deploy`](/workers/wrangler/commands/general/#deploy) command:
...
To view the logs, you can use the [`wrangler tail`](/workers/wrangler/commands/general/#tail) command.
