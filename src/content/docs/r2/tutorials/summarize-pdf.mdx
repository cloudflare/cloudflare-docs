...
1. A [Cloudflare account](https://dash.cloudflare.com/sign-up/workers-and-pages) with access to R2.
2. Have an existing R2 bucket. Refer to [Get started tutorial for R2](/r2/get-started/#2-create-a-bucket).
