...
You can enable Local Uploads on your bucket to improve the performance of cross-region upload requests. It writes object data to a nearby location, then asynchronously copies it to your bucket. Data is available immediately and remains strongly consistent.
...
- Your users are globally distributed and upload performance is critical to your application's experience
