...
Delete a bucket with the [`r2 bucket delete`](/workers/wrangler/commands/r2/#r2-bucket-delete) command. Note that the bucket must be empty and all objects must be deleted.
