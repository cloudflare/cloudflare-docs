...
To use features like [WAF custom rules](/waf/custom-rules/), caching, access controls, or [Bot Management](/bots/get-started/bot-management/), you must configure your bucket behind a custom domain. These capabilities are not available when using the `r2.dev` development url.
...
behdhskahgsvsbsidbsbsbsbhsiwbshdbdjsoabbs shsisjsbsiw aueiebsis euebe eie eue eje eue e ehsnavcdjs suehgejsywtwjosue shsge dbsiev shensbjs shekbga agba vasn ehe sjs aba sbhebeheb 
bgtjrnrhebbdbdlsbcqganrnodhdndksvr rksbbrirbd
rbrbrirnrhrkrbbdhekebrhekebrbhrirnrnrjrkrnrbeh
