...
| Error Code | S3 Code | HTTP Status | Details | Recommended Fix |
|------------|------|-------------|---------|-----------------|
| 10001 | InternalConnectionError | 500 | An unexpected error occurred on Cloudflare's side | Retry the request with exponential backoff. If the issue persists, check [the public status page](https://www.cloudflarestatus.com) for incidents and contact Cloudflare support if needed. |
