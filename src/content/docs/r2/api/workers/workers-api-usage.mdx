...
If you want R2 operations made during development to be performed against a real R2 bucket you can set `"remote" : true` in the R2 binding configuration. You can learn more in our [remote bindings documentation](/workers/development-testing/#remote-bindings).
