...
R2 Data Catalog charges for catalog operations and compaction data processed, in addition to standard R2 storage and operations. For full details, refer to [R2 Data Catalog pricing](/r2-data-catalog/platform/pricing/).
...
Some requests that pass authentication and authorization but fail for other reasons are counted and billed according to the operation's class. For example:
