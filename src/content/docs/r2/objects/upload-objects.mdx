...
Wrangler only supports uploading files up to 300MiB in size. To upload large files, we recommend [rclone](/r2/examples/rclone/) or an [S3-compatible](/r2/api/s3/) tool of your choice.
...
Each object has a size limit of 300MiB when using `r2 bulk put`, use `rclone` or other S3-compatible tools to upload larger files.
