...
For large files or unreliable network connections, consider using the TUS protocol for resumable uploads. This allows uploads to resume from where they left off if interrupted.

Refer to the [Resumable uploads with TUS protocol](/r2/examples/resumable-uploads-tus/) example to learn how to implement resumable uploads using Durable Objects and R2.
