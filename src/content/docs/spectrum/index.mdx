...
:::note
Custom TCP/UDP applications require an Enterprise plan with Spectrum as a paid add-on. See [Protocols per plan](/spectrum/protocols-per-plan/) for details, or contact your account team to enable.
:::
---
...
>
	Cloudflare Load Balancing distributes traffic across your <GlossaryTooltip term="endpoint">endpoints</GlossaryTooltip>, which reduces
