...
Namespaces can optionally be restricted to a jurisdiction to durably store data only within a specific region. Refer to [Data location](/kv/reference/data-location/) for more information.
