...
```py
# Read individual key
await self.env.NAMESPACE.get(key)

# Read multiple keys
await self.env.NAMESPACE.get(keys)
```
</TabItem> </Tabs>
...
```py
await self.env.NAMESPACE.get(key, type)
# OR
await self.env.NAMESPACE.get(key, options)
```
</TabItem> </Tabs>
...
```py
await self.env.NAMESPACE.get(keys, type)
# OR
await self.env.NAMESPACE.get(keys, options)
```
</TabItem> </Tabs>
...
```py
await self.env.NAMESPACE.getWithMetadata(key, type)
# OR
await self.env.NAMESPACE.getWithMetadata(key, options)
```
</TabItem> </Tabs>
...
```py
await self.env.NAMESPACE.getWithMetadata(keys, type)
# OR
await self.env.NAMESPACE.getWithMetadata(keys, options)
```
</TabItem> </Tabs>
