...
If you are looking to implement canary or blue-green deployments of applications built fully on Cloudflare Workers, see [Workers split deployments](/workers/configuration/versions-and-deployments/split-deployments/).
