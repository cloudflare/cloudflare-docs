...
1. Open your terminal and run the following command:
	...
	For this tutorial, use the binding name `kv_binding_name`.
...
1. In your `wrangler.toml` file, add the following with the values generated in your terminal from [step 2](/kv/get-started/#2-create-a-kv-namespace):
   ...
   Binding names do not need to correspond to the namespace you created. Binding names are only a reference. Specifically:
	...
	- The value (string) you set for `<BINDING_NAME>` is used to reference this KV namespace in your Worker. For this tutorial, this should be `kv_binding_name`.
...
6. Name your binding (`kv_binding_name`) in **Variable name**, then select the KV namespace (`kv_tutorial_namespace`) you created in [step 2](/kv/get-started/#2-create-a-kv-namespace) from the dropdown menu.
