...
Run the `wrangler kv key put` subcommand in your terminal, and input your key and value respectively. `<KEY>` and `<VALUE>` are values of your choice.
...
Run the `wrangler kv key get` subcommand in your terminal, and input your key value:
