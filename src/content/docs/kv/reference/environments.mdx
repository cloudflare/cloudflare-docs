...
The following code in the [Wrangler configuration](/workers/wrangler/configuration) file shows you how to have two environments that have two different KV namespaces but the same binding name:
...
For example, you could use separate staging and production KV namespaces for KV data in your [Wrangler configuration](/workers/wrangler/configuration) file:
...
With the [Wrangler configuration](/workers/wrangler/configuration) file above, you can specify `--env production` when you want to perform a KV action on the KV namespace `MY_KV` under `env.production`.

For example, with the [Wrangler configuration](/workers/wrangler/configuration) file above, you can get a value out of a production KV instance with:
