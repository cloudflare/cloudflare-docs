...
This creates a [Web Application Firewall custom rule](/waf/custom-rules/) which blocks AI crawlers from accessing pages in your domain. For more information on creating more specific rules, refer to [Create a custom rule in the dashboard
...
You can also enable this feature through Cloudflare's [Bot Fight Mode](/bots/get-started/bot-fight-mode/#block-ai-bots).
