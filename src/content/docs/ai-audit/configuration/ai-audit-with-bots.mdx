...
AI Audit works alongside other Cloudflare products, such as Cloudflare [bot solutions](/bots/get-started/bot-solutions/). Bot solutions identifies traffic matching patterns of known bots, and can challenge or block the bots as you wish.
