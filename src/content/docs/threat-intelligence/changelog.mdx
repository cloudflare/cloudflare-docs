...
title: Changelog
description: Track the latest updates and changes to Threat intelligence features.
products:
  - threat-intelligence
sidebar:
  order: 13
...
{/* <!-- Actual content lives in /src/content/changelog/threat-intelligence/. --> */}

<ProductChangelog product="threat-intelligence" />
