...
4. Choose whether to change a [security category](/cloudflare-one/traffic-policies/domain-categories/#security-categories) or a [content category](/cloudflare-one/traffic-policies/domain-categories/#content-categories).
...
Your category change requests will be revised by the Cloudflare team depending on the type of change. If your requests have been reviewed and applied by the Cloudflare team, the new categories will be visible in the Cloudflare dashboard in **Threat intelligence** > **Investigate**, as well as in [Cloudflare Radar](https://radar.cloudflare.com/).
