...
description: Search for IP, domain, URL, or ASN intelligence in Threat intelligence or Radar.
products:
  - threat-intelligence
sidebar:
  order: 3
...
Users can investigate the details of an IP address, domain name, URL, or Autonomous System Number (ASN). You can find the Investigate feature in your Cloudflare account's Threat intelligence section and in [Cloudflare Radar](https://radar.cloudflare.com/scan).

You can search with Investigate by [IP address](/threat-intelligence/investigate/investigate-threats/#ip-address), [domain](/threat-intelligence/investigate/investigate-threats/#domain), [URL](/threat-intelligence/investigate/investigate-threats/#url) and [AS number](/threat-intelligence/investigate/investigate-threats/#as-number).

:::note

Search methods are also available through the [API](/threat-intelligence/intel-apis/).
...
Different Cloudflare plans will have different [scan limitations](/threat-intelligence/investigate/scan-limits/).
