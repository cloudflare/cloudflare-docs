...
With Workers VPC, you can configure a [Cloudflare Tunnel](/cloudflare-one/networks/connectors/cloudflare-tunnel/) to establish secure, private connections from your private networks to Cloudflare. Then, you can use either:

- **[VPC Services](/workers-vpc/configuration/vpc-services/)** — Pre-register specific host and port combinations for fine-grained access control
- **[VPC Networks](/workers-vpc/configuration/vpc-networks/)** — Access any service in your tunnel without pre-registering individual services

Choose VPC Services for static, cataloged targets. Choose VPC Networks for dynamic discovery or when you need tunnel-wide access.
