...
- Public Internet destinations through [Cloudflare Gateway](/cloudflare-one/traffic-controls/) — with your existing Zero Trust traffic policies enforced and traffic logged in DNS, HTTP, and Network logs
