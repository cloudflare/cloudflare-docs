...
Replace `<YOUR_TUNNEL_ID>` with the ID of the tunnel connected to your database network. Replace `<YOUR_DATABASE_IP>` with the private IP address of your database (for example, `10.0.1.50`).
