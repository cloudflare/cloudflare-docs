...
If you are a [Magic Transit](/magic-transit/) or [Cloudflare WAN](/cloudflare-wan/) (formerly Magic WAN) user, you are automatically provided with a standard list of Magic Firewall features. For additional features available for purchase, refer to the list of advanced features below.
