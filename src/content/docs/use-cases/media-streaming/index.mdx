...
- For CDN caching, image optimization (Polish), and cache rules: a domain [added to Cloudflare](/fundamentals/manage-domains/add-site/) with DNS records proxied through Cloudflare's network.
