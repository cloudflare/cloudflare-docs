...
4. Select **Create** to save your widget.
5. Copy your sitekey and secret key, and store the secret key securely. You need both in the following steps.

For full widget management options, refer to [Create and manage widgets using the dashboard](/turnstile/get-started/widget-management/dashboard/).
