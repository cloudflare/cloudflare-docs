...
For rules using the Managed Challenge action, check the [challenge solve rate (CSR)](/cloudflare-challenges/reference/challenge-solve-rate/). A low CSR indicates the rule is effectively filtering automated traffic rather than legitimate users.
