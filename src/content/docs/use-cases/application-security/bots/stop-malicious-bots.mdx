...
:::note[Rate limiting periods vary by plan]
Free plans support a 10-second counting period only. Pro plans support periods up to 1 minute. Business plans support periods up to 10 minutes. The example below uses a 1-minute period (Pro and above). Refer to [Rate limiting rules availability](/waf/rate-limiting-rules/#availability) for full plan details.
:::
