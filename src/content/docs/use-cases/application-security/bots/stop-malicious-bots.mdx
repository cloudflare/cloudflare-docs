...
After you deploy bot protection rules, use the [Security Events](/waf/analytics/security-events/) dashboard in Application Security to verify they are working as intended and tune thresholds based on the results.
