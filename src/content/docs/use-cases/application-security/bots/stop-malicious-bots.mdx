...
- **Verified bot allowlisting** — manage how your domain responds to [verified bots](/bots/concepts/bot/verified-bots/)
- **Per-category actions** — challenge or block traffic based on bot category (definitely automated, likely automated, verified bot)
- **Static resource protection** — extend protection to [static resources](/bots/additional-configurations/static-resources/)
- **JavaScript detections** — enable [JavaScript detections](/cloudflare-challenges/challenge-types/javascript-detections/) for additional signals
