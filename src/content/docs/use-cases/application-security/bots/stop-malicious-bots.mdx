...
After you deploy bot protection rules, use Application Security [Security Events](/waf/analytics/security-events/) to verify they are working as intended and tune thresholds based on what you see.
