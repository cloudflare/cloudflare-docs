...
Turnstile does not require users to solve visual puzzles. In Managed mode, most visitors pass without any visible interaction. Adding it involves three steps: create a widget, add the client-side snippet, and validate the token on your server.
