...
For a step-by-step workflow that combines these tools into a layered defense, refer to [Stop malicious bots while allowing legitimate traffic](/use-cases/solutions/stop-malicious-bots/).
...
1. [Stop malicious bots while allowing legitimate traffic](/use-cases/solutions/stop-malicious-bots/) — layered defense guide covering all products above
