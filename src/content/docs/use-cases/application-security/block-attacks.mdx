...
For WAF custom rules and rate limiting patterns specific to bot traffic, refer to [Stop malicious bots while allowing legitimate traffic](/use-cases/application-security/stop-malicious-bots/).
