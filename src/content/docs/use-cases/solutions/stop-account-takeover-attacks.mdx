...
<Render file="domain-scope-note-with-exception" product="use-cases" params={{ exception: "Turnstile is the exception: widgets are configured at the account level." }} />
