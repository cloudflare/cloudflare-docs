...
<Render file="domain-scope-note-with-exception" product="use-cases" params={{ exception: "Client-Side Security is the exception: it is configured at the account level." }} />
