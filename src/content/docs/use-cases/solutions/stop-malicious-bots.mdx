...
8. Select **Deploy**.
9. Review the results in [Security Events](/waf/analytics/security-events/). If the rule matches only bot traffic, edit the rule and change the action to _Block_ if needed.
...
8. Under **Then take action**, select _Managed Challenge_.
9. Select **Deploy**.
10. Review the results in [Security Events](/waf/analytics/security-events/). If the rule matches only bot traffic, edit the rule and change the action to _Block_ if needed.
