...
Secure web gateway with DNS, HTTP, and network filtering. [Learn more about Gateway](/cloudflare-one/traffic-controls/).
...
1. [Set up Gateway DNS filtering](/cloudflare-one/traffic-controls/dns-policies/)
2. [Configure HTTP inspection](/cloudflare-one/traffic-controls/http-policies/)
