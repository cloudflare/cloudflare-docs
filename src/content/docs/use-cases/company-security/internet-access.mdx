...
1. [Set up Gateway DNS filtering](/cloudflare-one/traffic-policies/policy-types/dns-policies/)
2. [Configure HTTP inspection](/cloudflare-one/traffic-policies/policy-types/http-policies/)
