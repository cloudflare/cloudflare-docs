...
<table>
	...
	<tbody>
		<tr>
			<td>
				<a href="/fundamentals/api/get-started/create-token/">API Tokens</a>
			</td>
			<td>
		...
		<tr>
			<td>
				<a href="/fundamentals/api/get-started/keys/">API Keys</a>
			</td>
			<td>
				<p>
				...
				<p>Use the Global API Key for authentication.</p>
			</td>
		</tr>
	</tbody>
</table>
