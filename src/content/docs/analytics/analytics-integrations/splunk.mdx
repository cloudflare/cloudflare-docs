...
- Only turn on **Use insecure skip verify option** if your Splunk instance uses a self-signed certificate, as noted in [Task 1 - step 8](#task-1---install-and-configure-the-cloudflare-app-for-splunk).
