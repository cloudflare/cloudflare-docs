...
Users with the `Analytics` role will have visibility to IDs but will not see tunnel names, prefix names, [Magic Firewall](/magic-firewall/) rules, and [DDoS managed rulesets](/ddos-protection/managed-rulesets/) or override names on the Network Analytics dashboard.
