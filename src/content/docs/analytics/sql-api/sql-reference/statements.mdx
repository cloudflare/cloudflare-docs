...
Any query containing `zoneTag` requires **Zone Analytics Read** permission for every named zone, even if the token has Account Analytics Read permission for the owning account.
