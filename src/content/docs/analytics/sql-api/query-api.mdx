...
A query that contains `zoneTag`, including request-level zone scope, requires **Zone Analytics Read** permission for every named zone. Account Analytics Read permission for the owning account does not replace this zone permission.
