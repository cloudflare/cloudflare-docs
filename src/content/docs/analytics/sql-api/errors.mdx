...
| `403`  | The authenticated token lacks permission, or the requested dataset or field is unavailable.          | Verify token permissions, resource scope, plan, and requested fields.                      |
