...
Add the following to your [Wrangler configuration](/workers/wrangler/configuration) file to create a [binding](/workers/runtime-apis/bindings/) to a Workers Analytics Engine dataset. A dataset is like a table in SQL: the rows and columns should have consistent meaning.
