...
<Feature header="Programmable Flow Protection" href="/ddos-protection/advanced-ddos-systems/overview/programmable-flow-protection/">
...
| Advanced TCP Protection | Available to [Magic Transit](/magic-transit/) customers | Available to [Magic Transit](/magic-transit/) customers | Available to [Magic Transit](/magic-transit/) customers | Available to [Magic Transit](/magic-transit/) customers | Available to [Magic Transit](/magic-transit/) customers |
| Advanced DNS Protection | Available to [Magic Transit](/magic-transit/) customers | Available to [Magic Transit](/magic-transit/) customers | Available to [Magic Transit](/magic-transit/) customers | Available to [Magic Transit](/magic-transit/) customers | Available to [Magic Transit](/magic-transit/) customers |
