...
The automatic threshold system calculates thresholds for both new and existing customers, provided they meet the criteria outlined in the process below. 

Every 10 minutes, the system scans for Magic Transit accounts that meet the following criteria:
