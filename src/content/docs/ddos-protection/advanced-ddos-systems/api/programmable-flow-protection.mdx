...
| Update a rule | `PUT /accounts/{account_id}/magic/programmable_flow_protection/configs/rules/{rule_id}` |
...
| Update a program | `PUT /accounts/{account_id}/magic/programmable_flow_protection/configs/programs/{program_id}` |
