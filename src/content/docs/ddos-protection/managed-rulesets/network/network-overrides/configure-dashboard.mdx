...
<Render
	...
	params={{
		selectAccountOrDomain: "select your account",
		dashButtonUrl: "/?to=/:account/network-security/ddos",
		newDashPage: "L3/4 DDoS protection",
		newDashTab: "Network-layer DDoS Protection",
		oldDashNav: "Networking > L3/4 DDoS Protection",
	}}
/>
