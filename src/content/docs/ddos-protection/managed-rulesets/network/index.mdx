...
description: Explore the main categories of Network-layer DDoS Attack Protection managed rules, including GRE, ESP, and advanced rules for effective threat mitigation.
sidebar:
  order: 4
head:
  - tag: title
