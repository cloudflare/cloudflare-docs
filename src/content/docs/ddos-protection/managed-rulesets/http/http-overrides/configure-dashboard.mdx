...
<Tabs syncKey="dashNewNav">
	<TabItem label="Old dashboard">
		<Steps>
			...
			select your account and website. 2. Go to **Security** > **DDoS**. 3. Next
			to **HTTP DDoS attack protection**, select **Deploy a DDoS override**.
		</Steps>
	</TabItem>
	<TabItem label="New dashboard" icon="rocket">
		<Steps>
			1. Log in to the [Cloudflare dashboard](https://dash.cloudflare.com/), and
			select your account and domain. 2. Go to **Security** > **Security rules**
			> **DDoS protection** tab. 3. On **HTTP DDoS attack protection**, select
			**Create override**.
		</Steps>
	</TabItem>
</Tabs>
