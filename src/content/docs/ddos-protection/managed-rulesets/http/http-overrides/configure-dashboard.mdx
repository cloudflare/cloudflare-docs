...
<Render
	...
	params={{
		selectAccountOrDomain: "select your account and domain",
		dashButtonUrl: "/?to=/:account/:zone/security/security-rules",
		newDashPage: "Security rules",
		newDashTab: "DDoS protection",
		oldDashNav: "Security > DDoS",
	}}
/>
