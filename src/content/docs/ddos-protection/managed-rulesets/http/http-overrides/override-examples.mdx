...
- If you are a Magic Transit customer, [use Cloudflare Network Firewall rules](/cloudflare-one/traffic-policies/policy-types/packet-filtering/add-policies/) to help mitigate the attack.
