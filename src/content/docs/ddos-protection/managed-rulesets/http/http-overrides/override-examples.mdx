...
import { Details, GlossaryTooltip, Steps } from "~/components";
...
- If you are a Magic Transit customer, [use Cloudflare Network Firewall rules](/cloudflare-one/traffic-controls/packet-filtering/add-policies/) to help mitigate the attack.
