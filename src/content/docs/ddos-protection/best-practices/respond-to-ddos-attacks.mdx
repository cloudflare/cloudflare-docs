...
1. Make sure all [DDoS managed rulesets](/ddos-protection/managed-rulesets/) are set to default settings (*High* sensitivity level and mitigation actions) for optimal DDoS activation.
