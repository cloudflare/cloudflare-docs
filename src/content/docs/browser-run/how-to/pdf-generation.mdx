...
As seen in the [Deploy a Browser Run Worker](/browser-run/how-to/deploy-worker/) guide, Browser Run can be used to generate screenshots for any given URL. Alongside screenshots, you can also generate full PDF documents for a given webpage, and can also provide the webpage markup and style ourselves.

You can generate PDFs with Browser Run in two ways:

- **[Quick Actions](/browser-run/quick-actions/)**: Use the [/pdf endpoint](/browser-run/quick-actions/pdf-endpoint/). This is ideal if you do not need to customize rendering behavior.
- **[Puppeteer](/browser-run/puppeteer/) or [Playwright](/browser-run/playwright/)**: Use browser automation within Workers for additional control and customization.

Choose the method that best fits your use case.

The following example shows you how to generate a PDF using [Puppeteer](/browser-run/puppeteer/).
...
<PackageManagers type="exec" pkg="wrangler" args="dev" cfCommand="cf dev" />
...
![A screenshot of a generated PDF, with the author's name shown in a mock certificate.](~/assets/images/browser-run/pdf-generation.png).
...
For detailed instructions and examples, refer to [Use your own custom font](/browser-run/features/custom-fonts/).
