...
Cloudflare automatically attaches headers to every request made through Browser Run (formerly Browser Rendering). These headers make it easy for destination servers to identify that these requests came from Cloudflare.
