...
description: Capture multiple representations of a webpage in a single Browser Run /snapshot request, including HTML content, screenshots, Markdown, and the accessibility tree.
sidebar:
  order: 6
products:
  - browser-run
