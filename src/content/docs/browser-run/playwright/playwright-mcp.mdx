...
2. Make sure you have the [Browser Run](/browser-run/) and [Durable Object](/durable-objects/) bindings and [migrations](/durable-objects/reference/durable-objects-migrations/) in your Wrangler configuration file.
...
![Screenshot of the AI Playground](~/assets/images/browser-rendering/playground-ai-screenshot.png)
...
Check our [GitHub page](https://github.com/cloudflare/playwright-mcp) for more examples and MCP client configuration options, and refer to the developer documentation on how to [build Agents on Cloudflare](/agents/).
