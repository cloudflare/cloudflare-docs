...
<CURL
	url="https://api.cloudflare.com/client/v4/accounts/ACCOUNT_ID/browser-run/devtools/browser/SESSION_ID/json/new"
	method="PUT"
	headers={{
		Authorization: "Bearer {api_token}",
	}}
...
<CURL
	url="https://api.cloudflare.com/client/v4/accounts/ACCOUNT_ID/browser-run/devtools/browser/SESSION_ID"
	method="DELETE"
	headers={{
		Authorization: "Bearer {api_token}",
	}}
