...
3. Use the /ask endpoint on your custom domain to power the search (for example, https://ask.example.com/ask)

This lets you serve conversational AI search directly from your own domain, with full control over how people and agents access your content.
