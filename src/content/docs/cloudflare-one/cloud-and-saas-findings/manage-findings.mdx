...
import { DashButton, TabItem, Tabs, Details } from "~/components";
...
1. In [Cloudflare dashboard](https://dash.cloudflare.com/), go to **Zero Trust** > **Cloud & SaaS findings** > **Posture Findings**.

   <DashButton url="/?to=/:account/cloud-saas-findings/overview" zeroTrust />
...
1. In [Cloudflare dashboard](https://dash.cloudflare.com/), go to **Zero Trust** > **Cloud & SaaS findings** > **Content Findings**.
...
After you configure one or more [CASB webhooks](/cloudflare-one/integrations/cloud-and-saas/webhooks/), you can send posture finding instances to external systems such as chat platforms, ticketing systems, SIEMs, SOAR tools, and custom automation services.
...
To validate a destination before sending a live finding instance, use **Test delivery** from the [Webhooks](/cloudflare-one/integrations/cloud-and-saas/webhooks/) page.
...
Ensure that you have [enabled HTTP filtering](/cloudflare-one/traffic-policies/get-started/http/) for your organization.
:::

To create a Gateway policy directly from a CASB finding:

1. In [Cloudflare dashboard](https://dash.cloudflare.com/), go to **Zero Trust** > **Cloud & SaaS findings** > **Posture Findings** or **Cloud & SaaS findings** > **Content Findings**.
