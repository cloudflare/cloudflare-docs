...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Cloud & SaaS findings** > **Posture Findings**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Cloud & SaaS findings** > **Content Findings**.
2. Choose **SaaS** or **Cloud**.
3. To view details about a finding, select the finding's name.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Cloud & SaaS findings** > **Integrations**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Cloud & SaaS findings** > **Posture Findings** or **Cloud & SaaS findings** > **Content Findings**.
2. Choose **SaaS** or **Cloud**.
