...
4. Open [Wrangler's configuration](/workers/wrangler/configuration) file in a text editor and insert the following:
...
2. Open [Wrangler's configuration](/workers/wrangler/configuration) file in a text editor and set the `debug` variable to `TRUE`.
