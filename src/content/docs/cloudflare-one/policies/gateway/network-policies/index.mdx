...
<Render file="gateway/selectors/destination-continent" params={{ one: "net.dst" }} />

### Destination Country

<Render file="gateway/selectors/destination-country" params={{ one: "net.dst" }} />
...
<Render file="gateway/selectors/source-internal-ip" params={{ one: "network", two: "net" }} />
...
<Render file="gateway/selectors/virtual-network" params={{ one: "net.vnet_id" }} />
