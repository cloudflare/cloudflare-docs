...
::::note[Cloudflare Tunnel version requirement]
If you're aiming to use Cloudflare Tunnel for source IP anchoring and DNS resolution, you must use `cloudflared` version 2025.7.0 or later.
::::
