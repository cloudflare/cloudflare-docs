...
Cloudflare does not and will not publish WARP egress IP ranges publicly. WARP egress IPs are not documented at [Cloudflare's IP Ranges](https://cloudflare.com/ips). To obtain an egress IP, contact your CSM.
