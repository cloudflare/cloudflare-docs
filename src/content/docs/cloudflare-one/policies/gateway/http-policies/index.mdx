...
The [approval status](/cloudflare-one/insights/analytics/shadow-it-discovery/#approval-status) of an application from [Shadow IT Discovery](/cloudflare-one/insights/analytics/shadow-it-discovery/) or the [Application Library](/cloudflare-one/applications/app-library/).

| UI name    | API example                          |
| ---------- | ------------------------------------ |
| App Status | `any(app.statuses[*] == "approved")` |
