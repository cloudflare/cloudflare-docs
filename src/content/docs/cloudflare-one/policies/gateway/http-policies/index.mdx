...
:::note
To use the Quarantine action, turn on [file sandboxing](/cloudflare-one/policies/gateway/http-policies/file-sandboxing/#get-started) in Zero Trust.
:::

API value: `quarantine`

For more information, refer to [File sandboxing](/cloudflare-one/policies/gateway/http-policies/file-sandboxing/).
