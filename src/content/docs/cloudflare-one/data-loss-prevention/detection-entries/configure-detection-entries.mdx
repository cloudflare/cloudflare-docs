...
DLP uses [Application Granular Controls](/cloudflare-one/traffic-policies/policy-types/http-policies/#granular-controls) to detect and categorize prompts submitted to generative AI tools. Application Granular Controls analyzes prompts for both content and user intent. Supported AI prompt protection detections include:
