...
- Turn on [Gateway HTTP filtering](/cloudflare-one/traffic-controls/get-started/http/).
- Turn on [TLS decryption](/cloudflare-one/traffic-controls/http-policies/tls-decryption/) for HTTPS traffic.
...
For uploaded or downloaded files, refer to the [supported file types](/cloudflare-one/data-loss-prevention/#supported-file-types). Traffic that bypasses Gateway or matches a [Do Not Inspect](/cloudflare-one/traffic-controls/http-policies/#do-not-inspect) policy cannot produce findings.
