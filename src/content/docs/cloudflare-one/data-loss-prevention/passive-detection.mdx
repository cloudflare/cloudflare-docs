...
- Make sure each detection entry you want to scan is enabled in at least one [DLP profile](/cloudflare-one/data-loss-prevention/dlp-profiles/) in your account. Passive Detection scans entries enabled in any profile in your account, not just profiles selected for a policy.
