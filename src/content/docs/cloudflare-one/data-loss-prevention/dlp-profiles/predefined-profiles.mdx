...
Credit card numbers begin with a six or eight-digit Issuer Identification Number (IN) and are followed by up to 23 additional digits. Card verification values (CVVs) are not validated.
