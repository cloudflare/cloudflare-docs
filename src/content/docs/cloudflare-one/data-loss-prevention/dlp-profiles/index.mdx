...
To decide which data types to focus on, use [Passive Detection](/cloudflare-one/data-loss-prevention/passive-detection/) to explore detections in sampled Gateway traffic before creating a DLP policy.
...
Before you apply a custom profile to production traffic, use [Test scan](/cloudflare-one/data-loss-prevention/test-scan/) to confirm that it detects the content you expect.
