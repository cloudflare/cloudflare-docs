...
- **Medium** — Requires more proximity keywords. Filters out Low confidence detections.
- **High** — Requires the most proximity keywords. Filters out Low and Medium confidence detections, and has a higher likelihood of accuracy.
