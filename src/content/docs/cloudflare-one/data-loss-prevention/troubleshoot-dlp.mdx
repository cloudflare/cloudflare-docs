...
- **Supported file types**: Content must be in a [supported file type](/cloudflare-one/data-loss-prevention/troubleshoot-dlp/#supported-file-types) for DLP inspection.
