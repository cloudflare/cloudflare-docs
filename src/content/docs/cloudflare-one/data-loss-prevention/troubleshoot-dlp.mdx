...
To check whether a profile detects specific content without sending traffic through Gateway, use [Test scan](/cloudflare-one/data-loss-prevention/test-scan/). This separates a detection problem from a policy or traffic problem.
