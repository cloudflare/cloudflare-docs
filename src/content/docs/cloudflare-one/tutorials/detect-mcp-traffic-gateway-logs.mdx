...
- [Gateway](/cloudflare-one/traffic-controls/) with HTTP filtering enabled and actively proxying user traffic
...
- [Gateway policies](/cloudflare-one/traffic-controls/)
