...
description: >-
  This tutorial covers how to secure access to your Microsoft 365 applications with Cloudflare Gateway dedicated egress IPs. Only available on Zero Trust Enterprise plans.
---
