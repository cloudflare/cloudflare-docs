...
- (Optional)[Resolver policies](/cloudflare-one/traffic-controls/resolver-policies/) enabled on your account
...
3. Create an expression to match against the private [domain](/cloudflare-one/traffic-controls/resolver-policies/#domain) or [hostname](/cloudflare-one/traffic-controls/resolver-policies/#host) of the application, like in the following example:
