...
6. Select **Create new policy** and build an [Access policy](/cloudflare-one/access-controls/policies/access/) using the _Azure AD - Auth context_ selector. For example:
