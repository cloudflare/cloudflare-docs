...
5. Select **Application permissions** and add `Policy.Read.ConditionalAccess`. **You must select Application permission, delegated permissions will not work for this feature.**
