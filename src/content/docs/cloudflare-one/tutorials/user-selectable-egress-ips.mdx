...
import { Details, TabItem, Tabs, APIRequest, DashButton } from "~/components";
...
- Received multiple [dedicated egress IP addresses](/cloudflare-one/traffic-policies/policy-types/egress-policies/dedicated-egress-ips/).
