...
- [Gateway HTTP filtering](/cloudflare-one/traffic-controls/get-started/http/) enabled on your devices
...
Finally, create a [Gateway HTTP policy](/cloudflare-one/traffic-controls/http-policies/) to isolate traffic for risky user groups.
