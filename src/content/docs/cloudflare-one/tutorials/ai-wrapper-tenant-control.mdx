...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Traffic policies** > **Firewall policies** > **HTTP**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Data loss prevention** > **Profiles**.
