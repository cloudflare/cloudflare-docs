...
8. Add [Access policies](/cloudflare-one/access-controls/policies/access/policy-management/) to control who can connect to your application.
...
For more information on isolating an Access application, refer to [Isolate self-hosted application](/cloudflare-one/access-controls/policies/access/isolate-application/).
