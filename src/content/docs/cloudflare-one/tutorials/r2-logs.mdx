...
1. In [Cloudflare dashboard](https://dash.cloudflare.com/), go to **Zero Trust** > **Insights** > **Logs**. Select **Manage Logpush**.

   <DashButton url="/?to=/:account/insights/logs" zeroTrust />
