...
6. Add [Access policies](/cloudflare-one/access-controls/policies/) to determine which users and applications may access your bucket. You can optionally create a [service token](/cloudflare-one/access-controls/service-credentials/service-tokens/) policy to automatically authenticate access to your S3 bucket.
...
- Cloudflare Zero Trust account with [dedicated egress IPs](/cloudflare-one/traffic-policies/egress-policies/dedicated-egress-ips/)
- S3 bucket to be protected by Cloudflare Zero Trust
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Traffic policies** > **Egress policies**. Select **Add a policy**.
