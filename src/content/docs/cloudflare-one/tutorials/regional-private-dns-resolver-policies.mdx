...
- A [Cloudflare Tunnel](/cloudflare-one/connections/connect-networks/) connecting your private DNS servers to Cloudflare
- Internal domains that need to be resolved (for example, `internal.example.com`)

## Connect private DNS servers with Cloudflare Tunnel
