...
Gateway will apply resolver policies based on [order of precedence](/cloudflare-one/traffic-policies/policy-types/resolver-policies/order-of-enforcement/#order-within-resolver-policies). Ensure your policies are ordered from most specific to least specific:
