...
Gateway will apply resolver policies based on [order of precedence](/cloudflare-one/traffic-controls/order-of-enforcement/#order-of-precedence). Ensure your policies are ordered from most specific to least specific:
...
- **Implement network policies**: Combine resolver policies with [network policies](/cloudflare-one/traffic-controls/network-policies/) to control access to internal resources based on user identity and device posture.
...
- [Resolver policies](/cloudflare-one/traffic-controls/resolver-policies/)
