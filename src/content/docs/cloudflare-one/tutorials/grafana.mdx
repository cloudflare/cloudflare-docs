...
description: >-
  Grafana is a dashboard tool that visualizes data stored in other databases. Grafana uses Prometheus as a data source to present metrics to the administrator. This tutorial covers how to create the metrics endpoint and set up the Prometheus server.
---
