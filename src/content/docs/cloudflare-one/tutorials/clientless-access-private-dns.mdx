...
- [Resolver policies](/cloudflare-one/traffic-controls/resolver-policies/) enabled on your account
...
3. Create an expression to match against the private [domain](/cloudflare-one/traffic-controls/resolver-policies/#domain) or [hostname](/cloudflare-one/traffic-controls/resolver-policies/#host) of the application:
...
2. Add a [network policy](/cloudflare-one/traffic-controls/network-policies/) that targets the private IP address of your application. You can optionally include any ports or protocols relevant for application access. For example,
