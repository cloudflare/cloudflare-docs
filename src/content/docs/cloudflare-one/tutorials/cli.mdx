...
description: >-
  Cloudflare's cloudflared command-line tool allows you to interact with endpoints protected by Cloudflare Access. This walkthrough uses the domain `example.com` as a stand-in for a protected API.
---
