...
- Build an [Access policy](/cloudflare-one/access-controls/policies/) that require users login with a hardware key
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to the **Access controls** > **Access settings**.
