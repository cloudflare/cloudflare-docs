...
In [Wrangler's configuration](/workers/wrangler/configuration) file, [set up a route](/workers/configuration/routing/routes/) that maps the Worker to your Access application domain:
