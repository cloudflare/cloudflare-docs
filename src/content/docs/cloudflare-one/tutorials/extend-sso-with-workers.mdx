...
- Enable the [Disk encryption](/cloudflare-one/reusable-components/posture-checks/client-checks/disk-encryption/) and [Firewall](/cloudflare-one/reusable-components/posture-checks/client-checks/firewall/) device posture checks.
