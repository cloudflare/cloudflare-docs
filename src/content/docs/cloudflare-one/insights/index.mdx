...
If your device is experiencing connectivity issues, Cloudflare recommends starting with [troubleshooting WARP](/cloudflare-one/team-and-resources/devices/warp/troubleshooting/troubleshooting-guide/) as WARP misconfiguration is the most common cause of connectivity issues.
