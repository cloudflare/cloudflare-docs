...
Access event analytics allows you to review login attempts to the applications you protect behind [Access](/cloudflare-one/access-controls/policies/access/). Access event analytics are powered by [Access audit logs](/cloudflare-one/insights/logs/audit-logs/).
...
Access Event Analytics aggregates authentication activity based on your [Access policies](/cloudflare-one/access-controls/policies/access/policy-management/).
