...
To learn which sensitive data types appear in your Gateway traffic before creating a DLP policy, use [Passive Detection](/cloudflare-one/data-loss-prevention/passive-detection/). It shows sampled detections separately from the policy activity on this dashboard.
