...
Your [Gateway network policies](/cloudflare-one/traffic-policies/network-policies/) power the Network session analytics dashboard. If you are not using Gateway network policies, the dashboard will appear empty.
