...
To view a detailed description of an HTTP request and its associated policy, go to **Logs** > **Gateway** > **HTTP** in [Zero Trust](https://one.dash.cloudflare.com/).
...
To view a detailed description of a DNS query and its associated policy, go to **Logs** > **Gateway** > **DNS** in [Zero Trust](https://one.dash.cloudflare.com/).
...
To view a detailed description of a network session and its associated policy, go to **Logs** > **Gateway** > **Network** in [Zero Trust](https://one.dash.cloudflare.com/).
