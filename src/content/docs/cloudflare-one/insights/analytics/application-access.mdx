...
The Application Access Report dashboard summarizes user login activity and Access policy usage across your organization. This dashboard helps administrators monitor authentication patterns, identity provider usage, and Access configuration metrics. If [Access](/cloudflare-one/policies/access/) is not configured in your account, the dashboard appears empty.
...
The Application Access Report dashboard is different from the [Access event analytics](/cloudflare-one/insights/analytics/access/) because 
