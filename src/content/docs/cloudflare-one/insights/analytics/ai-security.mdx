...
* [Cloudflare Gateway](/cloudflare-one/policies/gateway/) enabled to inspect outbound HTTP and DNS traffic.
* AI apps?
...
Shows the total number of AI applications identified and their review statuses.  
Statuses include:
...
This view helps administrators understand whether sensitive data is being sent to unapproved or unreviewed AI applications.
...
Shows the number of login attempts to MCP servers protected by Access.  
You can use this panel to review login activity to your MCP servers.
