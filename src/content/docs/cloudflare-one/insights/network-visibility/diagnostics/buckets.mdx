...
1. In the [Cloudflare dashboard](https://dash.cloudflare.com/), go to **Zero Trust** > **Insights** > *Network visibility** > **Diagnostics**.
...
To learn how to collect packet captures, refer to [Collect packet captures](/cloudflare-network-firewall/packet-captures/collect-pcaps/).
