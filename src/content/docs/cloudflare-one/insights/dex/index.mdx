...
- Verify that a website routed through [Gateway](/cloudflare-one/traffic-controls/) is reachable from user devices.
...
For help resolving common issues with Digital Experience Monitoring, refer to [Troubleshoot Digital Experience Monitoring](/cloudflare-one/insights/dex/troubleshooting/).
