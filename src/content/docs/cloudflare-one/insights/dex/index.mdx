...
DEX is fully compatible with Cloudflare's [Customer Metadata Boundary](/data-localization/metadata-boundary/) which ensures that customer logs will stay in the region \('EU' or 'US'\) the customer selects.
