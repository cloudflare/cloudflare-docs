...
- Objectively measure network performance with the Cloudflare One client enabled.
...
| Web chat / RTC  | Rates the connection quality for real-time communication applications such as video calls and VoIP. |
