...
| ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| **User email**               | For specifying [user emails](/cloudflare-one/traffic-policies/identity-selectors/#user-email).                                    |
| **User group emails**        | For specifying [group emails](/cloudflare-one/traffic-policies/identity-selectors/#user-group-email).                             |
| **User group IDs**           | For specifying [group IDs](/cloudflare-one/traffic-policies/identity-selectors/#user-group-ids).                                  |
| **User group names**         | For specifying a [group name](/cloudflare-one/traffic-policies/identity-selectors/#user-group-names).                             |
