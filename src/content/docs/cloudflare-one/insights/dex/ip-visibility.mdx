...
2. Select **My team** > **Devices**.
3. Select a device > **View details** > under **Details**, scroll down to **IP details**.
...
2. Select **My team** > **Devices**.
3. Select a device > **View details** > under **Details**, scroll down to **IP details**.
4. Select **View device history**.
5. View the device's IP history and status from the last seven days.
6. Select a time to view more information about the device at that time.
