...
The log data for all [DEX application tests](/logs/logpush/logpush-job/datasets/account/dex_application_tests/) can be exported to R2, a cloud bucket, or a SIEM via [Logpush](/cloudflare-one/insights/logs/logpush/). 
