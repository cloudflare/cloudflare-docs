...
The Cloudflare Logs documentation lists the full set of data fields available in [DEX application tests](/logs/logpush/logpush-job/datasets/account/dex_application_tests/) which includes traceroute test results.
