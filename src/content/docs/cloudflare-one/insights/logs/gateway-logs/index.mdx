...
| **CNAMEs**            | `CNAME` record in the query (if any).                                                                                                                                                                                                                                                                                                                                                                  |
...
| **Matched indicator feed names**    | Name of the indicator feeds that matched a Gateway policy (if any).                                   |
| **Query indicator feed names**      | Name of the indicator feeds that a matched domain or IP belongs to (if any).                          |
...
| Field                           | Description |
| ------------------------------- | ----------- |
| **Resolved CNAME categories**   |             |
| **Resolved IP categories**      |             |
| **Resolved IPs**                |             |
