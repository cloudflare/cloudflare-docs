...
| [WARP Config Changes](/logs/logpush/logpush-job/datasets/account/warp_config_changes/)                     | Configuration changes made to [WARP client settings](/cloudflare-one/team-and-resources/devices/warp/configure-warp/warp-settings/) |
