...
To view SSH command logs, log in to [Cloudflare One](https://dash.cloudflare.com/one/) and go to **Insights** > **Logs** > **SSH command logs**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Insights** > **Logs** > **SSH command logs**.
