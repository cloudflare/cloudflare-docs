...
To view SSH command logs, log in to [Cloudflare dashboard](https://dash.cloudflare.com/) and go to **Zero Trust** > **Insights** > **Logs** > **SSH command logs**.
...
1. In [Cloudflare dashboard](https://dash.cloudflare.com/), go to **Zero Trust** > **Insights** > **Logs** > **SSH command logs**.

   <DashButton url="/?to=/:account/insights/logs/ssh" zeroTrust />
