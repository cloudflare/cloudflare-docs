...
- **Filter by field** - Select any field value to add it as a filter.
- **Customize columns** - Choose which fields to display in the log table. Querying for fewer fields improves log loading performance.
