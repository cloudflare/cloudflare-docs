...
<Render file="access/enable-scim-on-dashboard" params={{ one: "Enable SCIM and Support groups"}} />
...
If building a Gateway policy, choose the [*User Group Names*](/cloudflare-one/policies/gateway/identity-selectors/#user-group-names) selector.
