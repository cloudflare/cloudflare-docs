...
| EID last seen | Elapsed time since the device was last seen, based on its `datetime` attribute. | Less than 1 hour, 3 hours, 6 hours, 12 hours, 24 hours, 7 days, 30 days, or more than 30 days |
