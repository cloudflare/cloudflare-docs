...
6. Enter the domain you want to check for, such as `example.com`. **NOTE:** The domain field is capitalization sensitive (IE if your domain is example.com, entering Example.com will fail the posture check)
7. Select **Save**.
