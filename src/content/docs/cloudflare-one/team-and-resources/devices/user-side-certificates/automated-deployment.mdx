...
6. (Optional) If the device is running macOS Big Sure or newer, [manually trust the certificate](#manually-trust-the-certificate).
...
macOS Big Sure and newer do not allow the Cloudflare One Client to automatically trust the certificate. To manually trust the certificate:
