...
Alternatively, you can download and install a certificate [using the Cloudflare One Client](/cloudflare-one/team-and-resources/devices/user-side-certificates/automated-deployment/#install-a-certificate-using-warp). the Cloudflare One Client will add the certificates to the device's system certificate store in `installed_certs/<certificate_id>.pem`.
...
<Tabs>
<TabItem label="Debian-based" icon="seti:debian">
...
<TabItem label="Red Hat-based" icon="seti:redhat">
...
<TabItem label="NixOS" icon="seti:nix">
...
<TabItem label="Linux" icon="seti:linux">
