...
2.  Use the [`auto_connect`](/cloudflare-one/team-and-resources/devices/warp/deployment/mdm-deployment/parameters/#auto_connect) and [`switch_locked`](/cloudflare-one/connections/connect-devices/warp/deployment/mdm-deployment/parameters/#switch_locked) parameters in the managed configuration for seamless connectivity.
