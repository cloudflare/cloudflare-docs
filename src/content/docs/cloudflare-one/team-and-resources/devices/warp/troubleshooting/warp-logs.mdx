...
| `alternate-networks-check.txt`                                                                      | Connectivity status for each [managed network](/cloudflare-one/team-and-resources/devices/warp/configure-warp/managed-networks/).                                                                                                                                                                                                                      |
...
| `connectivity.txt`                                                                                  | DNS resolution and HTTP trace requests to [validate a successful connection](/cloudflare-one/team-and-resources/devices/warp/deployment/firewall/#connectivity-checks). Can be used to determine whether traffic is routing through the WARP tunnel.                                                                                                   |
...
| `dns-check.txt`                                                                                     | Verifies that the Cloudflare One Client DNS servers are set as system default. For [operating modes](/cloudflare-one/team-and-resources/devices/warp/configure-warp/warp-modes/) where DNS filtering is enabled, this file contains the IPs of the local DNS proxy (`127.0.2.2:0`, `127.0.2.3:0`, `[fd01:db8:1111::2]:0`, and `[fd01:db8:1111::3]:0`). |
...
| `firewall-rules.txt`                                                                                | The [system firewall rules](/cloudflare-one/team-and-resources/devices/warp/configure-warp/route-traffic/warp-architecture/#system-firewall) configured by the Cloudflare One Client.                                                                                                                                                                  |
...
| `local_policy.redacted.txt`<br/> `mdm.plist` <br/> `mdm.xml`                                        | [Managed deployment parameters](/cloudflare-one/team-and-resources/devices/warp/deployment/mdm-deployment/parameters/) on the device.                                                                                                                                                                                                                  |
...
| `traceroute.txt`                                                                                    | Traceroute to the [WARP ingress IPs](/cloudflare-one/team-and-resources/devices/warp/deployment/firewall/#warp-ingress-ip) showing the path from the device to Cloudflare's global network.                                                                                                                                                            |
...
| `version.txt`                                                                                       | [Cloudflare One Client version](/cloudflare-one/team-and-resources/devices/warp/download-warp/) installed on the device.                                                                                                                                                                                                                               |
...
| `warp-settings.txt`                                                                                 | [Cloudflare One Client settings](/cloudflare-one/team-and-resources/devices/warp/configure-warp/warp-settings/) applied to the device.                                                                                                                                                                                                                 |
