...
The device is not authenticated to a [Zero Trust organization](/cloudflare-one/setup/#create-a-zero-trust-organization) because:
...
Your device was unenrolled from your company's [Cloudflare One organization](/cloudflare-one/setup/#create-a-zero-trust-organization) by an administrator on your account.
