...
2. Alternatively, switch WARP to [Traffic only mode](/cloudflare-one/team-and-resources/devices/warp/configure-warp/warp-modes/#traffic-only-mode) mode.
...
The account administrator must turn off both of the following features:
	- [Disconnect WARP on all devices](/cloudflare-one/team-and-resources/devices/warp/configure-warp/warp-settings/#disconnect-warp-on-all-devices)
	- [Manage device connection using an external signal](/cloudflare-one/team-and-resources/devices/warp/configure-warp/warp-settings/#manage-device-connection-using-an-external-signal)
