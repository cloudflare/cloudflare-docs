...
The WARP client supports the current major version of macOS and the two previous major versions,specifically on devices with Apple silicon. Devices on a previous major version must have the latest minor update in order to be considered supported. This policy aligns with Apple's standard security update cycle, as well as the comparatively rapid release of new macOS versions compared to other desktop operating systems.

#### Supported macOS versions

As of December 2025, the following versions of macOS are supported:

| macOS version | Supported until |
| --- | --- |
| macOS&nbsp;26&nbsp;(Tahoe) | Release of 2028 macOS major version |
| macOS&nbsp;15&nbsp;(Sequoia) | Release of 2027 macOS major version |
| macOS&nbsp;14&nbsp;(Sonoma) | Release of 2026 macOS major version |
