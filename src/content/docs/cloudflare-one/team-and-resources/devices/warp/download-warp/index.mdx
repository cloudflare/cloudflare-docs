...
Cloudflare also offers an unstable [beta release track](/cloudflare-one/team-and-resources/devices/warp/download-warp/beta-releases/) with the latest features and improvements, and an [LTS release track](/cloudflare-one/team-and-resources/devices/warp/download-warp/lts-releases/) with extended support durations. For more information about WARP client support and end-of-life (EOL) policies, refer to the [Support lifecycle](/cloudflare-one/team-and-resources/devices/warp/download-warp/support-lifecycle/) page.
