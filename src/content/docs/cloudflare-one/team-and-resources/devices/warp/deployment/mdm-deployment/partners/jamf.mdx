...
- [Download the `Cloudflare_WARP.pkg` file](/cloudflare-one/team-and-resources/devices/warp/download-warp/#macos)

- [Create a `plist` file](/cloudflare-one/team-and-resources/devices/warp/deployment/mdm-deployment/#create-plist-file)
