...
To learn how the pre-login configuration works with [multi-user mode](/cloudflare-one/team-and-resources/devices/warp/deployment/mdm-deployment/windows-multiuser/), refer to the [Cloudflare One Client registration flowchart](/cloudflare-one/team-and-resources/devices/warp/deployment/mdm-deployment/windows-multiuser/#cloudflare-one-client-registration-logic).
