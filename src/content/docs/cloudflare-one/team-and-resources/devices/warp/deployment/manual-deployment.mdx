...
- [Set device enrollment permissions](/cloudflare-one/team-and-resources/devices/warp/deployment/device-enrollment/) to specify which users can connect.
...
7. If you did not configure the client to [auto-connect](/cloudflare-one/team-and-resources/devices/warp/configure-warp/warp-settings/#auto-connect), manually connect:
...
1.  [Download](/cloudflare-one/team-and-resources/devices/warp/download-warp/) and install the Cloudflare One Agent app.
...
4.  If you did not enable [auto-connect](/cloudflare-one/team-and-resources/devices/warp/configure-warp/warp-settings/#auto-connect), manually turn on the switch to **Connected**.
