...
### 2.1 Add Cloudflare One Agent app to Intune configuration
...
### 2.2 Configure Cloudflare One Agent app

1. In the [Microsoft Intune admin center](https://intune.microsoft.com), select **Apps** > **Manage apps** > **Configuration**.

2. Select **Create** > _Managed Apps_.

3. In **Basics**, input the necessary field(s) and give your policy a name like `Cloudflare One Agent` > select **Next**.

4. For the **Target policy to** field, select **Cloudflare One Agent** > select **Next**. It may take a while for your app to be available.
...
4. Select **Create** > _Managed Apps_.

5. In **Basics**, input the necessary field(s) and give your policy a name like `Cloudflare One Agent` > select **Next**.
