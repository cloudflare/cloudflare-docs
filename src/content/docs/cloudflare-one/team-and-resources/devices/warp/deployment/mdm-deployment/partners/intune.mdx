...
3. In **Basics**, input the necessary field(s) and give your policy a name like `Cloudflare One Agent`. Select _iOS/iPadOS_ for Platform and target the Cloudflare One Agent app. Select **Next**.
