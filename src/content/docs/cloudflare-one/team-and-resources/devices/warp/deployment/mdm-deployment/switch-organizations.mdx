...
2. The **Configuration** dropdown will show the organizations that the admin has configured for your device.
	<Details header="Version 2026.1 and earlier">
	In the WARP version 2026.1 and earlier, select the gear icon > **Switch configurations**.
	</Details>
