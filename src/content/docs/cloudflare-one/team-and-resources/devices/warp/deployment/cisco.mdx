...
| Cloudflare WARP | Cisco VPN | Compatibility |
|-----------------------------|-----------------------|---------------|
| Include IPs and domains | Split tunnel          | ✅ Supported |
| Exclude IPs and domains | Split tunnel          | ✅ Supported |
| Include IPs and domains | Full tunnel           | ✅ Supported |
| Exclude IPs and domains | Full tunnel           | ❌ Not supported |
