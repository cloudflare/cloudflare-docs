...
- **Unified security policies everywhere**: With the WARP client deployed in the Traffic and DNS mode mode, [Gateway policies](/cloudflare-one/traffic-policies/) are not location-dependent — they can be enforced anywhere.
