...
This mode enables our complete suite of [device security features](/cloudflare-one/team-and-resources/devices/warp/configure-warp/warp-modes/).
...
Create [device enrollment rules](/cloudflare-one/team-and-resources/devices/warp/deployment/device-enrollment/) to define which users in your organization should be able to connect devices to your organization's Cloudflare Zero Trust setup. As you create your rule, you will be asked to select which login method you would like users to authenticate with.
...
Choose one of the [different ways](/cloudflare-one/team-and-resources/devices/warp/deployment/) to deploy the Cloudflare One Client, depending on what works best for your organization.
