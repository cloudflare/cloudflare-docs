...
- [Global disconnection settings](#global-disconnection-settings) allow administrators to quickly  disconnect all devices during a security incident, compliance event, or disaster recovery scenario.
