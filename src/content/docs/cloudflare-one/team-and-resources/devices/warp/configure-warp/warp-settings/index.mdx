...
Allows administrators to disconnect WARP independently from any Cloudflare infrastructure. When `Enabled`, WARP clients will poll the configured HTTPS endpoint on regular intervals and disconnect when it receives a valid disconnect signal.
