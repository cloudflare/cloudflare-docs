...
You can then [delete the service token](/cloudflare-one/access-controls/service-credentials/service-tokens/), if desired. You cannot use this service token to create new registrations.
