...
If you plan to direct your users to manually download and configure the Cloudflare One Client (formerly WARP Client), users will need to connect the client to your organization's Cloudflare Zero Trust instance.
...
7. If you did not configure the client to [auto-connect](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/configure-cloudflare-one-client/cloudflare-one-client-settings/#auto-connect), manually turn on the Cloudflare One Client:
...
1.  [Download](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/download-cloudflare-one-client/) and install the Cloudflare One Agent app.
...
4.  If you did not enable [auto-connect](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/configure-cloudflare-one-client/cloudflare-one-client-settings/#auto-connect), manually turn on the switch to **Connected**.

The device is now protected by your organization's Zero Trust policies.

## Virtual machines

By default, virtual machines (VMs) are subject to the Cloudflare One Client settings of the host. If you want to deploy a separate instance of the client in a VM, you must configure the VM to operate in bridged networking mode.
