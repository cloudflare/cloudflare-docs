...
2. If you have enabled [TLS decryption](/cloudflare-one/traffic-policies/policy-types/http-policies/tls-decryption/), ensure that you have a [Do Not Inspect policy](/cloudflare-one/traffic-policies/get-started/http/) in place for the following applications:
...
2. [Download](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/download/#ios) the **Cloudflare One Agent** app.
...
If you do not wish to use the old 1.1.1.1 app for personal browsing, you may [uninstall](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/uninstall/#ios-and-android) it.
