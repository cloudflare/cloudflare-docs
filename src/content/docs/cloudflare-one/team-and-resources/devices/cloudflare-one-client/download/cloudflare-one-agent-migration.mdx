...
2. If you have enabled [TLS decryption](/cloudflare-one/traffic-policies/tls-decryption/), ensure that you have a [Do Not Inspect policy](/cloudflare-one/traffic-policies/get-started/http/) in place for the following applications:
