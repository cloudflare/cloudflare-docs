...
As of July 2026, only RHEL 8 has completed full compatibility testing for all functionality, which is now out of the Red Hat Full Support window. However, starting with Cloudflare One Client version 2026.3.846.0, RHEL 9 is supported for [Cloudflare Mesh](/cloudflare-one/networks/connectors/cloudflare-mesh/) functionality, and 2026.6.822.0 adds the same Cloudflare Mesh suport for RHEL 10.

This section will be updated as we add RHEL support to match Red Hat's support lifecycle.

| RHEL version | Supported until                                                        |
| ------------ | ---------------------------------------------------------------------- |
| RHEL&nbsp;10 | Cloduflare Mesh functionality supported. Full Cloudflare One Client functionality pending full testing. Once complete, will be supported until May 2030. |
| RHEL&nbsp;9  | Cloduflare Mesh functionality supported. Full Cloudflare One Client functionality pending full testing. Once complete, will be supported until May 2027. |
