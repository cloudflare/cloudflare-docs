...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Team & Resources** > **Devices**.
...
Alternatively, you can use [DEX remote captures](/cloudflare-one/insights/dex/remote-captures/) to collect client diagnostic logs. The device profile UUID is shown in your [detection report](/cloudflare-one/insights/dex/remote-captures/#diagnostics-analyzer-beta) under `Profile ID`.
