...
The Cloudflare One Client routes device traffic for all ports and protocols, and forwards DNS resolution to the [client DNS resolver](/cloudflare-one/traffic-controls/resolver-endpoints/dns-resolver-ips/).
