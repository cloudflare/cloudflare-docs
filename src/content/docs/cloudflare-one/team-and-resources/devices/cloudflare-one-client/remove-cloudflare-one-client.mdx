...
title: Remove Cloudflare One Client
sidebar:
  order: 16
---

The following procedures will uninstall the Cloudflare One Client (formerly WARP Client) from your device. If you used the Cloudflare One Client to deploy a root certificate, the certificate will also be removed.
...
4. Scroll to find the Cloudflare One Agent application and select **Uninstall**.
