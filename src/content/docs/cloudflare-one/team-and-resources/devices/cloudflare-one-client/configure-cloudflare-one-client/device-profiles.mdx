...
5. Configure [client settings](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/configure-cloudflare-one-client/cloudflare-one-client-settings/#device-settings) for these devices.
...
Apply a device profile based on the [OS version](/cloudflare-one/reusable-components/posture-checks/cloudflare-one-client-checks/os-version/#determine-the-os-version) of the device.
...
Apply a device profile based on the [managed network](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/configure-cloudflare-one-client/managed-networks/) that the device is connected to.
