...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Teams & Resources**.
2. Select **Users**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Access controls** > **Policies**.
