...
* **Multi-factor authentication**: If [independent MFA](/cloudflare-one/access-controls/policies/mfa-requirements) is enabled, this section shows the user's enrolled authenticators. Administrators can delete authenticators on behalf of users.
