...
To access the App Library in [Cloudflare One](https://dash.cloudflare.com/one/), go to **Team & Resources** > **Application library**. Each application card will list the number of hostnames associated with the application, the supported Cloudflare One product usage, and the [app type](/cloudflare-one/traffic-policies/application-app-types/#app-types).
...
The Shadow IT Discovery dashboard will provide more details for discovered applications. To access Shadow IT Discovery in [Cloudflare One](https://dash.cloudflare.com/one/), go to **Insights** > **Dashboards**, then select **Shadow IT: SaaS analytics** or **Shadow IT: Private Network analytics**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Team & Resources** > **Application library**
