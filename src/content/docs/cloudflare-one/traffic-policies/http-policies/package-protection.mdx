...
When Gateway detects a package download, the package metadata is included in the Gateway HTTP log. This data is available in [Gateway Activity Log](/cloudflare-one/insights/analytics/gateway-activity-log/) and through [Logpush](/logs/logpush/logpush-job/datasets/account/gateway_http/).
