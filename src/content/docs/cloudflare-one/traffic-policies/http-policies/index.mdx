...
The package registry ecosystem detected from the HTTP request URL. For more information, refer to [Package protection](/cloudflare-one/traffic-policies/http-policies/package-protection/).
