...
:::note
Only applies to traffic sent through the [WARP client](/cloudflare-one/team-and-resources/devices/warp/set-up-warp/#gateway-with-warp-default).
:::
...
<Render
	file="gateway/value"
	product="cloudflare-one"
	params={{ selector: "hostnames", selectorName: "Host", operator: "matches regex", value: ".*whispersystems.org|.*signal.org" }}
/>
