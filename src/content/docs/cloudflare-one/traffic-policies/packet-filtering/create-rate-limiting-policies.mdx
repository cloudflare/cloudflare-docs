...
:::note
For Advanced Cloudflare Network Firewall customers, rate limiting (beta) is available by request through the account team.
:::
...
3. Fill out the information for your new policy:
   - Select the **Field**: At the moment, you can only choose a [data center name](/cloudflare-network-firewall/reference/network-firewall-fields/).
