...
- **Packet filtering** inspects and filters unwanted traffic based on packet attributes. Packet filtering policies block threats regardless of user or session context. Traffic is matched in the order the configured rules.
...
To get started with specific Gateway filtering types, refer to the initial setup for [DNS](/cloudflare-one/traffic-policies/initial-setup/dns/), [Network](/cloudflare-one/traffic-policies/initial-setup/network/), and [HTTP](/cloudflare-one/traffic-policies/initial-setup/http/) policies.
...
Refer to the [DNS](/cloudflare-one/traffic-policies/dns-policies/), [Network](/cloudflare-one/traffic-policies/network-policies/), [HTTP](/cloudflare-one/traffic-policies/http-policies/), and [egress](/cloudflare-one/traffic-policies/egress-policies/) configuration pages to see the available filtering options within each policy builder.
