...
Gateway supports several policy types because network traffic can be inspected at different layers — from DNS queries up to full HTTP requests. Each policy type gives you control at a specific layer:
