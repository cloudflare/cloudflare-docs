...
If you are blocking a [security category](/cloudflare-one/traffic-policies/policy-types/dns-policies/#security-categories) or a [content category](/cloudflare-one/traffic-policies/policy-types/dns-policies/#content-categories), you can test that the policy is working by using the [test domain](#common-test-domains) associated with each category.
