...
- Enable [TLS decryption](/cloudflare-one/traffic-policies/tls-decryption/) to inspect HTTPS traffic.
- Create [Do Not Inspect](/cloudflare-one/traffic-policies/policy-types/http-policies/actions/#do-not-inspect) policies for applications that use certificate pinning.
