...
Before you start, make sure you are connected to a network that is associated with the [DNS location](/cloudflare-one/networks/resolvers-and-proxies/locations/) where the policy is applied.
...
If you [enabled EDNS client subnet](/cloudflare-one/networks/resolvers-and-proxies/locations/) for your DNS location, you can validate EDNS as follows:
