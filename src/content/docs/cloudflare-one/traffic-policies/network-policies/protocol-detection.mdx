...
Protocol detection only applies to devices connected to Cloudflare One via the WARP client in [Traffic and DNS mode](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/configure/modes/#traffic-and-dns-mode-default) mode.
