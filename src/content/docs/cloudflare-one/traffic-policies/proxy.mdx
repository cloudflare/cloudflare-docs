...
Gateway uses the [Happy Eyeballs algorithm](https://datatracker.ietf.org/doc/html/rfc6555) — which tries IPv6 and IPv4 connections simultaneously and uses whichever responds first — to proxy traffic in the following order:
