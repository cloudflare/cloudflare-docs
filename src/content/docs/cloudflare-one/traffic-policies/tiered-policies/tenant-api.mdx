...
:::caution
The Tenant API platform only supports [DNS policies](/cloudflare-one/traffic-policies/policy-types/dns-policies/). To apply HTTP, network, and resolver policies, use [Cloudflare Organizations](/cloudflare-one/traffic-policies/tiered-policies/organizations/) instead.
:::
