...
Only available for [Cloudflare Partners](https://www.cloudflare.com/partners/) on Enterprise plans. Cloudflare recommends users on Enterprise plans configure a [Cloudflare Organization](/fundamentals/organizations/) for use with [tiered policies](/cloudflare-one/traffic-policies/tiered-policies/). Tiered policies allows for additional configurations, logging options, and policy types.
...
For a more comprehensive solution with additional policy types, consider using [tiered policies](/cloudflare-one/traffic-policies/tiered-policies/) with Cloudflare Organizations.
