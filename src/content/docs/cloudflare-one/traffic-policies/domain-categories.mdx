...
To request changes to a domain's categorization, refer to [Change categorization](/threat-intelligence/investigate/change-categorization/). For more information on investigating potentially risky domains, refer to [Investigate threats](/threat-intelligence/investigate/investigate-threats/#domain).
