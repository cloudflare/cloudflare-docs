...
- [DNS policy selectors](/cloudflare-one/traffic-policies/policy-types/dns-policies/#selectors)
- [HTTP policy selectors](/cloudflare-one/traffic-policies/policy-types/http-policies/#selectors)
- [Network policy selectors](/cloudflare-one/traffic-policies/policy-types/network-policies/#selectors)
- [Egress policy selectors](/cloudflare-one/traffic-policies/policy-types/egress-policies/#selectors)
- [Resolver policy selectors](/cloudflare-one/traffic-policies/policy-types/resolver-policies/#selectors)
...
- [DNS policies](/cloudflare-one/traffic-policies/policy-types/dns-policies/)
- [HTTP policies](/cloudflare-one/traffic-policies/policy-types/http-policies/)
- [Network policies](/cloudflare-one/traffic-policies/policy-types/network-policies/)
