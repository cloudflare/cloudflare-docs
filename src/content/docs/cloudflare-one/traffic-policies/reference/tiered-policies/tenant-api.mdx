...
:::caution
The Tenant API platform only supports [DNS policies](/cloudflare-one/traffic-policies/policy-types/dns-policies/). To apply HTTP, network, and resolver policies, use [Cloudflare Organizations](/cloudflare-one/traffic-policies/reference/tiered-policies/organizations/) instead.
:::
...
To set up the Tenant API, refer to [Get started](/tenant/get-started/). Once you have provisioned and configured your customer's Cloudflare accounts, you can create [DNS policies](/cloudflare-one/traffic-policies/policy-types/dns-policies/).
