...
Gateway [evaluates Do Not Inspect policies first](/cloudflare-one/traffic-policies/policy-types/http-policies/order-of-enforcement/#do-not-inspect-precedence), regardless of their position in the policy list. Cloudflare recommends moving your Do Not Inspect policies to the top of the list to reduce confusion.
