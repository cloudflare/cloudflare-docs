...
You can now create [Quarantine HTTP policies](/cloudflare-one/traffic-policies/policy-types/http-policies/#quarantine) to determine what files to scan in the sandbox.
