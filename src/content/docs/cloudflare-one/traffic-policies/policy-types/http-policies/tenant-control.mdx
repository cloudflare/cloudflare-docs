...
Microsoft 365 tenant control requires two policies. When you order your policies, make sure they follow [HTTP policy order of enforcement](/cloudflare-one/traffic-policies/policy-types/http-policies/order-of-enforcement/).
