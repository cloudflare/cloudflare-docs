...
These rules are also available as [managed rules](/cloudflare-one/traffic-policies/policy-types/packet-filtering/enable-managed-rulesets/) that you can enable without manual configuration. The rules above are provided for reference and customization.
