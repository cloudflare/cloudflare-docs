...
- [Install the Cloudflare One Client](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/set-up/) on end-user devices.
- [Install the Cloudflare root certificate](/cloudflare-one/team-and-resources/devices/user-side-certificates/) on end-user devices.
...
3. Name the policy and specify the [Destination IP](/cloudflare-one/traffic-policies/policy-types/network-policies/selectors/#destination-ip) for your origin server.

   You can enter either a public or private IP. To use a private IP, refer to [Connect private networks](/cloudflare-one/networks/connectors/cloudflare-tunnel/private-net/cloudflared/).
