...
For information about how Gateway evaluates network policies, refer to [Network policy order of enforcement](/cloudflare-one/traffic-policies/policy-types/network-policies/order-of-enforcement/).
