...
For information about how Gateway evaluates DNS policies, refer to [DNS policy order of enforcement](/cloudflare-one/traffic-policies/policy-types/dns-policies/order-of-enforcement/).
