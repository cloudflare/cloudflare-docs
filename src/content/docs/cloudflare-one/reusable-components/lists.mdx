...
:::note
The lists described in this page are not the same as [custom lists](/waf/tools/lists/custom-lists/) defined at the account level. They support different data types and have different validation rules.
:::
