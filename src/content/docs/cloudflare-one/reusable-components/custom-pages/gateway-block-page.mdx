...
1. In [Cloudflare dashboard](https://dash.cloudflare.com/), go to **Zero Trust** > **Reusable components** > **Custom pages**.

   <DashButton url="/?to=/:account/reusable-components" zeroTrust />
...
For more information on fixing certificate issues, refer to [Troubleshooting](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/troubleshooting/common-issues/#browser-and-certificate-issues).
