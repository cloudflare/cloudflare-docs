...
To create an HTTP policy to redirect URLs, refer to the [Redirect action](/cloudflare-one/traffic-policies/policy-types/http-policies/actions/#redirect).
