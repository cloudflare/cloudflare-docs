...
The legacy Tanium integration cannot be used in [Gateway network policies](/cloudflare-one/traffic-controls/network-policies/#device-posture). Only [Access policies](/cloudflare-one/access-controls/policies/) are supported.
:::
