...
6. (Optional) Set the maximum number of days allowed since the last antivirus signature update. If a device exceeds this limit, it will fail the posture check.
7. Select **Save**.
