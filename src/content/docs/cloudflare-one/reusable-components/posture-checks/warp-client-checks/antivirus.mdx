...
2. List all installed antivirus products registered with Windows Security Center:
	...
	__RELPATH                : AntiVirusProduct.instanceGuid="{00000000-0000-0000-0000-000000000000}"
	__PROPERTY_COUNT         : 6
	__DERIVATION             : {}
	__SERVER                 : LOCALHOST
	__NAMESPACE              : ROOT\SecurityCenter2
	__PATH                   : \\LOCALHOST\ROOT\SecurityCenter2:AntiVirusProduct.instanceGuid="{00000000-0000-0000-0000-000000000000}"
