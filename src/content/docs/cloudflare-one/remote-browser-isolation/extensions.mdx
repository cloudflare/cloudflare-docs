...
Installing extensions requires Chrome Web Store isolation. Create an [HTTP policy](/cloudflare-one/traffic-policies/policy-types/http-policies/) to isolate the Chrome Web Store (chromewebstore.google.com).
