...
Installing extensions requires Chrome Web Store isolation. Create an [HTTP policy](/cloudflare-one/traffic-controls/http-policies/) to isolate the Chrome Web Store (chromewebstore.google.com).
