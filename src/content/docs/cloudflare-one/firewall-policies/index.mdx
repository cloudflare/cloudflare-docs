...
To get started with specific Gateway filtering types, refer to the initial setup for [DNS](/cloudflare-one/firewall-policies/initial-setup/dns/), [Network](/cloudflare-one/firewall-policies/initial-setup/network/), and [HTTP](/cloudflare-one/firewall-policies/initial-setup/http/) policies.
...
Refer to the [DNS](/cloudflare-one/firewall-policies/dns-policies/), [network](/cloudflare-one/firewall-policies/network-policies/), [HTTP](/cloudflare-one/firewall-policies/http-policies/), and [egress](/cloudflare-one/firewall-policies/egress-policies/) configuration pages to see the available filtering options within each policy builder.
