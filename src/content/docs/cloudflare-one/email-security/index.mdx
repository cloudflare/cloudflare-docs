...
- A series of recommendations. For example, you may be recommended to learn how to submit emails for [reclassification](/cloudflare-one/email-security/email-monitoring/search-email/#reclassify-messages), [create policies]((/cloudflare-one/email-security/detection-settings/)), or learn how to manage your [impersonation registry](/cloudflare-one/email-security/detection-settings/impersonation-registry/).
