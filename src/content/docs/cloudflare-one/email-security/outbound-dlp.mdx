...
:::caution
The Cloudflare add-in can take up to 24 hours to propagate after install or uninstall. To avoid issues, do not install or uninstall the add-in during propagation.
:::
