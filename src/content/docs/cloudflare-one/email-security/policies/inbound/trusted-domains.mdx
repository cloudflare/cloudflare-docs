...
- Go to **Policies & rules** > **Inbound** > **Trusted domains**.
...
- **Upload trusted domain list**: You can upload a file no larger than 150 KB of multiple trusted domains. The file can only contain `Domain`, `Proximity`, `New`, `Is Regex`, and `Notes` fields. The first row must be a header row. Refer to [CSV uploads](#csv-uploads) for an example file.

6. Select **Save**.

### CSV uploads

You can upload a file no larger than 150 KB of multiple trusted domains. The file can only contain `Domain`, `Proximity`, `New`, `Is Regex`, and `Notes` fields. The first row must be a header row.

An example file would look like this:

```txt
Domain, Proximity, New, Is Regex, Notes
mydomain.com, true, true, false, First Person
testdomain.com, false, true, false, New Hire
```
...
1. On the **Trusted domains** page, select **Domain**. Selecting **Domain** will select all trusted domains.
2. Select **Export to CSV**.

To export specific trusted domains:

1. On the **Trusted domains** page, select the trusted domains you want to export.
2. Select **Export to CSV**.
...
1. On the **Trusted domains** page, select the trusted domains you want to edit.
...
1. On the **Trusted domains** page, select the trusted domain you want to delete.
2. Select the three dots > **Delete**.
3. On the pop up message, select **Delete**.

To delete multiple trusted domains at once:

1. On the **Trusted domains** page, select the trusted domains you want to delete.
2. Select **Action**.
3. Select **Delete**.
