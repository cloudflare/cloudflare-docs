...
:::note
[PhishGuard](src/content/docs/cloudflare-one/email-security/phishguard.mdx) customers can have submissions analyzed when submitting at either user or team level. Any non-PhishGuard customer can still have submissions analyzed by submitting at team level.
:::
