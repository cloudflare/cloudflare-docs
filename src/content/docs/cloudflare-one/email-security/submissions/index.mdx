...
3. Choose from the following submission types:
   - [**Team submissions**](/cloudflare-one/email-security/reclassifications/team-submissions/): View emails your security team submitted for submissions.
   - [**User submissions**](/cloudflare-one/email-security/reclassifications/user-submissions/): View emails your users submitted for submissions.
