...
2. **Modify default scanning (optional)**: You can configure which folder Email Security can scan.
2. (**Optional**, select **Skip for now** to skip this step) **Redirect messages**: Refer to [Auto-moves](/cloudflare-one/email-security/auto-moves/) to learn what auto-moves are, and how to configure auto-moves.
