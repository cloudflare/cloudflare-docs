...
![With API deployment, messages travel through Email security's email filter after reaching your users.](~/assets/email-security/M365_API_Deployment_Graph.png)
