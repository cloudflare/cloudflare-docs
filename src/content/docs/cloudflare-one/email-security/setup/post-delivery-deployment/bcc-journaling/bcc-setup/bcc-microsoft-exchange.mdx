...
![Email flow when setting up a phishing assessment risk for Microsoft Exchange with Email security.](~/assets/email-security/Microsoft_Exchange_365.png)

:::note[Auto-moves for Microsoft Exchange customers]
