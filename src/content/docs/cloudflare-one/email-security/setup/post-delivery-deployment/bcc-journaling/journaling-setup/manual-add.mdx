...
4. Once you completed the steps to enable the integration, select **Continue to Email Security**. You will be redirected to the **Domain management** page, where you will connect the integration to your specified domain.
