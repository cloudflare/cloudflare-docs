...
On the [Cloudflare One dashboard](https://dash.cloudflare.com/one/), upload the `.json` file downloaded on step 3.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Integrations**.
