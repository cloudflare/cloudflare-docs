...
The following tables compares features available across API, BCC/Journaling and MX/Inline:
...
[^1] With inline, we recommend setting up the integrations to allow post-delivery response and phish submission response to work. Refer to step 7 in [Auto-moves](/cloudflare-one/email-security/auto-moves/) to learn more.
