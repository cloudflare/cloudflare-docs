...
:::caution
If you currently do not have text add-ons enabled, configuring text add-ons will add a banner to the subject line, causing the subject line to be reduced.
:::
