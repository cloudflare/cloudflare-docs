...
Use Retro Scan to identify security threats that your current email provider may have missed. Cloudflare will analyze up to 14 days of historical emails in your Microsoft 365 inbox and provide a detailed report of malicious messages that may require remediation. You will receive an email notification once your report is ready.
...
4. Enable your [Microsoft integration](/cloudflare-one/email-security/setup/post-delivery-deployment/api/m365-api/#enable-microsoft-integration). Once you enabled your Microsoft integration, you will redirected to a page where you will add your domains and specify your current email security system.
