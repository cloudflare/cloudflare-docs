...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Email security**, and select **Investigation**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Email security** > **Investigation**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Settings** > **Resources**.
