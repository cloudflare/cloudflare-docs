...
1. Get the customized manifest URL from [Cloudflare One](https://dash.cloudflare.com/?to=/:account/one/email-security/settings/email-policy/phish-submission?tab=phish-submission).
