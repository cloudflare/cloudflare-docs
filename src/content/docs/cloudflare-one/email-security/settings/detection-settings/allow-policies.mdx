...
import { DashButton, Example, Details } from "~/components";
...
2. Go to **Detection settings** > **Allow policies**.
3. On the **Detection settings** page, select **Add a policy**.
4. On the **Add an allow policy** page, enter the policy information:
