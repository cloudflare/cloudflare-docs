...
2. Go to **Detection settings** > **Trusted domains**.
3. On the **Detection settings** page, select **Add a domain**.
4. Select the **Input method**: Choose between **Manual input**, and **Upload trusted domain list**:
   - **Manual input**:
