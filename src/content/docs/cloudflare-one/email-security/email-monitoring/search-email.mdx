...
- [Download files](/cloudflare-one/policies/browser-isolation/isolation-policies/#file-downloads)
- [Uploads files](/cloudflare-one/policies/browser-isolation/isolation-policies/#file-uploads)
