...
:::note
If you purchased [Gateway](/cloudflare-one/policies/gateway/) and [Browser Isolation](/cloudflare-one/policies/browser-isolation/), use these to use open files as more customizable. 

Email Security cannot access Browser Isolation's **Clipboard**, **Device Interaction**, and **File Access** policy settings on the Cloudflare dashboard.
:::
