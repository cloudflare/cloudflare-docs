...
:::note
If you purchased [Gateway](/cloudflare-one/policies/gateway/) and [Browser Isolation](/cloudflare-one/policies/browser-isolation/), you can perform more actions when opening links.

When opening links, Email Security will not allow you to:

- [Copy (from remote to client)](/cloudflare-one/policies/browser-isolation/isolation-policies/#copy-from-remote-to-client)
- [Paste (from client to remote)](/cloudflare-one/policies/browser-isolation/isolation-policies/#paste-from-client-to-remote)
- Use [keyboard](/cloudflare-one/policies/browser-isolation/isolation-policies/#keyboard)
- Perform [printing](/cloudflare-one/policies/browser-isolation/isolation-policies/#printing)
- Perform [file downloads](/cloudflare-one/policies/browser-isolation/isolation-policies/#file-downloads)
- Perform [file uploads](/cloudflare-one/policies/browser-isolation/isolation-policies/#file-uploads)
