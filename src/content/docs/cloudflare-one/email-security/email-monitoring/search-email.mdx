...
- A submission has been made without a .EML attachment.
- Email Security does not protect the domain you are submitting emails from. 
...
- Ensure the file attached has a .EML file extension.
- Ensure your domain is recognized by Email Security.
