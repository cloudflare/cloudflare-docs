...
User submissions are the emails your users submitted for reclassification. User submissions displays emails users reported as [phish](/cloudflare-one/email-security/phish-submissions/). User submissions help enhance our detection model, but can be escalated for human review.
