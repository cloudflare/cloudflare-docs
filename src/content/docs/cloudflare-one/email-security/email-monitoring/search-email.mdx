...
:::note
[PhishGuard](/cloudflare-one/email-security/phish-guard/) customers can have submissions analyzed when submitting at either user to team level. Any non PhishGuard customer can still have submissions analyzed by submitting at team level.
:::
