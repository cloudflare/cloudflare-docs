...
You can filter based on **Date Range** and **Submitted by** (which will list emails that made the invalid submissions). Select **Apply filters** once you have applied your filters.
