...
2. Select **Export messages** on the pop-up message. You can only export up to 500 rows from the dashboard. To export all matching messages, use the [API](/api/resources/email_security/subresources/investigate/methods/get/).
