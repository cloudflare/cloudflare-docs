...
:::note
Package registry security requires [TLS decryption](/cloudflare-one/traffic-controls/http-policies/tls-decryption/) to be turned on for the traffic you want to inspect.
:::
...
The following selectors are available for [HTTP policies](/cloudflare-one/traffic-controls/http-policies/) with the Allow and Block actions:
...
- Package detection requires [TLS decryption](/cloudflare-one/traffic-controls/http-policies/tls-decryption/) to be turned on. Packages downloaded over connections that bypass TLS inspection (due to Do Not Inspect policies or applications on the [inspection limitations list](/cloudflare-one/traffic-controls/http-policies/tls-decryption/#inspection-limitations)) are not detected.
