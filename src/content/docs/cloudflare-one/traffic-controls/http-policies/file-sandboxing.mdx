...
In addition to [anti-virus (AV) scanning](/cloudflare-one/traffic-controls/http-policies/antivirus-scanning/), Gateway can quarantine previously unseen files downloaded by your users into a sandbox and scan them for malware.
...
You can now create [Quarantine HTTP policies](/cloudflare-one/traffic-controls/http-policies/#quarantine) to determine what files to scan in the sandbox.
