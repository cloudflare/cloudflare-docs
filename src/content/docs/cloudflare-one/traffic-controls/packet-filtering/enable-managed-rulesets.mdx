...
In addition to enabling managed rulesets, you can also add and enable custom policies. Refer to [add policies](/cloudflare-one/traffic-controls/packet-filtering/add-policies/).
