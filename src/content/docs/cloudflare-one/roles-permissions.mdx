...
[^2]: Users with the **Cloudflare Zero Trust DNS Locations Write** role can view all DNS locations for an organization but can only create and edit [secure DNS locations](/cloudflare-one/traffic-controls/resolver-endpoints/#secure-dns-locations).
