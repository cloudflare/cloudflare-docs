...
:::note
If your domain uses a [partial (`CNAME`) setup](/dns/zone-setups/partial-setup/), refer to [Use Access with a partial CNAME setup](/cloudflare-one/access-controls/applications/http-apps/self-hosted-partial-cname/) for additional DNS configuration steps.
:::
