...
1. In a separate tab or window, open [Cloudflare One](https://dash.cloudflare.com/one/) and go to **Access controls** > **Applications**.
...
9. Configure [Access policies](/cloudflare-one/access-controls/policies/) for the application.
