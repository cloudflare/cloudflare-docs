...
2. In a separate tab or window, open [Cloudflare One](https://dash.cloudflare.com/one/), select your account, and go to **Access controls** > **Applications**.
...
6. To determine who can access Zendesk, [create an Access policy](/cloudflare-one/access-controls/policies/).
