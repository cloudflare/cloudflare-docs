...
- (Optional) Turn on [Gateway TLS decryption](/cloudflare-one/traffic-policies/tls-decryption/) if you want to use Access JWTs to manage [HTTPS application sessions](#https-applications).
...
10. (Optional) Go to the **Additional settings** tab to customize the application experience:
	...
	- The following settings only apply to private hostnames and require [Gateway TLS decryption](/cloudflare-one/traffic-policies/tls-decryption/):
