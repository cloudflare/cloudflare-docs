...
:::note
If you do not wish to use Access, refer instead to our [SSH proxy instructions](/cloudflare-one/traffic-policies/policy-types/network-policies/ssh-logging/).
:::
...
Your SSH server is now protected behind Cloudflare Access — users will be prompted to authenticate with your identity provider before they can connect. You can also enable SSH command logging by configuring a [Gateway Audit SSH policy](/cloudflare-one/traffic-policies/policy-types/network-policies/ssh-logging/).
