...
End users can connect to the SSH session without any configuration by using Cloudflare's browser-based terminal. To enable, refer to [Browser rendering](/cloudflare-one/access-controls/applications/non-http/browser-rendering/).
