...
1. **[Client session](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/configure/client-sessions/)** (if enabled) — Overrides all other durations. The user re-authenticates when this expires.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Access controls** > **Access settings**.
...
2. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Team & Resources** > **Users**.
