...
4. Under **Custom domain**, select a domain for the portal URL. You can choose a domain from an active zone in your account or a `pages.dev` domain associated with a Pages project. You can optionally specify a subdomain.
