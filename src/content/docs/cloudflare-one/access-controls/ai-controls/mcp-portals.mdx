...
Portal traffic will now appear in your [Gateway HTTP logs](/cloudflare-one/insights/logs/gateway-logs/#http-logs). To apply DLP scanning, [create a Gateway HTTP policy](#example-gateway-policy).
