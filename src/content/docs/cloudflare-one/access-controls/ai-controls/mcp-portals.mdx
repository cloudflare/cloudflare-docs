...
When users visit the portal domain in a browser, the portal displays a homepage with connection details and setup instructions. The homepage shows:
...
To end a portal session, select **Sign out** from the portal homepage session bar. The sign-out flow:
