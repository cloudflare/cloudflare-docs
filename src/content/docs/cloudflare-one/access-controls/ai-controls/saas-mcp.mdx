...
You can use the button below to quickly deploy our [example MCP server](https://github.com/cloudflare/ai/tree/main/demos/remote-mcp-cf-access) to your Cloudflare account:
...
This button will guide you through setting up a new git repository on your GitHub or GitLab account, configured to automatically deploy to Cloudflare each time you push a change or merge a pull request to the main branch of the repository.

Alternatively, you can use the command line as shown below to create the MCP server on your local machine.
