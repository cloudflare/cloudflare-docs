...
- No Access policy rule directly references the token.
...
1. In the [Cloudflare dashboard](https://dash.cloudflare.com/), go to **Zero Trust** > **Access controls** > **Access settings**.
   ...
   <DashButton url="/?to=/:account/access-controls/settings" zeroTrust />

2. Under **Clean up inactive service tokens**, turn on **Automatically clean up inactive service tokens**.
