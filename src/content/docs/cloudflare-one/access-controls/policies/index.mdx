...
:::note
The following selectors will only appear in the policy builder after you create the corresponding device posture check:
- **Warp** - Requires creating a [WARP posture check](/cloudflare-one/reusable-components/posture-checks/warp-client-checks/require-warp/)
- **Gateway** - Requires creating a [Gateway posture check](/cloudflare-one/reusable-components/posture-checks/warp-client-checks/require-gateway/)  
All other selectors are available by default.
:::
