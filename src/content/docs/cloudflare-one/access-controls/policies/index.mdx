...
| Authentication Method    | Checks the [multifactor authentication](/cloudflare-one/access-controls/policies/mfa-requirements/#enforce-idp-based-mfa) method used by the user, if supported by the identity provider. To enforce MFA independently of your IdP, refer to [independent MFA](/cloudflare-one/access-controls/policies/mfa-requirements/#enforce-independent-mfa). | ✅               | ❌                               | ✅                       |
