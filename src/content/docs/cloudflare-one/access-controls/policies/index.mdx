...
| User Risk Score          | The user's current [risk score](/cloudflare-one/team-and-resources/users/risk-score/) (Low, Medium, High, or Unscored). Matches only the values selected in the rule. This selector only displays for Enterprise plans.                                                                                                                   | ✅               | ✅                               | ✅                       |
