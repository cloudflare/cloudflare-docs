...
| Linked App Token |  Checks for a valid [token](/cloudflare-one/access-controls/applications/linked-app-token/) issued to a specific Access application (self-hosted or SaaS). Requires the [Service Auth](#service-auth) action.                                 | ✅               | ✅                               | ❌                       |
