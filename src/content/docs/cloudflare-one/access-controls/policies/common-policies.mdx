...
<APIRequest
	...
	json={{
		...
		require: [
			...
			{
				device_posture: {
					integration_uid: "<MINIMUM_OS_VERSION_CHECK_ID>",
				},
			},
			{
				device_posture: {
					integration_uid: "<DISK_ENCRYPTION_CHECK_ID>",
				},
			},
			{
				device_posture: {
					integration_uid: "<FIREWALL_CHECK_ID>",
				},
			},
		],
	}}
...
resource "cloudflare_zero_trust_access_policy" "require_device_posture" {
  ...
  require = [
    ...
    {
      device_posture = {
        integration_uid = cloudflare_zero_trust_device_posture_rule.minimum_os_version.id
      }
    },
    {
      device_posture = {
...
<APIRequest
	...
	json={{
		...
		require: [
			...
			{
				device_posture: {
					integration_uid: "<WINDOWS_FIREWALL_CHECK_ID>",
				},
			},
		],
...
resource "cloudflare_zero_trust_access_policy" "require_purpose_justification" {
  ...
  require = [
    ...
    {
      device_posture = {
        integration_uid = cloudflare_zero_trust_device_posture_rule.windows_firewall.id
      }
    },
  ]
}
