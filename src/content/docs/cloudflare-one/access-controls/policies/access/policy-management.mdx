...
4. Choose an [**Action**](/cloudflare-one/access-controls/policies/access/#actions) for the policy.
5. Choose a [**Session duration**](/cloudflare-one/identity/users/session-management/) for the policy.
6. Configure as many [**Rules**](/cloudflare-one/access-controls/policies/access/#rule-types) as needed.
7. (Optional) Configure additional settings for users who match this policy:
   - [Isolate application](/cloudflare-one/access-controls/policies/access/isolate-application/).
   - [Purpose justificaton](/cloudflare-one/access-controls/policies/access/require-purpose-justification/)
   - [Temporary authentication](/cloudflare-one/access-controls/policies/access/temporary-auth/)
8. Select **Save**.
