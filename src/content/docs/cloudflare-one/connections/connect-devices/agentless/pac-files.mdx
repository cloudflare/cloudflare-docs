...
If your firewall only allows config via domain, you will need to create a firewall rule to allow your proxy endpoint domain.
...
2. Copy the result in `subdomain`.
