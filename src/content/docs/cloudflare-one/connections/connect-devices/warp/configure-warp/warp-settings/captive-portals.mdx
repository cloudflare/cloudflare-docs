...
Captive portal logs are used by Cloudflare Support to troubleshoot WARP captive portal issues. When an end user reports an issue with a captive portal, you can ask the user to collect captive portal logs and then attach the logs to your support ticket.
