...
Each WARP log file (`daemon.log`, `boringtun.log`, `dns.log`, `dns-stats.log`, `warp-stats.log`) is limited by size and age:

- **Maximum file size:** 10 MB
- **Maximum file age:** 24 hours
- **Maximum number of retained versions per log:** 4
