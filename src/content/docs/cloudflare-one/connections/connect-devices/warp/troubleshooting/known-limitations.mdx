...
## Win10 in Microsoft 365 Cloud PC is not supported

Use of the WARP client in a Microsoft 365 Win10 Cloud PC is not supported. To work around this limitation, use Win11.
