...
User identifiers that are bound to Microsoft Entra ID domains must enter their username as AzureAD\user@example.com or as AzureAD\user. The AzureAD\ prefix is case-insensitive.
