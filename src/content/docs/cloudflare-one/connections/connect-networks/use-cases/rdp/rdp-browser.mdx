...
5. (Optional) In your browser settings, allow the Access application to access the clipboard. Clipboard permissions grant the ability to copy/paste text between the local machine and the remote Windows machine.
