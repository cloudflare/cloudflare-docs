...
5. For **Rule action**, select *Service Auth*.
...
8. To authenticate the WARP Connector to your Zero Trust organization:
   ...
   ```
      ...
      * Ensure that you have a [device enrollment rule](/cloudflare-one/connections/connect-networks/private-net/warp-connector/#2-add-a-device-enrollment-rule) with the *Service Auth* action (not *Allow*).
