...
{/_ Commenting out notes within tabs for now
...
:::
_/} 4. Configure your tunnels with the IP/CIDR range of your private networks, and assign the tunnels to their respective virtual networks.
...
:::
_/} 5. Verify that the IP routes are listed correctly:
