...
2. Find the **Block page**, **Customize App Launcher**, and **Login page** > select **Customize** next to the page you would like to review.
3. Review that the value in **Your Organization's name (Required)** matches your new team name.
4. If not matching, change the value to your desired team name and select **Save**.
5. Check all three pages (**Block page**, **App Launcher**, and **Login page**) to make sure the desired team name will be displayed.
