...
You can sign up today at [this link](https://dash.cloudflare.com/). Follow the onboarding steps, choose a team name and a payment plan, and start protecting your network in just a few minutes.
