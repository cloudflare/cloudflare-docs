...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Custom pages** > **Team name and domain**.
...
To make changes to your subscription, visit the Billing section under **Settings** in [Cloudflare One](https://dash.cloudflare.com/one/). You can change or cancel your subscription at any time. Just remember - if you downgrade your plan during a billing cycle, your downgraded pricing will apply in the next billing cycle. If you upgrade during a billing cycle, you will be billed for the upgraded plan at the moment you select it.
