...
5. Check both pages (**Block page** and **Login page**) to set **Your Organization's name (Required)** as your desired team name.

The App Launcher will display the same team name set on the Login page, so you do not need to update the **Your Organization's name (Required)** field in the App Launcher page.
