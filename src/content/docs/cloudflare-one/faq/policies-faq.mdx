...
As admin, you could define this geolocation policy by using [Include](/cloudflare-one/access-controls/policies/#include) rules, meaning the user could log in to the application from Country A or Country B.

Or you could define this geolocation policy using a [Require](/cloudflare-one/access-controls/policies/#require) rule, meaning the user must be in Country A to log in.
