...
For a complete walkthrough of using Access with a partial CNAME setup, refer to [Use Access with a partial CNAME setup](/cloudflare-one/access-controls/applications/http-apps/self-hosted-partial-cname/).
