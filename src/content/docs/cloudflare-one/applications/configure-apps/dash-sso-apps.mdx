...
7. In Zero Trust, go to **Settings** > **Authentication**.
8. Turn on **Cloudflare dashboard SSO** to re-enable SSO.
9. Ask your account team to create your new SSO domain.

Once your SSO domain is approved, a new **SSO App** application will appear under **Access** > **Applications**.
