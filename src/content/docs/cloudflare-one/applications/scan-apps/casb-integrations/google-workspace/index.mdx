...
<Render file="casb/integration-description" params={{ one: "Google Workspace", two: "Google Workspace account" }} />
...
<Render file="casb/security-findings" params={{ one: "Google Workspace", two: "google-workspace" }} />
