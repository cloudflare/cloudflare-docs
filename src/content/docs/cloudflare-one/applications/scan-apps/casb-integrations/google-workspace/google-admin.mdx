...
<Render file="casb/integration-description" params={{ one: "Google Admin", two: "Google Workspace account" }} />
...
<Render file="casb/security-findings" params={{ one: "Google Admin", two: "google-workspace/google-admin" }} />
