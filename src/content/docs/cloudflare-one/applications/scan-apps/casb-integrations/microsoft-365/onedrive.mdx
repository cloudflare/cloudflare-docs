...
<Render file="casb/integration-description" params={{ one: "OneDrive", two: "Microsoft 365 account" }} />
...
<Render file="casb/security-findings" params={{ one: "OneDrive", two: "microsoft-365/onedrive" }} />
