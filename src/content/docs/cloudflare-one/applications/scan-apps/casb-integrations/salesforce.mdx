...
<Render file="casb/integration-description" params={{ one: "Salesforce", two: "Salesforce environment" }} />
...
<Render file="casb/security-findings" params={{ one: "Salesforce", two: "salesforce" }} />
