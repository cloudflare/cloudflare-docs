...
<Render file="casb/integration-description" params={{ one: "ServiceNow", two: "ServiceNow instance" }} />
...
<Render file="casb/security-findings" params={{ one: "ServiceNow", two: "servicenow" }} />
