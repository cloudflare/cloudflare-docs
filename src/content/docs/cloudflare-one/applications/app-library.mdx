...
If you believe one of the Application confidence scores is incorrect or have additional evidence that should be considered in the scoring process, email app-confidence-scores@cloudflare.com. Include relevant documentation or evidence that supports your assessment to help us review and update the score accordingly.
