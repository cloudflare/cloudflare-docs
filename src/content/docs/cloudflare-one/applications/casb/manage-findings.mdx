...
Before you can remediate findings, [add a new integration](/cloudflare-one/applications/casb/#add-an-integration) and choose _Cloudflare One Read-Write Microsoft Policy_ during setup. Alternatively, you can update an existing integration:
