...
Additionally, to [remediate findings](/cloudflare-one/integrations/cloud-and-saas/manage-findings/#remediate-findings), CASB requires the following permissions:
