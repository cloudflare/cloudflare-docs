...
11. In Cloudflare One, go to **Integrations** > **Identity providers**.
...
To test that your connection is working, select **Test** next to the login method you want to test.
