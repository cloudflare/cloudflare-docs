...
To test that your connection is working, go to [Cloudflare One](https://dash.cloudflare.com/one/) > **Integrations** > **Identity providers** > select **Test** next to your LinkedIn login method.
