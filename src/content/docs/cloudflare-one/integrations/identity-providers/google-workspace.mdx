...
:::note
This configuration is not supported. Refer to [Set up Google Workspace as an identity provider](#set-up-google-workspace-as-an-identity-provider) for more information.
:::
