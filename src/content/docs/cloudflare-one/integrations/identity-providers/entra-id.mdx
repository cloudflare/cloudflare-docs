...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Integrations** > **Identity providers**.
...
4.  If you gave your email claim another name than `email`, you must update your configuration in Cloudflare One:
        ...
        a. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Integrations** > **Identity providers** > **Azure AD** > **Edit**.
...
To monitor the exchange of identity details between Cloudflare Access and Microsoft Entra ID, go to [Cloudflare One](https://dash.cloudflare.com/one/) > **Insights** > **Logs** > **SCIM provisioning logs** and view the [SCIM activity logs](/cloudflare-one/insights/logs/dashboard-logs/scim-logs/).
