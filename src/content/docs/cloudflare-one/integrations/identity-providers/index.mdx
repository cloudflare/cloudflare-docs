...
Adding an identity provider as a login method requires configuration both in [Cloudflare One](https://dash.cloudflare.com/one/) and with the identity provider itself. Consult our IdP-specific documentation to learn more about what you need to set up.
