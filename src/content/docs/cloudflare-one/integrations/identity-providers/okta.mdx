...
Please note that the Okta App Catalog template does not support syncronizing [Active Directory groups](https://help.okta.com/en-us/Content/Topics/Directory/ad-agent-import-groups.htm), if you would like to build policies using AD groups, please use the Okta Custom OIDC or SAML options.
