...
10. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Integrations** > **Identity providers**.
...
To test that your connection is working, go to [Cloudflare One](https://dash.cloudflare.com/one/) > **Integrations** > **Identity providers** and select **Test** next to your GitHub login method. If you have GitHub two-factor authentication enabled, you will need to first login to GitHub directly and return to Access.
