...
6. To fill in your Cloudflare Access metadata:
   ...
   where `<your-team-name>` is your Cloudflare Zero Trust <GlossaryTooltip term="team domain">team name</GlossaryTooltip>. 3. Select **Import**. 4. **Save** the configuration.
