...
You can now apply [DNS policies](/cloudflare-one/traffic-policies/policy-types/dns-policies/) to your location using the [Location selector](/cloudflare-one/traffic-policies/policy-types/dns-policies/#location).
