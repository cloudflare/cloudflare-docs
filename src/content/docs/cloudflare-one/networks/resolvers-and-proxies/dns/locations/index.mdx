...
You can now apply [DNS policies](/cloudflare-one/traffic-policies/policy-types/dns-policies/) to your location using the [Location selector](/cloudflare-one/traffic-policies/policy-types/dns-policies/selectors/#location).
...
- [Source network filtering](/cloudflare-one/traffic-policies/policy-types/network-policies/) is configured for your IPv4, IPv6, and DoT endpoints.
