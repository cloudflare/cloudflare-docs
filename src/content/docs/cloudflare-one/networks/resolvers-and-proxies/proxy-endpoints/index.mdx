...
Gateway [HTTP Isolate policies](/cloudflare-one/traffic-policies/policy-types/http-policies/actions/#isolate) are not supported with authorization endpoints.
