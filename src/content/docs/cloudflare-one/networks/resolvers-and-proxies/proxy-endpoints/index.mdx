...
You can now use the Proxy Endpoint selector in [network](/cloudflare-one/traffic-policies/policy-types/network-policies/selectors/#proxy-endpoint) and [HTTP](/cloudflare-one/traffic-policies/policy-types/http-policies/selectors/#proxy-endpoint) policies to filter traffic proxied via PAC files.
...
| **UDP traffic**                                                                     | —                  | —                      |
| **[HTTP3](/cloudflare-one/traffic-policies/tls-decryption/http3/)**                  | —                  | —                      |
