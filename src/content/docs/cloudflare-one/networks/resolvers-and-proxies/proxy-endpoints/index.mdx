...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Networks** > **Resolvers & Proxies**, then go to **Proxy endpoints**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Networks** > **Resolvers & Proxies**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Networks** > **Resolvers & Proxies** > **Proxy endpoints**.
