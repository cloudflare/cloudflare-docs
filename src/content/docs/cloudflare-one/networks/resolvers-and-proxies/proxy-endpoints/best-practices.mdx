...
[Do Not Inspect (DNI) policies](/cloudflare-one/traffic-policies/policy-types/http-policies/actions/#do-not-inspect) will not prevent certificate pinning errors on these connections — bypassing certificate-pinned apps in the PAC file is required.
