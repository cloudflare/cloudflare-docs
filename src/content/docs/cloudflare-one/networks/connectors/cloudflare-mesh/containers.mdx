...
:::note
A [Terraform resource](https://registry.terraform.io/providers/cloudflare/cloudflare/latest/docs/resources/zero_trust_tunnel_cloudflared) (`cloudflare_zero_trust_tunnel_cloudflared`) can also create and manage Mesh nodes. Set the tunnel type to `warp_connector` when using Terraform.
:::
...
### Node registers as a regular WARP device
