...
| [Gateway proxy](/cloudflare-one/traffic-policies/reference/proxy/) | Enables the TCP, UDP, and ICMP traffic proxy for Mesh communication.                                     |
...
- [ ] **Traffic proxying** — Enable the [Gateway proxy](/cloudflare-one/traffic-policies/reference/proxy/) for TCP, UDP, and ICMP so that Mesh traffic can flow between devices.
