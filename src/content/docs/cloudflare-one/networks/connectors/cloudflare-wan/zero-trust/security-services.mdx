...
[Cloudflare Network Firewall](/cloudflare-one/traffic-controls/packet-filtering/network-firewall-overview/) provides packet-level filtering at layers 3 and 4. You define allow or block rules based on IP addresses, ports, and protocols.
...
[Cloudflare Gateway](/cloudflare-one/traffic-controls/) inspects traffic at layers 4 through 7 and supports three policy types:
...
- [Cloudflare Network Firewall](/cloudflare-one/traffic-controls/packet-filtering/network-firewall-overview/): Configure packet-level filtering rules.
