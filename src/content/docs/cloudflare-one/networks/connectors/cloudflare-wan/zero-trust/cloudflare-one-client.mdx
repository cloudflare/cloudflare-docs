...
To learn which IP addresses and UDP ports you should exclude to accomplish this, refer to [Cloudflare One Client ingress IP](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/deployment/firewall/#warp-ingress-ip).
