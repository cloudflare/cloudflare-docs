...
Use the Cloudflare dashboard or API to [configure two IPsec tunnels](/cloudflare-one/networks/connectors/cloudflare-wan/configuration/how-to/configure-tunnel-endpoints/#add-tunnels). This guide uses the settings mentioned below for the IPsec tunnels throughout the remainder.

### Add IPsec tunnels

1. Follow the [Add tunnels](/cloudflare-one/networks/connectors/cloudflare-wan/configuration/how-to/configure-tunnel-endpoints/#add-tunnels) instructions to create the required IPsec tunnels with the following options:
...
:::note
If site-to-site traffic is a requirement, enable replay protection. Refer to [Add tunnels](/cloudflare-one/networks/connectors/cloudflare-wan/configuration/how-to/configure-tunnel-endpoints/#add-tunnels) > IPsec tunnel to learn how to enable this feature.
:::
...
Create a [static route](/cloudflare-one/networks/connectors/cloudflare-wan/configuration/how-to/configure-routes/#create-a-static-route) for each of the two IPsec tunnels configured in the previous section, with the following settings (settings not mentioned here can be left with their default values):
...
![pfSense IPsec overview](~/assets/images/cloudflare-wan/third-party/pfsense/ipsec-overview.png)
...
![Assign a new interface to the first IPsec tunnel](~/assets/images/cloudflare-wan/third-party/pfsense/interfaces.png)

</div>

<div class="full-img">

![Configuring interface assignments](~/assets/images/cloudflare-wan/third-party/pfsense/interface-assignments.png)
...
![There should already be a gateway configured in the interface](~/assets/images/cloudflare-wan/third-party/pfsense/gateways.png)
...
![Allow all traffic for IPsec](~/assets/images/cloudflare-wan/third-party/pfsense/firewall-ipsec.png)
...
![The gateway should now be online](~/assets/images/cloudflare-wan/third-party/pfsense/status-gateways.png)
...
![Change the gateway in the firewall rules for LAN traffic](~/assets/images/cloudflare-wan/third-party/pfsense/firewall-lan.png)
