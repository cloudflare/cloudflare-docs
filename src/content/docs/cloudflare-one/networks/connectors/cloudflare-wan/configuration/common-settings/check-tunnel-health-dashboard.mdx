...
:::note
To access more than one hour of tunnel health data, you should use the [GraphQL API](/cloudflare-one/networks/connectors/cloudflare-wan/analytics/query-tunnel-health/).
:::
...
4. Find the tunnel you want to inspect, select the three dots next to it, and choose:
	- **Create alert**: Opens the [notifications wizard](/cloudflare-one/networks/connectors/cloudflare-wan/configuration/common-settings/configure-tunnel-health-alerts/) so you can create specific alerts for that tunnel when specific conditions are met.
...
- Network Analytics: Leverage real-time insights into [network analytics](/cloudflare-one/networks/connectors/cloudflare-wan/analytics/network-analytics/).
...
Refer to [Heartbeat](/cloudflare-one/networks/connectors/cloudflare-wan/configuration/appliance/maintenance/heartbeat/) to learn more.
