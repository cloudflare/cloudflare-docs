...
For details, refer to [How Cloudflare calculates Tunnel health alerts](/cloudflare-one/networks/connectors/cloudflare-wan/reference/how-cloudflare-calculates-tunnel-health-alerts/).
...
8. Select the **Alert Sensitivity Level** threshold from the drop-down menu. The threshold defaults to _Medium (98.0)_. You can choose from options between _Minimum (95.0)_ and _Maximum (99.9)_. For details, refer to [How Cloudflare calculates Tunnel health alerts](/cloudflare-one/networks/connectors/cloudflare-wan/reference/how-cloudflare-calculates-tunnel-health-alerts/).
...
2. Disable the tunnel you are testing, so there is 100% [health check failure](/cloudflare-one/networks/connectors/cloudflare-wan/reference/tunnel-health-checks/).
