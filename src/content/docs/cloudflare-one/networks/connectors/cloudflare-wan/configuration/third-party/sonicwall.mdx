...
You can connect your SonicWall appliance through [IPsec tunnels](/cloudflare-one/networks/connectors/cloudflare-wan/configuration/how-to/configure-tunnel-endpoints/) to Cloudflare WAN. Generic Routing Encapsulation (GRE) is not supported on SonicWall.

## Topology

![Topology diagram showing how to connect SonicWall appliances to Cloudflare WAN](~/assets/images/cloudflare-wan/third-party/sonicwall/topology.png)
...
1. Start by [creating your IPsec tunnels](/cloudflare-one/networks/connectors/cloudflare-wan/configuration/how-to/configure-tunnel-endpoints/#add-tunnels) on Cloudflare. Name and describe the tunnels as needed, and add the following settings:
...
3. After you create your tunnel, Cloudflare dashboard will load a list of tunnels set up for your account. Select the arrow to expand the tunnels you have just created, and check the following settings:
   ...
   ![An example of what your IPsec tunnel should look like](~/assets/images/cloudflare-wan/third-party/sonicwall/step3.png)
...
1. [Create your static routes](/cloudflare-one/networks/connectors/cloudflare-wan/configuration/how-to/configure-routes/#create-a-static-route). Name and describe them as needed, and add the following settings:
...
![Configure a VPN policy on your SonicWall device](~/assets/images/cloudflare-wan/third-party/sonicwall/3-vpn-config.png)
...
10. In **VPN Policy bound to** select your WAN interface from the drop-down menu, to bind it to your VPN.
11. Select **Save**.

<div class="large-img">

![Enable anti-replay on your SonicWall device](~/assets/images/cloudflare-wan/third-party/sonicwall/5-anti-replay.png)
...
![Enable ping so that your interface can be pinged for debugging and Cloudflare WAN health checks](~/assets/images/cloudflare-wan/third-party/sonicwall/6-vpn-ping.png)

</div>

5. Select **Advanced**.
6. Enable the **Enable Asymmetric Route Support** option. This is required for the IPsec tunnel health check.

<div class="large-img">

![Enable Asymmetric Route Support. It is required for Cloudflare WAN health checks](~/assets/images/cloudflare-wan/third-party/sonicwall/6-vpn-assymetric.png)
...
![Enter the appropriate settings for your object](~/assets/images/cloudflare-wan/third-party/sonicwall/7-address-objects-settings.png)
...
![Copy the individual network objects and add them to your group](~/assets/images/cloudflare-wan/third-party/sonicwall/7-add-objects-group.png)
...
You have to [configure Cloudflare WAN health checks](/cloudflare-wan/configuration/how-to/configure-tunnel-endpoints/#add-tunnels) correctly. Here is an example of how to set up health checks:
