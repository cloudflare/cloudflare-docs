...
<Aside>
	For a conceptual overview of virtual networks, including how they work across
	Cloudflare products, refer to [Virtual
	networks](/cloudflare-one/networks/virtual-networks/). Cloudflare WAN
	connections (IPsec, GRE, CNI) currently use only the default virtual network.
</Aside>
...
<AnchorHeading title="Automatic Return Routing" depth={2} />
...
<AnchorHeading title="Unified Routing mode" slug="unified-routing" depth={2} />
...
| [Cloudflare source IPs](/cloudflare-one/networks/connectors/cloudflare-wan/configuration/how-to/configure-cloudflare-source-ips/)                         | Generally available.                                                                               |
| [Custom Cloudflare One Client device subnets](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/configure/device-ips/) with Cloudflare WAN | Generally available.                                                                               |
| [Cloudflare Mesh](/mesh/) and Cloudflare WAN interoperability                                                                                             | Generally available.                                                                               |
...
| Feature                                                                                        | Availability with Unified Routing                                                                                       |
| ---------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| [Sample packet captures](/cloudflare-network-firewall/packet-captures/#sample-packet-captures) | Generally available.                                                                                                    |
| [Full packet captures](/cloudflare-network-firewall/packet-captures/#full-packet-captures)     | Not available.                                                                                                          |
| [Gateway filtering](/cloudflare-one/traffic-policies/)                                         | Generally available. Supports WAN-to-Internet and WAN-to-WAN filtering. Cloudflare staff must enable WAN-to-WAN filtering. |
| [Load Balancing](/load-balancing/private-network/)                                             | Generally available.                                                                                                    |
| [Workers VPC](/workers-vpc/)                                                                   | Generally available.                                                                                                    |
| Application Services                                                                           | Generally available.                                                                                                    |
| [Network Analytics](/analytics/network-analytics/)                                             | Generally available.                                                                                                    |

[Cloudflare Network Firewall](/cloudflare-network-firewall/) features have the following availability:
...
<Aside type="note">
	If you need consistent longest-prefix-match across all scenarios, follow [How
	to upgrade to Unified Routing](#how-to-upgrade-to-unified-routing).
</Aside>

<AnchorHeading
	depth={4}
	title="Cross-system traffic (WAN to Zero Trust or Zero Trust to WAN)"
/>
...
<AnchorHeading
	depth={3}
	title="BGP peering with the Cloudflare Virtual Network routing table"
/>
