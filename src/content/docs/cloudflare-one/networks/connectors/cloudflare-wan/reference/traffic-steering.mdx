...
| [Gateway filtering](/cloudflare-one/traffic-policies/)                                         | Generally available. Supports WAN-to-Internet and WAN-to-WAN filtering. Configure WAN-to-WAN filtering through the API. |
...
When [Gateway network policies](/cloudflare-one/traffic-controls/network-policies/) are applied to site-to-site WAN traffic, route selection follows these rules:
...
For more information, refer to [Applications and app types](/cloudflare-one/traffic-controls/application-app-types/).
