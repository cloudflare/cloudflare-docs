...
<Tabs>
  <TabItem label="Dashboard">
      ...
      1. Create two unique virtual networks:
         1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Networks** > **Routes** > **Virtual networks**.
				 :::note
...
<Tabs>
  <TabItem label="Dashboard">
      ...
      1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Networks** > **Connectors** > **Cloudflare Tunnels** and ensure that no IP routes are assigned to the virtual network you are trying to delete. If your virtual network is in use, delete the route or reassign it to a different virtual network.
