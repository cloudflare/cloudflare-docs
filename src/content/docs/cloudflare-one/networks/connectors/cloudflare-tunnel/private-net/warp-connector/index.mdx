...
:::note
Accounts on Legacy routing mode do not support WARP Connector when [Magic WAN](/magic-wan/) is enabled. Your account needs to be on Unified Routing for this to be supported. Contact your account team for more information.
:::
...
[^1]: WARP Connector is an extension of the [WARP client](/cloudflare-one/team-and-resources/devices/warp/).
