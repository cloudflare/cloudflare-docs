...
<Render
	...
	params={{
		metricsURL:
			"/cloudflare-one/networks/connectors/cloudflare-tunnel/monitor-tunnels/metrics/#configure-the-metrics-server-address",
	}}
/>
...
<Render
	...
	params={{
		...
		defaultMetricsURL:
			"/cloudflare-one/networks/connectors/cloudflare-tunnel/monitor-tunnels/metrics/#default-metrics-server-address",
	}}
/>
...
<Render
	...
	params={{
		...
		loglevelURL:
			"/cloudflare-one/networks/connectors/cloudflare-tunnel/monitor-tunnels/logs/#view-logs-on-the-server",
	}}
/>
