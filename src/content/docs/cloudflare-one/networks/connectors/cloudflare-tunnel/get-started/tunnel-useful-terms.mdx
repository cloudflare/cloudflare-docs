...
Quick Tunnels generate a random `trycloudflare.com` subdomain that sends traffic to a local service. For more information, refer to [Quick Tunnels](/tunnel/get-started/quick-tunnels/).
