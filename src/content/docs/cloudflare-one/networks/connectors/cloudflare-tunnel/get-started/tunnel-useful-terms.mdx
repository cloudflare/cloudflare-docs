...
A remotely-managed tunnel is a [tunnel](#tunnel) that was created in [Cloudflare One](https://dash.cloudflare.com/one/) under **Networks** > **Tunnels**. Tunnel configuration is stored in Cloudflare, which allows you to manage the tunnel from the dashboard or using the [API](/api/resources/zero_trust/subresources/tunnels/subresources/cloudflared/subresources/configurations/methods/get/).
