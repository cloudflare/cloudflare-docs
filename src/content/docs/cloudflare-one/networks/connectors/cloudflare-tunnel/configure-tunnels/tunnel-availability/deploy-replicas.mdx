...
To deploy multiple instances of `cloudflared`, you can create and configure one tunnel and run it on multiple hosts. For remotely-managed tunnels, you can also [run multiple named services](/tunnel/guides/named-services/) on one host.
