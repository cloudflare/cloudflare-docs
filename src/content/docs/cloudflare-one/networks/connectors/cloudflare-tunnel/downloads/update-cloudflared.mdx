...
3. On the **Overview** tab, select 'Add a Replica', choose your operating system and copy the Docker installation command. The copied command will contain your token.
