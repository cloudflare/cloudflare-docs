...
<Render
	...
	params={{
		publishedAppRouteURL:
			"/cloudflare-one/networks/connectors/cloudflare-tunnel/get-started/create-remote-tunnel/#2a-publish-an-application",
		tunnelIdLocation:
			"the [Cloudflare dashboard](https://dash.cloudflare.com/) under **Zero Trust** > **Networks** > **Connectors** > **Cloudflare Tunnels**",
	}}
/>
