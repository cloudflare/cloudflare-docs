...
For TCP or UDP applications, Cloudflare can also route traffic through a [Spectrum application](/spectrum/get-started/#create-a-spectrum-application-using-a-virtual-network-origin) attached to a [virtual network](/cloudflare-one/networks/virtual-networks/).
