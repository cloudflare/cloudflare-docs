...
1. Create a Cloudflare Tunnel by following the [dashboard setup guide](/cloudflare-one/networks/connectors/cloudflare-tunnel/get-started/create-remote-tunnel/).
...
6. <Render file="access/add-access-policies" product="cloudflare-one" />
   ...
   <Render
   	file="access/self-hosted-app/browser-rendering-policies"
