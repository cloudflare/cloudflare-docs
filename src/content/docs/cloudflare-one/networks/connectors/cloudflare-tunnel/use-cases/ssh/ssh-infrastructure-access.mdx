...
Traffic from the WARP client to your infrastructure targets is filtered by both [Gateway network policies](/cloudflare-one/traffic-policies/get-started/network/) and the application-specific Access policies.
