...
7. Go to [**Policies**](/cloudflare-one/access-controls/policies/access/policy-management/#test-your-policies) to review what criteria may be blocking the user.

By adding an Access [policy](/cloudflare-one/access-controls/policies/access/) to allow the user, the connection issue should be resolved. After saving your policy changes, attempt to connect to the server.
