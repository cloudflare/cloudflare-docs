...
2. [Enable the Gateway proxy for TCP](/cloudflare-one/traffic-policies/send-traffic-to-gateway/#turn-on-the-gateway-proxy).
...
Cloudflare will stop logging SSH commands to your targets, as well as any commands subject to [Gateway Audit SSH](/cloudflare-one/traffic-policies/policy-types/network-policies/ssh-logging/) policies.
