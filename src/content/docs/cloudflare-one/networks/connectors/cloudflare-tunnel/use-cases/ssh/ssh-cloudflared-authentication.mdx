...
By default, anyone on the Internet can connect to the published hostname. To control who can reach your server, add a [self-hosted application](/cloudflare-one/access-controls/applications/http-apps/self-hosted-public-app/) to Cloudflare Access.
