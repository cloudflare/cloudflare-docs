...
WAN Tunnels supports a variety of <GlossaryTooltip term="on-ramp">on-ramps</GlossaryTooltip> including any device that supports <GlossaryTooltip term="anycast">anycast</GlossaryTooltip> <GlossaryTooltip term="GRE tunnel">GRE</GlossaryTooltip> or <GlossaryTooltip term="IPsec tunnel">IPsec</GlossaryTooltip> tunnels. To make it easier to onboard your cloud properties, you can use [Magic Cloud Networking](/cloudflare-one/networks/connectors/wan-tunnels/configuration/magic-cloud-networking/), which automates the process of creating on-ramps from your cloud networks.

Refer to [On-ramps](/cloudflare-one/networks/connectors/wan-tunnels/on-ramps/) for a full list of supported on-ramps.

Learn how to [get started](/cloudflare-one/networks/connectors/wan-tunnels/get-started/).
...
<Feature
	...
	href="/cloudflare-one/networks/connectors/wan-tunnels/configuration/appliances/"
	cta="Use Appliances"
>
	Use Appliances to automatically connect, steer, and shape any IP
	traffic.
</Feature>

<Feature
	header="Connect your network manually"
	href="/cloudflare-one/networks/connectors/wan-tunnels/configuration/manually/third-party/"
	cta="Use a third-party device"
>
	WAN Tunnels is compatible with a host of third-party devices. If you do not have
	Appliances, start here to learn how to set up WAN Tunnels manually.
</Feature>

<Feature
	header="Automatic cloud on-ramps"
	href="/cloudflare-one/networks/connectors/wan-tunnels/configuration/magic-cloud-networking/"
...
<Feature
	...
	href="/cloudflare-one/networks/connectors/wan-tunnels/zero-trust/"
	cta="Integrate with other Zero Trust products"
>
	Learn how you can use WAN Tunnels with other Cloudflare Zero Trust products.
</Feature>

<Feature header="BGP peering" href="/cloudflare-one/networks/connectors/wan-tunnels/configuration/manually/how-to/configure-routes/#configure-bgp-routes">
