...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Networks** > **Routes** > **CIDR**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Networks** > **Routes** > **Hostname routes**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Networks** > **Tunnels**.
