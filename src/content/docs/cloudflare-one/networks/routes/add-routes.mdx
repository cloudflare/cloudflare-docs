...
:::note
When adding a CIDR, hostname, or WAN route, you can enter multiple destinations at once (separated by commas or new lines), or select **Add another** to queue up several routes — including different types or connectors — before creating them all together.
:::
