...
For details on routing options, refer to [Routes](/cloudflare-one/networks/connectors/cloudflare-mesh/features/routes/).
...
- **Enable high availability**: Deploy multiple replicas of each mesh node for automatic failover. For more information, refer to [High availability](/cloudflare-one/networks/connectors/cloudflare-mesh/features/high-availability/).
...
- [Tips and best practices](/cloudflare-one/networks/connectors/cloudflare-mesh/best-practices/): review common Cloudflare Mesh configuration tips and troubleshooting strategies.
