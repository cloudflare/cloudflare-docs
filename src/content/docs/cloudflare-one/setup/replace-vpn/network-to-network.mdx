...
:::note
WARP Connector does not currently support IPv6 routes. Enter an IPv4 range. If you are not sure of your network's IP range, check your router or network settings.
:::
