...
For more details, refer to [Connect client devices](/cloudflare-one/networks/connectors/cloudflare-mesh/guides/connect-client-devices/).
...
- **Windows users**: Windows Firewall blocks device-to-device traffic by default. You may need to add a firewall rule that allows incoming traffic from `100.96.0.0/12`. For details, refer to [Connect client devices](/cloudflare-one/networks/connectors/cloudflare-mesh/guides/connect-client-devices/).
