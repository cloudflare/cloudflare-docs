...
- A Cloudflare account. If you have not set this up, refer to [Get started](/cloudflare-one/setup/).
...
1. In the [Cloudflare dashboard](https://dash.cloudflare.com), go to **Mesh**.
...
3. Download the Cloudflare One Client on your first device from the [download page](https://developers.cloudflare.com/cloudflare-one/team-and-resources/devices/warp/download-warp/).
