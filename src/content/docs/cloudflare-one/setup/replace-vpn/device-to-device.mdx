...
3. If prompted, enter a team name and select **Just me** or **My organization** for the enrollment policy.
4. Review the proposed account changes, then select **Confirm and set up**.
5. Select your platform and follow the installation instructions.
6. Open the client, enter your team name, and sign in with your email.
