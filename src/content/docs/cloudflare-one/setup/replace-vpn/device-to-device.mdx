...
- **Set up Gateway policies**: By default, all enrolled devices can reach each other over the Mesh IP space. Gateway policies let you scan, filter, and log traffic between your devices. For more information, refer to [DNS policies](/cloudflare-one/traffic-policies/policy-types/dns-policies/), [Network policies](/cloudflare-one/traffic-policies/policy-types/network-policies/), and [HTTP policies](/cloudflare-one/traffic-policies/policy-types/http-policies/).
