...
This guide follows the same steps as the **Get Started** onboarding wizard in the [Cloudflare One dashboard](https://dash.cloudflare.com/one/).
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), select the **Get Started** tab.
...
- **Explore more with Zero Trust**: Review your tunnel, policies, and connected devices in the [Cloudflare One dashboard](https://dash.cloudflare.com/one/).
