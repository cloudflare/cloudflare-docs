...
import { AvailableNotifications, Render, TabItem, Tabs, Stream } from "~/components";

<Render file="load-balancer-definition" /> <br />

<Stream id="ce39fdf599aed3661f60e8f780761808" title="Set up Load Balancer" thumbnail="2s" showMoreVideos={false} />
