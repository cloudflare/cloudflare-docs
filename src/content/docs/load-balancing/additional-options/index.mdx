...
- Return endpoint hostnames as `CNAME` records to support multi-CDN and downstream DNS steering with [CNAME flattening for endpoints](/load-balancing/additional-options/cname-flattening/)
