...
For a list of optional parameters, which are useful for filtering log results, see *[Cloudflare API: Health Monitor Events](/api/operations/load-balancer-healthcheck-events-list-healthcheck-events)*.
