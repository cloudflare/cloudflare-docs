...
Please note that you can use the root domain as a Load balancer hostname, please add the hostname without the auto-generated dot before your zone's name. 
