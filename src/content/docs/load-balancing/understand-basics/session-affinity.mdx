...
Session Affinity is not supported in [DNS-only mode (gray cloud)](/load-balancing/understand-basics/proxy-modes/). Alternatively, you can use [DNS persistence](/load-balancing/additional-options/dns-persistence/).
