...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Team & Resources** > **Device profiles**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Traffic policies** > **Firewall policies**> **DNS**.
