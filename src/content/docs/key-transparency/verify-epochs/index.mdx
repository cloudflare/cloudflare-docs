...
```sh
curl 'https://plexi-staging.research.cloudflare.com/namespaces/{namespace}/audits' \
      --header 'Content-Type: application/json' \
      --data '{"epoch": 1, "digest": "1111111111111111111111111111111111111111111111111111111111111111"}'
{
  "namespace": "whatsapp-2024",
...
```sh
curl 'https://plexi-staging.research.cloudflare.com/namespaces/{namespace}/audits/1'
{
  "namespace": "whatsapp-2024",
  "timestamp": 1717084639921,~
  "epoch": 1,
