...
- Also verify that your [Internet Routing Registry (IRR)](/byoip/concepts/irr-entries/) records are up to date and contain:
    ...
    <Render file="cloudflare-asn-callout" product="byoip" />
...
2. <Render file="validate-prefix-endpoint" product="byoip" />
