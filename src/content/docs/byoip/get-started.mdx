...
:::note
Magic Transit can only be used as default binding, spanning across your entire prefix. For details refer to [Service bindings scope](/byoip/service-bindings/#scope).
:::
