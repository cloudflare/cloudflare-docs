...
description: >-
  Cloudflare allows users to use their Cloudflare prefix to route traffic to a different service. Service bindings must be created on the parent account of the prefix. Service binding will take four to six hours to propagate across Cloudflar's network.
---
