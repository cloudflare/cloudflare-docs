...
Industry benchmarks are calculated globally from the percentage of mitigated traffic on your account. This is based on the number of mitigated traffic relative to the total amount of traffic for companies within your industry. Cloudflare analyzes where you are in the percentile to determine how you compare to your peers. 
