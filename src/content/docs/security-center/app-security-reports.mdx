...
Industry benchmarks are calculated globally from the percentage of mitigated traffic on your account. This is based on the number of mitigated traffic relative to the total amount of traffic on your account. Cloudflare analyzes where you are in the percentile to determine how you compare to other companies in your industry. 
