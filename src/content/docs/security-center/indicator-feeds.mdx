...
head:
  - tag: title
    content: Custom Indicator Feeds
---
...
If your organization is interested in becoming a provider or a subscriber, contact your account team to facilitate the required authorization.
