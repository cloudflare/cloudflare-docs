...
You can only submit an abuse report if your domain is with [Cloudflare Registrar](https://www.cloudflare.com/en-gb/products/registrar/), or if the IP used by the domain is hosted by Cloudflare.
:::
