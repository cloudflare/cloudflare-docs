...
While the Brand Protection tool is in beta, all Cloudflare Enterprise customers have automatic access to Brand Protection, including five saved queries. Only Admins, Super Admin and users with a Brand Protection role can access Brand Protection 
:::
