...
The [Brand Protection API](/api/resources/brand_protection/) allows forprogrammatic management and integration with your SOC/SIEM. Using the Brand Protection API, you can:
