...
- File Hashes
- JA3 Fingerprints
- Threat Insights: Connect dots by linking events to specific campaigns or industry aliases (for example, APT28).

### Automation and alerts

- Saved views: Save custom filters for recurring investigations.
- Real-time notifications: Get notified as soon as the telemetry matches your custom filters.
- Automated rules: Generate security rules directly from threat data and push them to your Cloudflare WAF or Firewall.
- STIX2 exports: Export intellihence for seamless integration with third-party SIEM/SOAR platforms.
