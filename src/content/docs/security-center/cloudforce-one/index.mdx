...
Confirms if an attack is happening against a specific website and to share any available indicators and potential attribution. 

### Indicator Analysis - IOCs

Conducts DNS lookups, origin pivots, and account pivots to provide indicators such as DNS resolutions, origin IPs, and subdomains. Analysis can include account registration patterns and victimology.
