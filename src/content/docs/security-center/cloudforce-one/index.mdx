...
The Cloudflare dashbaord presents you with dynamic visualizations that include:
...
- File Hashes
- [JA3 Fingerprints](/bots/additional-configurations/ja3-ja4-fingerprint/)
...
- Automated rules: Generate security rules directly from threat data and push them to your Cloudflare [WAF](/waf/) or Firewall.
