...
For a detailed list of categories, refer to [Domain categories](/cloudflare-one/traffic-controls/domain-categories/).
...
4. Choose whether to change a [security category](/cloudflare-one/traffic-controls/domain-categories/#security-categories) or a [content category](/cloudflare-one/traffic-controls/domain-categories/#content-categories).
