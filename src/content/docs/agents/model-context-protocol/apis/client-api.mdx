...
MCP servers can request input from your agent during a tool call using [elicitation](https://modelcontextprotocol.io/specification/latest/client/elicitation). To respond, override `onElicitRequest` on your agent:
