...
`McpAgent` also remains available for stateful 2025 servers. It is deprecated and feature-frozen. Refer to the [`McpAgent` API](/agents/model-context-protocol/apis/agent-api/) for its existing behavior.
