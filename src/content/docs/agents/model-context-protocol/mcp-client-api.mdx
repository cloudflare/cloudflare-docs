...
This page covers connecting to MCP servers as a client. To create your own MCP server, see [Creating MCP servers](/agents/model-context-protocol/mcp-agent-api/).
...
- [Creating MCP servers](/agents/model-context-protocol/mcp-agent-api/) — Build your own MCP server
- [Client SDK](/agents/api-reference/client-sdk/) — Connect from browsers with `onMcpUpdate`
- [Store and sync state](/agents/api-reference/store-and-sync-state/) — Learn about agent persistence
