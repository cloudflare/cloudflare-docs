...
If your stateless MCP server declares `McpServer` or transport instances in the global scope, you must update your code to create new instances per request.
:::
