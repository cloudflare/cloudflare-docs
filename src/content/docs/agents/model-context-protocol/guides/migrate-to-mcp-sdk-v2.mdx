...
This guide covers the [MCP SDK v2](https://github.com/modelcontextprotocol/typescript-sdk) upgrade in Agents SDK v0.20.0. It explains how to move stateless servers to `@modelcontextprotocol/server`, keep existing servers on an explicit legacy handler, and update MCP clients.
