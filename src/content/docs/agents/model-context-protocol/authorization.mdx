...
### (2) Your MCP Server handles authorization and authentication itself
...
<LinkCard
	...
	href="/agents/guides/remote-mcp-server/#add-authentication"
	description="Use GitHub as a third-party OAuth provider."
/>
