...
<PackageManagers pkg="@cloudflare/voice-twilio" />

<PackageManagers pkg="@cloudflare/voice-plivo" />
...
<PackageManagers pkg="@cloudflare/voice-telnyx" />
...
<CardGrid>
	<LinkCard
		title="Plivo voice agent"
		href="https://github.com/cloudflare/agents/tree/main/examples/plivo-voice-agent"
		description="Answer inbound Plivo calls in a Worker, including the answer URL and application setup."
	/>
	<LinkCard
		title="Telnyx voice agent"
		href="https://github.com/cloudflare/agents/tree/main/examples/telnyx-voice-agent"
		description="Bridge PSTN calls through the browser, including the JWT endpoint and client wiring."
	/>
</CardGrid>
