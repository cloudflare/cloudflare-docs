...
This guide shows how to add agents to an existing Cloudflare Workers project. If you are starting fresh, see [Building a chat agent](/agents/getting-started/build-a-chat-agent/) instead.
...
You can generate types automatically from your `wrangler.jsonc`:
...
See [Configuration](/agents/api-reference/configuration/#generating-types) for more details on type generation.
...
See [Routing](/agents/api-reference/routing/) for more options including CORS, custom instance naming, and location hints.
...
- Learn about [state management](/agents/api-reference/store-and-sync-state/) for managing agent state.
- Explore [scheduling](/agents/api-reference/schedule-tasks/) for background tasks and cron jobs.
- Read the [Agent class internals](/agents/concepts/agent-class/) for the full lifecycle and methods.
- Review the [Agents API documentation](/agents/api-reference/agents-api/) for the complete API reference.
