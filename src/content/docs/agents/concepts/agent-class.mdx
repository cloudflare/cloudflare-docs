...
The [Workers runtime](https://blog.cloudflare.com/workerd-open-source-workers-runtime/) always calls the constructor to handle things internally. This means two things:
