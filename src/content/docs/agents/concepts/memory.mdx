...
The agent uses `load_context` to fetch full content and `unload_context` to free the space when done. Skills are covered in depth in the [Skills](#skills) section below.
