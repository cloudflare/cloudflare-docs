...
The Session API supports four types of memory, each suited to different kinds of information. The type is determined by the **provider** backing the context block — the Session detects the provider's capabilities automatically.
