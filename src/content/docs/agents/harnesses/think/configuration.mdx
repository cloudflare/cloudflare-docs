...
| `getSkills()`              | `[]`                             | Return Agent Skills sources for on-demand skill activation — refer to [Skills](/agents/harnesses/think/skills/)                                                                                                                                                                     |
| `getSkillScriptRunner()`   | `null`                           | Enable the optional `run_skill_script` tool — refer to [Skills](/agents/harnesses/think/skills/#script-runner)                                                                                                                                                                     |
...
The Agent Skills engine and its script runner live in [`agents/skills`](/agents/runtime/execution/agent-skills/), so skill scripts pull `@cloudflare/worker-bundler` and `just-bash` through `agents`, not Think. For configuring skills in Think, refer to [Skills](/agents/harnesses/think/skills/).
