...
Every span counts as one observability event, including spans not shown in the Agents view. Tracing is free while in beta. Beginning September 1, 2026, tracing will be included in existing Workers Observability pricing:
