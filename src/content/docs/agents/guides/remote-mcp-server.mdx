...
You can use Cloudflare Access to secure authentication to your MCP server, without managing OAuth logic within your code. This method allows you to restrict access to your tools based on user attributes from identity providers (like Google, Okta, or Microsoft Entra ID), email domains, IP addresses, and [other criteria](/cloudflare-one/access-controls/policies/).
