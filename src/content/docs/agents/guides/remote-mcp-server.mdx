...
const createOptions = (env: Env) => {
	// if using your own wallet, uncomment below
	//
	// const paymentDestination = new ChainPaymentDestination(
	//	env.PAYMENT_DESTINATION_ADDRESS,
	//	env.PAYMENT_DESTINATION_NETWORK,
	//);
...
Test the `hello_world` tool to verify it works correctly.
