...
- Learn about [routing](/agents/api-reference/routing/) for routing and authentication hooks.
- Explore [WebSocket connections](/agents/api-reference/websockets/) for real-time communication.
