...
- Learn more about [Workflows](/agents/api-reference/run-workflows/) for the complete `waitForApproval()` API
- Explore [MCP servers](/agents/model-context-protocol/mcp-agent-api/) for building MCP agents with elicitation
