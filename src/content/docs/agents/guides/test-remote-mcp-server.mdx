...
The AI Playground supports MCP servers with both Workers AI and external providers (OpenAI, Anthropic, Google). For more information about using external providers with the playground, refer to [Use external AI providers in the Playground](/agents/guides/ai-playground-external-providers/).
