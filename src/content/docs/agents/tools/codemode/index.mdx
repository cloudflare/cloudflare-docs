...
Use direct tool calls for a small, fixed tool set and one or two independent operations. Use Code Mode when a task needs composition, dependent calls, progressive discovery, reusable logic, or control flow:

| Pattern           | Best suited for                                                                                                  |
| ----------------- | ---------------------------------------------------------------------------------------------------------------- |
| Direct tool calls | One or two independent operations from a small, known tool set                                                   |
