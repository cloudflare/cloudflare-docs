...
sidebar:
  order: 1
description: Accept Machine Payments Protocol (MPP) payments from a Cloudflare Worker route or Model Context Protocol (MCP) tool.
products:
  - agents
---
...
Use Cloudflare Workers to accept Machine Payments Protocol (MPP) payments. Add `mppx` to an HTTP route or a Model Context Protocol (MCP) tool.
