...
[x402](https://www.x402.org/) is a payment standard built around HTTP 402 (Payment Required). Services ret
urn a 402 response with payment instructions, and clients pay programmatically without accounts, sessions,
or API keys.
