...
- Learn about [callable methods](/agents/api-reference/callable-methods/) for exposing methods to clients.
- Explore [state management](/agents/api-reference/store-and-sync-state/) for managing agent state.
