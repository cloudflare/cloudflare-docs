...
This page provides an overview of the Agents SDK. For detailed documentation on each feature, see the linked reference pages.
...
Agents require [Cloudflare Durable Objects](/durable-objects/). See [Configuration](/agents/api-reference/configuration/) to learn how to add the required bindings.
...
| Method                                        | When it runs                                       |
| --------------------------------------------- | -------------------------------------------------- |
| `onStart()`                                   | When the instance starts or wakes from hibernation |
...
| **HTTP client**      | `agentFetch()`   | [Client SDK](/agents/api-reference/client-sdk/) |
| **React hook**       | `useAgent()`     | [Client SDK](/agents/api-reference/client-sdk/) |
...
See [Build a chat agent](/agents/getting-started/build-a-chat-agent/) for a complete tutorial.
...
See [Routing](/agents/api-reference/routing/) for custom paths, CORS, and instance naming patterns.

## Next steps

- Follow the [Quick start](/agents/getting-started/quick-start/) to build your first agent
- Learn about [configuration](/agents/api-reference/configuration/) and deployment
- Explore [WebSockets](/agents/api-reference/websockets/) for real-time communication
- Build AI applications with [AIChatAgent](/agents/getting-started/build-a-chat-agent/)
