...
See [WebSockets](/agents/api-reference/websockets/) for WebSocket documentation.

## Next steps

- Learn about [WebSockets](/agents/api-reference/websockets/) for bi-directional communication
- Explore [state management](/agents/api-reference/store-and-sync-state/) for persisting stream progress
- Build a [chat agent](/agents/getting-started/build-a-chat-agent/) with streaming responses
