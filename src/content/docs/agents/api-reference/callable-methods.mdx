...
- Learn about [WebSockets](/agents/api-reference/websockets/) for real-time communication.
- Explore [state management](/agents/api-reference/store-and-sync-state/) for syncing state between agents and clients.
