...
- Learn about [routing](/agents/api-reference/routing/) for URL patterns and custom routing.
- Explore [callable methods](/agents/api-reference/callable-methods/) for RPC over WebSocket.
- Review [cross-domain authentication](/agents/guides/cross-domain-authentication/) for secure connections.
- Build a [chat agent](/agents/getting-started/build-a-chat-agent/) with the complete client integration.
