...
Agents support WebSocket connections for real-time, bi-directional communication. This page covers server-side WebSocket handling. For client-side connection, see the [Client SDK](/agents/api-reference/client-sdk/).
...
See [Client SDK](/agents/api-reference/client-sdk/) for full documentation.

## Next steps

- Learn about [state synchronization](/agents/api-reference/store-and-sync-state/) between agents and clients
- Explore [callable methods](/agents/api-reference/callable-methods/) for RPC over WebSockets
- Review [cross-domain authentication](/agents/guides/cross-domain-authentication/) for secure connections
