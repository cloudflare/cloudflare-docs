...
- Learn about [configuration](/agents/api-reference/configuration/) for wrangler.jsonc setup.
- Explore [Cloudflare dashboard](/agents/api-reference/configuration/#dashboard-setup) for viewing logs.
