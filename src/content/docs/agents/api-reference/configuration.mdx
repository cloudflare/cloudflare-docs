...
2. Select your account, then Workers & Pages.
3. Select your Worker.
4. Go to the **Durable Objects** tab.
...
- Learn about [routing](/agents/api-reference/routing/) to route requests to your agents.
- Explore [schedule tasks](/agents/api-reference/schedule-tasks/) for background processing.
