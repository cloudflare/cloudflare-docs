...
`terminate()` is not yet supported in local development with `wrangler dev`. It works when deployed to Cloudflare. Follow [cloudflare/agents#823](https://github.com/cloudflare/agents/issues/823) for details and updates.
...
`pause()` is not yet supported in local development with `wrangler dev`. It works when deployed to Cloudflare. Follow [cloudflare/agents#823](https://github.com/cloudflare/agents/issues/823) for details and updates.
...
`resume()` is not yet supported in local development with `wrangler dev`. It works when deployed to Cloudflare. Follow [cloudflare/agents#823](https://github.com/cloudflare/agents/issues/823) for details and updates.
...
`restart()` is not yet supported in local development with `wrangler dev`. It works when deployed to Cloudflare. Follow [cloudflare/agents#823](https://github.com/cloudflare/agents/issues/823) for details and updates.
