...
- Learn about [handling HTTP requests](/agents/api-reference/http-sse/) in your Agent.
- Explore [webhooks](/agents/guides/webhooks/) for receiving events from external services.
