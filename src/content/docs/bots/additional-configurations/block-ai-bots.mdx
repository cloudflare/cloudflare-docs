...
- **Agent**: automated activity acting in real time on a person's behalf, such as browser-use agents and chat fetch bots.
...
For new domains, **Training** and **Agent** are blocked by default on pages that display ads, while **Search** is allowed by default. Existing configurations are not changed automatically.
:::
...
<Steps>
  ...
  3. Go to the AI bot presets (**Training**, **Search**, and **Agent**).
