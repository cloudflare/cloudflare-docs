...
:::note
Not all login endpoints will be automatically detected, however [endpoints labeled](https://developers.cloudflare.com/api-shield/management-and-monitoring/endpoint-labels/#categories) as `cf-log-in`, will be evaluated for Account Takeover detection IDs.
:::
