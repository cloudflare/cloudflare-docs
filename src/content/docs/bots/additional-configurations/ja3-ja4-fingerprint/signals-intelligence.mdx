...
Bot Management customers can view aggregate intelligence data for each [JA4 fingerprint](/bots/additional-configurations/ja3-ja4-fingerprint/) based on traffic across the Cloudflare network. Use this data to understand why a request received a specific bot score or to feed into your own machine learning models running in [Cloudflare Workers](/workers/) or at your origin.
...
You can also use these fields with [Workers AI](/workers-ai/) to build custom machine learning models.
