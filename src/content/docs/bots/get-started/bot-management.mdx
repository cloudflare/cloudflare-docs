...
Cloudflare recommends that you deploy these basic settings and customize them to traffic in your zone.

### Enable The Latest ML Version

<Render file="latest-ml-model-enable" params={{ one: "Bot Management" }} />
