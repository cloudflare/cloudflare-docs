...
:::note
Custom rules created from these templates execute before the managed rules configured in **Security Settings**. For more details on this execution order, refer to [WAF custom rules](/bots/get-started/super-bot-fight-mode/#waf-custom-rules) in the Super Bot Fight Mode documentation.
:::
