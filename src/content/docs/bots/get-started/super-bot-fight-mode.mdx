...
You can see bot-related actions by going to **Security** > **Events**. Any requests challenged or blocked by this feature will be grouped together under **Managed rules** in the **Service** field, with rule names such as **manage definite bots** or **Manage likely bots** pointing to Super Bot Fight Mode. This allows you to observe, analyze, and follow trends in your bot traffic over time.
