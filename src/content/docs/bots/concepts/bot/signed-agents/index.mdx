...
A signed agent is a bot controlled by an end user and verified through [Web Bot Auth](/bots/reference/bot-verification/web-bot-auth/) cryptographic signatures.
