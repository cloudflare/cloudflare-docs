...
A <GlossaryTooltip term="verified bot">verified bot</GlossaryTooltip> is a bot that Cloudflare has confirmed as legitimate, such as search engine crawlers and monitoring services.
