...
The Bot Feedback Loop allows you to report requests that Bot Management <GlossaryTooltip term="bot score" link="/bots/concepts/bot-score/">scored</GlossaryTooltip> incorrectly. When you submit a false negative or false positive report, Cloudflare analyzes the data and uses it to train the next machine learning model.
