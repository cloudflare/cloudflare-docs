...
<GlossaryTooltip term="bot tags">Bot tags</GlossaryTooltip> provide more detail
about *why* Cloudflare assigned a
<GlossaryTooltip term="bot score" link="/bots/concepts/bot-score/">
	bot score
</GlossaryTooltip>
to a request.
