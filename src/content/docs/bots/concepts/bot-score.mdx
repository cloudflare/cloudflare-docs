...
The Heuristics engine gives automated requests a score of 1 for high-confidence detections, or a score of 29 for detections where Cloudflare is still assessing confidence.
