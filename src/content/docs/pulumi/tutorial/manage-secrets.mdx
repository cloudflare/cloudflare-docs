...
:::note
The `.dev.vars` file is located in the root of your Wrangler project to define secrets used when running `wrangler dev`. [Learn more about Local Development with Secrets](/workers/configuration/secrets/#local-development-with-secrets)
:::
