...
head:
  - tag: title
    content: Deploy a Hello World app
...
![alt\_text](~/assets/images/pulumi/hello-world-tutorial/sn2.png "Running Cloudflare Workers application deployed with Pulumi")
...
:::note[Link to the full solution]
...
![alt\_text](~/assets/images/pulumi/hello-world-tutorial/sn3.png "Pulumi Cloud stack")
...
4. Open the "hello-world" application. Example:
   ![alt\_text](~/assets/images/pulumi/hello-world-tutorial/sn4.png)
...
5. For **Routes**, select **View** to verify the Worker Route details match your definition.
   ![alt\_text](~/assets/images/pulumi/hello-world-tutorial/sn5.png "Cloudflare Dashboard - Worker Route")
...
![alt\_text](~/assets/images/pulumi/hello-world-tutorial/sn6.png "Pulumi Cloud stack")
...
![alt\_text](~/assets/images/pulumi/hello-world-tutorial/sn2.png "Hello World app browser screenshot")
