...
sidebar:
  order: 5
description: >-
  Pulumi and Wrangler can be used to create different types of resources. You can use Pulumi for some resources supported by the Cloudflare Pulumi provider. Use Wrangler to create other resources such as Workers and D1 databases.
---
