...
Enterprise customers also have the option to configure [Dedicated CDN Egress IPs](/smart-shield/configuration/dedicated-egress-ips/), enabling you to increase origin security by only allowing traffic from a small list of IP addresses. If you are interested, reach out to your account team.
