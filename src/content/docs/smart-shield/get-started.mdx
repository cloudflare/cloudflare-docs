...
Enterprise customers also have the option to configure [Dedicated CDN Egress IPs](/smart-shield/configuration/dedicated-egress-ips/). This means egress IPs that are reserved exclusively for your account so that you can increase your origin security by only allowing traffic from a small list of IP addresses.
