...
For IPv4 traffic, based on [IPs allocation](/smart-shield/configuration/dedicated-egress-ips/about/#ips-allocation), not all egress data centers will have access to an applicable dedicated CDN egress IP.
