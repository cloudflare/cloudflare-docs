...
Refer to [connection forwarding](/smart-shield/configuration/dedicated-egress-ips/about/connection-forwarding/) to understand how requests are processed when reaching different Cloudflare data centers.
