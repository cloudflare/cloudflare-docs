...
- **env.PROJECT** is the project binding defined in your [Wrangler configuration](/workers/wrangler/configuration) file.
...
const tensorInputArray = [
	new Tensor(TensorType.Int32, 1),
	new Tensor(TensorType.Int32, 2),
	new Tensor(TensorType.Int32, 3),
];
