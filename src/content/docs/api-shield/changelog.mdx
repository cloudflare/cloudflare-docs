...
Endpoints and Schema Validation now support up to 10,000 saved and validated API endpoints.
...
Customers can now save endpoints in [Web Assets](/api-shield/management-and-monitoring/) that contain variables in the hostname. Hostname variables are supported across all product features.