...
| --- | --- | --- |
| API Discovery | Authentication Posture | Schema validation |
| Schema learning | Broken Object Level Authorization vulnerability detection | JWT validation |
| Sequence Analytics | Risk labels | Sequence mitigation |
| | Volumetric abuse detection | Mutual TLS (mTLS) |
| | | GraphQL protection |
