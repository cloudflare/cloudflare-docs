...
[Application Profiles](/waf/detections/application-profiles/) provides the shared profile detection, analytics, and mitigation model. Schema Profile is its only current profile type.

[Schema Learning](/api-shield/management-and-monitoring/endpoint-management/schema-learning/) learns a Schema Profile from traffic. [Schema Validation](/api-shield/security/schema-validation/) supplies the same profile type through uploaded OpenAPI schemas.
...
| Improper Inventory Management                   | [Discovery](/api-shield/security/api-discovery/), [Schema learning](/api-shield/management-and-monitoring/endpoint-management/schema-learning/)                                                                                         |
