...
Endpoint Management uses the [Web Assets](/security/web-assets/) dashboard. Go to **Web Assets** > **Operations** to manage <GlossaryTooltip term="API endpoint">API endpoints</GlossaryTooltip>.
...
You can manage saved operations through the Cloudflare API. For more information, refer to the [operations API documentation](/api/resources/api_gateway/subresources/operations/methods/list/).
...
After you turn on Sensitive Data Detection, Web Assets marks operations whose responses matched the Sensitive Data Detection ruleset during the past week.
