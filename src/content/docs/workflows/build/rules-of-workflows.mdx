...
- [Rules of Durable Objects](/durable-objects/concepts/rules-of-durable-objects/): best practices for stateful, coordinated applications — useful when combining Durable Objects with Workflows.
