...
:::tip[Use Static Assets]

To call Workflows from Pages, you are required to deploy a separate Worker containing your Workflows. We recommend using [**Static Assets**](/workers/static-assets/) instead, as this allows you to add your Workflows directly to your Static Assets Worker.

If you wish to migrate your Pages project to Static Assets, follow this [guide](/workers/static-assets/migration-guides/migrate-from-pages/).
...
- Learn more about how to programmatically call and trigger Workflows from the [Workers API](/workflows/build/workers-api/)
