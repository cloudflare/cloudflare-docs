...
Workflows currently requires you to bind to a Workflow via the Wrangler configuration file, and does not yet support bindings via the Workers dashboard.
