...
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| Workflow class definitions per script                                                         | 64 MiB max uncompressed Worker size per [Worker size limits](/workers/platform/limits/#worker-size) | 64 MiB max uncompressed Worker size per [Worker size limits](/workers/platform/limits/#worker-size)       |
