...
| Maximum queued Workflow executions                                                            | 100,000 per day [shared with Workers daily limit](/workers/platform/limits/#worker-limits)  | Unlimited                                                                                                 |
...
| Total instances per account                                                                   | Unlimited                                                                                   | Unlimited                                                                                                 |
