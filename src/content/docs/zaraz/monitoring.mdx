...
You can also check activity data in the **Activity last 24hr** section, when you access [tools](/zaraz/get-started/add-tool/), [actions](/zaraz/custom-actions/) and [triggers](/zaraz/custom-actions/create-trigger/) in the dashboard.
