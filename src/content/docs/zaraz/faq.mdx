...
Yes. To learn more about how Zaraz compatibility with [<GlossaryTooltip term="content security policy (CSP)">CSP</GlossaryTooltip>](/fundamentals/reference/policies-compliances/content-security-policies/) configurations works, refer to the [Cloudflare Zaraz supports CSP](https://blog.cloudflare.com/cloudflare-zaraz-supports-csp/) blog post.
...
#### Does Zaraz work with Cloudflare Client-Side Security?

Yes. Refer to [Client-Side Security](/client-side-security/) (formerly known as Page Shield) for more information related to this product.
