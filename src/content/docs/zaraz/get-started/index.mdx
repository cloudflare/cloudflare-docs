...
For example, when adding Facebook pixel to your site, you can track all events you send using `zaraz.track()`. Read more about `zaraz.track()` [here](/zaraz/web-api/track).
...
Read more about `zaraz.ecommerce()` [here](/zaraz/web-api/ecommerce).
