...
For example, when adding Facebook pixel to your site, you can track all events you send using `zaraz.track()`. Read more about using `zaraz.track()` in our [documentation on tracking events with Zaraz](/zaraz/web-api/track).
