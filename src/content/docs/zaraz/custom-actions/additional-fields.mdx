...
Some tools supported by Zaraz let you add fields in addition to the required field. Fields can usually be added either to a specific action, or too all the action within a tool, by adding the field as a **Default Field**.
