...
Cloudflare does not guarantee against domain loss in the sense of fully indemnifying you for business losses if you lose your domain. However, they do have mechanisms in place to alert you of domain expiration [https://www.cloudflare.com/products/registrar/custom-domain-protection/] and redemption grace periods [https://www.cloudflare.com/products/registrar/custom-domain-protection/] should your domain expire. You may also elect to set up your domain registration to renew automatically {https://www.cloudflare.com/products/registrar/custom-domain-protection/]. In addition, they also offer a custom Domain Protection Service [https://www.cloudflare.com/products/registrar/custom-domain-protection/] to provide you with an additional layer of control over your domains.
