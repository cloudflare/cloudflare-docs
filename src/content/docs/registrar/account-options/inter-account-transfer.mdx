...
Navigate to the Support and select **Contact Cloudflare** from the Cloudflare dashboard. Select the category **Registrar** > **Transfer a domain between Cloudflare accounts**. Select the domain(s) in your account that you wish to transfer, enter a Summary and select **Open a Ticket**. 
