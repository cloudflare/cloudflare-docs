...
This process only applies to domains which are registered with Cloudflare Registrar. For domains with other Registrar, refer to [Move a domain between Cloudflare accounts
