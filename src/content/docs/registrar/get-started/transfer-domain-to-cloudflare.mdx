...
In some cases, premium (non-standard priced) domains may not be detected immediately. Pricing will be confirmed with the registry before submission, and you'll have the opportunity to review and approve any price adjustments.
...
- If the domain already has more than 9 years remaining, a full year may not be added. This is also subject to Registry policy.
