...
The process for bulk transferring domains to Cloudflare follows the same process for transferring a single domain. Even if you bulk transfer domains, you will be charged for each domain as bulk billing is not yet available.
