...
- **Query strings** are either absent or limited to the supported marketing parameters. For more information, refer to [Query parameters and cached responses](/automatic-platform-optimization/reference/query-parameters/).
- **No Page Rule** with `Cache Level: Bypass` matches the request. For more information, refer to [Page Rule integration with APO](/automatic-platform-optimization/reference/page-rule-integration/).
