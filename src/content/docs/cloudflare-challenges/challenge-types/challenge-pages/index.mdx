...
Cloudflare recommends Managed Challenge for most WAF rules. Unless there are specific compatibility issues, do not use other Challenge types.
...
Interactive Challenge Pages require a visitor to interact with the Interstitial Challenge Page to pass.

Cloudflare does not recommend Interactive Challenge. Use Managed Challenge instead. For more information, refer to the [Cloudflare blog post](https://blog.cloudflare.com/end-cloudflare-captcha/).
