...
<RelatedProduct header="Turnstile" href="/turnstile/" product="turnstile">
  Use Cloudflare's smart CAPTCHA [alternative](https://blog.cloudflare.com/introducing-cryptographic-attestation-of-personhood/) to run less intrusive Challenges.
</RelatedProduct>
