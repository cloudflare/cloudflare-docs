...
If your zone serves both browser pages and API endpoints, use rules to scope where strict enforcement applies.
...
- Start with **Minimize Friction** globally, then apply **Maximize Security** only to sensitive pages or paths.
- Start with **Maximize Security** globally, then add **Minimize Friction** rules for API hostnames or API paths.
