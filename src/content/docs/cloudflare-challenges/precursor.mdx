...
4. Turn on Precursor.
   ...
   ![Security Settings page in the Cloudflare dashboard, showing the Precursor card with the on/off toggle](~/assets/images/cloudflare-challenges/precursor-settings.png)
...
Disable JSD on the zone when you enable Precursor to avoid running both features on the same traffic. Precursor includes all detections previously covered by JSD, and any JSD-driven Security Rules will still apply.
