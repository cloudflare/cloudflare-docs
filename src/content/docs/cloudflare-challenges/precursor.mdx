...
3. Locate **Precursor**.
4. Toggle Precursor **On**.

<img
	src="/images/precursor-settings.png"
	alt="Precursor settings in the Cloudflare dashboard"
...
<img
	...
	alt="Precursor rules configuration"
	style="border:1px solid #e5e7eb;border-radius:6px;display:block;margin:0;margin-top:-50px;"
/>
