...
<Details header="Google Chrome (desktop and mobile)">
	...
	and Chromium-based browsers that track the current Chrome stable version
	:::caution Beta, Dev, Canary, Nightly, or other unreleased builds are not
	officially supported. :::
</Details>

<Details header="Mozilla Firefox">
	- Current version and two previous major versions - Extended Support Release
	(ESR) versions are supported
</Details>

<Details header="Safari">
	- Current version and two previous major versions - iOS Safari on current iOS
	version and two previous major versions
</Details>
