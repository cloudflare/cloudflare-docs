...
For session-level detection that informs when challenges should be applied, refer to [Precursor](/cloudflare-challenges/challenge-types/precursor/).
...
- [Precursor](/cloudflare-challenges/challenge-types/precursor/)
