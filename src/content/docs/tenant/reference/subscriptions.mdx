...
| [Gateway](/cloudflare-one/traffic-controls/)               | `TEAMS_GATEWAY_ENT`, `TEAMS_GATEWAY`                                                                          |
...
| [Image transformations](/images/optimization/transformations/overview/) | `IMAGE_RESIZING_ENT`, `IMAGE_RESIZING_BASIC`                                            |
...
| Feature                                                      | Subscription IDs                                  |
| ------------------------------------------------------------ | ------------------------------------------------- |
| [Cloudflare Network Firewall](/cloudflare-network-firewall/) | `MAGIC_FIREWALL_BASIC`, `MAGIC_FIREWALL_ADVANCED` |
| [Cloudflare WAN](/cloudflare-wan/)                           | `MAGIC_WAN`                                       |
