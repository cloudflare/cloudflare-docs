...
Before using the Tenant API, you need to [create an account](/fundamentals/account/create-account/), [verify your email address](/fundamentals/account/verify-email-address/), and [add your billing information](/billing/create-billing-profile/).
