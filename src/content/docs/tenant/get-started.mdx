...
Before using the Tenant API, you need to [create an account](/fundamentals/account/create-account/), [verify your email address](/fundamentals/user-profiles/verify-email-address/), and [add your billing information](/billing/get-started/create-billing-profile/).
