...
:::note
If you grant a website access to your microphone or camera, your IP address will [no longer be hidden](#known-issues).
:::
...
- Refer to [Known Limitations](/cloudflare-one/connections/connect-devices/warp/troubleshooting/known-limitations/) for information on devices, software, and configurations that are incompatible with Cloudflare WARP.
