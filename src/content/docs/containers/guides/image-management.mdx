...
## Cloudflare-managed image

Cloudflare provides the following managed image:
...
`cloudflare/debian-trixie` is a Cloudflare-managed identifier, not a public Cloudflare Docker Hub image.
