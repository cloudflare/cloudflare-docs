...
- You do not need to configure a Durable Object binding explicitly. Access the class via `ctx.exports.MyContainer` using [automatic loopback bindings](/changelog/2025-09-26-ctx-exports/).
