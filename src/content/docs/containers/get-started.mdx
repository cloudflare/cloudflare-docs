...
- Read [Deployments](/containers/deployments/) for what changes on deploy, version skew, and how to verify updates
- Use [Deploy with Workers Builds](/containers/deploy-with-workers-builds/) when you connect the Worker to Git
