...
requesting them, but not necessarily. Refer to ["How are container instance locations selected?"](/containers/faq/#how-are-container-instance-locations-selected)
for details.
...
environment variable](/containers/platform-details/environment-variables/#runtime-environment-variables) `CLOUDFLARE_DEPLOYMENT_ID.`
