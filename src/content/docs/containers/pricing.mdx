...
When you [enable observability for your Worker](/workers/observability/logs/workers-logs/#enable-workers-logs), or configure `containers[].observability` for a specific container, logs from that container will show in both the Containers and Observability sections of the Cloudflare dashboard.
