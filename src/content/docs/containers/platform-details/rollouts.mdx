...
A **rollout** applies a target container application configuration after you [deploy](/containers/deploy/) a Worker that uses Containers. The target can change the image, instance type, limits, placement, or other container settings.
