...
If you call `ctx.exports.MyContainer.get(id)` with a completely novel ID and launch
...
- This Worker request calls `getContainer(ctx.exports.MyContainer, "session-1337")`. Under the hood, this brings up a Durable
...
- The Worker again calls `getContainer(ctx.exports.MyContainer, "session-1337")`.
