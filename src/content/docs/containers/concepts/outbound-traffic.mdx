...
- [Connect to Workers bindings](/containers/concepts/workers-connections/) like KV, R2, and Durable Objects
...
- [Connect to Workers bindings](/containers/concepts/workers-connections/) — Access KV, R2, Durable Objects, and other bindings from a container
