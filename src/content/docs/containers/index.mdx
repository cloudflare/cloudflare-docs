...
<Feature header="Local development" href="/containers/local-dev/" cta="Develop locally">

Run your Worker and container together with `wrangler dev` or `vite dev` before you deploy.

</Feature>

<Feature header="Deploy" href="/containers/deploy/" cta="Deploy Containers">
...
<LinkTitleCard
	...
	href="/containers/platform-details/image-management/"
	icon="seti:docker"
>
...
<LinkTitleCard
	...
	href="/containers/platform-details/architecture/"
	icon="rocket"
>
...
<LinkTitleCard title="SSH" href="/containers/ssh/" icon="terminal">
