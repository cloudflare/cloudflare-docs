...
<LinkTitleCard
	...
	icon="seti:typescript"
>
	Reference the class and its routing, readiness checks, lifecycle hooks,
	and scheduling for existing applications.
</LinkTitleCard>
...
The `Container` class builds on Durable Objects and the runtime API. Existing applications may use its request proxying, readiness checks, lifecycle hooks, and scheduling. These helpers handle common Durable Object lifecycle tasks. Some features still use Durable Object storage and alarms.
