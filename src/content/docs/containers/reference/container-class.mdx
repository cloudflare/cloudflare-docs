...
Use `this.ctx.container.exec()` to start another process inside a running Container. Refer to [Execute commands](/containers/guides/execute-commands/) for startup, streaming, output, and process-control examples.
...
- <span id="enableinternet"></span>**`enableInternet`** (`boolean`, default:
  ...
  traffic](/containers/concepts/outbound-traffic/).
...
For more information, refer to [Handle outbound traffic](/containers/concepts/outbound-traffic/).
