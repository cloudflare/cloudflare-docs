...
Internal DNS is included with Cloudflare Gateway DNS Enterprise. If you have a Gateway DNS Enterprise subscription, you can start using Internal DNS immediately. There is no additional SKU or separate enrollment required.
