...
:::caution
If you simply need to configure internal records that resolve to Cloudflare, you can create a CNAME record on your local DNS that points to `<hostname>.cdn.cloudflare.net`:
`example.com CNAME example.com.cdn.cloudflare.net`

See our [DNS FAQ entry](/dns/troubleshooting/faq/#how-to-configure-records-on-local-dns-servers)
:::
...
<RelatedProduct
	...
	href="/cloudflare-one/policies/gateway/"
