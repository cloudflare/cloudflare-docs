...
Enterprise customers can also use Cloudflare DNS for their private network with [Internal DNS](/dns/internal-dns/) and proxy public hostnames to [private origins (Beta)](/dns/private-origins/).
...
<Feature
	header="DNS records"
	href="/dns/manage-dns-records/how-to/create-dns-records/"
>
	DNS records make resources available on your domain, and allow you to
	configure services such as email.
</Feature>
...
<Feature header="CNAME flattening" href="/dns/cname-flattening/">
	...
	record at your apex domain (`example.com`). Paid accounts can choose to
	flatten all CNAME records on their domain.
</Feature>

<br />

Refer to [DNS features and availability](/dns/reference/all-features/) for a complete list of features and their availability according to different Cloudflare plans and configurations.
...
<RelatedProduct header="Registrar" href="/registrar/" product="registrar">
	Before you can start using Cloudflare DNS you must first have a domain. Buy
	and renew your domain at cost with Cloudflare Registrar.
</RelatedProduct>

<RelatedProduct header="DNS Resolver" href="/1.1.1.1/" product="1.1.1.1">
	Cloudflare DNS focuses on businesses and their domain administration. If you
	are a consumer and want a more private way to browse the Internet, check out
