...
Enterprise customers can also use Cloudflare DNS for their private network with [Internal DNS (Beta)](/dns/internal-dns/) and proxy public hostnames to [private origins (Beta)](/dns/private-origins/).
