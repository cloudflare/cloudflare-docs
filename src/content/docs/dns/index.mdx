...
Enterprise customers can also use Cloudflare DNS for their private network with [Internal DNS](/dns/internal-dns/), proxy public hostnames to [private origins (Beta)](/dns/private-origins/), and more.
