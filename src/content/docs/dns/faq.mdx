...
To verify that your domain's parent zone is publishing the Cloudflare nameservers assigned to you (for example, when your zone is stuck in **Pending Nameserver Update** status), refer to [Zone stuck in Pending Nameserver Update](/dns/zone-setups/troubleshooting/pending-nameservers/).
