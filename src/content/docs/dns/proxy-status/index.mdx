...
For a detailed list of scenarios, refer to [Common scenarios](/dns/proxy-status/common-scenarios/). For hard constraints on proxying, refer to [Proxying limitations](/dns/proxy-status/limitations/).
