...
Enforce DNS-only does apply to proxied [Load Balancer](/load-balancing/) records.
...
- [Cloudflare Tunnel](/tunnel/) records: These records are required for tunnel routing and setting them to DNS-only may break tunnel connectivity.
