...
### Expected behaviors and additional configuration

When traffic is proxied through Cloudflare, the following behaviors apply. Depending on your origin configuration, you may need to consider the following:
