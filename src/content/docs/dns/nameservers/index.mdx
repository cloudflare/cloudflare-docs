...
Standard nameservers are hosted on `ns.cloudflare.com` and follow the pattern `<proper_name>.ns.cloudflare.com`c.
...
:::
`<ace.ns.cloudflare.com>.ns.cloudflare.com`>
`<wanda.ns.cloudflare.com>.ns.cloudflare.com`>
[primary (full)](/dns/zone-setups/full-setup/)
