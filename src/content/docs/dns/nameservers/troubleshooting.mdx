...
head:
  - tag: title
    content: Troubleshooting nameservers
---

If you see unexpected results when changing your nameservers to Cloudflare, review the following troubleshooting questions.
