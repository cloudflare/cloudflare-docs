...
Platforms like Shopify and GoHighLevel pre-configure domains with their own Cloudflare nameserver pair through partner programs. Adding the same domain to your own Cloudflare account assigns a different nameserver pair, which creates a conflict.
