...
:::caution[Foundation DNS and dashboard options]
<Render file="foundation-dns-sub-callout"/>
:::

The default TTL is 24 hours (or 86,400 seconds), but Enterprise customers have the option to lower this value depending on their needs. For example, shorter TTLs can be useful when you are changing nameservers or migrating a zone. Accepted values range from 30 to 86,400 seconds.
