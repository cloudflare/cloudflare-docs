...
To use custom nameservers, a zone must be using Cloudflare as [Primary setup (Full)](/dns/zone-setups/full-setup/) or [Secondary](/dns/zone-setups/zone-transfers/cloudflare-as-secondary/) DNS provider.
