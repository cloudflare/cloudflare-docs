...
- Cloudflare [responds to all DNS queries](/fundamentals/concepts/how-cloudflare-works/#how-cloudflare-works-as-a-dns-provider) for your hostnames and your DNS records are cached across the [Cloudflare global network](https://www.cloudflare.com/network/), speeding up your domain.
