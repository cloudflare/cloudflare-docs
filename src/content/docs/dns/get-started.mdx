...
In the most common setup (full), you [add your domain](/fundamentals/setup/manage-domains/add-site/), we import your DNS records, and you [update your nameservers](/dns/nameservers/update-nameservers/) to make Cloudflare your primary DNS provider. Once the setup is completed:
...
- Cloudflare [responds to all DNS queries](/fundamentals/concepts/how-cloudflare-works/#how-cloudflare-works-as-a-dns-provider) for your hostnames.
