...
Ensure that you have the necessary DNS records in **DNS** > **Records** on the Cloudflare dashboard. This includes having the following records:
...
DNS resolution failures occur if [DNSSEC is not disabled](/dns/dnssec/#disable-dnssec) at your domain provider before you add the domain to Cloudflare. For more information, refer to [Cannot add domain](/dns/zone-setups/troubleshooting/cannot-add-domain/) and [Troubleshooting DNSSEC](/dns/dnssec/troubleshooting/).
