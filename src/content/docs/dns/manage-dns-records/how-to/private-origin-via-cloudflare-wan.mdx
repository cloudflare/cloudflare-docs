...
- **DNS entitlement enabled on your account**: Contact your Cloudflare account team to request access.
...
For the dashboard and API steps, refer to [Private network routing](/dns/manage-dns-records/how-to/private-network-routing/).
...
- Review the [Private network routing](/dns/manage-dns-records/how-to/private-network-routing/) reference for dashboard and API details.
