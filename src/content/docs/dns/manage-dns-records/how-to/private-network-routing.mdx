...
For an end-to-end setup walkthrough using Cloudflare WAN (formerly Magic WAN) IPsec, refer to [Set up a private origin via Cloudflare WAN](/dns/manage-dns-records/how-to/private-origin-via-cloudflare-wan/).
