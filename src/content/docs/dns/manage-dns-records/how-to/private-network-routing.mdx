...
Traffic routes through your default [virtual network](/cloudflare-one/networks/connectors/cloudflare-tunnel/private-net/cloudflared/tunnel-virtual-networks/). Selecting a specific virtual network is not supported.
:::
...
[Check same partial as proxied behavior]
