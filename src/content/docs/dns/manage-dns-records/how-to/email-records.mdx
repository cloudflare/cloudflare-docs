...
<Render file="domain-spoofing" product="new-product" />

### Configure email security records

Refer to [Security records](/new-product/security-records/) to learn how to set up your email security records.
