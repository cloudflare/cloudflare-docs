...
For more guidance, refer to [Redirect domain to subdomain](/fundamentals/manage-domains/manage-subdomains/#redirect-the-apex-domain-to-a-subdomain) or [Redirect one domain to another](/fundamentals/manage-domains/redirect-domain/).
