...
For the dashboard and API steps, refer to [Private network routing](/dns/manage-dns-records/how-to/private-origins/private-network-routing/).
...
- Review the [Private network routing](/dns/manage-dns-records/how-to/private-origins/private-network-routing/) reference for dashboard and API details.
