...
Comments and tags are only supported for [primary zones (full setup)](/dns/zone-setups/full-setup/) and [partial zones (CNAME setup)](/dns/zone-setups/partial-setup/).
