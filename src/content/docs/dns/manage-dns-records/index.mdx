...
If you are an Enterprise customer and require more DNS records on an Enteprise zone, contact your account team. Cloudflare can support millions of DNS records on a single zone.
