...
<Stream
	id="cd8b06dfaf43918ab8d0590f03ec68b7"
	title="How DNS and nameservers work"
	thumbnail="https://imagedelivery.net/xDOJvHcv1KwTQn6S-BGFIw/64a4facf-6882-4c95-9001-492fdeae8200/public"
/>
...
<Details header="Record fields">
	...
	different information in their corresponding `Content` field. - **Name**:
	Identifies the resource that the record resolves to. Depending on the purpose
	of the record, the value you want to add to this field will also change. -
	**Content**: Contains the core value of a record, depending on the record
	type. - **TTL**: Controls how long each record is cached by DNS resolvers. -
	**Comment**: An optional note for your own reference. Use comments to track
	record ownership, link to internal tickets, or note which service a record
	belongs to. Refer to [Comments and
	tags](/dns/manage-dns-records/reference/record-attributes/) for details.
</Details>
