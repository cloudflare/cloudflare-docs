...
- **Key Signing Key (KSK)**: Rarely rotated and remains stable. When rotation occurs, CDS and CDNSKEY records signal the change to registrars that support [RFC 8078](https://www.rfc-editor.org/rfc/rfc8078.html).
