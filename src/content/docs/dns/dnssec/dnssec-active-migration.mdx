...
description: >-
  Follow this tutorial to migrate an existing DNS zone to Cloudflare without having to disable DNSSEC. This procedure involves cross-importing the [zone signing keys (ZSKs) from one provider to the other.
---
