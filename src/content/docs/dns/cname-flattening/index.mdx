...
- CNAME to a different Cloudflare account is prohibited and will result in a [1014 error (CNAME Cross-User Banned)](/support/troubleshooting/http-status-codes/cloudflare-1xxx-errors/error-1014/)
