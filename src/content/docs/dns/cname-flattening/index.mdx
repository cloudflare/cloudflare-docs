...
Only A and AAAA target records are flattened. Refer to the information below for the expected behaviors when you have TXT, MX, or another CNAME record as the target.
