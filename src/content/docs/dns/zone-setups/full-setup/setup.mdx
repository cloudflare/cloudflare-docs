...
:::note
If you do not already have a [domain name](https://www.cloudflare.com/learning/dns/glossary/what-is-a-domain-name/), get one at-cost through [Cloudflare Register](https://dash.cloudflare.com/?to=/:account/domains/register).
