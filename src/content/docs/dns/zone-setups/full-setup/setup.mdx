...
Go to the **DNS Records** page and locate the your **Cloudflare Nameservers**. If you just completed the onboarding flow, your assigned nameservers were also displayed on the activation screen.
