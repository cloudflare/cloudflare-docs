...
head:
  - tag: title
    content: Use Cloudflare as primary provider (Full setup)
description: >-
  Change your nameservers to use Cloudflare as your primary DNS provider. On this setup, you can use our reverse proxy and manage your records at Cloudflare.
---
