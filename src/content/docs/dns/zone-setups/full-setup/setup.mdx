...
If you want to use Cloudflare as your primary DNS provider and manage your DNS records on Cloudflare, your domain should be using a [primary setup (also known as full setup)](/dns/zone-setups/full-setup/).
