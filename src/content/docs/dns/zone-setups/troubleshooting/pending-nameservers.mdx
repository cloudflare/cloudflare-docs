...
After the stale DS records are removed and expire from cache, your Cloudflare zone will activate automatically. You can then re-enable DNSSEC via the Cloudflare dashboard if needed.
