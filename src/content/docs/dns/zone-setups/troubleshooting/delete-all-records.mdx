...
You can delete records in bulk via the dashboard, which removes the need for custom scipts as the one below. Refer to [Batch record changes](/dns/manage-dns-records/how-to/batch-record-changes/#delete-records-in-bulk) for details.
:::
