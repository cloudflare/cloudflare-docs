...
Cloudflare cannot provide authoritative DNS resolution for a domain — a [domain on a primary setup (full)](/dns/zone-setups/full-setup/) — when **DNSSEC** is enabled at your domain registrar.
...
- **Error: Cannot be found** OR **`<your domain>` is not a registered domain (code: 1049)**
  ...
  - **Resolution:** Contact [Cloudflare Support](/support/contacting-cloudflare-support/) if you require assistance adding a `.gov` and/or other domains that require manual registration.
...
- [Troubleshooting primary setup (full)](/dns/zone-setups/full-setup/troubleshooting/)
- [Troubleshooting DNSSEC](/dns/dnssec/troubleshooting/)
