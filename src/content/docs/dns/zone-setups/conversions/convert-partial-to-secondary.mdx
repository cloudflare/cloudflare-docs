...
description: >-
  If you initially set up a partial zone on Cloudflare, you can later convert it to use a secondary setup. This page will guide you through this conversion using [export and import] and API calls.
---
