...
description: >-
  If you initially configured a [full setup] you can later convert your zone to use [incoming zone transfers (Cloudflare as secondary)] Follow the steps below to achieve this conversion.
---
