...
description: >-
  If you initially set up incoming zone transfers (Cloudflare as secondary), you can later convert your zone to use a partial setup. Follow the steps below to achieve this conversion.
---
