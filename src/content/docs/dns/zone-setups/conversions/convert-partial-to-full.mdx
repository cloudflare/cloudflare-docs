...
description: >-
  If you initially set up a partial domain on Cloudflare, you can later migrate it to a full setup. To minimize downtime, it is recommended having a certificate in place beforehand. You should also delete the previous [zone activation TXT record] before converting your zone.
---
