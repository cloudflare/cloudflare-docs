...
<Tabs syncKey="dashPlusAPI">
  <TabItem label="Dashboard">
	  ...
	  1. On the Cloudflare dashboard, go to the zone **Overview** page.
...
Add the **Verification TXT Record** at your new authoritative DNS provider. Cloudflare will verify the TXT record and send a confirmation email. This can take up to a few hours.
...
Once verification is complete, update the nameservers at your domain registrar to point to your new authoritative DNS provider.