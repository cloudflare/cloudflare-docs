...
description: >-
  With outgoing zone transfers, you keep Cloudflare as your primary DNS provider and use one or more secondary providers for increased availability and fault tolerance. You should configure [multi-signer DNSSEC](https://developers.cloudflare.com/dns/dNSsec/multi- signer-dnssec/). After setting up [Cloudflar as primary], follow the steps below to enable DNSSec.
---
