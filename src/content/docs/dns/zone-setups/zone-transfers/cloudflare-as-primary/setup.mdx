...
To link a primary zone to a peer using the API, send a [POST](</api/operations/secondary-dns-(-primary-zone)-create-primary-zone-configuration>) request with the ID of the peer you [previously created](#2-create-peer-dns-server-optional).
...
## 5. Update your secondary DNS provider
...
## 6. Add secondary nameservers within Cloudflare
...
## 7. Enable outgoing zone transfers
...
## 8. Add secondary nameservers to registrar
