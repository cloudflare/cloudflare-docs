...
description: >-
  With incoming zone transfers, you can keep your primary DNS provider and use Cloudflare as a secondary DNS provider. The TSIG names configured at your primary and secondary DNS providers have to be exactly the same.
---
