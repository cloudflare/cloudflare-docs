...
- **TSIG name** (optional): A descriptive name of the TSIG following domain name syntax ([RFC 8945 section 4.2](https://datatracker.ietf.org/doc/html/rfc8945#section-4.2)). <Render file="tsig-name-match" product="dns" />
...
- [Nameserver names](/dns/zone-setups/full-setup/setup/#31-get-nameserver-names), which should have **secondary** in the name.
...
At your registrar, add the secondary nameservers [specified in the Cloudflare dashboard](/dns/zone-setups/full-setup/setup/#31-get-nameserver-names). Do not remove your primary DNS provider's nameservers.
