...
Moved zones are automatically deleted after 7 days. However, a zone with an active paid subscription will not be deleted if its domain is not active in another account.
