...
Moved zones will be deleted automatically after 7 days. Please note that zones which are not already active in another Cloudflare account and where the moved zones has an active paid subscription will not be automatically deleted.
