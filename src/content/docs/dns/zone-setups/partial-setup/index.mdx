...
- [Set up a CNAME domain (partial)](/dns/zone-setups/partial-setup/setup/)
...
When you have a partial zone (<GlossaryTooltip term="partial setup" link="/dns/zone-setups/partial-setup/">CNAME setup</GlossaryTooltip>), Cloudflare resolves [DNS records differently](/dns/zone-setups/partial-setup/dns-resolution/) than for primary zones (full setup).
