...
description: >-
  A partial (CNAME) setup allows you to use Cloudflare's reverse proxy while maintaining your primary and authoritative DNS provider. A partial setup is only available to customers on a Business or Enterprise plan.
---
