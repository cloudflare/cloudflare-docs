...
:::note[Setup compatibility]

The availability of subdomain setups depends on the combination of parent and child zone configurations. Review the [available setups](/dns/zone-setups/subdomain-setup/setup/#available-setups) to understand which combinations are supported.
