...
Application security and performance focuses on resources available on the public Internet. Get started by [onboarding a domain](/fundamentals/manage-domains/add-site/).
...
Network services extend protection and acceleration to cloud, on-premise, or hybrid networks. Get started with [Magic Transit](/magic-transit/) or [Magic WAN](/magic-wan/).
