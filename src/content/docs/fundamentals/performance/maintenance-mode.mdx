...
Users on all plans can [create an Access application](/cloudflare-one/applications/configure-apps/self-hosted-public-app/). Make sure to limit your [Access policy](/cloudflare-one/access-controls/policies/access/policy-management/#create-a-policy) to only include yourself and any collaborators.
