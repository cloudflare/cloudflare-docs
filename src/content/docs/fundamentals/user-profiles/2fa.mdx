...
After [enabling 2FA on your Cloudflare account](profile/access-management/authentication/two-factor), you can select **Manage** to configure 2FA security key authentication.
...
1. Once your security key is plugged in, go to **Profile** > **Access Management** > **Authentication**.
...
To reconfigure, follow [Steps 1-7](profile/access-management/authentication/two-factor) as detailed above.
...
1. Navigate to **User Profile**, then **Access Management** > **Authentication**.
...
2. Select **My Profile**.
3. Select **Access Management** > **Authentication**.
...
2. Select **Profile**.
3. Select the **Access Management** > **Authentication**.
