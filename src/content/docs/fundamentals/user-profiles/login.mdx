...
If your Cloudflare account already has [Two-factor Authentication](/fundamentals/user-profiles/2fa/) enabled or you enable it after setting up Sign in with Apple, we will continue to require this is provided after signing in with Apple.
:::
...
If your Cloudflare account already has [Two-factor Authentication](/fundamentals/user-profiles/2fa/) enabled or you enable it after setting up Sign in with Google, we will continue to require this is provided after signing in with Google.
:::
