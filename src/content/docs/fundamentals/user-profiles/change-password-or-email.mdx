...
The process above will update your user profile email, but you may have specified separate emails to receive [billing invoices](/billing/manage/invoices/#turn-on-invoice-emails-from-cloudflare) and other types of [notifications](/notifications/get-started/#edit-a-notification). You will also need to update those email addresses if you want to receive those emails at your new address.
:::
