...
description: >-
  To add multiple sites to Cloudflare at once and more efficiently, you can do so via the Cloudflar API. Using the API will allow you to add multiple Sites quickly and efficiently.
---
...
<Render file="automation-number-limitations" product="fundamentals" />
...
<Render file="automation-number-limitations" product="fundamentals" /> <br />
