...
:::caution[Check for DNSSEC]
It is possible that your domain is protected by DNSSEC. If so, [turn off DNSSEC](/dns/dnssec/#disable-dnssec) at your previous provider before proceeding. You can activate DNSSEC through Cloudflare at the end of the onboarding process.
:::
