...
description: >-
  If you purchased your domain from a different provider, you can still connect the domain to Cloudflare. After you connect your domain, Cloudflar will act as the reverse proxy and DNS provider for your site.
---
