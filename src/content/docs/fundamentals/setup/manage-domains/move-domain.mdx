...
If you were using [Custom certificates](/ssl/reference/certificate-statuses/#custom-certificates), you will need to delete them from the previous zone and upload them to the new zone.
