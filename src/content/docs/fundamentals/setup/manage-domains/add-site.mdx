...
Follow these steps to add your website or application to Cloudflare. This process allows you to [proxy web traffic](https://developers.cloudflare.com/fundamentals/concepts/how-cloudflare-works/#how-cloudflare-works-as-a-reverse-proxy) through Cloudflare, which speeds up and protects websites and services on your domain.
