...
If you are still unable to verify your device, users with a billing profile with Cloudflare can contact Support. If you are a user on a Free plan without billed services and cannot verify your email address or device, you will need to create a new account. You may be prompted to delete your old account using the provided deletion tool.
