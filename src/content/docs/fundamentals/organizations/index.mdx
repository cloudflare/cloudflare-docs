...
- **[MSSP/Distributor Organizations](/fundamentals/organizations/for-mssp-distributors/)**: A multi-tier structure for channel partners and managed service providers. A Distributor Organization contains child MSSP Organizations, each managing their own customer accounts.
...
- **API, SDK, and Terraform support**: Manage Organizations programmatically with the Cloudflare API, SDKs, or Terraform provider.
