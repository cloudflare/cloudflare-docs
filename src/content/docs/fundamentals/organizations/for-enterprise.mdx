...
- You must be a Super Administrator on at least one Enterprise plan account.
...
- When you navigate to any account within your Organization, you automatically have Super Administrator permissions on that account.
