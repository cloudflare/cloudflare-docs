...
Organization Super Administrators can create up to five Free accounts within an Enterprise Organization. To add accounts beyond this limit, contact [Cloudflare Support](/support/contacting-cloudflare-support/) to create them, then [assign the accounts to your Organization](#assign-existing-accounts).
