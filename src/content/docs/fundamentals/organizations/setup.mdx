...
- You must have [two-factor authentication (2FA)](/fundamentals/setup/account/account-security/2fa/) or [single sign-on (SSO)](/fundamentals/manage-members/dashboard-sso/) enabled.
