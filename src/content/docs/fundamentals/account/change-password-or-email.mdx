...
:::warn
You will not be able to change your email address in the following circumstances:

- If you did not successfully verify the original email address - for example if it was mis-typed or an incorrect, non-working email address. You will need to create a new account with a working email address and [move domains](/fundamentals/manage-domains/move-domain/).
- If your administrator has [enabled Single sign-on (SSO)](/cloudflare-one/applications/configure-apps/dash-sso-apps/)
:::
