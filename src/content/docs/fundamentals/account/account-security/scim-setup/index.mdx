...
2. Members of each user group can be assigned one or more policies. Each policy defines one or more roles to be applied to all group members thereof.
...
- You must be a [Super Administrator](/fundamentals/manage-members/roles/) for the initial setup.
