...
5. In the Push Groups tab, add the Okta groups you want to synchronize with Cloudflare Dash. View these Okta groups in the dashboard under Manage Account > Manage members > Members > User Groups.
