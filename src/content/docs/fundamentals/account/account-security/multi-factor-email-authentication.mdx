...
Email MFA can only be disabled by enabling [two-factor authentication](/fundamentals/account/account-security/2fa/).
:::
...
* [Secure user access with two-factor authentication](/fundamentals/account/account-security/2fa/)
