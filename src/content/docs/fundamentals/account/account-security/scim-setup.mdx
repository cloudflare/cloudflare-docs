...
* Map your IdP groups to a Cloudflare built-in [Role](/fundamentals/manage-members/roles/). Groups may only be linked to one role.
...
Refer to the list of [Roles](/fundamentals/manage-members/roles/) for more details.
