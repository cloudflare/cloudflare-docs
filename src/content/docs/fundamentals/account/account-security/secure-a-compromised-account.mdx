...
For more guidance on changing your password, refer to [Change email address or password](/fundamentals/account/change-password-or-email/).
...
To prevent future compromises, make sure that you have [Two-Factor Authentication (2FA)](/fundamentals/account/account-security/2fa/) enabled on your account.
