...
Users leveraging [Single Sign-On (SSO)](/cloudflare-one/applications/configure-apps/dash-sso-apps/) or [two-factor authentication (2FA)](/fundamentals/account/account-security/2fa/) will not be subject to these requirements given the higher level of security provided by those features.

We encourage you to [enable two-factor authentication](/fundamentals/account/account-security/2fa/) to secure your account.

Cloudflare account Super Administrators can also require that [all members enable 2FA](/fundamentals/account/account-security/2fa/#enable-two-factor-authentication-for-your-cloudflare-account). This functionality can be enabled by going to **Manage Account** > **Members** in the Cloudflare dashboard.
