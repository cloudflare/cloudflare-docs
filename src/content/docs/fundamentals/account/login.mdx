...
* *Different Cloudflare account email as Apple ID*: This will create a new Cloudflare account. If you want to log into an existing account, [change your email address](/fundamentals/account/change-password-or-email/) to match the one used for your Apple ID.
...
1. [Add a new member to your account](/fundamentals/manage-members/manage/#add-account-members). For example, a secondary email address.
