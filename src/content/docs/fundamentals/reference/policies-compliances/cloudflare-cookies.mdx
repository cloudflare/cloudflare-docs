...
To review Cloudflare Access cookies and their behavior, refer to [Access cookies](/cloudflare-one/access-controls/applications/http-apps/authorization-cookie/#access-cookies).
