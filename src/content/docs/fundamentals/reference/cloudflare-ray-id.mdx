...
All customers can view Ray IDs and associated information — IP address, user agent, ASN, etc. — by looking through the [Sampled logs](/waf/analytics/security-events/#sampled-logs) in Security Events.
...
![Example of adding a new filter in Security Events](~/assets/images/waf/events-add-filter.png)
