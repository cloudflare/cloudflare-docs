...
The crawler uses a _User-Agent_ of `Cloudflare-AI-Search`. You can allow or block it with WAF rules using its [bot detection ID](/ai-search/configuration/data-source/website/#allow-ai-search-through-waf).
