...
- `X-Accel-Redirect`
- `Alt-Svc`
- `Cache-Tag` — Removed before the response is sent to the visitor or passed to a [Worker](/workers/). Refer to [Purge by cache-tags](/cache/how-to/purge-cache/purge-by-tags/).
