...
- **Under Attack mode adds a JavaScript challenge at the edge.** You may still see attempted requests in your origin logs or Cloudflare analytics, because the challenge page itself generates a request that is logged.
