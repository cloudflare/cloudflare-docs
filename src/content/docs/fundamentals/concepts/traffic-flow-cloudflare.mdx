...
* Connect your private application to Cloudflare using [secure tunnels](/cloudflare-one/networks/connectors/cloudflare-tunnel/), and use a [device agent](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/) to connect as a user.
