...
There may be times when you will want to manaully pay an invoice
...
3. Click on “Billing”
4. If you see an unpaid invoice click on it
5. From within the invoice, click the “Pay Online” link
6. You will then be redirected to the BIlling system where you can proceed with your payment
7. Once the payment is made you should be able to make any desired changes to your subscription including downgrades and cancelation that are in adherence with Cloudflare policies 
