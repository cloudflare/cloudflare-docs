...
3. Click on “Billing”
5. Any unpaid invoices will appear at the bottom of your screen with a "Pay Now" button next to them
6. Click that button to proceed with your payment
7. Once all invoices are paid and processed you should be able to make any desired changes to your subscription including downgrades and cancelation that are in adherence with Cloudflare policies 
