...
Most challenges are quick to complete and typically take only a few seconds. If a challenge takes longer, verify your network stability and follow the [troubleshooting steps](#troubleshooting).
