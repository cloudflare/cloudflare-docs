...
If you have another _A_ or _AAAA_ record in your Cloudflare **DNS** or your Cloudflare **Load Balancer** provides another <GlossaryTooltip term="endpoint" link="/load-balancing/understand-basics/load-balancing-components/">endpoint</GlossaryTooltip> in the same pool, **Zero-Downtime Failover** automatically retries requests to your origin even before a Load Balancing decision is made.
