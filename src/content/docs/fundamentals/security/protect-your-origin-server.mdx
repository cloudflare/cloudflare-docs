...
- **DNS**:
  ...
  4. **Rotate origin IPs**: Once [onboarded](/dns/zone-setups/full-setup/setup/#35-verify-changes), rotate your origin IPs, as DNS records are in the public domain. Historical records are kept and would contain IP addresses prior to joining Cloudflare
...
<Render file="zero-downtime-failover-retry-on-error" product="fundamentals" />
<br />
