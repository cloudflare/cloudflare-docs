...
<Tabs syncKey="dashPlusAPI">
	<TabItem label="Dashboard">
		<Steps>
			...
			6. Optional: Add non-required fields, such as Client URL, Logo URL, Policy URL, Terms of Service URL, Post-logout Redirect URLs, and Allowed CORS Origins. These fields are optional for private clients, but you must add them before you can make a client public.
