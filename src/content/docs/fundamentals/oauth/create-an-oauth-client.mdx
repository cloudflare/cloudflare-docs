	...
	<TabItem label="Dashboard">
		<Steps>
			...
			5. Enter the required configuration details:
				...
				- Redirect URLs
			6. Optional: Add non-required fields, such as Client URL and Logo. These fields are optional for private clients, but you must add both before you can make a client public.
