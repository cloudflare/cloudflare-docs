...
<Tabs syncKey="dashPlusAPI">
	<TabItem label="Dashboard">
		<Steps>
			...
			6. Optional: Add non-required fields, such as Client URL, Logo URL, Policy URL, Terms of Service URL, Post-logout Redirect URLs, and Allowed CORS Origins. All of these fields are optional for private clients. If you plan to make a client public, you must also add the [required fields for public clients](#required-fields-for-public-clients).
			7. Select **Continue** and define the scopes required for your client. All clients must have at least one scope.
...
### Required fields for public clients

Before you can make a client public, you must populate the following fields:
