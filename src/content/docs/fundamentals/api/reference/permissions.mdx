...
<Render file="account-permissions-table" params={{ one: "Edit", two: "Cloudflare", three: "Cloudflare" }} />

</TabItem> <TabItem label="API">

<Render file="account-permissions-table" params={{ one: "Write", two: "Argo", three: "" }} />
