...
New and rolled Global API Keys use the `cfk_` prefixed [scannable format](/fundamentals/api/get-started/token-formats/), which allows credential scanning tools to detect leaked keys.
