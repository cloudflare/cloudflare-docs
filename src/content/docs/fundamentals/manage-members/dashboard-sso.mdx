...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Access controls** > **Applications** > select your **SSO App**.
...
4. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Reusable components** > **Custom pages**.
