...
For setup instructions, refer to [Granular permissions for Access](/cloudflare-one/access-controls/granular-permissions/) or [Granular permissions for Tunnels and Mesh nodes](/cloudflare-one/networks/connectors/granular-permissions/).
