...
For information about running `cloudflared` in a Kubernetes deployment, refer to the [Kubernetes guide](/cloudflare-tunnel/deployment-guides/kubernetes/).
:::

## Remotely-managed tunnels

1. To create a remotely-managed tunnel, follow the [dashboard setup guide](/cloudflare-tunnel/get-started/create-remote-tunnel/).
...
1. To create a locally-managed tunnel, complete Steps 1 through 5 in the [CLI setup guide](/cloudflare-tunnel/other-tunnel-types/local-management/create-local-tunnel/).
