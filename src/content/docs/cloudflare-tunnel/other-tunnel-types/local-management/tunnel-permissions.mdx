...
| **File type**           | `.pem`                                                                                                                           | `.json`                                                                                                                          |
| **Stored in**           | [Default directory](/cloudflare-tunnel/get-started/tunnel-useful-terms/#default-cloudflared-directory) | [Default directory](/cloudflare-tunnel/get-started/tunnel-useful-terms/#default-cloudflared-directory) |
