...
:::note
If you would prefer to manually install the tunnel, refer to [Install and run the tunnel](/cloudflare-tunnel/get-started/create-remote-tunnel-api/#4-install-and-run-the-tunnel).
:::
