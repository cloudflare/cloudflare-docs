...
Three GraphQL datasets are available. All three return aggregate data only — no raw per-connection records are exposed.
...
- `requests` – `uint64` — Total request count. _(Request dataset)_
- `bytesToGateway` – `uint64` — Total bytes sent from client to gateway. _(Request dataset)_
- `bytesToClient` – `uint64` — Total bytes sent from gateway back to client. _(Request dataset)_
- `connections` – `uint64` — Total connection count. _(Ingress and egress connection datasets)_

</Details>

<Details header="Quantile fields">

- `clientRelayRttMsP50` – `float64` — Median round-trip time between client and relay, in milliseconds. _(Ingress connection dataset)_
- `clientRelayRttMsP95` – `float64` — 95th percentile RTT between client and relay, in milliseconds. _(Ingress connection dataset)_
- `clientRelayRttMsP99` – `float64` — 99th percentile RTT between client and relay, in milliseconds. _(Ingress connection dataset)_
- `relayGatewayRttMsP50` – `float64` — Median round-trip time between relay and gateway, in milliseconds. _(Egress connection dataset)_
- `relayGatewayRttMsP95` – `float64` — 95th percentile RTT between relay and gateway, in milliseconds. _(Egress connection dataset)_
- `relayGatewayRttMsP99` – `float64` — 99th percentile RTT between relay and gateway, in milliseconds. _(Egress connection dataset)_
...
All three datasets share the same argument signature.
...
<Details header="ohttpRelayRequestMetricsAdaptiveGroups">
...
<Details header="ohttpRelayIngressConnMetricsAdaptiveGroups">
...
<Details header="ohttpRelayEgressConnMetricsAdaptiveGroups">
