...
sidebar:
  order: 3
description: >-
  By default, Version Management is not enabled on a zone. To enable Version Management, log in to the Cloudflare dashboard. Create default environments for **Production**, **Staging**, and **Development.
---
