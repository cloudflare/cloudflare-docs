...
* Your user account must have a Super Administrator or Administrator [role](/fundamentals/setup/manage-members/roles/). **Zone Versioning** roles cannot create new versions.
