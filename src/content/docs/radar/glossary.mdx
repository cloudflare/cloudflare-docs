...
Radar's prefix routing page displays realtime BGP routes as a Sankey diagram. This visualization is built using MRT data from [RouteViews][route-views] and [RIPE RIS][ripe-ris], combined with realtime streams from RouteViews' Kafka instance and [RIS Live][ris-live].
