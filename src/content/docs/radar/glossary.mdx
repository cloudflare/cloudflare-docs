...
Measurements are aggregated across requests from all Cloudflare data centers made to cloud-based origin infrastructure. Performance data for specific regions is quartile-based, but averages are used for overall and provider-level views.
