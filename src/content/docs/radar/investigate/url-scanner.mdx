...
You can also use the [API](https://developers.cloudflare.com/api/resources/url_scanner/subresources/scans/methods/create/#(params)%20default%20%3E%20(param)%20account_id%20%3E%20) to select a country to scan a URL from.

In Security Center, you can retrieve information already pre-filtered by:
