...
<Render file="c3-run-command-with-directory" product="workers" params={{ one: "hijack-alerts" }} />

<Render file="c3-post-run-steps" product="workers" params={{ one: "Demo application", two: "Scheduled Worker (Cron Trigger)", three: "JavaScript" }} />
