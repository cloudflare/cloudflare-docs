...
<LinkCard
	title="Deploy Workers from agents"
	href="/workers/platform/claim-deployments/"
	description="Use wrangler deploy --temporary to deploy with a temporary preview account before authentication."
/>
