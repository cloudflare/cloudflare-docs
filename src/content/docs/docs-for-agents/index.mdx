...
- Set up [Claude Code](/agent-setup/claude-code/), [Cursor](/agent-setup/cursor/), [Codex](/agent-setup/codex/), [GitHub Copilot](/agent-setup/github-copilot/), [OpenCode](/agent-setup/opencode/), or [Windsurf](/agent-setup/windsurf/) with Cloudflare [Skills](#skills) and [MCP servers](#mcp-servers).
- Append `/index.md` to any docs page URL and paste the Markdown into your conversation.
- Add a product-level [`llms.txt`](#per-product-endpoints) URL to your AI tool's configuration file for an index of relevant pages.
- Add the [OpenAPI specification](#openapi-specification) to your AI tool's context for full Cloudflare API coverage.
