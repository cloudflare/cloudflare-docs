...
Each agent has its own installation method for Skills. Refer to the [setup guide for your agent](#set-up-your-agent) for installation instructions.
...
Each agent's [setup guide](#set-up-your-agent) includes MCP server installation as part of its Quick start. For the full list of available MCP servers, refer to [MCP servers for Cloudflare](/agents/model-context-protocol/mcp-servers-for-cloudflare/).
