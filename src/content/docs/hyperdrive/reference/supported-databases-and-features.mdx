...
| Prisma Postgres | ✅        | All                      | Serverless Postgres with built-in connection pooling. Refer to the [Prisma Postgres guide](/hyperdrive/examples/connect-to-postgres/postgres-database-providers/prisma-postgres/). |
