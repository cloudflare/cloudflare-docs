...
| Metric              | GraphQL Field Name   | Description                                          |
| ------------------- | -------------------- | ---------------------------------------------------- |
| Waiting connections | `waitingConnections` | Client requests waiting for an available connection. |
| Open connections    | `openConnections`    | Active connections to your database.                 |
| Pool size maximum   | `poolSizeMaximum`    | Your configured origin connection limit.             |
