...
{/* TODO: create a hyperdrive getting started template and ask the user to use that one */}
<PackageManagers
	type="create"
...
this enables the Node.js compatibility mode which is genrally required for database drivers to function.
...
The code above, upon receiving a request:
...
3. Returnes the response as JSON to the client.
