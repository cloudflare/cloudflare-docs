...
- A [[Wrangler configuration](/workers/wrangler/configuration) file](/workers/wrangler/configuration/) configuration file. [Wrangler configuration](/workers/wrangler/configuration) file is how your `hyperdrive-tutorial` Worker will connect to Hyperdrive.

:::note

Note that the [Wrangler configuration](/workers/wrangler/configuration) file contains the following option:
