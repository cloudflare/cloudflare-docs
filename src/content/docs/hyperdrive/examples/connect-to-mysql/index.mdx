...
| mysql                    | [mysql documentation](https://github.com/mysqljs/mysql)          | `mysql@2.18.0`           | Requires `compatibility_flags = ["nodejs_compat"]` and `compatibility_date = "2025-02-24"` - refer to [Node.js compatibility](/workers/runtime-apis/nodejs). Requires wrangler `3.78.7` or later. |
