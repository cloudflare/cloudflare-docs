...
| Prisma ORM | [Prisma documentation](https://www.prisma.io/) | `6.6.0` | Requires Node.js compatibility. Works with Hyperdrive for connection pooling and performance optimization. |
