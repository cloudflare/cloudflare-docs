...
:::note[Prefer a simpler setup?]

You can connect PlanetScale to Cloudflare using the [native integration](/workers/databases/third-party-integrations/planetscale/) which automatically creates a Hyperdrive configuration without manually copying credentials. The native integration is available for both PostgreSQL and MySQL databases.
