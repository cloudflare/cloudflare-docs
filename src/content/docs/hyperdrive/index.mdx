...
Hyperdrive supports any Postgres or MySQL database, including those hosted on AWS, Google Cloud, Azure, Neon, PlanetScale, and Prisma Postgres. Hyperdrive also supports Postgres-compatible databases like CockroachDB and Timescale.
