...
Hyperdrive supports any Postgres or MySQL database, including those hosted on AWS, Google Cloud, Azure, Neon and PlanetScale. Hyperdrive also supports Postgres-compatible databases like CockroachDB, Timescale, and MotherDuck.
...
<Feature header="Query Caching" href="/hyperdrive/concepts/query-caching/" cta="Learn about Query Caching">
