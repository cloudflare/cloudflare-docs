...
To update your Worker to use the new Hyperdrive configuration, redeploy your Worker or use [split deployments](/workers/configuration/versions-and-deployments/split-deployments/).
