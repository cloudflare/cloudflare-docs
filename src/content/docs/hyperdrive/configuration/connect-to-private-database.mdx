...
9. Go back to the application configuration and add the newly created Access policy.

10. In **Identity providers**, turn off _Accept all available identity providers_ and clear all identity providers.

11. In **Session Duration**, select `No duration, expires immediately`.

12. (Optional) Go to the **Additional settings** tab. Turn off **Show application in App Launcher**.
