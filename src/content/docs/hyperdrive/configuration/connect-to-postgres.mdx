...
The command above will output the ID of your Hyperdrive, which you will need to set in the [Wrangler configuration](/workers/wrangler/configuration) file for your Workers project:
...
**Ensure you have `compatibility_flags = ["nodejs_compat_v2"]` set in your [Wrangler configuration](/workers/wrangler/configuration) file**:
