...
D1 supports [SQLite PRAGMA](https://www.sqlite.org/pragma.html) statements.

For example, D1 supports `table_list` and `table_info`:
...
For the full list of supported PRAGMA statements, see [SQL statements](/d1/reference/sql-statements).
