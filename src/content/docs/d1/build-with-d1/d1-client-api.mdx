...
D1 supports [SQLite PRAGMA](https://www.sqlite.org/pragma.html) statements. PRAGMA statements are an extension to SQLite, which can be used to:

- Modify the behavior of certain SQLite operations
- Query your schema or table
