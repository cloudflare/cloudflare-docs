...
Copy the last part of the command output and paste it into your [Wrangler configuration](/workers/wrangler/configuration) file. It should look similar to this:
