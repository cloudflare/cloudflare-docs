...
The above command creates a new Workers project with a default frontend. You will update the frontend to list the products. You will also add a new page to the frontend to display a single product.
...
Next, update the `src/index.ts` file. You will import the Hono library and create the API routes.
