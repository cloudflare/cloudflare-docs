...
This binding enables your application to interact with Cloudflare resources such as D1 databases, KV namespaces, and R2 buckets. To configure this, create a [Wrangler configuration](/workers/wrangler/configuration) file in your project's root directory and input the basic setup information:
...
After setting up your D1 database and configuring the [Wrangler configuration](/workers/wrangler/configuration) file as outlined in previous steps, your database is accessible in your code through the `DB` binding. This allows you to directly interact with the database by preparing and executing SQL statements. In the following step, you will learn how to use this binding to perform common database operations such as retrieving data and inserting new records.
...
Once the bucket is created, add the R2 bucket binding to your [Wrangler configuration](/workers/wrangler/configuration) file:
...
After successful login, confirm that your [Wrangler configuration](/workers/wrangler/configuration) file is configured similarly to the code block below:
