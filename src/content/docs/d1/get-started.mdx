...
To bind your D1 database to your Worker, copy the following lines obtained from [step 2](/d1/get-started/#2-create-a-database) from your terminal, then add the following to the end of your `wrangler.toml` file:
