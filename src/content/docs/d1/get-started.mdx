...
1. Create a new project named `d1-tutorial` by running:
    ...
    - A [Wrangler configuration](/workers/wrangler/configuration) file. This is how your `d1-tutorial` Worker accesses your D1 database.
...
You create bindings by updating your [Wrangler configuration](/workers/wrangler/configuration) file.

<Steps>

1. Copy the lines obtained from [step 2](/d1/get-started/#2-create-a-database) from your terminal.
2. Add them to the end of your [Wrangler configuration](/workers/wrangler/configuration) file.
...
With [Wrangler's configuration](/workers/wrangler/configuration) file configured properly, set up your database. Use the example `schema.sql` file below to initialize your database.
...
3. Paste the following code snippet into your `index.ts` file:
    ...
    1. Define a binding to your D1 database in your TypeScript code. This binding matches the `binding` value you set in [Wrangler's configuration](/workers/wrangler/configuration) file under `[[d1_databases]]`.
