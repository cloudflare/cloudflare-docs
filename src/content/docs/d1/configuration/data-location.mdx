...
Location hints are optional parameters you can provide to indicate your desired geographical location for your database.
...
:::caution
Location hint does not guarantee that D1 runs in your preferred location. Instead, it will run in the nearest possible location (by latency) to your preference.
:::
...
:::caution
D1 location hints are not currently supported for South America (`sam`), Africa (`afr`), and the Middle East (`me`)
:::
