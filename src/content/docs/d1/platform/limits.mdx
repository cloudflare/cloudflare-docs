...
| Feature                                                                                                             | Limit                                             |
| ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| Databases per account                                                                                               | 1,000,000 (Workers Paid) [^1] / 10 (Free)         |
...
| Queries per Worker invocation (read [subrequest limits](/workers/platform/limits/#subrequests)) | 1000 (Workers Paid) / 50 (Free)                   |
...
[^1]: 1,000,000 databases per account is a soft ceiling on Workers Paid and Enterprise plans. If you need more than 1,000,000 databases per account, you can request an increase. Cloudflare can support millions to tens-of-millions of databases (or more) per account. Refer to the guidance on limit increases on this page.
