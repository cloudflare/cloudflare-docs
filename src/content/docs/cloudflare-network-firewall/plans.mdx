...
- [Protocol validation](/cloudflare-network-firewall/how-to/form-expressions/#protocol-validation) to inspect traffic validity and enforce a positive security model.
