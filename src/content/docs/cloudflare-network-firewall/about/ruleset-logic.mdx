...
head:
  - tag: title
    content: Cloudflare Network Firewall ruleset logic
---
...
Refer to [Enable managed rulesets](/cloudflare-network-firewall/how-to/enable-managed-rulesets/) for more information.
