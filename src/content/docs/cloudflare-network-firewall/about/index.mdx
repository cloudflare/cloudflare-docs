...
- When using Cloudflare Network Firewall, fragmented <GlossaryTooltip term="data packet">packets</GlossaryTooltip> are reassembled into complete packets before they are inspected. As a result, you cannot create firewall rules for fragments.
