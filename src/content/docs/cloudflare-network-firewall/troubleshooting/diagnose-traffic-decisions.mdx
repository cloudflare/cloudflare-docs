...
3. Go to **Diagnostics**, and configure a packet capture filter matching the affected traffic. Note that the pcap might be empty because packets were dropped.
