...
| `authToken`    | `string`      | No       | A Cloudflare [API token](/flagship/api-tokens/) with Flagship Evaluate or Flagship App Evaluate permission. Required when not using a binding. |
