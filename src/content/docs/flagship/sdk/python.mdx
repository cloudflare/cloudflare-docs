...
Configure the provider with your Flagship app ID, Cloudflare account ID, and an [API token](/flagship/api-tokens/) with Flagship Evaluate or Flagship App Evaluate permission.
