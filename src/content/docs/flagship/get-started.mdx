...
1. Log in to the [Cloudflare dashboard](https://dash.cloudflare.com/?to=/:account/flagship) and select your account.
...
6. Enable the flag and select **Save**.
...
## Use the OpenFeature SDK (optional)
