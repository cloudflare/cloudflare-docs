...
Replace `<APP_ID>` with the app ID from the [Cloudflare dashboard](https://dash.cloudflare.com). The `binding` field sets the name you use to access Flagship in your Worker code (for example, `env.FLAGS`).
