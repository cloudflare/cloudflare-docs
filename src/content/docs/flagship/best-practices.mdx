...
For browser or other client-side evaluation, use an [app-scoped API token](/flagship/api-tokens/) with **Flagship App Evaluate**. Do not put an account-wide Flagship token in client-side code.
