...
## Add or change CORS headers at your origin
...
* You can use a [Worker](/workers/) to set CORS header, see the [CORS header proxy](/workers/examples/cors-header-proxy/) in the Workers examples section.
* You can configure a [Snippet](/rules/snippets/), see the [Define CORS headers](/rules/snippets/examples/define-cors-headers/) example.
* You can also use [Transform Rules](/rules/transform/) to set such header, see the [Add a wildcard CORS response header](/rules/transform/examples/add-cors-header) example.
