...
:::note[Workaround for different edge and browser TTLs]
...
For all available directives, refer to [Cache-Control directives](/cache/concepts/cache-control/#cache-control-directives).
