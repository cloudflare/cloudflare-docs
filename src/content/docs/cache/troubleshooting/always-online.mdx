...
- Tiered Cache. Refer to limitation 3 for details.
...
3. Always Online does not activate when Tiered Cache is enabled on a zone. If your zone uses Tiered Cache, visitors will see the 520–527 error page rather than the archived version.
