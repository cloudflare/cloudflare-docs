...
[Single file purge](/cache/how-to/purge-cache/purge-by-single-file/) is not compatible if you add other [available fields](/ruleset-engine/rules-language/fields/reference/) than those listed, such as `ip.*` fields.
