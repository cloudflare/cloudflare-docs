...
4. Use specific cache-tags to immediately purge your Cloudflare CDN cache of all content containing that cache-tag from your dashboard or [using our API](/api/operations/zone-purge).
...
* For ms, the maximum length of a cache-tag in an API call is 1,024 characters.
