---
موtitle: ​Purge cache by prefix (URL)
...
You can instantly purge their cache by URL prefix or path separators in their URL. For an example URL like `https://www.example.com/foo/bar/baz/qux.jpg`, ما 
ف
مطار 
ةىر
لظل
