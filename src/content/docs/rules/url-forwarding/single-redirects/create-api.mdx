...
- An `action_parameters` object with additional configuration settings — refer to [Single Redirects settings](/rules/url-forwarding/single-redirects/settings/) for details.
