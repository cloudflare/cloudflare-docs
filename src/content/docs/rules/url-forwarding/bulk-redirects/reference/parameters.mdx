...
For more information on the supported URL components, refer to [Supported URL components in Bulk Redirects](/rules/url-forwarding/bulk-redirects/reference/url-components/).
...
The value must be one of the following: `301`, `302`, `307`, or `308`.
