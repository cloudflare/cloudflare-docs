...
Use this setting to configure the request body buffering mode for matching requests:
...
Use this setting to configure the response body buffering mode for matching requests:
