...
- When an Origin Rule is configured to override the Host header for a request destined for a Worker, the override is applied after the Worker has executed.
