...
Your custom error page cannot be blank and cannot exceed 1.5 MB in size (1500000 characters). To avoid exceeding the custom error page limit, preview your page to check its size before publishing.
