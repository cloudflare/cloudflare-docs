...
If Cloudflare cannot load your site or you have blocked the United States (US) via [IP Access rules](/waf/tools/ip-access-rules/) or [WAF custom rules](/waf/custom-rules/), publishing and previewing a custom error page might not work.
...
If you block countries or IP addresses with an [IP Access rule](/waf/tools/ip-access-rules/), affected visitors will get a [1005](/support/troubleshooting/http-status-codes/cloudflare-1xxx-errors/error-1005/) error and your **IP/Country Block** custom page.
...
You cannot customize the following [1XXX](https://developers.cloudflare.com/support/troubleshooting/http-status-codes/cloudflare-1xxx-errors/) errors via Error Pages:
