...
These types of challenges are being discouraged in favor of managed challenges. Refer to [Interstitial Challenge Pages](/cloudflare-challenges/challenge-types/challenge-pages/) for more information.
