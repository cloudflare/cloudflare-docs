...
This example configures a custom JSON error response for all [5XX errors](/support/troubleshooting/http-status-codes/cloudflare-5xx-errors/) (`500`-`599`) in a zone. The HTTP status code of the custom error response will be set to `530`.
