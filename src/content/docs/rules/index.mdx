...
Rules features require that your domain (or subdomain) has its [DNS records proxied](/dns/proxy-status/) through Cloudflare, meaning traffic passes through the Cloudflare network before reaching your origin server.
