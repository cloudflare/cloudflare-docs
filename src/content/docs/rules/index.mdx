...
sidebar:
  order: 1
description: Explore Cloudflare Rules to adjust requests and responses, configure settings, and trigger actions for specific requests. Learn via API, dashboard, or Terraform.
head:
  - tag: title
    content: Overview
---
