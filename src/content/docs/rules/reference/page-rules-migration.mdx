...
:::caution
If you are still using [WAF managed rules (previous version)](/waf/reference/reference/legacy/old-waf-managed-rules/) or [Rate Limiting (previous version)](/waf/reference/reference/legacy/old-rate-limiting/), consider upgrading to the new versions of these products. It is not possible to turn off these older products using modern Rules features.
:::
