...
sidebar:
  ...
  badge:
    text: Beta
    // TODO: set the badge text in the frontmatter with <ProductMaturity product="cloudflare-trace" /> as well
head:
  - tag: title
