...
head:
  - tag: title
    content: API parameter reference | Request Header Transform Rules
---
...
For step-by-step instructions, refer to [Create a request header transform rule via API](/rules/transform/request-header-modification/create-api/).
