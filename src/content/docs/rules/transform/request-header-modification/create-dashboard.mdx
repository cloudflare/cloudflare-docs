...
4. To create a new empty rule, select **Create rule**. To duplicate an existing rule, select the three dots next to it > **Duplicate**.
   ...
   ![The HTTP request header modification rule creation page in the Cloudflare dashboard.](~/assets/images/rules/transform/create-request-header-modification-rule.png)
