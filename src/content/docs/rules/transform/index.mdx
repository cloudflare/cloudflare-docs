...
Alternatively, you can create a transform rule from scratch in the dashboard or via Cloudflare API. Refer to the following sections for detailed instructions:
