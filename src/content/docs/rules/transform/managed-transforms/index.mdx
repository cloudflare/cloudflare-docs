...
Enabled Managed Transforms will apply to all inbound requests for the [zone](/fundamentals/setup/accounts-and-zones/#zones) (domain or subdomain added to Cloudflare).
