...
## Edit response header modification rule

To edit a rule you previously created:

1. Go to **Rules** > **Overview**.
2. Under **Response Header Transform Rules**, select the rule name to edit it.
3. Edit the rule configuration and then select **Save**.
