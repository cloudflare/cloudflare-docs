...
This error occurs when a Snippet exceeds the defined [CPU time limit](/rules/snippets/#availability) for Snippets.
...
This error occurs when a Snippet exceeds the defined [memory limit](/rules/snippets/#availability) for Snippets.
