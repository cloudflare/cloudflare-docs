...
| Perform compute-heavy tasks (for example, [AI](/workers-ai/), [image transformations](/images/optimization/transformations/transform-via-workers/))                                                                       |    ❌    |   ✅    |
...
- Performs compute-intensive operations, including:
  ...
  - [Image transformations](/images/optimization/transformations/transform-via-workers/)
