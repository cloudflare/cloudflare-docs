...
sidebar:
  order: 8
description: >-
  This guide helps you determine when to use Snippets or Workers on Cloudflare's global network. It provides best practices, comparisons, and real-world use cases to help you choose the right product.
---
