...
:::note
To help with PCI DSS requirements, Page Shield requires that you have an Enterprise plan with a paid add-on. Refer to [Availability](/page-shield/#availability) for details on what is included in each plan.
:::
