...
Once you have configured one or more allow policies in a zone you can filter alert notifications according to those policies. These alerts are called [scoped alerts](/page-shield/detection/configure-alerts/#scoped-alerts).
