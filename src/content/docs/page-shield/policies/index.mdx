...
Shortly after you configure policies, the Cloudflare dashboard will start displaying any [violations](/page-shield/policies/violations/) of those policies.

You can filter Page Shield alert notifications according to the policies you configured in a zone. These alerts are called [scoped alerts](/page-shield/alerts/#scoped-alerts).
