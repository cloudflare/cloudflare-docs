...
For alerts without a **Policies of these zones** filter, you cannot add filter on zones when setting up notification, and will only receive alerts for resources detected in all your zones.
