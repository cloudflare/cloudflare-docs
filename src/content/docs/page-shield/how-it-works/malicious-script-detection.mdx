...
You can [configure Malicious Script Alerts](/page-shield/alerts/configure/) to receive an alert notification as soon as Cloudflare detects JavaScript code classified as malicious in your domain. Please note that currently the script classifier will only run on scripts up to 300 KB.
