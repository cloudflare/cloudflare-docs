...
Health checks consist of probes to determine the status of a tunnels. Magic Transit uses this information to steer traffic through the best available route, and to warn you about potential issues with a tunnel.
...
Refer to [Tunnel health checks](/magic-transit/reference/tunnel-health-checks/) for a deep dive on the different type of health checks, what they do and how to work.

Refer to the pages on this list for details on how to use the various health checks available.
