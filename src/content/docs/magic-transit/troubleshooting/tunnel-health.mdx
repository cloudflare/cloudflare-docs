...
- **API**: Tunnel health status via the [Magic Transit tunnel health API](/magic-transit/reference/tunnel-health-checks/)
- **Network Analytics**: Traffic volume, packet counts, and protocol distribution through [Network Analytics](/magic-transit/analytics/network-analytics/)
...
4. **IPsec parameters**: Confirm your cryptographic parameters match [Cloudflare's supported configuration](/magic-transit/reference/gre-ipsec-tunnels/#supported-configuration-parameters).
...
For instructions on monitoring tunnel status, refer to [Check tunnel health in the dashboard](/magic-transit/network-health/check-tunnel-health-dashboard/).
...
For a detailed explanation of why this setting is necessary, refer to [Anti-replay protection](/magic-transit/reference/anti-replay-protection/).
...
For detailed information on how bidirectional health checks work, refer to [Tunnel health checks](/magic-transit/reference/tunnel-health-checks/).
...
For the complete list of supported parameters, refer to [Supported configuration parameters](/magic-transit/reference/gre-ipsec-tunnels/#supported-configuration-parameters).
...
- [Tunnel health checks](/magic-transit/reference/tunnel-health-checks/): Technical details on health check behavior
- [Anti-replay protection](/magic-transit/reference/anti-replay-protection/): Why anti-replay must be disabled
- [Configure tunnel endpoints](/magic-transit/how-to/configure-tunnel-endpoints/): Tunnel setup instructions
- [Check tunnel health in the dashboard](/magic-transit/network-health/check-tunnel-health-dashboard/): Dashboard navigation guide
- [Network Analytics](/magic-transit/analytics/network-analytics/): Traffic analysis tools
