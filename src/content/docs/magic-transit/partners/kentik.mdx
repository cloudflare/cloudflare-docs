...
3. In this example scenario, the prefix protected by Cloudflare displays a **Withdrawn** status.

   After a DDoS attack occurs, the status changes to **Advertised**, which indicates the network is protected.
