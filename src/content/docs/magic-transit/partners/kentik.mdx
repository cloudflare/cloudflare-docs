...
1. Go to the [**BYOIP Prefixes**](https://dash.cloudflare.com/?to=/:account/ip-addresses/ip-prefixes) page.
2. In this example scenario, the prefix Cloudflare protects displays a **Withdrawn** status.
