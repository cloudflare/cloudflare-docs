...
If you are connecting to Cloudflare through a [Direct CNI connection](/network-interconnect/express-cni/), you can [configure BGP routing instead](/magic-transit/how-to/bgp-peering/) instead.