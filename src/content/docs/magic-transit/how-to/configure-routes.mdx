...
- [IPsec and GRE tunnels (beta)](/magic-transit/how-to/configure-tunnel-endpoints/). Requires [Unified Routing](/magic-transit/reference/traffic-steering/#unified-routing).
