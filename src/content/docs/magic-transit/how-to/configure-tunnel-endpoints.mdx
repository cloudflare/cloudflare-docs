...
Now that you have set up your tunnel endpoints, configure routes to direct your traffic through Cloudflare. Refer to [Configure routes](/magic-transit/how-to/configure-routes/) to learn more about static routing and BGP peering (only available through CNI with Dataplane v2 (beta) connection).