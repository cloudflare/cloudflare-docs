...
- **BGP peering with Magic Transit routing table**: Automatically control prefix advertisements based on BGP routes learned through CNI with Dataplane v2 (beta), GRE and IPsec tunnels. Refer to [BGP control to Magic routing table](#bgp-control-to-magic-routing-table).
