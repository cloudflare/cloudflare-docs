...
<Tabs syncKey="dashPlusAPI">
  ...
  <TabItem label="Dashboard">
		:::note
		You can only advertise your prefix after running pre-flight checks with Cloudflare. If your prefix status is greyed out and shows an Withdrawn status, your prefix is locked. Contact your account team to close the pre-flight checks phase with you and unlock your prefixes.

		Currently only the default BGP prefix (that matches the IP prefix) can be controlled via the UI.
		:::
		...
		4. From the dropdown menu **Status**, choose weather the status of your IP is **Advertised** or **Withdrawn**.
		5. (Optional) Edit the description for your prefix.
		6. Select **Edit IP Prefix** to save your changes.
  </TabItem>

  <TabItem label="API" icon="moon">
