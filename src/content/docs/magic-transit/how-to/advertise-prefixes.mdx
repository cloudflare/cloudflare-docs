...
<Tabs syncKey="dashPlusAPI">
  ...
  <TabItem label="Dashboard">
		:::note
		You can only advertise your prefix after running pre-flight checks with Cloudflare. If your prefix status is greyed out and shows a Withdrawn status, Cloudflare locks your prefix. Contact your account team to close the pre-flight checks phase and unlock your prefixes.
