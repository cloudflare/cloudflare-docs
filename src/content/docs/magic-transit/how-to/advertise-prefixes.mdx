...
You can bring your own public IP addresses to Cloudflare to use with Magic Transit. This is also known as bring your own IP (BYOIP). This process requires two steps:
...
Cloudflare offers multiple mechanisms to control the announcement and withdrawal of on-demand prefixes. You can manage advertisements through one of the following methods:
