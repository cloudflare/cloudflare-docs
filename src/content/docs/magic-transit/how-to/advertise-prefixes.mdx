...
If you use Direct CNI as a way to on-ramp your network traffic to Magic Transit, refer to [BGP peering](/magic-transit/how-to/bgp-peering/) to learn how to configure BGP peering. Note that this is a different option to using BGP as a means to control the advertisement status of your prefix.
