...
import { APIRequest, Details, GlossaryTooltip, Tabs, TabItem } from "~/components"
...
Provide all IP prefixes you plan to onboard, along with the [ASNs](https://www.cloudflare.com/learning/network-layer/what-is-an-autonomous-system/) from which they will be advertised. When specifying prefixes, observe these guidelines:
...
## BGP control with Cloudflare Route Reflectors (via Internet or Classic CNI)
