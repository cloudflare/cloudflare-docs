...
import { AnchorHeading, Details, GlossaryTooltip } from "~/components";
...
For instructions, refer to [Set maximum segment size](/magic-transit/get-started/#set-maximum-segment-size).
...
For information on how to set up an IPsec tunnel, refer to [Configure tunnel endpoints](/magic-transit/how-to/configure-tunnel-endpoints/). To learn more about the configuration parameters Magic Transit uses to create an IPsec tunnel, keep reading.
...
- Disable [anti-replay protection](/magic-transit/reference/anti-replay-protection/).
...
For help resolving tunnel issues:
- [Troubleshoot tunnel health](/magic-transit/troubleshooting/tunnel-health/) - Diagnose and fix health check failures
- [Troubleshoot with IPsec logs](/magic-transit/troubleshooting/ipsec-troubleshoot/) - Use Logpush to analyze IPsec handshake issues
