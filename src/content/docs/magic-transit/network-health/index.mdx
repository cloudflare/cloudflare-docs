...
Refer to [Tunnel health checks](/magic-transit/reference/tunnel-health-checks/) for a deep dive on the different types of health checks, what they do, and how they work.
