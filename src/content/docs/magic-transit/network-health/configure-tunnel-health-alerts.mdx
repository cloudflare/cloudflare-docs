...
For details, refer to [How Cloudflare calculates Tunnel health alerts](/magic-transit/reference/how-cloudflare-calculates-tunnel-health-alerts/).
...
2. Disable the tunnel you are testing, so there is 100% [health check failure](/magic-transit/reference/tunnel-health-checks/).
