...
- [Email Obfuscation](/waf/tools/scrape-shield/email-address-obfuscation/), located in the **Security** > **Settings** section.
- [Rocket Loader](/speed/optimization/content/rocket-loader/), located in **Speed** > **Settings** > **Content Optimization** section.
