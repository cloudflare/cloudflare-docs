...
You can also configure Speed Brain using Terraform. For more details, refer to the [`cloudflare_zone_settings_override` resource](https://registry.terraform.io/providers/cloudflare/cloudflare/4.43.0/docs/resources/zone_settings_override#nestedblock--settings) in the Terraform documentation.
