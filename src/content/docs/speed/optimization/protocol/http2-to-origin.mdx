...
Cloudflare first reuses existing keep-alive connections. If those reach concurrency limits, new connections are opened as needed. Even during surges, total connection count is typically lower than without multiplexing.
