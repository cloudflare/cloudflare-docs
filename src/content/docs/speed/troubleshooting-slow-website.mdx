...
Saying "my website is slow" is not enough to diagnose a performance issue. To effectively troubleshoot, you need to:
...
```bash
curl -sI https://www.example.com/asset.jpg | grep -i "cf-cache-status"
```
