...
6. Then, you can select, depending on your plan, run test **once**, **daily** or **weekly**. Refer to the [Quotas](/speed/observatory/run-speed-test/#quotas) section for information on the test frequency available for your plan, noting that these limits may change over time.
