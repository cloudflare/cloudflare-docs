...
The Observatory overview dashboard provides a single view of your zone's performance over the past 7 days. It combines synthetic monitoring, real user data, and Cloudflare's analysis to help you quickly identify performance bottlenecks and receive actionable recommendations.
...
- **4xx errors**: Client errors, broken down by Cloudflare edge vs origin.
- **5xx errors**: Server errors, broken down by Cloudflare edge vs origin.
