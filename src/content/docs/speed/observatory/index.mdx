...
Use Origin Analytics to identify slow endpoints, monitor origin response times, and diagnose errors. For more information, refer to [Origin Analytics](/speed/observatory/origin-analytics/).
