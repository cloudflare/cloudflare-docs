...
## Step 1: Identify slow resources

The first step is to identify which specific resources are causing slowness. A slow website is often caused by one or more slow resources, not necessarily the entire site.
