...
Dynamic Workers let you spin up an unlimited number of Workers to execute code. Because they are created at runtime, they work well for fast, secure code execution.
