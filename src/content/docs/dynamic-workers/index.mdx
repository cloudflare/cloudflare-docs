...
- **[Limits](/dynamic-workers/usage/limits/)**: Enforce custom limits on the dynamic Worker's resource usage.
- **[Durable Object Facets](/dynamic-workers/usage/durable-object-facets/)**: Run dynamically-loaded code as a Durable Object with its own isolated SQLite storage.
