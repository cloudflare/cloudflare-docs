...
let aliceRoom = ctx.exports.ChatRoom({
	props: { roomName: "#alice", apiKey: ALICE_KEY },
});
let bobRoom = ctx.exports.ChatRoom({
	props: { roomName: "#bob", apiKey: BOB_KEY },
});
```
...
export class MyStorage extends WorkerEntrypoint<
	Cloudflare.Env,
	MyStorageProps
> {
