...
Accounts on Legacy routing mode do not support Cloudflare Mesh when Cloudflare WAN (formerly Magic WAN) is enabled. Your account must be on [Cloudflare One Unified Routing](/cloudflare-wan/reference/traffic-steering/#unified-routing) for both to work together.
:::
...
| ---- | ---- | ---- |
| Cloudflare Mesh + Cloudflare WAN | Conditional | Requires [Cloudflare One Unified Routing](/cloudflare-wan/reference/traffic-steering/#unified-routing). Accounts on Legacy routing mode cannot use both. |
