...
[Cloudflare Network Firewall](/cloudflare-network-firewall/) provides packet-level filtering at layers 3 and 4. You define allow or block rules based on IP addresses, ports, and protocols.
...
Gateway provides the deepest inspection for WAN traffic, covering DNS, network, and HTTP layers. For detailed setup instructions, refer to [Connect to Cloudflare Gateway with Cloudflare WAN](/cloudflare-wan/zero-trust/cloudflare-gateway/).
...
- [Connect to Cloudflare Gateway with Cloudflare WAN](/cloudflare-wan/zero-trust/cloudflare-gateway/): Detailed setup guide for Gateway integration with WAN traffic.
- [Cloudflare Network Firewall](/cloudflare-network-firewall/): Configure packet-level filtering rules.
...
- [WAN transformation](/cloudflare-wan/wan-transformation/): Plan your migration from traditional WAN to Cloudflare.
