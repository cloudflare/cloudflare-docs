...
If you connect through [GRE](/cloudflare-wan/configuration/how-to/configure-tunnel-endpoints/#add-tunnels), [IPsec](/cloudflare-wan/configuration/how-to/configure-tunnel-endpoints/#add-tunnels), [CNI](/network-interconnect/), or [WARP](/cloudflare-one/team-and-resources/devices/cloudflare-one-client/) and want to run `traceroute` to an endpoint behind a [Cloudflare Tunnel](/cloudflare-one/networks/connectors/cloudflare-tunnel/), you need to change some settings.
