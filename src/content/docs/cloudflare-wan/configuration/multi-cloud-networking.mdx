...
- Went through the process of [setting up your cloud provider](/multi-cloud-networking/get-started/).
- Have the correct cloud resources. Refer to [Reference](/multi-cloud-networking/reference/) to check resources by cloud provider.
...
Refer to [Reference](/multi-cloud-networking/reference/) to learn more about how Cloudflare orchestrates VPN connectivity to your cloud networks.
...
7. Select the network that you want to connect to. This list comes from the [cloud integrations](/multi-cloud-networking/get-started/) you have already set up. When you are done, select **Continue**.
...
5. Give your new on-ramp a name and a description (optional), then select **Continue**.
6. From the drop-down menu, choose your cloud provider. You can choose between AWS, GCP, and Azure. Then, select **Continue**.
7. Choose an existing hub. This list comes from the [cloud integrations](/multi-cloud-networking/get-started/) you have already set up. When you are done, select **Continue**.
...
6. Configure your cloud in **Select your cloud details**:
   ...
   2. Choose an existing integration. This list comes from the [cloud integrations](/multi-cloud-networking/get-started/) you have already set up.
...
After setting up your on-ramps, you need to update your network security groups in your cloud provider to allow traffic to/from Cloudflare WAN. Refer to the [Cloud on-ramps](/multi-cloud-networking/reference/) reference page for more information.
...
6. In **Configurations**, you can modify where the required routes are installed. Select **Continue**.
   ...
   2. Review your settings, and select **Approve changes**.
      :::caution
      If you uncheck any of the Propagation settings, you will have to manually configure Cloudflare WAN or your cloud provider to ensure successful communication between them. Refer to the [How to](/cloudflare-wan/configuration/how-to/) section of Cloudflare WAN, or consult the documentation for your cloud provider for more information.
      :::
