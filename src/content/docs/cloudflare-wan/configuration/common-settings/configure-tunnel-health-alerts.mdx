...
For details, refer to [How Cloudflare calculates Tunnel health alerts](/cloudflare-wan/reference/how-cloudflare-calculates-tunnel-health-alerts/).
...
2. Disable the tunnel you are testing, so there is 100% [health check failure](/cloudflare-wan/reference/tunnel-health-checks/).
