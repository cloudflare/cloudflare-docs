...
- Already configured [IPsec tunnels](/cloudflare-wan/configuration/how-to/configure-tunnel-endpoints/) and [static routes](/cloudflare-wan/configuration/how-to/configure-routes/) in the Cloudflare dashboard
...
- Understand the importance of [MSS clamping](/cloudflare-wan/reference/mtu-mss/#mss-clamping) and adjusting it based on the traffic flows traversing the Cloudflare WAN IPsec Tunnels
