...
1. Refer to [Add tunnels](/cloudflare-wan/configuration/how-to/configure-tunnel-endpoints/#add-tunnels) to learn how to add an IPsec tunnel. When creating your IPsec tunnel, make sure you define the following settings:
...
1. Refer to [Create a static route](/cloudflare-wan/configuration/how-to/configure-routes/#create-a-static-route) to learn how to create one.
