...
You can connect your SonicWall appliance through [IPsec tunnels](/cloudflare-wan/configuration/how-to/configure-tunnel-endpoints/) to Cloudflare WAN. Generic Routing Encapsulation (GRE) is not supported on SonicWall.
...
1. Start by [creating your IPsec tunnels](/cloudflare-wan/configuration/how-to/configure-tunnel-endpoints/#add-tunnels) on Cloudflare. Name and describe the tunnels as needed, and add the following settings:
...
1. [Create your static routes](/cloudflare-wan/configuration/how-to/configure-routes/#create-a-static-route). Name and describe them as needed, and add the following settings:
