...
import { Render, Aside, Tabs, TabItem } from "~/components";
...
3. Choose **Virtual appliance** as the connector type. Choose **Hardware appliance** instead if you are registering a physical device through the existing account-team fulfillment workflow.
