...
- [Configure hardware Appliance](/cloudflare-wan/configuration/appliance/configure-hardware-appliance/#create-a-lan)
- [Configure Virtual Appliance](/cloudflare-wan/configuration/appliance/configure-virtual-appliance/#create-a-lan)
