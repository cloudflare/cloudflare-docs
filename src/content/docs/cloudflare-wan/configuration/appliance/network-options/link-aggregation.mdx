...
The following guide assumes you have already created a site and configured your Cloudflare One Appliance. For instructions, refer to [Configure hardware Appliance](/cloudflare-wan/configuration/appliance/configure-hardware-appliance/) or [Configure virtual Appliance](/cloudflare-wan/configuration/appliance/configure-virtual-appliance/).
