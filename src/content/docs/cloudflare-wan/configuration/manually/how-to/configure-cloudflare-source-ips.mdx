...
<Render
  ...
  params={{
    unifiedRoutingLink: "/cloudflare-wan/reference/traffic-steering/#unified-routing-mode-beta",
    connectivityOptionsLink: "/cloudflare-wan/zero-trust/connectivity-options/"
  }}
/>
