...
For a complete overview of which security services apply to WAN traffic, refer to [Secure WAN traffic](/cloudflare-wan/zero-trust/security-services/). For configuration details, refer to [Cloudflare Gateway](/cloudflare-one/traffic-controls/) and [Cloudflare Network Firewall](/cloudflare-network-firewall/).
