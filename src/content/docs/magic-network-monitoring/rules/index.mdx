...
:::caution[Invalid account error when trying to create a rule]
If you get the following error when trying to create a rule:

`Invalid account setting request body: account name format contains illegal characters or is not supported`
