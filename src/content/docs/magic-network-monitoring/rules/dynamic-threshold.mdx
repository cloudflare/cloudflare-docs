...
Dynamic thresholds are calculated using a [statistical measure called z-score (also referred to as standard score)](https://en.wikipedia.org/wiki/Standard_score). You can visit the section on **How the dynamic rule threshold is calculated** to learn more.
