...
description: >-
  Cloudflare's Magic Network Monitoring (MNM) can be used to test a simulated DDoS attack. To conduct a DDoS test, you would need to: Select and install a trusted and open source DDoS simulation tool. Conduct a small DDoStest attack in a safe test environment.
---
