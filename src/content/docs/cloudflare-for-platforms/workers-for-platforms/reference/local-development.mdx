...
In the dynamic dispatch Worker's Wrangler file, configure the [dispatch namespace binding](/workers/wrangler/configuration/#dispatch-namespace-bindings-workers-for-platforms) to connect to the remote namespace by setting [`remote = true`](/workers/local-development/#remote-bindings):
...
For more information about remote bindings during local development, refer to [remote bindings documentation](/workers/local-development/#remote-bindings).
