...
<PackageManagers type="create" pkg="cloudflare@latest" args={'customer-worker-1'} />
...
<PackageManagers type="create" pkg="cloudflare@latest" args={'dispatch-worker'} />
...
<PackageManagers type="create" pkg="cloudflare@latest" args={'outbound-worker'} />
