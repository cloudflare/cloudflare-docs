...
<Render file="c3-run-command-with-directory" product="workers" params={{ one: "customer-worker-1" }} />
...
<Render file="c3-run-command-with-directory" product="workers" params={{ one: "dispatch-worker" }} />
...
<Render file="c3-run-command-with-directory" product="workers" params={{ one: "outbound-worker" }} />
