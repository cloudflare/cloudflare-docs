...
## Related integration pattern

Some platforms deploy Workers before users create or connect Cloudflare accounts. For temporary accounts, refer to [Claim deployments (temporary accounts)](/workers/platform/claim-deployments/).
