...
- **Custom domains and subdomains** — You [call an API](/cloudflare-for-platforms/cloudflare-for-saas/domain-support/custom-hostnames/) to create custom subdomains or configure custom domains for each of your customers.
