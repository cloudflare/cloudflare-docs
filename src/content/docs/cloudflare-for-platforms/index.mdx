...
- **Programmable routing, ingress, egress, and limits** — You write code that dispatches requests to your customers' code, and can control [ingress](/cloudflare-for-platforms/workers-for-platforms/inbound-control/), [egress](/cloudflare-for-platforms/workers-for-platforms/outbound-control/), and set [per-customer limits](/cloudflare-for-platforms/workers-for-platforms/configuration/custom-limits/).
