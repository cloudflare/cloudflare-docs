...
If you use Render and also have a Cloudflare plan, you can use your own Cloudflare zone to proxy web traffic to your zone first, then Render's (the SaaS Provider) zone second. This configuration option is called [O2O](/cloudflare-for-platforms/cloudflare-for-saas/saas-customers/how-it-works/).
