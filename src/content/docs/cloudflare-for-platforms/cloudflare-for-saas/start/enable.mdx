...
3. The next step depends on the zone's plan:
   * **Enterprise**: Can preview this product as a [non-contract service](/billing/understand/preview-services/), which provide full access, free of metered usage fees, limits, and certain other restrictions.
