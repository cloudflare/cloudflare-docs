...
For a full list of certificate authority errors and who needs to act to resolve them, refer to [DCV troubleshooting](/cloudflare-for-platforms/cloudflare-for-saas/domain-support/hostname-validation/dcv-troubleshooting/).
