...
If a custom hostname certificate is stuck in **pending validation** or has timed out, a [domain control validation (DCV)](/ssl/edge-certificates/changing-dcv-method/dcv-flow/) step did not complete successfully.
