...
1. To test validation methods, set up a test zone and ask your Solutions Engineer to enable SSL for SaaS v2.
...
3. Review the results of our pre-migration tool (run by your Solutions Engineer) using one of the following methods:
   ...
   * Via a CSV file (provided by your Solutions Engineer)
