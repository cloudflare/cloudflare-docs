...
Eligible non-wildcard custom hostnames can use [automatic HTTP validation](#http-automatic) after the hostname points to your SaaS target.
...
During renewal, Cloudflare may use HTTP validation even if you selected TXT for initial issuance. Hostnames with properly configured [Delegated DCV](/cloudflare-for-platforms/cloudflare-for-saas/security/certificate-management/issue-and-validate/validate-certificates/delegated-dcv/) remain TXT-based. For more information, refer to [Renew certificates](/cloudflare-for-platforms/cloudflare-for-saas/security/certificate-management/issue-and-validate/renew-certificates/).
