...
<LinkTitleCard title="Binding configuration" href="/agent-memory/configuration/bindings/" description="Configure the agent_memory binding in your Wrangler configuration." />
