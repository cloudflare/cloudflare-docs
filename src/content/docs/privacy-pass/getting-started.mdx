...
The quickest way to see what an issuer-signed token looks like is with Cloudflare's [Privacy Pass Demo Tool](https://privacy-pass-demo.pvc-eng.workers.dev/). Pointed at an issuer, it runs the full issuance flow in your browser and returns a verified token.
...
1. Open the [Privacy Pass demo tool](https://privacy-pass-demo.pvc-eng.workers.dev/).
