...
The quickest way to see what an issuer-signed token looks like is with Cloudflare's [Privacy Pass Demo Tool](https://pepe-debug.research.cloudflare.com/). Pointed at an issuer, it runs the full issuance flow in your browser and returns a verified token.
...
1. Open the [Privacy Pass demo tool](https://pepe-debug.research.cloudflare.com/).
