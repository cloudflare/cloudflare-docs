...
To check that the directory endpoint is reachable, you can use the [Privacy Pass demo tool](https://privacy-pass-demo.pvc-eng.workers.dev/) to fetch the issuer's directory.
