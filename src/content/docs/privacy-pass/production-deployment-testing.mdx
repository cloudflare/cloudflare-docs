...
To check that the directory endpoint is reachable, you can use the [Privacy Pass demo tool](https://pepe-debug.research.cloudflare.com/) to fetch the issuer's directory.
