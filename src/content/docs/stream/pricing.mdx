...
- Playback using [Stream's built-in player](/stream/viewing-videos/using-the-stream-player/) or the [HLS or DASH manifests](/stream/viewing-videos/using-own-player/)
- [WebRTC (WHEP)](/stream/webrtc-beta/) playback
- MP4 Downloads
...
Media Transformations and [Image Transformations](/images/pricing/#images-transformed) use the same subscriptions and usage metrics.
