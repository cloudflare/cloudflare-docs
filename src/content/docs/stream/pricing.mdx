...
Storage consumption is rounded up to the second of video duration, and file size does not matter. Video stored in Stream does not incur additional storage fees from other storage products such as R2.
