...
description: Receive notifications when Cloudflare Stream videos finish processing, enter an error state, or when a live input changes state.
sidebar:
  order: 7
products:
  - stream
