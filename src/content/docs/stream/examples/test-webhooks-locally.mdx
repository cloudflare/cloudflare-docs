...
1. Start a [Quick Tunnel](/tunnel/get-started/quick-tunnels/) to get a public URL for your local environment.
...
Before registering a webhook URL, you need a public URL that points to your local machine. In a terminal, start a [Quick Tunnel](/tunnel/get-started/quick-tunnels/) that forwards to the default Wrangler dev server port (`8787`):
