...
For a complete, no-dependency example of going live from a browser, see the [First WebRTC broadcast in the browser](/stream/examples/browser-based-webrtc/) tutorial.
...
For a complete, no-dependency example of playing WebRTC in a browser, see the [First WebRTC broadcast in the browser](/stream/examples/browser-based-webrtc/) tutorial.
...
You can write your own broadcast and publishing apps using the browser's native WebRTC APIs — see the [First WebRTC broadcast in the browser](/stream/examples/browser-based-webrtc/) tutorial. Beyond native code, we have tested and confirmed that the following clients are compatible with Cloudflare Stream:
