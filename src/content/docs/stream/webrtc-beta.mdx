...
For a complete, no-dependency example of going live from a browser, see the [First WebRTC broadcast in the browser](/stream/examples/webrtc-whip-whep/) tutorial.
...
For a complete, no-dependency example of playing WebRTC in a browser, see the [First WebRTC broadcast in the browser](/stream/examples/webrtc-whip-whep/) tutorial.
