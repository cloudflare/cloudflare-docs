...
## Step 2: Go live from the browser using WHIP
...
## Step 3: Play live video in-browser using WHEP
...
While the creator is actively streaming, viewers can watch the broadcast in their browsers, with less than 1 second of latency. There are no fixed limits on the number of concurrent viewers.
