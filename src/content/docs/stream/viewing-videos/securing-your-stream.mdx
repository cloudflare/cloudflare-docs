...
You can also require signed URLs using the Stream binding in your Worker. Refer to [Bind to Workers API](/stream/manage-video-library/bindings/) for setup instructions.
...
Refer to [Bind to Workers API](/stream/manage-video-library/bindings/) for setup instructions.
