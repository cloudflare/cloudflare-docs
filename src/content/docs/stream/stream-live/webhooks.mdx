...
Notifications work differently for uploaded and on-demand videos. For more information, refer to [Receive events and webhooks](/stream/manage-video-library/using-webhooks/).
