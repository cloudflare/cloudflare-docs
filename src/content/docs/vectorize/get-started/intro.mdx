...
1. Define a binding to your Vectorize index from your Workers code. This binding matches the `binding` value you set in the Wrangler configuration file under `[[vectorize]]`.
