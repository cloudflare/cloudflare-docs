...
- A [[Wrangler configuration](/workers/wrangler/configuration) file](/workers/wrangler/configuration/) configuration file. [Wrangler configuration](/workers/wrangler/configuration) file is how your `embeddings-tutorial` Worker will access your index.
...
You must create a binding for your Worker to connect to your Vectorize index. [Bindings](/workers/runtime-apis/bindings/) allow your Workers to access resources, like Vectorize or R2, from Cloudflare Workers. You create bindings by updating your [Wrangler configuration](/workers/wrangler/configuration) file.

To bind your index to your Worker, add the following to the end of your [Wrangler configuration](/workers/wrangler/configuration) file:
...
From within the `embeddings-tutorial` directory, open your [Wrangler configuration](/workers/wrangler/configuration) file in your editor and add the new `[[ai]]` binding to make Workers AI's models available in your Worker:
