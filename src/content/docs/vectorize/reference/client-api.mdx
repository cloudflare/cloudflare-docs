...
Bindings are defined in either the [`wrangler.toml / wrangler.json(c)` file](/workers/wrangler/configuration/) associated with your Workers project, or via the Cloudflare dashboard for your project.
