...
3. Was created using the legacy [REST API](/api/operations/vectorize-(-deprecated)-create-vectorize-index).
...
Furthemore, the creation of legacy Vectorize indexes would be blocked by December 2024. Other operations would be unaffected and would remain functional.
