...
Privacy Proxy requires clients to authenticate before proxying traffic. This page explains each supported authentication methods and when to use them.
...
2. **Configure attestation**: Define how clients prove their identity before receiving tokens.
