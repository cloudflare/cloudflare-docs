...
This will create a new directory, which will include both a `src/index.ts` Worker script, and a [[Wrangler configuration](/workers/wrangler/configuration) file](/workers/wrangler/configuration/) configuration file. After you create your Worker, you will create a Queue to access.
...
To create a binding, open your newly generated [Wrangler configuration](/workers/wrangler/configuration) file and add the following:
...
Replace `MY_QUEUE` with the name you have set for your binding from your [Wrangler configuration](/workers/wrangler/configuration) file.
...
With your [Wrangler configuration](/workers/wrangler/configuration) file and `index.ts` file configured, you are ready to publish your producer Worker. To publish your producer Worker, run:
...
To connect your queue to your consumer Worker, open your [Wrangler configuration](/workers/wrangler/configuration) file and add this to the bottom:
...
With your [Wrangler configuration](/workers/wrangler/configuration) file and `index.ts` file configured, publish your consumer Worker by running:
...
If you get errors when you refresh, check that the queue name you created in [step 3](/queues/get-started/#3-create-a-queue) and the queue you referenced in your [Wrangler configuration](/workers/wrangler/configuration) file is the same. You should ensure that your producer Worker is returning `Success` and is not returning an error.
