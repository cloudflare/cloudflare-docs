...
To create a binding, open your newly generated Wrangler configuration file and add the following:
...
Replace `MY_QUEUE` with the name you have set for your binding from your Wrangler configuration file.
