...
- A [configured **producer** binding](/queues/configuration/configure-queues/#producer) in the Cloudflare dashboard or [Wrangler configuration](/workers/wrangler/configuration) file.
