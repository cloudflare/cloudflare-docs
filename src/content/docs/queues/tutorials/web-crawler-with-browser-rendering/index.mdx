...
Then, in your [Wrangler configuration](/workers/wrangler/configuration) file, add the following with the values generated in the terminal:
...
Then, in your [Wrangler configuration](/workers/wrangler/configuration) file, add the following:
