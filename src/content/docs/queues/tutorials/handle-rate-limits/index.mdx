...
### Add Queue bindings to [Wrangler configuration](/workers/wrangler/configuration) file

In your [Wrangler configuration](/workers/wrangler/configuration) file, add the following:
...
Your final [Wrangler configuration](/workers/wrangler/configuration) file should look similar to the example below.
