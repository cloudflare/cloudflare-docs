...
2. Set concurrency settings via [Wrangler configuration](/workers/wrangler/configuration) file
...
### Set concurrency settings via [Wrangler configuration](/workers/wrangler/configuration) file
...
To set a fixed maximum number of concurrent consumer invocations for a given queue, configure a `max_concurrency` in your [Wrangler configuration](/workers/wrangler/configuration) file:
