...
![Users can choose virtual networks to change their egress IP within the Cloudflare One Client](~/assets/images/learning-paths/secure-internet-traffic/change-user-egress-warp.png)
