...
For detailed instructions on creating a PAC file, refer to [Enable Gateway proxy with PAC files](/cloudflare-one/team-and-resources/devices/agentless/pac-files/).
