...
<Render file="indicator-feeds-overview" product="threat-intelligence" />

To subscribe to an indicator feed, contact your account team. For more information, refer to [Custom Indicator Feeds](/threat-intelligence/indicator-feeds/).