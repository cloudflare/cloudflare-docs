...
For additional commonly used HTTP policy examples, refer to [Common HTTP policies](/cloudflare-one/traffic-controls/http-policies/common-policies/). For more information on building HTTP policies, refer to [HTTP policies](/cloudflare-one/traffic-controls/http-policies/).
