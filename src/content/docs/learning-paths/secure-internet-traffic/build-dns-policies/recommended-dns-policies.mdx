...
For additional commonly used DNS policy examples, refer to [Common DNS policies](/cloudflare-one/traffic-policies/dns-policies/common-policies/). For more information on building DNS policies, refer to [DNS policies](/cloudflare-one/traffic-policies/dns-policies/).
