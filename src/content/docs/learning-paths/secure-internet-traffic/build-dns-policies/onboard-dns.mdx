...
To configure your router or OS, or to add additional DNS endpoints, refer to [DNS locations](/cloudflare-one/team-and-resources/devices/agentless/dns/locations/).
