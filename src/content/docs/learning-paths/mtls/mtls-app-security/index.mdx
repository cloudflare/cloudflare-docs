...
:::note
This implementation requires an active [Zone](/fundamentals/accounts-and-zones/#zones), a valid [Edge Certificate](/ssl/edge-certificates/), and [proxied](/dns/proxy-status/) hostname. <br />
