...
[PhishGuard](src/content/docs/cloudflare-one/email-security/phishguard.mdx) serves as an extension of your Security Operations team with dedicated Email Security technical resources providing real-time monitoring of your email environment. The Active Defense Service provides:
...
Refer to the [PhishGuard](src/content/docs/cloudflare-one/email-security/phishguard.mdx) documentation to learn more about this add-on service.
