...
To create this policy, you'll add a custom HTTP header to your Gateway policy. This header, `Chatgpt-Allowed-Workspace-Id`, ensures that only requests with your organization's unique workspace ID are permitted.
...
For more information, refer to [ChatGPT tenant control](/cloudflare-one/policies/gateway/http-policies/tenant-control/#chatgpt) and the [OpenAI documentation](https://help.openai.com/articles/8798594-what-is-a-workspace-how-do-i-access-my-chatgpt-business-workspace).
