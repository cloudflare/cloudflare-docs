...
To enforce Cloudflare One Client reauthentication, you can configure the Cloudflare One Client session timeouts on a per-application basis in your Gateway network policies. <Render file="warp/warp-sessions-intro" product="cloudflare-one" />
