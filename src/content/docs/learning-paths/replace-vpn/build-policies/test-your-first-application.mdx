...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Insights** > **Analytics** > **Dashboards**.
...
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Insights** > **Logs**.
2. Select **Access authentication logs**.
3. Review the [per-request logs](/cloudflare-one/insights/logs/dashboard-logs/access-authentication-logs/#per-request-logs) for your application.

To review traffic activity in the [Gateway logs](/cloudflare-one/insights/logs/dashboard-logs/gateway-logs/):
1. In [Cloudflare One](https://dash.cloudflare.com/one/), go to **Insights** > **Logs**.
