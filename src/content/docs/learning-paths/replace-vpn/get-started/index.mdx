...
This learning path focuses on client-based remote access to internal services. If you are looking for clientless or browser-based functionality, refer to our [Deploy clientless access](/learning-paths/clientless-access/concepts/) learning path.
:::
