...
For more granular control - including the ability to use the `Skip` action for bot mitigation - consider using [Super Bot Fight Mode](/bots/get-started/super-bot-fight-mode/).
...
If these limitations cause issues with your application, [disable](/bots/get-started/bot-fight-mode/#disable-bot-fight-mode) Bot Fight Mode.
