...
- <a href="/magic-transit/how-to/configure-tunnel-endpoints/">IPsec and GRE tunnels (beta)</a>. Requires <a href="/magic-transit/reference/traffic-steering/#unified-routing">Unified Routing</a>.
