...
14. (_Optional_) Select **Allow BGP (Border Gateway Protocol) peering** (beta) if you want to dynamically exchange routes between your network and Cloudflare. This feature requires <a href="/magic-transit/reference/traffic-steering/#unified-routing">Unified Routing</a>. <br /> BGP is recommended for environments with frequently changing routes or when you need automatic failover. Refer to [Configure BGP routes](/magic-transit/how-to/configure-routes/#configure-bgp-routes) for more information.
