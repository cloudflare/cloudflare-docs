...
- Enable Cloudflare Network Firewall's [Intrusion Detection System (IDS)](/cloudflare-network-firewall/about/ids/). Requires Logpush and is only available for accounts with [Advanced Cloudflare Network Firewall](/cloudflare-network-firewall/plans/#advanced-features).
