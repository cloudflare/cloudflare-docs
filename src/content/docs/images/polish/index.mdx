...
- <b>Polish</b> automatically optimizes all images served from your origin
  server. It keeps the same image URLs, and does not require changing markup of
  your pages.
- <b>Cloudflare Images</b> API allows you to create new images with resizing,
