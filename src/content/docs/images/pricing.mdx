...
By default, all users are on the Images Free plan. The Free plan includes access to the transformations feature, which lets you optimize images in remote sources (like R2). 

The Paid plan allows transformations, as well as access to storage features within Images.
...
|----------|---------|--------------|
| Optimize images in remote sources | Images Transformed | Free and Paid plans |
...
When you purchase an Images Paid plan, you can choose your own storage or add storage within Images.

| Metric | Pricing |
|--------|---------|
| Images Transformed | First 5,000 unique transformations included + $0.50 / 1,000 unique transformations / day |
...
Storage within Images is available only with an Images Paid plan. You can purchase storage in increments of $5 for every 100,000 images stored per month.
