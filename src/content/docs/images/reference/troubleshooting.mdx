...
- 9408 — The origin server returned an HTTP [4xx](/support/troubleshooting/http-status-codes/4xx-client-error/) status code and may be denying access to the image. Confirm your image settings and try again.
- 9509 — The origin server returned an HTTP [5xx](/support/troubleshooting/http-status-codes/cloudflare-5xx-errors/) status code. This is most likely a problem with the origin server-side software, not the resizing.
