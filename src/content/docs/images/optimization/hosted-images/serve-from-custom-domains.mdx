...
By default, Images are served from the `/cdn-cgi/imagedelivery/` path. You can use [Transform Rules](/rules/transform/) to rewrite URLs and serve images from custom paths.
