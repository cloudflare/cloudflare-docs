...
After activation, you can use [optimization parameters](/images/optimization/features/#parameters) on any Cloudflare image. For example,

`https://imagedelivery.net/{account_hash}/{image_id}/w=400,sharpen=3`

:::note

Flexible variants cannot be used for images that require a [signed delivery URL](/images/optimization/hosted-images/serve-private-images/).
