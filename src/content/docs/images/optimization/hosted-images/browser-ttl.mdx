...
By default, an image's TTL is set to two days to meet user needs, such as re-uploading an image under the same [Custom ID](/images/storage/upload-images/upload-custom-path/).
