...
- **[Control origin access](/images/optimization/transformations/control-origin-access)** — Use [Workers](/workers/) to add custom logic for validating and controlling access to source images.
- **[Set up rewrite rules](/images/optimization/transformations/rewrite-rules)** — Use [Transform Rules](/rules/transform/) to rewrite image URLs and serve transformations from custom paths.
