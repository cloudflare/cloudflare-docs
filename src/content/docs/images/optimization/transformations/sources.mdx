...
:::note
The allowed origins setting applies to requests from [Workers](/workers/).
...
To get started, you must have [transformations enabled on your zone](/images/optimization/transformations/overview/#how-it-works).
