...
You can delete an image from the Cloudflare Images storage using the dashboard, the API, or from a Worker via the [Images binding](/images/storage/workers-binding/#delete).
