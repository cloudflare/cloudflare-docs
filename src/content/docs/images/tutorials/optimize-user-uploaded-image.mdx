...
- [Images](/images/optimization/transformations/bindings/) to transform, resize, and encode images directly from your Worker.
...
Next, you can [set up a transformation URL](/images/optimization/features/#url-interface) to dynamically optimize images that are stored in R2.
