...
Learn about [pricing and limits for image transformation](/images/pricing/).
...
<sup>1</sup>Hard limit is 1,600 pixels when `format=avif` is explicitly used
with [image transformations](/images/transform-images/).
