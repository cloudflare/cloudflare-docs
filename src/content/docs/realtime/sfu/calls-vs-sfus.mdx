...
<Aside type="tip">
	**See it in action:** Explore our [interactive Global SFU
	visualization](https://realtime-sfu.dev-demos.workers.dev) to see how
	participants connect to their nearest Cloudflare datacenter and how media
	flows across the global backbone.
</Aside>
