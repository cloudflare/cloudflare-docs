...
<CardGrid class="xl:grid-cols-3">
  <LinkTitleCard
    ...
    icon="ph:cpu"
  >
    Connect an ESP32 to browser listeners. Publish audio and telemetry, give one
    operator control, and explore the pattern for robot gateways.
  </LinkTitleCard>
  <LinkTitleCard
    title="Cloud gaming"
  ...
  >
    Stream a game from a Container to browsers. Send keyboard and pointer input
    back through DataChannels.
  </LinkTitleCard>
  <LinkTitleCard
