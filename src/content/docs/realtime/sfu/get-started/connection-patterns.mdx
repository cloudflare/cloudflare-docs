...
Create the SFU session when ready to begin that connection's SDP exchange. [Unconnected sessions can expire before their first operation](/realtime/sfu/concepts/sessions-tracks/#session-setup).
