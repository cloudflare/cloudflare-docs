...
![Browsers publish and subscribe through SFU while a Worker and Durable Object coordinate room state.](~/assets/images/realtime/sfu/video-room-architecture.svg)
