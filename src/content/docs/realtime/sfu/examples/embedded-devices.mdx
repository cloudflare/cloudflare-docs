...
For a related implementation with a native video publisher, the [cloud-gaming example](/realtime/sfu/examples/cloud-gaming/) uses separate channels for reliable and transient input.
