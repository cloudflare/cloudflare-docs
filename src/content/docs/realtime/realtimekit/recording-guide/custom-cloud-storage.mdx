...
1. In the Cloudflare [RealtimeKit Dashboard](https://dash.cloudflare.com/?to=/:account/realtime/kit), go to Recordings.
...
![Recording Storage Screenshot](~/assets/images/realtime/realtimekit/recording-storage.png)
<br />

:::note

If you have specified storage configuration in the
[Start Recording](/api/resources/realtime_kit/subresources/recordings/methods/start_recordings/) APIs, it will take
