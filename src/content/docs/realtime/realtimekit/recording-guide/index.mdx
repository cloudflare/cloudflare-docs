...
meeting, record it, and then upload it to RealtimeKit's AWS S3 bucket. For video files,
...
1. When the recording is finished, it is stored in RealtimeKit's AWS S3 bucket.
