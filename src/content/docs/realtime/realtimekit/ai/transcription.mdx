...
You can enable post-meeting transcription when you create a meeting. Set `transcribe_on_end: true` to generate a transcript after the meeting ends. To also generate a [summary](/realtime/realtimekit/ai/summary/) automatically after the transcript is available, set `summarize_on_end: true`.
