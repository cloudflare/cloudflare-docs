...
import RTKPricingCalculator from "~/components/realtimekit/RTKPricingCalculator/RTKPricingCalculator.astro";
...
Use the calculator below to estimate your monthly cost based on expected usage.

<RTKPricingCalculator />
