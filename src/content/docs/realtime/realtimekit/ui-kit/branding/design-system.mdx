...
<RTKCodeSnippet id={["mobile-android", "mobile-flutter", "mobile-react-native"]}>
...
| Token              | Android   | Flutter   | React Native |
| ------------------ | --------- | --------- | ------------ |
| Brand color        | `#2160FD` | `#2160FD` | `#2160FD`    |
| Background         | `#080808` | `#080808` | `#080808`    |
| Text on background | `#FFFFFF` | `#FFFFFF` | `#FFFFFF`    |
| Text on brand      | `#111111` | —         | `#FFFFFF`    |
...
:::note
Flutter uses the enum value `RtkBorderRadius.extrarounded` (no hyphen). React Native uses the string `'extra-rounded'` (with hyphen).
:::
