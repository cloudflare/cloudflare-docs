...
<br/>
Creating meeting objects and participant tokens does not incur charges.
...
<br/>
The keep-alive period is included in the export charges. To avoid this extra time, explicitly end the session by calling <a href="/realtime/realtimekit/core/end-a-session/"><code>kickAll()</code></a> or the [Kick all participants API](/api/resources/realtime_kit/subresources/active-session/methods/kick_all_participants/).
