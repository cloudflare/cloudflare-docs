...
Instead, set up the default meeting UI in your own website by following the [UI Kit setup guide](/realtime/realtimekit/ui-kit/) or deploy the [RealtimeKit web examples](https://github.com/cloudflare/realtimekit-web-examples/) on your own infrastructure. The effort required for either approach is minimal and provides significant benefits:
