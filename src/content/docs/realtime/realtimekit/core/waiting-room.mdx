...
Hosts can manage waiting room requests using participant management methods. See [Remote Participants](/realtime/realtimekit/core/remote-participants/) for details on:
