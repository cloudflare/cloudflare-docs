...
| Param | Type | Description |
| --- | --- | --- |
| options | <code>FetchPrivateMessagesOptions</code> | Configuration options for fetching private messages, including the participant user ID and pagination settings. |
...
| --- | --- | --- |
| timestamp | <code>number</code> | Timestamp in milliseconds to use as the pagination cursor. Defaults to the current time. |
| limit | <code>number</code> | Number of messages to fetch. |
| direction | <code>&#x27;before&#x27;</code> \| <code>&#x27;after&#x27;</code> | Direction to fetch messages from the timestamp. |

#### FetchPrivateMessagesOptions

| Property | Type | Description |
| --- | --- | --- |
| userId | <code>string</code> | User ID of the participant in the private chat. |
| timestamp | <code>number</code> | Timestamp in milliseconds to use as the pagination cursor. Defaults to the current time. |
| limit | <code>number</code> | Number of messages to fetch. |
| direction | <code>&#x27;before&#x27;</code> \| <code>&#x27;after&#x27;</code> | Direction to fetch messages from the timestamp. |
