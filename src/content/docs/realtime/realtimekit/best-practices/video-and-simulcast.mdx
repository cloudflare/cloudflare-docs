...
- **Speaker preset**: Set resolution to `1280×720` or `1920×1080`. The speaker tile is large and benefits from higher quality.
- **Participant preset**: Set resolution to `320×240`. Participant tiles are small thumbnails.
...
**Turn off simulcast when:**

- The session is a 1:1 call (one receiver, no benefit from multiple layers)
