...
1. Log in to the [Cloudflare dashboard](https://dash.cloudflare.com/login) and select the [zone](/fundamentals/accounts-and-zones/#zones) you want to use with Instant Logs.
