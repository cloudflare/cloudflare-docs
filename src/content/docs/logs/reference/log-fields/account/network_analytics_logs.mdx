...
Reason for applying a mitigation to the packet, if any. <br />Possible values are <em>BLOCKED</em> | <em>RATE\_LIMITED</em> |<em>UNEXPECTED</em> | <em>CHALLENGE\_NEEDED</em> | <em>CHALLENGE\_PASSED</em> | <em>NOT\_FOUND</em> | <em>OUT\_OF\_SEQUENCE</em> | <em>ALREADY\_CLOSED</em>.
