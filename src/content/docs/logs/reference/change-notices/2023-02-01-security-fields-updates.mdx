...
Follow the instructions in [Update output_options](/logs/logpush/examples/example-logpush-curl/#optional---update-output_options) to update the fields in the Logpush job.
