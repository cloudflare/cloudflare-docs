...
```bash
curl "https://api.cloudflare.com/client/v4/zones/{zone_id}/logs/rayids/47ff6e2c812d3ccb?timestamps=rfc3339" \
--header "X-Auth-Email: <EMAIL>" \
--header "X-Auth-Key: <API_KEY>"
```
...
Refer to [Download jq](https://stedolan.github.io/jq/download/) for more information on obtaining and installing `jq`.
