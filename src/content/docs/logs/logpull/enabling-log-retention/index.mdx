...
To make a `POST` call, you must have zone-scoped `edit` permissions, such as Super Administrator, Administrator, or Log Share. Refer to the page [Make API Calls](/fundamentals/api/how-to/make-api-calls/) for more information.
