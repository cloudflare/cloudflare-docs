...
To view, create, update, or delete Logpush jobs for Zero Trust datasets (Access, Gateway, and DEX) users must have both the `logs:edit` and `teams:pii` permissions.
...
For more information, refer to [Managing roles within your Cloudflare account](/fundamentals/manage-members/).
