...
To open the **Infrastructure** tab, go to Account Home > **Application Security** > **Infrastructure**.
...
- **Manage your security.txt file** — Create or update a [`security.txt`](/application-security/infrastructure/security-file/) file that provides security researchers with a standardized way to report vulnerabilities.
