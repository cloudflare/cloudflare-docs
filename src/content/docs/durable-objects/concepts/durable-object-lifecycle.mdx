...
Refer to [Delay code updates until hibernation](/durable-objects/reference/durable-objects-code-updates/) to configure a code update strategy and understand how it interacts with gradual deployments.
