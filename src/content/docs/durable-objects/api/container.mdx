...
While the promise remains pending, it prevents eviction for up to 15 minutes for that I/O event. Subsequent eligible I/O can reset or extend the [keep-alive period](/durable-objects/concepts/durable-object-lifecycle/).
