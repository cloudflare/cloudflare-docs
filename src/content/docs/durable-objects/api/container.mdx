...
- `options` (optional): An object with the following properties:
  ...
  - `image`: The image reference to start. For a Container application that uses the `durable_object` scheduling policy, pass a reference from [`ctx.container.images`](#images) unless you are restoring a snapshot.
