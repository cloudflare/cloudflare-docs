...
- An optional object with the key `jurisdiction` and value of a [jurisdiction](/durable-objects/how-to/configure-data-location/#restrict-durable-objects-to-a-jurisdiction) string.
...
- An optional object with the key `locationHint` and value of a [locationHint](/durable-objects/how-to/configure-data-location/#provide-a-location-hint) string.
...
`jurisdiction` creates a subnamespace from a namespace where all Durable Object IDs and references created from that subnamespace will be restricted to the specified [jurisdiction](/durable-objects/how-to/configure-data-location/#restrict-durable-objects-to-a-jurisdiction).
...
- A required [jurisdiction](/durable-objects/how-to/configure-data-location/#restrict-durable-objects-to-a-jurisdiction) string.
