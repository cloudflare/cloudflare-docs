...
Alarms can be used to build distributed primitives, like queues or batching of work atop Durable Objects. Alarms also provide a mechanism to guarantee that operations within a Durable Object will complete without relying on incoming requests to keep the Durable Object alive. For a complete example, refer to [Use the Alarms API](/durable-objects/how-to/use-alarms/).
...
- <code>
  	alarm(alarmInfo <Type text="Object" />)
  </code>
  : <Type text="void" />
...
- Understand how to [use the Alarms API](/durable-objects/how-to/use-alarms/) in an end-to-end example.
