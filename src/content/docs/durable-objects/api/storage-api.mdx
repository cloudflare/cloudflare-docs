...
* `get(keystring, optionsObjectoptional)`: <Type text='Promise<any>' />

  * Retrieves the value associated with the given key. The type of the returned value will be whatever was previously written for the key, or undefined if the key does not exist.

* `get(keysArray\<string>, optionsObjectoptional)`: <Type text = 'Promise<Map<string, any>>' />
...
* `put(keystring, valueany, optionsObjectoptional)`: <Type text='Promise' />
...
* `put(entriesObject, optionsObjectoptional)`: <Type text='Promise' />
...
* `delete(keystring, optionsObjectoptional)`: <Type text='Promise<boolean>' />

  * Deletes the key and associated value. Returns `true` if the key existed or `false` if it did not.

* `delete(keysArray\<string>, optionsObjectoptional)`: <Type text='Promise<number>' />

  * Deletes the provided keys and their associated values. Supports up to 128 keys at a time. Returns a count of the number of key-value pairs deleted.

### deleteAll

* `deleteAll(optionsObjectoptional)`: <Type text='Promise' />
...
* `list(optionsObjectoptional)`: <Type text= 'Promise<Map<string, any>>' />
...
* `getAlarm(optionsObjectoptional)`: <Type text='Promise<Number | null>' />
...
* `setAlarm(scheduledTimeDate | number, optionsObjectoptional)`: <Type text='Promise' />
...
* `deleteAlarm(optionsObjectoptional)`: <Type text ='Promise' />
...
`ctx.storage.sql.exec(query: string, ...bindings: any[])`: <Type text='SqlStorageCursor' />
...
`ctx.storage.getBookmarkForTime(timestamp: number | Date)`: <Type text='Promise<string>' />
...
`ctx.storage.onNextSessionRestoreBookmark(bookmark: string)`: <Type text='Promise<string>' />
