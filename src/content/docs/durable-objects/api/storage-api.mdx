...
* <code>get(keysArray <Type text='string'/>, optionsObjectoptional)</code>: <Type text = 'Promise<Map<string, any>>' />
...
* <code>delete(keysArray <Type text='string'/>, optionsObjectoptional)</code>: <Type text='Promise<number>' />
...
* <code>setAlarm(scheduledTimeDate | <Type text='number'/>, optionsObjectoptional)</code>: <Type text='Promise' />
