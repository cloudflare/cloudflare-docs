...
* <code>getAlarm(options <Type='Object' /> <MetaInfo text='optional' />)</code>: <Type text='Promise<Number | null>' />
...
* <code>setAlarm(scheduledTime <Type text='Date | number' />, options <Type='Object' /> <MetaInfo text='optional' />)</code>: <Type text='Promise' />
