...
- `serializeAttachment(valueany)`: <Type text='void' />
...
- <code>acceptWebSocket(wsWebSocket, tagsArray <Type text='string'/> <MetaInfo text='optional'/>)</code>: <Type text='void' />
...
- `getWebSockets(tagstringoptional)`: <Type text='Array<WebSocket>' />
...
- `getTags(wsWebSocket)`: <Type text='Array\<string>' />
...
- `setWebSocketAutoResponse(webSocketRequestResponsePairWebSocketRequestResponsePairoptional)`: <Type text='void' />
...
- `getWebSocketAutoResponseTimestamp(wsWebSocket)`: <Type text= 'Date | null' />
...
- `setHibernatableWebSocketEventTimeout(timeoutnumberoptional)`: <Type text='void' />
...
- `webSocketMessage(wsWebSocket, messageString | ArrayBuffer)`: <Type text='void' />
...
- `webSocketClose(wsWebSocket, codenumber, reasonstring, wasCleanboolean)`: <Type text='void' />
...
- `webSocketError(wsWebSocket, errorany)` : <Type text='void' />
