...
You can only use Data Studio to access data for [SQLite-backed Durable Objects](/durable-objects/how-to/access-storage/#create-sqlite-backed-durable-object-class).
