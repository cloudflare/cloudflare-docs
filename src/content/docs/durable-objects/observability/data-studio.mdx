...
You need at least `Editor` access to the Worker that implements the Durable Object to access Data Studio. Refer to [Durable Objects roles and permissions](/workers/authorization/durable-objects/) for more information.
