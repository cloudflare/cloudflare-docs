...
This error occurs when a code update is applied before a Durable Object reaches hibernation. This includes immediate updates and updates whose hibernation timeout expires.
...
Refer to [Code updates in the Durable Object lifecycle](/durable-objects/concepts/durable-object-lifecycle/#code-updates) and [Global uniqueness](/durable-objects/platform/known-issues/#global-uniqueness).
