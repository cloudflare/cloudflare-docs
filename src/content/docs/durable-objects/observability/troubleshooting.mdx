...
Refer to [Delay code updates until hibernation](/durable-objects/reference/durable-objects-code-updates/) and [Global uniqueness](/durable-objects/platform/known-issues/#global-uniqueness).
