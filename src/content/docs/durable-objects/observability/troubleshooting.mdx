...
Refer to [Durable Objects code updates](/durable-objects/deployments/durable-objects-code-updates/) and [Global uniqueness](/durable-objects/platform/known-issues/#global-uniqueness).
