...
This error occurs when a code update is applied before a Durable Object reaches hibernation. This includes a `0` deployment grace period and deployments whose grace period ends before the object hibernates.
