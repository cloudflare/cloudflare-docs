...
<Tabs>
	<TabItem label="npm">
		```sh npm i -D vitest@~3.2.0 @cloudflare/vitest-pool-workers ```
	</TabItem>
	<TabItem label="pnpm">
		```sh pnpm add -D vitest@~3.2.0 @cloudflare/vitest-pool-workers ```
	</TabItem>
	<TabItem label="yarn">
		```sh yarn add -D vitest@~3.2.0 @cloudflare/vitest-pool-workers ```
	</TabItem>
</Tabs>
