...
- A [configured binding](/kv/concepts/kv-bindings/) for the `kv_namespace` in the Cloudflare dashboard or [Wrangler configuration](/workers/wrangler/configuration) file.
- A [Durable Object namespace binding](/workers/wrangler/configuration/#durable-objects).

Configure your [Wrangler configuration](/workers/wrangler/configuration) file as follows:
