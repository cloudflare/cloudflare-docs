...
tags:
  ...
  - SQL
description: >-
  This tutorial shows you how to build a seat reservation app using Durable Objects. The app will allow users to book a seat for a flight. It will be written in TypeScript and will use the new SQLite storage backend in Durable Object.
---
