...
However, an active outbound WebSocket connection **does** keep the Durable Object alive and prevents eviction for the duration of the connection (up to 15 minutes per connection). Refer to [Lifecycle of a Durable Object](/durable-objects/concepts/durable-object-lifecycle/) for more details.
