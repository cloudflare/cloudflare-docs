...
However, an active outbound WebSocket connection prevents eviction for up to 15 minutes. Starting another operation that prevents eviction can extend time in memory. There is no 15-minute limit for the entire invocation. Refer to [Lifecycle of a Durable Object](/durable-objects/concepts/durable-object-lifecycle/) for more information.
