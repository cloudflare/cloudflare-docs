...
To allow a new Durable Object class to use SQLite storage backend, use `new_sqlite_classes` on the migration in your Worker's [Wrangler configuration](/workers/wrangler/configuration) file:
