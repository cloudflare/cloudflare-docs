...
New beta version of Durable Objects is available where each Durable Object has a private, embedded SQLite database. When creating a Durabe Object class, users can [opt-in to using SQL storage](/reference/durable-objects-migrations/#enable-sql-storage-on-create-durable-object-class-migration).
