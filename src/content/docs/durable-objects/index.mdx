...
:::note
SQLite-backed Durable Objects are available on all Workers plans, including the Free plan. Refer to [pricing](/durable-objects/platform/pricing/) for details.
:::
...
For more information, refer to [How Durable Objects work](/durable-objects/concepts/how-durable-objects-work/).

---

## Features

<Feature header="In-memory State" href="/durable-objects/concepts/how-durable-objects-work/">
...
<Feature header="WebSocket Hibernation" href="/durable-objects/how-to/use-websockets/#websocket-hibernation-api">
