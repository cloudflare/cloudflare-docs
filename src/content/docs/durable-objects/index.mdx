...
:::note[SQLite in DO Beta]

New beta version of Durable Objects is available where each Durable Object has a private, embedded SQLite database. When creating a Durabe Object namespace, users can [opt-in to using SQL storage](TODO link).
