...
Durable Objects provide a powerful compute API for coordinating multiple clients or users. Each Durable Object has a private, transactional and strongly consistent storage attached.
