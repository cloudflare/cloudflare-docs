...
- Pending outbound I/O keeps a Durable Object in memory. The object incurs duration charges for up to 15 minutes per I/O event, even without incoming requests. New eligible I/O can reset or extend the keep-alive window. Refer to [Lifecycle of a Durable Object](/durable-objects/concepts/durable-object-lifecycle/) for more information.
