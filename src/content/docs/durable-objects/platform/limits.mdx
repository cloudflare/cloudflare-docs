...
| Feature                                  | Limit for class with key-value storage                           | Limit for class with SQL storage <sup>1</sup> |
| ---------------------------------        | ---------------------------------------------------------------- | --------------------------------------------- |
...
For classes with SQL storage these SQL limits apply:
| SQL                                                      | Limit | 
