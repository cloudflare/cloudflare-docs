...
For more information, refer to [Migration Wrangler Configuration](/durable-objects/reference/durable-object-class-migrations-legacy/#migration-wrangler-configuration).
...
Refer to Workers [Local development](/workers/local-development/bindings-per-env/).
