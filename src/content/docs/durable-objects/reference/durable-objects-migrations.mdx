...
:::caution[Important]
Durable Object migrations are atomic operations and cannot be gradually deployed. To provide early feedback to developers, new Worker versions with new migrations cannot be uploaded. Refer to [Split deployments for Durable Objects](/workers/configuration/versions-and-deployments/split-deployments/#split-deployments-for-durable-objects) for more information.
:::
