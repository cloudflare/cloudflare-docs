...
<Render file="c3-run-command-with-directory" product="workers" params={{ one: "durable-object-starter" }} />
...
<Render file="c3-post-run-steps" product="workers" params={{ one: "Hello World example", two: "Hello World Worker Using Durable Objects", three: "JavaScript / Typescript" }} />
