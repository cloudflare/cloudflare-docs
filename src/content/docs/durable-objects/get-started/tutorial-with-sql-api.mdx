...
The Durable Object migration to create a new Durable Object class with SQLite storage backend will look like the following in your Worker's [Wrangler configuration](/workers/wrangler/configuration) file:
