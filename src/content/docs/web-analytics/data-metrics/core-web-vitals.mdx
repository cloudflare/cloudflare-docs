...
Cumulative Layout Shift is currently only supported in Chromium browsers, Firefox and Safari have not yet implemented [support for the Layout Instability API](https://caniuse.com/wf-layout-instability).
