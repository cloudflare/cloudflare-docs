...
- **Capacity planning**: The customer owns the capacity planning across the links that they have available to us according to the topology and size of those links.
