...
CNI supports BGP peering with the Magic routing table. For detailed information about BGP architecture, Edge Resiliency Mode, and route propagation behavior, refer to the BGP reference documentation in [Magic Transit](/magic-transit/reference/traffic-steering/#bgp-information) or [Magic WAN](/magic-wan/reference/traffic-steering/#bgp-information) depending on your use case.
:::
