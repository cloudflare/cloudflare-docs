...
5. From the list of locations, choose the one that suits you with **Select the location**.
   ...
   :::note
   If your location does not come up in the search, that means that Express CNI is not available in your location yet. Refer to [Classic CNI](/network-interconnect/classic-cni/) to learn how you can use the classic version of network interconnect to connect your location to Cloudflare.
   :::
