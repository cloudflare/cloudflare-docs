...
4. From the list, choose a location that suits you with **Select location**, or search for a location in the search box. Beyond city, state and country, you can also search by the [IATA airport code](https://en.wikipedia.org/wiki/IATA_airport_code) for the metro area in which your data center is located.
   :::note
