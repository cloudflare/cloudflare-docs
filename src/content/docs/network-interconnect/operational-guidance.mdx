...
description: Plan a resilient CNI deployment and troubleshoot connectivity issues.
sidebar:
  order: 7
---

For information about maintenance coordination and notifications, refer to [Maintenance](/network-interconnect/maintenance/).
