...
The following applies to both CNI Dataplane v1 and Dataplane v2.
...
- Maintenance on redundant devices (for example, edge router 1 and edge router 2) may occur on consecutive days with a minimum 16-hour gap between windows.
