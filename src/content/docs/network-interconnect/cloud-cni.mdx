...
6. Select **Continue**.
7. From the **Interface speed** dropdown menu, select a connection speed that suits your network.
...
Your Google Cloud interconnect will take a few minutes to be available.

#### Next steps

Now that you have configured your Google Cloud Interconnect, you need to add [static routes](/magic-wan/configuration/manually/how-to/configure-static-routes/) to route your traffic through anycast tunnels from Cloudflare's global network to your locations.

You can also select **View interconnects** for a list of all interconnects on your account.