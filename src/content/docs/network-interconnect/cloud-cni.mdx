...
If you are a Magic WAN customer you can use Cloud Interconnect to connect to [AWS Direct Connect](https://docs.aws.amazon.com/directconnect/). Currently, Cloud Interconnect only supports Dedicated Direct Connect, not Hosted Direct Connect. A Dedicated AWS Direct Connect involves a full physical port allocation in AWS, whereas a Hosted AWS Direct Connect uses a VLAN on a shared port between AWS and Cloudflare.
