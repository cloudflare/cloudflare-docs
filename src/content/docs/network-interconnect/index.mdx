...
When you review the [available locations](/network-interconnect/static/cni-locations-04-08-2025.pdf), you can see which dataplane version(s) are available.
...
Refer to [Service Expectations](#link) for more information.
