---
thtitle: Cloudflare Network Interconnect
...
When you review the [available locations](/network-interconnect/static/cni-locations-31-mar-2026.pdf) (PDF), you can see which dataplane version(s) are available.
