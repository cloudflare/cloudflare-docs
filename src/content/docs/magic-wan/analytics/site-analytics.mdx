...
- How many active sites you have configured
- How many sites are healthy or unhealthy
- Ho many sites have no status available
- How many sites have no location set

![The map shows all sites you configured for Magic WAN](~/assets/images/magic-wan/analytics/all-sites.png)

#### Site health

Sites can be healthy or unhealthy, and Magic WAN routes traffic through tunnels according to their health. Refer to [Set thresholds for Magic WAN site health](#set-thresholds-for-magic-wan-site-health) to learn more about this topic.

#### No status available

If your sites show a **No status available** message, this means you did not configure your [Tunnel health check alerts](/magic-wan/configuration/common-settings/configure-magic-tunnel-alerts/).
...
![When you select one site you have access to more details, including traffic by tunnel](~/assets/images/magic-wan/analytics/site-info.png)
