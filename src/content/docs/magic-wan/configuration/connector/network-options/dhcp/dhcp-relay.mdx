...
:::caution
DHCP relay will not work if your DHCP server is behind a [Cloudflare Tunnel](/cloudflare-one/connections/connect-networks/). You need to use a Magic WAN tunnel or CNI connection for DHCP relay to work.
:::
