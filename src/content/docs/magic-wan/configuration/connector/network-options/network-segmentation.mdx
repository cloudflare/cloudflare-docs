...
Refer to [Magic WAN Connector deployment options](/reference-architecture/diagrams/sase/magic-wan-connector-deployment/) for detailed information on a high-level explanation of the deployment options for Magic WAN Connector, as well as examples of network segmentation.
