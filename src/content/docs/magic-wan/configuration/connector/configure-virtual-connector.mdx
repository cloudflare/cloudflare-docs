...
VLAN tagging. Virtual Connector supports creating subinterfaces through the use of [802.1Q VLAN tagging](https://en.wikipedia.org/wiki/IEEE_802.1Q).
...
<Render
	...
	params={{
		one: "Follow the instructions in [Activate connector](#activate-connector) to finish setting up your Connectors.",
	}}
/>
