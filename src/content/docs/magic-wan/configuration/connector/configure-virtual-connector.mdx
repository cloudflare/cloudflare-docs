...
Virtual Connector uses a DHCP connection at first boot to download your settings and go through the activation process. If you need to use a static IP in your Virtual Connector, and this is a fresh install:
