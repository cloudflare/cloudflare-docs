...
<Render file="mconn/configure-connectors"
  ...
  reserveIpAddressesURL: "/magic-wan/configuration/connector/network-options/dhcp/dhcp-static-address-reservation/",
	...
	finalInstructions: "Follow the instructions in [Set up your Magic WAN Connector](#set-up-your-magic-wan-connector) and [Activate appliance](#activate-appliance) to finish setting up your Connectors.",
