...
- Go through the setup flow below
- Activate your Connector
- Wait 60 seconds after activating
- Edit your WAN IP settings in the dashboard
- Wait 60 seconds again
- Adjust your physical connections as required to match the static IP configuration
