...
<Render
	...
	params={{
		one: "The dashboard shows the view of tunnel health as measured from each Cloudflare location where your traffic is likely to land.",
		two: "**Magic WAN** > **Tunnel health**",
	}}
/>
