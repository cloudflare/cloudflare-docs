...
![The Palo Alto interface showing the Trust\_L3\_Zone](~/assets/images/magic-wan/third-party/palo-alto/panw_zones/01_trust_zone.png)
...
![The Palo Alto interface showing the Untrust\_L3\_Zone](~/assets/images/magic-wan/third-party/palo-alto/panw_zones/02_untrust_zone.png)
...
![The Palo Alto interface showing the Cloudflare\_L3\_Zone](~/assets/images/magic-wan/third-party/palo-alto/panw_zones/03_cloudflare_zone.png)
...
| Name                       | Option      | Value                              |
| -------------------------- | ----------- | ---------------------------------- |
| `Magic_WAN_VLAN0010_Tun01` | Destination | _VLAN0010\_10-1-10-0--24_          |
...
| Name                       | Option      | Value                              |
| -------------------------- | ----------- | ---------------------------------- |
| `Magic_WAN_VLAN0010_Tun02` | Destination | _VLAN0010\_10-1-10-0--24_          |
...
| Name                       | Option      | Value                              |
| -------------------------- | ----------- | ---------------------------------- |
| `Magic_WAN_VLAN0020_Tun01` | Destination | _VLAN0020\_10-1-20-0--24_          |
|                            | Interface   | _tunnel.1_                         |
|                            | Next hop    | _IP Address_                       |
|                            |             | _CF\_MWAN\_IPsec\_VTI\_01\_Remote_ |
|                            | Metric      | `10`                               |
...
| Name                       | Option      | Value                              |
| -------------------------- | ----------- | ---------------------------------- |
| `Magic_WAN_VLAN0020_Tun02` | Destination | _VLAN0020\_10-1-20-0--24_          |
|                            | Interface   | _tunnel.2_                         |
|                            | Next hop    | _IP Address_                       |
|                            |             | _CF\_MWAN\_IPsec\_VTI\_02\_Remote_ |
|                            | Metric      | `11`                               |
...
|                                 | Source Address      | **CF\_Health\_Check\_Anycast\_01** <br/> **CF\_Health\_Check\_Anycast\_02** |
...
| Name                                    | Option              | Value                              |
| --------------------------------------- | ------------------- | ---------------------------------- |
| `PBF_Cloudflare_Health_Check_01`        | Tags                | _Cloudflare\_L3\_Zone_             |
|                                         | Group Rules By Tag  | _None_                             |
...
| Name                                    | Option              | Value                              |
| --------------------------------------- | ------------------- | ---------------------------------- |
| `PBF_Cloudflare_Health_Check_02`        | Tags                | _Cloudflare\_L3\_Zone_             |
|                                         | Group Rules By Tag  | _None_                             |
| **Source tab**                          | Type                | _Zone_                             |
|                                         | Zone                | **Cloudflare\_L3\_Zone**           |
...
| **Destination tab**                   | Destination Zone    | **Cloudflare\_L3\_Zone**                                      |
|                                       | Destination Address | **VLAN0010\_10-1-10-0--24** <br/> **VLAN0020\_10-1-20-0--24** |
| **Actions tab**                       | Action              | _Allow_                                                       |
|                                       | Log Setting         | **Log at Session End**                                        |
|                                       | Profile type        | _None_                                                        |
|                                       | Schedule            | _None_                                                        |
...
|                                       | Group Rules by Tag  | _None_                                                        |
| Source tab                            | Source Zone         | **Cloudflare\_L3\_Zone**                                      |
|                                       | Source Address      | **VLAN0010\_10-1-10-0--24** <br/> **VLAN0020\_10-1-20-0--24** |
...
|                                         | Source Address      | **VLAN0100\_10-1-100-0--24**                                  |
| **Destination/Application/Service tab** | Destination Address | **VLAN0010\_10-1-10-0--24** <br/> **VLAN0020\_10-1-20-0--24** |
| **Forwarding tab**                      | Action              | _Forward_                                                     |
|                                         | Egress Interface    | _tunnel.1_                                                    |
|                                         | Next hop            | _IP Address_                                                  |
|                                         |                     | _CF\_MWAN\_IPsec\_VTI\_01\_Remote_                            |
...
| **Source tab**                       | Source Zone         | **Trust\_L3\_Zone**                                                            |
| **Destination tab**                  | Destination Zone    | **Cloudflare\_L3\_Zone**                                                       |
|                                      | Destination Address | **VLAN0010\_10-1-10-0--24** <br/> **VLAN0020\_10-1-20-0--24** <br/> **Negate** |
| **Actions tab**                      | Action              | _Allow_                                                                        |
|                                      | Log Setting         | **Log at Session End**                                                         |
|                                      | Profile Type        | _None_                                                                         |
|                                      | Schedule            | _None_                                                                         |
...
| **Source tab**                          | Source Zone         | **Trust\_L3\_Zone**                                                            |
| **Destination/Application/Service tab** | Destination Address | **VLAN0010\_10-1-10-0--24** <br/> **VLAN0020\_10-1-20-0--24** <br/> **Negate** |
| **Forwarding tab**                      | Action              | _Forward_                                                                      |
|                                         | Egress Interface    | _tunnel.1_                                                                     |
|                                         | Next Hop            | _IP Address_                                                                   |
|                                         |                     | _CF\_MWAN\_IPsec\_VTI\_01\_Remote_                                             |
