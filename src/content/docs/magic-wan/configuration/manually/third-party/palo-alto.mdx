...
|                  | Version              | *IKEv2 only mode*. <br/> Make sure both IKE Gateways are based only on this setting.                                                                                                                                    |
...
|                  | Local Identification | *FQDN (hostname)*. <br/> You can obtain this value from the Cloudflare Dashboard - value is unique per tunnel.                                                                                                          |
