...
:::note
It can take anywhere from 30 to 45 minutes for Azure to fully provision the Virtual Network Gateway.
:::
...
We recommend creating one Local Network Gateways for your Cloudflare IPsec tunnel.
