...
1. Start by [creating the IPsec tunnels](/magic-wan/configuration/manually/how-to/configure-tunnel-endpoints/#add-tunnels) in the Cloudflare dashboard with the following values:
...
Add an IKE proposal that specifies the [Phase 1 Configuration Parameters](/magic-wan/reference/gre-ipsec-tunnels/#supported-configuration-parameters):
...
Add an IPsec proposal that specifies the [Phase 2 Configuration Parameters](/magic-wan/reference/gre-ipsec-tunnels/#supported-configuration-parameters):
