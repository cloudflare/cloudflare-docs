...
- For tunnel health check problems, refer to [Troubleshoot tunnel health](/magic-wan/troubleshooting/tunnel-health/).
- For IPsec tunnel establishment issues, refer to [Troubleshoot with IPsec logs](/magic-wan/troubleshooting/ipsec-troubleshoot/).
