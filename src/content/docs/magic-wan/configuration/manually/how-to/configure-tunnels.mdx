...
<Render
	...
	params={{ one: "(this address space is also a link-local address)" }}
/>
...
<Render
	...
	params={{
		one: "Magic WAN",
		two: "/magic-wan/reference/tunnels/",
		three: "/magic-wan/reference/tunnels/#supported-configuration-parameters",
	}}
/>
...
<Render
	...
	params={{
		one: "Magic WAN",
		two: "/magic-wan/reference/anti-replay-protection/",
	}}
/>
...
<Render
	...
	product="magic-transit"
	params={{ one: "/magic-wan/reference/tunnel-health-checks/" }}
/>
