...
Now that you have configured your tunnels and BGP peering, the next step is to create a site. <Render file="sites-brief" product="networking-services" />