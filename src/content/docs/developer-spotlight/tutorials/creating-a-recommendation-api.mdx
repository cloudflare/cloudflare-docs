...
To use the created Vectorize index from your Worker, let's add the relevant [remote binding](/workers/development-testing/#remote-bindings). Open the [Wrangler configuration file](/workers/wrangler/configuration/) and add the copied lines.
...
Additionally, let's add the configuration to use Workers AI in the [Wrangler configuration file](/workers/wrangler/configuration/), again as a [remote binding](/workers/development-testing/#remote-bindings).
