...
To use the database in your worker, you will need to add the binding to your [Wrangler configuration](/workers/wrangler/configuration) file, by copying the declaration and pasting it into the wrangler file, as shown in the example below.
...
To do this, go to the [Wrangler configuration](/workers/wrangler/configuration) file again and then add the following lines:
