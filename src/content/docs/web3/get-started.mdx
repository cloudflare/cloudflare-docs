...
Before you start, make sure the you have [set up an account](/fundamentals/account/) and [added your website](/fundamentals/setup/manage-domains/add-site/) to Cloudflare.
