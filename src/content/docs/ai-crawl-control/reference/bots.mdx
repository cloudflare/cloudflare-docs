...
<Aside type="note">
	[Bot Management](/bots/get-started/bot-management/) customers can use
	`cf.bot_management.detection_ids` in [WAF custom rules](/waf/custom-rules/).
	All other plans can use user agent matching in robots.txt or WAF rules.
</Aside>
