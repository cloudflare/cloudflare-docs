...
- Only [verified bots](/bots/concepts/bot/#verified-bots) with the [AI Crawler category](/bots/concepts/bot/verified-bots/#legacy-categories) are redirected. [AI Assistants and AI Search bots](/bots/concepts/bot/verified-bots/#legacy-categories) are not affected.
...
- [Verified bots](/bots/concepts/bot/verified-bots/#legacy-categories) - Bot categories including AI Crawler, AI Assistant, and AI Search
