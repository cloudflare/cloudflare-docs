...
| [Client-side security](/client-side-security/) (formerly Page Shield)      | Simplifies external script management by tracking loaded resources like scripts and providing alerts when it detects new resources or malicious scripts. |
...
| [Images](/images/optimization/transformations/bindings/)[^4]                          | Store, transform, optimize, and deliver images at scale.                                                                                           |
...
[^4]: Image Resizing works [within Workers](/images/optimization/transformations/transform-via-workers/), but may not be available [through URL format](/images/optimization/features/).
...
Refer to [Global Acceleration](/china-network/concepts/global-acceleration/) for more information.
