...
| Example format  | Beijing ICP preparation XXXXXXXX number                                                                                                                                                                       | Beijing ICP license XXXXXXXX number                                                                                                                                                                  |     | Companies acquiring an ICP license must already have obtained an ICP filing. |
