...
If you want to operate a website in China, you need government permission called an Internet Content Provider (ICP) number. Think of it as a permit — without one, your site can be shut down.
...
You do not apply for an ICP number directly with the Chinese government. Instead, Cloudflare recommends that you apply through your hosting or cloud services provider, who submits the registration on your behalf. You will need to provide the following documents to your provider:
