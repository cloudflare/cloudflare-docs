...
description: >-
  Use the Cloudflare Load Balancing product to fail traffic over as needed. Use \"geo steering\" to serve results from an origin server that is geographically closest to your users.
---
