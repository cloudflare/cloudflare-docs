...
description: >-
  Page Rules let you override zone settings for specific URL patterns. Redirects old URLs with a 301 permanent redirect. Increases security to \"Under Attack\" mode for your database endpoint.
---
