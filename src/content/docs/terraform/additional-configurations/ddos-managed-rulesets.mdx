...
1. Mitigate any large HTTP DDoS attacks by configuring a rule with a *Low* [sensitivity level](/ddos-protection/managed-rulesets/http/override-parameters/#sensitivity-level) and a *Block* action.
