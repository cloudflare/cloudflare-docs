...
description: >-
  The Cloudflare Terraform tool is available in the [Terraform ME] repository. To use it, you must first install the Terraform app on your Mac or Linux system. You must then import Cloudflar resources individually by providing their IDs and names.
---
