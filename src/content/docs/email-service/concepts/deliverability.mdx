...
Email Service adds eligible recipient-side hard bounces to your [suppression list](/email-service/concepts/suppressions/). The default expiration is seven days. Confirmed invalid recipients have no expiration. For the complete rules, refer to [Hard bounces](/email-service/concepts/suppressions/#hard-bounces).
...
Cloudflare automatically retries soft bounces with exponential backoff. Eligible recipient-side failures create a 24-hour suppression by default. For the complete rules, refer to [Soft bounces](/email-service/concepts/suppressions/#soft-bounces).
