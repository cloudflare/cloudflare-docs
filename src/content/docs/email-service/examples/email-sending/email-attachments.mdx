...
- [Send method](/email-service/api/send-emails/workers-api/) — full reference for the `Attachment` interface and the `send()` method.
- [Limits](/email-service/platform/limits/) — message size and attachment limits.
- [Email headers](/email-service/reference/headers/) — set custom headers alongside attachments.
