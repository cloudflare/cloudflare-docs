...
2. Navigate to **Compute** > **Email Service** > **Email Sending** or **Email Routing**.
   ...
   <DashButton url="/?to=/:account/email-service" />

3. Select **Onboard Domain**.

4. Choose a domain from your Cloudflare account. Optionally review the DNS records that Cloudflare will add to your domain:
