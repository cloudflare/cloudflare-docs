...
## 1. View suppressions in the dashboard
...
## 3. Remove a suppression in the dashboard
...
## 4. Manage suppressions with the API
...
- Review [Suppression lists](/email-service/concepts/suppressions/) for creation and expiration rules.
- Use the [Email Sending API reference](/api/resources/email_sending/) to view the complete API schema.
- Follow [Sync recipient records](/email-service/examples/email-sending/sync-recipient-records/) to maintain recipient status in your application.
