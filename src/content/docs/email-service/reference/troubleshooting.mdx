...
1. In the Cloudflare dashboard, go to **Email** > **Email Routing** and select your domain.
2. Disable Email Routing. Cloudflare removes the Cloudflare MX records automatically.
3. Add the five Google Workspace MX records. Refer to [Set up Google Workspace DNS records](/dns/manage-dns-records/how-to/set-up-google-workspace/) for the complete record values.
