...
4. Ensure you have only one SPF record that includes: `v=spf1 include:_spf.email.cloudflare.net ~all`
...
2. Add a TXT record with the following content:
   - **Name**: `@` (or your root domain)
   - **Content**: `v=spf1 include:_spf.email.cloudflare.net ~all`
3. If you already have an SPF record, modify it to include `include:_spf.email.cloudflare.net`
