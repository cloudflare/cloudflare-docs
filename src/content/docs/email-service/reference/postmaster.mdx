...
You can find the DKIM key for your domain by querying the following:
...
For SPF records, you'll need to include Cloudflare's Email Service sending infrastructure:
