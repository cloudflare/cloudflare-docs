...
import { Steps, Tabs, TabItem, WranglerConfig, PackageManagers, DashButton, Render } from "~/components";
...
<Tabs>
<TabItem label="Workflow with dashboard">
...
<TabItem label="Workflow with Workers">
