...
4. Use `npx wrangler dev` to develop your Worker project and send emails. This runs your code locally while connecting to Cloudflare Email Service (using [remote bindings](/workers/development-testing/#remote-bindings)).
...
For connection details, authentication, response codes, and language-specific examples, see the [SMTP reference](/email-service/api/send-emails/smtp/).
