...
Access Email Service using the [REST API](/email-service/api/send-emails/rest-api/) from any platform, directly from Cloudflare Workers using [bindings](/email-service/api/send-emails/workers-api/), or over [authenticated SMTP](/email-service/api/send-emails/smtp/):
