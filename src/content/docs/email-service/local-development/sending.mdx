...
Text (system): /tmp/miniflare-.../files/email-text/<message-id>.txt
Text (project): <project root>/.wrangler/tmp/email/<session-id>/email-text/<message-id>.txt
```
