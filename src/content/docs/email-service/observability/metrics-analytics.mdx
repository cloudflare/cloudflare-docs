...
| `spamScore`              | uint32 | Spam score value                                             |
| `spamThreshold`          | uint32 | Spam threshold value                                         |
...
- [Email logs](/email-service/observability/logs/) — view individual email activity in the dashboard.
- [Audit logs](/email-service/observability/audit-logs/) — track configuration changes.
- [GraphQL Analytics API](/analytics/graphql-api/) — full GraphQL API reference.
