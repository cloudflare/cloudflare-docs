...
[Tracing](/workers/observability/traces/) gives you end-to-end visibility into the life of a request as it travels through your Workers application and connected services. With automatic instrumentation, Cloudflare captures OpenTelemetry-compliant telemetry data for fetch calls, binding operations (KV, R2, Durable Objects), and handler invocations. Zero dependencies are required.
...
[Export OpenTelemetry-compliant traces and logs](/workers/observability/exporting-opentelemetry-data/) from Workers to your existing observability stack. Workers supports exporting to any destination with an OTLP endpoint, including Honeycomb, Grafana Cloud, Axiom, and Sentry. No additional dependencies are required.
