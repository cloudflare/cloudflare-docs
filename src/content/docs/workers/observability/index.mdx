...
[Real-Time Issues](/workers/observability/issues/) groups recurring Worker failures into issues. Review occurrences, diagnostic context, and notification activity without searching individual logs first.
