...
[Alerts](/workers/observability/alerts/) let you track your Workers' metrics and get notified when they exceed defined thresholds. Set conditions on aggregated log data — such as request counts, error rates, CPU time, and execution duration — and receive notifications via email, webhooks, or PagerDuty.
