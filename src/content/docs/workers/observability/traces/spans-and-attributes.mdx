...
- [`cloudflare.jsrpc.method`](/workers/runtime-apis/rpc/)

#### [`EmailHandler`](/email-routing/email-workers/runtime-api/)

- `cloudflare.email.from`
- `cloudflare.email.to`
- `cloudflare.email.size`

#### [`Trace Handler`](/workers/runtime-apis/handlers/tail/)

- `cloudflare.trace.count`

#### [`AlarmHandler`](/durable-objects/api/alarms/#alarm)
...
#### [`r2_get`](/r2/api/workers/workers-api-reference/#bucket-method-definitions)
...
#### [`r2_put`](/r2/api/workers/workers-api-reference/#bucket-method-definitions)
...
#### [`r2_list`](/r2/api/workers/workers-api-reference/#bucket-method-definitions)
...
#### [`r2_createMultipartUpload`](/r2/api/workers/workers-multipart-usage/)
