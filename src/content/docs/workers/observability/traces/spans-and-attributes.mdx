...
#### [`d1_bind`](/d1/worker-api/prepared-statements/#bind)
...
#### [`durable_object_storage_exec`](/durable-objects/api/storage-api/#exec)

#### [`durable_object_storage_getDatabaseSize`](/durable-objects/api/storage-api/#databasesize)
