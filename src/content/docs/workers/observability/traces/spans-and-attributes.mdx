...
#### [Durable Object shutdown hook](/durable-objects/api/base/#shutdown)

A shutdown invocation produces a tracing span, like a constructor invocation. Its `cloudflare.handler_type` value is `shutdown`.
...
### [Images](/images/optimization/binding/)

### [`images_output`](/images/optimization/binding/#output)
...
### [`images_info`](/images/optimization/binding/#info)
...
#### [`reply_email`](/email-service/api/route-emails/email-handler/#reply-to-emails)

#### [`forward_email`](/email-service/api/route-emails/email-handler/)

#### [`send_email`](/email-service/api/send-emails/workers-api/)
