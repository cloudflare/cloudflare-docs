...
All RPC requests within a [RPC session](/workers/runtime-apis/rpc/lifecycle/) using `RpcTarget` are nested under the initial session span.
...
- `cloudflare.durable_object.queue_time_ms`
- `cloudflare.durable_object.startup_time_ms`
- `cloudflare.durable_object.constructor_invoked`
- `cloudflare.durable_object.constructor_time_ms`
- `cloudflare.durable_object.cpu_time_ms`
- `cloudflare.durable_object.wall_time_ms`
// Added as attributes for now while we discusse span vs attribute
- `cloudflare.durable_object.input_gate_lock_hold_ms` is the time holding the gate
- `cloudflare.durable_object.input_gate_lock_wait_ms` is the time waiting for gate to be available
...
- `cloudflare.durable_object.objectId`
- `cloudflare.durable_object.objectName`

#### `durable_object_blockConcurrencyWhile`

---

### [Durable Object SQLite Storage API](/durable-objects/api/sqlite-storage-api)

The SQLite Storage API allows you to modify the SQLite database embedded within each Durable Object via SQL or key-value methods.

#### Attributes available on all Durable Object Storage SQL API spans

- `cloudflare.durable_object.response.rows_read`
- `cloudflare.durable_object.response.rows_written`
- `cloudflare.durable_object.response.bytes_read`
...
### [Durable Object KV Storage API](/durable-objects/api/legacy-kv-storage-api)

The legacy KV-backed Storage API allows you to modify embedded storage within a Durable Object.
