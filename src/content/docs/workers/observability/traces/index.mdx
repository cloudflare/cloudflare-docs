...
For a full list of instrumented operations, refer to the [spans and attributes documentation](/workers/observability/traces/spans-and-attributes/).
...
For more information, refer to [Custom spans](/workers/observability/traces/custom-spans/).
...
such as [Honeycomb](/workers/observability/exporting-opentelemetry-data/honeycomb/), [Grafana Cloud](/workers/observability/exporting-opentelemetry-data/grafana-cloud/),
[Axiom](/workers/observability/exporting-opentelemetry-data/axiom/), and [Statsig](/workers/observability/exporting-opentelemetry-data/statsig/), while requiring zero development effort from you. If your observability provider has an available OpenTelemetry endpoint, you can export traces (and logs)!
...
Starting on October 1, 2026, tracing will be billed as part of your usage on the Workers Free Paid and Enterprise plans. Each span in a trace represents one observability event, sharing the same monthly quota and pricing as [Workers logs](/workers/platform/pricing/#workers-logs):
