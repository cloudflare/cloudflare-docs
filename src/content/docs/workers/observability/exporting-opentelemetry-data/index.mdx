...
| [**Logfire**](/workers/observability/exporting-opentelemetry-data/logfire/)             | `https://logfire-{REGION}.pydantic.dev/v1/traces`            | `https://logfire-{REGION}.pydantic.dev/v1/logs` |
