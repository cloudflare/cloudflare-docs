...
| [**Datadog**](https://docs.datadoghq.com/opentelemetry/setup/otlp_ingest/managed_platforms/)| `https://cloudflare.integrations.otlp.datadoghq.com/v1/traces`| `https://cloudflare.integrations.otlp.datadoghq.com/v1/logs` |
