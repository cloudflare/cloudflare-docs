...
| [**SigNoz**](/workers/observability/exporting-opentelemetry-data/signoz/)               | `https://ingest.{region}.signoz.cloud:443/v1/traces`         | `https://ingest.{region}.signoz.cloud:443/v1/logs`           |
