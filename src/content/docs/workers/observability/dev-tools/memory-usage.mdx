...
errors when hitting [Worker memroy limits](/workers/platform/limits/#memory), and fixing memory leaks.
...
then inadvertantly overwriting the global variable with an increasingly large replacement string:
