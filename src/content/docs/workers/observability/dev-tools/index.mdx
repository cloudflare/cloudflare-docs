...
This provides tools to help you debug and optimize your Workers.

:::note
You may have experience with Chrome's DevTools from frontend development. Notably Worker DevTools are used for backend code and _not_ client-side JavaScript.
:::

## Opening DevTools

To get started, run your Worker in development mode with `wrangler dev`, then open the DevTools by hitting <kbd>d</kbd> from your terminal. This opens DevTools in a browser window. Now when you access this worker locally, it can be debugged and profiled with this DevTools instance.
