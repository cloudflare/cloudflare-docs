...
To get started, run your Worker in development mode with `wrangler dev`, then open the DevTools by hitting <kbd>d</kbd> from within your terminal. This will open the DevTools in a browser window. Now, when you access your worker locally, it can be debugged and profiled via this DevTools instance.
