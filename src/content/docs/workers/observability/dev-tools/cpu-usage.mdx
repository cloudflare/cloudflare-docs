...
"fetch" time at the top, and the subscomponents of fetch below, including our two functions "addNumbers" and
...
but after that "moreAdditions" is clearly the slowest portion of our Worker. We can see that garbage collection also represents
