...
| Persistent dev environment for a team | Named tunnel with a stable hostname and an [Access policy](/cloudflare-one/applications/configure-apps/self-hosted-public-app/) |
