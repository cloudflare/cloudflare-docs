...
- [`DynamicDispatcher`](https://docs.rs/worker/latest/worker/struct.DynamicDispatcher.html) - [Dynamic Dispatch](/cloudflare-for-platforms/workers-for-platforms/configuration/dynamic-dispatch/) binding.
