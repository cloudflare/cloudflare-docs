...
After you have created your first Worker, run the [`wrangler dev`](/workers/wrangler/commands/general/#dev) command to start a local server for developing your Worker. This will allow you to test your Worker in development.
...
:::note
If you have issues with this step or you do not have access to a browser interface, refer to the [`wrangler login`](/workers/wrangler/commands/general/#login) documentation for more information.
:::
...
- [`KvStore`](https://docs.rs/worker/latest/worker/kv/struct.KvStore.html) - Workers [KV](/kv/api/) namespace binding.
...
- [`D1Database`](https://docs.rs/worker/latest/worker/d1/struct.D1Database.html) - [D1](/d1/) database binding.
- [`Queue`](https://docs.rs/worker/latest/worker/struct.Queue.html) - [Queues](/queues/) producer binding.
- [`Ai`](https://docs.rs/worker/latest/worker/struct.Ai.html) - [Workers AI](/workers-ai/) binding.
- [`Hyperdrive`](https://docs.rs/worker/latest/worker/struct.Hyperdrive.html) - [Hyperdrive](/hyperdrive/) binding.
- [`AnalyticsEngineDataset`](https://docs.rs/worker/latest/worker/struct.AnalyticsEngineDataset.html) - [Analytics Engine](/analytics/analytics-engine/) binding.
- [`DynamicDispatcher`](https://docs.rs/worker/latest/worker/struct.DynamicDispatcher.html) - [Workers for Platforms hostname routing](/cloudflare-for-platforms/workers-for-platforms/inbound-control/hostname-routing/) binding.
- [`SecretStore`](https://docs.rs/worker/latest/worker/struct.SecretStore.html) - [Secrets Store](/secrets-store/) binding.
- [`RateLimiter`](https://docs.rs/worker/latest/worker/struct.RateLimiter.html) - [Rate Limiting](/workers/runtime-apis/bindings/rate-limit/) binding.
...
[`wasm-bindgen-futures`](https://wasm-bindgen.github.io/wasm-bindgen/api/wasm_bindgen_futures/) (part of the `wasm-bindgen` project) provides interoperability between Rust
