...
- Robust [JavaScript interop](/workers/languages/python/javascript-interop/) that lets you use JavaScript objects and functions directly from Python — including all [Runtime APIs](/workers/runtime-apis/)
...
- Learn about Python Workers' [JavaScript interop](/workers/languages/python/javascript-interop/), and how to use it to work with [bindings](/workers/runtime-apis/bindings/) and [Runtime APIs](/workers/runtime-apis/).
