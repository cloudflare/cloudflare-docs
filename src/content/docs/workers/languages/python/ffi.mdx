...
For example, to access a [KV](/kv) namespace from a Python Worker, you would declare the following in your Worker's [`wrangler.toml / wrangler.json(c)` file](/workers/wrangler/configuration/):
