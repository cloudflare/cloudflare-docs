...
Already on OpenNext or Next on Pages? See [other Next.js deployment paths](#use-another-nextjs-deployment-path).
...
| Path                                                                                   | Use when                                                                                                                                       |
| -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| [OpenNext adapter](/workers/framework-guides/web-apps/opennext/)                       | You need the mature OpenNext adapter for standard Next.js build output or your application needs a capability vinext does not support yet. |
