...
If you only need to work on one of the microfrontends, you can run the others remotely using [remote bindings](/workers/local-development/#remote-bindings), without needing to have access to the source code or run a local dev server.
