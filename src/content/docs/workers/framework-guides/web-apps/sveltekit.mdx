...
You can deploy an existing SvelteKit project to Cloudflare Workers with a single command:

<PackageManagers type="exec" pkg="wrangler" args="deploy" />

Wrangler will automatically install the SvelteKit adapter and configure your project. Refer to [Deploy an existing project](/workers/framework-guides/automatic-configuration/) for details.
:::
