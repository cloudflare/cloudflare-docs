...
:::tip[Already have a SvelteKit project?]
You can deploy an existing SvelteKit project to Cloudflare Workers with a single command. Run `npx wrangler deploy` in your project directory and Wrangler will automatically install the SvelteKit adapter and configure your project. Refer to [Deploy an existing project](/workers/framework-guides/automatic-configuration/) for details.
:::
