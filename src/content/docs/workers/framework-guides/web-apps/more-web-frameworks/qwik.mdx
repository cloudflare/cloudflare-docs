...
:::tip[Already have a Qwik project?]
Run `wrangler deploy` in a project without a Wrangler configuration file and Wrangler will automatically detect Qwik, generate the necessary configuration, and deploy your project.
...
<AutoconfigDiagram
	framework="Qwik"
	configs={[
		{ label: "main", file: "wrangler.jsonc", value: "server/entry.cloudflare.js" },
		{ label: "assets", file: "wrangler.jsonc", value: "directory: dist" },
