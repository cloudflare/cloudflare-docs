...
| ---------------------------------------------------------------------------- | ------------------------------ | -------------------------------------------------------------------------------------------------------------- |
| [Next.js](/workers/framework-guides/web-apps/nextjs/)                        | `vinext`                       | Configures vinext for Cloudflare Workers and adds the required Vite and Wrangler configuration.                 |
...
For Next.js projects, automatic configuration uses [vinext](/workers/framework-guides/web-apps/nextjs/) as the default deployment path for Cloudflare Workers. The generated configuration adds the vinext and Vite dependencies, creates the Cloudflare Workers configuration, and adds package scripts for development, builds, and deployment.
...
If you need the OpenNext adapter instead of vinext, configure it manually by following the [OpenNext adapter guide](/workers/framework-guides/web-apps/nextjs/opennext/).
