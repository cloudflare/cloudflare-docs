...
If you need the OpenNext adapter instead of vinext, configure it manually by following the [OpenNext adapter guide](/workers/framework-guides/web-apps/opennext/).
