...
{/* TEST: intentional broken link to verify CI link-check failure path — remove after confirming preview deploys despite link errors */}
[broken link test](/this-page-does-not-exist-astro-build-optimization-test/)
