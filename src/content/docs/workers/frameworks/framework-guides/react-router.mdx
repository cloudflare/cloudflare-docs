...
In this guide, you will create a new [React Router](https://reactrouter.com/) application and deploy to Cloudflare Workers (with the new [<InlineBadge preset="beta" /> Workers Assets](/workers/static-assets/)).

## 1. Set up a new project

Use the [`create-cloudflare`](https://www.npmjs.com/package/create-cloudflare) CLI (C3) to set up a new project.
C3 will create a new project directory, initiate React Router's official setup tool, and provide the option to deploy instantly.

To use `create-cloudflare` to create a new React Router project with <InlineBadge preset="beta" /> Workers Assets, run the following command:
...
After you have created your project, run the following command in the project directory to start a local development server.
This will allow you to preview your project locally during development.
