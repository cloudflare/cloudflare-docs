...
This guide explains how to get started with the `@cloudflare/vitest-plugin` package. For more complex examples of testing with `@cloudflare/vitest-plugin`, refer to [Recipes](/workers/testing/vitest-integration/recipes/).
...
- Vitest and `@cloudflare/vitest-plugin` are installed in your project as dev dependencies
  ...
  <PackageManagers
	pkg="vitest@^4.1.0 @cloudflare/vitest-plugin"
  	dev="true"
  />

  :::note

  The `@cloudflare/vitest-plugin` package requires Vitest 4.1 or later, but earlier than version 5.0.
...
- For more complex examples of testing with `@cloudflare/vitest-plugin`, refer to [Recipes](/workers/testing/vitest-integration/recipes/).
