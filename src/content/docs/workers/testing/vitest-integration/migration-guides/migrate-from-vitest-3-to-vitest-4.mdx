...
This guide applies to `@cloudflare/vitest-pool-workers` version 0.x. To migrate to version 1, refer to [Migrate to Vitest plugin](/workers/testing/vitest-integration/migration-guides/migrate-to-vitest-plugin/).
