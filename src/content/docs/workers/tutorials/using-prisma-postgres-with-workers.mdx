...
tags:
  ...
  - PostgreSQL
description: >-
  Prisma Postgres is a managed, serverless Postgres database. It supports features like connection pooling, caching, real-time subscriptions, and query optimization recommendations. This tutorial shows you how to set up a Cloudflare Workers project with Prisma ORM.
---
