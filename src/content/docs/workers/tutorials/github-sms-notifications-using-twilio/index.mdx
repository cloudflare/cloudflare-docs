...
<Render file="c3-run-command-with-directory" product="workers" params={{ one: "github-twilio-notifications" }} />
...
Add the nodejs\_compat flag to your `wrangler.toml` file:
