...
To deploy your Worker, open your [Wrangler configuration](/workers/wrangler/configuration) file and update the `name` key with your project's name. Below is an example with this tutorial's project name:
