...
tags:
  - JavaScript
description: >-
  This tutorial explains how to send emails from Cloudflare Workers using Resend. To continue with this tutorial, you’ll need:. A [Cloudflare account], if you don’t already have one, and a [Resend account] A [registered] domain, if you haven't already done so.
---
