...
You can also use explicit parameters by following the [wrangler documentation for Hyperdrive](https://developers.cloudflare.com/workers/wrangler/commands/#create-1).
