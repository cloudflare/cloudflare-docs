...
"nodejs_compat_v2" compatibility flag to your [Wrangler configuration](/workers/wrangler/configuration) file. This will be needed to use the library to connect to your PostgreSQL database.
...
Configure each database parameter as an [environment variable](/workers/configuration/environment-variables/) via the [Cloudflare dashboard](/workers/configuration/environment-variables/#add-environment-variables-via-the-dashboard) or in your [Wrangler configuration](/workers/wrangler/configuration) file. Refer to an example of a[Wrangler configuration](/workers/wrangler/configuration) file configuration:
...
This command outputs the Hyperdrive configuration `id` that will be used for your Hyperdrive [binding](/workers/runtime-apis/bindings/). Set up your binding by specifying the `id` in the [Wrangler configuration](/workers/wrangler/configuration) file.
