...
To add this configuration to your project, open the [Wrangler configuration](/workers/wrangler/configuration) file and create an entry for `kv_namespaces` above the build command:
