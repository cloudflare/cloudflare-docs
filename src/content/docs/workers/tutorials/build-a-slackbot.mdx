...
tags:
  ...
  - TypeScript
description: >-
  This tutorial assumes that you already have a Slack account and the ability to create and manage Slack applications. You will use TypeScript as the programming language and [Hono](https://hono.dev/) as the web framework. The tutorial is recommended for people who are familiar with writing web applications.
---
