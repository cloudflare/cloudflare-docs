...
tags:
  ...
  - TypeScript
description: >-
  Learn how to build a Slackbot with Hono and TypeScript in Cloudflare Workers
---
...
To use this constant inside of your codebase, use the [`wrangler secret`](/workers/wrangler/commands/general/#secret) command:
