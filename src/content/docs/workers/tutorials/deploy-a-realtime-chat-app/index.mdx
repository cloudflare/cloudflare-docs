...
To deploy your application to a custom domain using Wrangler, open your project's [Wrangler configuration](/workers/wrangler/configuration) file.

To configure a route in your [Wrangler configuration](/workers/wrangler/configuration) file, add the following to your environment:
...
If you have specified your zone ID in the environment of your [Wrangler configuration](/workers/wrangler/configuration) file, you will not need to write it again in object form.

To configure a subdomain in your [Wrangler configuration](/workers/wrangler/configuration) file, add the following to your environment:
...
To uninstall your chat application, modify your [Wrangler configuration](/workers/wrangler/configuration) file to remove the `durable_objects` bindings and add a `deleted_classes` migration:
