...
Use [`wrangler secret put`](/workers/wrangler/commands/general/#secret-put) to set `OPENAI_API_KEY`. This [secret's](/workers/configuration/secrets/) value is the API key you created earlier in the OpenAI dashboard:
