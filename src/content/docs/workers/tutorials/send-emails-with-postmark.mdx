...
tags:
  - JavaScript
description: >-
  This tutorial explains how to send transactional emails from Workers using Postmark. To continue with this tutorial, you’ll need:. A [Cloudflare account], if you don’t already have one, and a [registered] domain.
---
