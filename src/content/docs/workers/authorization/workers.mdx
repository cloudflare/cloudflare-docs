...
Members need a [zone-scoped role](/fundamentals/manage-members/scope/#specific-domains) with Zone Settings edit access, such as [Domain Administrator](/fundamentals/manage-members/roles/#domain-scoped-roles), for each affected zone.
