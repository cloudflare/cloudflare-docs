...
| Workers Routes Edit                   | `Editor` at the Workers product scope, plus [zone-level permission](/fundamentals/manage-members/scope/#specific-domains) for each zone referenced by routes |
