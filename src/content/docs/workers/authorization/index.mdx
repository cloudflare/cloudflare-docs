...
| Deploy a Worker with Routes or Custom Domains | `wrangler deploy`                                      | `Editor` for the Worker, plus the required [zone permissions](/workers/authorization/workers/#routes-and-custom-domains). |
...
| Deploy a Worker with Routes or Custom Domains           | Workers product and each affected zone | Editor and the required [zone permissions](/workers/authorization/workers/#routes-and-custom-domains) |
