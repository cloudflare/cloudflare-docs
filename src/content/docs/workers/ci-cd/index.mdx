...
- If you have a self-hosted instance of GitHub or GitLabs, which is currently not supported in Workers Builds' git integration
- If you are using a git provider that is not GitHub or GitLab
