...
Workers Build System allows you to integrate with your Git provider, and automatically deploy your changes when you make a push. To set up your build system, reference [Builds](/workers/ci-cd/builds/).
