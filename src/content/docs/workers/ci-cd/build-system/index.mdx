...
title: Build System
head: []
description: Leverage Worker's build system to integrate with Git and automatically build and deploy your project when you make a change.
sidebar:
  badge:
    text: Beta
---
...
If you have a monothelic repository or Wrangler enviornment setup, reference [Special Setup](/workers/ci-cd/build-system/build-configuration/#special-setup).
...
In Closed Beta, the following limits are applicable for the build system:
