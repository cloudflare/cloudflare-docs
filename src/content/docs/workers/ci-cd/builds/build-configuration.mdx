...
| **Deploy command**                           | The deploy command lets you set the **specific** Wrangler command to deploy your Worker. Your deploy command will default to `npx wrangler deploy`. Workers Builds will use the Wrangler version set in your `package.json`.                                                                                                                                            |
...
The Workers Builds API token with the following permissions: 
