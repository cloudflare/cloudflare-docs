...
:::note
[Preview URLs](/workers/versions-and-deployments/preview-urls/) are not generated for Workers that implement a [Durable Object](/durable-objects/), including [Containers](/containers/) and [Sandbox](/sandbox/) Workers. Refer to [Deploy Containers](/containers/deploy/#before-production) if your Worker uses containers.
:::
