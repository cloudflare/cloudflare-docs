...
| `npx wrangler deploy --containers-rollout=immediate` | [Containers](/containers/) rollout mode for this deploy. Refer to [Rollouts](/containers/platform-details/rollouts/).                                                                                                                                                           |
