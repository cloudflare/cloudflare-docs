...
:::note
Preview URLs are not generated for Durable Object Workers, including [Containers](/containers/). For Containers, `versions upload` also does not update the container image. Refer to [Deploy Containers](/containers/guides/deploy/#before-production).
:::
