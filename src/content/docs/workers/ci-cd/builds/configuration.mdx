...
| `npx wrangler deploy --containers-rollout=immediate` | For [Containers](/containers/) Workers that need a single 100% rollout step (not a simultaneous restart). Refer to [Rollouts](/containers/platform-details/rollouts/). |
