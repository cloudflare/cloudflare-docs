...
Preinstalled software (languages and tools) may be updated before they reach end-of-life (EOL). These updates only apply if you have not [overridden the default version](/workers/ci-cd/builds/build-image/#overriding-default-versions).
...
- **Pin specific versions** of critical preinstalled software by [overriding default versions](/workers/ci-cd/builds/build-image/#overriding-default-versions) to maintain full control over when versions change