...
Workers Build System build environment has broad support for a variety of languages, such as Ruby, Node.js, Python, PHP, and Go.
...
Workers Build System provides support with a variety of tools and languages. In the following table, review the preinstalled versions for tools included in the build environment, and how to override them as relevant:
