...
## Pricing
During the beta, Workers Builds will be free to try with the limits stated above. In the future you can expect the following updates to limits and pricing structure
