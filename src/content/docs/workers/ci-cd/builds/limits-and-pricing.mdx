...
| **Maximum environment variables**  | 64 per trigger              | 64 per trigger                                          |
...
- **Maximum environment variables**: The number of custom environment variables you can configure per trigger.
