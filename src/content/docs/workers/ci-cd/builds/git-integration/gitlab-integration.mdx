...
:::note
Preview URLs are not generated for Workers that use [Durable Objects](/durable-objects/), including [Containers](/containers/). Refer to [Preview URL limitations](/workers/versions-and-deployments/preview-urls/#limitations).
:::
