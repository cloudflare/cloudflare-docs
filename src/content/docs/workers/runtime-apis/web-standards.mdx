...
JavaScript hosts define the properties available through [`import.meta`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/import.meta). With the [`new_module_registry` compatibility flag](/workers/configuration/compatibility-flags/#new-module-registry), Workers provides `import.meta.url`, `import.meta.main`, `import.meta.filename`, `import.meta.dirname`, and [`import.meta.resolve()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/import.meta/resolve).

Use these properties to inspect the current module or resolve another module without importing it:
...
export default {
	async fetch() {
		return Response.json({
			currentModule: moduleMeta.url,
			isEntrypoint: moduleMeta.main,
			dependency: moduleMeta.resolve("./dependency.js"),
		});
	},
};
```
...
For property behavior and module-loading details, refer to the [`import.meta` module registry reference](/workers/reference/module-registry/#importmeta).
