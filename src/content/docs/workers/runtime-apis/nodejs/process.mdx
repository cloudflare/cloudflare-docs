...
:::note
If you use [Wrangler](/workers/wrangler/) or the [Cloudflare Vite plugin](/workers/vite-plugin/), `process.env.NODE_ENV` is statically replaced at build time and is not a runtime value. Refer to [Bundling](/workers/wrangler/bundling/#node_env) for more information.
:::
