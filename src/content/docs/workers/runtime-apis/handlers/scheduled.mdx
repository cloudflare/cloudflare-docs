...
Cron Trigger testing requires Wrangler 4.139.0 or later, or Cloudflare Vite plugin 1.60.0 or later. Configure at least one Cron Trigger for the active environment before using this interface.
