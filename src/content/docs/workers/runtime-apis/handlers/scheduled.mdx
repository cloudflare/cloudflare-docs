...
Cron Trigger testing requires Wrangler 4.137.0 or later, or Cloudflare Vite plugin 1.58.0 or later. Configure at least one Cron Trigger for the active environment.
