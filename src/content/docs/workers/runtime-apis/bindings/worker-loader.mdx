...
You can expose [AI SDK tools](/agents/tools/codemode/ai-sdk/), tools from an [MCP client connection](/agents/tools/codemode/mcp/), or operations from an [OpenAPI service](/agents/tools/codemode/openapi/) inside Code Mode.
