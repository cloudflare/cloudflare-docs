...
Code Mode can make [AI SDK tools](/agents/tools/codemode/ai-sdk/), tools from an [MCP client connection](/agents/tools/codemode/mcp/), and [OpenAPI operations](/agents/tools/codemode/openapi/) available to model-written code.
