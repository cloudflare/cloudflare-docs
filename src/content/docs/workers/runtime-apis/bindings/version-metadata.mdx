...
The version metadata binding can be used to access metadata associated with a [version](/workers/versions-and-deployments/#versions) from inside the Workers runtime.
