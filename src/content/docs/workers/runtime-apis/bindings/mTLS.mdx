...
To present a client certificate when communicating with a service, create a mTLS certificate [binding](/workers/runtime-apis/bindings/) in your Worker project's [Wrangler configuration](/workers/wrangler/configuration) file. This will allow your Worker to present a client certificate to a service on your behalf.
...
Then, update your Worker project's [Wrangler configuration](/workers/wrangler/configuration) file to create an mTLS certificate binding:
