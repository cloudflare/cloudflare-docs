...
3. [Connect](/workers/runtime-apis/handlers/connect/) forwards a raw TCP connection to the [`connect()` handler](/workers/runtime-apis/handlers/connect/) of another Worker.
