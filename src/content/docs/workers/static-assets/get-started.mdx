...
For an existing static directory or static Vite app directory, pass the directory with the experimental static assets auto-configuration flag:
...
After you have created your Worker, run the [`wrangler dev`](/workers/wrangler/commands/general/#dev) in the project directory to start a local server. This will allow you to preview your project locally during development.
...
The [`wrangler deploy`](/workers/wrangler/commands/general/#deploy) will build and deploy your project. If you're using CI, ensure you update your ["deploy command"](/workers/ci-cd/builds/configuration/#build-settings) configuration appropriately.
