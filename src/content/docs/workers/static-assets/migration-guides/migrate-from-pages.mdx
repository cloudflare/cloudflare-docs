...
[^1]: Workers can use Early Hints when the zone setting is turned on, and your Worker code sends the appropriate `Link` headers. For more information, refer to the [103 Early Hints](/workers/examples/103-early-hints/) example.
