...
There are two options for asset serving that can be [configured in [Wrangler's configuration](/workers/wrangler/configuration) file](/workers/wrangler/configuration/#assets):
...
Alternate configuration options are outlined on this page and can be specified in your project's [[Wrangler configuration](/workers/wrangler/configuration) file](/workers/wrangler/configuration/#assets) file. If you're deploying using a [framework](/workers/frameworks/), these options will be defined by the framework provider.

Example [Wrangler configuration](/workers/wrangler/configuration):
