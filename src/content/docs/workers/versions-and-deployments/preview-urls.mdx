...
Access can protect previews for one Worker or every Worker in an account. You can also protect both production and preview deployments. For setup instructions, refer to [Cloudflare Access](/workers/configuration/cloudflare-access/).
