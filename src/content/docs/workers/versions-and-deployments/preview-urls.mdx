...
- Preview URLs are not generated for Workers that implement a [Durable Object](/durable-objects/), including [Containers](/containers/) and [Sandbox](/sandbox/) Workers. For Containers testing options, refer to [Deploy Containers](/containers/guides/deploy/#before-production).
