...
Cloudflare rejects a `wrangler versions upload` that includes a Durable Object class lifecycle change with error 10211. Apply the migration with a non-versioned deploy:
