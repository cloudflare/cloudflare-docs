...
A `wrangler versions upload` that includes a Durable Object class lifecycle change is rejected with error 10211. Apply the migration with a non-versioned deploy:
