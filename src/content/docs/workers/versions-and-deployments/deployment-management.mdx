...
:::note
Changes made to a Worker's triggers ([routes, domains](/workers/configuration/routing/) or [cron triggers](/workers/configuration/cron-triggers/)) need to be applied separately with the command [`wrangler triggers deploy`](/workers/wrangler/commands/workers/#triggers-deploy).
:::
