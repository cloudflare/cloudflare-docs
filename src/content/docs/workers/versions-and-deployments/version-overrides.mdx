...
You can use version overrides to send a request to a specific version of your Worker in your [gradual deployment](/workers/versions-and-deployments/gradual-deployments/).
...
- [Gradual deployments](/workers/versions-and-deployments/gradual-deployments/) — Learn how percentage-based traffic splitting works, including version affinity and observability.
