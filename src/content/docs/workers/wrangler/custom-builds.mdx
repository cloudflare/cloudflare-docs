...
Custom builds are configured by adding a `[build]` section in your `wrangler.toml / wrangler.json(c)` file, and using the following options for configuring your custom build.
