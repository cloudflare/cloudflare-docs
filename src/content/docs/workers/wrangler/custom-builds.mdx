...
Custom builds are configured by adding a `[build]` section in your [Wrangler configuration](/workers/wrangler/configuration) file, and using the following options for configuring your custom build.
