...
- `SCRIPT` <Type text="string" />
  - The path to an entry point for your Worker. Only required if your `wrangler.toml / wrangler.json(c)` file does not include a `main` key (for example, `main = "index.js"`).
...
- `--var` <Type text="key:value\[]" /> <MetaInfo text="optional" />
  ...
  - This flag is an alternative to defining [`vars`](/workers/wrangler/configuration/#non-inheritable-keys) in your `wrangler.toml / wrangler.json(c)` file. If defined in both places, this flag's values will be used.
- `--define` <Type text="key:value\[]" /> <MetaInfo text="optional" />
  ...
  - This flag is an alternative to defining [`define`](/workers/wrangler/configuration/#non-inheritable-keys) in your `wrangler.toml / wrangler.json(c)` file. If defined in both places, this flag's values will be used.
...
- `--name` <Type text="string" /> <MetaInfo text="optional" />
  - Perform on a specific Worker rather than inheriting from a `wrangler.toml / wrangler.json(c)` file.
- `--env` <Type text="string" /> <MetaInfo text="optional" />
  - Perform on a specific environment.
...
- `KEY` <Type text="string" /> <MetaInfo text="required" />
  - The variable name for this secret to be accessed in the Worker.
- `--name` <Type text="string" /> <MetaInfo text="optional" />
  - Perform on a specific Worker rather than inheriting from the `wrangler.toml / wrangler.json(c)` file.
- `--env` <Type text="string" /> <MetaInfo text="optional" />
  - Perform on a specific environment.
...
Download your Pages project config as a `wrangler.toml / wrangler.json(c)` file.
...
You can then add this certificate as a [binding](/workers/runtime-apis/bindings/) in your `wrangler.toml / wrangler.json(c)` file:
