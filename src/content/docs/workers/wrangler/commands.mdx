...
- `--var` <Type text="key:value\[]" /> <MetaInfo text="optional" />
  ...
  - This flag is an alternative to defining [`vars`](/workers/wrangler/configuration/#non-inheritable-keys) in your Wrangler configuration file. If defined in both places, this flag's values will be used.
- `--define` <Type text="key:value\[]" /> <MetaInfo text="optional" />
  ...
  - This flag is an alternative to defining [`define`](/workers/wrangler/configuration/#non-inheritable-keys) in your Wrangler configuration file. If defined in both places, this flag's values will be used.
...
- `--name` <Type text="string" /> <MetaInfo text="optional" />
  - Perform on a specific Worker rather than inheriting from Wrangler configuration file.
- `--env` <Type text="string" /> <MetaInfo text="optional" />
  - Perform on a specific environment.
...
You can then add this certificate as a [binding](/workers/runtime-apis/bindings/) in your Wrangler configuration file:
