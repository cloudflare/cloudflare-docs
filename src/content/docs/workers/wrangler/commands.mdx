...
- `--experimental-json-config` <Type text="boolean" /> (not supported by Pages)
  - ⚠️ This is an experimental command. Read configuration from a `wrangler.json` file, instead of [Wrangler configuration](/workers/wrangler/configuration) file. `wrangler.json` is a [JSONC](https://code.visualstudio.com/docs/languages/json#_json-with-comments) file.
...
- `NAME` <Type text="string" /> <MetaInfo text="optional (default: name of working directory)" />
  - The name of the Workers project. This is both the directory name and `name` property in the generated [Wrangler configuration](/workers/wrangler/configuration) file [configuration](/workers/wrangler/configuration/) file.
...
Creates a new D1 database, and provides the binding and UUID that you will put in your [Wrangler configuration](/workers/wrangler/configuration) file.
...
- `--persist-to` <Type text="string" /> <MetaInfo text="optional" />
  - Specify directory to use for local persistence (for use in combination with `--local`).
- `--preview` <Type text="boolean" /> <MetaInfo text="optional" />
  - Show the list of unapplied migration files on your preview D1 database (as defined by `preview_database_id` in [[Wrangler configuration](/workers/wrangler/configuration) file](/workers/wrangler/configuration/#d1-databases)).
...
- `--persist-to` <Type text="string" /> <MetaInfo text="optional" />
  - Specify directory to use for local persistence (for use in combination with `--local`).
- `--preview` <Type text="boolean" /> <MetaInfo text="optional" />
  - Execute any unapplied migrations on your preview D1 database (as defined by `preview_database_id` in [[Wrangler configuration](/workers/wrangler/configuration) file](/workers/wrangler/configuration/#d1-databases)).
- `--batch-size` <Type text="number" /> <MetaInfo text="optional" />
  - Number of queries to send in a single batch.
...
Creates a new vector index, and provides the binding and name that you will put in your [Wrangler configuration](/workers/wrangler/configuration) file.
...
None of the options for this command are required. Many of these options can be set in your [Wrangler configuration](/workers/wrangler/configuration) file. Refer to the [[Wrangler configuration](/workers/wrangler/configuration)](/workers/wrangler/configuration) documentation for more information.
...
- `SCRIPT` <Type text="string" />
  - The path to an entry point for your Worker. Only required if your [Wrangler configuration](/workers/wrangler/configuration) file does not include a `main` key (for example, `main = "index.js"`).
...
- `--var` <Type text="key:value\[]" /> <MetaInfo text="optional" />
  ...
  - This flag is an alternative to defining [`vars`](/workers/wrangler/configuration/#non-inheritable-keys) in your [Wrangler configuration](/workers/wrangler/configuration) file. If defined in both places, this flag's values will be used.
- `--define` <Type text="key:value\[]" /> <MetaInfo text="optional" />
  ...
  - This flag is an alternative to defining [`define`](/workers/wrangler/configuration/#non-inheritable-keys) in your [Wrangler configuration](/workers/wrangler/configuration) file. If defined in both places, this flag's values will be used.
...
None of the options for this command are required. Also, many can be set in your [Wrangler configuration](/workers/wrangler/configuration) file. Refer to the [[Wrangler configuration](/workers/wrangler/configuration)](/workers/wrangler/configuration/) documentation for more information.
...
- `--name` <Type text="string" /> <MetaInfo text="optional" />
  ...
  - Perform on a specific Worker rather than inheriting from [Wrangler configuration](/workers/wrangler/configuration) file.
...
You can then add this certificate as a [binding](/workers/runtime-apis/bindings/) in your [Wrangler configuration](/workers/wrangler/configuration) file:
