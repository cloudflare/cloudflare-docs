...
None of the options for this command are required. Also, many can be set in your Wrangler file or in your [Previews Base configuration](/workers/previews/configuration/#setting-your-previews-base-configuration). Refer to the [Wrangler configuration](/workers/wrangler/configuration/) documentation for more information.
...
- `--json` <Type text="boolean" /> <MetaInfo text="(default: false) optional" />
  - Return machine-readable output.
- `--ignore-base-config` <Type text="boolean" /> <MetaInfo text="(default: false) optional" />
  - Only use settings from your Wrangler file, ignoring the Preview base config configured in the Cloudflare dashboard.
- `--worker-name` <Type text="string" /> <MetaInfo text="optional" />
...
<WranglerCommand command="preview delete" />

---

<WranglerCommand command="preview secret put" />

---

<WranglerCommand command="preview secret delete" />

---

<WranglerCommand command="preview secret list" />

---

<WranglerCommand command="preview secret bulk" />

---

<WranglerCommand command="preview base-config secret put" />

---

<WranglerCommand command="preview base-config secret delete" />

---

<WranglerCommand command="preview base-config secret list" />

---

<WranglerCommand command="preview base-config secret bulk" />
