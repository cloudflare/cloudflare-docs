...
Wrangler supports any Wrangler configuration file keys passed in as environment variables. This works by passing in `CF_` + any uppercased TOML key. For example:
