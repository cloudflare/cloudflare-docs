...
Your project will need some configuration before you can publish your Worker. Configuration is done through changes to keys and values stored in a [Wrangler configuration](/workers/wrangler/configuration) file located in the root of your project directory. You must manually edit this file to edit your keys and values before you can publish.

---

## Environments

The top-level configuration is the collection of values you specify at the top of your [Wrangler configuration](/workers/wrangler/configuration) file. These values will be inherited by all environments, unless otherwise defined in the environment.

The layout of a top-level configuration in a [Wrangler configuration](/workers/wrangler/configuration) file is displayed below:
...
Environment configuration (optional): the configuration values you specify under an `[env.name]` in your [Wrangler configuration](/workers/wrangler/configuration) file.
...
There are three types of keys in a [Wrangler configuration](/workers/wrangler/configuration) file:

- Top level only keys are required to be configured at the top level of your [Wrangler configuration](/workers/wrangler/configuration) file only; multiple environments on the same project must share this key's value.
...
- `bucket` required
  ...
  - The directory containing your static assets. It must be a path relative to your [Wrangler configuration](/workers/wrangler/configuration) file. Example: `bucket = "./public"`
...
`[site]` section of your [Wrangler configuration](/workers/wrangler/configuration) file:
...
If you want to exclude files or directories in your `bucket`, add an `exclude` field to your `[site]` section of your [Wrangler configuration](/workers/wrangler/configuration) file:
...
# You do not need to include these default rules in your [Wrangler configuration](/workers/wrangler/configuration) file, they are implicit.
...
To illustrate how these levels are applied, here is a [Wrangler configuration](/workers/wrangler/configuration) file using multiple environments:
