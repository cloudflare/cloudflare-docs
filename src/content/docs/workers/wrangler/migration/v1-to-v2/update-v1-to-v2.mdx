...
If you would like to read more on the deprecated Wrangler configuration file fields that cause Wrangler v2 to error, refer to [Deprecations](/workers/wrangler/deprecations/).
