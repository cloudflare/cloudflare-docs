...
- `vcpu` <Type text="number" /> <MetaInfo text="optional" />
  ...
  - The vCPU to be used by your container. Defaults to 1/16 vCPU.

- `memory_mib` <Type text="number" /> <MetaInfo text="optional" />

  - The memory to be used by your container, in MiB. Defaults to 256 MiB.

- `disk_mb` <Type text="number" /> <MetaInfo text="optional" />

  - The disk to be used by your container, in MB. Defaults to 2GB.
