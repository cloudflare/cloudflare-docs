...
- `preview_urls` <Type text="boolean" /> <MetaInfo text="optional" />
  - Enables use of Version URLs and Preview URLs to test your Worker. Defaults to value of `workers_dev`. Refer to [Version URLs](/workers/configuration/version-urls/) and [Previews](/workers/previews/).
