...
- `exports` <Type text="object" /> <MetaInfo text="optional" />
  - Declares the Durable Object classes this Worker exports and their lifecycle state. Refer to [Durable Object class exports](/durable-objects/reference/durable-objects-migrations/). Mutually exclusive with `migrations`.

- `migrations` <Type text="object[]" /> <MetaInfo text="optional" />
  - The legacy imperative configuration for managing Durable Object class lifecycle. For new Workers, prefer [`exports`](/durable-objects/reference/durable-objects-migrations/). Refer to [Durable Object class migrations (legacy)](/durable-objects/reference/durable-object-class-migrations-legacy/).
...
* `exports` <Type text="object"/> <MetaInfo text="optional"/>
  - Declares the Durable Object classes this Worker exports and their lifecycle state (live, deleted, renamed, transferred). Refer to [Durable Object class exports](/durable-objects/reference/durable-objects-migrations/). Mutually exclusive with `migrations`.
