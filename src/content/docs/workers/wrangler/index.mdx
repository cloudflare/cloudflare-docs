...
Wrangler commands use the permissions of the authenticated member or API token. Refer to [Workers roles and permissions](/workers/authorization/workers/#wrangler) for the minimum role required by common Wrangler commands.
