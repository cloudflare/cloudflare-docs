...
`getPlatformProxy` does not run your Worker's code. It ignores the Workflows declared in the [`exports`](/workers/wrangler/configuration/#workflow-exports) field of your Wrangler configuration.
