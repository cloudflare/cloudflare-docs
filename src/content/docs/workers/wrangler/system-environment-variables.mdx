...
See the [Environment variables and secrets](/workers/local-development/environment-variables/) page for more information on how to use `.env` files in local development.
:::
