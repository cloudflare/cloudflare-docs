...
- [Wrangler configuration](/workers/wrangler/configuration) file is no longer mandatory.
...
<div style="position: relative; padding-top: 56.25%;">
	<iframe
		src="https://iframe.videodelivery.net/6ce3c7bd51288e1e8439f50ad63eda1d?poster=https%3A%2F%2Fcloudflarestream.com%2F6ce3c7bd51288e1e8439f50ad63eda1d%2Fthumbnails%2Fthumbnail.jpg%3Ftime%3D%26height%3D600"
...
- `wrangler route` - Routes are defined in the [Wrangler configuration](/workers/wrangler/configuration) file.
...
These are new fields that can be added to your [Wrangler configuration](/workers/wrangler/configuration) file.
...
Routes are specified in the [Wrangler configuration](/workers/wrangler/configuration) file.

### Other deprecated behavior

- Cloudflare dashboard-defined routes will not be added alongside Wrangler-defined routes. Wrangler-defined routes are the `route` or `routes` key in your [Wrangler configuration](/workers/wrangler/configuration) file. If both are defined, only routes defined in [Wrangler's configuration](/workers/wrangler/configuration) file will be valid. To manage routes via the Cloudflare dashboard only, remove any `route` and `routes` keys from and add `workers_dev = false` to your [Wrangler configuration](/workers/wrangler/configuration) file.
