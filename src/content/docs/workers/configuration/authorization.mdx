...
:::note
Metadata Read-Only, Content Read-Only, Editor, and Admin roles are ordered from least to most privileged. More privileged roles include all access granted by less privileged roles.
...
![Authorization roles diagram](~/assets/images/workers/authorization-roles-diagram.svg)
...
| [Developer Platform Content Read-Only](/fundamentals/manage-members/roles/#account-scoped-roles) (existing role) | Can read metadata and product content (KV namespace values, Worker code). <br/> Cannot manage resources or update settings.                                                                          |
...
| Workers Editor             | Can deploy Worker changes to production. <br/> Can create versions and deployments. <br/> Can update Worker settings and bindings. <br/> Can manage routes, custom domains, cron triggers, and secrets. <br/> Can bind Worker via service bindings. <br/> Cannot create or delete Workers.                                                     |
| Workers Admin              | Can create, rename, and delete Workers. <br/> Can manage subdomain (\*.workers.dev) settings and account-level Workers settings. <br/> Can grant resource access to other users. <br/> Can bind Worker via service bindings.                                                                                                                   |
...
| D1 Content Read-Only  | Can read database content with read-only queries. <br/> Can read all metadata. <br/> Cannot write to database or update settings.                          |
