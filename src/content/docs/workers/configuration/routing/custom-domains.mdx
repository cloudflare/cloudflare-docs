...
To require visitors to sign in before they can access a Custom Domain, use [Cloudflare Access](/workers/configuration/cloudflare-access/#require-sign-in-for-one-hostname).
