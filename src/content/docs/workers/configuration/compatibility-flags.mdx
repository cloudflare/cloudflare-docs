...
As of compatibility date `2026-08-04`, the `nodejs_compat` flag is enabled by default. Workers using an older compatibility date can still opt in by adding `nodejs_compat` to their `compatibility_flags`:
