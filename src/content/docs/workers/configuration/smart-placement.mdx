...
Placement reduces latency by minimizing round trips between your Worker and back-end services. You can achieve single-digit millisecond latency to databases, APIs, and other services running in legacy cloud infrastructure.
...
If your infrastructure is not in a major cloud provider, you can specify an endpoint for Cloudflare to probe.
