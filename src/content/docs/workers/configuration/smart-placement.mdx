...
| ------------------- | --------------------------------------------------------------- | ------------------ |
| **Smart Placement** | Multiple back-end services, or unknown infrastructure locations | `mode = "smart"`   |
| **Placement Hints** | Single back-end service in a known location                     | `region` or `host` |
