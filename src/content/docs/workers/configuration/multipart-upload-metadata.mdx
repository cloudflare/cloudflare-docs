...
- `assets` <Type text="object" /> <MetaInfo text="optional" />
  ...
  - `retention` <Type text="object" /> <MetaInfo text="optional" />
    - Configures [asset retention](/workers/static-assets/asset-retention/) for the Worker. When enabled, assets from recently deployed versions remain reachable, preventing version skew.
    - `enabled` <Type text="boolean" /> <MetaInfo text="required" /> - set to `true` to enable asset retention.
