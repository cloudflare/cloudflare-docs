...
Secrets can be deleted through [`wrangler secret delete`](/workers/wrangler/commands/#secret-delete) or [`wrangler versions secret delete`](/workers/wrangler/commands/#secret-delete) commands.
