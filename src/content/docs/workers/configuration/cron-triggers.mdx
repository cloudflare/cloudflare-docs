...
#### Via [Wrangler configuration](/workers/wrangler/configuration) file

If a Worker is managed with Wrangler, Cron Triggers should be exclusively managed through the [[Wrangler configuration](/workers/wrangler/configuration) file](/workers/wrangler/configuration/) file.

Refer to the example below for a sample [Wrangler configuration](/workers/wrangler/configuration) file Cron Triggers configuration:
...
You also can set a different Cron Trigger for each [environment](/workers/wrangler/environments/) in your [Wrangler configuration](/workers/wrangler/configuration) file. You need to put the `[triggers]` table under your chosen environment. For example:
...
You can only delete Cron Triggers using the Cloudflare dashboard (and not through your [Wrangler configuration](/workers/wrangler/configuration) file).
...
- [Triggers](/workers/wrangler/configuration/#triggers) - Review [Wrangler configuration](/workers/wrangler/configuration) file syntax for Cron Triggers.
