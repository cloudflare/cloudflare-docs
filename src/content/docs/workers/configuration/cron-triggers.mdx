...
Cron Trigger testing in Local Explorer requires Wrangler 4.137.0 or later, or Cloudflare Vite plugin 1.58.0 or later.
...
Your local development server exposes `/cdn-cgi/local/scheduled`. If you use the Cloudflare Vite plugin, send requests to your Vite port. Vite uses port `5173` by default.
