...
Wrangler allows you to view the 100 most recent versions and deployments. Refer to the [`versions list`](/workers/wrangler/commands/general/#versions-list) and [`deployments`](/workers/wrangler/commands/general/#deployments-list) documentation to view the commands.
