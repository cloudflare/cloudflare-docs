...
|---|---|---|
| `cohort` | `string \| undefined` | The cohort name used for version selection, if a matching `Cloudflare-Workers-Cohort` header was present. |
| `override` | `string \| undefined` | The version ID specified by a `Cloudflare-Workers-Version-Overrides` header, if present. |
