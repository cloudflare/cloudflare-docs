...
```txt
Created:     2026-03-09T18:35:09.591Z
Author:      yomna@cloudflare.com
Source:      Unknown (deployment)
Message:     Canary at 50%, employees on new version
Version(s):  (100%) abc123-stable-version
                 Created:  2026-03-09T18:25:13.361Z
                     Tag:  -
                 Message:  -

Cohort(s):   canary:
                 (50%) abc123-stable-version
                 (50%) def456-new-version
             employee:
                 (100%) def456-new-version
```
...
block-beta
  columns 2
  block:vA["Version A (60%)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"]:2
    alice["alice"]
    carol["carol"]
    eve["eve"]
  end
  block:vB["Version B (40%)"]:2
    bob["bob"]
    dave["dave"]
  end

  style vA fill:#d4edda,stroke:#28a745
  style vB fill:#cce5ff,stroke:#0366d6
```
