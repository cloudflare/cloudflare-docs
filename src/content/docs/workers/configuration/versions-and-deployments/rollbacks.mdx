...
- A [Durable Object migration](/durable-objects/how-to/configure-migrations/) has occurred between the version in the active deployment and the version selected to roll back to.
