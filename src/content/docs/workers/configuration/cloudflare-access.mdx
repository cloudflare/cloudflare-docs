...
Cloudflare Auth identifies your application users. You can [use Access and Auth together](/workers/auth/cloudflare-access/) when a deployment needs both workforce protection and end-user sign-in.
