...
5. Name your application (e.g. my-worker) and add your `workers.dev` subdomain as the "Application domain".
...
7. Add a name for your access policy (e.g. Authorized preview emails for my-worker)
8. In the "Configure rules" section create a new rule with the "Emails" selector. Enter the emails you want to authorize to access the version preview. View [access policies](/cloudflare-one/policies/access/#selectors) to learn about configuring alternate rules.
