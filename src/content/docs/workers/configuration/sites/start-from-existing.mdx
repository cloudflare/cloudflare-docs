...
1. Run the `wrangler init` command in the root of your project’s directory to generate a basic Worker:
   ...
   - [Wrangler configuration](/workers/wrangler/configuration) file: The file containing project configuration.
...
2. Add your site’s build/output directory to the [Wrangler configuration](/workers/wrangler/configuration) file:
...
6. Deploy your site to a [custom domain](/workers/configuration/routing/custom-domains/) that you own and have already attached as a Cloudflare zone. Add a `route` property to the [Wrangler configuration](/workers/wrangler/configuration) file.
