...
There are a few specific configuration settings for Workers Sites in your [Wrangler configuration](/workers/wrangler/configuration) file:

- `bucket` required

  - The directory containing your static assets, path relative to your [Wrangler configuration](/workers/wrangler/configuration) file. Example: `bucket = "./public"`.
...
Example of a [Wrangler configuration](/workers/wrangler/configuration) file:
...
If you want to include only a certain set of files or directories in your `bucket`, you can add an `include` field to your `[site]` section of your [Wrangler configuration](/workers/wrangler/configuration) file:
...
If you want to exclude files or directories in your `bucket`, you can add an `exclude` field to your `[site]` section of your [Wrangler configuration](/workers/wrangler/configuration) file:
