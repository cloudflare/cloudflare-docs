...
| [FaunaDB](https://fauna.com/blog/getting-started-with-fauna-and-cloudflare-workers)                       | [Yes](/workers/databases/native-integrations/fauna/)       | [faunadb](https://github.com/fauna/fauna-js)                                       | API via client library                                             |
