...
- [Wrangler configuration](/workers/wrangler/configuration) file: Your [Wrangler](/workers/wrangler/configuration/#sample-wranglertoml-configuration) configuration file.
...
- `package.json`
- [Wrangler configuration](/workers/wrangler/configuration) file
- `src/` containing a worker script referenced from [Wrangler configuration](/workers/wrangler/configuration) file
