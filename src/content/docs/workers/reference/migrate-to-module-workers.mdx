...
3. Bindings for [D1](/d1/), [Workers AI](/workers-ai/), [Vectorize](/vectorize/), [Workflows](/workflows/), and [Images](/images/optimization/binding/) can only be used from Workers that use ES modules.
4. You can [gradually deploy changes to your Worker](/workers/versions-and-deployments/gradual-deployments/) when you use the ES modules format.
