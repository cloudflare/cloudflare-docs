...
4. You can [split deployments of your Worker across two versions](/workers/configuration/versions-and-deployments/split-deployments/) when you use the ES modules format.
