...
| **Direct TCP sockets** | Handle inbound TCP connections using the [`connect()` handler](/workers/runtime-apis/handlers/connect/)                                                                              | Create outbound TCP connections using the [`connect()` API](/workers/runtime-apis/tcp-sockets/)              |
