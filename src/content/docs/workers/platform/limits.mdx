...
| [CPU time](#cpu-time)    | 10 ms                                      | 50 ms HTTP request <br/> 50 ms [Cron Trigger](/workers/configuration/cron-triggers/)  | 30 s HTTP request <br/> 30 s [Cron Trigger](/workers/configuration/cron-triggers/) <br/> 30 s [Queue Consumer](/queues/configuration/javascript-apis/#consumer)                                           		|
