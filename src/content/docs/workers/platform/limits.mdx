...
| [Subrequests](#subrequests)                                                     | 50/request   | 1,000/request |
...
<sup>1</sup> If you reach this limit, consider using [Workers for Platforms](/cloudflare-for-platforms/workers-for-platforms/).
...
| Subrequests to internal services    | 1,000          | 1,000           |

Each subrequest in a redirect chain counts against this limit. The total number of subrequests may exceed the number of `fetch()` calls in your code.
