...
Cloudflare enforces Worker size before compression. Workers do not have a separate compressed size limit.
...
The `Total Upload` value is the uncompressed bundle size. Wrangler also reports gzip size for reference.
