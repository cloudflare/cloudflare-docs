...
For Workers subrequests, requests can only be made to URLs, not to IP addresses directly. To overcome this limitation [add an A or AAAA record to your zone](/dns/manage-dns-records/how-to/create-dns-records/) and then fetch that resource.
