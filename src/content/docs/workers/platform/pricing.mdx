...
For more information and [examples of Workers Logs billing](/workers/observability/logs/workers-logs/#examples), refer to the [Workers Logs documentation](/workers/observability/logs/workers-logs).
