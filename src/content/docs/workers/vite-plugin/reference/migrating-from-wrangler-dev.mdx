...
In most cases, migrating from [`wrangler dev`](/workers/wrangler/commands/general/#dev) is straightforward and you can follow the instructions in [Get started](/workers/vite-plugin/get-started/).
