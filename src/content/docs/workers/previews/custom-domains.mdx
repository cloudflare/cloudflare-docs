...
To restrict access to custom domain and `workers.dev` Preview URLs, use [Cloudflare Access](/workers/configuration/cloudflare-access/). This prevents unauthenticated users and crawlers from viewing your Preview.
...
For static assets, add the header through a [`_headers` file](/workers/static-assets/headers/). For Worker-generated responses, add it directly in your Worker code.
