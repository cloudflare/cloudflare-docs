...
Adding a Workflow binding to a `previews` block binds the Preview to an existing Workflow. It does not create or deploy a Preview-specific Workflow. To create a Workflow, [deploy one with Wrangler](/workflows/get-started/guide/#6-deploy-your-workflow).
