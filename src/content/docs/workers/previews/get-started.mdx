...
To post Preview URLs automatically to pull requests or merge requests, [connect your Git repository](/workers/ci-cd/builds/#get-started) and use [Workers Builds](/workers/ci-cd/builds/build-branches/#configure-preview-builds). If you already have a Git-connected Worker that uses Workers Builds, complete the [one-time setup](/workers/ci-cd/builds/build-branches/#existing-workers-connected-to-builds).
