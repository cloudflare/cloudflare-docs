...
To inject CSP nonces into inline `<script>` tags using HTMLRewriter, refer to the [CSP nonce example in SPA shell with bootstrap data](/workers/examples/spa-shell/#add-csp-nonces).
