...
You also can set a different Cron Trigger for each [environment](/workers/wrangler/environments/) in your Wrangler configuration file. You need to put the `[triggers]` table under your chosen environment. For example:
