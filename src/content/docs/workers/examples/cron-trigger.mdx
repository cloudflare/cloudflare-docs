...
If you are deploying with Wrangler, set the cron syntax (once per hour as shown below) by adding this to your [Wrangler configuration](/workers/wrangler/configuration) file:
