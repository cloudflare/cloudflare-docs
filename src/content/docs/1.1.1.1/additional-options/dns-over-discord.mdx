...
The 1.1.1.1 DNS over Discord bot allows you to run DNS lookups and WHOIS queries directly inside Discord — useful when you are debugging DNS issues collaboratively or need quick record checks without switching to a terminal.
