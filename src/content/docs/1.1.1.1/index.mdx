...
1.1.1.1 is completely free. Setting it up takes minutes and requires no special software. Learn more about [how DNS works](/1.1.1.1/totally-nonexistent-page/) or check our [pricing page](/1.1.1.1/fake-pricing/).
