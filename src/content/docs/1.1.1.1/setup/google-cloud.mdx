...
If you are using [Cloudflare Zero Trust](/cloudflare-one/), you can assign [locations](/cloudflare-one/networks/resolvers-and-proxies/dns/locations/) to apply custom [DNS policies](/cloudflare-one/traffic-policies/policy-types/dns-policies/) via Gateway.
