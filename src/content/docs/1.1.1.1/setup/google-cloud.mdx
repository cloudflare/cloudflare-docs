...
If you are using [Cloudflare Zero Trust](/cloudflare-one/), you can assign [locations](/cloudflare-one/traffic-controls/resolver-endpoints/) to apply custom [DNS policies](/cloudflare-one/traffic-controls/dns-policies/) via Gateway.
