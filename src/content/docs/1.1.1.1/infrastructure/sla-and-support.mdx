...
If you need SLAs and dedicated support, consider using [Cloudflare Gateway](/cloudflare-one/traffic-controls/) instead. Gateway adds policy-based DNS filtering and management.
