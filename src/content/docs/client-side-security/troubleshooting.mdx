...
There is currently no way to scope a content security rule to "root zone only, excluding custom hostnames." If you only need to monitor your own application surfaces, consider one of the following:
