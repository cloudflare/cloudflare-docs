...
Turning off client-side security's resource monitoring does not turn off [content security rules](/client-side-security/rules/) (previously known as policies). To turn off content security rules:
