...
:::note
To help with PCI DSS requirements, you must have an Enterprise plan with a paid add-on. Refer to [Availability](/client-side-security/#availability) for details on what is included in each tier.
:::
