...
Configuring [log policies](/client-side-security/policies/) will add other CSP report-only headers to responses. Cloudflare does not perform any sampling for these report-only headers related to customer-defined policies.
