...
Use client-side security's dashboards to review the scripts loaded in your domain and the connections they make. For more information, refer to [Monitor resources and cookies](/client-side-security/detection/monitor-connections-scripts/).
