...
With Client-Side Security Advanced, you can create [policies](/client-side-security/policies/) to define a positive security model (also known as positive blocking) for resources such as scripts.
