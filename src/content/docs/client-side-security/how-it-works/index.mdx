...
sidebar:
  ...
  group:
    label: How it works
description:
  Cloudflare Client-Side Security tracks resources (such as scripts) loaded by your
...
Enterprise customers with a paid add-on can create [policies](/client-side-security/policies/) to define a positive security model (also known as positive blocking) for resources such as scripts.

<Render file="policy-headers" product="client-side-security" />

For more information, refer to [Policies](/client-side-security/policies/).
