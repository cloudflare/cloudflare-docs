...
- [Cloudflare Blog](https://blog.cloudflare.com/tag/cloud-email-security/) | Cloud Email security and [Phishing](https://blog.cloudflare.com/tag/phishing/)
...
1. Email arrives at Cloudflare based on MX records.
