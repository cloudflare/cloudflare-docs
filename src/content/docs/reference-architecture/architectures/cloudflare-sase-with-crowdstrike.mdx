...
products: [access, gateway, zero-trust-warp, logpush, api]
sidebar:
  order: 1
...
**Cloudflare One** and **CrowdStrike <span style="text-decoration:underline;">Falcon® </span>** provide a powerful integrated solution to these challenges. By combining CrowdStrike's industry-leading security platform with Cloudflare's secure network and zero trust capabilities, organizations can implement comprehensive protection that secures both their devices and network traffic while simplifying management through automation and policy consistency.
...
![High Level Architecture: Integration](~/assets/images/reference-architecture/cloudflare-sase-with-crowdstrike/Main_Arch.svg)
##### Figure: High Level Architecture - Integration

### **Key use cases**

The integration between Cloudflare and CrowdStrike enables three primary use cases that address critical security challenges:

**Individual integrations — Service specific**
...
### Consolidated integrations — Platform scope
...
![1. Zero Trust access with device posture and user risk score](~/assets/images/reference-architecture/cloudflare-sase-with-crowdstrike/UseCase01.svg)
##### Figure 1. Zero Trust access with device posture and user risk score
...
![2. Unified threat hunting](~/assets/images/reference-architecture/cloudflare-sase-with-crowdstrike/UseCase02.svg)
##### Figure 2. Unified threat hunting
...
![3. Automated edge remediation](~/assets/images/reference-architecture/cloudflare-sase-with-crowdstrike/UseCase03.svg)
##### Figure 3. Automated edge remediation
...
![4. Compromised user lifecycle - detection and response](~/assets/images/reference-architecture/cloudflare-sase-with-crowdstrike/UseCase04.svg)
##### Figure 4. Compromised user lifecycle - detection and response
...
![5. Insider threat data protection](~/assets/images/reference-architecture/cloudflare-sase-with-crowdstrike/UseCase05.svg)
##### Figure 5. Insider threat data protection
...
![6. Proactive application defense](~/assets/images/reference-architecture/cloudflare-sase-with-crowdstrike/UseCase06.svg)
##### Figure 6. Proactive application defense
