...
head:
  - tag: title
    content: Cloudflare Security Architecture
...
![The API gateway has many stages, discovery, review, using a positive security model, abuse protection, data protection and endpoint management/monitoring.](~/assets/images/reference-architecture/security/security-ref-arch-11.svg)
_Common user workflow for API Gateway_
