...
![Figure 5: Cloudflare configured to proxy traffic for site https://api2.cf-time.com](~/assets/images/reference-architecture/multi-vendor-architecture-images/Figure_5.png "Figure 5")
