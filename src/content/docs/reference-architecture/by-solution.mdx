...
- [Cloudflare One Appliance deployment options](/reference-architecture/diagrams/sase/magic-wan-connector-deployment/)
...
- [Programmable Platforms](/reference-architecture/diagrams/serverless/programmable-platforms/)
