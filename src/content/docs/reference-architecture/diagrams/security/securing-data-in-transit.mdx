...
![Figure 1: Securing data from the user device, all the way to the website/API](~/assets/images/reference-architecture/securing-data-in-transit/securing-data-in-transit-fig1.svg)
_Figure 1: Securing data from the user device, all the way to the website/API_
...
![Figure 2: Various methods of connecting and routing traffic to Cloudflare to secure private traffic.](~/assets/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-14.svg)
_Figure 2: Various methods of connecting and routing traffic to Cloudflare to secure private traffic._
...
![Figure 3: Example of a Cloudflare policy blocking confidential data uploaded to approved cloud storage.](~/assets/images/reference-architecture/cloudflare-one-reference-architecture-images/cf1-ref-arch-29.svg)
_Figure 3: Example of a Cloudflare policy blocking confidential data uploaded to approved cloud storage._
...
![Figure 4: Upload of file containing sensitive data blocked by Cloudflare DLP](~/assets/images/reference-architecture/securing-data-in-transit/securing-data-in-transit-fig4.svg)
_Figure 4: Upload of file containing sensitive data blocked by Cloudflare DLP_
