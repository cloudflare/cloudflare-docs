...
head:
  - tag: title
    content: "Reference Architecture Diagram: Securing data in use"
...
![Figure 1: Text copy/paste blocked by Cloudflare RBI.](~/assets/images/reference-architecture/securing-data-in-use/securing-data-in-use-fig1.svg)
_Figure 1: Text copy/paste blocked by Cloudflare RBI._
