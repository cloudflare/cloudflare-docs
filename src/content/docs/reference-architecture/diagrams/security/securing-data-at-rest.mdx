...
head:
  - tag: title
    content: "Reference Architecture Diagram: Securing data at rest"
---
...
![Figure 1: Overall solution of user access controls to, and the discovery of, sensitive data.](~/assets/images/reference-architecture/securing-data-at-rest/securing-data-at-rest-fig1.svg)
_Figure 1: Overall solution of user access controls to, and the discovery of, sensitive data._
