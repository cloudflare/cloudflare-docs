...
5. **Advanced security and filtering options**.
   ...
   - [**Full SSL inspection**](/cloudflare-one/traffic-policies/tls-decryption/) to protect against sophisticated threats and provide traffic visibility on encrypted traffic. It enables additional protections such as antivirus scanning, malware prevention, and file sandboxing.
