...
7. Magic Transit Egress traffic is subject to Network Firewall filtering before being routed out to the Internet towards the users.
...
7. This Magic Transit Egress traffic is subject to Network Firewall filtering before being routed out to the Internet towards the users.
...
- [Cloudflare IPsec Device Compatibility Matrix](/cloudflare-wan/reference/device-compatibility/)
