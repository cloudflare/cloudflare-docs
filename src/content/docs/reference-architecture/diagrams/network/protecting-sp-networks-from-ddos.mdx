...
2. Service provider network devices send all traffic flow data (Netflow, IPFIX or sFlow) to the [Network Flow](/network-flow/) (formerly Magic Network Monitoring) service. Cloudflare analyses this flow data to detect DDoS attacks.
