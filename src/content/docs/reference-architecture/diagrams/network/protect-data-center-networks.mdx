...
products: [ddos-protection, gateway, magic-firewall, magic-transit, cloudflare-wan, network-interconnect]
sidebar:
  order: 1
  label: Protect data center networks
reviewed: 2024-12-19
description: >-
  This document focuses on the reference architecture of using Cloudflare WAN, Magic Firewall, and Cloudflare Gateway services.
---
...
The reference architecture diagrams below illustrate how Cloudflare services — Cloudflare WAN, Magic Firewall and Cloudflare Gateway — can be used to protect site-to-site, inter-data center traffic between your private networks.
...
3. After clearing Magic Firewall, traffic is subsequently routed to [Cloudflare Gateway](/cloudflare-one/traffic-policies/), our secure web gateway service.
