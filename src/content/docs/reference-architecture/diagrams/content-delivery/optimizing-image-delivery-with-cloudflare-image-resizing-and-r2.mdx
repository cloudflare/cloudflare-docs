...
head:
  - tag: title
    content: "Reference Architecture Diagram: Optimizing Image Delivery with
      Cloudflare Image Resizing and R2"
...
![Figure 1: Cloudflare Image Resizing and R2](~/assets/images/reference-architecture/optimizing-image-delivery-with-cloudflare-image-resizing-and-r2-diagrams/optimizing-image-delivery-with-cloudflare-image-resizing-and-r2-diagram.svg)
_Figure 1: Cloudflare Image Resizing and R2_
