...
head:
  - tag: title
    content: "Reference Architecture Diagram: Retrieval Augmented Generation (RAG)"
...
![Figure 1: Knowledge seeding](~/assets/images/reference-architecture/rag-ref-architecture-diagrams/rag-architecture-seeding.svg)
_Figure 1: Knowledge seeding_
...
![Figure 2: Knowledge queries](~/assets/images/reference-architecture/rag-ref-architecture-diagrams/rag-architecture-query.svg)
_Figure 2: Knowledge queries_
