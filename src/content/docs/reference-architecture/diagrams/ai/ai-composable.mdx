...
head:
  - tag: title
    content: "Reference Architecture Diagram: Composable AI architecture"
...
![Figure 1: Composable AI architecture](~/assets/images/reference-architecture/ai-composable/ai-composable.svg)
_Figure 1: Composable AI architecture_
