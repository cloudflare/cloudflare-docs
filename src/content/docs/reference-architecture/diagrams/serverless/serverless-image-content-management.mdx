...
head:
  - tag: title
    content: "Reference Architecture Diagram: Serverless image content management"
...
![Figure 1: Serverless image content management](~/assets/images/reference-architecture/serverless_image_content_management/diagram.svg)
_Figure 1: Serverless image content management reference architecture diagram_
