...
head:
  - tag: title
    content: Fullstack applications
...
![Figure 1: Fullstack application](~/assets/images/reference-architecture/fullstack-app/fullstack-app-base.svg)
_Figure 1: Fullstack application_
