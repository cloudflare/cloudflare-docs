...
head:
  - tag: title
    content: A/B-testing using Workers
---
...
![Figure 1: A/B testing using Workers](~/assets/images/reference-architecture/a-b-testing-workers/a-b-testing-workers.svg)
_Figure 1: A/B testing using Workers_
