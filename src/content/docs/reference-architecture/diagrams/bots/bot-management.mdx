...
reviewed: 2024-10-04
description: >-
  Cloudflare has bot management capabilities to help identify and mitigate automated traffic to protect domains from bad bots. Bot Fight Mode  and Super Bot Fight mode are options available on Free and Pro/Business accounts respectively. Bot Score is a score from 1 to 99 that indicates how likely that request came from a bot.
---
