...
With [Enterprise Bot Management](/bots/get-started/bm-subscription/) customers have the maximum protection, and features and capabilities. A [bot score](/bots/concepts/bot-score/) is exposed for every request. Scores below 30 are commonly associated with bot traffic. Customers can take action on this score by using [WAF custom rules](/waf/custom-rules/) or [Workers](/workers/runtime-apis/request/#incomingrequestcfproperties). Additionally, customers can view this score along with other bot specifics like bot score source, [bot detection IDs](/bots/concepts/detection-ids/), and [bot detection tags](/bots/concepts/detection-ids/#detection-tags) in the Bots, Security Analytics, and Events dashboards. These fields can also be seen in more detailed logs in Log Explorer or exported to third party SIEMs or Analytics platforms using Log Push.
