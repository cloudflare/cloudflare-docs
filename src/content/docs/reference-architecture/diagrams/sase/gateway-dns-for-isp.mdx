...
In cases of a miscategorization of domains, raise a [categorization change request](/threat-intelligence/investigate/change-categorization/#via-the-cloudflare-dashboard) directly from the Cloudflare dashboard.
:::
