...
reviewed: 2024-10-25
description: >-
  Cloudflare Gateway is a DNS filtering solution for Internet service providers. Service providers can offer enhanced security as a value-added service for residential and mobile subscribers or B2B clients. It is built on Cloudflare's 1.1 public DNS resolver.
---
