...
4. Traffic passes through our [Secure Web Gateway](/cloudflare-one/traffic-policies/gateway/) (SWG), which applies network level firewall rules to both inbound and outbound traffic.
