...
<LinkCard
    ...
    href="/cloudflare-one/access-controls/policies/access/external-evaluation/"
/>
...
- [External Evaluation rules](/cloudflare-one/access-controls/policies/access/external-evaluation/)
