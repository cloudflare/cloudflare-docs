...
sidebar:
  order: 1
  label: Cloudflare One Appliance deployment
reviewed: 2024-11-14
description: >-
...
![Figure 1: Connector location options: (a) replacing CPE, (b) north of CPE , (c) south of CPE.](~/assets/images/reference-architecture/cloudflare-one-appliance-deployment/figure01.svg "Figure 1. Connector location options: (a) replacing CPE, (b) north of CPE , (c) south of CPE")
...
![Figure 2. Uplink high-availability deployment.](~/assets/images/reference-architecture/cloudflare-one-appliance-deployment/figure02.svg "Figure 2. Uplink high-availability deployment.")
...
![Figure 3. Full HA with dual Connectors and dual uplinks.](~/assets/images/reference-architecture/cloudflare-one-appliance-deployment/figure03.svg "Figure 3. Full HA with dual Connectors and dual uplinks.")
...
![Figure 4. Hybrid MPLS/Internet use case.](~/assets/images/reference-architecture/cloudflare-one-appliance-deployment/figure04.svg "Figure 4. Hybrid MPLS/Internet use case.")
...
In some deployments, customers might want to protect only specific protocols using Cloudflare security services such as our [secure web gateway](/cloudflare-one/traffic-policies/), while the rest of the traffic routes through the existing edge device (router or firewall). Figure 5 illustrates such a use case.

![Figure 5. 'Split Tunneling' use case.](~/assets/images/reference-architecture/cloudflare-one-appliance-deployment/figure05.svg "Figure 5. 'Split Tunneling' use case.")
...
![Figure 6. Segmentation-related use cases.](~/assets/images/reference-architecture/cloudflare-one-appliance-deployment/figure06.svg "Figure 6. Segmentation-related use cases.")
...
- [Configuring Cloudflare One Appliance](/cloudflare-wan/configuration/appliance/)
