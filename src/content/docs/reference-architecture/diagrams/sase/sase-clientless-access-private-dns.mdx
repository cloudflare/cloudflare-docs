...
head:
  - tag: title
    content: "Reference Architecture Diagram: Access to private apps without having
      to deploy client agents"
...
![Figure 1: Remote Access Internal Hostname](~/assets/images/reference-architecture/sase-clientless-access-private-dns/diagram1.svg)
_Figure 1: Remote browser connected to private web service using internal hostname_
