...
- **Office-based users:** Connecting to a local network which routes Internet bound traffic to Cloudflare through GRE or IPsec [Cloudflare WAN tunnels](/cloudflare-wan/) (formerly Magic WAN).
