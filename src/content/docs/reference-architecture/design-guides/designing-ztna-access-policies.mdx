...
reviewed: 2024-11-27
description: >-
  This guide is for customers looking to deploy Cloudflare's ZTNA service. It provides best practices and guidelines for how to effectively build the right policies. This guide covers three main sections: Technical prerequisites, building policies, and use cases.
---
