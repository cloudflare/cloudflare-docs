...
To get started, navigate to firewall policies and select DNS in the Zero Trust dashboard. For detailed, step-by-step instructions, refer to the [DNS Policies](/cloudflare-one/traffic-policies/dns-policies/) guide.
...
- [DNS policies \- Cloudflare Zero Trust](/cloudflare-one/traffic-policies/dns-policies/)
