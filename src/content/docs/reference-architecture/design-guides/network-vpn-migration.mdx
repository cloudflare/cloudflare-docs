...
![Diagram showing suboptimal traffic paths for traffic to Internet resources.](~/assets/images/reference-architecture/design-guide-network-vpn-migr/traditional-vpn.png "Figure 1: A traditional VPN deployment, where all user traffic destined for the Internet must route through the company hosted and managed VPN service.")
...
![Diagram showing traffic paths directly flowing to Internet resources.](~/assets/images/reference-architecture/design-guide-network-vpn-migr/sase-remote-access.png "Figure 2: SASE platforms do not degrade user Internet access experience, and provide fast, secure global access to self hosted hosted resources.")
...
![A traditional VPN deployment using VPN concentrators spread across three DCs.](~/assets/images/reference-architecture/design-guide-network-vpn-migr/vpn-concentrators.png "Figure 3: A traditional VPN deployment using VPN concentrators spread across three DCs.")
...
![A high level design of Cloudflare traffic routing for phase 1 of the migration.](~/assets/images/reference-architecture/design-guide-network-vpn-migr/phase-1.png "Figure 4: A high level design of Cloudflare traffic routing for phase 1 of the migration.")
...
![An evolved architecture diagram showing software connector based tunnels offloading (or replacing) the IPsec tunnels.](~/assets/images/reference-architecture/design-guide-network-vpn-migr/phase-2.png "Figure 5: An evolved phase 2 architecture diagram showing software connector based tunnels offloading (or replacing) the IPsec tunnels.")
...
![Example architecture of tunnels deployed per application to improve security posture by reducing lateral movement within data centers.](~/assets/images/reference-architecture/design-guide-network-vpn-migr/phase-3.png "Figure 6: Example phase 3 architecture of tunnels deployed per application to improve security posture by reducing lateral movement within data centers.")
...
![Adding a public hostname to a tunnel for clientless access to internal applications.](~/assets/images/reference-architecture/design-guide-network-vpn-migr/clientless-access.png "Figure 7: Adding a public hostname to a tunnel for clientless access to internal applications.")
