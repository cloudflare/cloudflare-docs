...
1. Software connectors ([`cloudflared`](/cloudflare-one/networks/connectors/cloudflare-tunnel/private-net/cloudflared/) or [Cloudflare Mesh](/cloudflare-one/networks/connectors/cloudflare-mesh/))
...
- [Cloudflare Mesh](/cloudflare-one/networks/connectors/cloudflare-mesh/) (formerly WARP Connector)
...
- Policy configuration: [Gateway Network policies](/cloudflare-one/traffic-policies/policy-types/network-policies/)
