...
To query data with R2 SQL, you need your warehouse name associated with your [catalog](/r2-data-catalog/manage-catalogs/). To retrieve it, you can run the [`r2 bucket catalog get` command](/workers/wrangler/commands/r2/#r2-bucket-catalog-get):
