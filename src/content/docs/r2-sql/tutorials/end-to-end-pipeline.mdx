...
In this tutorial, you will learn how to build a complete data pipeline using [Cloudflare Pipelines](/pipelines/), R2 Data Catalog, and R2 SQL. This also includes a sample Python script that creates and sends financial transaction data to your Pipeline that can be queried by R2 SQL or any Apache Iceberg-compatible query engine.
