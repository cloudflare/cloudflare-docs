...
The maximum number of custom rules applies to an entire phase. Each scope (zone or account) has a separate maximum number of rules, counted in the following way:
