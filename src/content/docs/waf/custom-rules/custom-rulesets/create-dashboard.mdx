...
head:
  - tag: title
    content: Work with custom rulesets in the dashboard
---
...
10. (Optional) If you selected the _Block_ action, you can [configure a custom response](/waf/reference/response-for-blocked-requests/#custom-response).
