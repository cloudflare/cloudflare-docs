...
<Render
	...
	params={{
		one: "custom rule",
		two: "",
		three: "http_request_firewall_custom",
	}}
/>
...
The new rule, which will be the last rule in the ruleset, includes the definition of a [custom response](/waf/reference/response-for-blocked-requests/#custom-response) for blocked requests:
