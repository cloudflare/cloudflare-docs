...
{/* NOTE: Navigation steps (go to Security rules page, select Create rule) also exist as a
   partial at src/content/partials/waf/navigate-to-custom-rules.mdx, used by the solution
   guide at /use-cases/application-security/bots/stop-malicious-bots/. If you update the
   navigation steps below, update the partial too. */}
