...
Custom rulesets are collections of custom rules that you can deploy at the zone or [account level](/waf/account/custom-rulesets/).

Like [custom rules](/waf/custom-rules/), custom rulesets allow you to control incoming traffic by filtering requests.
...
Use the different operations in the [Rulesets API](/ruleset-engine/rulesets-api/) to work with the custom ruleset you created and deployed. The following table has a list of common tasks for working with custom rulesets at the zone level:
