...
Refer to [Available skip options](/waf/custom-rules/skip/options/#log-requests-matching-the-skip-rule) for more information on disabling logging for requests that match a skip rule.
...
Refer to [Available skip options](/waf/custom-rules/skip/options/#skip-products) for the list of products you can skip.
...
Currently, this skip option is only available at the zone level. Refer to [Available skip options](/waf/custom-rules/skip/options/#skip-the-remaining-custom-rules-current-phase) for more details.
