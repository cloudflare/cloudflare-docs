...
To enable traffic detections in the Cloudflare dashboard, go to your domain > **Security** > **Settings**. If you are using the new security dashboard, filter by **Detections**.
