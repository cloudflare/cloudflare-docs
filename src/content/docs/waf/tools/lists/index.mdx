...
- The lists described in this page are not the same as [Zero Trust lists](/cloudflare-one/reusable-components/lists/). They support different data types and have different validation rules (for example, regarding the list name).
