...
:::note
The **User agent rules** option appears only if you have configured at least one user agent rule. Cloudflare recommends that you use [custom rules](/waf/custom-rules/) instead of user agent rules.
:::
