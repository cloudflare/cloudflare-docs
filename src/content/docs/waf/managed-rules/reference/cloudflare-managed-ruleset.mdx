...
Once you have [deployed the Cloudflare Managed Ruleset](#deploy-the-cloudflare-managed-ruleset), do the following to configure individual ruleset rules in the dashboard:
