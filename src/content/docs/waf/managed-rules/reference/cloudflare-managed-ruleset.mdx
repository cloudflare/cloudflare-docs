...
<Render
	...
	product="waf"
	params={{
		rulesetNameOldDash: "Cloudflare Managed Ruleset",
		rulesetNameNewDash: "Cloudflare managed ruleset",
	}}
/>
...
Once you have [deployed the Cloudflare Managed Ruleset](#deploy-the-cloudflare-managed-ruleset), do the following to configure it in the dashboard:
...
Once you have [deployed the Cloudflare Managed Ruleset](#deploy-the-cloudflare-managed-ruleset), do the following to configure rules with specific tags in the dashboard:
...
Once you have [deployed the Cloudflare Managed Ruleset](#deploy-the-cloudflare-managed-ruleset), do the following to configure individual rules of the Cloudflare Managed Ruleset in the dashboard:
