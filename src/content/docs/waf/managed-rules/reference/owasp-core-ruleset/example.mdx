...
The [**Activity log** in Security Events](/waf/analytics/security-events/#activity-log) would display the following details for the example incoming request handled by the OWASP Core Ruleset:
