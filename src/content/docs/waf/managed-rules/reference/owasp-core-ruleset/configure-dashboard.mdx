...
export const availableActions =
	"The available actions are: _Managed Challenge_, _Block_, _JS Challenge_, _Interactive Challenge_, and _Log_.";
...
<Render
	...
	product="waf"
	params={{
		rulesetNameOldDash: "Cloudflare OWASP Core Ruleset",
		rulesetNameNewDash: "OWASP core ruleset",
	}}
/>
...
- **OWASP action**: The action to perform when the calculated [request threat score](/waf/managed-rules/reference/owasp-core-ruleset/concepts/#request-threat-score) is greater than the [score threshold](/waf/managed-rules/reference/owasp-core-ruleset/concepts/#score-threshold). <Markdown text={availableActions} />
...
To configure the Cloudflare OWASP Core Ruleset in the dashboard:
...
Once you have [deployed the Cloudflare OWASP Core Ruleset](#deploy-the-cloudflare-owasp-core-ruleset), do the following to configure rules with specific tags in the dashboard:
...
Once you have [deployed the Cloudflare OWASP Core Ruleset](#deploy-the-cloudflare-owasp-core-ruleset), do the following to configure individual rules of the managed ruleset in the dashboard:
