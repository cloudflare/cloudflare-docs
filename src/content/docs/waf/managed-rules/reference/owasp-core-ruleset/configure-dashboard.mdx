...
Once you have [deployed the Cloudflare OWASP Core Ruleset](#deploy-the-cloudflare-owasp-core-ruleset), do the following to configure individual ruleset rules in the dashboard:
