...
head:
  - tag: title
    content: Deploy a managed ruleset in the dashboard for a zone
...
3. Next to the *Execute* rule deploying the managed ruleset you want to configure, select the managed ruleset name.<br/> If you have not deployed the managed ruleset yet, select the managed ruleset name under **Managed Rulesets**.
