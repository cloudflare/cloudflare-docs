...
4. Next to the managed ruleset you want to deploy, select **Enable**.
...
Next to the managed ruleset you want to turn on or off, select the **Enabled** toggle.

</TabItem> <TabItem label="New dashboard" icon="rocket">

Next to the managed ruleset you want to turn on or off, select **Enable** or **Disable**, respectively.
...
3. In the rules table, search for the managed ruleset you want to configure. At the top of the page, you can filter the rules to show **Managed rules** only.
