...
- Create a [custom rule](/waf/custom-rules/) to block the specific attack pattern. Use fields such as URI path, query string, headers, or body content to match the malicious requests.
