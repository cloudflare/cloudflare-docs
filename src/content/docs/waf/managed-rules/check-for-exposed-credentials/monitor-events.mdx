...
The **Activity log** in [Security Events](/waf/analytics/security-events/) shows entries for requests with exposed credentials identified by rules with the _Log_ action.
