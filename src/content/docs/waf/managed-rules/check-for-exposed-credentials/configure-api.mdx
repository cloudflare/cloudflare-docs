...
If you are using Terraform, refer to [Configure exposed credentials checks using Terraform](/waf/managed-rules/check-for-exposed-credentials/configure-terraform/).
