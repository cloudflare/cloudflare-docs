...
- Learn more about Cloudflare's security scores (<GlossaryTooltip term="attack score" link="/waf/about/waf-attack-score/">attack score</GlossaryTooltip>, [bot score](/bots/concepts/bot-score/), [uploaded content scanning](/waf/about/content-scanning/), and [leaked credentials](/waf/detections/leaked-credentials/) results) with real data.
