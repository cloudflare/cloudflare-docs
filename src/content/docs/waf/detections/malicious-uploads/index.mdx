...
Cloudflare uses the same [anti-virus (AV) scanner used in Cloudflare Zero Trust](/cloudflare-one/traffic-policies/gateway/http-policies/antivirus-scanning/) for WAF content scanning.
