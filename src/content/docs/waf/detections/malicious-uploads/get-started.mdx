...
4. Next to **Malicious upload detection**, select **Enable**.
...
2. Go to **Security** > **Settings**.
3. In **Web application exploits**, select **Manage detections**.
4. On the sidebar, under **Custom content location**, select **Go to malicious upload**.
5. Select **Add content location**.
6. In **Content location**, enter your custom scan expression. For example:
