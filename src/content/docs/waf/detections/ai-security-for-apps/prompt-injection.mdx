...
3. If you see false positives (legitimate prompts being flagged), lower the threshold (for example, less than `25`).
4. If you see attacks getting through, raise the threshold (for example, less than `50`).
