...
- <GlossaryTooltip term="prompt injection">Prompt injection</GlossaryTooltip> detection — Detect prompts intentionally designed to subvert the intended behavior of your LLM as specified by the developer.
