...
AI Security for Apps is a detection that can help protect your services powered by <GlossaryTooltip term="LLM">large language models</GlossaryTooltip> (LLMs) against abuse. This model-agnostic detection currently helps you do the following:
...
| **Rules based on detections** — create custom rules or rate limiting rules using AI Security for Apps fields | No | No | No | Yes |
