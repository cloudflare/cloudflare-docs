...
6. In **Security** > **Analytics**, open **Profile Analysis**. Review conforming and violating requests.

   <DashButton url="/?to=/:account/:zone/security/analytics" />

7. Filter Security Analytics with `cf.schema_validation.learned.violated`.
