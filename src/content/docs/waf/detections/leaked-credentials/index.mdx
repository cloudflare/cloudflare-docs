...
:::note
Cloudflare may detect leaked credentials because an attacker is performing a credential stuffing attack, but also because a legitimate end user is reusing a previously leaked password.
:::
