...
:::note
If you are currently using [Exposed Credentials Check](/waf/managed-rules/check-for-exposed-credentials/) (a previous implementation) and want to upgrade to leaked credentials detection, refer to [Upgrade to leaked credentials detection](/waf/managed-rules/check-for-exposed-credentials/upgrade-to-leaked-credentials-detection/).
:::
