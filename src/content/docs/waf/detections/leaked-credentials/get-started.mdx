...
If you are on a Free plan, deploy the suggested [rate limiting rule](/waf/rate-limiting-rules/) template available in **Security** > **Security rules**.
...
Additionally, you may want to handle leaked credentials detected by Cloudflare at your <GlossaryTooltip term="origin server">origin server</GlossaryTooltip>:
