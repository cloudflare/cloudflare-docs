...
<Feature
	...
	href="/waf/detections/application-profiles/"
>
	Compare requests with an application-specific expected structure. Review
	profile detections before mitigating violations with Custom Rules.
</Feature>
