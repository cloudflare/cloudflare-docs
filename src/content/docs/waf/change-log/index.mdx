...
The [WAF changelog](/waf/change-log/changelog/) provides information about changes to managed rulesets and general updates to WAF protection.
...
The [changelog](/waf/change-log/changelog/) also includes more general updates to WAF protection.
