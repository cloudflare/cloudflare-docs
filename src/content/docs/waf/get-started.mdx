...
4. Next to **Cloudflare Managed Ruleset**, select **Enable**.
...
2. In **Web application exploits**, select **Manage detections**.
3. Next to **Cloudflare OWASP Core Ruleset**, select **Enable**.<br/>
   This will deploy the ruleset with the default configuration: paranoia level = _PL1_ and score threshold = _Medium - 40 and higher_.
