...
Enterprise customers with Bot Management should first configure bot protection using the **Security Settings** toggles, which provide baseline protection without creating custom rules:
