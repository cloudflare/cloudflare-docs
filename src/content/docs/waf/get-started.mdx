...
## Create custom rule based on WAF attack score
...
## Create custom rule based on bot score
...
## Optional - Deploy the Cloudflare OWASP Core Ruleset
...
## Review traffic in security dashboards
...
Use [leaked credential checks](/waf/managed-rules/check-for-exposed-credentials/) to prevent <GlossaryTooltip term="credential stuffing">credential stuffing</GlossaryTooltip> attacks on your applications.
