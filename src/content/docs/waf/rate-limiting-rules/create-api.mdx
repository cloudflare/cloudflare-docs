...
<Render file="api-generic-create-rule-procedure" params={{ one: "rate limiting rule", two: "with a `ratelimit` object", three: "http_ratelimit" }} />
...
<Render file="rules-next-steps-table" params={{ one: "rate limiting rules", two: "http_ratelimit" }} />
