...
:::note
Some Enterprise customers can create rate limiting rulesets at the account level that they can deploy to multiple Enterprise zones. For more information, refer to [Rate limiting rulesets](/waf/account/rate-limiting-rulesets/).
:::
