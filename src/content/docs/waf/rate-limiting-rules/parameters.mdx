...
* [**With response type**](/waf/rate-limiting-rules/parameters/#with-response-type-for-block-action)
* [**With response code**](/waf/rate-limiting-rules/parameters/#with-response-code-for-block-action)
* [**Response body**](/waf/rate-limiting-rules/parameters/#response-body-for-block-action)
