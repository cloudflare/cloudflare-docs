...
* [**With response type**](waf/custom-rules/custom-rulesets/create-dashboard/#configure-a-custom-response-for-blocked-requests)
* [**With response code**](waf/custom-rules/custom-rulesets/create-dashboard/#configure-a-custom-response-for-blocked-requests)
* [**Response body**](waf/custom-rules/custom-rulesets/create-dashboard/#configure-a-custom-response-for-blocked-requests)
