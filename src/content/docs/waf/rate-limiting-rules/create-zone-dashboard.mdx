...
11. (Optional) If you selected the _Block_ action, you can [configure a custom response](/waf/reference/response-for-blocked-requests/#custom-response) for requests exceeding the configured rate limit.
