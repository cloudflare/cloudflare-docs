...
* **Simulate**: The request is allowed through but is logged in the [**Activity log**](/waf/analytics/security-events/#activity-log).
...
Review the [Activity log](/waf/analytics/security-events/#activity-log) for the final score and for the individual triggered rules.
