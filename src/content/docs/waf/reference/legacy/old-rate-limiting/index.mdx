...
For more information on what changed in the [new version of rate limiting rules](/waf/rate-limiting-rules/), refer to the [upgrade guide](/waf/reference/legacy/old-rate-limiting/upgrade/).
...
For more information on challenge actions, refer to [Cloudflare challenges](/fundamentals/security/cloudflare-challenges/).
