...
In WAF custom rules you can [customize the response of the _Block_ action](/waf/reference/response-for-blocked-requests/#custom-response).
...
- [Define a custom response](/waf/reference/response-for-blocked-requests/#custom-response) for requests blocked by a specific WAF custom rule. This custom response supports other content types besides HTML.
