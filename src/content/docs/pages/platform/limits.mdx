...
Each time you push new code to your Git repository, Pages will build and deploy your site. You can build up to 500 times per month on the Free plan. Refer to the [Cloudflare plans](https://www.cloudflare.com/plans) page if you need more builds.
|                  | Free              | Pro                 | Business             |
| ---------------- | ----------------- | ------------------- | -------------------- |
