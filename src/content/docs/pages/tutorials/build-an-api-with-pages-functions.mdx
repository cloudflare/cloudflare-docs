...
In your `blog-frontend` directory, run [`wrangler pages deploy`](/workers/wrangler/commands/general/#deploy-1) to deploy your project to the Cloudflare dashboard.
