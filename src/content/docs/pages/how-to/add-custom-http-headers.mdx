...
To operate your Workers function alongside your Pages application, deploy it to the same custom domain as your Pages application. To do this, update the [Wrangler configuration](/workers/wrangler/configuration) file in your project with your account and zone details:
...
Once you have configured your [Wrangler configuration](/workers/wrangler/configuration) file, run `npx wrangler deploy` in your terminal to deploy your Worker:
