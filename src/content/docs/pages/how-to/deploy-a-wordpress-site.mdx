...
tags:
  - WordPress
description: >-
  This guide assumes that you are: The Administrator account on your WordPress site. Able to install WordPress plugins on the site. You will need to download a new ZIP file from the WordPress dashboard and redeploy to Cloudflare Pages.
---
