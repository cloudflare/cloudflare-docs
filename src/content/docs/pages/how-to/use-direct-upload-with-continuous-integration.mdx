...
You can modify the Wrangler command with any [`wrangler pages deploy` options](/workers/wrangler/commands/general/#deploy).
...
You can also modify the Wrangler command with any [`wrangler pages deploy` options](/workers/wrangler/commands/general/#deploy).
