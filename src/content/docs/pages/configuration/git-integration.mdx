...
2. If the Cloudflare Workers and Pages installation is there, click **Configure**, and click **Uninstall "Cloudflare Workers and Pages"** (if there is no "Cloudflare Workers and Pages" installation, the user doesn't need to do anything)
