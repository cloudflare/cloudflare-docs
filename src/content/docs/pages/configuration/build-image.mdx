...
import PagesBuildEnvironment from "~/components/cf/PagesBuildEnvironment.astro";
import PagesBuildEnvironmentLanguages from "~/components/cf/PagesBuildEnvironmentLanguages.astro";
import PagesBuildEnvironmentTools from "~/components/cf/PagesBuildEnvironmentTools.astro";
...
- Detecting pnpm version from `pnpm-lock.yaml` file version.
