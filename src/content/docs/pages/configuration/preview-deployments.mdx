...
You can use [Cloudflare Access](/cloudflare-one/policies/access/) to manage access to your preview URLs. By default, these URLs are public. Enabling the access policy will restrict viewing project preview URLs to your Cloudflare account.

Once enabled, you can [set up a multi-user account](/fundamentals/setup/manage-members/) to allow other members of your team to view preview URLs.
