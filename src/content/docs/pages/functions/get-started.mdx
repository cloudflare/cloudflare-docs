...
Set these configurations by passing an argument to your [Wrangler](/workers/wrangler/commands/pages/#pages-dev) command or by setting them in the dashboard. To set Pages compatibility flags in the Cloudflare dashboard:
...
- Using [Wrangler](/workers/wrangler/commands/pages/#pages) from the command line.
