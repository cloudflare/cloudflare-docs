...
sidebar:
  hidden: true
description: >-
  Migrating a Jekyll-based site from GitHub Pages to Cloudflare Pages will take a few short steps. This tutorial assumes: You have an existing GitHub Pages site using [Jekyll](https://jekyllrb.com/) You have some familiarity with Ruby's command-line tools. You know how to use a few basic Git operations. You have read the [Get Started] guide.
---
