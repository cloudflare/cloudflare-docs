...
3. Select the new GitHub repository that you created and, in the **Set up builds and deployments** section, select *Eleventy* as your **Framework preset**. Your selection will provide the following information:
