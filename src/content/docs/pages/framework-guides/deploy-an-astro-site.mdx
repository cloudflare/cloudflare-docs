...
### Ensure Variables and Secrets are read correctly on Cloudflare Pages

Open you file astro.config.mjs and add this vite config under the "export default defineConfig" section :
