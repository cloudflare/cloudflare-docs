...
Add bindings to your Pages project by [adding them to your [Wrangler configuration](/workers/wrangler/configuration) file](/pages/functions/wrangler-configuration/).
