...
### 2. Add [Wrangler configuration](/workers/wrangler/configuration) file

Then, add a [[Wrangler configuration](/workers/wrangler/configuration) file](/pages/functions/wrangler-configuration/) file to the root directory of your Next.js app:
