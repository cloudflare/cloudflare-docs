...
Use this guide when you specifically want to deploy a Next.js static export to Cloudflare Pages. For Next.js on Workers, Cloudflare recommends [vinext](/workers/framework-guides/web-apps/nextjs/), which also supports static exports.
