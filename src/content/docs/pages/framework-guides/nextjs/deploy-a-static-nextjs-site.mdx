...
Use this guide when you specifically want to deploy a Next.js static export to Cloudflare Pages. vinext also supports static exports. For Next.js on Workers, Cloudflare recommends [vinext on Workers](/workers/framework-guides/web-apps/nextjs/).
