...
Use this guide only when you have a specific use case for static exports. For full-stack Next.js applications, Cloudflare recommends [vinext on Workers](/workers/framework-guides/web-apps/nextjs/).
