...
To bind resources in local development, you need to configure the bindings in the [Wrangler configuration](/workers/wrangler/configuration) file. Refer to [Bindings](/workers/wrangler/configuration/#bindings) to learn more.

Once you have configured the bindings in the [Wrangler configuration](/workers/wrangler/configuration) file, the proxies are then available within `context.cloudflare` in your `loader` or `action` functions:
...
You may have noticed that `context.cloudflare.env` is not typed correctly when you add additional bindings in [Wrangler's configuration](/workers/wrangler/configuration) file.
...
2. Configure bindings for your D1 database in the [Wrangler configuration](/workers/wrangler/configuration) file:
