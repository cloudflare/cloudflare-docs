...
- Generate an account certificate, the <a href="/tunnel/advanced/local-management/local-tunnel-terms/#certpem">cert.pem file</a>, in the <a href="/tunnel/advanced/local-management/local-tunnel-terms/#default-cloudflared-directory">default `cloudflared` directory</a>.
...
- Generate a <a href="/tunnel/advanced/local-management/local-tunnel-terms/#credentials-file">tunnel credentials file</a> in the <a href="/tunnel/advanced/local-management/local-tunnel-terms/#default-cloudflared-directory">default `cloudflared` directory</a>.
...
1.  In your `.cloudflared` directory, create a <a href="/tunnel/advanced/local-management/configuration-file/">`config.yml` file</a> using any text editor. This file will configure the tunnel to route traffic from a given origin to the hostname of your choice.
...
To route a <a href="/tunnel/routing/">published application</a> through the tunnel:
...
Cloudflare Tunnel can install itself as a system service on Linux and Windows and as a launch agent on macOS. For more information, refer to <a href="/tunnel/advanced/local-management/as-a-service/">run as a service</a>.
