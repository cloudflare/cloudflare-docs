...
1. Download `cloudflared` on your machine. Visit the <a href="/tunnel/downloads/">downloads</a> page to find the right package for your OS.
...
Alternatively, you can <a href="/tunnel/downloads/">download the latest Darwin amd64 release</a> directly.
...
Alternatively you can download the `cloudflared` binary or the linux packages to your machine and install manually. Visit the <a href="/tunnel/downloads/">downloads</a> page to find the right package for your OS.
...
- Generate an account certificate, the <a href="/tunnel/features/locally-managed-tunnels/local-tunnel-terms/#certpem">cert.pem file</a>, in the <a href="/tunnel/features/locally-managed-tunnels/local-tunnel-terms/#default-cloudflared-directory">default `cloudflared` directory</a>.
...
- Generate a <a href="/tunnel/features/locally-managed-tunnels/local-tunnel-terms/#credentials-file">tunnel credentials file</a> in the <a href="/tunnel/features/locally-managed-tunnels/local-tunnel-terms/#default-cloudflared-directory">default `cloudflared` directory</a>.
...
1.  In your `.cloudflared` directory, create a <a href="/tunnel/features/locally-managed-tunnels/configuration-file/">`config.yml` file</a> using any text editor. This file will configure the tunnel to route traffic from a given origin to the hostname of your choice.
...
To route a <a href="/tunnel/concepts/routing/">published application</a> through the tunnel:
...
Cloudflare Tunnel can install itself as a system service on Linux and Windows and as a launch agent on macOS. For more information, refer to <a href="/tunnel/features/locally-managed-tunnels/as-a-service/">run as a service</a>.
