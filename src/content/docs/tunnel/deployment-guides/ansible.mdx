...
- <a href="/tunnel/deployment-guides/terraform/">Basic knowledge of Terraform</a> and <a href="https://developer.hashicorp.com/terraform/tutorials/certification-associate-tutorials/install-cli">Terraform installed</a>.
