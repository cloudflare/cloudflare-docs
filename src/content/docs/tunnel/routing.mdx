...
<Render
  ...
  params={{
    disableTlsVerificationURL: "/tunnel/advanced/origin-parameters/#notlsverify",
    locallyManagedTunnelsURL: "/tunnel/advanced/local-management/configuration-file/#file-structure-for-published-applications"
  }}
/>
