...
2. **Required ports and IPs are allowed**. Your firewall must permit egress to the [Cloudflare Tunnel IPs and ports](/tunnel/configuration/#firewall-rules), as well as `api.cloudflare.com` on port `443`.
