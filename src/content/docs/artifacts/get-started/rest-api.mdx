...
The REST control-plane base URL and the returned Git remote use different hosts. Use the exact `result.remote` value for Git operations. In that value, `{account_id}` is your Cloudflare account ID.
