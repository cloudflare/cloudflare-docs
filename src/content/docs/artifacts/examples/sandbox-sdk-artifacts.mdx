...
Start from the template with `create cloudflare`, as shown in [Create your project](#create-your-project). Then adapt the Artifacts flow with the focused snippets below.
...
<PackageManagers
	...
	args={
		"repo-per-sandbox --template=cloudflare/sandbox-sdk/examples/git-repo-per-sandbox#v0"
	}
/>
