...
```json
{
	"id": "repo_456",
	"name": "starter-repo-copy",
	"remote": "https://<ACCOUNT_SUBDOMAIN>.artifacts.cloudflare.dev/git/default/starter-repo-copy.git",
...
```json
{
	"id": "repo_789",
	"name": "react-mirror",
	"remote": "https://<ACCOUNT_SUBDOMAIN>.artifacts.cloudflare.dev/git/default/react-mirror.git",
...
<LinkCard
	...
	description="Call the same Artifacts operations from a Worker through the service binding."
/>

<LinkCard
	title="Authenticated remote URLs"
	href="/artifacts/api/authenticated-remote-urls/"
	description="Use repo remotes and tokens with git-compatible tooling."
/>

<LinkCard
	title="Git support"
	href="/artifacts/api/git-support/"
	description="Understand how Artifacts maps repo operations onto git-compatible workflows."
/>
