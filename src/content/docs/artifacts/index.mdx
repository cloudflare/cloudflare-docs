...
Artifacts is currently in closed beta and requires a **[Workers Paid](/workers/platform/pricing/)** plan. Usage is not available on Workers Free. Refer to [Artifacts pricing](/artifacts/platform/pricing/).

To request access, fill out [this form](https://forms.gle/DwBoPRa3CWQ8ajFp7).
