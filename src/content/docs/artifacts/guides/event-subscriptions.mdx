...
Triggered when commits are pushed to a repository. Includes the branch, before and after commit SHAs, commit messages, authors, and total commit count.
...
```json
{
  ...
  "metadata": {
    ...
    "eventSubscriptionId": "1830c4bb612e43c3af7f4cada31fbf3f",
    "eventSchemaVersion": 1,
    "eventTimestamp": "2026-05-18T15:53:47.132Z"
  }
}
```
