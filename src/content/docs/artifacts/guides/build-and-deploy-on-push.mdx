...
```ts
import { CIWorkflow, cloudflareArtifacts } from './src/pipeline';
import type { CiContext, CiParams, CloudflareArtifacts } from './src/pipeline';
import type { WorkflowEvent, WorkflowStep } from 'cloudflare:workers';

export class CI extends CIWorkflow({ provider }) {
