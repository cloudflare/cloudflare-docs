...
This guide defines those CI steps in a Workflow class named `CIWorkflow`. To start this Workflow automatically after each push, add an `artifacts.push` trigger to your Wrangler configuration:
...
:::note
If you are running CI for a User Worker, include `"dispatch_namespace":<DISPATHCH_NAMEPSACE>" in your Trigger target.
:::
