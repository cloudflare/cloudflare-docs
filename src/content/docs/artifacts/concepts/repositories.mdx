...
Every repository lives inside one namespace. The namespace groups related repositories, and the repository name identifies one repository inside that group.
