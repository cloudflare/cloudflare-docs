...
- `rules` <Type text="Array<Rule>" /> <MetaInfo text="Optional" />
  - A list of [rules](/ruleset-engine/rulesets-api/json-object/#rule-object-structure-and-properties) to include in the ruleset.

For additional details on these parameters, refer to [JSON objects](/ruleset-engine/rulesets-api/json-object/).
