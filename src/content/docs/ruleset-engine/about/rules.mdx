...
- The rule [expression](/ruleset-engine/rules-language/expressions/), also called filter expression, defines the scope of the rule.
- The rule [action](/ruleset-engine/rules-language/actions/) defines what happens when there is a match for the expression.
