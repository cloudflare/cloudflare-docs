...
For a list of API endpoints refer to [List and view rulesets](/ruleset-engine/rulesets-api/view/).

### Example: View available rulesets at the zone level

The response to the [GET request](/api/resources/rulesets/methods/list/) obtaining the list of rulesets at the zone level will include the following rulesets:
...
The response to the [GET request](/api/resources/rulesets/methods/list/) obtaining the list of rulesets at the account level will include the following rulesets:
...
You can get the definition of the [entry point ruleset](/ruleset-engine/about/rulesets/#entry-point-ruleset) of a given [phase](/ruleset-engine/about/phases/) at the zone or account level.
...
The following [GET request](/api/resources/rulesets/subresources/phases/methods/get/) obtains the definition of the entry point ruleset for the `http_request_firewall_managed` phase at the zone level. In this case, the entry point ruleset exists and contains one rule.
...
The following [GET request](/api/resources/rulesets/subresources/phases/methods/get/) obtains the definition of the entry point ruleset for the `http_request_firewall_managed` phase at the account level.
...
The following [GET request](/api/resources/rulesets/subresources/phases/subresources/versions/methods/get/) lists the rules in version `2` of the `http_request_firewall_managed` phase entry point ruleset at the zone level.
...
The following [GET request](/api/resources/rulesets/subresources/versions/methods/get/) lists the rules in version `2` of a managed ruleset (the most recent version of that ruleset).
