...
:::note
In HTTP/2, the names of HTTP headers are always in lowercase. Recent versions of the `curl` tool [enable HTTP/2 by default](https://curl.se/docs/http2.html#curl-tool) for HTTPS connections.
:::
