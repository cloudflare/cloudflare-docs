...
When validating HMAC tokens in an expression, pass this field as the _currentTimestamp_ argument to the [is_timed_hmac_valid_v0()](https://www.cloudflare.com/ruleset-engine/rules-language/functions/#hmac-validation) validation function.
