...
[^3]: [Adaptive DDoS Protection](/ddos-protection/managed-rulesets/adaptive-protection/) and [Advanced DNS Protection](/ddos-protection/advanced-ddos-systems/overview/advanced-dns-protection/) are only supported for CMB = US. All other features are available to all CMB regions.
