...
[^49]: Digital Experience supports Cloudflare's [Customer Metadata Boundary](/data-localization/metadata-boundary/get-started) only for the 'EU' (European Union) option
