...
Regional Hostnames support [managed regions](/data-localization/region-support/#region-types). If you need a custom region, use [Regionalized Spectrum Applications](/data-localization/regional-services/spectrum-applications/) or [Regionalized IP Bindings](/data-localization/regional-services/ip-bindings/) instead.
