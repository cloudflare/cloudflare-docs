...
To configure Customer Metadata Boundary to EU only, Log Retention, a legacy feature of [Logpull](/logs/logpull/), must be disabled for all zones within your account.
