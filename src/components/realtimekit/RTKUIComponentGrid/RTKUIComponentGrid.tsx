...
const RTKUIComponentGrid = () => {
	...
	const uiComponents = [
		...
		},
		{
			...
			componentName: "rtk-chat-header",
			tags: ["chat", "header", "message", "sidebar"],
		},
		{
			id: "rtk-chat-selector",
			name: "Chat Selector",
			imagePath: imageSrc("rtk-chat.svg"),
			componentName: "rtk-chat-selector",
			tags: ["chat", "selector", "private-chat", "message", "sidebar"],
		},
		{
			id: "rtk-pinned-message-selector",
			name: "Pinned Message Selector",
			imagePath: imageSrc("rtk-chat.svg"),
			componentName: "rtk-pinned-message-selector",
			tags: ["chat", "pinned-message", "selector", "message", "sidebar"],
		},
		{
			id: "rtk-chat-messages-ui-paginated",
			name: "Chat Messages UI Paginated",
			imagePath: imageSrc("rtk-chat.svg"),
			componentName: "rtk-chat-messages-ui-paginated",
			tags: ["chat", "message", "pagination", "sidebar"],
		},
		{
			id: "rtk-chat-composer-view",
			name: "Chat Composer View",
			imagePath: imageSrc("rtk-chat.svg"),
			componentName: "rtk-chat-composer-view",
			tags: ["chat", "composer", "message", "sidebar"],
		},
		{
		...
		},
		{
			...
			tags: ["notification", "sidebar", "popup"],
		},
		{
