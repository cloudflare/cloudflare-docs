...
export type ProductKey = "r2" | "superSlurper" | "vectorize" | "workersAi" | "workersBuilds" | "kv" | "workflows";
	...
	workflows: [
		{
			...
			description: "Triggered when an instance was created and is awaiting execution.",
			source: {
		...
		},
		{
			...
			description: "Triggered when an instance finishes execution successfully.",
			source: {
				type: "workflows.workflow",
				workflowName: "my-workflow"
			},
